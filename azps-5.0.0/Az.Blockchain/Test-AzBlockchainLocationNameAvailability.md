...
### Przykład 1. Sprawdź, czy nazwa zasobu jest dostępna
```powershell
...
Polecenie sprawdza, czy nazwa zasobu jest dostępna.
...
### Microsoft. Azure. PowerShell. polecenia. Blockchain. models. Api20180601Preview. INameAvailability
