...
## Opis
Polecenie cmdlet **stop-AzBatchJobSchedule** zatrzymuje harmonogram zadań usługi Azure Batch.
...
To polecenie zatrzymuje harmonogram zadań o IDENTYFIKATORze JobSchedule17.
...
### -ID
Określa identyfikator harmonogramu zadań, który zostanie zatrzymany przez to polecenie cmdlet.
