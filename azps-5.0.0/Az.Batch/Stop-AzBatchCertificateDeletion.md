...
## Opis
Polecenie cmdlet **stop-AzBatchCertificateDeletion** anuluje usunięcie nieudanego certyfikatu w usłudze Azure Batch.
Możesz zatrzymać usuwanie tylko wtedy, gdy certyfikat jest w stanie **DeleteFailed** .
To polecenie cmdlet przywraca stan **aktywny** .
