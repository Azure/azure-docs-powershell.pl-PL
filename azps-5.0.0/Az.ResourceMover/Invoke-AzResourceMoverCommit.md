...
### Przykład 1. Sprawdź poprawność dependecies przed zatwierdzeniem zasobów
```powershell
...
Sprawdź poprawność dependecies przed zatwierdzeniem zasobów.

### Przykład 2: zatwierdzanie zestawu zasobów w kolekcji Move przy użyciu funkcji "MoveResource Name" jako danych wejściowych
```powershell
...
Zatwierdzanie zestawu zasobów w kolekcji Move przy użyciu funkcji "MoveResource Name" jako danych wejściowych

### Przykład 3: zatwierdzanie zestawu zasobów w kolekcji Move przy użyciu funkcji "SourceARMID" jako danych wejściowych
```powershell
...
Zatwierdzanie zestawu zasobów w kolekcji przenoszenia przy użyciu danych wejściowych "SourceARMID"
