...
## Opis
Polecenie cmdlet **Remove-AzSearchQueryKey** usuwa klucz zapytania z usługi Azure Search.
...
W przykładzie usunięto klucz zapytania z usługi Azure Search.
...
### -Wartość parametru
Wartość klucza zapytania usługi wyszukiwania.
