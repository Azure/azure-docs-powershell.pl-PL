...
### Przykład 1: Usuwanie rozszerzenia komputera.
```powershell
PS C:\> Remove-AzConnectedMachineExtension -MachineName myMachine -ResourceGroupName myRG -Name custom

```

Usuwa rozszerzenie na komputerze.

### Przykład 2: Usuwanie rozszerzenia za pośrednictwem rurociągu
```powershell
PS C:\> Get-AzConnectedMachineExtension -ResourceGroupName contoso-connected-machines -MachineName myMachine | Remove-AzConnectedMachineExtension

```

Usuwa wszystkie rozszerzenia określonego komputera.
...
### -NazwaKomputera
Nazwa komputera, na którym należy usunąć rozszerzenie.
