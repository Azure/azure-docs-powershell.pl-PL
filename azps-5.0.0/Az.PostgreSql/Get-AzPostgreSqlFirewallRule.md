...
### Przykład 1: wyświetla wszystkie reguły zapory na określonym serwerze PostgreSql
```powershell
...
To polecenie cmdlet umożliwia pobieranie reguły zapory według nazwy.
...
To polecenie cmdlet umożliwia pobieranie reguły zapory według tożsamości.
