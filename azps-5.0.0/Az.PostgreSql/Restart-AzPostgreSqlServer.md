...
### Przykład 1: ponowne uruchomienie serwera PostgreSql według grupy zasobów i nazwy serwera
```powershell
PS C:\> Restart-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

To polecenie cmdlet ponownie uruchamia PostgreSql serwera według grupy zasobów i nazwy serwera.

### Przykład 2: ponowne uruchomienie PostgreSql serwera za pomocą tożsamości
```powershell
...
Te polecenia cmdlet ponownie uruchamiają PostgreSql serwer po tożsamości.
