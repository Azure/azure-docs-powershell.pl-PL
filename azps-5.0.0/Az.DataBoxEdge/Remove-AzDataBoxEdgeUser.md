...
## Opis
Polecenie cmdlet **Remove-AzDataBoxEdgeUser** usuwa użytkownika na urządzeniu z danymi na krawędziach pola danych. Możliwość tworzenia tylko użytkowników typu `Share` jest obsługiwana.
