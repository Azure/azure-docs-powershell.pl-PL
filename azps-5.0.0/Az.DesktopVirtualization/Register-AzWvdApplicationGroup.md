...
### Przykład 1: rejestrowanie grupy aplikacji klasycznej Windows Virtual
```powershell
...
To polecenie rejestruje grupę aplikacji pulpit wirtualny systemu Windows w obszarze roboczym.
