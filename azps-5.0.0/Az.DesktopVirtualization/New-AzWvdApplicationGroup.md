...
### Przykład 1: Tworzenie okna aplikacji klasycznego pulpitu systemu Windows według nazwy
```powershell
...
To polecenie powoduje utworzenie grupy aplikacji pulpitu wirtualnego systemu Windows w grupie zasobów.

### Przykład 2: Tworzenie okna aplikacji klasycznego pulpitu systemu Windows według nazwy
```powershell
PS C:\> New-AzWvdApplicationGroup -ResourceGroupName ResourceGroupName `
                            -Name ApplicationGroupName `
                            -Location 'eastus' `
...
Typ zasobu w polu ApplicationName.
...
### — Opis
Opis aplikacji ApplicationName.
...
### -HostPoolArmPath
HostPool ARM ścieżka do aplikacji.
...
### Microsoft. Azure. PowerShell. polecenia. DesktopVirtualization. models. Api20191210Preview. IApplicationGroup
