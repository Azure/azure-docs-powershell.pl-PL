...
### Przykład 1: usuwanie pulpitu wirtualnego systemu Worksapce według nazwy
```powershell
PS C:\> Remove-AzWvdWorksapce -ResourceGroupName ResourceGroupName -Name WorkspaceName
```

To polecenie usuwa obszar roboczy pulpit wirtualny systemu Windows w grupie zasobów.
