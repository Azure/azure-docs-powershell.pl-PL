...
### Przykład 1: uzyskiwanie tokenu rejestracji wirtualnego pulpitu systemu Windows
```powershell
...
To polecenie pobiera token rejestracji pulpitu wirtualnego systemu Windows w puli hostów.
...
### Microsoft. Azure. PowerShell. polecenia. DesktopVirtualization. models. Api20191210Preview. RegistrationInfo
