...
### Przykład 1: usuwanie tokenu rejestracji wirtualnego pulpitu systemu Windows
```powershell
PS C:\> Remove-AzWvdRegistrationInfo -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName
```

To polecenie usuwa token rejestracji wirtualnego pulpitu systemu Windows w puli hostów.
