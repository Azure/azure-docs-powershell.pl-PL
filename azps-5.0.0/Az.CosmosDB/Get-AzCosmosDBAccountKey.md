...
## Opis
Pobieranie listy kluczy połączeń.
...
Lista kluczy dla konta CosmosDB. Typem klucza może być wartość z: ConnectionStrings, Keys i ReadOnlyKeys. Wartość domyślna to Keys.
...
### -Type
Wartość z: {ConnectionStrings, Keys, ReadOnlyKeys}.
Wartość domyślna to Keys.
