...
## STRESZCZENIe
Tworzy nowy obiekt IndexingPolicy CosmosDB.
...
## Opis
Polecenie cmdlet **New-AzCosmosDBGremlinIndexingPolicy** tworzy nowy obiekt typu PSIndexingPolicy.
...
### -Automatyczna
Wartość logiczna wskazująca, czy zasady indeksowania są automatyczne
...
### -CompositePath
Tablica tablicy obiektów typu Microsoft. Azure. Commands. CosmosDB. PSCompositePath
...
### -ExcludedPath
Tablica ciągów zawierających excludedPath (określa ścieżkę w dokumencie JSON, która ma zostać wykluczona w ramach usługi Azure Cosmos DB Service).  czynników.
...
### -IncludedPath
Tablica ciągów zawierających includedPath (określa ścieżkę w dokumencie JSON, która ma być uwzględniana w elementach usługi Azure Cosmos DB Service).
...
Możliwe wartości to: "zgodne", "z opóźnieniem", "Brak".
...
### -SpatialSpec
Tablica obiektów typu Microsoft. Azure. Commands. CosmosDB. PSSpatialSpec
