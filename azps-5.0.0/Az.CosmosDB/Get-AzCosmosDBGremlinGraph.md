...
## STRESZCZENIe
Pobiera wykres Gremlin CosmosDB.
...
## Opis
Polecenie cmdlet **Get-AzCosmosDBGremlinGraph** pobiera właściwości CosmosDB Gremlin wykresu.
...
Obiekt zasobu zawiera IndexingPolicy, PartitionKey, DefaultTtl, UniqueKeyPolicy, ConflictResolutionPolicy, _rid, _ts, _etag.
