...
## STRESZCZENIe
Tworzy nowy obiekt typu PSIncludedPath. Może on zostać przekazany jako wartość parametru w parametrze Set-AzCosmosDBGremlinGraph.
...
## Opis
Obiekt odpowiadający IncludedPath API Gremlin.
