...
### Przykład 1: usuwanie środowiska informacji o seriach czasu według nazwy
```powershell
PS C:\> Remove-AzTimeSeriesInsightsEnvironment -ResourceGroupName testgroup -Name tsill

```

To polecenie usuwa środowisko informacji o seriach czasowych.

### Przykład 2: usuwanie środowiska informacji o seriach czasu według obiektów
```powershell
