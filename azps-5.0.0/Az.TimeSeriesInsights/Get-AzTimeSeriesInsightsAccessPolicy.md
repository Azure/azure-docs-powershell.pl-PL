...
### Przykład 1: wyświetlanie wszystkich zasad dostępu w określonym środowisku
```powershell
...
To polecenie wyświetla listę wszystkich zasad dostępu w określonym środowisku.
...
To polecenie pobiera określone zasady dostępu.

### Przykład 3: uzyskiwanie określonych zasad dostępu według obiektów
```powershell
