...
### Przykład 1: aktualizowanie środowiska szczegółowego dotyczącego serii czasu Gen1
```powershell
...
To polecenie aktualizuje środowisko Gen1 informacji o seriach czasu.

### Przykład 2: aktualizowanie środowiska informacji o seriach czasu Gen1
```powershell
...
### -Tag
Pary klucz-wartość dodatkowych właściwości dla środowiska.
