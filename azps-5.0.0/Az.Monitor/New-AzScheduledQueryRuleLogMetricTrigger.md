...
Dane wejściowe nie są sprawdzane. Zostanie ona najpierw sprawdzona, gdy New-AzScheduledQueryRule jest po pewnym czasie wywoływana.
...
### -Próg
Wartość progowa metryki: kolejno, suma.
Dane wejściowe nie są sprawdzane. Zostanie ona najpierw sprawdzona, gdy New-AzScheduledQueryRule jest po pewnym czasie wywoływana.
...
### -ThresholdOperator
Operator progu metrycznego: GreaterThan, LessThan, równe.
Dane wejściowe nie są sprawdzane. Zostanie ona najpierw sprawdzona, gdy New-AzScheduledQueryRule jest po pewnym czasie wywoływana.
