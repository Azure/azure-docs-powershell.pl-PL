...
### ByResourceNameParameterSet (domyślny)
```
...
Aktualizowanie zakresu linków prywatnych o nazwie "scope_name" w obszarze Grupa zasobów "rg_name", aby użyć tagu "Key: value"
...
Aktualizowanie zakresu linków prywatnych za pomocą identyfikatora zasobu w celu użycia tagu "Key: value"
...
Aktualizowanie zakresu linków prywatnych za pomocą obiektu z wejściowym linkiem prywatnym w celu użycia tagu "Key: value"
