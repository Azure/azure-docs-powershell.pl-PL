...
### Przykład 1: Uzyskaj wiosenną aplikację w chmurze Deploymeng według nazwy.
```powershell
...
Uzyskaj wiosenną aplikację Deploymeng w chmurze według imienia i nazwiska.

### Przykład 2: wyświetlanie wszystkich wdrożeń w ramach danej aplikacji ze sprężyną chmurową.
```powershell
...
Lista wszystkich wdrożeń w danej aplikacji ze sprężyną chmurową.
...
### -Version
Wersje wdrożeń, które mają być wyświetlane
