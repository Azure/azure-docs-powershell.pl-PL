...
Aby skonstruować, zobacz sekcję notatki dla właściwości właściwości i Utwórz tablicę skrótów.
...
Właściwość <IMigrateProjectProperties> : określa właściwości projektu.
  - `[ProvisioningState <ProvisioningState?>]`: Stan inicjowania obsługi projektu migracji.
