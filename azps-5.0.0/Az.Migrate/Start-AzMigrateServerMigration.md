...
### -Inputobject
Określa serwer replikacji, dla którego należy zainicjować migrację.
...
### -TargetObjectID
Określa serwer replcating, dla którego należy zainicjować migrację.
...
### -TurnOffSourceServer
Określa, czy serwer źródłowy powinien być wyłączony.
...
INPUTobject <IMigrationItem> : Określa serwer replikacji, dla którego należy zainicjować migrację. Obiekt serwera można pobrać przy użyciu polecenia cmdlet Get-AzMigrateServerReplication.
