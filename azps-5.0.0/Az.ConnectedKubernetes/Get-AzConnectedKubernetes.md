...
## STRESZCZENIe
Zwraca właściwości określonego klastra połączonego, w tym nazwę, tożsamość, właściwości i dodatkowe szczegóły klastra.
...
### Przykład 1: uzyskiwanie wszystkich połączonych Kubernetes w ramach abonamentu
```powershell
...
To polecenie uzyskuje wszystkie połączone Kubernetes w ramach abonamentu.

### Przykład 2: uzyskiwanie wszystkich połączonych Kubernetes w grupie zasób
```powershell
...
To polecenie pobiera wszystkie połączone Kubernetes w grupie zasobów.

### Przykład 3: uzyskiwanie połączonego Kubernetes
```powershell
...
To polecenie uzyskuje połączony Kubernetes.

### Przykład 4: uzyskiwanie połączonego Kubernetes przez obiekt
```powershell
...
To polecenie uzyskuje połączony Kubernetes przez obiekt.

## PARAMETRÓW

### -Nazwaklastraname
Nazwa klastra usługi Kubernetes, na którym jest wywoływana pozycja get.
...
### Microsoft. Azure. PowerShell. polecenia. ConnectedKubernetes. models. IConnectedKubernetesIdentity

## WYSYŁA

### Microsoft. Azure. PowerShell. polecenia. ConnectedKubernetes. models. Api202001Preview. IConnectedCluster
...
INPUTobject <IConnectedKubernetesIdentity> : parametr Identity
  - `[ClusterName <String>]`: Nazwa klastra usługi Kubernetes, na którym jest wywoływana metoda get.
