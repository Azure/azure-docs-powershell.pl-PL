...
### Przykład 1. Tworzenie nowej reguły zapory serwera MySql
```powershell
...
Te polecenia cmdlet tworzą regułę zapory serwera MySql.

### Przykład 2: Tworzenie nowej reguły zapory MySql przy użyciu polecenia-ClientIPAddress.
```powershell
...
Te polecenia cmdlet tworzą regułę zapory MySql przy użyciu funkcji-ClientIPAddress.

### Przykład 3: Tworzenie nowej reguły zapory MySql w celu umożliwienia obsługi wszystkich adresów IP
```powershell
...
Te polecenia cmdlet umożliwiają utworzenie nowej reguły zapory MySql w celu umożliwienia obsługi wszystkich adresów IP.
