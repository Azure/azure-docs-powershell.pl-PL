...
## Opis
Polecenie cmdlet **Get-AzStorageObjectReplicationPolicy** Pobiera lub wyświetla zasady replikacji obiektów dla konta magazynu.

## Przykłady

### Przykład 1: uzyskiwanie zasad replikacji obiektów z określonym identyfikatorem zasad i wyświetlanie jego reguł.
```
...
To polecenie pobiera zasady replikacji obiektów z określonym identyfikatorem zasad i wyświetla jego reguły.

### Przykład 2: wyświetlanie zasad replikacji obiektów z konta magazynu
```
...
To polecenie wyświetla listę zasad replikacji obiektów z konta magazynu.
