...
## Opis
Polecenie cmdlet **Set-AzStorageContainerStoredAccessPolicy** ustawia zapisane zasady dostępu dla kontenera magazynu platformy Azure.

## Przykłady

### Przykład 1: Ustawianie zasad dostępu przechowywanych w kontenerze magazynu z pełnymi uprawnieniami
```
PS C:\>Set-AzStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy06" -Permission rwdl
```

To polecenie ustawia zasady dostępu o nazwie Policy06 dla kontenera magazynu o nazwie.
...
### -Nostarttime
Umożliwia ustawienie godziny rozpoczęcia $Null.
...
### -Uprawnienie
Określa uprawnienia w przechowywanych zasadach dostępu w celu uzyskania dostępu do kontenera magazynu.
