...
### Przykład 1: przenoszenie składu w tym samym systemie plików
```
...
To polecenie Przenieś katalog "dir1" do katalogu "dir3" w tym samym systemie plików.

### Przykład 2: przenoszenie pliku według rurociągu do innego systemu plików na tym samym koncie magazynu bez monitu
```
...
To polecenie Przenieś plik "dir1/plik1" w "filesystem1" do pliku "dir2/file2" w "filesystem2" na tym samym koncie magazynu bez monitowania.
...
### -DestFileSystem
Nazwa docelowego systemu plików
...
### -DestPath
Ścieżka docelowego obiektu BLOB
...
### -Force
Wymuś przekroczenie miejsca docelowego.
...
### -Inputobject
Obiekt usługi Azure datalake Gen2, z którego można przechodzić.
...
### -Path
Ścieżka w określonym systemie plików, z której należy przechodzić.
