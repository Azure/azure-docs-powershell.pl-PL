...
Należy go uruchomić na docelowym obiekcie blob kopiowania.
...
### Przykład 4: Rozpoczynanie kopiowania i potoku w celu uzyskania statusu kopii
```
...
Pierwsze polecenie rozpoczyna Kopiowanie obiektu BLOB "ContosoPlanning2015" do "ContosoPlanning2015_copy", a następnie wyprowadza obiekt BLOB destiantion. Drugie polecenie podaje obiekt BLOB destiantion, aby uzyskać-AzStorageBlobCopyState, aby uzyskać stan kopii obiektu BLOB. 
