...
## Opis
Polecenie cmdlet **Remove-AzStorageQueueStoredAccessPolicy** usuwa zapisane zasady dostępu z kolejki usługi Azure Storage.

## Przykłady

### Przykład 1: usuwanie zapisanych zasad dostępu z kolejki magazynu
```
PS C:\>Remove-AzStorageQueueStoredAccessPolicy -Queue "MyQueue" -Policy "Policy04"
```

To polecenie usuwa zasady dostępu o nazwie Policy04 z kolejki magazynu o nazwie Moja kolejka.
