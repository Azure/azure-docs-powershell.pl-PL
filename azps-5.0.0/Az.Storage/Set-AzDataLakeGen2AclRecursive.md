...
## Opis
Polecenie cmdlet **Set-AzDataLakeGen2AclRecursive** ustawia rekursywnie listę ACL w określonej ścieżce. Wejściowa lista ACL zastąpi całkowicie pierwotną listę ACL.

## Przykłady

### Przykład 1: ustawianie listy ACL rekursywnie w directiry
```
...
To polecenie najpierw tworzy obiekt ACL z trzema wpisami ACL, a następnie ustawia rekursywnie listę ACL w katalogu.

### Przykład 2: ustawianie listy ACL rekursywnie na głównym directiry systemu plików
```
...
To polecenie najpierw ustawia listę ACL rekursywnie w katalogu głównym i nie powiodło się, a następnie wznawia pracę z ContinuationToken po usunięciu nieudanego pliku przez użytkownika.

### Przykład 3: ustawianie listy ACL rekursywnie według fragmentu
```
$token = $null
...
Ten skrypt ustawia listę ACL rescursively dla fragmentu katalogu, z rozmiarem fragmentu jako BatchSize * MaxBatchCount. Rozmiar fragmentu to 200 w tym skrypcie.

### Przykład 4: ustawianie listy ACL w katalogu i ContinueOnFailure, a następnie wznawianie od błędów o jednej
```
...
To polecenie najpierw ustawia listę ACL rekursywnie w katalogu zawierającym ContinueOnFailure, a niektóre elementy nie powiodły się, a następnie wznowić działanie elementów, które nie powiodły się pojedynczo.
