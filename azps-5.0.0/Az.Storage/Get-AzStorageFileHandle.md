...
## Opis
Polecenie cmdlet **Get-AzStorageFileHandle** zawiera listę dojść do plików udziału plików lub katalogu plików lub pliku.

## Przykłady

### Przykład 1: pocyklicznie Wyświetl wszystkie uchwyty plików w udziale plików, a następnie Sortuj według ClientIp i OpenTime
```
...
To polecenie wyświetla listę dojść do plików w udziale plików i sortuje dane wyjściowe według ClientIp, a następnie OpenTime.

### Przykład 2: Lista pierwszych 2 dojść do plików w katalogu plików rekurencyjnie
```
...
To polecenie wyświetla cyklicznie listę pierwszych 2 dojść do plików w katalogu plików.

### Przykład 3: Wyświetlanie listy od trzeciej do szóstego uchwytu do pliku
```
...
To polecenie wyświetla listę od trzeciego do szóstego dojścia do pliku w pliku.
...
### -File (plik)
Obiekt CloudFile wskazał na plik listę dojść do pliku.
...
### -IncludeTotalCount
Wyświetla liczbę obiektów w zbiorze danych (liczba całkowita), a następnie obiekty. Jeśli polecenie cmdlet nie może ustalić całkowitej liczby, zwraca wartość "Łączna liczba nieznanych".
Obecnie ten parametr nie wykonuje żadnych działań.
