...
### Przykład 1: aktualizowanie dostawcy tożsamości w serwisie Facebook
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\> Set-AzApiManagementIdentityProvider -Context $apimContext -Type Facebook -ClientSecret "updatedSecret" -PassThru
```

Polecenie cmdlet aktualizuje klucz tajny klienta usługi Facebook Identity Provider.

### Przykład 2

Umożliwia zaktualizowanie konfiguracji istniejącego dostawcy tożsamości. (autogenerowana)
...
### -Authority
OpenID Połącz hosta punktu końcowego odnajdowania w usłudze AAD lub AAD B2C. Ten parametr jest opcjonalny.
...
### -Inputobject
Wystąpienie PsApiManagementIdentityProvider. Ten parametr jest wymagany.
...
### -PassThru
Wskazuje, że to polecenie cmdlet zwróci  **PsApiManagementIdentityProvider** , które modyfikuje to polecenie cmdlet.
...
Nazwa zasady resetowania hasła. Dotyczy tylko dostawcy tożsamości usługi AAD B2C. Ten parametr jest opcjonalny.
...
### -SigninPolicyName
Nazwa zasady logowanie się. Dotyczy tylko dostawcy tożsamości usługi AAD B2C. Ten parametr jest opcjonalny.
...
### -SigninTenant
Zaloguj się, aby zastąpić w usłudze AAD B2C zamiast `common` dzierżawy
...
### -SignupPolicyName
Nazwa zasad zapisywania się. Dotyczy tylko dostawcy tożsamości usługi AAD B2C. Ten parametr jest opcjonalny.
