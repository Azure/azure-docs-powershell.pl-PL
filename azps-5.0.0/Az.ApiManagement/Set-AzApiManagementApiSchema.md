...
## Opis
Polecenie cmdlet **Set-AzApiManagementApiSchema** modyfikuje schemat interfejsu API zarządzania interfejsem Azure API.

## Przykłady

### Przykład 1. modyfikuje schemat API
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Set-AzApiManagementApiSchema -Context $ApiMgmtContext -ApiId "echo-api" -SchemaId "2"
```

W przykładzie Zaktualizowano schemat API

### Przykład 2

Modyfikuje schemat API. (autogenerowana)
...
### -Inputobject
Wystąpienie PsApiManagementApiSchema.
Ten parametr jest wymagany.
...
### -ResourceId
Identyfikator zasobu ARM dla schematu diagnostycznego lub interfejsu API. Ten parametr jest wymagany.
...
### -SchemaDocument
Dokument schematu API jako ciąg. Ten parametr jest wymagany — SchemaDocumentFile nie jest określony.
...
ContentType schematu API. Ten parametr jest opcjonalny.
...
Ścieżka pliku dokumentu schematu API. Ten parametr jest wymagany — SchemaDocument nie jest określony.
