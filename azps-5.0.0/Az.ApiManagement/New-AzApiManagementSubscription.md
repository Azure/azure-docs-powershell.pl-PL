...
## Opis
Polecenie cmdlet **New-AzApiManagementSubscription** tworzy abonament.
...
### Przykład 2: Tworzenie abonamentu dla całego zakresu interfejsów API
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>New-AzApiManagementSubscription -Context $context -Scope "/apis" -Name "GlobalApiScope"
```

### Przykład 3: Tworzenie abonamentu dla zakresu produktów
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### -AllowTracing
Flaga określająca, czy można włączyć śledzenie na poziomie abonamentu. To jest parametr opcjonalny, a wartość domyślna to $null.
