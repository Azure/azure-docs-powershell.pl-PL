...
### Przykład 1. Usuń obszar roboczy datacegły
```powershell
PS C:\> Remove-AzDatabricksWorkspace -ResourceGroupName testgroup -Name databricks-test
```

To polecenie umożliwia usunięcie obszaru roboczego datakostki z grupy zasobów.

### Przykład 2: Usuwanie obszaru roboczego datakostkowe według obiektu
```powershell
