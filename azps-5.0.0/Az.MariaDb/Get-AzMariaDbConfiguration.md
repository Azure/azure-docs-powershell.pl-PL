...
### Przykład 1: wyświetlanie wszystkich konfiguracji pod MariaDB
```powershell
...
To polecenie wyświetla listę wszystkich konfiguracji pod MariaDB.

### Przykład 2: Uzyskiwanie konfiguracji MariaDB
```powershell
...
To polecenie pobiera konfigurację MariaDB.
...
### Microsoft. Azure. PowerShell. polecenia. MariaDb. models. Api20180601Preview. IConfiguration
