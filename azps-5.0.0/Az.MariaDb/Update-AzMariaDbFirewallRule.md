...
### Przykład 2: aktualizowanie reguły zapory MariaDB według tożsamości.
```powershell
...
Polecenie cmdlet aktualizuje MariaDBą regułę zapory według tożsamości.
...
Polecenie cmdlet aktualizuje MariaDBą regułę zapory o-ClientIPAddress.
