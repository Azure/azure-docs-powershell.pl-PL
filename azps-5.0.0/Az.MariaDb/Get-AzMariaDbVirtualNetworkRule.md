...
### Przykład 1: Lista wszystkich reguł sieci wirtualnej w obszarze MariaDB
```powershell
...
To polecenie wyświetla listę wszystkich reguł sieci wirtualnej pod MariaDB.

### Przykład 2: Pobierz regułę sieci wirtualnej pod MariaDB
```powershell
...
To polecenie pobiera regułę sieci wirtualnej pod MariaDB.
...
### Microsoft. Azure. PowerShell. polecenia. MariaDb. models. Api20180601Preview. IVirtualNetworkRule
