...
## Opis
Polecenie cmdlet **Get-AzSqlInstanceAdvancedDataSecurityPolicy** pobiera zaawansowane zasady zabezpieczeń danych wystąpienia zarządzanego.

## Przykłady

### Przykład 1: Pobiera zaawansowane zabezpieczenia danych wystąpienia zarządzanego
```powershell
...
### Przykład 2: Pobiera zaawansowane zabezpieczenia danych wystąpienia zarządzanego z zasobu zarządzanego wystąpienia
```powershell
