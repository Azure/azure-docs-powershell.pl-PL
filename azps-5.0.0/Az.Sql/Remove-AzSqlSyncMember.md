...
## Opis
Polecenie cmdlet **Remove-AzSqlSyncMember** usuwa członka synchronizacji bazy danych SQL Azure.

## Przykłady

### Przykład 1. Usuń członka synchronizacji
```
...
To polecenie usuwa członka synchronizacji bazy danych SQL Azure o nazwie syncMember01.
...
### -PassThru
Określa, czy zwrócić usunięty element synchronizacji
