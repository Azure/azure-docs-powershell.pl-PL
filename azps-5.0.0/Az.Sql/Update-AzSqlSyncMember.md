...
## Opis
Polecenie cmdlet **Update-AzSqlSyncGroup** modyfikuje właściwości członka synchronizacji bazy danych Azure SQL Database.
...
To polecenie resetuje hasło administratora bazy danych członka.
...
Czy używać linku prywatnego podczas nawiązywania połączenia z tym członkiem synchronizacji.
