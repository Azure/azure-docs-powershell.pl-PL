...
## Opis
Polecenie cmdlet **Remove-AzSqlInstancePool** usuwa pulę wystąpień SQL platformy Azure.

## Przykłady

### Przykład 1: Usuwanie puli wystąpień
```powershell
PS C:\> Remove-AzSqlInstancePool -ResourceGroup resourcegroup01 -Name instancePool0
```

### Przykład 2: Usuwanie puli wystąpień za pomocą identyfikatora zasobu
```powershell
...
### Przykład 3: Usuwanie puli wystąpień przez obiekt puli wystąpień
```powershell
...
To polecenie usuwa pulę wystąpień o nazwie instancePool0.
...
### -Inputobject
Obiekt puli wystąpień do usunięcia.
...
### -ResourceId
Identyfikator zasobu puli wystąpień do usunięcia.
