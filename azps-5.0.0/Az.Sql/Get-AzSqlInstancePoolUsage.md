...
### InstancePoolUsageDefaultParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **Get-AzSqlInstancePoolUsage** zwraca informacje dotyczące użycia puli wystąpień SQL platformy Azure.

## Przykłady

### Przykład 1: Pobiera użycie puli wystąpień SQL Azure
```powershell
...
Pobiera użycie instancepool0 puli wystąpień usługi Azure SQL.

### Przykład 2: Pobiera użycie puli wystąpień SQL platformy Azure przy użyciu obiektu puli wystąpień
```powershell
...
Pobiera użycie puli wystąpień usługi Azure SQL instancepool0 przy użyciu obiektu puli wystąpień.

### Przykład 3: Pobiera użycie puli wystąpień SQL platformy Azure przy użyciu identyfikatora zasobu puli wystąpień
```powershell
...
Pobiera użycie puli wystąpień usługi Azure SQL instancepool0 przy użyciu identyfikatora zasobu puli wystąpień.

### Przykład 3: Pobiera użycie puli wystąpień SQL platformy Azure z podziałem użycia zarządzanych wystąpień w puli.
```powershell
...
Pobiera użycie puli wystąpień usługi Azure SQL instancepool0 wraz z użyciem funkcji zarządzanych wystąpień w instancepool0.
...
### -ExpandChildren
Flaga wskazująca, czy ma być rozwijane użycie tej puli wystąpień wraz z użyciem jej dzieci.
...
### -Name (nazwa)
Nazwa puli wystąpień zarządzanych.
...
### Microsoft. Azure. Commands. SQL. Usages. modele. AzureSqlUsageModel
