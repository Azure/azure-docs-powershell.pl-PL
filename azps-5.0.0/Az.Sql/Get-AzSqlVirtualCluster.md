...
### GetVirtualClusterByResourceGroup (domyślny)
```
...
## Opis
Polecenie cmdlet **Get-AzSqlVirtualCluster** zwraca informacje dotyczące co najmniej jednego wirtualnego klastra usługi Azure SQL.
Określ nazwę klastra wirtualnego, aby wyświetlić informacje dotyczące tylko tego klastra.

## Przykłady

### Przykład 1. pobieranie wszystkich wirtualnych klastrów przydzielonych do grupy zasobów
```powershell
...
To polecenie pobiera informacje o wszystkich klastrach wirtualnych przypisanych do grupy zasobów ResourceGroup01.

### Przykład 2: uzyskiwanie informacji o konkretnym klastrze wirtualnym
```
...
To polecenie pobiera informacje o VirtualCluster1 klastra wirtualnego w ResourceGroup01 grupy zasobów.
