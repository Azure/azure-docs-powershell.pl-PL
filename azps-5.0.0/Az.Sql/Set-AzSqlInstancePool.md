...
### DefaultSetInstancePoolParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **Set-AzSqlInstancePool** modyfikuje właściwości puli wystąpień usługi Azure SQL.
...
To polecenie ustawia typ licencji i/lub znaczniki puli wystąpień o nazwie instancePool0.
...
To polecenie ustawia typ licencji i/lub znaczniki puli wystąpień przy użyciu obiektu puli wystąpień.
