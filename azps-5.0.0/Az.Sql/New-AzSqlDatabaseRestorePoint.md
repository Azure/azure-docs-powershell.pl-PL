...
## Opis
Polecenie cmdlet **New-AzSqlDatabaseRestorePoint** tworzy nowy punkt przywracania, z którego można przywrócić magazyn danych SQL Azure.
To polecenie cmdlet jest obecnie obsługiwane w przypadku hurtowni danych SQL Azure.

## Przykłady

### Przykład 1. Tworzenie punktu przywracania
```
...
To polecenie tworzy punkt przywracania dla hurtowni danych SQL Azure i zwraca szczegóły punktu przywracania.
...
### -RestorePointLabel
Określa etykietę punktu przywracania w celu łatwego identyfikowania.
