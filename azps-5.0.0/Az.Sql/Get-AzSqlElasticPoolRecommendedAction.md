...
## Opis
Polecenie cmdlet **Get-AzSqlElasticPoolRecommendedAction umożliwia pobranie** co najmniej jednej z polecanych akcji dla klasyfikatora Elastic Pool SQL platformy Azure.
