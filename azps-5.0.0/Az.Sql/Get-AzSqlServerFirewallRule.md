...
## Opis
Polecenie cmdlet **Get-AzSqlServerFirewallRule** pobiera reguły zapory dla serwera bazy danych Azure SQL.
...
To polecenie pobiera wszystkie reguły zapory dla serwera o nazwie Server01, rozpoczynając od "reguły".
