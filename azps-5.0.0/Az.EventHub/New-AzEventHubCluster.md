...
## STRESZCZENIe
Tworzy nowy dedykowany klaster eventhub

## POLECENIA

### ClusterPropertiesSet (domyślny)
```
...
## Opis
Polecenie cmdlet New-AzEventHubCluster powoduje utworzenie dedykowanego klastra eventhub w danej grupie zasobów.
...
Umożliwia utworzenie dedykowanego klastra "Eventhub-Cluster-5557" w przystawce Resources "RSG-Cluster27651" z lokalizacją southcentralus i pojemności jako 1

## PARAMETRÓW

### -Pojemność
Pojemność klastra (CU), curerntrly, dozwolona wartość = 1
...
### -Tag
Tagi skrótów przedstawiające znaczniki zasobów dla klastrów
...
### Microsoft. Azure. Commands. EventHub. modele. PSEventHubClusterAttributes
