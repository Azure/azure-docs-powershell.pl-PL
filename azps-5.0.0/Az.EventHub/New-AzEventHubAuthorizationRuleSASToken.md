...
## STRESZCZENIe
Generuje token SAS dla reguły autoryzacji usługi Azure eventhub w obszarze nazw/eventhub. 
...
## Opis
Polecenie cmdlet New-AzEventHubAuthorizationRuleSASToken generuje token dostępu współużytkowanego (SAS) dla usługi Azure Eventhub Namesapce lub Azure Eventhub
...
Generuj token SAS dla danej reguły authorixation dla obszaru nazw z godziną rozpoczęcia i upływem czasu...
...
Generuj token SAS dla danej reguły authorixation dla obszaru nazw z upływem czasu wygaśnięcia.

## PARAMETRÓW

### -AuthorizationRuleId
Identyfikator zasobu ARM reguły Authoraization
...
### Microsoft. Azure. Commands. EventHub. modele. PSSharedAccessSignatureAttributes
