...
### CreateByNameAndEnableAutoScaleParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **New-AzSynapseSparkPool** tworzy pulę platformy Azure Synapse Analytics Spark.
...
To polecenie tworzy pulę platformy Azure Synapse Analytics Spark.
...
To polecenie tworzy pulę usługi Azure Synapse Analytics Spark z włączoną funkcją automatycznej skali.
...
To polecenie tworzy pulę usługi Azure Synapse Analytics Spark za pośrednictwem rurociągu.
...
To polecenie tworzy pulę usługi Azure Synapse Analytics Spark z włączoną funkcją automatycznego skalowania za pomocą potoku.
