...
## Opis
Polecenie cmdlet **New-AzSynapseWorkspace** tworzy obszar roboczy funkcji Azure Synapse Analytics.
...
To polecenie tworzy obszar roboczy analizy Synapse o nazwie ContosoWorkspace, który używa ContosoAdlGenStorage magazynu danych w grupie zasobów o nazwie ContosoResourceGroup.
...
Domyślna nazwa konta ADLS Gen2 Storage.
...
### — Lokalizacja
Obszar platformy Azure, w którym ma zostać utworzony zasób.
...
Nazwa zarządzanej sieci wirtualnej Synapse dla obszaru roboczego usługi Azure Synapse.
...
Poświadczenia administratora SQL.
