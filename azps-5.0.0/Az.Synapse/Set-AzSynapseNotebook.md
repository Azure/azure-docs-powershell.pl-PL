...
## Opis
Polecenie cmdlet **Set-AzSynapseNotebook** umożliwia utworzenie lub zaktualizowanie notesu w obszarze roboczym.
...
To polecenie umożliwia utworzenie lub zaktualizowanie notesu z notesu pliku notesu. ipynb w obszarze roboczym o nazwie ContosoWorkspace.
...
To polecenie umożliwia utworzenie lub zaktualizowanie notesu z notesu pliku notesu. ipynb w obszarze roboczym o nazwie ContosoWorkspace za pośrednictwem rurociągu.
...
To polecenie umożliwia utworzenie lub zaktualizowanie notesu z notesu pliku notesu. ipynb, który dołącza do ContosoSparkPool i używa 2 modułów wykonujących w obszarze roboczym o nazwie ContosoWorkspace.
