...
### ResetByNameParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **Remove-AzSynapseSparkSessionTimeout** resetuje limit czasu sesji usługi Synapse Analytics Spark.
...
To polecenie resetuje limit czasu sesji Synapse analiz Spark z określonym IDENTYFIKATORem livy.
...
To polecenie resetuje limit czasu sesji Synapse Analytics Spark z określonym IDENTYFIKATORem livy za pośrednictwem rurociągu.
