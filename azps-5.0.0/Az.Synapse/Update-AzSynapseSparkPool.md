...
## Opis
Polecenie cmdlet **Update-AzSynapseSparkPool** aktualizuje pulę platformy Azure Synapse Analytics Spark.
...
To polecenie aktualizuje pulę platformy Azure Synapse Analytics Spark.
...
To polecenie aktualizuje pulę usługi Azure Synapse Analytics Spark za pośrednictwem rurociągu.
...
To polecenie aktualizuje pulę usługi Azure Synapse Analytics Spark z IDENTYFIKATORem zasobu.
...
To polecenie umożliwia automatyczną skalowanie puli platformy Azure Synapse Analytics Spark.
...
To polecenie wyłącza automatyczną skalowanie puli platformy Azure Synapse Analytics Spark.
...
To polecenie umożliwia automatyczne wstrzymanie puli platformy Azure Synapse Analytics Spark.
...
To polecenie wyłącza automatyczne wstrzymywanie puli platformy Azure Synapse Analytics Spark.
...
Liczba minut bezczynności. Ten parametr należy określić, gdy funkcja automatycznego wstrzymywania jest włączona.
...
Maksymalna liczba węzłów do przydzielenia w określonej puli platformy Spark.
Ten parametr należy określić, gdy funkcja automatycznego skalowania jest włączona.
...
Minimalna liczba węzłów do przydzielenia w określonej puli platformy Spark.
Ten parametr należy określić, gdy funkcja automatycznego skalowania jest włączona.
...
### -EnableAutoPause
Wskazuje, czy funkcja automatycznego wstrzymywania ma być włączona.
...
### -EnableAutoScale
Wskazuje, czy funkcja automatycznej skali ma być włączona
...
Plik konfiguracji środowiska ("PIP Zablokuj").
...
### -NodeSize
Liczba nośników podstawowych i pamięci, które mają być używane dla węzłów przydzielonych w określonej puli platformy Spark.
Ten parametr należy określić, gdy funkcja automatycznego skalowania jest wyłączona
...
### -SparkVersion
Wersja oprogramowania Apache Spark.
