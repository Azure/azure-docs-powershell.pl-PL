...
## Opis
Polecenie cmdlet **Set-AzHpcCacheStorageTarget** umożliwia zaktualizowanie miejsca docelowego miejsca do magazynowania dołączonego do pamięci podręcznej Azure HPC.
...
### -ResourceGroupName
Nazwa grupy zasobów, pod którą chcesz zaktualizować miejsce docelowe magazynu.
