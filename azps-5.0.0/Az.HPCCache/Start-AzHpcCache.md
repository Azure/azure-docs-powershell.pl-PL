...
## Opis
Polecenie cmdlet **Start-AzHpcCache** uruchamia pamięć podręczną usługi Azure HPC.
...
### -Force
Wskazuje, że polecenie cmdlet nie monituje o potwierdzenie. Domyślnie to polecenie cmdlet monituje o potwierdzenie zamiaru uruchomienia pamięci podręcznej.
...
### -Inputobject
Obiekt pamięci podręcznej, który ma zostać uruchomiony.
...
### -ResourceGroupName
Nazwa grupy zasobów, w której ma zostać rozpoczęta pamięć podręczna.
