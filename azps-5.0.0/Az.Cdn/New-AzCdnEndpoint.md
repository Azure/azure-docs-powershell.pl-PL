...
## Opis
Polecenie cmdlet **New-AzCdnEndpoint** umożliwia utworzenie punktu końcowego sieci dostarczania zawartości Azure (CDN).
...
Liczba sekund między badaniami kondycji.
...
Ścieżka odnosząca się do pochodzenia, która jest używana do określania kondycji pochodzenia.
...
Protokół używany do badania kondycji.
...
Typ żądania badania kondycji, które zostało wykonane.
...
### -OriginId
Identyfikatory grup pochodzenia usługi Azure CDN.
...
### -Priority (priorytet)
Priorytet pochodzenia usługi Azure CDN.
...
Niestandardowa wiadomość, która ma być uwzględniona w żądaniu zatwierdzenia w celu nawiązania połączenia z prywatnym linkiem.
...
### -PrivateLinkLocation
Lokalizacja prywatnego łącza pochodzenia usługi Azure CDN.
...
Identyfikator zasobu prywatnego łącza pochodzenia usługi Azure CDN.
...
### -ProbePath
Określa ścieżkę sondy dla przyspieszania dynamicznego witryny
...
### -Tag
Znaczniki, które mają zostać skojarzone z punktem końcowym usługi Azure CDN.
...
### -Waga
Waga pochodzenia usługi Azure CDN.
