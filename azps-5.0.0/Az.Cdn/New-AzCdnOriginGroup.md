...
## STRESZCZENIe
Tworzy nową grupę pochodzenia sieci CDN
...
## Opis
New-AzCdnOriginGroup utworzy nową grupę źródłową w określonym punkcie końcowym. Jeśli jest to pierwsza grupa źródłowa punktu końcowego, należy również ustawić właściwość DefaultOriginGroup.
...
```
To polecenie cmdlet spowoduje utworzenie nowej grupy źródłowej w określonym punkcie końcowym. Będzie ona używać podanych identyfikatorów pochodzenia jako zestawu źródeł.

## PARAMETRÓW

### -CdnOriginGroup
Obiekt grupy pochodzenie sieci CDN.
