...
## Opis
Remove-AzCdnOrigin usunie początek sieci CDN z danego punktu końcowego. Jeśli pochodzenie jest jedynym źródłem w określonym punkcie końcowym, operacja usunięcia zakończy się niepowodzeniem, ponieważ co najmniej 1 Początek jest wymagane. 
...
```
To polecenie cmdlet spowoduje usunięcie określonego pochodzenia z danego punktu końcowego. 
...
### -ResourceId
Identyfikator zasobu pochodzenia usługi Azure CDN.
