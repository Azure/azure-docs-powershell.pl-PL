...
## Opis
Polecenie cmdlet **Get-AzCognitiveServicesAccount** pobiera konta usług poznawczych w grupie zasobów określonym przez parametr *ResourceGroupName* .
Jeśli nie określisz parametru *ResourceGroupName* , to polecenie cmdlet otrzyma wszystkie konta usług poznawczych dla bieżącego abonamentu.
...
### -Name (nazwa)
Określa nazwę konta usług poznawczych, które ma zostać pozyskane.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, do której przypisano konto usług poznawczych.
