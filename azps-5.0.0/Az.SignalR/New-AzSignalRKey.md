...
### Ponowne generowanie klucza podstawowego
```powershell
...
### -KeyType
Typ klucza: podstawowy lub pomocniczy.
...
### -PassThru
Zwraca wartość PRAWDA, jeśli ponowne generowanie zostało zakończone pomyślnie.
