...
## Opis
Polecenie cmdlet **Start-AzDataFactoryV2IntegrationRuntime** rozpoczyna zarządzane dedykowane środowisko uruchomieniowe integracji. Zasób jest inicjowany i po wykonaniu operacji jest to stan uruchomiony.

## Przykłady

### Przykład 1. Rozpocznij środowisko uruchomieniowe integracji
```
...
To polecenie cmdlet rozpoczyna zarządzane dedykowane środowisko uruchomieniowe integracji o nazwie "Tested-IR".
...
[Zatrzymaj — AzDataFactoryV2IntegrationRuntime]()
