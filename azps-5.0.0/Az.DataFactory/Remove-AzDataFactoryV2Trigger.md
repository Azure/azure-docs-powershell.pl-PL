...
## Opis
Polecenie cmdlet **Remove-AzDataFactoryV2Trigger** usuwa wyzwalacz z fabryki danych. Jeśli parametr _Force_ jest określony, przed usunięciem wyzwalacza nie jest wyświetlany monit cmdlet.

## Przykłady

### Przykład 1: usuwanie wyzwalacza
```
...
Usuwanie wyzwalacza o nazwie "ScheduledTrigger" z fabryki danych "WikiADF".
...
### -Inputobject
Obiekt wyzwalacza do usunięcia.
