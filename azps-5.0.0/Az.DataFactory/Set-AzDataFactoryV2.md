...
## Opis
Polecenie cmdlet **Set-AzDataFactoryV2** tworzy fabrykę danych z określoną nazwą i lokalizacją grupy zasobów.
Wykonuj następujące operacje w następującej kolejności:--Tworzenie fabryki danych.
...
### Przykład 2: Tworzenie fabryki danych przy użyciu szczegółów konfiguracji repozytorium przy użyciu istniejącego obiektu fabryki.
```
...
To polecenie umożliwia utworzenie fabryki danych o nazwie WikiADF w grupie zasobów o nazwie ADF w lokalizacji wschodnioazjatyckiej za pomocą konfiguracji kontroli źródła usługi Azure DevOps.

### Przykład 3: Tworzenie fabryki danych za pomocą szczegółów konfiguracji repozytorium GitHub za pomocą nowego obiektu Factory.
```
...
To polecenie tworzy fabrykę danych o nazwie WikiADF w grupie zasobów o nazwie ADF w lokalizacji wschodnioazjatyckiej z konfiguracją kontroli źródła GitHub.

## PARAMETRÓW

### -AccountName
Nazwa konta dla konfiguracji repozytorium.
...
### -CollaborationBranch
Gałąź współpracy na potrzeby konfiguracji repozytorium.
...
Słownik zawierający parametry globalne fabryki danych.
...
### -HostName
Nazwa hosta na potrzeby konfiguracji repozytorium GitHub.
...
### -LastCommitId
Ostatni identyfikator zatwierdzenia dla konfiguracji repozytorium.
...
### — Lokalizacja
Fabryka danych jest tworzona w tym regionie.
...
### -NazwaProjektu
Nazwa projektu dotycząca konfiguracji usługi Azure DevOps dla repozytorium.
...
### -Repositoryname
Nazwa repozytorium konfiguracji repozytorium.
...
### -ResourceId
Identyfikator zasobu platformy Azure fabryki danych w wersji 2.
...
### -RootFolder
Folder główny dla konfiguracji repozytorium.
...
### -Dzierżawy
Identyfikator dzierżawy dla konfiguracji repozytorium usługi Azure DevOps.
