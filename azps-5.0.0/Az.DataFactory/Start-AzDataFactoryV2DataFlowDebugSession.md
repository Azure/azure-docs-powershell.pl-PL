...
## Opis
To długie uruchomione polecenie rozpoczyna sesję debugowania przepływu danych dla nadchodzących poleceń debugowania. To polecenie może zostać dołączone za pomocą definicji środowiska uruchomieniowego integracji w celu skonfigurowania rozmiaru/typu klastra sesji debugowania.
