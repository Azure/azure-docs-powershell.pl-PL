...
## Opis
Zatwierdzanie połączenia replikacji w woluminie źródłowym
...
To polecenie zatwierdza replikację w witrynie MyAnfVolume.

## PARAMETRÓW

### -AccountName
Nazwa konta ANF woluminu źródłowego replikacji
...
Identyfikator systemu plików docelowego woluminu ochrony danych
...
### -Inputobject
Obiekt woluminu źródłowego ANF do autoryzowanego miejsca docelowego replikacji
...
### -Name (nazwa)
Nazwa woluminu źródłowego replikacji ANF
...
### -PassThru
Zwraca, czy autoryzacja replikacji określonego woluminu została wykonana
...
### -PoolName
Nazwa puli ANF woluminu źródłowego replikacji
...
### -ResourceGroupName
Grupa zasobów woluminu źródłowego replikacji ANF
...
### -ResourceId
Identyfikator zasobu woluminu źródłowego replikacji ANF
