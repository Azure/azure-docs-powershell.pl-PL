...
## Opis
Polecenie cmdlet **Remove-AzAutomationDscNodeConfiguration** usuwa metadane z konfiguracji węzłów konfiguracji stanu żądanego (DSC) w usłudze Azure Automation.
...
Usuwa metadane z konfiguracji węzłów DSC w automatyzacji. (autogenerowana)
...
Określa nazwę konta usługi Automation, które zawiera konfiguracje węzła DSC, dla których to polecenie cmdlet usuwa metadane.
...
### -IgnoreNodeMappings
Wskazuje, że ten aplet polecenia ignoruje mapowania węzłów.
...
### -Name (nazwa)
Określa nazwę konfiguracji węzła DSC, dla której to polecenie cmdlet usuwa metadane.
...
To polecenie cmdlet usuwa metadane konfiguracji węzłów DSC w grupie zasobów, którą ten parametr określa.
...
[Polecenia cmdlet usługi Azure Automation](/powershell/module/Az.Automation/)
