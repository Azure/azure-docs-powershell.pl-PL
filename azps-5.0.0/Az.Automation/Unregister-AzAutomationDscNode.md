...
## Opis
Polecenie cmdlet **Unregister-AzAutomationDscNode** umożliwia usunięcie węzła konfiguracji stanu żądanego (DSC) od zarządzania przez konto usługi Azure Automation.

## Przykłady

### Przykład 1: Usuwanie węzła usługi Azure DSC z zarządzania przez konto usługi Automation
```
...
To polecenie umożliwia usunięcie węzła DSC o określonym identyfikatorze GUID z zarządzania przez konto usługi Automation o nazwie Contoso17.

## PARAMETRÓW

### -AutomationAccountName
Określa nazwę konta automatyzacji, na podstawie którego to polecenie cmdlet usuwa węzeł DSC.
...
### -ID
Określa unikatowy identyfikator węzła DSC, który jest usuwany przez to polecenie cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, w której ten polecenie cmdlet wyrejestrowuje węzeł DSC.
