...
Aktualizowanie klastra za pomocą właściwości magazynu kluczy i jednostki SKU
...
### -KeyVaultUri
Identyfikator URI magazynu kluczy, "Wyczyść ochronę" i "usuwanie nietrwałe" trzeba włączyć dla tego magazynu kluczy
...
### -SkuName
Nazwa SKU, teraz może być tylko "CapacityReservation"
