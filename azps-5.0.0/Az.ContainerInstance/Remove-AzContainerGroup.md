...
## STRESZCZENIe
Usuwa grupę kontenerów.

## POLECENIA

### RemoveContainerGroupByResourceGroupAndNameParamSet (domyślny)
```
...
## Opis
Polecenie cmdlet **Remove-AzContainerGroup** usuwa grupę kontenerów.

## Przykłady

### Przykład 1. usuwa grupę kontenerów
```
PS C:\> Remove-AzContainerGroup -ResourceGroupName MyResourceGroup -Name MyContainer
```

To polecenie umożliwia usunięcie określonej grupy kontenerów.

### Przykład 2: Usunięcie grupy kontenerów według połączeń rurowych
```
PS C:\> Get-AzContainerGroup -ResourceGroupName MyResourceGroup -Name MyContainer | Remove-AzContainerGroup
```

To polecenie usuwa grupę kontenerów według połączeń rurowych.

### Przykład 3: usuwa grupę kontenerów według identyfikatora zasobu.
```
PS C:\> Find-AzResource -ResourceGroupEquals MyResourceGroup -ResourceNameEquals MyContainer | Remove-AzContainerGroup
```

To polecenie usuwa grupę kontenerów według identyfikatora zasobu.
