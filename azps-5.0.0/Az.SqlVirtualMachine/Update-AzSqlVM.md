...
## Opis
Polecenie cmdlet Update-AzSqlVM umożliwia zaktualizowanie maszyny wirtualnej SQL.
...
Aktualizuje znaczniki maszyny wirtualnej SQL.

### Przykład 2

Umożliwia zaktualizowanie maszyny wirtualnej SQL. (autogenerowana)
