...
## STRESZCZENIe
Umożliwia utworzenie lub zaktualizowanie typu oceny zabezpieczeń.
...
## Opis
Służy do tworzenia lub aktualizowania metadanych oceny zabezpieczeń, których można użyć w celu utworzenia różnych właściwości oceny i zarządzania nimi.
Po wykonaniu tej akcji możesz raportować wyniki oceny dowolnego zasobu w tej subskrypcji.
...
### — Opis
Szczegółowy ciąg, który pomoże użytkownikom zrozumieć znaczenie tej oceny i sposobu jej obliczania.
...
### -DisplayName
Odczytany przez człowieka tytuł tego obiektu.
...
Szczegółowy ciąg, który pomoże użytkownikom zrozumieć różne sposoby łagodzenia i rozwiązywania problemu z zabezpieczeniami.
...
### — Ważność
Wskazuje ważność ryzyka związanego z zabezpieczeniami, jeśli Szacowanie jest niezdrowe.
