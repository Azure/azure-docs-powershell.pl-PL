...
## Opis
Polecenie cmdlet New-AzDeviceSecurityGroupThresholdCustomAlertRuleObject tworzy nową listę niestandardowych reguł alertów dla grupy zabezpieczeń urządzenia w rozwiązaniu bezpieczeństwa IoT.
...
Utwórz nową regułę alertu niestandardowego progu z typu "SomeRuleType" z włączonym stanem wartości ANT dla progu minimalnego i maksymalnego
