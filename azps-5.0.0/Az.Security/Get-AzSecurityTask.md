...
## Opis
Usługa Azure Security Center umożliwia skanowanie zasobów w celu wykrywania potencjalnych problemów z zabezpieczeniami.
To polecenie cmdlet umożliwia odnajdowanie zadań związanych z zabezpieczeniami, które program Azure Security Center poleca.
...
Pobiera wszystkie zadania związane z zabezpieczeniami, które zostały wykryte dla zasobów w ramach abonamentu.
...
Pobiera wszystkie zadania związane z zabezpieczeniami, które zostały wykryte dla zasobów w grupie zasobów.
...
Pobiera określone zadanie zabezpieczeń.
