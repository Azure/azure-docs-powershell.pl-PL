...
## Opis
Polecenie cmdlet Set-AzDeviceSecurityGroup służy do tworzenia lub aktualizowania grupy zabezpieczeń urządzenia zdefiniowanej w rozwiązaniu zabezpieczeń IoT.
...
Aktualizowanie istniejącej grupy zabezpieczeń urządzenia z Centrum IoT "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub" z typem reguły "ActiveConnectionsNotInAllowedRange"

## PARAMETRÓW

### -AllowlistRule
Zezwalanie na reguły list.
