...
## Opis
Polecenie cmdlet **Wyrejestrowanie — AzRecoveryServicesBackupContainer** wyrejestruje system Windows Server lub inny kontener kopii zapasowych z magazynu.
...
Wyrejestrowuje serwer z systemem Windows lub inny kontener z magazynu. (autogenerowana)
...
Aby uzyskać obiekt **BackupContainer** , użyj polecenia cmdlet Get-AzRecoveryServicesBackupContainer.
