...
Trzecie polecenie pobiera kontenery kopii zapasowych AzureWorkload i przechowuje je w zmiennej $Container.
Czwarte polecenie pobiera element kopii zapasowej, a następnie udostępnia go w potoku polecenia cmdlet jako obiekt kopii zapasowej.
...
To polecenie zawiera listę punktów początkowych i końcowych nieprzerwanego łańcucha dziennika danego elementu kopii zapasowej. (autogenerowana)
