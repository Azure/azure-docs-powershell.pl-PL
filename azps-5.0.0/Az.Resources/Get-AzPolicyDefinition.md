...
## Opis
Polecenie cmdlet **Get-AzPolicyDefinition** Pobiera kolekcję definicji zasad lub określoną definicję zasady zidentyfikowaną według nazwy lub identyfikatora.
...
### Przykład 2: pobieranie definicji zasad z bieżącego abonamentu według nazwy
```
...
To polecenie pobiera wszystkie definicje zasad z kategorii "maszyna wirtualna".
...
### -Wbudowane
Ograniczanie listy wyników tylko do wbudowanych definicji zasad.
