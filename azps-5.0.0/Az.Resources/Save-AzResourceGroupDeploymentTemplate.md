...
## Opis
Polecenie cmdlet **Save-AzResourceGroupDeploymentTemplate**  umożliwia zapisanie szablonu rozmieszczania grup zasobów w pliku JSON.
...
Zapisuje szablon rozmieszczania grup zasobów do pliku. (autogenerowana)
