...
# AZ. LogicApp, moduł
## Opis
W tym temacie są wyświetlane tematy pomocy dotyczące poleceń cmdlet aplikacji logicznych.

## AZ. LogicApp polecenia cmdlet
### [Get-AzIntegrationAccount](Get-AzIntegrationAccount.md)
Pobiera konta integracji.
...
Pobiera historię przebiegu aplikacji logicznej.

### [Get-AzLogicAppTrigger](Get-AzLogicAppTrigger.md)
Pobiera wyzwalacze aplikacji logicznej.

### [Get-AzLogicAppTriggerCallbackUrl](Get-AzLogicAppTriggerCallbackUrl.md)
Pobiera adres URL wywołania zwrotnego wyzwalacza aplikacji logicznej.

### [Get-AzLogicAppTriggerHistory](Get-AzLogicAppTriggerHistory.md)
Pobiera historię wyzwalaczy w aplikacji logicznej.

### [Get-AzLogicAppUpgradedDefinition](Get-AzLogicAppUpgradedDefinition.md)
Pobiera uaktualnioną definicję dla aplikacji logicznej.

### [Nowe — AzIntegrationAccount](New-AzIntegrationAccount.md)
Tworzy konto integracji.

### [Nowe — AzIntegrationAccountAgreement](New-AzIntegrationAccountAgreement.md)
Umożliwia utworzenie umowy dotyczącej konta integracji.

### [Nowe — AzIntegrationAccountAssembly](New-AzIntegrationAccountAssembly.md)
Tworzy zestaw kont integracyjnych.

### [Nowe — AzIntegrationAccountBatchConfiguration](New-AzIntegrationAccountBatchConfiguration.md)
Umożliwia utworzenie konfiguracji partii konta integracji.
...
Umożliwia utworzenie mapy konta integracji.
...
Umożliwia usunięcie zestawu konta integracyjnego.
...
Usuwa certyfikat konta integracyjnego z grupy zasobów.
...
Umożliwia usunięcie schematu konta integracji.
...
Modyfikuje zestaw kont integracyjnych.
...
Modyfikuje mapę konta integracji.

### [Set-AzIntegrationAccountPartner](Set-AzIntegrationAccountPartner.md)
Modyfikuje partnera kont integracji.
...
Modyfikuje aplikację logiczną w grupie zasobów.

### [Start — AzLogicApp](Start-AzLogicApp.md)
Uruchamia aplikację logiczną w grupie zasobów.

### [Zatrzymaj — AzLogicAppRun](Stop-AzLogicAppRun.md)
