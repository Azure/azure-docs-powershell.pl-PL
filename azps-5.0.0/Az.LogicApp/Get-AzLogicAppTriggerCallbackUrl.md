...
## Opis
Polecenie cmdlet **Get-AzLogicAppTriggerCallbackUrl** Pobiera adres URL wywołania zwrotnego wyzwalacza aplikacji z grupy zasobów.
To polecenie cmdlet zwraca obiekt **WorkflowTriggerCallbackUrl** reprezentujący adres URL wywołania zwrotnego.
Określ nazwę grupy zasobów, nazwę aplikacji logicznej i nazwę wyzwalacza.
...
### Przykład 1: Uzyskaj adres URL wywołania zwrotnego wyzwalacza aplikacji logicznej
```
...
To polecenie pobiera adres URL wywołania zwrotnego wyzwalacza aplikacji logicznej.
...
### Microsoft. Azure. Management. Logic. MODELES. WorkflowTriggerCallbackUrl
