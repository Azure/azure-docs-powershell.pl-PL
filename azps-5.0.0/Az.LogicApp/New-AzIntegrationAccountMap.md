...
## Opis
Polecenie cmdlet **New-AzIntegrationAccountMap** umożliwia utworzenie mapy konta integracji.
To polecenie cmdlet zwraca obiekt reprezentujący mapę konta integracji.
Określanie nazwy konta integracji, nazwy grupy zasobów, nazwy mapy i definicji mapy.
...
### Przykład 1. Tworzenie mapy konta integracji
```powershell
...
To polecenie powoduje utworzenie mapy konta integracji w określonej grupie zasobów.
Polecenie Określa definicję mapy przechowywaną w zmiennej $MapContent za pomocą poprzedniego polecenia.

### Przykład 2

Umożliwia utworzenie mapy konta integracji. (autogenerowana)
...
### -Type
Określa typ zawartości mapy konta integracji.
...
### -MapDefinition
Określa obiekt definicji dla mapy kont integracji.
Określ ten parametr lub parametr *MapFilePath* .
...
### -MapFilePath
Określa ścieżkę pliku definicji mapy konta integracji. Określ ten parametr lub parametr *MapDefinition* .
...
### -MapType
Umożliwia określenie typu mapy konta integracji.
To polecenie cmdlet obsługuje język XSLT jako typ mapy.
...
### -Metadata
Określa obiekt metadanych mapy.
...
### -Name (nazwa)
Określa nazwę konta integracyjnego.
