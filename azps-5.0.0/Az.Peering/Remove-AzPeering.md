...
## Opis
Perminently usunąć zasób równorzędny.
...
Usuwanie komunikacji równorzędnej według identyfikatora zasobu.
...
### -Inputobject
Użyj Get-AzPeering, aby pobrać ten obiekt.
...
### -PassThru
Zwraca wartość PRAWDA, jeśli została ukończona
