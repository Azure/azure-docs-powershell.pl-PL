...
### Uzyskiwanie komunikacji równorzędnej i tworzenie zarejestrowanego prefiksu
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredPrefix -Name $asnName -Asn $asn
```

Pobierz komunikację z innymi użytkownikami, w przypadku których chcesz dodać zarejestrowany prefiks. Następnie Przekaż to unifiedgroup.
...
### Microsoft. Azure. PowerShell. cmdlet. peer. MODELES. PSPeeringRegisteredPrefix
