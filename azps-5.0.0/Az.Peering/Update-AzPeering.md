...
### Aktualizuj UseForPeeringService
```powershell
...
Ustawia flagę "Użyj dla usługi peer"
...
Ustawia adres IPv4 dla komunikacji równorzędnej programu Exchange przy użyciu ResourceId
...
### -DirectConnection
Tworzenie nowych połączeń bezpośrednich przy użyciu New-AzDirectPeeringConnectionObject i potoku do tego polecenia.
...
### -ExchangeConnection
Utwórz nowe połączenie programu Exchange przy użyciu New-AzExchangePeeringConnectionObject i potoku do tego polecenia.
