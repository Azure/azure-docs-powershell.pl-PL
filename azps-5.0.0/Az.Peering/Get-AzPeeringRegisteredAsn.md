...
## Opis
Uzyskaj lub wystaw zarejestrowany ASN.

## Przykłady

### Lista zarejestrowanych WPW dla komunikacji równorzędnej
```powershell
PS C:\> Get-AzPeeringRegisteredAsn -ResourceGroupName $resourceGroupName -PeeringName $peeringName
```

Lista zarejestrowanych ASN.

### Pobiera zarejestrowany ASN na potrzeby komunikacji równorzędnej według nazwy
```powershell
PS C:\> Get-AzPeeringRegisteredAsn -ResourceGroupName $resourceGroupName -PeeringName $peeringName -Name $registeredAsnName
```

Pobiera zarejestrowany ASN równorzędny.
...
### -Name (nazwa)
Nazwa zarejestrowanego konta ASN
