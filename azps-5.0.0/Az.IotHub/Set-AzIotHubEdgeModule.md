...
## Opis
Umożliwia zastosowanie zawartości konfiguracji dostarczonych modułów do określonego urządzenia brzegowego.
Uwaga: po wykonaniu polecenia polecenie przeprowadzi zbieranie modułów zastosowanych do urządzenia.
...
Testowanie modułów brzegowych podczas opracowywania przez ustawienie modułów na urządzeniu docelowym.
...
### -DeviceId
Identyfikator urządzenia w celu krawędzi docelowej.
...
### -ModulesContent
Zawartość konfiguracji modułów na urządzeniach IoT Edge.
