...
## Opis
Wywołaj metodę bezpośrednią na urządzeniu. https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methodsAby uzyskać więcej informacji, zobacz.
...
### -Name (nazwa)
Nazwa metody do wywołania na tym urządzeniu.
...
### -Ładunek
Ładunek metody wywoływania na tym urządzeniu.
