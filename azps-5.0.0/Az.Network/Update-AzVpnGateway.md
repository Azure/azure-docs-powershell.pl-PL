...
## Opis
Polecenie cmdlet **Update-AzVpnGateway** umożliwia zaktualizowanie skalowalnej bramy sieci VPN.  
Brama sieci VPN platformy Azure to zdefiniowana w oprogramowaniu łączność z połączeniami z witrynami w VirtualHub. Ta brama zmienia rozmiar i skaluje się na podstawie jednostki skali określonej przez użytkownika. Połączenie można skonfigurować z poziomu gałęzi/witryny nazywanej witryną sieci VPN dla bramy skalowalnej. Każde połączenie składa się z 2 Active-Active tuneli
...
Po utworzeniu bramy używa Update-AzVpnGateway, aby uaktualnić bramę do 3 jednostek skali.
...
Po utworzeniu bramy Użyj Set-AzVpnGateway, aby zaktualizować BgpPeeringAddress.
...
### -BgpPeeringAddress
Adresy równorzędne BGP dla tego VpnGateway bgpsettings.
...
### -Inputobject
Obiekt bramy sieci VPN do zmodyfikowania
...
### -ResourceId
Identyfikator zasobu platformy Azure VpnGateway, który ma zostać zmodyfikowany.
...
### -VpnConnection
Lista VpnConnections, które ta VpnGateway musi posiadać.
...
### -VpnGatewayScaleUnit
Jednostka skali dla tego VpnGateway.
