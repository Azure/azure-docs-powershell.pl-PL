...
### -FilterData
Opcje filtrowania dotyczące uruchamiania funkcji przechwytywania pakietów w połączeniu VPN.
...
### -Name (nazwa)
Nazwa połączenia z siecią VPN, w którym przechwytywanie pakietów jest uruchamiane.
...
[Zatrzymaj — AzVpnConnectionPacketCapture](./Stop-AzVpnConnectionPacketCapture.md)