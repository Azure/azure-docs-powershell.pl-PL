...
## Opis
Zatrzymuje operację przechwytywania pakietów w połączeniu bramy sieci wirtualnej i przekazuje wynik w podanym SasUrlie magazynu.
...
### -Name (nazwa)
Nazwa połączenia bramy sieci wirtualnej, w której ma zostać uruchomione przechwytywanie pakietów.
...
### -SasUrl
Adres URL SAS na potrzeby funkcji przechwytywania pakietów w bramie sieci wirtualnej.
