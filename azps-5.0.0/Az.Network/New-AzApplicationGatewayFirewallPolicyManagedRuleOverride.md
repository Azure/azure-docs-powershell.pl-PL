...
## Opis
**Nowy — AzApplicationGatewayFirewallPolicyManagedRuleOverride** tworzy wpis ruleOverride.
...
Tworzy wpis ruleOverride z RuleId jako $ruleId i stan jako wyłączony.
...
### -RuleId
Określ RuleId w polu reguła zastąpienia.
