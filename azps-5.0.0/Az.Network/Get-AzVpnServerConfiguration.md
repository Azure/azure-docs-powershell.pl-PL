...
## Opis
Polecenie cmdlet **Get-AzVpnServerConfiguration** zwraca istniejące VpnServerConfiguration na potrzeby połączenia z witryną.
...
Powyższe polecenie otrzyma istniejące VpnServerConfiguration.
