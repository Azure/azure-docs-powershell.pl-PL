...
## Opis
Polecenie cmdlet New-AzRouteFilterRuleConfig powoduje utworzenie reguły filtru tras dla filtru tras platformy Azure.
...
Polecenie tworzy nową regułę filtru tras i zapisuje ją w zmiennej $rule 1.
