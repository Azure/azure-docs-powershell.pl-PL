...
## Opis
Polecenie cmdlet New-AzRadiusServer powoduje utworzenie zewnętrznej konfiguracji serwera RADIUS, która będzie używana w konfiguracji bramy sieci wirtualnej i serwera sieci VPN.
...
Tworzenie wielu zewnętrznych konfiguracji serwera RADIUS, które będą używane do konfigurowania P2S w nowej bramie sieci wirtualnej.
...
### -RadiusServerAddress
Adres zewnętrznego serwera RADIUS
...
### -RadiusServerScore
Wynik zewnętrznego serwera RADIUS
...
### -RadiusServerSecret
Klucz tajny zewnętrznego serwera RADIUS
