...
## Opis
Polecenie cmdlet **Set-AzApplicationGatewayRewriteRuleSet** modyfikuje regułę rozsyłania żądań.
...
Drugie polecenie modyfikuje zestaw reguł ponownej edycji dla bramy aplikacji, aby używać reguł dotyczących ponownej pisania określonych w zmiennej $rule.
