...
## Opis
Polecenie cmdlet **New-AzApplicationGatewayRewriteRuleActionSet** umożliwia utworzenie akcji reguły ponownego zapisu dla bramy aplikacji platformy Azure.
...
To polecenie umożliwia utworzenie ustawionej akcji przepisywania i zapisanie wyniku w zmiennej o nazwie $action.
