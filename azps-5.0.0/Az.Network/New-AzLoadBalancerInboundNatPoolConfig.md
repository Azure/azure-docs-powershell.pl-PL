...
## Opis
Polecenie cmdlet **New-AzLoadBalancerInboundNatPoolConfig** umożliwia utworzenie konfiguracji puli adresów NAT dla ruchu przychodzącego dla modułu równoważenia obciążenia.
...
### -EnableFloatingIP
Umożliwia skonfigurowanie punktu końcowego maszyny wirtualnej dla przestawnego adresu IP wymaganego do skonfigurowania grupy dostępności funkcji SQL AlwaysOn. To ustawienie jest wymagane w przypadku używania grup dostępności funkcji SQL AlwaysOn w programie SQL Server. Tego ustawienia nie można zmienić po utworzeniu punktu końcowego.
...
Limit czasu bezczynności połączenia TCP. Wartość może być ustawiona między 4 a 30 minut. Wartość domyślna to 4 minuty. Ten element jest wykorzystywany tylko wtedy, gdy protokół jest ustawiony na protokół TCP.
