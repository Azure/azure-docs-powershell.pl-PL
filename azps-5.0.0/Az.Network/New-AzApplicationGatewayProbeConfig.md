...
### Przykład 1: example1: Tworzenie badania kondycji
```powershell
...
Umożliwia utworzenie badania dotyczącego kondycji. (autogenerowana)
...
### -Port
Określa port służący do obsługi serwerów zaplecza sondowania.
