...
Połączenie VPN tworzy połączenie IPsec, które łączy bramę VPN z zdalną gałęzią klienta reprezentowaną na platformie Azure jako witryną sieci VPN.
...
Po zaktualizowaniu połączenie będzie miało nowe IpSecPolicy za pomocą polecenia Set-AzVpnConnection.
...
### -ResourceId
Identyfikator zasobu obiektu VpnConnection, który ma zostać usunięty.
...
Lista VpnSiteLinkConnections, które ta VpnConnection musi posiadać.
