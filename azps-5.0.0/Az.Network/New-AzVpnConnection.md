...
### ByVpnGatewayNameByVpnSiteObject (domyślny)
```
...
Powyższego poziomu spowoduje utworzenie grupy zasobów, wirtualnej sieci WAN, sieci wirtualnej, wirtualnego centrum i VpnSite z 1 VpnSiteLinks na zachodnim terenie Stanów Zjednoczonych w obszarze "testRG" w grupie zasobów platformy Azure.
Brama sieci VPN zostanie utworzona później w koncentratorze wirtualnym.
Po utworzeniu bramy jest ona połączona z VpnSite za pomocą polecenia New-AzVpnConnection z 1 VpnSiteLinkConnections na VpnSiteLink VpnSite.
...
Przepustowość, która musi być obsługiwana przez to połączenie w MB/s.
...
Włączanie zabezpieczeń internetowych dla tego połączenia
...
Gdy jest inicjowane połączenie, Użyj lokalnego adresu IP platformy Azure jako adresu źródłowego.
...
Użyj selektorów ruchu opartego na zasadach dla tego połączenia.
...
Protokół połączeń z bramą: IKEv1/IKEv2
...
### -VpnSite
Zdalna witryna sieci VPN, do której jest podłączone połączenie z siecią wirtualną tego centrum.
...
Lista VpnSiteLinkConnections, które posiada ta VpnConnection.
