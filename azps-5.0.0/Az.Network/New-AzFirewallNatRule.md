...
## Opis
Polecenie cmdlet **New-AzFirewallNatRule** umożliwia utworzenie reguły NAT dla zapory platformy Azure.

## Przykłady

### Przykład 1: Utwórz regułę DNAT całego ruchu TCP z 10.0.0.0/24 na 10.1.2.3 docelowy: 80 do lokalizacji docelowej 10.4.5.6:8080
```powershell
