...
## STRESZCZENIe
Tworzy konfigurację linku prywatnego dla bramy aplikacji.
...
## Opis
Polecenie cmdlet **New-AzApplicationGatewayPrivateLinkConfiguration** tworzy konfigurację PrivateLink dla bramy aplikacji platformy Azure.
Aby można było włączyć funkcję linków prywatnych, konfiguracja prywatnego linku musi być skojarzona z konfiguracją adresu IP frontonu.
Jedna prywatna konfiguracja linku może atmost być skojarzona tylko z jednej konfiguracji adresu IP frontonu w bramie Application Gateway.

## Przykłady

### Przykład 1. Tworzenie prywatnej konfiguracji linku przy użyciu jednej konfiguracji IP
```powershell
...
To polecenie tworzy konfigurację PrivateLink o nazwie "privateLinkConfig01" i zapisuje wynik w zmiennej o nazwie $PrivateLinkConfiguration.

### Przykład 2: Tworzenie prywatnej konfiguracji linku z wieloma konfiguracjami protokołu IP
```powershell
...
To polecenie tworzy konfigurację PrivateLink o nazwie "privateLinkConfig01" z dwoma elementami Ipconfiguration i zapisuje wynik w zmiennej o nazwie $PrivateLinkConfiguration. 
...
Lista elementu ipConfiguration
...
[Dodaj-AzApplicationGatewayPrivateLinkConfiguration](./Add-AzApplicationGatewayPrivateLinkConfiguration.md)
