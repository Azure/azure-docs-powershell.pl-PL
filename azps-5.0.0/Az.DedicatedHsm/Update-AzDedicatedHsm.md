...
### Przykład 1: Aktualizowanie znacznika parametru dedykowanego modułu HSM według nazwy
```powershell
...
To polecenie aktualizuje tag parametru dedykowanego modułu HSM według nazwy

### Przykład 2: zaktualizowanie znacznika parametru dedykowanego modułu HSM według obiektu
```powershell
...
To polecenie aktualizuje tag parametru dedykowanego modułu HSM według obiektu
