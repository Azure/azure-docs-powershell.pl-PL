...
```
Kwerenda zawierająca wszystkie maszyny wirtualne, które nie używają zarządzanych dysków i obejmuje imiona i nazwiska wyświetlania subskrypcji.
...
```
Kwerenda wyświetlająca liczbę zasobów według dzierżaw i nazw wyświetlanych w abonamentach.
