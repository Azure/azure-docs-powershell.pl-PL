...
### Przykład 1: Usuwanie magazynu konfiguracji aplikacji
```powershell
PS C:\> Remove-AzAppConfigurationStore -Name appconfig-test03 -ResourceGroupName lucas-manual-test

```

To polecenie umożliwia usunięcie magazynu konfiguracji aplikacji.

### Przykład 2: Usuwanie magazynu konfiguracji aplikacji
```powershell
