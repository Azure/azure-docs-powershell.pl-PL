...
### Przykład 1: testowanie dostępności nazwy magazynu konfiguracji aplikacji
...
To polecenie sprawdza dostępność nazwy magazynu konfiguracji aplikacji.
...
### -Name (nazwa)
Nazwa służąca do sprawdzania dostępności.
...
### Microsoft. Azure. PowerShell. polecenia. AppConfiguration. models. Api20200601. INameAvailabilityStatus
