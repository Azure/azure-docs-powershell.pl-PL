...
### Przykład 1: wyświetlanie wszystkich kluczy sklepu w magazynie konfiguracji aplikacji
```powershell
...
To polecenie zawiera listę wszystkich kluczy sklepu w magazynie konfiguracji aplikacji.
