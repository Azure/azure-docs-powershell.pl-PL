...
## Opis
Usuń rozszerzenie maszyny wirtualnej z typu węzła według nazwy. W celu wyświetlenia bieżącego rozszerzenia typu węzła użyj [Get-AzServiceFabricManagedNodeType](./Get-AzServiceFabricManagedNodeType.md) i sprawdź, czy właściwość VmExtensions jest obecne.
...
Usuwanie rozszerzenia z typu węzła według nazwy.
...
Usuwanie rozszerzenia z typu węzła według nazwy z potokiem.
