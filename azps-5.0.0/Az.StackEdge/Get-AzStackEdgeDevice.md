...
## Opis
Polecenie cmdlet **Get-AzStackEdgeDevice** pobiera informacje na temat dostępnych urządzeń brzegowych. Możesz określić nazwę urządzenia wraz z nazwą grupy zasobów, aby uzyskać informacje na określonym urządzeniu. 
...
### -Alert
Pobieranie alertów na urządzeniu z krawędzią/bramą stosu
...
### -ExtendedInfo
Pobiera dodatkowe informacje dla określonego urządzenia bramy z krawędzią/stosem.
...
### -NetworkSetting
Pobiera ustawienia sieciowe określonego urządzenia bramy z krawędzią/stosem.
...
### -UpdateSummary
Pobiera informacje o dostępności aktualizacji w oparciu o ostatnie skanowanie urządzenia. Pobiera również informacje o wszystkich trwających zadaniach pobierania lub instalowania na urządzeniu.
