...
### -AppServicePlan
Nazwa planu usługi App Service lub identyfikator planu usługi App Service. Jeśli plan i usługa App Service nie znajdują się w różnych grupach zasobów, użyj identyfikatora zamiast nazwy. Identyfikator planu usługi App Service można pobrać, używając: $asp = Get-AzAppServicePlan-resourceName myRG-Name MyWebapp $asp. ID zwraca identyfikator planu usługi App Service.
