...
## Opis
Tworzy obiekt reprezentujący ścieżkę usługi Azure Storage, która będzie instalowana w aplikacji sieci Web.
...
### -AccessKey
Klucz dostępu do konta usługi Azure Storage
...
Na przykład: myfilestorageaccount.file.core.windows.net
...
### -MountPath
Ścieżka w kontenerze, w którym zostanie uwidoczniony udział określony przez nazwa_udziału.
...
### -Name (nazwa)
Identyfikator właściwości magazynu platformy Azure.
Musi być unikatowa w aplikacji sieci Web lub gnieździe
...
### -Nazwa_udziału
Nazwa udziału do zainstalowania w kontenerze
...
### -Type
Typ konta usługi Azure Storage.
Kontenery systemu Windows obsługują tylko pliki platformy Azure
...
### Microsoft. Azure. Commands. webapps. modele. WebAppAzureStoragePath
