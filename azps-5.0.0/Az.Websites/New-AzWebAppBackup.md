...
## Opis
Polecenie cmdlet **New-AzWebAppBackup** tworzy kopię zapasową aplikacji Azure Web App.
...
Tworzy kopię zapasową określonego ContosoWebApp aplikacji, który znajduje się w obszarze domyślne grupy zasobów — w sieci Web — zachód. https://storageaccount.file.core.windows.net

### Przykład 2

Polecenie cmdlet New-AzWebAppBackup tworzy kopię zapasową aplikacji Azure Web App. (autogenerowana)
