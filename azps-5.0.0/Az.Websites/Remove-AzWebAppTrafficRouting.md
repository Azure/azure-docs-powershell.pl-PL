...
## Opis
Polecenie cmdlet **Remove-AzWebAppTrafficRouting** usuwa regułę routingu z miejsca w aplikacji Azure Web App.

## Przykłady

### Przykład 1 usuwa określoną regułę routingu z gniazda aplikacji
```powershell
PS C:\> Remove-AzWebAppTrafficRouting -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite"  -RuleName 'Stg'
```

To polecenie usuwa regułę routingu dla danego gniazda aplikacji.
