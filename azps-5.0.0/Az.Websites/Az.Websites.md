...
Dodawanie reguły routingu do gniazda.
...
Pobiera konfigurację restiction programu Access dla aplikacji sieci Web platformy Azure.
...
Get-AzWebAppContainerContinuousDeploymentUrl zwróci adres URL wdrożenia ciągłego kontenera
...
Pobierz regułę routingu dla danej nazwy miejsca.
...
### [Nowe — AzWebAppAzureStoragePath](New-AzWebAppAzureStoragePath.md)
Tworzy obiekt reprezentujący ścieżkę usługi Azure Storage, która będzie instalowana w aplikacji sieci Web. Jest ona przeznaczona do Set-AzWebApp i Set-AzWebAppSlot za pomocą parametru (-AzureStoragePath).

### [Nowe — AzWebAppBackup](New-AzWebAppBackup.md)


### [Nowe — AzWebAppContainerPSSession](New-AzWebAppContainerPSSession.md)
...
### [Publikowanie — AzWebApp](Publish-AzWebApp.md)
...
Usuwanie reguły routingu z gniazda.
