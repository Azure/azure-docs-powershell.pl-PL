...
### Usuwanie istniejącego klastra zarządzanego Kubernetes
```powershell
...
### -Force
Usuwanie zarządzanego klastra Kubernetes bez monitowania
...
### -PassThru
Zwraca wartość PRAWDA, Jeśli usunięcie powiodło się.
