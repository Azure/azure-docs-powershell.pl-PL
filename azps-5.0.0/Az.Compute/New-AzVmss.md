...
### -HostGroupId
Określa dedykowaną grupę hostów, w której znajduje się zestaw Skala maszyny wirtualnej.
...
### -Priority (priorytet)
Priorytet maszyny wirtualnej w zestawie skali.  Obsługiwane są tylko wartości "Regular", "spot" i "Low".
