...
## Opis
Polecenie cmdlet **Set-AzVM** oznacza maszynę wirtualną jako uogólnioną.
...
### -Ponownie Zastosuj
Ponowne zastosowanie maszyny wirtualnej.
...
### -SimulateEviction
Wskazuje, że to polecenie cmdlet symuluje wykluczenie dostosowanej maszyny wirtualnej.
