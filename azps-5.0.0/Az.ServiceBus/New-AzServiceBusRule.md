...
## Opis
Polecenie cmdlet **New-AzServiceBusRule** tworzy nową regułę dla danej subskrypcji.
...
Polecenie cmdlet New-AzServiceBusRule tworzy nową regułę dla określonej subskrypcji.
...
Polecenie cmdlet New-AzServiceBusRule tworzy nową regułę dla określonego abonamentu z ActionFilter.

## PARAMETRÓW

### -ActionSqlExpression
Wyrażenie akcji sqlfilter
...
Akcja wymaga wstępnego przetwarzania
