...
## Opis
Polecenie cmdlet **Get-AzServiceBusKey** zwraca podstawowe i pomocnicze ciągi połączeń dla danego obszaru nazw lub kolejki lub tematu albo aliasu (GeoDR konfiguracje).
