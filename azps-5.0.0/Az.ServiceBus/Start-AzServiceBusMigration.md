...
## Opis
Polecenie cmdlet **Start-AzServiceBusMigration** tworzy nową konfigurację migracji i rozpoczyna migrację jednostek z obszarów nazw standardowych do Premium
...
Tworzy nową konfigurację migracji dla "TestingNamespaceStandardMigration" do obszarów nazw "TestingNamespacePremiumMigration".
...
### -PostMigrationName
Nazwa wpisu po migracji dla standardowej przestrzeni nazw w ramach migracji
