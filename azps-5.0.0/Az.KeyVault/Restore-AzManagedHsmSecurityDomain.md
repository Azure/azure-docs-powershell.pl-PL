...
## STRESZCZENIe
Przywraca wcześniejsze kopie zapasowe danych domeny zabezpieczeń do zarządzanego modułu HSM.
...
## Opis
To polecenie cmdlet przywraca wcześniejsze kopie zapasowe danych domeny zabezpieczeń do zarządzanego modułu HSM.
...
Najpierw należy podać klucze, aby odszyfrować dane domeny zabezpieczeń. Następnie polecenie **Restore-AzManagedHsmSecurityDomain** przywraca poprzednie kopie zapasowe danych domeny zabezpieczeń do zarządzanego modułu HSM przy użyciu tych kluczy.
