...
## Opis
Utwórz obiekt reprezentujący ustawienia reguły sieci, których można użyć podczas tworzenia magazynu.
...
Utworzenie nowego magazynu i określenie reguł sieciowych umożliwiających dostęp do określonego adresu IP z sieci wirtualnej określonej przez $myNetworkResId.
...
### Microsoft. Azure. Commands. platforming. models. PSKeyVaultNetworkRuleSet
