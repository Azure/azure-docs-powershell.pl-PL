...
## Opis
Obróć klucz szyfrowania dysku określonego klastra usługi HDInsight. W przypadku tej operacji klaster musi mieć dostęp zarówno do bieżącego klucza, jak i do zamierzonego nowego klucza, w przeciwnym razie operacja obracania klucza zakończy się niepowodzeniem.
...
[Szyfrowanie dysków klucza zarządzanego przez klienta](https://docs.microsoft.com/en-us/azure/hdinsight/disk-encryption)
