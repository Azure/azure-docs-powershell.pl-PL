...
## Opis
Polecenie cmdlet **use-AzHDInsightCluster** umożliwia wybranie klastra usługi Azure HDInsight dla Invoke-AzHDInsightHiveJob polecenia cmdlet służącego do przesyłania zadań w usłudze Hive.
