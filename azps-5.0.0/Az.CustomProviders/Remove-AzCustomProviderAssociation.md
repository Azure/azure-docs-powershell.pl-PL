...
### Przykład 1: Usunięcie skojarzenia dostawcy niestandardowego.
```powershell
PS C:\> PS C:\> Remove-AzCustomProviderAssociation -Scope $id -Name Namespace.Type
```

Usuwanie skojarzenia dostawcy niestandardowego.

### Przykład 2: Usuwanie niestandardowego skojarzenia dostawcy za pomocą połączeń rurowych
```powershell
...
Usuń skojarzenie dostawcy niestandardowego przy użyciu instalacji rurowej i funkcji PassThru, aby wskazać sukces lub niepowodzenie.
