...
### Przykład 1. Usuń dostawcę niestandardowego.
```powershell
PS C:\> PS C:\> Remove-AzCustomProvider -ResourceGroupName myRg -Name Namespace.Type
```

Usuwanie dostawcy niestandardowego

### Przykład 2: Usuwanie niestandardowego dostawcy z PassThru
```powershell
...
Usuń dostawcę niestandardowego przy użyciu funkcji PassThru, aby wskazać sukces lub niepowodzenie.
