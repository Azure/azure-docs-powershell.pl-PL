...
## Opis
Polecenie cmdlet **Get-AzPolicyRemediation** pobiera wszystkie korygowanie zasad w zakresie lub korygowanie.

## Przykłady

### Przykład 1: uzyskiwanie wszystkich korekt zasad w bieżącej subskrypcji
```
PS C:\> Select-AzSubscription -Subscription "My Subscription"
PS C:\> Get-AzPolicyRemediation
```

To polecenie umożliwia pobieranie wszystkich korekt utworzonych w ramach abonamentu o nazwie "Moja subskrypcja" lub pod nim.

### Przykład 2: uzyskiwanie określonych korekt zasad i szczegółów wdrożenia
```
PS C:\> Get-AzPolicyRemediation -ResourceGroupName "myResourceGroup" -Name "remediation1" -IncludeDetail
```

To polecenie pobiera korygowanie o nazwie "remediation1" z grupy zasobów "Moja zasobów". Zostaną uwzględnione dane dotyczące korygowanych zasobów.

### Przykład 3: Uzyskaj 10 korekt zasad w grupie zarządzania z filtrami opcjonalnymi
```
...
To polecenie pobiera maksymalnie 10 korekt zasad z grupy zarządzania o nazwie "MG1". Zostaną pobrane tylko korygowanie zasad dla danego przydziału zasad.
...
### -IncludeDetail
Uwzględnij szczegóły wdrożeń utworzonych przez korygowanie.
