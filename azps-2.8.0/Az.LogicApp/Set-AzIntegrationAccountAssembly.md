...
### ByIntegrationAccountAndFilePath (domyślny)
```
...
## Opis
Polecenie cmdlet **Set-AzIntegrationAccountAssembly** modyfikuje zestaw kont integracji.

## Przykłady

### Przykład 1: modyfikowanie zestawu przy użyciu pliku lokalnego
```powershell
...
Modyfikuje zestaw o nazwie "sampleAssembly" przy użyciu pliku lokalnego znajdującego się w ścieżce pliku znajdującej się w "$localAssemblyFilePath".

### Przykład 2: modyfikowanie zestawu za pomocą bajtów danych
```powershell
...
Modyfikuje zestaw o nazwie "sampleAssembly" przy użyciu tablicy bajtowej zawartej w "$assemblyContent".

### Przykład 3: modyfikowanie zestawu za pomocą linku do zawartości
```powershell
...
Modyfikuje zestaw o nazwie "sampleAssembly" przy użyciu danych bajtowych znajdujących się w adresie URL "$assemblyUrl". Jest to sugerowana metoda tworzenia zestawów o dużym rozmiarze.

## PARAMETRÓW

### -AssemblyData
Dane zestawu konta integracji.
...
### -AssemblyFilePath
Ścieżka pliku zestawu konta integracji.
...
### -ContentLink
Publicznie dostępne łącze do danych zestawu konta integracji.
...
### -Metadata
Metadane zestawu konta integracji.
...
### -ResourceId
Identyfikator zasobu zestawu konta integracji.
