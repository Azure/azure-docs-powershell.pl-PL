...
## Opis
Polecenie cmdlet **Get-AzLogicAppUpgradedDefinition** pobiera uaktualnioną definicję dla wersji schematu i aplikacji logicznej z grupy zasobów.
To polecenie cmdlet zwraca obiekt reprezentujący definicję uaktualnionej aplikacji logicznej.
Określ nazwę grupy zasobów, nazwę aplikacji logicznej i wersję schematu docelowego.
...
### Przykład 1: uzyskiwanie definicji uaktualnionej przez aplikację logiczną
```
...
W pierwszym poleceniu jest pobierana definicja aplikacji logicznej uaktualnionej do określonej wersji schematu docelowego.
Polecenie zapisuje definicję w zmiennej $UpgradedDefinition.
Drugie polecenie wyświetla zawartość $UpgradedDefinition jako ciąg.
...
### -TargetSchemaVersion
Określa wersję schematu docelowego definicji.
