...
## Opis
Polecenie cmdlet Get-AzAutomationSourceControl umożliwia pobieranie kontrolek źródeł automatyzacji.
Aby uzyskać określoną kontrolę źródła, określ jej nazwę.

## Przykłady

### Przykład 1
To polecenie pobiera kontrolę źródła automatyzacji o nazwie VSTSNative na koncie o nazwie devAccount.
