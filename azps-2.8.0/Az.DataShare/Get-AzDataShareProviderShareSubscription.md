...
## Opis
Polecenie cmdlet **Get-AzDataShareProviderSubscription** pobiera informacje o abonamentach udostępniania klienta na stronie dostawcy. Jeśli określisz identyfikator udziału wykupionym, to polecenie cmdlet pobiera informacje o subskrypcji udziału. Jeśli nie określisz identyfikatora subskrypcji udostępniania, to polecenie cmdlet będzie pobierać informacje o wszystkich abonamentach z udziałem konsumenta skojarzonych z danym udziałem.
...
Te polecenia dostarczają informacji na temat subskrypcji udziału konsumenta skojarzonego z AdsShare udostępniania w WikiAds kont udostępniania danych.

## PARAMETRÓW

### -AccountName
Nazwa konta usługi Azure dataudział.
...
### -ResourceGroupName
Grupa zasobów konta usługi Azure dataudział.
...
### -ShareSubscriptionId
Identyfikator subskrypcji udziału konsumenta
