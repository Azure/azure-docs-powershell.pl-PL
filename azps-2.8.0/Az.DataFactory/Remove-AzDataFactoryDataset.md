...
## Opis
Polecenie cmdlet **Remove-AzDataFactoryDataset** umożliwia usunięcie zestawu danych z usługi Azure Data Factory.
...
### -Force
Wskazuje, że to polecenie cmdlet usunie zestaw danych bez monitowania o potwierdzenie.
