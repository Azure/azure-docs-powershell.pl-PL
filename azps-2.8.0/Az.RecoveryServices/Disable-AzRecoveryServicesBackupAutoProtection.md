...
Pierwsze polecenie cmdlet wyłącza zasady ochrony kopii zapasowych.

## PARAMETRÓW

### -BackupManagementType
Typ zarządzania kopią zapasową zasobu (na przykład MAB, DPM).
...
### -Obciążenia
Typ obciążenia pracą zasobu (na przykład: AzureVM, WindowsServer, AzureFiles).
