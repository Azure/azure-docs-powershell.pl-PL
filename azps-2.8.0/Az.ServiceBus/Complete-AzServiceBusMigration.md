...
## Opis
Polecenia cmdlet **Complete-AzServiceBusMigration** umożliwiają ustawienie migracji z przestrzeni nazw Standard do Premium jako ukończone i parametry połączenia dla standardowej przestrzeni nazw wskazują na obszar nazw Premium.
...
Ustawia migrację przestrzeni nazw "NamespaceStandardMigration" jako ukończonej.
...
### -ResourceId
Migracja magistrali usług — Identyfikator zasobu standardowego obszaru nazw
