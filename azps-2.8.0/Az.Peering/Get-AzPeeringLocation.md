...
## Opis
Umożliwia przełączenie urządzeń równorzędnych, w których użytkownicy mogą się łączyć z RAMIENIem.
...
Jej długa lista lokalizacji. Umożliwia pobieranie wszystkich urządzeń komunikacji równorzędnej.
...
Pobiera lokalizację komunikacji równorzędnej programu Exchange dla identyfikatora funkcji komunikacji równorzędnej 71. 
...
### -DirectPeeringType
Wybierz pozycję "Edge", "CDN" i "transport".
...
### -PeeringDbFacilityId
Identyfikator funkcji PeeringDB.com
...
### Microsoft. Azure. PowerShell. cmdlet. peer. MODELES. PSPeeringLocation
