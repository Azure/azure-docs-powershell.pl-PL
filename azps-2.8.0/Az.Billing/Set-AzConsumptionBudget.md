...
## Opis
Polecenie cmdlet Set-AzConsumptionBudget umożliwia zaktualizowanie budżetu w ramach subskrypcji lub grupy zasobów.

## Przykłady

### Przykład 1: aktualizowanie budżetu za pomocą nowej kwoty z nazwą budżetu na poziomie abonamentu
```powershell
...
### Przykład 2: aktualizowanie budżetu za pomocą powiadomienia, gdy koszt lub użycie osiągnie próg 90 procent kwoty na poziomie subskrypcji
```powershell
...
### Przykład 3: aktualizowanie budżetu według nowej kwoty z nazwą budżetu na poziomie grupy zasobów
```powershell
...
Jeśli ta opcja nie jest określona, powiadomienie jest domyślnie wyłączone.
