...
## Opis
Polecenie cmdlet **Remove-AzNetworkInterfaceTapConfig** usuwa konfigurację sieci Azure TAP z listy interfejsów sieciowych.
...
To polecenie usuwa TapConfiguration z NetworkInterface1 w grupie zasobów ResourceGroup1.
...
### -Inputobject
Odwołanie do NetworkInterfaceTapConfig.
...
### -Name (nazwa)
Nazwa elementu równorzędnego sieci wirtualnej.
