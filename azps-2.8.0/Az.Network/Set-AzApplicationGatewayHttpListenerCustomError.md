...
## Opis
Polecenie cmdlet **Set-AzApplicationGatewayCustomError** aktualizuje błąd niestandardowy w odbiorniku http bramy Application Gateway.

## Przykłady

### Przykład 1: aktualizowanie błędu niestandardowego od odbiornika http
```powershell
...
To polecenie aktualizuje błąd niestandardowy kodu stanu HTTP 502 w odbiorniku http $listener 01 i zwraca zaktualizowany detektor.
