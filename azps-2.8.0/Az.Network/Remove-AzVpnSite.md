...
Po utworzeniu witryny jest ona natychmiast usuwana przy użyciu polecenia Remove-AzVpnSite.
...
Taki sam jak w przykładzie 1, ale usunięcie jest wykonywane przy użyciu danych wyjściowych potoku z poziomu polecenia Get-AzVpnSite.
...
### -Inputobject
Obiekt vpnSite, który ma zostać usunięty.
...
### -ResourceId
Identyfikator zasobu platformy Azure dla vpnSite, który ma zostać usunięty.
