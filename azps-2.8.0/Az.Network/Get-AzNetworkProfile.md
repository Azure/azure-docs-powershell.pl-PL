...
### GetByResourceNameNoExpandParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **Get-AzNetworkProfile** pobiera istniejący profil sieci zasób najwyższego poziomu
...
Spowoduje to pobranie profilu NP1 w grupie zasób RG1
...
Spowoduje to pobranie profilów sieciowych, które zaczynają się od "np"
...
### -ResourceId
Identyfikator Menedżera zasobów platformy Azure profilu sieciowego.
