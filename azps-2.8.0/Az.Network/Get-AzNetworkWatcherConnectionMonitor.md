...
### Przykład 2: uzyskiwanie monitorów połączeń przy użyciu filtrowania
```
...
W tym przykładzie są odbierane wszystkie monitory połączeń w NetworkWatcher_centraluseuap rozpoczynające się od "cm"
