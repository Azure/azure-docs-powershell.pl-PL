...
## Opis
Polecenie cmdlet Get-AzDdosProtectionPlan pobiera plan ochrony DDoS.
...
### Przykład 3: pobieranie wszystkich planów ochrony DDoS w ramach subskrypcji
```
...
### Przykład 4: pobieranie wszystkich planów ochrony DDoS w ramach subskrypcji
```
...
To polecenie cmdlet zwraca wszystkie DdosProtectionPlans, które zaczynają się od tekstu "test".
