...
Aby zaktualizować inne właściwości, zobacz polecenie "Set-AzScheduledQueryRule".

## Przykłady

### Przykład 1-Aktualizuj według nazwy reguły
```powershell
...
### Przykład 2 — Aktualizuj według obiektu wejścia
```powershell
