...
### Przykład 1-Wyświetlanie listy według abonamentu lub grupy zasobów
```powershell
...
### Przykład 2 — Pobierz według nazwy reguły
```powershell
...
### Przykład 3 — Uzyskaj według identyfikatora zasobu
```powershell
