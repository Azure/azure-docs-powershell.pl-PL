...
## Opis
Polecenie cmdlet **Set-AzBatchPoolOSVersion** umożliwia zmianę wersji systemu operacyjnego określonej puli.

## Przykłady

### Przykład 1: Ustawianie docelowej wersji systemu operacyjnego puli
```
PS C:\>Set-AzBatchPoolOSVersion -Id "MyPool" -TargetOSVersion "WA-GUEST-OS-4.20_201505-01" -BatchContext $Context
```

To polecenie ustawia docelowy system operacyjny puli moja Pula w wersji WA-GUEST-OS-4.20 _201505-01.
...
### -TargetOSVersion
Określa wersję systemu operacyjnego gościa platformy Azure do zainstalowania na maszynach wirtualnych w puli.
Aby uzyskać więcej informacji na temat wersji systemu operacyjnego gościa platformy Azure, zobacz Zestawy wersji systemu operacyjnego gościa platformy Azure oraz Matryca zgodności zestawu SDK https://azure.microsoft.com/en-us/documentation/articles/cloud-services-guestos-update-matrix/ ( https://azure.microsoft.com/en-us/documentation/articles/cloud-services-guestos-update-matrix/) .
