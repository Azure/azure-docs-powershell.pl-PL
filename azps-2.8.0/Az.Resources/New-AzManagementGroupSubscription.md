...
## Opis
Polecenie cmdlet **New-AzManagementGroupSubscription** umożliwia dodanie subskrypcji do grupy zarządzania.

## Przykłady

### Przykład 1. Dodaj subskrypcję do grupy zarządzania
```
