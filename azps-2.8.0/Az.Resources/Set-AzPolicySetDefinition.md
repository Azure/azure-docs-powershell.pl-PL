...
### -Metadata
Metadane zaktualizowanej definicji zestawu zasad. Może to być ścieżka do nazwy pliku zawierającego metadane lub metadane w postaci ciągu.
...
### -Parameter
Deklaracja parametrów zaktualizowanej definicji zestawu zasad. Może to być ścieżka do nazwy pliku lub identyfikatora URI zawierającego deklarację Parameters lub deklaracji Parameters jako ciągu.
...
### -PolicyDefinition
Definicje zasad. Może to być ścieżka do nazwy pliku zawierającej definicje zasad lub definicje zasad jako ciąg.
