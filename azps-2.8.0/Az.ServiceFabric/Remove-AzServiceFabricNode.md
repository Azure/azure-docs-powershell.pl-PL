...
## Opis
Za pomocą narzędzia **Remove-AzServiceFabricNode** można usuwać węzły z określonego typu węzła z poziomu klastra. Usuwanie jest kontynuowane tylko wtedy, gdy spełnia on metryki kondycji klastra.
