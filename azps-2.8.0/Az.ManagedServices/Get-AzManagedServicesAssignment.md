...
Pobiera wszystkie zadania rejestracji w zakresie domyślnym.
...
Pobiera wszystkie zadania rejestracji ze szczegółami definicji rejestracji.
...
Pobiera zadanie rejestracji bez szczegółów definicji rejestracji.
...
Pobiera zadanie rejestracji ze szczegółami definicji rejestracji.
...
Pobiera wszystkie zadania rejestracji.
...
Pobiera przypisanie rejestracji z pełnym kwalifikowanym identyfikatorem zasobów.
...
Czy uwzględniać szczegóły definicji rejestracji.
...
### -ID
Identyfikator przydziału rejestracji (na przykład b0c052e5-c437-4771-a476-8b1201158a57).
```yaml
Type: System.String
Parameter Sets: ById
Aliases:
...
### -ResourceId
Identyfikator ResourceId zadania rejestracji (na przykład/subscriptions/bb6d49b2-603d-489f-b6ca-ca4dc497c749/providers/Microsoft.ManagedServices/registrationAssignments/b0c052e5-c437-4771-a476-8b1201158a57)
```yaml
Type: System.String
...
### -Zakres
Zakres, w którym utworzono zadanie rejestracji.
