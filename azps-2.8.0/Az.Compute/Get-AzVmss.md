...
## Opis
Polecenie cmdlet **Get-AzVmss** umożliwia wyświetlenie modelu i widoku wystąpienia zestawu skali maszyny wirtualnej (VMSS).
...
### Przykład 2: pobieranie wszystkich VMSS w grupie zasobów
```
...
Pobierz wszystkie VMSS w grupie zasobów "Group001"

### Przykład 3: uzyskiwanie wszystkich VMSS w ramach subskrypcji
```
PS C:\> Get-AzVmss
...
Pobierz wszystkie VMSS w ramach abonamentu.

### Przykład 4: pobieranie wszystkich VMSS przy użyciu funkcji filtrowania
```
...
Pobierz wszystkie VMSS w subskrypcji rozpoczynające się od "VMSS00".
