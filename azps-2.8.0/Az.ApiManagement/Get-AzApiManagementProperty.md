...
## Opis
Polecenie cmdlet **Get-AzApiManagementProperty** pobiera listę lub określoną właściwość.

## Przykłady

### Przykład 1: pobieranie właściwości według nazwy
```
