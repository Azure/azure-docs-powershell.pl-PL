...
## STRESZCZENIe
**Ważne: to polecenie cmdlet jest przestarzałe, funkcja [Set-AzSqlServerAudit](https://docs.microsoft.com/en-us/powershell/module/az.sql/set-azsqlserveraudit) zamienia je.**
