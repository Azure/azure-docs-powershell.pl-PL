...
## Opis
Polecenie cmdlet **Get-AzSqlDatabaseImportExportStatus** pobiera szczegóły importu pliku BACPAC z konta magazynu do bazy danych SQL Azure lub eksportu bazy danych SQL Azure jako pliku BACPAC do konta magazynu.
To polecenie cmdlet jest również obsługiwane przez usługę bazy danych SQL Server undatabase na platformie Azure.

## Przykłady

### Przykład 1: uzyskiwanie stanu importu i eksportu bazy danych SQL
```
...
To polecenie uzyskuje stan żądania importu lub eksportu bazy danych pod określonym adresem URL.
