...
## Opis
To polecenie modyfikuje konfigurację reguły sieci wirtualnej usługi Azure SQL Server.
Aby sterować zestawem reguł sieci wirtualnej na serwerze, użyj polecenia "Add-AzSqlServerVirtualNetworkRule" i "Remove-AzSqlServerVirtualNetworkRule".
...
Modyfikuje istniejącą regułę sieci wirtualnej o identyfikator nowej podsieci sieci wirtualnej, który zawiera informacje o nowej sieci wirtualnej.
...
Nazwa reguły sieci wirtualnej usługi Azure SQL Server.
...
Identyfikator podsieci sieci wirtualnej dla reguły.
