...
## Opis
Tworzy nowy alias DNS programu Azure SQL Server wskazujący określony serwer.
...
To polecenie tworzy alias DNS programu Azure SQL Server o nazwie alias wskazujący serwer nazwa_serwera
