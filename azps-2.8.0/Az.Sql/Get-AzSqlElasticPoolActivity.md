...
## Opis
Polecenie cmdlet **Get-AzSqlElasticPoolActivity** Pobiera stan operacji z puli elastycznej dla bazy danych SQL Azure.
Możesz sprawdzić stan tworzenia puli i aktualizacji konfiguracji.

## Przykłady

### Przykład 1: uzyskiwanie stanu operacji dla puli elastycznej
```
PS C:\>Get-AzSqlElasticPoolActivity -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

To polecenie uzyskuje stan operacji dla puli elastycznej o nazwie ElasticPool01.
