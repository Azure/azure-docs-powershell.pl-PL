...
## Opis
Stan aktualizacji polecenia cmdlet **Set-AzSqlServerRecommendedActionState** dla zalecanej akcji programu Azure SQL Server.
To polecenie cmdlet dotyczy, przywraca lub odrzuca zalecaną akcję na podstawie nowego stanu.

## Przykłady

### Example1: zaktualizuj stan określonej zalecanej akcji do oczekujących
```
...
Stan aktualizacji zalecanej akcji serwera o nazwie "IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893" do "oczekujących"

## PARAMETRÓW

### -Klasyfikatorname
Określa nazwę klasyfikatora zawierającego zalecaną akcję.
