...
## Opis
Polecenie cmdlet **Remove-AzSqlSyncAgent** usuwa agenta synchronizacji Azure SQL Sync.
...
To polecenie usuwa agenta synchronizacji SQL Azure o nazwie syncAgent01.
...
### -PassThru
Określa, czy zwrócić usuniętego agenta synchronizacji
