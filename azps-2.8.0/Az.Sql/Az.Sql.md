...
Pobiera zasady bezpiecznego połączenia z bazą danych. Bezpieczne połączenie jest przestarzałe i to polecenie zostanie usunięte w przyszłej wersji. Aby wyświetlić parametry połączenia, użyj bloku bazy danych SQL w portalu Azure.
