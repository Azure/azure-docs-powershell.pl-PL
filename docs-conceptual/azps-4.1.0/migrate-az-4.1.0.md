...
Polecenie cmdlet `Get-AzApiManagementProperty` zostało usunięte, a alias nazwy oryginalnego parametru nie został znaleziony.

### `New-AzApiManagementProperty`

Polecenie cmdlet `New-AzApiManagementProperty` zostało usunięte, a alias nazwy oryginalnego parametru nie został znaleziony.

### `Remove-AzApiManagementProperty`

Polecenie cmdlet `Remove-AzApiManagementProperty` zostało usunięte, a alias nazwy oryginalnego parametru nie został znaleziony.

### `Set-AzApiManagementProperty`

Polecenie cmdlet `Set-AzApiManagementProperty` zostało usunięte, a alias nazwy oryginalnego parametru nie został znaleziony.
...
Polecenie cmdlet `Get-AzOperationalInsightsSavedSearchResult` zostało usunięte, a alias nazwy oryginalnego parametru nie został znaleziony.

### `Get-AzOperationalInsightsSearchResult`

Polecenie cmdlet `Get-AzOperationalInsightsSearchResult` zostało usunięte, a alias nazwy oryginalnego parametru nie został znaleziony.
...
Polecenie cmdlet `Get-AzOperationalInsightsLinkTarget` zostało usunięte, a alias nazwy oryginalnego parametru nie został znaleziony.
