...
Program Azure PowerShell działa z programem PowerShell 5.1.x lub nowszym w systemie Windows 6 albo z programem PowerShell 6.x na dowolnej platformie.
...
Jeśli używasz programu PowerShell 5.x w systemie Windows, musisz mieć również zainstalowany program .NET Framework 4.7.2. Aby uzyskać instrukcje dotyczące aktualizacji lub instalowania nowej wersji programu .NET Framework, zobacz [Przewodnik instalacji programu .NET Framework](/dotnet/framework/install).
