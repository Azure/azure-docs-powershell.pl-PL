...
#### <a name="azanalysisservices"></a><span data-ttu-id="ce9e9-112">Az.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="ce9e9-112">Az.AnalysisServices</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="ce9e9-127">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ce9e9-127">Az.Resources</span></span>
...
* <span data-ttu-id="ce9e9-144">Obsługa parametru -AsJob w poleceniach cmdlet przekazywania oraz pobierania obiektów blob i plików</span><span class="sxs-lookup"><span data-stu-id="ce9e9-144">-AsJob support for Blob and file upload and download cmdlets</span></span>
    ...
    - <span data-ttu-id="ce9e9-148">Set-AzStorageFileContent</span><span class="sxs-lookup"><span data-stu-id="ce9e9-148">Set-AzStorageFileContent</span></span>
...
#### <a name="azkeyvault"></a><span data-ttu-id="ce9e9-166">Az.KeyVault</span><span class="sxs-lookup"><span data-stu-id="ce9e9-166">Az.KeyVault</span></span>
...
* <span data-ttu-id="ce9e9-180">Obsługa pobierania/ustawiania/usuwania zasad zarządzania na koncie magazynu</span><span class="sxs-lookup"><span data-stu-id="ce9e9-180">Support Get/Set/Remove Management Policy on a Storage account</span></span>
    ...
    - <span data-ttu-id="ce9e9-185">New-AzStorageAccountManagementPolicyFilter</span><span class="sxs-lookup"><span data-stu-id="ce9e9-185">New-AzStorageAccountManagementPolicyFilter</span></span>
...
#### <a name="azdatafactory"></a><span data-ttu-id="ce9e9-201">Az.DataFactory</span><span class="sxs-lookup"><span data-stu-id="ce9e9-201">Az.DataFactory</span></span>
...
#### <a name="azsql"></a><span data-ttu-id="ce9e9-219">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="ce9e9-219">Az.Sql</span></span>
...
#### <a name="azcompute"></a><span data-ttu-id="ce9e9-233">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="ce9e9-233">Az.Compute</span></span>
...
* <span data-ttu-id="ce9e9-252">Nowe polecenia cmdlet dla konfiguracji partii konta integracji</span><span class="sxs-lookup"><span data-stu-id="ce9e9-252">New cmdlets for Integration Account Batch Configuration</span></span>
    ...
    - <span data-ttu-id="ce9e9-254">New-AzIntegrationAccountBatchConfiguration</span><span class="sxs-lookup"><span data-stu-id="ce9e9-254">New-AzIntegrationAccountBatchConfiguration</span></span>
...
#### <a name="azsql"></a><span data-ttu-id="ce9e9-271">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="ce9e9-271">Az.Sql</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="ce9e9-287">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ce9e9-287">Az.Resources</span></span>
...
## <a name="120---january-2019"></a><span data-ttu-id="ce9e9-303">1.2.0 — styczeń 2019 r.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-303">1.2.0 - January 2019</span></span>
...
#### <a name="azdatafactory"></a><span data-ttu-id="ce9e9-321">Az.DataFactory</span><span class="sxs-lookup"><span data-stu-id="ce9e9-321">Az.DataFactory</span></span>
...
* <span data-ttu-id="ce9e9-339">Rozwiązano problem z formatowaniem obiektu PSResourceGroupDeployment</span><span class="sxs-lookup"><span data-stu-id="ce9e9-339">Fix formatting issue with 'PSResourceGroupDeployment' object</span></span>
    - <span data-ttu-id="ce9e9-340">Więcej informacji: https://github.com/Azure/azure-powershell/issues/2123</span><span class="sxs-lookup"><span data-stu-id="ce9e9-340">More information here: https://github.com/Azure/azure-powershell/issues/2123</span></span>
...
#### <a name="aztrafficmanager"></a><span data-ttu-id="ce9e9-358">Az.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="ce9e9-358">Az.TrafficManager</span></span>
...
#### <a name="azeventgrid"></a><span data-ttu-id="ce9e9-374">Az.EventGrid</span><span class="sxs-lookup"><span data-stu-id="ce9e9-374">Az.EventGrid</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="ce9e9-391">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ce9e9-391">Az.Resources</span></span>
...
#### <a name="azwebsites"></a><span data-ttu-id="ce9e9-407">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="ce9e9-407">Az.Websites</span></span>
...
### <a name="azbatch"></a><span data-ttu-id="ce9e9-422">Az.Batch</span><span class="sxs-lookup"><span data-stu-id="ce9e9-422">Az.Batch</span></span>
...
### <a name="azdatalakestore"></a><span data-ttu-id="ce9e9-435">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="ce9e9-435">Az.DataLakeStore</span></span>
...
<span data-ttu-id="ce9e9-446">Dodano obsługę konfigurowania zestawów RewriteRuleSet w usłudze Application Gateway</span><span class="sxs-lookup"><span data-stu-id="ce9e9-446">Added support for the configuring RewriteRuleSets in the Application Gateway</span></span>
    - <span data-ttu-id="ce9e9-447">Dodano nowe polecenia cmdlet:</span><span class="sxs-lookup"><span data-stu-id="ce9e9-447">New cmdlets added:</span></span>
        ...
        - <span data-ttu-id="ce9e9-455">New-AzureRmApplicationGatewayRewriteRuleHeaderConfiguration</span><span class="sxs-lookup"><span data-stu-id="ce9e9-455">New-AzureRmApplicationGatewayRewriteRuleHeaderConfiguration</span></span>
...
### <a name="azrecoveryservices"></a><span data-ttu-id="ce9e9-473">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="ce9e9-473">Az.RecoveryServices</span></span>
...
### <a name="azservicefabric"></a><span data-ttu-id="ce9e9-477">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="ce9e9-477">Az.ServiceFabric</span></span>
- <span data-ttu-id="ce9e9-478">Obsługa określania certyfikatu według nazwy pospolitej i odcisku palca</span><span class="sxs-lookup"><span data-stu-id="ce9e9-478">Support specfying certificate by common name and thumbprint</span></span>
- <span data-ttu-id="ce9e9-479">Niewielkie zmiany powodujące niezgodność; zobacz [Przewodnik migracji](https://aka.ms/azps-migration-guide), aby uzyskać szczegółowe informacje</span><span class="sxs-lookup"><span data-stu-id="ce9e9-479">Mnor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azsignalr"></a><span data-ttu-id="ce9e9-480">Az.SIgnalR</span><span class="sxs-lookup"><span data-stu-id="ce9e9-480">Az.SIgnalR</span></span>
- <span data-ttu-id="ce9e9-481">Ogólna dostępność poleceń cmdlet programu PowerShell dla modułu SIgnalR</span><span class="sxs-lookup"><span data-stu-id="ce9e9-481">General Availability for PowerShell cmdlets for SIgnalR</span></span>

### <a name="azsql"></a><span data-ttu-id="ce9e9-482">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="ce9e9-482">Az.Sql</span></span>
- <span data-ttu-id="ce9e9-483">Dodano nowe typy wykrywania, Data_Exfiltration i Unsafe_Action, do poleceń cmdlet wykrywania zagrożeń</span><span class="sxs-lookup"><span data-stu-id="ce9e9-483">Added new Data_Exfiltration and Unsafe_Action detection types to Threat Detection's cmdlets</span></span>
- <span data-ttu-id="ce9e9-484">Zaktualizowano przykłady poleceń cmdlet dotyczących inspekcji SQL w dokumentacji</span><span class="sxs-lookup"><span data-stu-id="ce9e9-484">Updated documentation examples for Sql Auditing cmdlets</span></span>
- <span data-ttu-id="ce9e9-485">Drobne zmiany powodujące niezgodność; zobacz [Przewodnik migracji](https://aka.ms/azps-migration-guide), aby uzyskać szczegółowe informacje</span><span class="sxs-lookup"><span data-stu-id="ce9e9-485">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azstorage"></a><span data-ttu-id="ce9e9-486">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="ce9e9-486">Az.Storage</span></span>
- <span data-ttu-id="ce9e9-487">Drobne zmiany powodujące niezgodność; zobacz [Przewodnik migracji](https://aka.ms/azps-migration-guide), aby uzyskać szczegółowe informacje</span><span class="sxs-lookup"><span data-stu-id="ce9e9-487">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azwebsites"></a><span data-ttu-id="ce9e9-488">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="ce9e9-488">Az.Websites</span></span>
- <span data-ttu-id="ce9e9-489">Drobne zmiany powodujące niezgodność; zobacz [Przewodnik migracji](https://aka.ms/azps-migration-guide), aby uzyskać szczegółowe informacje</span><span class="sxs-lookup"><span data-stu-id="ce9e9-489">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

## <a name="070---december-2018"></a><span data-ttu-id="ce9e9-490">0.7.0 — grudzień 2018 r.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-490">0.7.0 - December 2018</span></span>

### <a name="general"></a><span data-ttu-id="ce9e9-491">Ogólne</span><span class="sxs-lookup"><span data-stu-id="ce9e9-491">General</span></span>

* <span data-ttu-id="ce9e9-492">Drobne zmiany na potrzeby nadchodzącego przejścia z modułu AzureRM do modułu Az</span><span class="sxs-lookup"><span data-stu-id="ce9e9-492">Minor changes for upcoming AzureRM to Az transition</span></span>

### <a name="azcompute"></a><span data-ttu-id="ce9e9-493">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="ce9e9-493">Az.Compute</span></span>

* <span data-ttu-id="ce9e9-494">Dodano obsługę opcji UltraSSD i Galeria obrazów w prostych zestawach parametrów dla poleceń cmdlet `New-AzVm(ss)`.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-494">Add support for UltraSSD and Gallery Images in the simple param sets for `New-AzVm(ss)` cmdlets.</span></span>

### <a name="azdatalakestore"></a><span data-ttu-id="ce9e9-495">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="ce9e9-495">Az.DataLakeStore</span></span>

* <span data-ttu-id="ce9e9-496">Poprawiono końcowy ukośnik w domenie konta usługi ADLS</span><span class="sxs-lookup"><span data-stu-id="ce9e9-496">Fix the trailing slash of the domain of adls account</span></span>

### <a name="azfrontdoor"></a><span data-ttu-id="ce9e9-497">Az.FrontDoor</span><span class="sxs-lookup"><span data-stu-id="ce9e9-497">Az.FrontDoor</span></span>

* <span data-ttu-id="ce9e9-498">Poprawiono kilka przerwanych hiperlinków</span><span class="sxs-lookup"><span data-stu-id="ce9e9-498">Fixed some broken links</span></span>
    - <span data-ttu-id="ce9e9-499">W artykułach dotyczących poleceń New-AzureRmFrontDoor i Set-AzureRmFrontDoor poprawiono link do artykułu dotyczącego polecenia cmdlet New-AzureRmFrontDoorHealthProbeSettingObject.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-499">In the New-AzureRmFrontDoor and Set-AzureRmFrontDoor articles, fixed the link to the New-AzureRmFrontDoorHealthProbeSettingObject cmdlet article.</span></span>
    - <span data-ttu-id="ce9e9-500">W artykule dotyczącym polecenia New-AzureRmFrontDoorManagedRuleObject poprawiono link do artykułu dotyczącego polecenia cmdlet New-AzureRmFrontDoorRuleGroupOverrideObject.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-500">In the New-AzureRmFrontDoorManagedRuleObject article, fixed the link to the New-AzureRmFrontDoorRuleGroupOverrideObject cmdlet article.</span></span>

### <a name="azrecoveryservices"></a><span data-ttu-id="ce9e9-501">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="ce9e9-501">Az.RecoveryServices</span></span>

* <span data-ttu-id="ce9e9-502">Dodano walidacje po stronie klienta na potrzeby operacji przywracania udziału plików platformy Azure.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-502">Added client side validations for Azure File Share restore operations.</span></span>
* <span data-ttu-id="ce9e9-503">Parametry storageAccountName i storageAccountResourceGroupName są teraz opcjonalne w przypadku przywracania udziału plików platformy Azure.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-503">Made storageAccountName and storageAccountResourceGroupName optional for afs restore.</span></span>

### <a name="azresources"></a><span data-ttu-id="ce9e9-504">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ce9e9-504">Az.Resources</span></span>

* <span data-ttu-id="ce9e9-505">Rozwiązano problem https://github.com/Azure/azure-powershell/issues/7679</span><span class="sxs-lookup"><span data-stu-id="ce9e9-505">Fix for https://github.com/Azure/azure-powershell/issues/7679</span></span>
    - <span data-ttu-id="ce9e9-506">Aktualizacja polecenia Get-AzureRmRoleAssignment w celu używania zakresu subskrypcji, jeśli został podany, podczas żądania klasycznych administratorów.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-506">Update Get-AzureRmRoleAssignment to use the subscription scope if it is provided when requesting classic administrators.</span></span>

### <a name="azsql"></a><span data-ttu-id="ce9e9-507">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="ce9e9-507">Az.Sql</span></span>

* <span data-ttu-id="ce9e9-508">Drobne zmiany na potrzeby nadchodzącego przejścia z modułu AzureRM do modułu Az</span><span class="sxs-lookup"><span data-stu-id="ce9e9-508">Minor changes for upcoming AzureRM to Az transition</span></span>
* <span data-ttu-id="ce9e9-509">Rozwiązano problem dotyczący używania polecenia Get-AzureRmSqlDatabaseVulnerabilityAssessment na platformie .NET Core</span><span class="sxs-lookup"><span data-stu-id="ce9e9-509">Fixed issue with using Get-AzureRmSqlDatabaseVulnerabilityAssessment with DotNet core</span></span>
* <span data-ttu-id="ce9e9-510">Zmodyfikowano dokumentację komunikatów pomocy dotyczących poleceń cmdlet z zakresu inspekcji SQL.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-510">Modified documentation of help messages related to SQL Auditing cmdlets.</span></span>

### <a name="azstorage"></a><span data-ttu-id="ce9e9-511">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="ce9e9-511">Az.Storage</span></span>

* <span data-ttu-id="ce9e9-512">Dodano parametr -EnableHierarchicalNamespace do polecenia New-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="ce9e9-512">Add -EnableHierarchicalNamespace to New-AzureRmStorageAccount</span></span>
* <span data-ttu-id="ce9e9-513">Rozwiązano problem polegający na tym, że polecenie cmdlet kopiowania pliku nie może ponownie używać kontekstu źródłowego w miejscu docelowym, jeśli nie podano parametru -DestContext</span><span class="sxs-lookup"><span data-stu-id="ce9e9-513">Fix issue that Copy File cmdlet can't reuse source context in destination when not input -DestContext</span></span>
    - <span data-ttu-id="ce9e9-514">Start-AzureStorageFileCopy</span><span class="sxs-lookup"><span data-stu-id="ce9e9-514">Start-AzureStorageFileCopy</span></span>
* <span data-ttu-id="ce9e9-515">Obsługa konfiguracji statycznej witryny internetowej</span><span class="sxs-lookup"><span data-stu-id="ce9e9-515">Support Static Website configuration</span></span>
    - <span data-ttu-id="ce9e9-516">Enable-AzureStorageStaticWebsite</span><span class="sxs-lookup"><span data-stu-id="ce9e9-516">Enable-AzureStorageStaticWebsite</span></span>
    - <span data-ttu-id="ce9e9-517">Disable-AzureStorageStaticWebsite</span><span class="sxs-lookup"><span data-stu-id="ce9e9-517">Disable-AzureStorageStaticWebsite</span></span>

### <a name="azwebsites"></a><span data-ttu-id="ce9e9-518">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="ce9e9-518">Az.Websites</span></span>

* <span data-ttu-id="ce9e9-519">Set-AzureRmWebApp i Set-AzureRmWebAppSlot</span><span class="sxs-lookup"><span data-stu-id="ce9e9-519">Set-AzureRmWebApp and Set-AzureRmWebAppSlot</span></span> 
    - <span data-ttu-id="ce9e9-520">Dodano nowy parametr (-AzureStoragePath) umożliwiający określenie ścieżek usługi Azure Storage, które mają zostać zainstalowane w aplikacjach kontenera systemów Windows i Linux.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-520">New parameter (-AzureStoragePath) added to specify Azure Storage paths to be mounted in Windows and Linux container apps.</span></span> <span data-ttu-id="ce9e9-521">Użyj danych wyjściowych nowego polecenia cmdlet New-AzureRmWebAppAzureStoragePath jako parametru, aby ustawić ścieżki usługi Azure Storage.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-521">Use the output of the new cmdlet New-AzureRmWebAppAzureStoragePath as a parameter to set the Azure Storage paths.</span></span>

## <a name="061---november-2018"></a><span data-ttu-id="ce9e9-522">0.6.1 — listopad 2018 r.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-522">0.6.1 - November 2018</span></span>

### <a name="azapimanagement"></a><span data-ttu-id="ce9e9-523">Az.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="ce9e9-523">Az.ApiManagement</span></span>
* <span data-ttu-id="ce9e9-524">Aktualizacja zależności w związku z problemem dotyczącym mapowania typów</span><span class="sxs-lookup"><span data-stu-id="ce9e9-524">Update dependencies for type mapping issue</span></span>

### <a name="azautomation"></a><span data-ttu-id="ce9e9-525">Az.Automation</span><span class="sxs-lookup"><span data-stu-id="ce9e9-525">Az.Automation</span></span>
* <span data-ttu-id="ce9e9-526">Polecenia cmdlet usługi Azure Automation oparte na programie Swagger</span><span class="sxs-lookup"><span data-stu-id="ce9e9-526">Swagger based Azure Automation cmdlets</span></span>
* <span data-ttu-id="ce9e9-527">Dodano polecenia cmdlet rozwiązania Update Management</span><span class="sxs-lookup"><span data-stu-id="ce9e9-527">Added Update Management cmdlets</span></span>
* <span data-ttu-id="ce9e9-528">Dodano polecenia cmdlet kontroli kodu źródłowego</span><span class="sxs-lookup"><span data-stu-id="ce9e9-528">Added Source Control cmdlets</span></span>
* <span data-ttu-id="ce9e9-529">Dodano polecenie cmdlet Remove-AzureRmAutomationHybridWorkerGroup</span><span class="sxs-lookup"><span data-stu-id="ce9e9-529">Added Remove-AzureRmAutomationHybridWorkerGroup cmdlet</span></span>
* <span data-ttu-id="ce9e9-530">Naprawiono polecenie konfiguracji DSC służące do rejestrowania węzła</span><span class="sxs-lookup"><span data-stu-id="ce9e9-530">Fixed the DSC Register Node command</span></span>

### <a name="azcompute"></a><span data-ttu-id="ce9e9-531">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="ce9e9-531">Az.Compute</span></span>
* <span data-ttu-id="ce9e9-532">Rozwiązano problem dotyczący tożsamości SystemAssigned</span><span class="sxs-lookup"><span data-stu-id="ce9e9-532">Fixed identity issue for SystemAssigned identity</span></span>
* <span data-ttu-id="ce9e9-533">Aktualizacja zależności w związku z problemem dotyczącym mapowania typów</span><span class="sxs-lookup"><span data-stu-id="ce9e9-533">Update dependencies for type mapping issue</span></span>

### <a name="azcontainerinstance"></a><span data-ttu-id="ce9e9-534">Az.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="ce9e9-534">Az.ContainerInstance</span></span>
* <span data-ttu-id="ce9e9-535">Aktualizacja zależności w związku z problemem dotyczącym mapowania typów</span><span class="sxs-lookup"><span data-stu-id="ce9e9-535">Update dependencies for type mapping issue</span></span>

### <a name="azmarketplaceordering"></a><span data-ttu-id="ce9e9-536">Az.MarketplaceOrdering</span><span class="sxs-lookup"><span data-stu-id="ce9e9-536">Az.MarketplaceOrdering</span></span>
* <span data-ttu-id="ce9e9-537">Aktualizacja opisu przykładów dla poleceń cmdlet witryny Marketplace</span><span class="sxs-lookup"><span data-stu-id="ce9e9-537">update the examples description for marketplace cmdlets</span></span>

### <a name="aznetwork"></a><span data-ttu-id="ce9e9-538">Az.Network</span><span class="sxs-lookup"><span data-stu-id="ce9e9-538">Az.Network</span></span>
* <span data-ttu-id="ce9e9-539">Dodano następujące polecenia cmdlet: New-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayCustomError, Get-AzureRmApplicationGatewayCustomError, Set-AzureRmApplicationGatewayCustomError, Remove-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayHttpListenerCustomError, Get-AzureRmApplicationGatewayHttpListenerCustomError, Set-AzureRmApplicationGatewayHttpListenerCustomError, Remove-AzureRmApplicationGatewayHttpListenerCustomError</span><span class="sxs-lookup"><span data-stu-id="ce9e9-539">Added cmdlet New-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayCustomError, Get-AzureRmApplicationGatewayCustomError, Set-AzureRmApplicationGatewayCustomError, Remove-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayHttpListenerCustomError, Get-AzureRmApplicationGatewayHttpListenerCustomError, Set-AzureRmApplicationGatewayHttpListenerCustomError, Remove-AzureRmApplicationGatewayHttpListenerCustomError</span></span>
* <span data-ttu-id="ce9e9-540">Ponownie dodano protokół ICMP do obsługiwanych protokołów sieciowych AzureFirewall</span><span class="sxs-lookup"><span data-stu-id="ce9e9-540">Added ICMP back to supported AzureFirewall Network Protocols</span></span>
* <span data-ttu-id="ce9e9-541">Aktualizacja polecenia cmdlet Test-AzureRmNetworkWatcherConnectivity — dodanie walidacji identyfikatora, adresu i portu docelowego.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-541">Update cmdlet Test-AzureRmNetworkWatcherConnectivity, add validation on destination id, address and port.</span></span> 
* <span data-ttu-id="ce9e9-542">Rozwiązano problemy z użyciem pamięci w mapie VirtualNetwork</span><span class="sxs-lookup"><span data-stu-id="ce9e9-542">Fix issues with memory usage in VirtualNetwork map</span></span>

### <a name="azrecoveryservicesbackup"></a><span data-ttu-id="ce9e9-543">Az.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="ce9e9-543">Az.RecoveryServices.Backup</span></span>
* <span data-ttu-id="ce9e9-544">Poprawka dotycząca modyfikowania zasad dla chronionego udziału plików.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-544">Fix for modifying policy for a protected file share.</span></span>
* <span data-ttu-id="ce9e9-545">Przekonwertowano strefę czasową zasad na wielkie litery.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-545">Converted policy timezone to uppercase.</span></span>

### <a name="azrecoveryservicessiterecovery"></a><span data-ttu-id="ce9e9-546">Az.RecoveryServices.SiteRecovery</span><span class="sxs-lookup"><span data-stu-id="ce9e9-546">Az.RecoveryServices.SiteRecovery</span></span>
* <span data-ttu-id="ce9e9-547">Poprawiono przykład w poleceniu New-AzureRmRecoveryServicesAsrProtectableItem</span><span class="sxs-lookup"><span data-stu-id="ce9e9-547">Corrected example in New-AzureRmRecoveryServicesAsrProtectableItem</span></span>
* <span data-ttu-id="ce9e9-548">Aktualizacja zależności w związku z problemem dotyczącym mapowania typów</span><span class="sxs-lookup"><span data-stu-id="ce9e9-548">Update dependencies for type mapping issue</span></span>

### <a name="azrelay"></a><span data-ttu-id="ce9e9-549">Az.Relay</span><span class="sxs-lookup"><span data-stu-id="ce9e9-549">Az.Relay</span></span>
* <span data-ttu-id="ce9e9-550">Dodano opcjonalny parametr -KeyValue do polecenia cmdlet New-AzureRmRelayKey, umożliwiając użytkownikowi wprowadzanie wartości elementu KeyValue.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-550">Added optional Parameter -KeyValue to New-AzureRmRelayKey cmdlet, which enables user to provide KeyValue.</span></span>

### <a name="azresources"></a><span data-ttu-id="ce9e9-551">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ce9e9-551">Az.Resources</span></span>
* <span data-ttu-id="ce9e9-552">Aktualizacja dokumentacji pomocy dotyczącej parametrów związanych z tożsamością zasobu w poleceniach `New-AzureRmPolicyAssignment` i `Set-AzureRmPolicyAssignment`</span><span class="sxs-lookup"><span data-stu-id="ce9e9-552">Update help documentation for resource identity related parameters in `New-AzureRmPolicyAssignment` and `Set-AzureRmPolicyAssignment`</span></span>
* <span data-ttu-id="ce9e9-553">Dodanie przykładu dla polecenia New-AzureRmPolicyDefinition używającego parametru -Metadata</span><span class="sxs-lookup"><span data-stu-id="ce9e9-553">Add an example for New-AzureRmPolicyDefinition that uses -Metadata</span></span>
* <span data-ttu-id="ce9e9-554">Poprawka umożliwiająca zachowanie wielkości liter w kluczach tagów w elemencie NetStandard: #7678 #7703</span><span class="sxs-lookup"><span data-stu-id="ce9e9-554">Fix to allow case preservation in Tag keys in NetStandard: #7678 #7703</span></span>

### <a name="azservicefabric"></a><span data-ttu-id="ce9e9-555">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="ce9e9-555">Az.ServiceFabric</span></span>
* <span data-ttu-id="ce9e9-556">Dodanie komunikatów o zakończeniu obsługi w związku z nadchodzącymi zmianami powodującymi niezgodność</span><span class="sxs-lookup"><span data-stu-id="ce9e9-556">Add deprecation messages for upcoming breaking changes</span></span>

### <a name="azsql"></a><span data-ttu-id="ce9e9-557">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="ce9e9-557">Az.Sql</span></span>
* <span data-ttu-id="ce9e9-558">Dodano nowe polecenia cmdlet dla operacji CRUD w wystąpieniu zarządzanym usługi Azure SQL Database i zarządzanej bazie danych Azure SQL</span><span class="sxs-lookup"><span data-stu-id="ce9e9-558">Added new cmdlets for CRUD operations on Azure Sql Database Managed Instance and Azure Sql Managed Database</span></span>
    - <span data-ttu-id="ce9e9-559">Get-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="ce9e9-559">Get-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="ce9e9-560">New-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="ce9e9-560">New-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="ce9e9-561">Set-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="ce9e9-561">Set-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="ce9e9-562">Remove-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="ce9e9-562">Remove-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="ce9e9-563">Get-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="ce9e9-563">Get-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="ce9e9-564">New-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="ce9e9-564">New-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="ce9e9-565">Restore-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="ce9e9-565">Restore-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="ce9e9-566">Remove-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="ce9e9-566">Remove-AzureRmSqlInstanceDatabase</span></span>
* <span data-ttu-id="ce9e9-567">Włączono rozszerzone zarządzanie zasadami inspekcji na serwerze lub w bazie danych.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-567">Enabled Extended Auditing Policy management on a server or a database.</span></span>
    - <span data-ttu-id="ce9e9-568">Dodano nowy parametr (PredicateExpression), aby umożliwić filtrowanie dzienników inspekcji.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-568">New parameter (PredicateExpression) was added to enable filtering of audit logs.</span></span>
    - <span data-ttu-id="ce9e9-569">Zmodyfikowano polecenia cmdlet tak, aby korzystały z klientów SQL zamiast starszych klientów.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-569">Cmdlets were modified to use SQL clients instead of Legacy clients.</span></span>
    - <span data-ttu-id="ce9e9-570">Set-AzureRmSqlServerAuditing.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-570">Set-AzureRmSqlServerAuditing.</span></span>
    - <span data-ttu-id="ce9e9-571">Get-AzureRmSqlServerAuditing.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-571">Get-AzureRmSqlServerAuditing.</span></span>
    - <span data-ttu-id="ce9e9-572">Set-AzureRmSqlDatabaseAuditing.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-572">Set-AzureRmSqlDatabaseAuditing.</span></span>
    - <span data-ttu-id="ce9e9-573">Get-AzureRmSqlDatabaseAuditing.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-573">Get-AzureRmSqlDatabaseAuditing.</span></span>
* <span data-ttu-id="ce9e9-574">Rozwiązano problem występujący podczas używania polecenia Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings z ustawionym parametrem nazwy konta magazynu</span><span class="sxs-lookup"><span data-stu-id="ce9e9-574">Fixed issue with using Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings with storage account name parameter set</span></span>

## <a name="050---november-2018"></a><span data-ttu-id="ce9e9-575">0.5.0 — listopad 2018 r.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-575">0.5.0 - November 2018</span></span>
#### <a name="general"></a><span data-ttu-id="ce9e9-576">Ogólne</span><span class="sxs-lookup"><span data-stu-id="ce9e9-576">General</span></span>
* <span data-ttu-id="ce9e9-577">Dodano moduły wypełniania zasobów do wielu podstawowych poleceń cmdlet — umożliwiają one przechodzenie między nazwami istniejących zasobów za pomocą klawisza Tab podczas interaktywnego wywoływania poleceń cmdlet</span><span class="sxs-lookup"><span data-stu-id="ce9e9-577">Added Resource Completers to many core cmdlets - these alloow you to tab through existing resource names when invoking cmdlets interactively</span></span>

#### <a name="azprofile"></a><span data-ttu-id="ce9e9-578">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="ce9e9-578">Az.Profile</span></span>
* <span data-ttu-id="ce9e9-579">Zaktualizowano wspólny kod, aby korzystał z najnowszej wersji środowiska uruchomieniowego klienta</span><span class="sxs-lookup"><span data-stu-id="ce9e9-579">Update common code to use latest version of ClientRuntime</span></span>
* <span data-ttu-id="ce9e9-580">Zmieniono nazwę parametru TenantId w poleceniu cmdlet Connect-AzAccount na Tenant i dodano alias dla parametru TenantId</span><span class="sxs-lookup"><span data-stu-id="ce9e9-580">Rename param TenantId in cmdlet Connect-AzAccount to Tenant and add an alias for TenantId</span></span>
* <span data-ttu-id="ce9e9-581">Zaktualizowano opis parametru TenantId dla polecenia Connect-AzAccount</span><span class="sxs-lookup"><span data-stu-id="ce9e9-581">Updated TenantId description for Connect-AzAccount</span></span>
* <span data-ttu-id="ce9e9-582">Naprawiono komunikat o błędzie dotyczący nieudanego logowania podczas podawania domeny dzierżawy</span><span class="sxs-lookup"><span data-stu-id="ce9e9-582">Fix error message for failed login when providing tenant domain</span></span>
    - https://github.com/Azure/azure-powershell/issues/6936
* <span data-ttu-id="ce9e9-583">Rozwiązano problem polegający na konflikcie nazw kontekstu w przypadku kont bez subskrypcji w dzierżawie</span><span class="sxs-lookup"><span data-stu-id="ce9e9-583">Fix issue with context name clashing for accounts with no subscriptions in tenant</span></span>
    - https://github.com/Azure/azure-powershell/issues/7453
* <span data-ttu-id="ce9e9-584">Rozwiązano problem z punktami końcowymi usługi DataLake w przypadku używania tożsamości usługi zarządzanej</span><span class="sxs-lookup"><span data-stu-id="ce9e9-584">Fix issue with DataLake endpoints when using MSI</span></span>
    - https://github.com/Azure/azure-powershell/issues/7462
* <span data-ttu-id="ce9e9-585">Rozwiązano problem polegający na tym, że polecenie „Disconnect-AzAccount” zgłaszało wyjątek w przypadku braku połączenia</span><span class="sxs-lookup"><span data-stu-id="ce9e9-585">Fix issue where 'Disconnect-AzAccount' would throw if not connected</span></span>
    - https://github.com/Azure/azure-powershell/issues/7167

#### <a name="azcognitiveservices"></a><span data-ttu-id="ce9e9-586">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="ce9e9-586">Az.CognitiveServices</span></span>
* <span data-ttu-id="ce9e9-587">Dodano operację Get-AzCognitiveServicesAccountSkus.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-587">Add Get-AzCognitiveServicesAccountSkus operation.</span></span>

#### <a name="azcompute"></a><span data-ttu-id="ce9e9-588">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="ce9e9-588">Az.Compute</span></span>
* <span data-ttu-id="ce9e9-589">Dodano polecenia cmdlet Add-AzVmssVMDataDisk i Remove-AzVmssVMDataDisk</span><span class="sxs-lookup"><span data-stu-id="ce9e9-589">Add Add-AzVmssVMDataDisk and Remove-AzVmssVMDataDisk cmdlets</span></span>
* <span data-ttu-id="ce9e9-590">Polecenie Get-AzVMImage wyświetla element AutomaticOSUpgradeProperties</span><span class="sxs-lookup"><span data-stu-id="ce9e9-590">Get-AzVMImage shows AutomaticOSUpgradeProperties</span></span>
* <span data-ttu-id="ce9e9-591">Rozwiązano problem polegający na tym, że wartości opcji SetAzVMChefExtension -BootstrapOptions i -JsonAttribute nie były ustawiane w formacie JSON.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-591">Fixed SetAzVMChefExtension -BootstrapOptions and -JsonAttribute option values are not setting in json format.</span></span>

#### <a name="azdatalakestore"></a><span data-ttu-id="ce9e9-592">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="ce9e9-592">Az.DataLakeStore</span></span>
* <span data-ttu-id="ce9e9-593">Zaktualizowano pakiet usługi DataLake do wersji 1.1.10.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-593">Update the DataLake package to 1.1.10.</span></span>
* <span data-ttu-id="ce9e9-594">Dodano domyślną współbieżność do operacji wielowątkowych.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-594">Add default Concurrency to multithreaded operations.</span></span>

#### <a name="azinsights"></a><span data-ttu-id="ce9e9-595">Az.Insights</span><span class="sxs-lookup"><span data-stu-id="ce9e9-595">Az.Insights</span></span>
* <span data-ttu-id="ce9e9-596">Rozwiązano problem nr 7267 (obszar autoskalowania)</span><span class="sxs-lookup"><span data-stu-id="ce9e9-596">Fixed issue #7267 (Autoscale area)</span></span>
    - <span data-ttu-id="ce9e9-597">Podczas tworzenia nowej reguły autoskalowania występował problem polegający na niepoprawnym ustawieniu parametrów wyliczanych (zawsze była ustawiana wartość domyślna).</span><span class="sxs-lookup"><span data-stu-id="ce9e9-597">Issues with creating a new autoscale rule not properly setting enumerated parameters (would always set them to the default value).</span></span>
* <span data-ttu-id="ce9e9-598">Rozwiązano problem nr 7513 [Insights] polegający na tym, że polecenie Set-AzDiagnosticSetting wymagało jawnego określenia kategorii podczas tworzenia ustawienia</span><span class="sxs-lookup"><span data-stu-id="ce9e9-598">Fixed issue #7513 [Insights] Set-AzDiagnosticSetting requires explicit specification of categories during creation of setting</span></span>
    - <span data-ttu-id="ce9e9-599">Teraz polecenie cmdlet nie wymaga jawnego określenia kategorii do włączenia podczas tworzenia, czyli działa zgodnie z opisem w dokumentacji</span><span class="sxs-lookup"><span data-stu-id="ce9e9-599">Now the cmdlet does not require explicit indication of the categories to enable during creation, i.e. it works as it is documented</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="ce9e9-600">Az.Network</span><span class="sxs-lookup"><span data-stu-id="ce9e9-600">Az.Network</span></span>
* <span data-ttu-id="ce9e9-601">Parametr PeeringType jest teraz obowiązkowym parametrem dla następujących poleceń cmdlet:</span><span class="sxs-lookup"><span data-stu-id="ce9e9-601">Changed PeeringType to be a mandatory parameter for the following cmdlets:-</span></span>
    - <span data-ttu-id="ce9e9-602">Get-AzExpressRouteCircuitRouteTable</span><span class="sxs-lookup"><span data-stu-id="ce9e9-602">Get-AzExpressRouteCircuitRouteTable</span></span>
    - <span data-ttu-id="ce9e9-603">Get-AzExpressRouteCircuitARPTable</span><span class="sxs-lookup"><span data-stu-id="ce9e9-603">Get-AzExpressRouteCircuitARPTable</span></span>
    - <span data-ttu-id="ce9e9-604">Get-AzExpressRouteCircuitRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="ce9e9-604">Get-AzExpressRouteCircuitRouteTableSummary</span></span>
    - <span data-ttu-id="ce9e9-605">Get-AzExpressRouteCrossConnectionArpTable</span><span class="sxs-lookup"><span data-stu-id="ce9e9-605">Get-AzExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="ce9e9-606">Get-AzExpressRouteCrossConnectionRouteTable</span><span class="sxs-lookup"><span data-stu-id="ce9e9-606">Get-AzExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="ce9e9-607">Get-AzExpressRouteCrossConnectionRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="ce9e9-607">Get-AzExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azpolicyinsights"></a><span data-ttu-id="ce9e9-608">Az.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="ce9e9-608">Az.PolicyInsights</span></span>
* <span data-ttu-id="ce9e9-609">Dodano polecenia cmdlet korygowania zasad</span><span class="sxs-lookup"><span data-stu-id="ce9e9-609">Added policy remediation cmdlets</span></span>

#### <a name="azresources"></a><span data-ttu-id="ce9e9-610">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ce9e9-610">Az.Resources</span></span>
* <span data-ttu-id="ce9e9-611">Rozwiązano problem https://github.com/Azure/azure-powershell/issues/7402</span><span class="sxs-lookup"><span data-stu-id="ce9e9-611">Fix for https://github.com/Azure/azure-powershell/issues/7402</span></span>
    - <span data-ttu-id="ce9e9-612">Umożliwiono wyświetlanie list zasobów za pomocą parametru „-ResourceId” polecenia „Get-AzResource”</span><span class="sxs-lookup"><span data-stu-id="ce9e9-612">Allow listing resources using the '-ResourceId' parameter for 'Get-AzResource'</span></span>

#### <a name="azservicebus"></a><span data-ttu-id="ce9e9-613">Az.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="ce9e9-613">Az.ServiceBus</span></span>
* <span data-ttu-id="ce9e9-614">Dodano właściwość tylko do odczytu MigrationState do elementu PSServiceBusMigrationConfigurationAttributes, dzięki czemu można łatwiej sprawdzić stan migracji.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-614">Added MigrationState read-only property to PSServiceBusMigrationConfigurationAttributes which will help to know the Migration state.</span></span>

#### <a name="azservicefabric"></a><span data-ttu-id="ce9e9-615">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="ce9e9-615">Az.ServiceFabric</span></span>
* <span data-ttu-id="ce9e9-616">Rozwiązano problem z dodawaniem certyfikatu do zestawu skalowania maszyn wirtualnych w systemie Linux.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-616">Fix add certificate to Linux Vmss.</span></span>
* <span data-ttu-id="ce9e9-617">Rozwiązano problem z poleceniem „Add-AzServiceFabricClusterCertificate”</span><span class="sxs-lookup"><span data-stu-id="ce9e9-617">Fix 'Add-AzServiceFabricClusterCertificate'</span></span>
    - <span data-ttu-id="ce9e9-618">Jest używany poprawny odcisk palca z nowego certyfikatu (Azure/service-fabric-issues#932).</span><span class="sxs-lookup"><span data-stu-id="ce9e9-618">Using correct thumbprint from new certificate (Azure/service-fabric-issues#932).</span></span>
    - <span data-ttu-id="ce9e9-619">Wyjątek jest wyświetlany poprawnie (Azure/service-fabric-issues#1054).</span><span class="sxs-lookup"><span data-stu-id="ce9e9-619">Display exception correctly (Azure/service-fabric-issues#1054).</span></span>
* <span data-ttu-id="ce9e9-620">Rozwiązano problem z poleceniem „Update-AzServiceFabricDurability” polegający na aktualizowaniu konfiguracji klastra przed rozpoczęciem operacji CreateOrUpdate zestawu skalowania maszyn wirtualnych.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-620">Fix 'Update-AzServiceFabricDurability' to update cluster configuration before starting Vmss CreateOrUpdate operation.</span></span>

## <a name="040---october-2018"></a><span data-ttu-id="ce9e9-621">0.4.0 — październik 2018 r.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-621">0.4.0 - October 2018</span></span>
#### <a name="azprofile"></a><span data-ttu-id="ce9e9-622">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="ce9e9-622">Az.Profile</span></span>
* <span data-ttu-id="ce9e9-623">Rozwiązano problem z poleceniem Get-AzSubscription w usłudze CloudShell</span><span class="sxs-lookup"><span data-stu-id="ce9e9-623">Fix issue with Get-AzSubscription in CloudShell</span></span>
* <span data-ttu-id="ce9e9-624">Zaktualizowano wspólny kod, aby korzystał z najnowszej wersji środowiska uruchomieniowego klienta</span><span class="sxs-lookup"><span data-stu-id="ce9e9-624">Update common code to use latest version of ClientRuntime</span></span>

#### <a name="azcompute"></a><span data-ttu-id="ce9e9-625">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="ce9e9-625">Az.Compute</span></span>
* <span data-ttu-id="ce9e9-626">Dodano nowe rozmiary do listy dozwolonych rozmiarów maszyn wirtualnych, dla których będzie włączona przyspieszona sieć w przypadku użycia prostego zestawu parametrów dla polecenia „New-AzVm”</span><span class="sxs-lookup"><span data-stu-id="ce9e9-626">Added new sizes to the whitelist of VM sizes for which accelerated networking will be turned on when using the simple param set for 'New-AzVm'</span></span>
* <span data-ttu-id="ce9e9-627">Dodano moduł uzupełniający argument ResourceName do wszystkich poleceń cmdlet.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-627">Added ResourceName argument completer to all cmdlets.</span></span>

#### <a name="azdatalakestore"></a><span data-ttu-id="ce9e9-628">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="ce9e9-628">Az.DataLakeStore</span></span>
* <span data-ttu-id="ce9e9-629">Dodawanie obsługi dla reguł sieci wirtualnej</span><span class="sxs-lookup"><span data-stu-id="ce9e9-629">Adding support for Virtual Network Rules</span></span>
    - <span data-ttu-id="ce9e9-630">Get-AzDataLakeStoreVirtualNetworkRule: Pobiera lub wyświetla regułę sieci wirtualnej usługi Azure Data Lake Store.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-630">Get-AzDataLakeStoreVirtualNetworkRule: Gets or Lists Azure Data Lake Store virtual network rule.</span></span>
    - <span data-ttu-id="ce9e9-631">Add-AzDataLakeStoreVirtualNetworkRule: Dodaje regułę sieci wirtualnej do określonego konta usługi Data Lake Store.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-631">Add-AzDataLakeStoreVirtualNetworkRule: Adds a virtual network rule to the specified Data Lake Store account.</span></span>
    - <span data-ttu-id="ce9e9-632">Set-AzDataLakeStoreVirtualNetworkRule: Modyfikuje wskazaną regułę sieci wirtualnej na określonym koncie usługi Data Lake Store.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-632">Set-AzDataLakeStoreVirtualNetworkRule: Modifies the specified virtual network rule in the specified Data Lake Store account.</span></span>
    - <span data-ttu-id="ce9e9-633">Remove-AzDataLakeStoreVirtualNetworkRule: Usuwa regułę sieci wirtualnej usługi Azure Data Lake Store.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-633">Remove-AzDataLakeStoreVirtualNetworkRule: Deletes an Azure Data Lake Store virtual network rule.</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="ce9e9-634">Az.Network</span><span class="sxs-lookup"><span data-stu-id="ce9e9-634">Az.Network</span></span>
* <span data-ttu-id="ce9e9-635">Aktualizacja polecenia cmdlet Test-AzNetworkWatcherConnectivity: przekazywanie wartości protokołu do zaplecza.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-635">Update cmdlet Test-AzNetworkWatcherConnectivity, pass the protocol value to backend.</span></span>
* <span data-ttu-id="ce9e9-636">Dodano moduł uzupełniający argument ResourceName do wszystkich poleceń cmdlet.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-636">Added ResourceName argument completer to all cmdlets.</span></span>

#### <a name="azresources"></a><span data-ttu-id="ce9e9-637">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ce9e9-637">Az.Resources</span></span>
* <span data-ttu-id="ce9e9-638">Rozwiązano problem polegający na tym, że polecenie Get-AzRoleDefinition zgłaszało niezrozumiały wyjątek (gdy domyślny profil nie zawierał subskrypcji i nie określono zakresu), dodając zrozumiały wyjątek do scenariusza.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-638">Fix isssue where Get-AzRoleDefinition throws an unintelligible exception (when the default profile has no subscription in it and no scope is specified) by adding a meaningful exception in the scenario.</span></span> <span data-ttu-id="ce9e9-639">Oprócz tego ustawiono domyślny zestaw parametrów na wartość „RoleDefinitionNameParameterSet”.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-639">Also set the default param set to 'RoleDefinitionNameParameterSet'.</span></span>

## <a name="030---october-2018"></a><span data-ttu-id="ce9e9-640">0.3.0 — październik 2018 r.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-640">0.3.0 - October 2018</span></span>
#### <a name="azurestorage"></a><span data-ttu-id="ce9e9-641">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="ce9e9-641">Azure.Storage</span></span>
* <span data-ttu-id="ce9e9-642">Rozwiązano problem polegający na tym, że nie można skopiować pliku lub obiektu blob, gdy w miejscu docelowym występuje problem z metadanymi</span><span class="sxs-lookup"><span data-stu-id="ce9e9-642">Fix Copy Blob/File won't copy metadata when destination has metadata issue</span></span>
    - <span data-ttu-id="ce9e9-643">Start-AzureStorageBlobCopy</span><span class="sxs-lookup"><span data-stu-id="ce9e9-643">Start-AzureStorageBlobCopy</span></span>
    - <span data-ttu-id="ce9e9-644">Start-AzureStorageFileCopy</span><span class="sxs-lookup"><span data-stu-id="ce9e9-644">Start-AzureStorageFileCopy</span></span>
* <span data-ttu-id="ce9e9-645">Dodano obsługę pobierania danych użycia zasobów magazynu w określonej lokalizacji i dodano komunikat ostrzegawczy w przypadku pobrania przestarzałych danych użycia globalnego zasobu magazynu.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-645">Support get the Storage resource usage of a specific location, and add warning message for get global Storage resource usage is obsolete.</span></span>
    - <span data-ttu-id="ce9e9-646">Get-AzStorageUsage</span><span class="sxs-lookup"><span data-stu-id="ce9e9-646">Get-AzStorageUsage</span></span>
    
#### <a name="azcognitiveservices"></a><span data-ttu-id="ce9e9-647">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="ce9e9-647">Az.CognitiveServices</span></span>
* <span data-ttu-id="ce9e9-648">Obsługa polecenia Get-AzCognitiveServicesAccountSkus bez istniejącego konta.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-648">Support Get-AzCognitiveServicesAccountSkus without an existing account.</span></span>

#### <a name="azcompute"></a><span data-ttu-id="ce9e9-649">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="ce9e9-649">Az.Compute</span></span>
* <span data-ttu-id="ce9e9-650">Rozwiązano problem z poleceniem Get-AzVM -ResourceGroupName <rg>, dzięki czemu można zwracać więcej niż 50 wyników, jeśli to konieczne</span><span class="sxs-lookup"><span data-stu-id="ce9e9-650">Fix Get-AzVM -ResourceGroupName <rg> to return more than 50 results if needed</span></span>
* <span data-ttu-id="ce9e9-651">Dodano przykładowy zestaw SimpleParameterSet do pomocy polecenia cmdlet New-AzVmss.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-651">Added an example of the 'SimpleParameterSet' to New-AzVmss cmdlet help.</span></span>
* <span data-ttu-id="ce9e9-652">Usunięto błąd pisowni w komunikacie o postępie usługi Azure Disk Encryption</span><span class="sxs-lookup"><span data-stu-id="ce9e9-652">Fixed a typo in the Azure Disk Encryption progress message</span></span>

#### <a name="azdatafactoryv2"></a><span data-ttu-id="ce9e9-653">Az.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="ce9e9-653">Az.DataFactoryV2</span></span>
* <span data-ttu-id="ce9e9-654">Zaktualizowano zestaw ADF .Net SDK do wersji 2.3.0.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-654">Updated the ADF .Net SDK version to 2.3.0.</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="ce9e9-655">Az.Network</span><span class="sxs-lookup"><span data-stu-id="ce9e9-655">Az.Network</span></span>
* <span data-ttu-id="ce9e9-656">Dodano funkcję NetworkProfile.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-656">Added NetworkProfile functionality.</span></span> <span data-ttu-id="ce9e9-657">Dodano nowe polecenia cmdlet</span><span class="sxs-lookup"><span data-stu-id="ce9e9-657">new cmdlets added</span></span>
    - <span data-ttu-id="ce9e9-658">Get-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="ce9e9-658">Get-AzNetworkProfile</span></span>
    - <span data-ttu-id="ce9e9-659">New-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="ce9e9-659">New-AzNetworkProfile</span></span>
    - <span data-ttu-id="ce9e9-660">Remove-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="ce9e9-660">Remove-AzNetworkProfile</span></span>
    - <span data-ttu-id="ce9e9-661">Set-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="ce9e9-661">Set-AzNetworkProfile</span></span>
    - <span data-ttu-id="ce9e9-662">New-AzContainerNicConfig</span><span class="sxs-lookup"><span data-stu-id="ce9e9-662">New-AzContainerNicConfig</span></span>
    - <span data-ttu-id="ce9e9-663">New-AzContainerNicConfigIpConfig</span><span class="sxs-lookup"><span data-stu-id="ce9e9-663">New-AzContainerNicConfigIpConfig</span></span>
* <span data-ttu-id="ce9e9-664">Dodano link skojarzenia usługi w modelu podsieci</span><span class="sxs-lookup"><span data-stu-id="ce9e9-664">Added service association link on Subnet Model</span></span>
* <span data-ttu-id="ce9e9-665">Dodano polecenia cmdlet New-AzVirtualNetworkTap, Get-AzVirtualNetworkTap, Set-AzVirtualNetworkTap i Remove-AzVirtualNetworkTap</span><span class="sxs-lookup"><span data-stu-id="ce9e9-665">Added cmdlet New-AzVirtualNetworkTap, Get-AzVirtualNetworkTap, Set-AzVirtualNetworkTap, Remove-AzVirtualNetworkTap</span></span>
* <span data-ttu-id="ce9e9-666">Dodano polecenia cmdlet Set-AzNEtworkInterfaceTapConfig, Get-AzNEtworkInterfaceTapConfig i Remove-AzNEtworkInterfaceTapConfig</span><span class="sxs-lookup"><span data-stu-id="ce9e9-666">Added cmdlet Set-AzNEtworkInterfaceTapConfig, Get-AzNEtworkInterfaceTapConfig, Remove-AzNEtworkInterfaceTapConfig</span></span>

#### <a name="azrediscache"></a><span data-ttu-id="ce9e9-667">Az.RedisCache</span><span class="sxs-lookup"><span data-stu-id="ce9e9-667">Az.RedisCache</span></span>
* <span data-ttu-id="ce9e9-668">Jako parametru Size będzie można użyć dowolnego ciągu.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-668">Allow any string as Size parameter going forward.</span></span> <span data-ttu-id="ce9e9-669">Dodano element P5 w menu podręcznym PSArgumentCompleter</span><span class="sxs-lookup"><span data-stu-id="ce9e9-669">Add P5 in PSArgumentCompleter popup</span></span>

#### <a name="azresources"></a><span data-ttu-id="ce9e9-670">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="ce9e9-670">Az.Resources</span></span>
* <span data-ttu-id="ce9e9-671">Dodano brakujący parametr -Mode do polecenia Set-AzPolicyDefinition</span><span class="sxs-lookup"><span data-stu-id="ce9e9-671">Add missing -Mode parameter to Set-AzPolicyDefinition</span></span>
* <span data-ttu-id="ce9e9-672">Usunięto usterkę polecenia cmdlet Get-AzProviderOperation w operacjach ze źródłem zawierającym użytkownika</span><span class="sxs-lookup"><span data-stu-id="ce9e9-672">Fix Get-AzProviderOperation commandlet bug for operations with Origin containing User</span></span>

#### <a name="azsql"></a><span data-ttu-id="ce9e9-673">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="ce9e9-673">Az.Sql</span></span>
* <span data-ttu-id="ce9e9-674">Rozwiązano problem polegający na tym, że niektóre polecenia cmdlet kopii zapasowych nie rozpoznawały bieżącej subskrypcji platformy Azure</span><span class="sxs-lookup"><span data-stu-id="ce9e9-674">Fixed issue where some backup cmdlets would not recognize the current azure subscription</span></span>

#### <a name="azwebsites"></a><span data-ttu-id="ce9e9-675">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="ce9e9-675">Az.Websites</span></span>
* <span data-ttu-id="ce9e9-676">Nowe polecenie cmdlet Get-AzWebAppContainerContinuousDeploymentUrl umożliwiające pobranie adresu URL elementu webhook ciągłego wdrażania kontenera</span><span class="sxs-lookup"><span data-stu-id="ce9e9-676">New Cmdlet Get-AzWebAppContainerContinuousDeploymentUrl - Gets the Container Continuous Deployment Webhook URL</span></span>
* <span data-ttu-id="ce9e9-677">Nowe polecenia cmdlet New-AzWebAppContainerPSSession i Enter-WebAppContainerPSSession umożliwiające zainicjowanie zdalnej sesji programu PowerShell w aplikacji kontenera systemu Windows</span><span class="sxs-lookup"><span data-stu-id="ce9e9-677">New Cmdlets New-AzWebAppContainerPSSession and Enter-WebAppContainerPSSession  - Initiates a PowerShell remote session into a windows container app</span></span>

## <a name="020---september-2018"></a><span data-ttu-id="ce9e9-678">0.2.0 — Wrzesień 2018 r.</span><span class="sxs-lookup"><span data-stu-id="ce9e9-678">0.2.0 - September 2018</span></span>
 <span data-ttu-id="ce9e9-679">Wersja początkowa</span><span class="sxs-lookup"><span data-stu-id="ce9e9-679">Initial Release</span></span>