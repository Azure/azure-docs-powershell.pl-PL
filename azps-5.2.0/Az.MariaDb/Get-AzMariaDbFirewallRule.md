...
### Przykład 1: wyświetlanie wszystkich reguł zapory pod MariaDB
```powershell
...
To polecenie wyświetla listę wszystkich reguł girewall pod MariaDB.

### Przykład 2: uzyskiwanie reguły zapory w obszarze MariaDB
```powershell
...
To polecenie pobiera regułę zapory pod MariaDB.
