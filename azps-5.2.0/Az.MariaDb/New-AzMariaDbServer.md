...
### Przykład 1. Utwórz nowy MariaDB
```powershell
...
To polecenie tworzy nowy MariaDB.

## PARAMETRÓW

### -AdministratorLoginPassword
Hasło administratora powinno być poleceniem SecureString.
...
NazwaUżytkownika administratora.
...
### -GeoRedundantBackup
Włącz lokalizację geograficzną lub niezbędną dla kopii zapasowych serwera.
