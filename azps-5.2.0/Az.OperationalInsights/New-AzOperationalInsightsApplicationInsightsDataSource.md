...
## Opis
Polecenie cmdlet **New-AzOperationalInsightsApplicationInsightsDataSource** umożliwia zbieranie dzienników z danej aplikacji Application-Insights.

## Przykłady

### Przykład 1: tworzenie źródła danych w usłudze Application-Insights w obszarze roboczym
```
...
To polecenie tworzy źródło danych usługi Application-Insights dla danej aplikacji w danym obszarze roboczym analizy dzienników. Spowoduje to włączenie zbierania dzienników z danej aplikacji do obszaru roboczego Analiza dzienników.

### Przykład 2: Pobieranie obiektu obszaru roboczego i tworzenie źródła danych w usłudze Application-Insights według identyfikatora zasobu aplikacji
```
...
To polecenie ilustruje obiekt obszar roboczy Analiza dzienników, a następnie przekazanie danych wyjściowych w celu utworzenia skojarzonego źródła danych usługi Application-Insights przez identyfikator zasobu aplikacji. 
...
Identyfikator zasobu połączonej aplikacji.
...
Nazwa obszaru roboczego, który będzie zawierać źródło danych.
