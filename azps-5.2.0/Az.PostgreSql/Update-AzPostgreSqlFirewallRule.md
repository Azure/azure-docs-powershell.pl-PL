...
### Przykład 1: aktualizowanie reguły zapory PostgreSql według nazwy
```powershell
...
To polecenie cmdlet aktualizuje PostgreSqlą regułę zapory według nazwy.

### Przykład 2: aktualizowanie reguły zapory PostgreSql według tożsamości.
```powershell
