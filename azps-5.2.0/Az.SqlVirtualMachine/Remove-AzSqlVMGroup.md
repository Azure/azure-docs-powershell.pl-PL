...
## Opis
Polecenie cmdlet Remove-AzSqlVMGroup usuwa grupę maszyny wirtualnej SQL.
...
Usuwa grupę maszyn wirtualnych SQL Azure "test-Group" w ResourceGroup01 grupy zasobów.
...
### -PassThru
Określa, czy usunięty zasób ma być wyprowadzany na końcu wykonania polecenia cmdlet.
