...
## Opis
Polecenie cmdlet **Remove-AzRelayNamespace** usuwa obszar nazw z określonej grupy zasobów.
...
Usuwa obszar nazw przekaźnika `TestNameSpace-Relay1` z określonej grupy zasobów `Default-ServiceBus-WestUS` .
