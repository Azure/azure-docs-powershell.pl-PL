...
## Opis
Polecenie cmdlet **Remove-AzRelayHybridConnection** usuwa HybridConnection z określonego obszaru nazw Relay.
...
Usuwa HybridConnection `TestHybridConnection` z obszaru nazw `TestNameSpace-Relay1` .
