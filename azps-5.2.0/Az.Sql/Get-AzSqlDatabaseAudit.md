...
## Opis
Polecenie cmdlet **Get-AzSqlDatabaseAudit** pobiera ustawienia inspekcji bazy danych SQL Azure.
...
### Przykład 1: uzyskiwanie ustawień inspekcji bazy danych SQL Azure
```
...
### Przykład 2: uzyskiwanie, za pośrednictwem rurociągu, ustawienia inspekcji bazy danych Azure SQL Database
```
...
### Przykład 3: uzyskiwanie ustawień inspekcji bazy danych SQL Azure
```
PS C:\>Get-AzSqlDatabaseAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
ServerName                          : server01
DatabaseName                        : database01
