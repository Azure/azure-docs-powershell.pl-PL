...
### ListBySubOrResourceGroupParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **Get-AzSqlInstancePool** zwraca informacje o jednej lub większej liczbie puli wystąpień SQL platformy Azure.
Określ nazwę puli wystąpień, aby wyświetlić informacje dotyczące tylko tej puli wystąpień.

## Przykłady

### Przykład 1: pobieranie wszystkich pul wystąpień w ramach abonamentu klienta
```powershell
...
To polecenie pobiera informacje o wszystkich pulach wystąpień w ramach abonamentu klienta.

### Przykład 2: pobieranie wszystkich pul wystąpień w grupie zasobów
```powershell
...
To polecenie pobiera informacje o wszystkich pulach wystąpień w resourcegroup01 grupy zasobów.
...
To polecenie pobiera informacje o puli wystąpień instancePool0.
...
To polecenie pobiera informacje o puli wystąpień z identyfikatorem zasobu.
