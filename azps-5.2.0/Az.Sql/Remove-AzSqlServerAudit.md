...
## Opis
Polecenie cmdlet **Remove-AzSqlServerAudit** usuwa ustawienia inspekcji programu Azure SQL Server.
Określ parametry *ResourceGroupName* i *nazwa_serwera* identyfikujące serwer.

## Przykłady

### Przykład 1: usuwanie ustawień inspekcji programu Azure SQL Server
```
PS C:\>Remove-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
```

### Przykład 2: usuwanie za pośrednictwem rurociągu ustawień inspekcji programu Azure SQL Server
```
