...
### CreateNewInstanceDatabaseFromInputParameters (domyślny)
```
...
## Opis
Polecenie cmdlet **New-AzSqlInstanceDatabase** tworzy bazę danych wystąpienia zarządzanego SQL Azure.

## Przykłady

### Przykład 1: Tworzenie bazy danych w określonym wystąpieniu
```
...
To polecenie tworzy bazę danych wystąpienia o nazwie Database01 w wystąpieniu managedInstance1.
...
### — Sortowanie
Sortowanie sortowania bazy danych wystąpienia SQL Azure do użycia.
...
### -Name (nazwa)
Nazwa bazy danych wystąpienia SQL Azure do utworzenia.
...
### -Tag
Tagi, które mają zostać skojarzone z bazą danych wystąpienia SQL Azure
