...
## Opis
Polecenie cmdlet **Get-AzSqlServerAudit** pobiera ustawienia inspekcji programu Azure SQL Server.
Określ parametry *ResourceGroupName* i *nazwa_serwera* identyfikujące serwer.

## Przykłady

### Przykład 1: uzyskiwanie ustawień inspekcji usługi Azure SQL Server
```
...
### Przykład 2: Get, za pośrednictwem rurociągu — ustawienia inspekcji programu Azure SQL Server
```
...
### Przykład 3: uzyskiwanie ustawień inspekcji dla programu Azure SQL Server
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
