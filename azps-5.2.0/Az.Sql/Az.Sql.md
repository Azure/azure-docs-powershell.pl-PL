...
### [<span data-ttu-id="c59a8-111">Dodaj-AzSqlInstanceKeyVaultKey</span><span class="sxs-lookup"><span data-stu-id="c59a8-111">Add-AzSqlInstanceKeyVaultKey</span></span>](Add-AzSqlInstanceKeyVaultKey.md)
...
### [<span data-ttu-id="c59a8-123">Clear-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="c59a8-123">Clear-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Clear-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
...
### [<span data-ttu-id="c59a8-135">Ukończone — AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="c59a8-135">Complete-AzSqlInstanceDatabaseLogReplay</span></span>](Complete-AzSqlInstanceDatabaseLogReplay.md)
...
### [<span data-ttu-id="c59a8-147">Disable-AzSqlInstanceDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="c59a8-147">Disable-AzSqlInstanceDatabaseSensitivityRecommendation</span></span>](Disable-AzSqlInstanceDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="c59a8-159">Enable-AzSqlInstanceAdvancedDataSecurity</span><span class="sxs-lookup"><span data-stu-id="c59a8-159">Enable-AzSqlInstanceAdvancedDataSecurity</span></span>](Enable-AzSqlInstanceAdvancedDataSecurity.md)
...
### [<span data-ttu-id="c59a8-171">Get-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="c59a8-171">Get-AzSqlDatabase</span></span>](Get-AzSqlDatabase.md)
...
### [<span data-ttu-id="c59a8-185">Get-AzSqlDatabaseDataMaskingPolicy</span><span class="sxs-lookup"><span data-stu-id="c59a8-185">Get-AzSqlDatabaseDataMaskingPolicy</span></span>](Get-AzSqlDatabaseDataMaskingPolicy.md)
...
### [<span data-ttu-id="c59a8-199">Get-AzSqlDatabaseIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="c59a8-199">Get-AzSqlDatabaseIndexRecommendation</span></span>](Get-AzSqlDatabaseIndexRecommendation.md)
...
### [<span data-ttu-id="c59a8-213">Get-AzSqlDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="c59a8-213">Get-AzSqlDatabaseSensitivityRecommendation</span></span>](Get-AzSqlDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="c59a8-225">Get-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="c59a8-225">Get-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Get-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
...
### [<span data-ttu-id="c59a8-239">Get-AzSqlElasticJobStep</span><span class="sxs-lookup"><span data-stu-id="c59a8-239">Get-AzSqlElasticJobStep</span></span>](Get-AzSqlElasticJobStep.md)
...
### [<span data-ttu-id="c59a8-253">Get-AzSqlElasticPoolDatabase</span><span class="sxs-lookup"><span data-stu-id="c59a8-253">Get-AzSqlElasticPoolDatabase</span></span>](Get-AzSqlElasticPoolDatabase.md)
...
### [<span data-ttu-id="c59a8-267">Get-AzSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="c59a8-267">Get-AzSqlInstanceDatabase</span></span>](Get-AzSqlInstanceDatabase.md)
...
### [<span data-ttu-id="c59a8-279">Get-AzSqlInstanceDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="c59a8-279">Get-AzSqlInstanceDatabaseSensitivityClassification</span></span>](Get-AzSqlInstanceDatabaseSensitivityClassification.md)
...
### [<span data-ttu-id="c59a8-291">Get-AzSqlInstanceOperation</span><span class="sxs-lookup"><span data-stu-id="c59a8-291">Get-AzSqlInstanceOperation</span></span>](Get-AzSqlInstanceOperation.md)
...
### [<span data-ttu-id="c59a8-305">Get-AzSqlServerActiveDirectoryOnlyAuthentication</span><span class="sxs-lookup"><span data-stu-id="c59a8-305">Get-AzSqlServerActiveDirectoryOnlyAuthentication</span></span>](Get-AzSqlServerActiveDirectoryOnlyAuthentication.md)
...
### [<span data-ttu-id="c59a8-317">Get-AzSqlServerDisasterRecoveryConfiguration</span><span class="sxs-lookup"><span data-stu-id="c59a8-317">Get-AzSqlServerDisasterRecoveryConfiguration</span></span>](Get-AzSqlServerDisasterRecoveryConfiguration.md)
...
### [<span data-ttu-id="c59a8-331">Get-AzSqlServerTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="c59a8-331">Get-AzSqlServerTransparentDataEncryptionProtector</span></span>](Get-AzSqlServerTransparentDataEncryptionProtector.md)
...
### [<span data-ttu-id="c59a8-345">Get-AzSqlSyncGroupLog</span><span class="sxs-lookup"><span data-stu-id="c59a8-345">Get-AzSqlSyncGroupLog</span></span>](Get-AzSqlSyncGroupLog.md)
...
### [<span data-ttu-id="c59a8-359">Nowe — AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="c59a8-359">New-AzSqlDatabase</span></span>](New-AzSqlDatabase.md)
...
### [<span data-ttu-id="c59a8-373">Nowe — AzSqlDatabaseRestorePoint</span><span class="sxs-lookup"><span data-stu-id="c59a8-373">New-AzSqlDatabaseRestorePoint</span></span>](New-AzSqlDatabaseRestorePoint.md)
...
### [<span data-ttu-id="c59a8-387">Nowe — AzSqlInstance</span><span class="sxs-lookup"><span data-stu-id="c59a8-387">New-AzSqlInstance</span></span>](New-AzSqlInstance.md)
...
### [<span data-ttu-id="c59a8-401">Nowe — AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="c59a8-401">New-AzSqlServerFirewallRule</span></span>](New-AzSqlServerFirewallRule.md)
...
### [<span data-ttu-id="c59a8-417">Remove-AzSqlDatabaseDataMaskingRule</span><span class="sxs-lookup"><span data-stu-id="c59a8-417">Remove-AzSqlDatabaseDataMaskingRule</span></span>](Remove-AzSqlDatabaseDataMaskingRule.md)
...
### [<span data-ttu-id="c59a8-431">Remove-AzSqlDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="c59a8-431">Remove-AzSqlDatabaseSensitivityClassification</span></span>](Remove-AzSqlDatabaseSensitivityClassification.md)
...
### [<span data-ttu-id="c59a8-445">Remove-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="c59a8-445">Remove-AzSqlElasticPool</span></span>](Remove-AzSqlElasticPool.md)
...
### [<span data-ttu-id="c59a8-459">Remove-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="c59a8-459">Remove-AzSqlInstancePool</span></span>](Remove-AzSqlInstancePool.md)
...
### [<span data-ttu-id="c59a8-473">Remove-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="c59a8-473">Remove-AzSqlServerFirewallRule</span></span>](Remove-AzSqlServerFirewallRule.md)
...
### [<span data-ttu-id="c59a8-479">Remove-AzSqlSyncAgent</span><span class="sxs-lookup"><span data-stu-id="c59a8-479">Remove-AzSqlSyncAgent</span></span>](Remove-AzSqlSyncAgent.md)
<span data-ttu-id="c59a8-480">Usuwa agenta synchronizacji usługi Azure SQL.</span><span class="sxs-lookup"><span data-stu-id="c59a8-480">Removes an Azure SQL Sync Agent.</span></span>

### [<span data-ttu-id="c59a8-481">Remove-AzSqlSyncGroup</span><span class="sxs-lookup"><span data-stu-id="c59a8-481">Remove-AzSqlSyncGroup</span></span>](Remove-AzSqlSyncGroup.md)
<span data-ttu-id="c59a8-482">Usuwa grupę usługi Azure SQL Database Sync.</span><span class="sxs-lookup"><span data-stu-id="c59a8-482">Removes an Azure SQL Database Sync Group.</span></span>

### [<span data-ttu-id="c59a8-483">Remove-AzSqlSyncMember</span><span class="sxs-lookup"><span data-stu-id="c59a8-483">Remove-AzSqlSyncMember</span></span>](Remove-AzSqlSyncMember.md)
<span data-ttu-id="c59a8-484">Usuwa członka synchronizacji bazy danych SQL Azure.</span><span class="sxs-lookup"><span data-stu-id="c59a8-484">Removes an Azure SQL Database Sync Member.</span></span>

### [<span data-ttu-id="c59a8-485">Remove-AzSqlVirtualCluster</span><span class="sxs-lookup"><span data-stu-id="c59a8-485">Remove-AzSqlVirtualCluster</span></span>](Remove-AzSqlVirtualCluster.md)
<span data-ttu-id="c59a8-486">Usuwa klaster wirtualny usługi Azure SQL.</span><span class="sxs-lookup"><span data-stu-id="c59a8-486">Removes an Azure SQL Virtual Cluster.</span></span>

### [<span data-ttu-id="c59a8-487">Restore-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="c59a8-487">Restore-AzSqlDatabase</span></span>](Restore-AzSqlDatabase.md)
<span data-ttu-id="c59a8-488">Przywraca bazę danych SQL.</span><span class="sxs-lookup"><span data-stu-id="c59a8-488">Restores a SQL database.</span></span>

### [<span data-ttu-id="c59a8-489">Restore-AzSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="c59a8-489">Restore-AzSqlInstanceDatabase</span></span>](Restore-AzSqlInstanceDatabase.md)
<span data-ttu-id="c59a8-490">Przywraca bazę danych wystąpienia zarządzanego SQL Azure.</span><span class="sxs-lookup"><span data-stu-id="c59a8-490">Restores an Azure SQL Managed Instance database.</span></span>

### [<span data-ttu-id="c59a8-491">Życiorys — AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="c59a8-491">Resume-AzSqlDatabase</span></span>](Resume-AzSqlDatabase.md)
<span data-ttu-id="c59a8-492">Wznawia bazę danych hurtowni danych SQL.</span><span class="sxs-lookup"><span data-stu-id="c59a8-492">Resumes a SQL Data Warehouse database.</span></span>

### [<span data-ttu-id="c59a8-493">Set-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="c59a8-493">Set-AzSqlDatabase</span></span>](Set-AzSqlDatabase.md)
<span data-ttu-id="c59a8-494">Ustawia właściwości bazy danych lub przenosi istniejącą bazę danych do puli elastycznej.</span><span class="sxs-lookup"><span data-stu-id="c59a8-494">Sets properties for a database, or moves an existing database into an elastic pool.</span></span>

### [<span data-ttu-id="c59a8-495">Set-AzSqlDatabaseAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="c59a8-495">Set-AzSqlDatabaseAdvisorAutoExecuteStatus</span></span>](Set-AzSqlDatabaseAdvisorAutoExecuteStatus.md)
<span data-ttu-id="c59a8-496">Modyfikuje stan automatycznego wykonywania klasyfikatora usługi Azure SQL Database.</span><span class="sxs-lookup"><span data-stu-id="c59a8-496">Modifies auto execute status of an Azure SQL Database Advisor.</span></span>

### [<span data-ttu-id="c59a8-497">Set-AzSqlDatabaseAudit</span><span class="sxs-lookup"><span data-stu-id="c59a8-497">Set-AzSqlDatabaseAudit</span></span>](Set-AzSqlDatabaseAudit.md)
<span data-ttu-id="c59a8-498">Zmienia ustawienia inspekcji bazy danych SQL Azure.</span><span class="sxs-lookup"><span data-stu-id="c59a8-498">Changes the auditing settings for an Azure SQL database.</span></span>

### [<span data-ttu-id="c59a8-499">Set-AzSqlDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="c59a8-499">Set-AzSqlDatabaseBackupLongTermRetentionPolicy</span></span>](Set-AzSqlDatabaseBackupLongTermRetentionPolicy.md)
<span data-ttu-id="c59a8-500">Ustawia zasady przechowywania długoterminowych serwerów.</span><span class="sxs-lookup"><span data-stu-id="c59a8-500">Sets a server long term retention policy.</span></span>

### [<span data-ttu-id="c59a8-501">Set-AzSqlDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="c59a8-501">Set-AzSqlDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="c59a8-502">Ustawia zasady przechowywania krótkoterminowej kopii zapasowej.</span><span class="sxs-lookup"><span data-stu-id="c59a8-502">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="c59a8-503">Set-AzSqlDatabaseDataMaskingPolicy</span><span class="sxs-lookup"><span data-stu-id="c59a8-503">Set-AzSqlDatabaseDataMaskingPolicy</span></span>](Set-AzSqlDatabaseDataMaskingPolicy.md)
<span data-ttu-id="c59a8-504">Ustawia maskowanie danych dla bazy danych.</span><span class="sxs-lookup"><span data-stu-id="c59a8-504">Sets data masking for a database.</span></span>

### [<span data-ttu-id="c59a8-505">Set-AzSqlDatabaseDataMaskingRule</span><span class="sxs-lookup"><span data-stu-id="c59a8-505">Set-AzSqlDatabaseDataMaskingRule</span></span>](Set-AzSqlDatabaseDataMaskingRule.md)
<span data-ttu-id="c59a8-506">Ustawia właściwości reguły maskowania danych dla bazy danych.</span><span class="sxs-lookup"><span data-stu-id="c59a8-506">Sets the properties of a data masking rule for a database.</span></span>

### [<span data-ttu-id="c59a8-507">Set-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="c59a8-507">Set-AzSqlDatabaseFailoverGroup</span></span>](Set-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="c59a8-508">Modyfikuje konfigurację grupy trybu failover bazy danych SQL Azure.</span><span class="sxs-lookup"><span data-stu-id="c59a8-508">Modifies the configuration of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="c59a8-509">Set-AzSqlDatabaseGeoBackupPolicy</span><span class="sxs-lookup"><span data-stu-id="c59a8-509">Set-AzSqlDatabaseGeoBackupPolicy</span></span>](Set-AzSqlDatabaseGeoBackupPolicy.md)
<span data-ttu-id="c59a8-510">Ustawianie zasad tworzenia kopii zapasowej bazy danych.</span><span class="sxs-lookup"><span data-stu-id="c59a8-510">Sets a database geo backup policy.</span></span>

### [<span data-ttu-id="c59a8-511">Set-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="c59a8-511">Set-AzSqlDatabaseInstanceFailoverGroup</span></span>](Set-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="c59a8-512">Modyfikuje konfigurację grupy trybu failover wystąpienia.</span><span class="sxs-lookup"><span data-stu-id="c59a8-512">Modifies the configuration of an Instance Failover Group.</span></span>

### [<span data-ttu-id="c59a8-513">Set-AzSqlDatabaseRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="c59a8-513">Set-AzSqlDatabaseRecommendedActionState</span></span>](Set-AzSqlDatabaseRecommendedActionState.md)
<span data-ttu-id="c59a8-514">Aktualizuje stan zalecanej akcji bazy danych SQL Azure.</span><span class="sxs-lookup"><span data-stu-id="c59a8-514">Updates the state of an Azure SQL Database recommended action.</span></span>

### [<span data-ttu-id="c59a8-515">Set-AzSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="c59a8-515">Set-AzSqlDatabaseSecondary</span></span>](Set-AzSqlDatabaseSecondary.md)
<span data-ttu-id="c59a8-516">Przełącza pomocniczą bazę danych na podstawową w celu zainicjowania trybu failover.</span><span class="sxs-lookup"><span data-stu-id="c59a8-516">Switches a secondary database to be primary in order to initiate failover.</span></span>

### [<span data-ttu-id="c59a8-517">Set-AzSqlDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="c59a8-517">Set-AzSqlDatabaseSensitivityClassification</span></span>](Set-AzSqlDatabaseSensitivityClassification.md)
<span data-ttu-id="c59a8-518">Ustawia typy informacji i oznakowań liter kolumn w bazie danych.</span><span class="sxs-lookup"><span data-stu-id="c59a8-518">Sets the information types and sensitivity labels of columns in the database.</span></span>

### [<span data-ttu-id="c59a8-519">Set-AzSqlDatabaseTransparentDataEncryption</span><span class="sxs-lookup"><span data-stu-id="c59a8-519">Set-AzSqlDatabaseTransparentDataEncryption</span></span>](Set-AzSqlDatabaseTransparentDataEncryption.md)
<span data-ttu-id="c59a8-520">Modyfikuje Właściwość TDE bazy danych.</span><span class="sxs-lookup"><span data-stu-id="c59a8-520">Modifies TDE property for a database.</span></span>

### [<span data-ttu-id="c59a8-521">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="c59a8-521">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="c59a8-522">Ustawia plan bazowy reguły oceny usterki.</span><span class="sxs-lookup"><span data-stu-id="c59a8-522">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="c59a8-523">Set-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="c59a8-523">Set-AzSqlElasticJob</span></span>](Set-AzSqlElasticJob.md)
<span data-ttu-id="c59a8-524">Aktualizowanie zadania</span><span class="sxs-lookup"><span data-stu-id="c59a8-524">Updates a job</span></span>

### [<span data-ttu-id="c59a8-525">Set-AzSqlElasticJobAgent</span><span class="sxs-lookup"><span data-stu-id="c59a8-525">Set-AzSqlElasticJobAgent</span></span>](Set-AzSqlElasticJobAgent.md)
<span data-ttu-id="c59a8-526">Aktualizowanie elastycznego agenta zadań</span><span class="sxs-lookup"><span data-stu-id="c59a8-526">Updates an elastic job agent</span></span>

### [<span data-ttu-id="c59a8-527">Set-AzSqlElasticJobCredential</span><span class="sxs-lookup"><span data-stu-id="c59a8-527">Set-AzSqlElasticJobCredential</span></span>](Set-AzSqlElasticJobCredential.md)
<span data-ttu-id="c59a8-528">Aktualizowanie poświadczenia zadania</span><span class="sxs-lookup"><span data-stu-id="c59a8-528">Updates a job credential</span></span>

### [<span data-ttu-id="c59a8-529">Set-AzSqlElasticJobStep</span><span class="sxs-lookup"><span data-stu-id="c59a8-529">Set-AzSqlElasticJobStep</span></span>](Set-AzSqlElasticJobStep.md)
<span data-ttu-id="c59a8-530">Aktualizowanie kroku zadania</span><span class="sxs-lookup"><span data-stu-id="c59a8-530">Updates a job step</span></span>

### [<span data-ttu-id="c59a8-531">Set-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="c59a8-531">Set-AzSqlElasticPool</span></span>](Set-AzSqlElasticPool.md)
<span data-ttu-id="c59a8-532">Modyfikuje właściwości puli Elastic Database w bazie danych Azure SQL Database.</span><span class="sxs-lookup"><span data-stu-id="c59a8-532">Modifies properties of an elastic database pool in Azure SQL Database.</span></span>

### [<span data-ttu-id="c59a8-533">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="c59a8-533">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span></span>](Set-AzSqlElasticPoolAdvisorAutoExecuteStatus.md)
<span data-ttu-id="c59a8-534">Aktualizuje stan automatycznego wykonania klasyfikatora Elastic Pool SQL platformy Azure.</span><span class="sxs-lookup"><span data-stu-id="c59a8-534">Updates auto execute status of an Azure SQL Elastic Pool Advisor.</span></span>

### [<span data-ttu-id="c59a8-535">Set-AzSqlElasticPoolRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="c59a8-535">Set-AzSqlElasticPoolRecommendedActionState</span></span>](Set-AzSqlElasticPoolRecommendedActionState.md)
<span data-ttu-id="c59a8-536">Aktualizuje stan zalecanej akcji puli elastycznej w usłudze Azure SQL.</span><span class="sxs-lookup"><span data-stu-id="c59a8-536">Updates the state of an Azure SQL Elastic Pool recommended action.</span></span>

### [<span data-ttu-id="c59a8-537">Set-AzSqlInstance</span><span class="sxs-lookup"><span data-stu-id="c59a8-537">Set-AzSqlInstance</span></span>](Set-AzSqlInstance.md)
<span data-ttu-id="c59a8-538">Ustawia właściwości wystąpienia zarządzanego bazy danych Azure SQL Database.</span><span class="sxs-lookup"><span data-stu-id="c59a8-538">Sets properties for an Azure SQL Database Managed Instance.</span></span>

### [<span data-ttu-id="c59a8-539">Set-AzSqlInstanceActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="c59a8-539">Set-AzSqlInstanceActiveDirectoryAdministrator</span></span>](Set-AzSqlInstanceActiveDirectoryAdministrator.md)
<span data-ttu-id="c59a8-540">Inicjuje obsługę administracyjną administratora usługi Azure AD dla wystąpienia zarządzanego SQL.</span><span class="sxs-lookup"><span data-stu-id="c59a8-540">Provisions an Azure AD administrator for SQL Managed Instance.</span></span>

### [<span data-ttu-id="c59a8-541">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="c59a8-541">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy.md)
<span data-ttu-id="c59a8-542">Polecenie cmdlet **Set-AzSqlInstanceDatabaseLongTermRetentionBackup** określa zasady przechowywania długoterminowych zarządzanych baz danych.</span><span class="sxs-lookup"><span data-stu-id="c59a8-542">The **Set-AzSqlInstanceDatabaseLongTermRetentionBackup** cmdlet sets a managed database's long term retention policy.</span></span>

### [<span data-ttu-id="c59a8-543">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="c59a8-543">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="c59a8-544">Ustawia zasady przechowywania krótkoterminowej kopii zapasowej.</span><span class="sxs-lookup"><span data-stu-id="c59a8-544">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="c59a8-545">Set-AzSqlInstanceDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="c59a8-545">Set-AzSqlInstanceDatabaseSensitivityClassification</span></span>](Set-AzSqlInstanceDatabaseSensitivityClassification.md)
<span data-ttu-id="c59a8-546">Ustawia typy informacji i oznakowań liter kolumn w bazie danych wystąpienia zarządzanego SQL Azure.</span><span class="sxs-lookup"><span data-stu-id="c59a8-546">Sets the information types and sensitivity labels of columns in the Azure SQL managed instance database.</span></span>

### [<span data-ttu-id="c59a8-547">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="c59a8-547">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="c59a8-548">Ustawia plan bazowy reguły oceny usterki.</span><span class="sxs-lookup"><span data-stu-id="c59a8-548">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="c59a8-549">Set-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="c59a8-549">Set-AzSqlInstancePool</span></span>](Set-AzSqlInstancePool.md)
<span data-ttu-id="c59a8-550">Ustawia właściwości puli wystąpień usługi Azure SQL.</span><span class="sxs-lookup"><span data-stu-id="c59a8-550">Sets properties for an Azure SQL Instance pool.</span></span>

### [<span data-ttu-id="c59a8-551">Set-AzSqlInstanceTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="c59a8-551">Set-AzSqlInstanceTransparentDataEncryptionProtector</span></span>](Set-AzSqlInstanceTransparentDataEncryptionProtector.md)
<span data-ttu-id="c59a8-552">Ustawia ochronę przezroczystego szyfrowania danych (TDE) dla wystąpienia zarządzanego SQL.</span><span class="sxs-lookup"><span data-stu-id="c59a8-552">Sets the Transparent Data Encryption (TDE) protector for a SQL managed instance.</span></span>

### [<span data-ttu-id="c59a8-553">Set-AzSqlServer</span><span class="sxs-lookup"><span data-stu-id="c59a8-553">Set-AzSqlServer</span></span>](Set-AzSqlServer.md)
<span data-ttu-id="c59a8-554">Modyfikuje właściwości serwera bazy danych SQL.</span><span class="sxs-lookup"><span data-stu-id="c59a8-554">Modifies properties of a SQL Database server.</span></span>

### [<span data-ttu-id="c59a8-555">Set-AzSqlServerActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="c59a8-555">Set-AzSqlServerActiveDirectoryAdministrator</span></span>](Set-AzSqlServerActiveDirectoryAdministrator.md)
<span data-ttu-id="c59a8-556">Inicjuje obsługę administracyjną administratora usługi Azure AD dla programu SQL Server.</span><span class="sxs-lookup"><span data-stu-id="c59a8-556">Provisions an Azure AD administrator for SQL Server.</span></span>

### [<span data-ttu-id="c59a8-557">Set-AzSqlServerAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="c59a8-557">Set-AzSqlServerAdvisorAutoExecuteStatus</span></span>](Set-AzSqlServerAdvisorAutoExecuteStatus.md)
<span data-ttu-id="c59a8-558">Aktualizuje stan automatycznego wykonywania usługi Azure SQL Server Advisor.</span><span class="sxs-lookup"><span data-stu-id="c59a8-558">Updates the auto execute status of an Azure SQL Server Advisor.</span></span>

### [<span data-ttu-id="c59a8-559">Set-AzSqlServerAudit</span><span class="sxs-lookup"><span data-stu-id="c59a8-559">Set-AzSqlServerAudit</span></span>](Set-AzSqlServerAudit.md)
<span data-ttu-id="c59a8-560">Zmienia ustawienia inspekcji programu Azure SQL Server.</span><span class="sxs-lookup"><span data-stu-id="c59a8-560">Changes the auditing settings of an Azure SQL server.</span></span>

### [<span data-ttu-id="c59a8-561">Set-AzSqlServerDisasterRecoveryConfiguration</span><span class="sxs-lookup"><span data-stu-id="c59a8-561">Set-AzSqlServerDisasterRecoveryConfiguration</span></span>](Set-AzSqlServerDisasterRecoveryConfiguration.md)
<span data-ttu-id="c59a8-562">Modyfikuje konfigurację odzyskiwania serwera bazy danych.</span><span class="sxs-lookup"><span data-stu-id="c59a8-562">Modifies a database server recovery configuration.</span></span>

### [<span data-ttu-id="c59a8-563">Set-AzSqlServerDnsAlias</span><span class="sxs-lookup"><span data-stu-id="c59a8-563">Set-AzSqlServerDnsAlias</span></span>](Set-AzSqlServerDnsAlias.md)
<span data-ttu-id="c59a8-564">Modyfikuje serwer, do którego jest wskazywany alias DNS programu Azure SQL Server.</span><span class="sxs-lookup"><span data-stu-id="c59a8-564">Modifies the server to which Azure SQL Server DNS Alias is pointing</span></span>

### [<span data-ttu-id="c59a8-565">Set-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="c59a8-565">Set-AzSqlServerFirewallRule</span></span>](Set-AzSqlServerFirewallRule.md)
<span data-ttu-id="c59a8-566">Modyfikuje regułę zapory na serwerze bazy danych SQL Azure.</span><span class="sxs-lookup"><span data-stu-id="c59a8-566">Modifies a firewall rule in Azure SQL Database server.</span></span>

### [<span data-ttu-id="c59a8-567">Set-AzSqlServerRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="c59a8-567">Set-AzSqlServerRecommendedActionState</span></span>](Set-AzSqlServerRecommendedActionState.md)
<span data-ttu-id="c59a8-568">Aktualizuje stan zalecanej akcji programu Azure SQL Server.</span><span class="sxs-lookup"><span data-stu-id="c59a8-568">Updates the state of an Azure SQL Server recommended action.</span></span>

### [<span data-ttu-id="c59a8-569">Set-AzSqlServerTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="c59a8-569">Set-AzSqlServerTransparentDataEncryptionProtector</span></span>](Set-AzSqlServerTransparentDataEncryptionProtector.md)
<span data-ttu-id="c59a8-570">Ustawia funkcję ochrony przezroczystego szyfrowania danych (TDE) dla programu SQL Server.</span><span class="sxs-lookup"><span data-stu-id="c59a8-570">Sets the Transparent Data Encryption (TDE) protector for a SQL server.</span></span>

### [<span data-ttu-id="c59a8-571">Set-AzSqlServerVirtualNetworkRule</span><span class="sxs-lookup"><span data-stu-id="c59a8-571">Set-AzSqlServerVirtualNetworkRule</span></span>](Set-AzSqlServerVirtualNetworkRule.md)
<span data-ttu-id="c59a8-572">Modyfikuje konfigurację reguły sieci wirtualnej usługi Azure SQL Server.</span><span class="sxs-lookup"><span data-stu-id="c59a8-572">Modifies the configuration of an Azure SQL Server Virtual Network Rule.</span></span>

### [<span data-ttu-id="c59a8-573">Start — AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="c59a8-573">Start-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Start-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="c59a8-574">Uruchamia przepływ pracy, w którym jest uruchamiana zalecana operacja indeksowania.</span><span class="sxs-lookup"><span data-stu-id="c59a8-574">Starts the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="c59a8-575">Start — AzSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="c59a8-575">Start-AzSqlDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="c59a8-576">Rozpoczyna skanowanie oceny dotyczącego luki w zabezpieczeniach.</span><span class="sxs-lookup"><span data-stu-id="c59a8-576">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="c59a8-577">Start — AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="c59a8-577">Start-AzSqlElasticJob</span></span>](Start-AzSqlElasticJob.md)
<span data-ttu-id="c59a8-578">Rozpoczyna zadanie, zwracając identyfikator wykonywania zadania, który może być sondowany w celu wyświetlenia jego statusu.</span><span class="sxs-lookup"><span data-stu-id="c59a8-578">Starts a job, returning a job execution id that can be polled to view it's status</span></span>

### [<span data-ttu-id="c59a8-579">Start — AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="c59a8-579">Start-AzSqlInstanceDatabaseLogReplay</span></span>](Start-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="c59a8-580">Uruchamia usługę powtarzania dziennika z podanymi parametrami.</span><span class="sxs-lookup"><span data-stu-id="c59a8-580">Starts a Log Replay service with the given parameters.</span></span>

### [<span data-ttu-id="c59a8-581">Start — AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="c59a8-581">Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="c59a8-582">Rozpoczyna skanowanie oceny dotyczącego luki w zabezpieczeniach.</span><span class="sxs-lookup"><span data-stu-id="c59a8-582">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="c59a8-583">Start — AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="c59a8-583">Start-AzSqlSyncGroupSync</span></span>](Start-AzSqlSyncGroupSync.md)
<span data-ttu-id="c59a8-584">Rozpoczyna synchronizację grupy synchronizacji.</span><span class="sxs-lookup"><span data-stu-id="c59a8-584">Starts a sync group synchronization.</span></span>

### [<span data-ttu-id="c59a8-585">Zatrzymaj — AzSqlDatabaseActivity</span><span class="sxs-lookup"><span data-stu-id="c59a8-585">Stop-AzSqlDatabaseActivity</span></span>](Stop-AzSqlDatabaseActivity.md)
<span data-ttu-id="c59a8-586">Anuluje operację aktualizacji asynchronicznych w bazie danych.</span><span class="sxs-lookup"><span data-stu-id="c59a8-586">Cancels the asynchronous updates operation on the database.</span></span>

### [<span data-ttu-id="c59a8-587">Zatrzymaj — AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="c59a8-587">Stop-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Stop-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="c59a8-588">Zatrzymuje przepływ pracy, w którym jest uruchamiana zalecana operacja indeksowania.</span><span class="sxs-lookup"><span data-stu-id="c59a8-588">Stops the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="c59a8-589">Zatrzymaj — AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="c59a8-589">Stop-AzSqlElasticJob</span></span>](Stop-AzSqlElasticJob.md)
<span data-ttu-id="c59a8-590">Zatrzymuje zadanie o identyfikatorze wykonania zadania</span><span class="sxs-lookup"><span data-stu-id="c59a8-590">Stops a job given it's job execution id</span></span>

### [<span data-ttu-id="c59a8-591">Zatrzymaj — AzSqlElasticPoolActivity</span><span class="sxs-lookup"><span data-stu-id="c59a8-591">Stop-AzSqlElasticPoolActivity</span></span>](Stop-AzSqlElasticPoolActivity.md)
<span data-ttu-id="c59a8-592">Anuluje operację aktualizacji asynchronicznej w puli elastycznej.</span><span class="sxs-lookup"><span data-stu-id="c59a8-592">Cancels the asynchronous update operation on an elastic pool.</span></span>

### [<span data-ttu-id="c59a8-593">Zatrzymaj — AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="c59a8-593">Stop-AzSqlInstanceDatabaseLogReplay</span></span>](Stop-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="c59a8-594">Anuluje usługę rejestrowania powtarzania, upuszczając bazę danych.</span><span class="sxs-lookup"><span data-stu-id="c59a8-594">Cancels the Log Replay service by dropping the database.</span></span>

### [<span data-ttu-id="c59a8-595">Zatrzymaj — AzSqlInstanceOperation</span><span class="sxs-lookup"><span data-stu-id="c59a8-595">Stop-AzSqlInstanceOperation</span></span>](Stop-AzSqlInstanceOperation.md)
<span data-ttu-id="c59a8-596">Zatrzymuje operacje wystąpienia zarządzanego przez SQL.</span><span class="sxs-lookup"><span data-stu-id="c59a8-596">Stops a SQL managed instance's operations.</span></span>

### [<span data-ttu-id="c59a8-597">Zatrzymaj — AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="c59a8-597">Stop-AzSqlSyncGroupSync</span></span>](Stop-AzSqlSyncGroupSync.md)
<span data-ttu-id="c59a8-598">Zatrzymuje synchronizację grupy synchronizacji.</span><span class="sxs-lookup"><span data-stu-id="c59a8-598">Stops a sync group synchronization.</span></span>

### [<span data-ttu-id="c59a8-599">Suspend — AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="c59a8-599">Suspend-AzSqlDatabase</span></span>](Suspend-AzSqlDatabase.md)
<span data-ttu-id="c59a8-600">Wstrzymuje bazę danych hurtowni danych SQL.</span><span class="sxs-lookup"><span data-stu-id="c59a8-600">Suspends a SQL Data Warehouse database.</span></span>

### [<span data-ttu-id="c59a8-601">Przełącznik-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="c59a8-601">Switch-AzSqlDatabaseFailoverGroup</span></span>](Switch-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="c59a8-602">Wykonuje przejście do trybu failover grupy trybu failover bazy danych SQL Azure.</span><span class="sxs-lookup"><span data-stu-id="c59a8-602">Executes a failover of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="c59a8-603">Przełącznik-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="c59a8-603">Switch-AzSqlDatabaseInstanceFailoverGroup</span></span>](Switch-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="c59a8-604">Wykonuje przejście do trybu failover w grupie praca awaryjna wystąpienia.</span><span class="sxs-lookup"><span data-stu-id="c59a8-604">Executes a failover of an Instance Failover Group.</span></span>

### [<span data-ttu-id="c59a8-605">Update-AzSqlDatabaseAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="c59a8-605">Update-AzSqlDatabaseAdvancedThreatProtectionSetting</span></span>](Update-AzSqlDatabaseAdvancedThreatProtectionSetting.md)
<span data-ttu-id="c59a8-606">Ustawia zaawansowane ustawienia ochrony przed zagrożeniami w bazie danych.</span><span class="sxs-lookup"><span data-stu-id="c59a8-606">Sets a advanced threat protection settings on a database.</span></span>

### [<span data-ttu-id="c59a8-607">Update-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="c59a8-607">Update-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="c59a8-608">Umożliwia zaktualizowanie ustawień oceny luk w zabezpieczeniach bazy danych.</span><span class="sxs-lookup"><span data-stu-id="c59a8-608">Updates the vulnerability assessment settings of a database.</span></span>

### [<span data-ttu-id="c59a8-609">Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="c59a8-609">Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="c59a8-610">Umożliwia zaktualizowanie ustawień oceny luk w zarządzanej bazie danych.</span><span class="sxs-lookup"><span data-stu-id="c59a8-610">Updates the vulnerability assessment settings of a managed database.</span></span>

### [<span data-ttu-id="c59a8-611">Update-AzSqlInstanceVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="c59a8-611">Update-AzSqlInstanceVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceVulnerabilityAssessmentSetting.md)
<span data-ttu-id="c59a8-612">Aktualizuje ustawienia oceny usterki wystąpienia zarządzanego.</span><span class="sxs-lookup"><span data-stu-id="c59a8-612">Updates the vulnerability assessment settings of a managed instance.</span></span>

### [<span data-ttu-id="c59a8-613">Update-AzSqlServerAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="c59a8-613">Update-AzSqlServerAdvancedThreatProtectionSetting</span></span>](Update-AzSqlServerAdvancedThreatProtectionSetting.md)
<span data-ttu-id="c59a8-614">Ustawia zaawansowane ustawienia ochrony przed zagrożeniami na serwerze.</span><span class="sxs-lookup"><span data-stu-id="c59a8-614">Sets a advanced threat protection settings on a server.</span></span>

### [<span data-ttu-id="c59a8-615">Update-AzSqlServerVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="c59a8-615">Update-AzSqlServerVulnerabilityAssessmentSetting</span></span>](Update-AzSqlServerVulnerabilityAssessmentSetting.md)
<span data-ttu-id="c59a8-616">Umożliwia zaktualizowanie ustawień oceny usterek serwera.</span><span class="sxs-lookup"><span data-stu-id="c59a8-616">Updates the vulnerability assessment settings of a server.</span></span>

### [<span data-ttu-id="c59a8-617">Update-AzSqlSyncGroup</span><span class="sxs-lookup"><span data-stu-id="c59a8-617">Update-AzSqlSyncGroup</span></span>](Update-AzSqlSyncGroup.md)
<span data-ttu-id="c59a8-618">Umożliwia zaktualizowanie grupy synchronizacji bazy danych Azure SQL.</span><span class="sxs-lookup"><span data-stu-id="c59a8-618">Updates an Azure SQL Database Sync Group.</span></span>

### [<span data-ttu-id="c59a8-619">Update-AzSqlSyncMember</span><span class="sxs-lookup"><span data-stu-id="c59a8-619">Update-AzSqlSyncMember</span></span>](Update-AzSqlSyncMember.md)
<span data-ttu-id="c59a8-620">Umożliwia zaktualizowanie elementu członkowskiego synchronizacji bazy danych Azure SQL Database.</span><span class="sxs-lookup"><span data-stu-id="c59a8-620">Updates an Azure SQL Database Sync Member.</span></span>

### [<span data-ttu-id="c59a8-621">Update-AzSqlSyncSchema</span><span class="sxs-lookup"><span data-stu-id="c59a8-621">Update-AzSqlSyncSchema</span></span>](Update-AzSqlSyncSchema.md)
<span data-ttu-id="c59a8-622">Aktualizowanie schematu synchronizowania bazy danych członka synchronizacji lub bazy danych Centrum synchronizacji.</span><span class="sxs-lookup"><span data-stu-id="c59a8-622">Update the sync schema for a sync member database or a sync hub database.</span></span>
<span data-ttu-id="c59a8-623">Pobierze on najnowszą wersję schematu bazy danych z rzeczywistej bazy danych, a następnie użyje go w celu odświeżenia schematu buforowanego przez bazę danych metadanych synchronizacji.</span><span class="sxs-lookup"><span data-stu-id="c59a8-623">It will get the latest database schema from the real database and then use it refresh the schema cached by Sync metadata database.</span></span>
<span data-ttu-id="c59a8-624">Jeśli zostanie określona wartość "SyncMemberName", spowoduje to odświeżenie schematu bazy danych członka. Jeśli nie, zostanie odświeżony schemat bazy danych centrum.</span><span class="sxs-lookup"><span data-stu-id="c59a8-624">If "SyncMemberName" is specified, it will refresh the member database schema; if not, it will refresh the hub database schema.</span></span>
