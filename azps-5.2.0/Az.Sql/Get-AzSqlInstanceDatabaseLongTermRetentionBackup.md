...
Pobiera wszystkie długoterminowe kopie zapasowe przechowywania dla konkretnej bazy danych.  Grupa zasobów jest opcjonalna. 
...
### -DatabaseName
Nazwa zarządzanej bazy danych, w której znajdują się kopie zapasowe.
...
### -InstanceName
Nazwa wystąpienia zarządzanego, w którym znajdują się kopie zapasowe.
