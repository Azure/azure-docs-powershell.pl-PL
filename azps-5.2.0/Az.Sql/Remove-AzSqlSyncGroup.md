...
## Opis
Polecenie cmdlet **Remove-AzSqlSyncGroup** usuwa grupę synchronizacji bazy danych Azure SQL.

## Przykłady

### Przykład 1. Usuń grupę synchronizacji
```
PS C:\>Remove-AzSqlSyncGroup -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "database01" -Name "syncGroup01"
```

To polecenie usuwa grupę usługi Azure SQL Database Sync o nazwie syncGroup01.
...
### -PassThru
Określa, czy ma zostać zwrócona usunięta Grupa synchronizacji
