...
## Opis
Polecenie cmdlet **Get-AzSqlSyncMember** zwraca informacje o co najmniej jednym członku synchronizacji bazy danych SQL Azure Database.
Określ nazwę członka synchronizacji, aby wyświetlić informacje dotyczące tylko tego członka synchronizacji.

## Przykłady

### Przykład 1: Pobierz wszystkie wystąpienia elementu członkowskiego synchronizacji platformy Azure SQL przypisanego do grupy synchronizacji
```
...
To polecenie pobiera informacje o składniku synchronizacji bazy danych SQL Azure przypisanym do grupy synchronizacji SyncGroup01.

### Przykład 2: uzyskiwanie informacji o członku synchronizacji bazy danych SQL Azure Database
```
...
To polecenie pobiera informacje o członku synchronizacji bazy danych Azure SQL Database o nazwie "SyncMember01".

### Przykład 3: Pobierz wszystkie wystąpienia elementu członkowskiego synchronizacji platformy Azure SQL przypisanego do grupy synchronizacji przy użyciu filtrowania
```
...
To polecenie pobiera informacje o członku synchronizacji bazy danych SQL Azure przypisanym do grupy synchronizacji SyncGroup01, która rozpoczyna się od "SyncMember".
