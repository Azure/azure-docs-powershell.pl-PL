...
## Opis
To polecenie aktualizuje serwer, do którego jest wskazywany alias. To polecenie należy wydać w ramach abonamentu, w którym znajduje się nowy serwer, do którego ma się odnosić alias.
...
To polecenie umożliwia zaktualizowanie aliasu, który był wcześniej wskazujący oldServer, aby wskazać serwer newServer
...
### -SourceServerName
Nazwa serwera Azure SQL Server, na który obecnie jest wskazywany alias.
...
Nazwa grupy zasobów serwera źródłowego.
...
Identyfikator subskrypcji serwera źródłowego
...
### -TargetServerName
Nazwa serwera Azure SQL Server, do którego alias powinien wskazywać.
