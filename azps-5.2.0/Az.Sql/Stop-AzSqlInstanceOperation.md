...
### StopByNameAndManagedInstanceAndResourceGroupParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet Stop-AzSqlInstanceOperation zatrzymuje działanie z podaną nazwą operacji w wystąpieniu zarządzanym SQL.

## Przykłady

### Przykład 1. Aby uzyskać określoną operację
```powershell
...
To polecenie zatrzymuje działanie o nazwie "d0f5bef5-e2b1-4ef8-bb42-2e54073874f9" w wystąpieniu zarządzanym SQL.
...
### Przykład 3: korzystanie z obiektu Operation
```powershell
...
To polecenie zatrzymuje działanie w przypadku $managedInstanceOperation obiektów.
...
### -ResourceId
Obiekt identyfikator zasobu do zatrzymania
