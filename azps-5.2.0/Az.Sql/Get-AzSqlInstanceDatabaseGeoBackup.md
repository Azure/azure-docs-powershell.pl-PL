...
## Opis
Polecenie cmdlet **Get-AzSqlInstanceDatabaseGeoBackup umożliwia pobranie** co najmniej jednej bazy danych SQL platformy Azure, których kopie zapasowe są dublowane z wystąpienia zarządzanego bazy danych SQL Azure.

## Przykłady

### Przykład 1: pobieranie wszystkich rezerwowych kopii zapasowych baz danych w wystąpieniu
```
...
To polecenie pobiera wszystkie nadmiarowe kopie zapasowe bazy danych z wystąpienia o nazwie managedInstance1.

### Przykład 2: pobieranie bazy danych z nadmiarową kopią zapasową według nazwy w zarządzanym wystąpieniu
```
...
To polecenie pobiera bazę danych o nadmiarowej kopii zapasowej o nazwie managedDatabase1 z wystąpienia o nazwie managedInstance1.

### Przykład 3: pobieranie wszystkich zbędnych kopii zapasowych baz danych na instancji przy użyciu filtrowania
```
...
To polecenie pobiera wszystkie nadmiarowe kopie zapasowe bazy danych z wystąpienia o nazwie managedInstance1, które rozpoczynają się od "managedDatabase".
...
### -Name (nazwa)
Nazwa bazy danych wystąpienia do pobrania.
