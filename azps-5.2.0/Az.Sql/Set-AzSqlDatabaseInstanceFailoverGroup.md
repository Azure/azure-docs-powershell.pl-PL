...
### SetInstanceFailoverGroupDefaultSet (domyślny)
```
...
Ustawia zasady pracy awaryjnej grupy dla wystąpienia jako "ręczna" przez potok w grupie trybu failover.

## PARAMETRÓW

### -AllowReadOnlyFailoverToPrimary
Informacja o tym, czy w przypadku dzieci na serwerze pomocniczym powinna być wyzwalana automatyczna praca awaryjna punktu końcowego tylko do odczytu.
...
### -Inputobject
Obiekt grupy trybu failover wystąpienia do ustawienia
...
### -ResourceId
Identyfikator zasobu grupy trybu failover wystąpienia do ustawienia.
