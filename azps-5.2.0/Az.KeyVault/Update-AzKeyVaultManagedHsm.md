...
## Opis
To polecenie cmdlet aktualizuje stan modułu HSM zarządzanego na platformie Azure.

## Przykłady

### Przykład 1: aktualizowanie zarządzanego modułu HSM bezpośrednio
```powershell
...
Aktualizuje znaczniki zarządzanego modułu HSM o nazwie `$hsmName` w grupie zasobów `$resourceGroupName` .

### Przykład 2: aktualizowanie zarządzanego modułu HSM za pomocą połączeń rurowych
```powershell
...
Aktualizuje znaczniki zarządzanego modułu HSM za pomocą składni połączeń rurowych.
