...
### Przykład 3: Lista wszystkich kont magazynu zarządzanego w magazynie kluczy przy użyciu filtrowania
```powershell
...
Wyświetla wszystkie konta, których klucze są zarządzane przez magazyn "Moja magazyn", rozpoczynające się od tekstu "test"
...
### -InRemovedState
Określa, czy mają być pokazywane uprzednio usunięte konta magazynu w danych wyjściowych.
