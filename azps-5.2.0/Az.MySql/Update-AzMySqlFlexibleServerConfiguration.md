...
To polecenie cmdlet powoduje zaktualizowanie konfiguracji MySql za pomocą nazwy.

### Przykład 2: aktualizowanie konfiguracji MySql według tożsamości.
```powershell
...
Te polecenia cmdlet aktualizują konfigurację MySql przez tożsamość.
...
### -Source
Źródło wartości aktualizującej.
Wartość domyślna to zastąpienie przez użytkownika
