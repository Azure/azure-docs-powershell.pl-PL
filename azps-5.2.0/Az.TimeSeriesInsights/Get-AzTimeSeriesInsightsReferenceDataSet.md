...
### Przykład 1: wyświetlanie wszystkich zestawów danych referencyjnych w ramach określonego środowiska
```powershell
...
To polecenie wyświetla listę wszystkich zestawów danych źródłowych w ramach określonego środowiska.

### Przykład 2: uzyskiwanie określonych danych referencyjnych ustawionych według nazwy
```powershell
...
To polecenie pobiera określony zestaw danych referencyjnych.

### Przykład 3: uzyskiwanie określonych danych referencyjnych ustawionych według obiektów
```powershell
