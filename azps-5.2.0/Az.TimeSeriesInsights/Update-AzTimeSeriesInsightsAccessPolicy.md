...
### Przykład 1: aktualizowanie określonych zasad dostępu według nazwy
```powershell
...
To polecenie aktualizuje określone zasady dostępu.

### Przykład 2: aktualizowanie określonych zasad dostępu według obiektów
```powershell
