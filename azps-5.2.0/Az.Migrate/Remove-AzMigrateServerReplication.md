...
## STRESZCZENIe
Zatrzymuje replikację zmigrowanego serwera.
...
### Przykład 1: Usuwanie według identyfikatora.
```powershell
...
Ponowna synchronizacja według identyfikatora.

### Przykład 2: usuwanie przez obiekt wejściowy
```powershell
...
### -ForceRemove
Określa, czy należy wymusić usunięcie replikacji.
...
### -TargetObjectID
Określa serwer replcating, dla którego należy wyłączyć replicatio.
