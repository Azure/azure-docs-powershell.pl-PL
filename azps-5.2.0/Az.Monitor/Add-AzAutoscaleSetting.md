...
## Opis
Polecenie cmdlet **Add-AzAutoscaleSetting** powoduje utworzenie ustawienia skalowania automatycznego.
...
W dwóch pierwszych poleceniach użyto poleceń [New-AzAutoscaleRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscalerule) w celu utworzenia dwóch reguł autoskalowania $Rule 1 i $Rule 2.
W trzecim i czwartym menu są tworzone profile autoskalowania $Profile [AzAutoscaleProfile](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscaleprofile) 1 i $profile 2, przy użyciu $Rule 1 i $Rule 2.
...
### -Inputobject
Kompletna Specyfikacja AutoscaleSetting
...
### System. Collections. Generic. list "1 [[Microsoft. Azure. Management. Monitor. Management.. AutoscaleProfile; Microsoft. Azure. PowerShell. cmdlets.

### System. Collections. Generic. list "1 [[Microsoft. Azure. Management. Monitor. Management.. AutoscaleNotification; Microsoft. Azure. PowerShell. cmdlets.
