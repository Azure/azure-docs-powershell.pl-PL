...
## Opis
Utwórz obiekt PSMetricSettings lub PSLogSettings. Kategorie można uzyskiwać za pomocą funkcji `Get-AzDiagnosticSettingCategory` .
...
Utwórz obiekt PSMetricSettings.
...
### -Log
Aby utworzyć ustawienia dziennika
...
### -Metric
Aby utworzyć ustawienie metryki
...
### -TimeGrain
TimeGrain dla ustawienia metryki
