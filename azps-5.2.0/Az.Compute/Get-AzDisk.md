...
## Opis
Polecenie cmdlet **Get-AzDisk** pobiera właściwości dysku zarządzanego.
...
To polecenie pobiera właściwości wszystkich dysków pod nazwą subskrypcji, rozpoczynając od win1_OsDisk.
