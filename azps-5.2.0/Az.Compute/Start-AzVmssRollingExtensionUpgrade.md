...
## STRESZCZENIe
To polecenie cmdlet rozpoczyna uaktualnianie stopniowe wszystkich rozszerzeń na danej skali maszyny wirtualnej do najnowszej dostępnej wersji. 
...
## Opis
Rozpoczyna uaktualnienie stopniowe, aby przenieść wszystkie rozszerzenia tej skali maszyny wirtualnej na najnowszą dostępną wersję.
Rozszerzenia, na których jest już uruchomiona najnowsza dostępna wersja, nie ulegają zmianie.
...
W tym przykładzie jest pobierany istniejący zestaw skali maszyny wirtualnej "MyVmssName" i dodano do niego rozszerzenie. Polecenie ostatnie uruchamia proces uaktualniania stopniowego. 
