...
Określ parametr *status* , aby uzyskać widok wystąpienia maszyny wirtualnej zamiast widoku modelu, który jest domyślny.
...
### Przykład 6: pobieranie wszystkich maszyn wirtualnych przy użyciu filtrowania
```
...
To polecenie umożliwia pobieranie wszystkich maszyn wirtualnych w subskrypcji, które zaczynają się od tekstu "test".
