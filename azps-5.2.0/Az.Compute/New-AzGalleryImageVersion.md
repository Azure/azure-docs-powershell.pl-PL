...
Tworzenie Zdjęcia z galerii za pomocą szyfrowania obrazu dysku.
...
### -DataDiskImage
Obrazy na dyskach danych.   na przykład @ {Source = @ {ID =<source_id>}; LUN = 1; SizeInGBd = 100; HostCaching = "ReadOnly"}
...
### -OSDiskImage
Obraz dysku systemu operacyjnego, na przykład @ {Source = @ {ID =<source_id>}; SizeInGBd = 100; HostCaching = "ReadOnly"}
...
### -StorageAccountType
Określa typ konta magazynu, który ma być wykorzystywany do przechowywania obrazu. Tej właściwości nie można aktualizować. Dostępne wartości to Standard_LRS, Standard_ZRS i Premium_LRS.
