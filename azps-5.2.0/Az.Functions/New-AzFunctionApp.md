...
### Przykład 1: Tworzenie aplikacji do obsługi funkcji programu PowerShell w centrum Central my.
```powershell
...
To polecenie tworzy aplikację funkcji programu PowerShell w centrum Central my.
...
To polecenie tworzy aplikację funkcji programu PowerShell, która będzie hostowana w planie usług.
...
To polecenie tworzy aplikację funkcji przy użyciu obrazu prywatnego ACR.

## PARAMETRÓW

### -ApplicationInsightsKey
Klucz Instrumentacji aplikacji, który ma zostać dodany.
...
Wyłączenie tworzenia zasobu usługi Application Insights podczas tworzenia aplikacji funkcji.
Żadne dzienniki nie będą dostępne.
...
### -DockerImageName
Tylko Linux.
Nazwa obrazu kontenera z rejestru dokowania, na przykład "Publisher/Image-Name": znacznik.
...
Wymagane w przypadku prywatnych kancelarii.
...
### -IdentityType
Określa typ tożsamości używanej przez aplikację funkcji.
Dopuszczalne wartości tego parametru to:-SystemAssigned-UserAssigned
...
### -Nowait
Rozpoczyna operację i wraca natychmiast, zanim operacja zostanie ukończona.
W celu ustalenia, czy operacja została wykonana pomyślnie, użyj innego mechanizmu.
...
### -OSType
System operacyjny do obsługi aplikacji funkcji.
