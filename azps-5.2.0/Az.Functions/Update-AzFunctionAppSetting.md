...
To polecenie umożliwia dodanie nowego ustawienia aplikacji w aplikacji funkcji.

## PARAMETRÓW

### -AppSetting
Hashtable za pomocą klawiszy i wartości opisują ustawienia aplikacji, które mają zostać dodane lub zaktualizowane w aplikacji funkcji.
...
### -Force
Wymusza zaktualizowanie funkcji polecenia cmdlet do poziomu aplikacji bez monitowania o potwierdzenie.
