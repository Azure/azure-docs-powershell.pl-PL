...
Pobiera systemAssignedIdentity dostępną w ramach określonego zakresu RP.

### [GetAzWebAppConfig](GetAzWebAppConfig.md)


### [Get-AzWebAppFunctionKey](Get-AzWebAppFunctionKey.md)
Opis funkcji pobierania dla klawiszy funkcyjnych w witrynie sieci Web lub w miejscu wdrożenia.
...
Opis pobiera ustawienia i stan aplikacji odniesienia konfiguracji

### [Get-AzWebAppSyncStatus](Get-AzWebAppSyncStatus.md)
Opis tej funkcji zezwala na rozmowy za pośrednictwem szablonu programu PowerShell i usługi ARM.
...
Opis metadanych wyzwalacza funkcji synchronizacji z bazą danych zarządzania
