...
### Przykład 1: pobieranie wszystkich aplikacji funkcji.
```powershell
...
### Przykład 2: Uzyskaj aplikacje funkcji według nazwy.
```powershell
...
### Przykład 3: pobieranie aplikacji funkcji według nazwy grupy zasobów.
```powershell
...
### Przykład 4: pobieranie aplikacji funkcji dla danych subskrypcji.
```powershell
...
### Przykład 5: pobieranie aplikacji funkcji według lokalizacji.
```powershell
...
### -IncludeSlot
Umożliwia określenie, czy w wynikach mają być uwzględniane gniazda wdrożenia.
