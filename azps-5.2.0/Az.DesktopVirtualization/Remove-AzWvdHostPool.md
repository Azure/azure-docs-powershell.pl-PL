...
### Przykład 1: usuwanie pulpitu wirtualnego systemu HostPool według nazwy
```powershell
PS C:\> Remove-AzWvdHostPool -ResourceGroupName ResourceGroupName -Name HostPoolName
```

To polecenie usuwa HostPool pulpitu wirtualnego systemu Windows w grupie zasobów.
...
### -Force
Wymuszaj flagę usuwania sessionHost.
