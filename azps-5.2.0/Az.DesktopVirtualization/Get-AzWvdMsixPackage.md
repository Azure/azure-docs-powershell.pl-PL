...
### Przykład 1: Uzyskaj pakiet MSIX według nazwy
```powershell
...
To polecenie pobiera pakiet MSIX w HostPool.
...
To polecenie wyświetla listę pakietów MSIX w HostPool.
...
### Microsoft. Azure. PowerShell. polecenia. DesktopVirtualization. models. Api20201019Preview. IMsixPackage
