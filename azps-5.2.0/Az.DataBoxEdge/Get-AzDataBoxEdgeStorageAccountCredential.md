...
## Opis
Polecenie cmdlet **Get-AzDataBoxEdgeStorageAccountCredential** Pobiera poświadczenia konta magazynu dla odpowiedniego konta magazynu na urządzeniu z danymi na krawędziach pola danych. Możesz określić nazwę, nazwę grupy zasobów i parametry nazwy urządzenia, aby uzyskać informacje o poświadczeniach określonego konta magazynu.
