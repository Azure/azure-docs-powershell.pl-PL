...
## Opis
Polecenie cmdlet **Get-AzDataBoxEdgeStorageContainer** Pobiera kontener magazynu dla konta magazynu Edge na urządzeniu z danymi na krawędziach pola danych. Możesz określić nazwę jako parametr w poleceniu cmdlet, aby pobrać szczegóły określonego kontenera magazynu. 
