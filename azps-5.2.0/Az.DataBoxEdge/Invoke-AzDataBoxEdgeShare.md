...
## Opis
Polecenie cmdlet **Invoke-AzDataBoxEdgeShare** umożliwia wywołanie akcji dotyczącej odświeżania danych w udziale na urządzeniu z danymi na krawędziach pola danych.
...
### -RefreshData
Odświeżanie metadanych udziału przy użyciu danych z chmury
