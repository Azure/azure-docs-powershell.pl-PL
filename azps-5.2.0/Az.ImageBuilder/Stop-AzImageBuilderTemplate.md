...
### Przykład 1: zatrzymywanie tworzenia szablonu obrazu
```powershell
...
To polecenie powoduje zatrzymanie tworzenia szablonu obrazu.

### Przykład 2: zatrzymywanie tworzenia szablonu obrazu
```powershell
PS C:\> Start-AzImageBuilderTemplate -ImageTemplateName template-name-sn78hg -ResourceGroupName wyunchi-imagebuilder -AsJob 
