...
### Przykład 1: wyświetlanie wszystkich wyników uruchamiania na podstawie szablonu
```powershell
...
To polecenie wyświetla wszystkie wyniki uruchamiania pod szablonem.

### Przykład 2: uzyskiwanie wyniku uruchomienia pod szablonem
```powershell
...
To polecenie uzyskuje wynik uruchomienia pod szablonem.

### Przykład 3: uzyskiwanie wyniku uruchomienia pod szablonem
```powershell
...
### Microsoft. Azure. PowerShell. polecenia. ImageBuilder. models. Api20200214. IRunOutput
