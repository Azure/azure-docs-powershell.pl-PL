...
### Przykład 1: Dodawanie profilu zabezpieczeń do obiektu konfiguracji klastra
```
...
To polecenie dodaje wartość profilu zabezpieczeń do klastra o nazwie Your-Hadoop-001.
...
### -DomainResourceId
Identyfikator zasobu domeny usługi Active Directory dla klastra.
