...
### Przykład 1: Lista prywatna chmura w ramach abonamentu
```powershell
...
Lista prywatnej chmury w ramach subskrypcji

### Przykład 2: Lista prywatna chmura w obszarze Grupa zasobów
```powershell
...
Lista prywatna chmura w obszarze Grupa zasobów

### Przykład 3: Uzyskaj prywatną chmurę
```powershell
