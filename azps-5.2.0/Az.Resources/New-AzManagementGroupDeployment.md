...
## Opis
Polecenie cmdlet **New-AzManagementGroupDeployment** umożliwia dodanie wdrożenia w grupie zarządzania.
...
Aby dodać zasoby w zakresie dzierżawy, użyj **nowego-AzTenantDeployment** , który tworzy wdrożenie w zakresie dzierżawy.
...
To polecenie tworzy nowe wdrożenie w grupie zarządzania "myMG" przy użyciu szablonu niestandardowego i pliku szablonu na dysku z parametrem defined Tags.
...
To polecenie tworzy nowe wdrożenie w grupie zarządzania "myMG" przy użyciu szablonu niestandardowego i pliku szablonu na dysku, który został przekonwertowany na obiekt Hashtable znajdujący się w pamięci.
