...
To polecenie pobiera What-If wynik w zakresie dzierżawy przy użyciu pliku szablonu niestandardowego i pliku parametrów na dysku.
...
### Przykład 2: uzyskiwanie What-If wyniku w zakresie dzierżawy przy użyciu ResourceIdOnly
```powershell
PS C:\> Get-AzTenantDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
