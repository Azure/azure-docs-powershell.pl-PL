...
3) NotDataActions: zestaw operacji, które muszą być wykluczone z akcji dataactions, aby określić efektywne akcje danych dla roli niestandardowej.
...
### Przykład 1. Tworzenie przy użyciu PSRoleDefinitionObject
```powershell
