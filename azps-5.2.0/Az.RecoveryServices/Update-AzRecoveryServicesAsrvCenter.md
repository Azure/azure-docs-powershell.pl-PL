...
## Opis
Polecenie cmdlet **Update-AzRecoveryServicesAsrvCenter** jest aktualizacją szczegółów wykrywania dla zarejestrowanego vCenter.
...
### — Konto
konto z poświadczeniami logowania vCenter.
...
### -Inputobject
Obiekt serwera vCenter, dla którego mają zostać zaktualizowane szczegóły dotyczące odnajdowania.
