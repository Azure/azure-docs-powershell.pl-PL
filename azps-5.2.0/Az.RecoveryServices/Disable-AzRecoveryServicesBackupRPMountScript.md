...
## Opis
Polecenie cmdlet Disable-AzRecoveryServicesBackupRPMountScript Odinstalowuje pliki punktu odzyskiwania, które zostały zainstalowane wcześniej za pomocą Get-AzRecoveryServicesBackupRPMountScript polecenia cmdlet.

## Przykłady

### Przykład 1: Odinstalowywanie punktu odzyskiwania
```powershell
...
Odinstalowuje wszystkie pliki punktu odzyskiwania. (autogenerowana)
