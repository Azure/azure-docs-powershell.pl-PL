...
Polecenie cmdlet rejestruje maszynę wirtualną platformy Azure jako kontener dla usługi MSSQL do obsługi obciążeń.
...
### -Obciążenia
Typ obciążenia pracą zasobu. Bieżąca obsługiwana wartość to AzureVM, WindowsServer, AzureFiles, MSSQL
