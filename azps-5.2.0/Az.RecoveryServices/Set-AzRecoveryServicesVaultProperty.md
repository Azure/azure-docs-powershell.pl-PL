...
## Opis
Polecenie cmdlet **Set-AzRecoveryServicesVaultProperty** aktualizuje właściwości magazynu usług odzyskiwania.
To polecenie cmdlet zwraca zaktualizowane właściwości magazynu po bieżącej operacji set.
Za pomocą tych właściwości polecenia cmdlet magazynu, takich jak Soft-Delete, można włączyć w dowolnym momencie.
Właściwość **SoftDeleteFeatureState** magazynu może być wyłączona tylko wtedy, gdy w magazynie nie ma zarejestrowanych kontenerów.
