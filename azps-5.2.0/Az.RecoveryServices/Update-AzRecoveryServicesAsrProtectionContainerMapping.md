...
### AzureToAzureEnableAutoUpdate (domyślny)
```
...
## Opis
Polecenie cmdlet **Update-AzRecoveryServicesAsrProtectionContainerMapping** aktualizuje określone mapowanie kontenera ochrony usługi Azure Site Recovery.
...
Rozpocznij operację wyłączania automatycznej aktualizacji kontenera.
...
Rozpocznij operację wyłączania Włącz automatyczne aktualizowanie kontenera.

## PARAMETRÓW

### -AutomationAccountId
Określa identyfikator accountId służący do automatycznego udpate.
...
### -AzureToAzure
Określa kontener ochrony platformy Azure na platformie Azure.
...
### -DisableAutoUpdate
Parametr Switch umożliwiający wyłączenie automatycznej aktualizacji.
...
### -EnableAutoUpdate
Parametr Switch umożliwiający włączenie automatycznej aktualizacji.
...
### -Inputobject
Obiekt mapowania kontenera ochrony.
