...
## STRESZCZENIe
Aktualizuje lub tworzy ofertę w sklepie prywatnym.
...
## Opis
Umożliwia aktualizowanie lub tworzenie oferty dla prywatnego magazynu utworzonego w ramach zakresu dzierżawy.
...
Tworzenie oferty z prywatnymi i publicznymi planami dla prywatnego magazynu, które zostały utworzone w ramach zakresu dzierżawy. 
...
Umożliwia tworzenie oferty za pomocą planów prywatnych tylko w przypadku prywatnego magazynu, który został utworzony w ramach zakresu subskrypcji. 
...
Aktualizacje oferują prywatne i publiczne plany dla prywatnego sklepu, które zostały utworzone w ramach zakresu dzierżawy. Potrzebny jest element ETag.
...
Aktualizacje są oferowane tylko w sklepie prywatnym z planami prywatnymi, które zostały utworzone w ramach zakresu subskrypcji. Potrzebny jest element ETag.
...
### -ETag
Element eTag oferty usługi Azure Marketplace privateStore do aktualizacji
...
### -OfferId
Wymagana oferta usługi Azure Marketplace privateStore
...
### -PrivateStoreId
Wymagane oferty usługi Azure Marketplace privateStore
...
Wymagane ograniczenia dotyczące identyfikatorów planu dla usługi Azure Marketplace privateStore oferta
...
### Microsoft. Azure. Commands. Marketplace. modele. PrivateStore. PSPrivateStoreOffer
