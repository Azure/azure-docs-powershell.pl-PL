...
## Opis
Polecenie **Get-AzDataFactoryV2PipelineRun** zwraca informacje dotyczące uruchamiania określonego potoku. Jeśli PipelineRunId jest określony, wyświetlane są szczegóły dotyczące uruchamiania z tym IDENTYFIKATORem. Jeśli nie podano PipelineRunId, wyświetlane są informacje o wszystkich przebiegach dla rurociągów, które wystąpiły między wartościami LastUpdatedAfter i LastUpdatedBefore.

## Przykłady

### Przykład 1: uzyskiwanie informacji o uruchomieniu rurociągu
```
