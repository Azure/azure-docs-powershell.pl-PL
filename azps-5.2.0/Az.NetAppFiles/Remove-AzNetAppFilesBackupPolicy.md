...
## Opis
Polecenie cmdlet **Remove-AzNetAppFilesBackupPolicy** usuwa ANFą zasadę tworzenia kopii zapasowych.
...
To polecenie usuwa nowe zasady ANF kopii zapasowej z nazwą "MyBackupPolicy" dla konta "Moje konto".
...
### -Accountobject
Obiekt konta zawierający zasady tworzenia kopii zapasowych do usunięcia
...
### -PassThru
Zwraca, czy określone zasady tworzenia kopii zapasowych zostały pomyślnie usunięte
