...
To polecenie usuwa nową ANF kopię zapasową z nazwą "Moja kopia zapasowa" dla woluminu "Moja głośność".
...
### -PassThru
Zwraca, czy określona kopia zapasowa została pomyślnie usunięta.
