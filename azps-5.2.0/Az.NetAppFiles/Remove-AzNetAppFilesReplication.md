...
To polecenie usuwa połączenie replikacji ANF w woluminie "MyDestinationAnfVolume".
...
### -Inputobject
Wolumin docelowy ANF z replikacją do usunięcia
...
### -PassThru
Zwraca, czy określona replikacja ANF została pomyślnie usunięta.
