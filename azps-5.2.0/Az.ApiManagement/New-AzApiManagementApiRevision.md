...
Polecenie cmdlet **New-AzApiManagementApiRevision** tworzy poprawkę API dla istniejącego interfejsu API w kontekście zarządzania interfejsem API.

## Przykłady

### Przykład 1: Tworzenie pustej wersji interfejsu API dla interfejsu API
```powershell
...
To polecenie tworzy wersję API `5` `echo-api` interfejsu API.
...
### -ApiRevisionDescription
Opis poprawki API. Ten parametr jest opcjonalny.
...
### -ServiceUrl
Adres URL usługi sieci Web, która uwidacznia interfejs API w usłudze wewnętrznej bazy danych. Ten adres URL będzie wykorzystany tylko przez funkcję zarządzania interfejsem Azure API i nie zostanie udostępniony publicznie. Musi zawierać od 1 do 2000 znaków. Ten parametr jest wymagany.
