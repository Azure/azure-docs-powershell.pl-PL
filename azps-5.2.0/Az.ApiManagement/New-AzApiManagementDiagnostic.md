...
## Opis
Polecenie cmdlet **New-AzApiManagementDiagnostic** tworzy jednostkę diagnostyczną w zakresie globalnym lub w konkretnym zakresie interfejsu API.

## Przykłady

### Przykład 1. Tworzenie nowego globalnego zakresu diagnostycznego
```powershell
...
W tym przykładzie pokazano, jak utworzyć jednostkę diagnostyczną w zakresie globalnym.
...
Powyższym przykładem jest utworzenie diagnostycznego interfejsu API `httpbin` w celu zarejestrowania nagłówka i 100 bajtów treści do `azuremonitor` rejestratora.
...
Jeśli określisz, ustaw zasady dotyczące zakresu interfejsu API.
