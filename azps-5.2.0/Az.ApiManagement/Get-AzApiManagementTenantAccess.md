...
## Opis
Polecenie cmdlet **Get-AzApiManagementTenantAccess** Pobiera konfigurację dostępu dzierżawy dla dzierżawy.
Klucze nie zostaną uwzględnione w szczegółach wyników. Aby uzyskać klucz tajny klienta, użyj polecenie **Get-AzApiManagementTenantAccessSecret**.
