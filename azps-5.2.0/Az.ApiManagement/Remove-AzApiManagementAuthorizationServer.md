...
## Opis
Polecenie cmdlet **Remove-AzApiManagementAuthorizationServer** usuwa serwer autoryzacji zarządzania interfejsem Azure API.
...
To polecenie powoduje usunięcie określonego serwera autoryzacji zarządzania interfejsem API.
...
### -ServerId
Określa identyfikator serwera autoryzacji, który ma zostać usunięty.
