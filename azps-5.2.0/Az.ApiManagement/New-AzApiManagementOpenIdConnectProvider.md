...
## Opis
Polecenie cmdlet **New-AzApiManagementOpenIdConnectProvider** umożliwia utworzenie dostawcy usługi OpenID Connect w usłudze Azure API Management.
...
To polecenie tworzy **dostawcę** OpenID Connect o nazwie contoso OpenID Connect Provider

### Przykład 2

Tworzy dostawcę OpenID Connect. (autogenerowana)
