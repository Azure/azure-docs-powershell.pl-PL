...
## Opis
Polecenie cmdlet **New-AzApplicationGatewayRewriteRule** umożliwia utworzenie reguły ponownego zapisu dla bramy aplikacji platformy Azure.

## Przykłady

### Przykład 1: Tworzenie reguły ponownego zapisu dla bramy aplikacji
```powershell
PS C:\> $rule = New-AzApplicationGatewayRewriteRule -Name rule1 -ActionSet $action -RuleSequence 101 -Condition $condition
```

To polecenie umożliwia utworzenie reguły zapisu o nazwie RULE1 i zapisanie wyniku w zmiennej o nazwie $rule.

## PARAMETRÓW

### -ActionSet
ActionSet reguły ponownej edycji
...
### -Warunek
Warunek reguły ponownego zapisu do wykonania
...
### -RuleSequence
Kolejność reguły tej reguły ponownie zapisu w zestawie reguł ponownej edycji
