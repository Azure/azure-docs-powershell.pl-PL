...
### ByVpnServerConfigurationNameByCertificateAuthentication (domyślny)
```
...
## Opis
Polecenie cmdlet **New-AzVpnServerConfiguration** umożliwia tworzenie nowych VpnServerConfiguration przy użyciu różnych VpnProtocols, VpnAuthenticationTypes, IpsecPolicies i Ustawianie wybranych parametrów związanych z typem uwierzytelniania sieci VPN zgodnie z wymaganiami klienta dotyczącymi łączności witryny.
...
Powyższe polecenie utworzy nowy VpnServerConfiguration z VpnAuthenticationType jako certyfikat.

### Przykład 2

Utwórz nowy VpnServerConfiguration, aby wskazać łączność witryny. (autogenerowana)
...
### -AadAudience
Grupa odbiorców AAD dla uwierzytelniania w usłudze AAD P2S.
...
### -AadIssuer
Wystawca AAD dla uwierzytelniania w usłudze P2S w usłudze AAD.
...
### -AadTenant
Dzierżawa AAD na potrzeby uwierzytelniania w usłudze P2S w usłudze AAD.
...
Lista zasad IPSec dla VpnServerConfiguration.
...
Lista ścieżek VpnClientCertificates do odwołania plików
...
Lista ścieżek plików VpnClientRootCertificates do dodania
