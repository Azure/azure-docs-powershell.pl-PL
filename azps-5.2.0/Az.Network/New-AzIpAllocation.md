...
## Opis
Polecenie cmdlet **New-AzIpAllocation** tworzy składnik Azure IpAllocation
...
### -IpAllocationTag
Znaczniki przydziału dla przydziału adresu IP
...
### -IpamAllocationId
Identyfikator przydziału usługi IPAM przydziału adresów IP
...
### -PrefixLength
Długość prefiksu przydziału adresu IP
...
### -Prefixtype
Typ prefiksu przydziału adresu IP
