...
```
Powyższe polecenia otrzymają RoutingConfiguration już istniejący AzVHubRoute, a następnie dodają trasę statyczną w połączeniu. Możesz również w przypadku, gdy mamy nadzieję, by utworzyć nowe połączenie z trasą statyczną, zapoznaj się z przykładem 1 [.](New-AzRoutingConfiguration.md)
## PARAMETRÓW
