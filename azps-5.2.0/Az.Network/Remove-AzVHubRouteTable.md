...
## Opis
Usuwa określoną tabelę tras centrum, która jest skojarzona z określonym koncentratorem wirtualnym.
...
### -Inputobject
Zasób vhubroutetable do usunięcia.
...
### -ResourceId
Identyfikator zasobu vhubroutetable, który ma zostać usunięty.
