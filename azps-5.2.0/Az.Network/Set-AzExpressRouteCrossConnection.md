...
## Opis
Polecenie cmdlet **Set-AzExpressRouteCrossConnection** zapisuje zmodyfikowane ExpressRoute krzyżowe połączenie z usługą Azure.

## Przykłady

### Przykład 1. Zmień stan inicjowania obsługi dostawcy usług w połączeniu krzyżowym ExpressRoute
```
...
Określa obiekt **ExpressRouteCrossConnection** , który jest modyfikowany przez to polecenie cmdlet.
...
### -Peer
Lista połączeń z użytkownikami połączeń krzyżowych
...
Uwagi dotyczące dostawcy usług
...
Stan inicjowania obsługi dostawcy usług
