...
### ByPublicIpAddressByVirtualNetwork (domyślny)
```
...
## Opis
Tworzy zasób Bastion. Będzie to wymagał publicznego adresu IP i VirtualNetwork. W tym VirtualNetwork musi istnieć podsieć o nazwie AzureBastionSubnet. adres IP Pubic należy utworzyć przy użyciu standardu SKU.
...
### -PublicIpAddress
Obiekt publiczny adres IP dla Bastion.
...
### -PublicIpAddressId
Publiczny adres IP Azure ID zasobu usługi Azure dla Bastion.
...
### -PublicIpAddressName
Nazwa zasobu publicznego adresu IP dla Bastion.
...
Nazwa grupy zasobów publicznego adresu IP dla Bastion.
...
### -ResourceGroupName
Nazwa grupy zasobów, w której trzeba utworzyć Bastion.
...
### -VirtualNetwork
Wirtualny obiekt sieciowy dla Bastion.
...
### -VirtualNetworkId
Identyfikator zasobu platformy Azure w sieci wirtualnej dla Bastion.
...
### -VirtualNetworkName
Nazwa zasobu sieci wirtualnej dla Bastion.
...
Nazwa grupy zasobu sieci wirtualnej dla Bastion.
