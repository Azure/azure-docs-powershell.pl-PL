...
## Opis
Polecenie cmdlet **Get-AzAvailableServiceDelegation** umożliwia pobieranie wszystkich dostępnych delegowań usługi dla podsieci w podanej lokalizacji. W tym poleceniu cmdlet *nie* opisano, które delegacje mogą współistnieć w jednej podsieci.

## Przykłady

### 1: uzyskiwanie wszystkich dostępnych delegowań usług
```powershell
