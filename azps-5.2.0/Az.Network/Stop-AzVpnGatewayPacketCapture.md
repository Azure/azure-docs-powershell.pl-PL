...
## STRESZCZENIe
Zatrzymuje operację przechwytywania pakietów na bramie VPN.
...
## Opis
Zatrzymuje operację przechwytywania pakietu na bramie VPN i przekazuje wynik w podanym SasUrlu magazynu.
...
### -Inputobject
Obiekt bramy sieci VPN, w którym jest uruchamiany przechwytywanie pakietów.
...
### -Name (nazwa)
Nazwa bramy sieci VPN, w której ma zostać rozpoczęte przechwytywanie pakietów.
...
### -ResourceId
Identyfikator zasobu platformy Azure VpnGateway, w którym jest uruchamiane przechwytywanie pakietów.
...
### -SasUrl
Przechwytywanie pakietów przez adres URL SAS w bramie VPN.
