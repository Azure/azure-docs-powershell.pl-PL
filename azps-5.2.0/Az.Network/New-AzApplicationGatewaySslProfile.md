...
## Opis
Polecenie cmdlet **New-AzApplicationGatewaySslProfile** tworzy profil SSL dla bramy aplikacji. Profil SSL jest konfigurowany na odbiornikach HTTPS.
...
```
Pierwsze polecenie tworzy nowe zasady SSL i zapisuje je w zmiennej $sslPolicy.
Drugie polecenie tworzy łańcuchy certyfikatów zaufanego urzędu certyfikacji klienta i zapisuje je w zmiennej $ClientCert 01.
Trzecie polecenie Utwórz nowy profil SSL z łańcuchem certyfikatów zasada SSL i zaufany certyfikat CA klienta.
