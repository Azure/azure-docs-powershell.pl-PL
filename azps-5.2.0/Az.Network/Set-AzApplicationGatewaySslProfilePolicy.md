...
## STRESZCZENIe
Modyfikuje zasady SSL profilu SSL bramy aplikacji.
...
## Opis
Polecenie cmdlet **Set-AzApplicationGatewaySslProfilePolicy** modyfikuje zasady SSL profilu SSL bramy aplikacji.
...
Lista protokołów SSL do wyłączenia
