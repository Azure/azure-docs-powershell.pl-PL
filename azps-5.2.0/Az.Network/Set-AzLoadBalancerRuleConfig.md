...
## Opis
Polecenie cmdlet **Set-AzLoadBalancerRuleConfig** umożliwia zaktualizowanie konfiguracji reguły dla modułu równoważenia obciążenia.
...
Drugie polecenie używa operatora potoku w celu przekazania modułu równoważenia obciążenia w $slb do polecenia Add-AzLoadBalancerRuleConfig, które umożliwia dodanie reguły o nazwie NewRule.
Trzecia komenda przekazuje modułowi równoważenia obciążenia **wartość Set-AzLoadBalancerRuleConfig**, która ustawia konfigurację nowej reguły.
...
To polecenie cmdlet umożliwia zaktualizowanie konfiguracji reguły dla modułu równoważenia obciążenia, który określa ten parametr.
