...
### ByVirtualHubNameByRemoteVirtualNetworkObject (domyślny)
```
...
Polecenie cmdlet New-AzVirtualHubVnetConnection tworzy zasób HubVirtualNetworkConnection, który jest równorzędny siecią wirtualną do wirtualnego centrum usługi Azure. (autogenerowana)
...
```
Powyższy sposób spowoduje utworzenie nowej konfiguracji routingu i utworzenie tras statycznych w konfiguracji routingu z następnym przeskokiem w określonym adresie IP. Taka konfiguracja routingu może zostać przekazana do polecenia New-AzVirtualHubVnetConnection jako parametr-RoutingConfiguration.
...
Zdalna Sieć wirtualna, do której jest podłączone połączenie z siecią wirtualną centrum.
