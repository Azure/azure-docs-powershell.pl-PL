...
Po utworzeniu bramy jest ona połączona z ExpressRouteSite przy użyciu polecenia New-AzExpressRouteConnection.

Następnie połączenie zostanie usunięte za pomocą nazwy połączenia.
...
Taki sam jak przykład 1, ale teraz usuwa połączenie przy użyciu obiektu potokowego z polecenia Get-AzExpressRouteConnection.
