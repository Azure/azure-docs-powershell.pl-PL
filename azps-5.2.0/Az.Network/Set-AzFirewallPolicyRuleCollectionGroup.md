...
## Opis
Polecenie cmdlet **Set-AzFirewallPolicyRuleCollectionGroup** aktualizuje grupy kolekcji reguł w zasadach zapory platformy Azure.
...
W tym przykładzie jest aktualizowana Grupa kolekcji reguł w $fp zasad zapory

### Przykład 2

zapisuje zmodyfikowaną grupę kolekcji reguł zasad zapory platformy Azure. (autogenerowana)
