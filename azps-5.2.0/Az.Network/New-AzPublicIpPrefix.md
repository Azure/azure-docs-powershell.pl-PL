...
### Przykład 1. Tworzenie nowego publicznego prefiksu adresu IP
```powershell
...
### Przykład 2: Tworzenie nowego globalnego publicznego prefiksu adresu IP
```powershell
...
To polecenie tworzy nowy globalny publiczny adres IP. 
...
### -CustomIpPrefix
CustomIpPrefix, z którym ten PublicIpPrefix będzie skojarzony
...
### -Warstwowy
Warstwa SKU prefiksu publicznego adresu IP.
