...
## Opis
Polecenie cmdlet **Remove-AzVirtualNetwork** usuwa sieć wirtualną Azure.

## Przykłady

### 1: Tworzenie i usuwanie sieci wirtualnej
```
...
W tym przykładzie przedstawiono tworzenie sieci wirtualnej w grupie zasobów, a następnie natychmiastowe jej usunięcie. Aby zapobiec wyświetlaniu monitu podczas usuwania sieci wirtualnej, Użyj flagi-Force.
...
### -Name (nazwa)
Określa nazwę sieci wirtualnej, która zostanie usunięta przez to polecenie cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów zawierającej sieć wirtualną, która zostanie usunięta przez to polecenie cmdlet.
