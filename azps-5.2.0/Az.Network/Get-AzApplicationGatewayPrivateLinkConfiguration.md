...
## STRESZCZENIe
Pobiera prywatną konfigurację linku do bramy aplikacji.
...
## Opis
Polecenie cmdlet **Get-AzApplicationGatewayPrivateLinkConfiguration** pobiera prywatną konfigurację linku do bramy aplikacji.
...
Drugie polecenie pobiera konfigurację linku prywatnego o nazwie privateLinkConfig01 z $AppGw i zapisuje ją w zmiennej $PrivateLinkConfiguration.

### Przykład 2: uzyskiwanie listy konfiguracji prywatnego linku
```powershell
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
...
Pierwsze polecenie pobiera bramkę Application Gateway o nazwie ApplicationGateway01 z grupy zasobów o nazwie ResourceGroup01 i zapisuje ją w zmiennej $AppGw.
Drugie polecenie pobiera wszystkie konfiguracje linków prywatnych z $AppGw i zapisuje je w zmiennej $PrivateLinkConfigurations.
...
### -Name (nazwa)
Nazwa konfiguracji usługi Application Gateway privateLink
