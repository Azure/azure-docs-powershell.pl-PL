...
## Opis
Polecenie cmdlet **Get-AzP2sVpnGateway** umożliwia otrzymywanie istniejących P2SVpnGateway w obszarze VirtualHub.
...
Polecenie cmdlet **Get-AzP2sVpnGateway** umożliwia pobieranie istniejących P2SVpnGateway w obszarze VirtualHub, które są używane do wskazywania łączności witryny.
