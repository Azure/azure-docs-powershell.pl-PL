...
## STRESZCZENIe
Tworzy nowy obiekt typu PSCompositePath. Może on zostać przekazany jako wartość parametru w parametrze Set-AzCosmosDBGremlinGraph.
...
## Opis
Obiekt odpowiadający CompositePath API Gremlin.
