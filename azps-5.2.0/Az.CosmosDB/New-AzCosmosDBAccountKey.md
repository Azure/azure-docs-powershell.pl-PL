...
Nowe klucze są generowane dla konta o nazwie dbname (nazwa konta) w RG.

### Przykład 2

Ponowne generowanie danego klucza konta CosmosDB. (autogenerowana)
...
### -Rodzaj
Klawisz dostępu do ponownego wygenerowania.
Akceptowane wartości: podstawowe, primaryReadonly, dodatkowe, secondaryReadonly
