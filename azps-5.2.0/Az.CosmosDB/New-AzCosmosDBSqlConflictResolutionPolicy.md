...
## STRESZCZENIe
Tworzy nowy obiekt typu PSSqlConflictResolutionPolicy. Może on zostać przekazany jako wartość parametru w parametrze Set-AzCosmosDBSqlContainer.
...
## Opis
Obiekt odpowiadający ConflictResolutionPolicy API funkcji SQL.
