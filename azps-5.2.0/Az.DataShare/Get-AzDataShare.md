...
## Opis
Polecenie cmdlet **Get-AzDataShare** pobiera informacje o udziałach danych w accoount udostępniania danych platformy Azure.
Jeśli określisz nazwę udziału danych, to polecenie cmdlet będzie pobierać informacje o udziale danych.
Jeśli nie określisz nazwy, to polecenie cmdlet będzie pobierać informacje o wszystkich udziałach danych w koncie udziału danych platformy Azure.

## Przykłady

### Przykład 1: uzyskiwanie określonego udziału danych
```
...
To polecenie wyświetla informacje o udziale danych AdsShare w WikiAdsAccount kont udostępniania danych usługi Azure oraz w REKLAMach grup zasobów.
