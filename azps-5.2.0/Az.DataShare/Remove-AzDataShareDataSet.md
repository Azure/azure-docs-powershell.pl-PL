...
## Opis
Polecenie cmdlet **Remove-AzDataShareDataSet** umożliwia usunięcie zestawu danych.
...
To polecenie usuwa zestaw danych o nazwie DS z WikiAds udostępniania. 
...
### -Inputobject
Obiekt zestawu danych platformy Azure.
