...
### -MatchValue
Dopasuj wartości do.
Operator będzie stosować się do każdej wartości w tym miejscu lub z semantyką.
Jeśli którykolwiek z tych elementów odpowiada zmiennej z danym operatorem, ten warunek dopasowywania jest traktowany jako odpowiednik.
...
### -MatchVariable
Zmienna dopasowania.
Możliwe wartości to IsMobile, RemoteAddr, RequestMethod, QueryString, PostArg, RequestUri, RequestPath, RequestFileName, RequestfilenameExtension, RequestHeader, RequestBody, RequestScheme
...
### -NegateCondition
W tym artykule opisano, czy jest to warunek Negate
...
### -Operator
W tym artykule opisano operator, którego należy użyć do warunku dopasowywania.
Możliwe wartości to dowolny, IPMatch, geodopasowanie, równa się, Contains, LessThan, GreaterThan, LessThanOrEqual, GreaterThanOrEqual, BeginsWith, EndsWith.
...
### -Transform
Lista elementów przekształceń, które są stosowane przed dopasowaniem. Możliwe wartości poszczególnych przekształceń to małe, wielkie, przycinanie, UrlDecode, UrlEncode, RemoveNulls.
