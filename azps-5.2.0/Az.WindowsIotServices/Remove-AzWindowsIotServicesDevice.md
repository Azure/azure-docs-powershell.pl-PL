...
### Przykład 1: Usuwanie usług IoT systemu Windows według nazw
```powershell
PS C:\> Remove-AzWindowsIotServicesDevice -Name wsi-t03 -ResourceGroupName azure-rg-test

```

To polecenie powoduje usunięcie usług IoT systemu Windows według nazwy.

### Przykład 2: Usuwanie usług IoT systemu Windows według rurociągu
```powershell
...
To polecenie usuwa usługi Windows IoT według rurociągu.
