...
## STRESZCZENIe
Pobiera elementy równorzędne wirtualnej przestrzeni roboczej.
...
### Przykład 1: wyświetlanie wszystkich elementów równorzędnych wirtualnej w ramach datakostki
```powershell
...
To polecenie wyświetla listę wszystkich elementów równorzędnych wirtualnej w obszarze datakostki.

### Przykład 2: uzyskiwanie komunikacji równorzędnej VNET
```powershell
...
To polecenie umożliwia pobieranie komunikacji równorzędnej sieci VNET.

### Przykład 3: uzyskiwanie komunikacji równorzędnej VNET według obiektów
```powershell
...
To polecenie pobiera komunikację równorzędną VNET według obiektu.
