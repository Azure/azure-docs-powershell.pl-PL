...
## Opis
Tworzy klucz dla podanej IotHub.
Nazwy tych, które nie są unikatowe, muszą być dobrze zarządzane.

## Przykłady

### Przykład 1 Dodawanie klucza do IotHub
```
PS C:\> Add-AzIotHubKey -ResourceGroupName "myresourcegroup" -Name "myiothub" -KeyName "newkey" -PrimaryKey "primarykey" -SecondaryKey "secondarykey" -Rights RegistryRead
```

Tworzy klucz o nazwie "MyKey" dla iothub "myiothub" z uprawnieniami RegistryRead.
