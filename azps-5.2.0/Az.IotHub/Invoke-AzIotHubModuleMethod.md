...
## Opis
Wywoływanie metody modułu Edge. https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methodsAby uzyskać więcej informacji, zobacz.
...
### -ConnectionTimeOut
Liczba sekund określająca czas oczekiwania na pomyślną nawiązaniu połączenia.
...
### -Name (nazwa)
Nazwa metody, którą należy wywołać w tym module urządzenia.
...
### -Ładunek
Ładunek metody wywoływania w tym module urządzenia.
...
### -ResponseTimeOut
Liczba sekund określająca czas oczekiwania na otrzymanie wyniku z metody bezpośredniej.
Wartość domyślna to 10.
