...
## Opis
Oceń niestandardową wartość docelową lub metrykę systemową zdefiniowaną w konfiguracji urządzenia IoT.
Istnieją wstępnie zdefiniowane metryki systemowe, które są obliczane przez Centrum IoT i nie można ich dostosowywać.
- "Cel" określa liczbę Twins urządzenia, które pasują do warunku docelowego.
- W polu "zastosowano" określono liczbę Twins urządzenia, które zostały zmodyfikowane przez konfigurację. 
...
Oceń metryczną "zastosowaną przez system".
