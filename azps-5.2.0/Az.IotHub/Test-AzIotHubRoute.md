...
Przetestuj wszystkie trasy ze źródłem "DeviceMessages".
...
Przetestuj określoną trasę i pokazywanie przyczyny niepowodzenia.
...
Przetestuj określoną trasę, korzystając z AppProperty i SystemProperty.

## PARAMETRÓW

### -AppProperty
Właściwości aplikacji trasy
...
### -ShowError
Pokaż szczegółowy błąd (jeśli istnieje)
...
### -SystemProperty
Właściwości systemowe komunikatu o trasie
