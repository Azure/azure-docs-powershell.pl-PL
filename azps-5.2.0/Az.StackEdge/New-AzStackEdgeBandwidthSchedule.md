...
### UnlimitedBandwidthParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **New-AzStackEdgeBandwidthSchedule** tworzy nowy harmonogram przepustowości dla urządzenia ze stosem, aby ułatwić zarządzanie użyciem przepustowości.
...
### -StartTime
Planowanie godziny rozpoczęcia
...
### -StopTime
Planowanie godziny zakończenia
...
### -UnlimitedBandwidth
Ustawienie przepustowości jako bez ograniczeń
...
### Microsoft. Azure. PowerShell. polecenia. StackEdge. models. PSStackEdgeBandWidthSchedule
