...
### Przykład 1. Tworzenie DigitalTwinsIdentityObject
```powershell
...
Tworzenie DigitalTwinsIdentityObject według identyfikatora i lokalizacji
...
### Microsoft. Azure. PowerShell. polecenia. DigitalTwins. models. DigitalTwinsIdentity
