...
### Przykład 1. Usuń azDigitalTwinsEndPoint za pomocą punktu końcowego.
```powershell
...
Usuwanie azDigitalTwinsEndPoint za pomocą ResourceGroupName i resourceName

### Przykład 2: usuwanie azDigitalTwinsEndPoint przez obiekt
```powershell
...
Usuwanie azDigitalTwinsEndPoint przez obiekt
