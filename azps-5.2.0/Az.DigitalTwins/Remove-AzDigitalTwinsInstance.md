...
### Przykład 1. Usuń AzDigitalTwinsInstance według nazwy
```powershell
...
To polecenie usuwa AzDigitalTwinsInstance według nazwy

### Przykład 2: usuwanie AzDigitalTwinsInstance za pomocą obiektu Inputobject
```powershell
