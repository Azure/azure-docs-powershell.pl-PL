...
### Przykład 1: Lista AzDigitalTwinsEndpoint w obszarze zasobów
```powershell
...
Lista wszystkich AzDigitalTwinsEndpoints według ResourceGroupName

### Przykład 2: Get AzDigitalTwinsEndpoint według punktu Końcowegoname
```powershell
...
Pobierz AzDigitalTwinsEndpoint według punktu końcowego w obszarze zasobów

### Przykład 3: pobieranie AzDigitalTwinsEndpoint według obiektu "AzDigitalTwinsEndpoint"
```powershell
...
AzDigitalTwinsEndpoint według obiektu "AzDigitalTwinsEndpoint"
