...
### Przykład 1: UpdateExpanded (domyślnie)
```powershell
...
Aktualizowanie określonego DigitalTwinsInstance przez ResourceGroupName

### Przykład 2: aktualizowanie AzDigitalTwinsInstance przez inną AzDigitalTwinsInstance
```powershell
...
Aktualizowanie AzDigitalTwinsInstance przez inną AzDigitalTwinsInstance
...
Opis usługi DigitalTwins.
Aby skonstruować, zobacz sekcję notatki dla właściwości DIGITALTWINSPATCHDESCRIPTION i Utwórz tablicę skrótów.
...
### Microsoft. Azure. PowerShell. polecenia. DigitalTwins. models. Api20201031. IDigitalTwinsPatchDescription

### Microsoft. Azure. PowerShell. polecenia. DigitalTwins. models. IDigitalTwinsIdentity

## WYSYŁA

### Microsoft. Azure. PowerShell. polecenia. DigitalTwins. models. Api20201031. IDigitalTwinsDescription
...
DIGITALTWINSPATCHDESCRIPTION <IDigitalTwinsPatchDescription> : Opis usługi DigitalTwins.
  - `[Tag <IDigitalTwinsPatchDescriptionTags>]`: Znaczniki wystąpienia
    - `[(Any) <String>]`: Wskazuje, że do tego obiektu można dodać dowolną właściwość.

INPUTobject <IDigitalTwinsIdentity> : parametr Identity
  - `[EndpointName <String>]`: Nazwa zasobu punktu końcowego.
  - `[Id <String>]`: Ścieżka tożsamości zasobu
  - `[Location <String>]`: Lokalizacja DigitalTwinsInstance.
  - `[ResourceGroupName <String>]`: Nazwa grupy zasobów zawierającej DigitalTwinsInstance.
  - `[ResourceName <String>]`: Nazwa DigitalTwinsInstance.
