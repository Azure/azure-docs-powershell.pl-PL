...
## STRESZCZENIe
Interfejs API umożliwiający zarejestrowanie nowego klastra K8s i w związku z tym utworzenie prześledzonego zasobu w ARM
...
### Przykład 1. Tworzenie połączonego Kubernetes
```powershell
...
To polecenie tworzy połączony Kubernetes.

### Przykład 1. Utwórz połączony Kubernetes z parametrami kubeConfig i kubeContext
```powershell
...
To polecenie tworzy połączony Kubernetes z parametrami kubeConfig i kubeContext.
...
### -KubeContext
Kubconfig kontekst na bieżącym komputerze
...
### -ResourceGroupName
Nazwa grupy zasobów, do której jest zarejestrowany klaster Kubernetes.
...
### -Subskrypcji
Identyfikator subskrypcji, do której jest zarejestrowany klaster Kubernetes.
