...
## Opis
Polecenie cmdlet Get-AzAttestationPolicy pobiera zasady od dzierżawy w zaświadczeniu platformy Azure.
...
Pobiera zasady *Pshtest* dostawcy zaświadczania dla typu tee *SgxEnclave*.
...
Pobiera zasadę domyślnego dostawcy zaświadczania z lokalizacji *UK południe* dla tee typu *SgxEnclave*.
...
To polecenie cmdlet pobiera zasady zaświadczania dla dzierżawy, którą ten parametr określa.
...
### Microsoft. Azure. Commands. zaświadczanie. modele. PSPolicy
