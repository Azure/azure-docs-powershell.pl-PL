...
### NewByNameParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **New-AzSynapseIntegrationRuntimeKey** generuje ponownie klucz środowiska uruchomieniowego integracji z nazwą klucza określoną przez parametr "KeyName". Poprzedni klucz będzie nieprawidłowy.
