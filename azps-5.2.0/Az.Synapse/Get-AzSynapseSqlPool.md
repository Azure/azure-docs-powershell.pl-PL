...
To polecenie pobiera wszystkie pule SQL w obszarze roboczym.
...
To polecenie pobiera pulę SQL w obszarze roboczym ContosoWorkspace z nazwą ContosoSqlPool.
...
To polecenie pobiera wszystkie pule SQL w obszarze roboczym za pośrednictwem rurociągu.
...
To polecenie pobiera pulę SQL z określonym IDENTYFIKATORem zasobu.
...
### -Version
[Ta funkcja jest w ograniczonym podglądzie, początkowo dostępna tylko w przypadku niektórych abonamentów.] Wersja puli SQL Synapse. Na przykład 2 lub 3.
