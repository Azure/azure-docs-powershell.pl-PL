...
### ClearByNameParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **Reset-AzSynapseSqlAdvancedThreatProtectionSetting** usuwa zaawansowane ustawienia ochrony przed zagrożeniami z obszaru roboczego funkcji Azure Synapse Analytics.
