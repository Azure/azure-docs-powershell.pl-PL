...
## Opis
Polecenie cmdlet **Get-AzSynapseIntegrationRuntimeKey** pobiera klucze środowiska wykonawczego integracji. Klucze są używane do rejestrowania węzła środowiska wykonawczego integracji.
