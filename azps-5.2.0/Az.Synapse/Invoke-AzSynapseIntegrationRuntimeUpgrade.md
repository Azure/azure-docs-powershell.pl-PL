...
## Opis
Polecenie cmdlet **Invoke-AzSynapseIntegrationRuntimeUpgrade** umożliwia uaktualnienie programu obsługi integracji obsługiwanego automatycznie, jeśli jest dostępna nowa wersja.
...
Polecenie cmdlet uaktualnia w obszarze roboczym programu SelfHost o nazwie "test--IR".
