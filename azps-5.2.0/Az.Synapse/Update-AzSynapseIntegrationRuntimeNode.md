...
## Opis
Polecenie cmdlet **Update-AzSynapseIntegrationRuntimeNode** aktualizuje właściwości węzła w obszarze roboczym do obsługi integracji samodzielnego. Obecnie obsługuje tylko aktualizowanie "ConcurrentJobsLimit".
