...
## Opis
To polecenie cmdlet utworzy zarządzany zasób klastra bez typów węzłów. Aby zainicjować Inicjowanie klastra, należy dodać podstawowy typ węzła użyj [nowych-AzServiceFabricManagedNodeType](./New-AzServiceFabricManagedNodeType.md).
...
To polecenie tworzy zasób klastra mający domyślną podstawową jednostkę SKU.
...
To polecenie tworzy zasób klastra w centraluseuap za pomocą początkowego certyfikatu klienta administratora i standardowej jednostki SKU.

## PARAMETRÓW

### -AdminPassword
Hasło administratora używane przez maszyny wirtualne.
...
Używaj tylko w połączeniu z ClientCertCommonName.
...
Port służący do połączeń klientów z klastrem.
...
### -CodeVersion
Wersja kodu sieci szkieletowej usługi klastrowania.
Używaj tylko trybu uaktualniania ręcznego.
...
Port służący do połączeń HTTP z klastrem.
Wartość domyślna: 19080.
...
### -SKU
SKU klastra, dostępne są następujące opcje: co najmniej 3 węzły dosienne i dozwolone jest tylko 1 węzeł i standard: będzie zawierać co najmniej 5 węzłów rozrzutu i umożliwia korzystanie z wielu typów węzłów.
...
### -Upgrademode
Tryb uaktualniania wersji kodu sieci szkieletowej usługi klastrowania.
...
### -UseTestExtension
Jeśli określisz, klaster zostanie wyposażony w rozszerzenie VMSS test usługi.
