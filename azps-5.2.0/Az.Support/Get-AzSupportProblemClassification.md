...
## STRESZCZENIe
Pobierz klasyfikacje problemów dla określonej usługi.
...
### Przykład 1: Uzyskaj wszystkie classificaitons problemu dla usługi, korzystając z parametru identyfikator usługi.
```powershell
...
### Przykład 2: uzyskiwanie wszystkich classificaitons problemów dla usługi przy użyciu nadrzędnego obiektu usługi
```powershell
...
### Przykład 3: uzyskiwanie szczegółowych informacji o pojedynczym problemie classificaiton na podstawie identyfikatora według obiektu usługi dla połączeń rurowych
```powershell
...
### -ServiceId
Identyfikator usługi, dla którego zostaną pobrane wszystkie klasyfikacje problemów.
...
### -Serviceobject
Obiekt usługi, dla którego zostaną pobrane klasyfikacje problemów.
