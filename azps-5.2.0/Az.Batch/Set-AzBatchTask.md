...
## Opis
Polecenie cmdlet **Set-AzBatchTask** aktualizuje właściwości zadania w usłudze Azure Batch.
Użyj polecenia cmdlet Get-AzBatchTask, aby uzyskać obiekt **PSCloudTask** .
...
Pierwsze polecenie pobiera zadanie przy użyciu polecenia **Get-AzBatchTask**, a następnie zapisuje je w zmiennej $Task.
