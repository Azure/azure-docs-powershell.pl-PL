...
## STRESZCZENIe
Generowanie nowej instancji ApiProperties konta usług poznawczych
...
## Opis
Generowanie nowego wystąpienia ApiProperties konta usług poznawczych.
ApiProperties można użyć podczas tworzenia nowego konta lub aktualizowania istniejącego konta.
ApiProperties jest wymagany przez niektóre typy kont.
...
Powyższy przykład utworzy konto QnAMaker z właściwością interfejsu API "QnaRuntimeEndpoint".
...
### Microsoft. Azure. Management. CognitiveServices. MODELES. CognitiveServicesAccountApiProperties
