...
## Opis
Polecenie cmdlet **Remove-AzAutomationDscConfiguration** usuwa konfiguracje konfiguracji pożądanego stanu (DSC) z usługi Azure Automation.

## Przykłady

### Przykład 1

Usuwa konfiguracje DSC z automatyzacji. (autogenerowana)
...
Określa nazwę konta automatyzacji zawierającego konfiguracje DSC, które zostanie usunięte przez to polecenie cmdlet.
...
### -Name (nazwa)
Określa nazwę konfiguracji DSC, która zostanie usunięta przez to polecenie cmdlet.
