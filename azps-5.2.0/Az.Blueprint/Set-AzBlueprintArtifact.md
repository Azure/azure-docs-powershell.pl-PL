...
### UpdateTemplateArtifact (domyślny)
```
...
## Opis
Aktualizowanie artefaktu. Istnieją dwa sposoby aktualizowania artefaktu: za pośrednictwem notacji JSON artefaktu jako pliku wejściowego lub dostarczając parametrów w tekście artefaktu. Gdy metoda JSON nie wymaga typu artefaktu, który ma zostać dostarczony w metodzie parametered, wymagane jest, aby użytkownik podał typ artefaktu za pomocą parametru-type.
...
Aktualizowanie artefaktu za pośrednictwem pliku JSON artefaktu.
...
Aktualizowanie artefaktu za pomocą parametrów wbudowanych.
...
Aktualizowanie artefaktu za pośrednictwem pliku szablonu ARM.
...
### -DependsOn
Lista nazw artefaktów, które należy utworzyć przed utworzeniem bieżącego artefaktu.
...
Obiekt Hashtable parametrów do przekazania do artefaktu definicji zasad.
...
### -ResourceGroupName
Nazwa grupy zasobów, w której ma się pojawić artefakt.
...
Lokalizacja pliku parametrów szablonu ARM na dysku.
...
### Microsoft. Azure. Management. plan. MODELES. artefakt
