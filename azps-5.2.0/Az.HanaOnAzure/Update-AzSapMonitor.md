...
### Przykład 1: aktualizowanie monitora SAP według nazwy
```powershell
...
To polecenie aktualizuje Monitor protokołu SAP według nazwy.

### Przykład 2: aktualizowanie monitora SAP według obiektów
```powershell
...
To polecenie aktualizuje Monitor protokołu SAP według obiektu.
