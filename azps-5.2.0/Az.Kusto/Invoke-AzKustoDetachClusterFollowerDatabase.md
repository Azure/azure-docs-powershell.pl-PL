...
### Przykład 1. odłączanie bazy danych z danymi
```powershell
...
Powyższe polecenie odłącza bazę danych programu zgodna ze zdefiniowaną w AttachedDatabaseConfiguration "myfollowerconfiguration" z poziomu klastra "testnewkustoclusterf".
...
Nazwa zasobu dołączonej konfiguracji bazy danych w klastrze z danymi.
...
### -ClusterResourceId
Identyfikator zasobu klastra znajdującego się za bazą danych należącymi do tego klastra.
