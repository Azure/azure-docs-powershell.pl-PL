...
### Przykład 1: Lista kwalifikujących się jednostek SKU
```powershell
...
Powyższe polecenie wyświetla listę kwalifikowanych jednostek SKU.

### Przykład 2: Wyświetla listę kwalifikowanych jednostek SKU dla określonego klastra
```powershell
...
Powyższe polecenie wyświetla listę kwalifikowanych jednostek SKU dla określonego klastra
...
### Microsoft. Azure. PowerShell. polecenia. Kusto. models. Api20200614. IAzureResourceSku

### Microsoft. Azure. PowerShell. polecenia. Kusto. models. Api20200614. ISkuDescription
