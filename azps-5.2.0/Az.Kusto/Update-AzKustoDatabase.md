...
Powyższe polecenie aktualizuje okres usuwania nietrwałego i okres pamięci podręcznej Kusto bazy danych "mykustodatabase" w klastrze "testnewkustocluster" odnaleziony w grupie zasobów "testrg".

### Przykład 2: aktualizowanie istniejącej bazy danych przy użyciu tożsamości
```powershell
...
### Przykład 3: aktualizowanie istniejącej bazy danych tylko do odczytu według nazwy
```powershell
PS C:\> $2ds = New-TimeSpan -Days 2
...
Powyższe polecenie aktualizuje okres pamięci podręcznej bazy danych Kusto "mykustodatabase" w klastrze "myfollowercluster" w grupie zasobów "testrg".

### Przykład 4: aktualizowanie istniejącej bazy danych tylko do odczytu za pomocą tożsamości
```powershell
...
### -HotCachePeriod
Czas przechowywania danych w pamięci podręcznej w przypadku szybkiego wykonywania kwerend w polu TimeSpan.
...
### -SoftDeletePeriod
Czas przechowywania danych przed zakończeniem dostępu do zapytań w polu TimeSpan.
...
### Microsoft. Azure. PowerShell. polecenia. Kusto. models. Api20200614. IDatabase
