...
### Przykład 1: usuwanie uprawnień podmiotów zabezpieczeń bazy danych
```powershell
...
Powyższe polecenie usuwa uprawnienia podmiotów zabezpieczeń bazy danych
...
### -Value
Lista podmiotów Kusto bazy danych.
Aby skonstruować, zobacz sekcję notatki dla właściwości wartości i Utwórz tablicę skrótów.
...
### Microsoft. Azure. PowerShell. polecenia. Kusto. models. Api20200614. IDatabasePrincipal
...
WARTOŚĆ <IDatabasePrincipal [] >: Lista podmiotów zabezpieczeń bazy Kusto.
  - `Name <String>`: Główna nazwa bazy danych.
  - `Role <DatabasePrincipalRole>`: Rola główna bazy danych.
  - `Type <DatabasePrincipalType>`: Typ podmiotu zabezpieczeń bazy danych.
  - `[AppId <String>]`: Identyfikator aplikacji — dotyczy tylko typu głównego aplikacji.
  - `[Email <String>]`: Główna wiadomość e-mail bazy danych, jeśli istnieje.
  - `[Fqn <String>]`: Główna w pełni kwalifikowana nazwa podmiotu zabezpieczeń bazy danych.
