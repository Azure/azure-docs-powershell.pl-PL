...
### Przykład 1: Sprawdzanie dostępności nazwy principalassignment bazy danych, która jest w użyciu
```powershell
...
Powyższe polecenie zwraca informację o tym, czy PrincipalAssignment o nazwie "Moja Principal" istnieje w bazie danych "mykustodatabase" z poziomu klastra "testnewkustocluster".

### Przykład 2: Sprawdzanie dostępności bazy danych principalassignment nazwa, która nie jest używana
```powershell
...
### -Type
Typ zasobu, Microsoft. Kusto/klaster/bazy danych/principalAssignments.
