...
## Opis
Polecenie cmdlet **Remove-AzHpcCacheStorageTarget** usuwa miejsce docelowe miejsca do magazynowania z pamięci podręcznej Azure HPC.
...
### -Force
Wskazuje, że polecenie cmdlet nie monituje o potwierdzenie. Domyślnie to polecenie cmdlet monituje o potwierdzenie zamiaru usunięcia celu zapisu.
...
### -ResourceGroupName
Nazwa grupy zasobów, pod którą chcesz usunąć miejsce docelowe magazynu z pamięci podręcznej.
