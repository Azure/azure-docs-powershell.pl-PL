...
## Opis
Polecenie cmdlet **Update-AzHpcCache** aktualizuje pamięć podręczną usługi Azure HPC.
...
### -Force
Wskazuje, że polecenie cmdlet nie monituje o potwierdzenie. Domyślnie to polecenie cmdlet monituje o potwierdzenie zamiaru zaktualizowania pamięci podręcznej.
...
### -ResourceGroupName
Nazwa grupy zasobów, pod którą ma zostać zaktualizowana pamięć podręczna.
