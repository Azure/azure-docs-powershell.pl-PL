...
### Przykład 1. Tworzenie obiektu wyrażenia porównawczego zapytania na potrzeby eksportu zarządzania kosztami
```powershell
...
To polecenie tworzy obiekt wyrażenia porównania zapytania na potrzeby eksportu zarządzania kosztami.
...
### -Operator
Operator używany do porównywania.
...
### -Value
Tablica wartości, które mają zostać użyte do porównania.
...
### Microsoft. Azure. PowerShell. polecenia. CostManagement. models. Api20200601. QueryComparisonExpression
