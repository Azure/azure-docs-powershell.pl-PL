...
## STRESZCZENIe
Aktualizowanie ustawienia zabezpieczeń w centrum zabezpieczeń platformy Azure

## POLECENIA

### GeneralScope (domyślny)
```
...
## Opis
Polecenie cmdlet Set-AzSecuritySetting aktualizuje określone ustawienie zabezpieczeń w usłudze Azure Security Center.
...
Aktualizowanie ustawienia eksportu danych MCAS   
...
### -SettingKind
Rodzaj ustawienia. (DataExportSettings)
...
### System. String
### Microsoft. Azure. Commands. Security. MODELES. Settings. PSSecuritySetting
### Microsoft. Azure. Commands. Security. MODELES. Settings. PSSecurityDataExportSetting
