...
## Opis
Polecenie cmdlet New-AzDeviceSecurityGroupDenylistCustomAlertRuleObject tworzy nową listę odrzuconych niestandardowych reguł alertów dla grupy zabezpieczeń urządzenia w rozwiązaniu bezpieczeństwa IoT.
...
Tworzenie nowej niestandardowej reguły alertu listy odrzuconych z typem Rull "SomeRuleType" i stanem ustawionym na desable
