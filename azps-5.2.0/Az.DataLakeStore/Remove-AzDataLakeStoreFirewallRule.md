...
## Opis
Polecenie cmdlet **Remove-AzDataLakeStoreFirewallRule** usuwa określoną regułę zapory w określonym sklepie Data Lake Store.
...
### -ResourceGroupName
Określa nazwę grupy zasobów zawierającej konto, z którego ma zostać usunięta Reguła zapory.
