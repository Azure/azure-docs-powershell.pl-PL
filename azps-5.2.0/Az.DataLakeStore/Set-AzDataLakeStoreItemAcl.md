...
### Przykład 2: ustawianie listy ACL folderu rekursywnie
```
...
Pierwsze polecenie pobiera listę ACL dla katalogu Folder1 konta ContosoADL, a następnie zapisuje je w zmiennej $ACL.
Drugie polecenie ustawia listę ACL rekursywnie na Folder2 oraz jej podkatalogi i pliki w $ACL.
...
### -Rekursywowanie
Wskazuje listę ACL, która ma być ustawiana cyklicznie w podkatalogach podrzędnych i plikach.
...
### -ShowProgress
Jeśli przekazano, stan postępu będzie wyświetlany. Obowiązuje tylko w przypadku ustawienia cyklicznego zestawu ACL.
