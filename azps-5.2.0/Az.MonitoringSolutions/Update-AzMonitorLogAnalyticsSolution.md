...
## STRESZCZENIe
Zaktualizuj znaczniki rozwiązania.
...
To polecenie aktualizuje rozwiązanie analizy dzienników według nazwy.

### Przykład 2: aktualizowanie rozwiązania analizy dziennika monitora według obiektów
```powershell
...
To polecenie aktualizuje rozwiązanie analizy dziennika według obiektu.
