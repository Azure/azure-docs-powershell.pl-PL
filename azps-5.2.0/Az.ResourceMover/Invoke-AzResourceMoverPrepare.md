...
### Przykład 1. Sprawdź poprawność dependecies przed przygotowaniem zasobów
```powershell
...
Sprawdź poprawność dependecies przed przygotowaniem zasobów.

### Przykład 2: Inicjowanie przygotowywania zestawu zasobów w kolekcji Move przy użyciu funkcji "MoveResource Name" jako danych wejściowych
```powershell
...
Rozpocznij przygotowywanie zestawu zasobów w kolekcji Move przy użyciu funkcji "MoveResource Name" jako danych wejściowych.

### Przykład 3: Inicjowanie przygotowywania zestawu zasobów w kolekcji Move przy użyciu "SourceARMID"
```powershell
...
Zainicjuj przygotowywanie zestawu zasobów w kolekcji Move przy użyciu "SourceARMID".
