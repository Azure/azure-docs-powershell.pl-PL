...
### Przykład 1: uzyskiwanie szczegółów dotyczących wszystkich przeniesień kolekcji w subskrypcji
```powershell
...
Uzyskaj szczegółowe informacje na temat wszystkich przeniesień kolekcji w ramach subskrypcji.

### Przykład 2: pobieranie szczegółów kolekcji Move z określoną nazwą kolekcji przenoszenia w subskrypcji
```powershell
...
Uzyskaj szczegółowe informacje o kolekcji Move z określoną nazwą kolekcji przeniesień w subskrypcji.

### Przykład 3: uzyskiwanie szczegółowych informacji o kolekcji Move z określoną nazwą grupy zasobów w subskrypcji
```powershell
...
Uzyskaj szczegółowe informacje o kolekcji Przenieś z określoną nazwą grupy zasobów w subskrypcji.
...
### Microsoft. Azure. PowerShell. polecenia. ResourceMover. models. Api20191001Preview. IMoveCollection
