...
Utwórz usługę inicjowania obsługi urządzenia centrum usług Azure IoT z standardową warstwą cenową S1 i znacznikami w regionie grupy zasobów.
...
Utwórz usługę inicjowania obsługi urządzenia centrum usług Azure IoT z standardową warstwą cenową S1 w regionie "Wschód".
...
### -Tag
Znaczniki wystąpienia usługi obsługi urządzeń IoT. Zbiór właściwości w postaci par klucz-wartość w formie tabeli skrótów.
