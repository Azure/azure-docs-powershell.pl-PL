...
Zaktualizuj zasadę alokacji na "geoopóźnienie" usługi dostarczania urządzeń centrum usług Azure IoT "myiotdps".
...
Dodawanie tagów do usługi inicjowania obsługi administracyjnej urządzenia centrum usług Azure IoT "myiotdps".
...
Usuwanie znacznika i dodawanie nowych tagów do usługi inicjowania obsługi administracyjnej urządzenia centrum usług Azure IoT "myiotdps" przy użyciu potoku.

## PARAMETRÓW

### -AllocationPolicy
Zasady alokacji usług dla urządzeń IoT
...
### -Resetowanie
Resetowanie numerów seryjnych usług obsługi urządzeń IoT
...
### -Tag
Kolekcja znaczników usługi dostarczania urządzeń IoT
