...
### Przykład 1 uzyskiwanie kluczy interfejsu API dla zasobu usługi Application Insights
```
...
Pobierz klucze interfejsu API usługi Application Insights dla zasobu "test" w grupie zasobów "Tester".

### Przykład 2 uzyskiwanie określonego klucza interfejsu API dla zasobu usługi Application Insights
```
...
Pobierz określony klucz interfejsu API usługi Application Insights o identyfikatorze "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" dla zasobu "test" w grupie "Tester".
