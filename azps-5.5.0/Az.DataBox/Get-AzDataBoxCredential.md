...
## OPIS
Polecenie **cmdlet Get-AzDataBoxCredential** pobiera poświadczenia pola danych określonego zadania. Właściwości wewnętrzne obiektu zwracanych poświadczeń będą się różnić w przypadku różnych typów elementów SKU.
...
To retuns the JobSecrets of the specified job
