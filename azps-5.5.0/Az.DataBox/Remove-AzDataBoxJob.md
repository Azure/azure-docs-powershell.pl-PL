...
## OPIS
Polecenie **cmdlet Remove-AzDataBoxJob** służy do usuwania gotowego zadania pola danych z listy zadań skrzynki danych.
...
Usuwa określone zadanie pola danych.
...
Wymusza usunięcie określonego zadania pola danych bez potwierdzenia
...
### — Wymuszanie
Wymusz usunięcie bez potwierdzenia
