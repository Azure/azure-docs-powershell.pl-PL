...
### Przykład 1. Tworzenie nowej bazy danych MariaDB
```powershell
...
To polecenie powoduje utworzenie nowej bazy danych MariaDB.

## PARAMETERS

### -AdministratorLoginPassword
Hasło administratora powinno mieć hasłem SecureString.
