...
### Przykład 1. Lista wszystkich reguł sieci wirtualnej w ramach bazy danych MariaDB
```powershell
...
To polecenie wyświetla listę wszystkich reguł sieci wirtualnej w obszarze Bazy danych MariaDB.

### Przykład 2. Uzyskiwanie reguły sieci wirtualnej w ramach bazy danych MariaDB
```powershell
...
To polecenie pobiera regułę sieci wirtualnej w obszarze bazy danych MariaDB.
...
### Microsoft.Azure.PowerShell.cmdlet.MariaDb.Models.Api20180601Preview.IVirtualNetworkRule
