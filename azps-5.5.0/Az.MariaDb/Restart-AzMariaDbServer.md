...
### Przykład 1. Ponowne uruchamianie bazy danych MariaDB
```powershell
PS C:\> Restart-AzMariaDbServer -Name mariadb-test-9pebvn -ResourceGroupName mariadb-test-qu5ov0

```

To polecenie powoduje ponowne uruchomienie bazy danych MariaDB.

### Przykład 2. Ponowne uruchamianie bazy danych MariaDB
```powershell
