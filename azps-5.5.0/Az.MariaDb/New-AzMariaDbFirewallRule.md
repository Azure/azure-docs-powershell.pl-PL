...
### Przykład 1. Tworzenie reguły zapory w obszarze bazy danych MariaDB
```powershell
...
To polecenie tworzy regułę zapory w obszarze bazy danych MariaDB.

### Przykład 2. Tworzenie nowej reguły zapory MariaDB przy użyciu ciągu -ClientIPAddress.
```powershell
...
Te polecenia cmdlet tworzą regułę zapory MariaDB przy użyciu -ClientIPAddress.

### Przykład 3. Tworzenie nowej reguły zapory MariaDB w celu zezwalania na wszystkie ip
```powershell
...
To polecenie cmdlet tworzy nową regułę zapory MariaDB, aby zezwolić na wszystkie ip.
...
Jeśli nie zostanie określona, wartość domyślna jest niezdefiniowana.
Jeśli jest obecna nazwa AllowAll, domyślną nazwą AllowAll_yyyy-MM-dd_HH-mm-ss.
...
### Microsoft.Azure.PowerShell.cmdlet.MariaDb.Models.Api20180601Preview.IFirewallRule
