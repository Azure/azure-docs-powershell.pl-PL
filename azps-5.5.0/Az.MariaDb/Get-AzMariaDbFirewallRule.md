...
### Przykład 1. Lista wszystkich reguł zapory w obszarze bazy danych MariaDB
```powershell
...
To polecenie wyświetla listę wszystkich reguł girewall w obszarze Bazy danych MariaDB.

### Przykład 2. Uzyskiwanie reguły zapory w obszarze bazy danych MariaDB
```powershell
...
To polecenie pobiera regułę zapory w obszarze bazy danych MariaDB.
