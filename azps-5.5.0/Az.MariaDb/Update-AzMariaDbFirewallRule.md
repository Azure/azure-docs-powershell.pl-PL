...
### Przykład 1. Aktualizowanie reguły zapory MariaDB
```powershell
...
To polecenie aktualizuje regułę zapory MariaDB.

### Przykład 2. Aktualizowanie reguły zapory MariaDB przez tożsamość.
```powershell
...
Polecenie cmdlet aktualizuje regułę zapory MariaDB za pomocą tożsamości.

### Przykład 3. Aktualizowanie reguły zapory MariaDB przez -ClientIPAddress.
```powershell
PS C:\> $ID = "/subscriptions/<SubscriptionId>/resourceGroups/mariadb-test-qu5ov0/providers/Microsoft.DBforMariaDB/servers/mariadb-test-4rmtig/firewallRules/fr-cfgl3y"
...
Polecenie cmdlet aktualizuje regułę zapory MariaDB przez -ClientIPAddress.
...
### Microsoft.Azure.PowerShell.Cmdlet.MariaDb.Models.IMariaDbIdentity
...
INPUTOBJECT: <IMariaDbIdentity> Parametr tożsamości
