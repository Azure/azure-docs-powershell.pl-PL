...
## OPIS
Polecenie cmdlet **Invoke-AzDataBoxEdgeShare** wywoła akcję odświeżania danych w udostępnieniu na urządzeniu z krawędzią pola danych.
...
### — RefreshData
Odświeżanie metadanych udostępniania danych z chmury
