...
## OPIS
Polecenie **cmdlet New-AzDataBoxEdgeUser** tworzy nowego użytkownika dla urządzenia z krawędzią pola danych. Obsługiwane jest tworzenie tylko użytkowników `Share` tego typu.
...
### — Wpisz
Wybierz pozycję UserType (Typ użytkownika)
