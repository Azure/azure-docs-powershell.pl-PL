...
## OPIS
Polecenie **cmdlet Remove-AzDataBoxEdgeUser** usuwa użytkownika z urządzenia z krawędzią pola danych. Obsługiwane jest tworzenie tylko użytkowników `Share` tego typu.
