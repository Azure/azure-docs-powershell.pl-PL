...
## OPIS
To **ustawienie Set-AzDataBoxEdgeShare** zastąpi prawa dostępu
...
### -ClientAccessRight
Dostęp do odczytu i zapisu dla identyfikatorów klienta, np.: @(@{"ClientId"="192.168.10.10";" AccessRight"="NoAccess"}, @{"ClientId"="192.168.10.11";" AccessRight"="ReadOnly"})
