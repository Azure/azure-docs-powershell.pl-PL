...
## OPIS
Polecenie **cmdlet Remove-AzDataBoxEdgeDevice** usuwa konfigurację urządzenia z przeglądarką Edge pola danych.
Pamiętaj, że urządzenie można usunąć dopiero po zmieściu się w zamówieniu i zanim urządzenie będzie przygotowane do wysyłki przez firmę Microsoft.

Przed użyciem tego [polecenia cmdlet](https://docs.microsoft.com/en-us/azure/databox-online/data-box-edge-return-device#delete-the-resource) zapoznaj się z dokumentacją dotyczącą usuwania zasobu
