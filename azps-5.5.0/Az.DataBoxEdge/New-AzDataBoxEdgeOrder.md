...
## OPIS
Polecenie **cmdlet New-AzDataBoxEdgeOrder** tworzy nową kolejność dla urządzenia z krawędzią pola danych. Przed utworzeniem zamówienia należy utworzyć zasób urządzenia z krawędzią pola danych. Możesz określić szczegóły, takie jak osoba kontaktowa, nazwa firmy, adres e-mail, adres itp. jako parametry tworzenia zamówienia.
