...
## OPIS
Polecenie **cmdlet Get-AzDataBoxEdgeTriger** pobiera wyzwalacze dla urządzenia. Nazwę można określić jako parametr w poleceniach cmdlet w celu pobrania szczegółów określonych wyzwalaczy.
