...
## OPIS
Polecenie **cmdlet Get-AzDataBoxEdgeStorageContainer** pobiera kontener magazynu dla konta magazynu edge na urządzeniu z programem Data Box Edge. Możesz określić nazwę jako parametr w poleceniach cmdlet, aby uzyskać dostęp do szczegółów określonego kontenera magazynu. 
