...
## OPIS
Polecenie **cmdlet Get-AzDataBoxEdgeStorageAccount** pobiera konta magazynu edge dostępne na urządzeniu z programem Data Box Edge. Możesz określić nazwę jako parametr w poleceniach cmdlet, aby uzyskać informacje o określonym koncie magazynu edge.
