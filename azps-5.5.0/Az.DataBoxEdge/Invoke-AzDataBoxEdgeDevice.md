...
### InvokeMeterForUpdateByResourceIdParameterSet
```
...
## OPIS
Polecenie cmdlet **Invoke-AzDataBoxEdgeDevice** wywoła akcje skanowania, pobierania i instalowania aktualizacji na urządzeniu z krawędzią pola danych. Automatyczne skanowanie jest uruchamiane na urządzeniu codziennie. Możesz jawnie wyzwolić skanowanie, uruchamiając to polecenie cmdlet.
...
### -FetchUpdate
Pobieranie aktualizacji na urządzeniu z krawędzią/bramą pola danych
...
### -InstallUpdate
Instaluje aktualizacje na urządzeniu z krawędzią/bramą pola danych
...
### -PassThru
zwraca wartość prawda, jeśli pomyślnie
...
### -ScanForUpdate
Skanuje w poszukiwaniu aktualizacji na urządzeniu z krawędzią/bramą pola danych.
