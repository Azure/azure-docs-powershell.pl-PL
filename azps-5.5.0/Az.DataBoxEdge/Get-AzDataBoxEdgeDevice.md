...
## OPIS
Polecenie **cmdlet Get-AzDataBoxEdgeDevice** pobiera informacje o dostępnych urządzeniach brzegowych pola danych. Możesz określić nazwę urządzenia wraz z nazwą grupy zasobów, aby uzyskać informacje na określonym urządzeniu. 
