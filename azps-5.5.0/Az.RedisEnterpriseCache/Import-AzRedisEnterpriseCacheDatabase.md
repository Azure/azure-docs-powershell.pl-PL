...
To polecenie importuje plik bazy danych do bazy danych redis Enterprise Cache o nazwie MyCache.

### Przykład 2. Importowanie bazy danych (przy użyciu przykładowej nazwy pliku)
```powershell
#[SuppressMessage("Microsoft.Security", "CS002:SecretInNextLine", Justification="Invalid SAS token")]
