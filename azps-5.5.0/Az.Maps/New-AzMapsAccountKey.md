...
## OPIS
Polecenie New-AzMapsAccountKey ponownie generuje klucz interfejsu API dla konta usługi Azure Maps.
...
Ponownie generuje podstawowy klucz interfejsu API dla konta MyAccount w grupie zasobów MyResourceGroup.
...
Ponowne generowanie pomocniczego klucza interfejsu API dla określonego konta usługi Azure Maps.
