...
### Przykład 1. Usunięcie niestandardowego skojarzenia dostawcy.
```powershell
...
Usuń niestandardowe skojarzenie dostawców za pomocą funkcji piping i PassThru, aby wskazać sukces lub niepowodzenie.
