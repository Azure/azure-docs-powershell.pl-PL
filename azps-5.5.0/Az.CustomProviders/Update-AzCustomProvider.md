...
## SYNOPSIS
Aktualizuje istniejącego dostawcę zasobów niestandardowych.
Jedyną wartością, która może być obecnie aktualizowana za pomocą poprawki, są tagi.
...
### Przykład 1. Dodawanie tagów do dostawcy niestandardowego
```powershell
...
Aktualizowanie tagów dostawcy niestandardowego.

### Przykład 2. Aktualizowanie dostawcy niestandardowego za pomocą rur
```powershell
...
Aktualizowanie dostawcy niestandardowego za pomocą rur.
