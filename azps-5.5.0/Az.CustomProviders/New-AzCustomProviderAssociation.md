...
Utwórz niestandardowe skojarzenie dostawcy, skojarzony element docelowy provioder musi być poprawnie skonfigurowany przy użyciu trasy dla "skojarzeń"
...
Na przykład użyj dla zasobu maszyny wirtualnej '/subscriptions/{subscription-id}/resourceGroups/{resource-group-name}/providers/Microsoft.Compute/virtualMachines/{virtual-name}".
