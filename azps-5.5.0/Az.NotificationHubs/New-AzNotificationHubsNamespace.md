...
### — Tag
Określa pary wartości nazw, których można używać do kategoryzowania i organizowania elementów platformy Azure.
Tagi działają podobnie do słów kluczowych i działają we wdrożeniu.
Jeśli na przykład wyszukuje się wszystkie elementy o tagu Department:IT, wyszukiwanie zwróci wszystkie elementy platformy Azure, które mają ten tag, bez względu na elementy, takie jak typ elementu, lokalizacja lub grupa zasobów.
