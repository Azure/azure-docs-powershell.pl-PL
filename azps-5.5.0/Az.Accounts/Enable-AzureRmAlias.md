...
Jeśli nie zostanie określone, wartością domyślną są wszystkie moduły.
...
### — Zakres
Wskazuje, dla jakich aliasów zakresów należy włączyć obsługę. Wartość domyślna to "Lokalne"
