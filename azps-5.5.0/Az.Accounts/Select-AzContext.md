...
## OPIS
Wybierz subskrypcję docelową (konto lub dzierżawę) w poleceniach cmdlet programu Azure PowerShell.  Po tym cmdlet przyszłe polecenia cmdlet będą kierowane do wybranego kontekstu.

## PRZYKŁADY

### Przykład 1. Kierowanie nazwanego kontekstu
```powershell
...
Kierowane do przyszłych poleceń cmdlet programu Azure PowerShell na koncie, dzierżawie i subskrypcji w kontekście "Praca".

### Przykład 2

Wybierz subskrypcję i konto do kierowania w poleceniach cmdlet programu Azure PowerShell w tej sesji programu PowerShell. (wygenerowane automatycznie)
...
### -InputObject
Obiekt kontekstowy, który zwykle przeszedł przez potok.
