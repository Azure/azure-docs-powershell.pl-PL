...
## OPIS
Polecenie Set-AzDefault cmdlet dodaje lub zmienia wartości domyślne w bieżącym kontekście.
...
To polecenie ustawia domyślną grupę zasobów na grupę zasobów określoną przez użytkownika.
...
### — Wymuszanie
Tworzenie nowej grupy zasobów, jeśli określone ustawienie domyślne nie istnieje
