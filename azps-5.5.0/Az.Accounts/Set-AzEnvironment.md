...
## OPIS
Polecenie Set-AzEnvironment ustawia punkty końcowe i metadane do łączenia się z wystąpieniem platformy Azure.
...
### -AzureOperationalInsightsEndpointResourceId
Odbiorcy tokenów uwierzytelniający się za pomocą interfejsu API Azure Log Analytics.
...
Sufiks rejestru azure container.
