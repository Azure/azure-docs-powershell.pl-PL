...
## OPIS
Polecenie Clear-AzDefault cmdlet usuwa wartości domyślne ustawione przez użytkownika w zależności od parametrów przełącznika określonych przez użytkownika.
