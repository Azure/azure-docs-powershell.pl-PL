...
## SYNOPSIS
Eksportuje dane z pamięci podręcznej Azure Redis Cache do kontenera.
...
## OPIS
Polecenie **cmdlet Export-AzRedisCache** eksportuje dane z pamięci podręcznej Azure Redis Cache do kontenera.
...
### —Prefiks
Określa prefiks do użycia dla nazw obiektów blob.
