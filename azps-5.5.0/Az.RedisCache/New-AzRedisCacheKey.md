...
## SYNOPSIS
Ponownie generuje klucz dostępu pamięci podręcznej Redis.
...
## OPIS
Polecenie **cmdlet New-AzRedisCacheKey** ponownie generuje klucz dostępu w usłudze Azure Redis Cache.

## PRZYKŁADY

### Przykład 1. Ponowne generowanie klucza podstawowego
```
...
To polecenie ponownie generuje klucz podstawowy pamięci podręcznej Redis.

### Przykład 2. Ponowne generowanie klucza pomocniczego
```
...
To polecenie ponownie generuje klucz pomocniczy pamięci podręcznej Redis.
...
### -KeyType
Określa, czy ponownie wygenerować klucz dostępu podstawowy, czy pomocniczy.
Prawidłowe wartości to: Podstawowy, Pomocniczy.
