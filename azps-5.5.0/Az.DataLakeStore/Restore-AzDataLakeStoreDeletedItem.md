...
## SYNOPSIS
Przywracanie usuniętego pliku lub folderu w usłudze Azure Data Lake.
...
## OPIS
Polecenie **cmdlet Restore-AzDataLakeStoreDeletedItem** przywraca usunięty plik lub folder w magazynie Data Lake Store. Wymaga ścieżki usuniętego elementu w Koszu zwróconej przez element Get-AzDataLakeStoreDeletedItem.
...
### Przykład 1. Przywracanie pliku ze sklepu Data Lake Store przy użyciu opcji wymuszania
```
...
### — miejsce docelowe
Ścieżka docelowa, do której należy przywrócić usunięty plik lub folder. 
...
### -PassThru
Zwraca wartość logiczną prawda w przypadku sukcesu.
...
### — Ścieżka
Ścieżka usuniętego pliku lub folderu w Koszu.
...
### -RestoreAction
Akcja do podjęcia w przypadku konfliktów nazwy miejsca docelowego — "kopiowanie" lub "zastępowanie"
...
### — Wpisz
Typ przywracanych wpisów — "plik" lub "folder"
