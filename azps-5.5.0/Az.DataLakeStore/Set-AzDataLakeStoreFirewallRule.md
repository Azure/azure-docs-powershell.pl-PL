...
## OPIS
Polecenie **cmdlet Set-AzDataLakeStoreFirewallRule** modyfikuje określoną regułę zapory w określonym magazynie Data Lake Store.

## PRZYKŁADY

### Przykład 1. Aktualizowanie początku i końca zakresu adresów IP reguły zapory
```
...
Aktualizuje regułę zapory "MyFirewallRule" w koncie "ContosoADL", aby mieć zakres od 127.0.0.1 do 127.0.0.2

## PARAMETERS

### — Konto
Konto usługi Data Lake Store w celu zaktualizowania reguły zapory w
...
### -ResourceGroupName
Określa nazwę grupy zasobów zawierającej konto, dla których ma być aktualizowane reguła zapory.
