...
## OPIS
Polecenie **cmdlet Remove-AzPowerBIWorkspaceCollection** usuwa kolekcję obszaru roboczego usługi Power BI z twojej subskrypcji platformy Azure i grupy zasobów.

## PRZYKŁADY

### Przykład 1. Usuwanie kolekcji obszaru roboczego
```
PS C:\>Remove-AzPowerBIWorkspaceCollection -ResourceGroupName "ResourceGroup17" -WorkspaceCollectionName "WCN11"
```

To polecenie usuwa zbiór obszarów roboczych o nazwie WCN11 w określonej grupie zasobów.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, z której to polecenie cmdlet usuwa kolekcję obszaru roboczego.
...
Określa nazwę zbioru obszarów roboczych usługi Power BI, które usuwa to polecenie cmdlet.
