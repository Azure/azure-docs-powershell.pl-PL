...
## SYNOPSIS
Tworzy nową pojemność osadzoną w u programie PowerBI.
...
## OPIS
Polecenie New-AzPowerBIEmbeddedCapacity cmdlet tworzy nową osadzoną pojemność usługi PowerBI
...
Tworzy wydajność o nazwie testcapacity w regionie Azure West Central US i w testRG grupy zasobów. Poziom SKU dla wydajności będzie mieć 1.

## PARAMETERS

### — Administrator
Nazwy rozdzielone przecinkami, które należy ustawić jako administrator w zakresie pojemności
...
### — Lokalizacja
Region platformy Azure, w którym jest hostowana osadzona pojemność usługi PowerBI
