...
## SYNOPSIS
Pobiera klucze dostępu udostępnionego używane do publikowania zdarzeń na temat siatki zdarzeń.
...
Pobiera klucze dostępu udostępnionego tematu Siatka zdarzeń \` , \` temat1, w grupie zasobów \` MyResourceGroupName. \`
