...
Usuwa temat domeny siatki zdarzeń \` (temat1) w \` obszarze Domain \` Domain1 \` (Domena domeny1) w grupie zasobów \` MyResourceGroupName (Nazwa_grupy \` zasobów).
...
### -ResourceId
Identyfikator zasobu reprezentujący temat domeny siatki zdarzeń.
