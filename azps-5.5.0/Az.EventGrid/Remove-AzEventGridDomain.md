...
Usuwa domenę domeny siatki \` zdarzeń1 \` w grupie zasobów \` MyResourceGroupName. \`
...
Usuwa domenę domeny siatki \` zdarzeń (1) w \` grupie zasobów \` MyResourceGroupName (Nazwa_grupy \` zasobów).
