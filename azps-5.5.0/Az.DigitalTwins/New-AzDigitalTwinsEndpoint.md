...
### Przykład 1. Tworzenie bazy danych AzDigitalTwinsEndpoint dla aplikacji Eventhub
```powershell
...
Tworzenie witryny AzDigitalTwinsEndpoint dla aplikacji Eventhub przez connectionStringPrimaryKey

### Przykład 2. Tworzenie witryny AzDigitalTwinsEndpoint dla aplikacji EventGrid
```powershell
...
Tworzenie witryny AzDigitalTwinsEndpoint dla aplikacji Eventhub według programu TopicEndpoint i uzyskiwanie dostępu do kluczaKey1

### Przykład 3. Tworzenie bazy danych AzDigitalTwinsEndpoint dla usługi ServiceBus
```powershell
...
Tworzenie punktu azDigitalTwinsEndpoint dla usługi ServicBus przez PrimaryConnectionString
...
### -DeadLetterSecret
Tajny magazyn listów traconych.
Podczas czytania zostanie on obmyty.
...
Aby skonstruować, zobacz sekcję NOTATKI, aby uzyskać informacje o właściwościach parametru ENDPOINTDESCRIPTION i utworzyć tabelę skrótu.
...
ENDPOINTDESCRIPTION: <IDigitalTwinsEndpointResource> zasób punktu końcowego DigitalTwinsInstance.
  - `EndpointType <EndpointType>`: typ punktu końcowego firmy Digital Przednia
  - `[DeadLetterSecret <String>]`: Tajny magazyn listów traconych. Podczas czytania zostanie on obmyty.
