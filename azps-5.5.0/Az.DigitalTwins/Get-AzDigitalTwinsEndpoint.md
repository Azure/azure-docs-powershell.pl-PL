...
Lista wszystkich elementów AzDigitalTwinsEndpoints według nazwy ResourceGroupName
...
### Przykład 3. Pobierz obiekt AzDigitalTwinsEndpoint za pomocą obiektu "AzDigitalTwinsEndpoint"
```powershell
...
Uzyskiwanie witryny AzDigitalTwinsEndpoint przez obiekt "AzDigitalTwinsEndpoint"
