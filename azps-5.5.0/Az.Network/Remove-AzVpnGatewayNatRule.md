...
## SYNOPSIS
Usuwa regułę NAT skojarzoną z siecią VpnGateway.
...
Powyższe spowoduje utworzenie grupy zasobów, wirtualnej sieci WAN, sieci wirtualnej, centrum wirtualnego, vpnGateway i reguły NAT skojarzonej z tą bramą VpnGateway.
Następnie usuwa regułę NAT przy użyciu nazwy reguły NAT.
...
### -PassThru
Zwraca obiekt reprezentujący element, na którym jest wykonywana ta operacja.
