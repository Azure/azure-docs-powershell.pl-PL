...
## OPIS
Polecenie **cmdlet Get-AzExpressRouteCircuitRouteTableSummary** pobiera podsumowanie informacji sąsiadów BGP dla określonego kontekstu routingu. Te informacje przydają się do określenia, jak długo został ustalony kontekst routingu i ile prefiksów trasy anonsuje router komunikacji równorzędnej.
