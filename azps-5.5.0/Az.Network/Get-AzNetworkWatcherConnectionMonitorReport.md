...
## OPIS
Polecenie Get-AzNetworkWatcherConnectionMonitorReport zwraca raport o najnowszych stanach połączenia.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie najnowszej migawki połączenia monitora połączenia według nazwy w określonej lokalizacji
```
...
W tym przykładzie sprawdzamy najnowsze stany połączenia określonego monitora połączenia.
...
### -ResourceId
Identyfikator zasobu monitora połączenia.
...
## NOTATKI
Słowa kluczowe: azure, azurerm, arm, resource, connectivity, management, manager, network, networking, network watcher, connection monitor
