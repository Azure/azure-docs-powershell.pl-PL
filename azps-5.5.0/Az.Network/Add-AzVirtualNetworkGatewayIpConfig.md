...
## OPIS
Polecenie **cmdlet Add-AzVirtualNetworkGatewayIpConfig** dodaje konfigurację adresu IP do bramy sieci wirtualnej.
...
### — Nazwa
Określa nazwę konfiguracji adresu IP bramy do dodania.
...
Za pomocą tego Get-AzVirtualNetworkGateway cmdlet można pobrać **obiekt PSVirtualNetworkGateway.**
