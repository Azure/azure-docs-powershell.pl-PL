...
## SYNOPSIS
Pobiera bieżący, zsumowany punkt na informacje o kondycji połączeń witryny z aplikacji P2SVpnGateway.
...
## OPIS
Polecenie **cmdlet Get-AzP2sVpnGatewayConnectionHealth** umożliwia uzyskiwanie bieżącej zagregowanej kondycji połączeń witryny z usługi P2SVpnGateway. Zagregowana kondycja pokazuje liczbę punktów klientów witryny połączonych z aplikacją P2SVpnGateway, całkowitą liczbę bajtów punktów przychodzących i wychodzących przesyłanych za pośrednictwem aplikacji P2SVpnGateway i przydzielonych adresów IP do połączonych punktów klientom witryny.
