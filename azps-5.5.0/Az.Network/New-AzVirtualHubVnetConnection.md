...
### ByVirtualHubNameByRemoteVirtualNetworkObject (Domyślne)
```
...
Polecenie New-AzVirtualHubVnetConnection cmdlet tworzy zasób HubVirtualNetworkConnection, który równorzędnie łączy sieć wirtualną z centrum wirtualnym platformy Azure. (wygenerowane automatycznie)
...
```
Powyższe spowoduje utworzenie nowej konfiguracji routingu i utworzenie tras statycznych w konfiguracji routingu z następnym przeskokem jako określonym adresem IP. Następnie ta konfiguracja routingu może zostać przekazana do New-AzVirtualHubVnetConnection jako parametr -RoutingConfiguration.
...
Zdalna sieć wirtualna, z którą jest połączone to połączenie sieci wirtualnej centrum.
