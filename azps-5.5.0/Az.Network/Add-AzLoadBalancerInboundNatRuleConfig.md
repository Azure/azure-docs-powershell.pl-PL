...
Drugie polecenie korzysta z operatora potoku w celu przekazania równoważenia obciążenia w programie $slb do dodatku **Add-AzLoadBalancerInboundNatRuleConfig,** co powoduje dodanie konfiguracji reguły nat ruchu przychodzącego do równoważenia obciążenia.
...
### — Nazwa
Określa nazwę konfiguracji reguły nat ruchu przychodzącego do dodania.
