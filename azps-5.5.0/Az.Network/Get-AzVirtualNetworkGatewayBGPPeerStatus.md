...
## OPIS
To polecenie wylicza, że równorzędne BGP są konfigurowane do komunikacji równorzędnej bramy wirtualnej platformy Azure. Jest również podawany stan każdej równorzędnej.
...
### — Peer
Adres IP współpracownika, dla których ma zostać pobrany stan
