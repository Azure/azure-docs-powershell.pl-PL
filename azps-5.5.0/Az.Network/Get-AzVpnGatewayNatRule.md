...
## SYNOPSIS
Pobiera regułę NAT skojarzoną z usługą VpnGateway.
...
Powyższe spowoduje utworzenie grupy zasobów, wirtualnej sieci WAN, sieci wirtualnej, centrum wirtualnego i sieci VpnGateway & regułę NAT skojarzoną z siecią Vpngateway.
Następnie reguła NAT uzyskuje nazwę reguły NAT.
...
### - ParentObject
Nadrzędny element VpnGateway dla tego elementu VpnGatewayNatRule.
...
### -ParentResourceId
Identyfikator zasobu nadrzędnej aplikacji VpnGateway dla tego elementu VpnGatewayNatRule.
