...
### ByVpnGatewayNameByVpnSiteObject (domyślne)
```
...
## OPIS
Tworzy połączenie IPSec łączące bramę VpnGateway ze zdalną gałęzią klienta reprezentowaną w Uściślanych klientach jako lokację VpnSite.
...
### - VpnSite
Zdalna witryna vpn, z którą jest połączone połączenie z wirtualną siecią w centrum.
...
Lista połączeń VpnSiteLinkConnections posiadana przez tę usługę VpnConnection.
