...
### 1. Usuwanie publicznego zasobu adresu IP
```
Remove-AzPublicIpAddress -Name $publicIpName -ResourceGroupName $rgName
```

To polecenie usuwa publiczny zasób adresu IP o nazwie $publicIpName w grupie zasobów $rgName.
...
### — Nazwa
Określa nazwę publicznego adresu IP, który usuwa to polecenie cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów zawierającą publiczny adres IP usuwany przez to polecenie cmdlet.
