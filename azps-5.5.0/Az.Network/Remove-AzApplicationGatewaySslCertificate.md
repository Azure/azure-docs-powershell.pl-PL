...
## OPIS
Polecenie cmdlet **Remove-AzApplicationGatewaySslCertificate** usuwa certyfikat Secure Sockets Layer (SSL) z bramy aplikacji azure.
...
Drugie polecenie usuwa certyfikat SSL o nazwie Cert02 z bramy aplikacji przechowywanej w $AppGW danych.
...
### — Nazwa
Określa nazwę certyfikatu SSL, który zostanie usuwany przez to polecenie cmdlet.
