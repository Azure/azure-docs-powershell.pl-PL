...
## SYNOPSIS
Modyfikuje obwód w układzie ExpressRoute.
...
## OPIS
Polecenie **cmdlet Set-AzExpressRouteCircuit** zapisuje zmodyfikowany obwód usługi ExpressRoute na platformie Azure.

## PRZYKŁADY

### Przykład 1. Zmienianie klucza usługi obwodu usługi ExpressRoute
```
...
### -ExpressRouteCircuit
Określa obiekt **ExpressRouteCircuit,** który zostanie zmodyfikowany przez to polecenie cmdlet.
