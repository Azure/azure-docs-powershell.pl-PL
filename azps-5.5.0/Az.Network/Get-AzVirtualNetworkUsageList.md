...
## OPIS
Polecenie **cmdlet Get-AzVirtualNetworkUsageList** pobiera użycie podsieci dla określonej sieci wirtualnej.
...
Pobiera dla podsieci bieżące wartości użycia dla sieci wirtualnej test użycia.
...
### — Nazwa
Określa nazwę sieci wirtualnej, dla których mają być wyświetlane użycia.
