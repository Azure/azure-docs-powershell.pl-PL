...
## SYNOPSIS
Tworzenie nowej listy analiz zagrożeń dla zasad zapory platformy Azure
...
## OPIS
Polecenie cmdlet **New-AzFirewallPolicyThreatIntelWhitelist** tworzy obiekt whitelist threat firmy Intel, którego można używać podczas tworzenia lub ustawiania zasad zapory platformy Azure.
...
W tym przykładzie jest białą listę zagrożeń firmy Intel zawierającą białą listę FQDN zawierającą jeden wpis i białą listę adresów IP zawierającą dwa wpisy.
