...
## OPIS
Polecenie **cmdlet Remove-AzRouteConfig** usuwa trasę z tabeli trasy platformy Azure.
...
Bieżące polecenie cmdlet usuwa trasę o nazwie Route02, a wynik przekazuje wynik do polecenia cmdlet **Set-AzRouteTable,** które aktualizuje tabelę w celu odzwierciedlenia wprowadzonych zmian.
...
### — Nazwa
Określa nazwę trasy, która zostanie usuwana przez to polecenie cmdlet.
...
### -RouteTable
Określa tabelę trasy zawierającą trasę usuwaną przez to polecenie cmdlet.
