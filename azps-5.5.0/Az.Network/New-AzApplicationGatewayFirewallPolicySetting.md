...
## OPIS
Ustawienie **New-AzApplicationGatewayFirewallPolicySetting** tworzy ustawienia zasad dla zasad zapory.
...
Polecenie tworzy ustawienie zasad o stanie $enabledState, trybie $enabledMode, requestBodyCheck jako fałsz, FileUploadLimitInMb jako $fileUploadLimitInMb i MaxRequestBodySizeInKb jako $$maxRequestBodySizeInKb.
Nowe ustawienia zasad są przechowywane w $condition.
...
### -MaxFileUploadInMb
Maksymalny rozmiar plikuŁaduj w MB.
...
### — województwo
Zmienna województwa w ustawieniach zasad zapory.
