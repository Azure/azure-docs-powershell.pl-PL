...
## OPIS
Polecenie **cmdlet New-AzExpressRoutePortIdentity** tworzy lokalny obiekt tożsamości usługi Azure ExpressRoutePort. Użyj **wyrażenia New-azExpressRoutePort** lub **Set-AzExpressRoutePort,** aby przypisać je do usługi Azure ExpressRoutePort.
