...
W drugim poleceniu polecenie cmdlet **Add-AzExpressRouteCircuitAuthorization** służy do dodawania nowej autoryzacji (ContosoCircuitAuthorization) do obwodu expressRoute. To polecenie powoduje dodanie autoryzacji, ale nie powoduje aktywowania tej autoryzacji. Aktywacja autoryzacji wymaga **ustawienia Set-AzExpressRouteCircuit** pokazanego w ostatnim poleceniu w przykładzie.
