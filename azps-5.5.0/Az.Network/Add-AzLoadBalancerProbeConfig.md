...
To polecenie pobiera równoważenie obciążenia o nazwie myLb, dodaje do niego określoną konfigurację konfiguracji konfiguracji, a następnie używa polecenia cmdlet **Set-AzLoadBalancer** w celu zaktualizowania równoważenia obciążenia.
