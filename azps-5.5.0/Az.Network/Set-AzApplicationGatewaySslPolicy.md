...
## OPIS
Polecenie cmdlet **Set-AzApplicationGatewaySslPolicy** modyfikuje zasady SSL bramy aplikacji.
...
Pierwsze polecenie pobiera bramę aplikacji o nazwie ApplicationGateway01 i zapisuje ją w $AppGw zmienną.
Drugie polecenie modyfikuje zasady ssl na zasady o typie Wstępnie zdefiniowane i o nazwie Zasady AppGwSslPolicy20170401.

## PARAMETERS

### -ApplicationGateway
Określa bramę aplikacji zasad SSL, które to polecenie cmdlet modyfikuje.
