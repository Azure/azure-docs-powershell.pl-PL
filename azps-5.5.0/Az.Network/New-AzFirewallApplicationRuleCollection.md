...
W tym przykładzie jest tworzyna kolekcja z jedną regułą. Dozwolony będzie cały ruch, który jest zgodnie z warunkami $rule 1.
Pierwsza reguła dotyczy całego ruchu HTTPS na porcie 443 z 10.0.0.0. Jeśli istnieje inny zbiór reguł aplikacji o wyższym priorytecie (mniejsza liczba), który również odpowiada ruchu zidentyfikowanego w programie $rule 1, zamiast tego zostanie wprowadzone działanie kolekcji reguł o wyższym priorytecie. 
