...
Polecenie **cmdlet Get-AzP2sVpnGateway** umożliwia uzyskanie istniejącej aplikacji P2SVpnGateway w obszarze VirtualHub, która jest używana do łączności z witryną typu Point to site.
