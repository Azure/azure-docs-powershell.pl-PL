...
## OPIS
Polecenie **cmdlet New-AzIpAllocation** tworzy usługę Azure IpAllocation
...
### -IpamAllocationId
Identyfikator alokacji ipam w alokacji ipam
...
### -PrefixLength
Długość prefiksu w alokacji adresów IP
