...
### ByPublicIpAddressByVirtualNetwork (Domyślne)
```
...
## OPIS
Tworzy zasób klasyki. Będzie to wymagało publicznego adresu IP i virtualNetwork. W tej witrynie VirtualNetwork.The Pubic Ip Address musi być utworzona za pomocą standardu SKU podsieci o nazwie AzureBastionSubnet.
...
### -PublicIpAddress
Publiczny obiekt adresu IP, który można przechylić.
...
### -PublicIpAddressId
Publiczny adres IP Azure Resource Id for bastion.
...
### -PublicIpAddressName
Nazwa publicznego zasobu adresu IP dla usługi.
...
Nazwa grupy zasobów publicznego adresu IP dla usługi.
...
### -ResourceGroupName
Nazwa grupy zasobów, w której należy utworzyć zasoby.
...
### — VirtualNetwork
Obiekt sieci wirtualnej dla pamięci.
...
### - VirtualNetworkId
Wirtualna sieć Azure Resource Id for.
...
### -VirtualNetworkName
Nazwa zasobu sieci wirtualnej dla firmy.
...
Nazwa grupy zasobów sieci wirtualnej dla klasy.
