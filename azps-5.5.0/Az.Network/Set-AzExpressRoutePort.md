...
## OPIS
Polecenie **cmdlet Set-AzExpressRoutePort** zapisuje zmodyfikowaną usługę ExpressRoutePort na platformie Azure.
...
Modyfikuje stan administratora łącza do usługi ExpressRoutePort
