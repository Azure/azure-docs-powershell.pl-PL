...
## OPIS
Polecenie **cmdlet Set-AzLoadBalancerOutboundRuleConfig** ustawia konfigurację reguły ruchu wychodzącego dla narzędzia do równoważenia obciążenia platformy Azure.

## PRZYKŁADY

### Przykład 1. Modyfikowanie konfiguracji reguły ruchu wychodzącego w równoważeniu obciążenia
```powershell
...
Drugie polecenie korzysta z operatora potoku w celu przekazania równoważenia obciążenia w programie $slb do dodatku Add-AzLoadBalancerOutboundRuleConfig, co powoduje dodanie do niego konfiguracji reguły ruchu wychodzącego.
Trzecie polecenie przekazuje równoważenie obciążenia do polecenia **Set-AzLoadBalancerOutboundRuleConfig,** które zapisuje i aktualizuje konfigurację reguł ruchu wychodzącego.
...
Adresy IP frontendu do równoważenia obciążenia.
