...
## SYNOPSIS
Pobierz dokument autoryzacji dla portu trasy ekspresowej.
...
## OPIS
New-AzExpressRoutePortLOA cmdlet pobiera dokument autoryzacji w formacie PDF dla portu trasy ekspresowej.
...
Pobierz dokument autoryzacji dla portu trasy ekspresowej "myPort" i przechowaj go w pliku "loa.pdf".
...
### -CustomerName
Nazwa klienta, do którego jest przypisany ten port trasy ekspresowej.
...
### — miejsce docelowe
Wyjściowa ścieżka pliku do przechowywania upoważnienia.
...
### -ResourceGroupName
Nazwa grupy zasobów dla portu trasy ekspresowej.
