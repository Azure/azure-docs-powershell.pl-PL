...
## SYNOPSIS
Usuwa grupę zabezpieczeń sieciowych.
...
## OPIS
Polecenie **cmdlet Remove-AzNetworkSecurityGroup** usuwa grupę zabezpieczeń sieci platformy Azure.

## PRZYKŁADY

### Przykład 1. Usuwanie grupy zabezpieczeń sieci
```
...
### — Nazwa
Określa nazwę grupy zabezpieczeń sieciowych, która jest usuwana przez to polecenie cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, z których to polecenie cmdlet usuwa grupę zabezpieczeń sieci.
