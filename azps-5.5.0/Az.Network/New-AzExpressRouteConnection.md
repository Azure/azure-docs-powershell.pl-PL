...
### ByExpressRouteGatewayName (Domyślna)
```
...
## OPIS
Tworzy połączenie usługi ExpressRoute między lokalnym obwodem usługi ExpressRoute komunikacji równorzędnej BGP z bramą usługi ExpressRoute w centrum wirtualnym.
...
### -AuthorizationKey
Klucz uzyskany od właściciela obwodu usługi ExpressRoute w celu możliwości utworzenia połączenia z bramą w innej subskrypcji.
...
Identyfikator zasobu komunikacji równorzędnej obwodu trasy expressowej, z którym ma zostać utworzone połączenie bramy trasy expressowej.
...
Nadrzędny element ExpressRouteGateway dla tego połączenia.
...
### -ParentResourceId
Identyfikator zasobu nadrzędnej aplikacji ExpressRouteGateway dla tego połączenia.
...
### -RoutingWeight
Waga routingu pakietów, która musi zostać przypisana do tego połączenia.
