...
Powyższe polecenie spowoduje usunięcie istniejącej konfiguracji VpnServerConfiguration.
...
### -InputObject
Obiekt vpnServerConfiguration do usunięcia.
...
### -ResourceId
Identyfikator zasobu Azure dla konfiguracji vpnServerConfiguration do usunięcia.
