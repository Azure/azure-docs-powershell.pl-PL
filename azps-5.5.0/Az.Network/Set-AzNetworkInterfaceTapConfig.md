...
## OPIS
**Set-AzNetworkInterfaceTapConfig** aktualizuje konfigurację naciśnięcia dla interfejsu sieciowego.

## PRZYKŁADY

### Przykład 1. Ustawianie konfiguracji TapConfiguration ze zaktualizowaną nazwą TapConfig
```
