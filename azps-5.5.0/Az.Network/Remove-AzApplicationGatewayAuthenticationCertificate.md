...
### Przykład 1. Usuwanie certyfikatu uwierzytelniania z bramy aplikacji
```
...
Drugie polecenie usuwa certyfikat uwierzytelniania o nazwie cert01 z bramy aplikacji.
...
### — Nazwa
Określa nazwę certyfikatu uwierzytelniania, który usuwa to polecenie cmdlet.
