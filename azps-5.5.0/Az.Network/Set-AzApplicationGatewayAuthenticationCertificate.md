...
Drugie polecenie aktualizuje certyfikat uwierzytelniania o nazwie cert01 w bramie aplikacji.
...
### -CertificateFile
Określa ścieżkę pliku certyfikatu uwierzytelniania, za pomocą którego to polecenie cmdlet aktualizuje certyfikat.
...
### — Nazwa
Określa nazwę certyfikatu uwierzytelniania, który będzie aktualizowany przez to polecenie cmdlet.
