...
Po utworzeniu brama jest połączona z lokalnym obwodem usługi ExpressRoute przy użyciu New-AzExpressRouteConnection usługi.
...
To polecenie spowoduje get all Connections in ExpressRoute "testExpressRoutegw", które zaczynają się od "test"
