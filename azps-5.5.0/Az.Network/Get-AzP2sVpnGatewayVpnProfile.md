...
## OPIS
Polecenie cmdlet **Get-AzP2sVpnGatewayVpnProfile** umożliwia generowanie i pobieranie adresu URL SAS klienta w celu pobrania profilu vpn w celu przekierowania konfiguracji klienta witryny do łączności z witryną P2SVpnGateway. Wskaż konfigurację klienta witryny przy użyciu tego profilu vpn, aby połączyć się tylko z tą konkretną aplikacją P2SVpnGateway.
...
Polecenie cmdlet **Get-AzP2sVpnGatewayVpnProfile** umożliwia generowanie i pobieranie adresu URL SAS klienta w celu pobrania profilu vpn w celu przekierowania konfiguracji klienta witryny do łączności z witryną P2SVpnGateway. ProfileUrl pokazuje adres URL SAS, z którego klient może pobrać profil Vpn w celu punktu konfiguracji klienta witryny.
