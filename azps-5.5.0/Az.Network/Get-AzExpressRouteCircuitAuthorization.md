...
**Następnie obiekt Where-Object** wybiera tylko te autoryzacje, dla których właściwość *AuthorizationUseStatus* jest ustawiona na Dostępny. Aby wyświetlić listę tylko tych uprawnień, które nie są dostępne, należy użyć tej składni dla klauzuli Where: `{$_.AuthorizationUseStatus -ne "Available"}`
