...
## OPIS
Polecenie **cmdlet Add-AzApplicationGatewayCustomError** powoduje dodanie błędu niestandardowego do bramy aplikacji.

## PRZYKŁADY

### Przykład 1. Dodanie błędu niestandardowego do poziomu bramy aplikacji
```powershell
...
To polecenie powoduje dodanie niestandardowego błędu o kodzie stanu http 502 do $appgw aplikacji i zwrócenie zaktualizowanej bramy.

### Przykład 2. Dodanie błędu niestandardowego do poziomu słuchacza bramy aplikacji
```powershell
...
To polecenie dodaje niestandardowy błąd o kodzie stanu http 502 do bramy aplikacji, która $appgw na poziomie słuchacza, i zwraca zaktualizowaną bramę.
