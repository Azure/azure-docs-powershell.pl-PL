...
## OPIS
Polecenie **cmdlet Get-AzApplicationGatewaySslCertificate** otrzymuje certyfikat SSL dla bramy aplikacji.
...
Polecenie przechowuje certyfikat w zmiennej o nazwie $Cert.
...
Drugie polecenie pobiera listę certyfikatów SSL z bramy aplikacji przechowywanych w zmiennej o nazwie $AppGW.
Następnie polecenie przechowuje wyniki w zmiennej o nazwie $Certs.

## PARAMETERS

### - ApplicationGateway
Określa obiekt bramy aplikacji zawierający certyfikat SSL.
...
### — Nazwa
Określa nazwę puli certyfikatów SSL, która otrzymuje to polecenie cmdlet.
