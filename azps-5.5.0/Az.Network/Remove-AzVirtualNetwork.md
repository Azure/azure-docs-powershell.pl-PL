...
## OPIS
Polecenie **cmdlet Remove-AzVirtualNetwork** usuwa sieć wirtualną platformy Azure.
...
W tym przykładzie jest grupę zasobów, która jest siecią wirtualną, a następnie natychmiast usuwana. Aby pominąć monit podczas usuwania sieci wirtualnej, użyj flagi -Force.
...
### — Nazwa
Określa nazwę sieci wirtualnej, która jest usuwana przez to polecenie cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów zawierającej sieć wirtualną, która jest usuwana przez to polecenie cmdlet.
