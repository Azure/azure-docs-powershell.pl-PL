...
## OPIS
Polecenie **cmdlet Update-AzVpnGateway** aktualizuje skalowalną bramę VPN.  
Brama Azure VPN to zdefiniowana przez oprogramowanie łączność witryny z witryną w aplikacji VirtualHub. Ta brama zmienia rozmiar i skaluje na podstawie jednostki skali określonej przez użytkownika. Połączenie można skonfigurować z gałęzi/witryny sieci VPN do skalowalnej bramy. Każde połączenie składa się z 2 Active-Active i podkołowych
...
Po utworzeniu bramy brama używa Update-AzVpnGateway do uaktualnienia bramy do 3 jednostek skali.
...
Po utworzeniu bramy używa ona Set-AzVpnGateway BgpPeeringAddress.
...
### -BgpPeeringAddress
Adresy komunikacji równorzędnej BGP dla tego elementu bgpsettings usługi VpnGateway.
...
### -InputObject
Obiekt bramy sieci vpn, który ma zostać zmodyfikowany
...
### -ResourceId
Identyfikator zasobu Azure w usłudze VpnGateway do modyfikacji.
