...
## OPIS
Polecenia **cmdlet Set-AzExpressRouteCircuitPeeringConfig** zapisują zmodyfikowaną konfigurację komunikacji równorzędnej usługi ExpressRoute z powrotem na platformie Azure.
...
Umożliwia zapisanie zmodyfikowanej konfiguracji komunikacji równorzędnej usługi ExpressRoute. (wygenerowane automatycznie)
...
### -ExpressRouteCircuit
Obiekt obwodu usługi ExpressRoute zawierający konfigurację komunikacji równorzędnej do zmodyfikowania.
