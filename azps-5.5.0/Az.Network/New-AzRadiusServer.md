...
## OPIS
Polecenie New-AzRadiusServer cmdlet tworzy konfigurację serwera o promieniu zewnętrznym do użytku w wirtualnej bramie sieciowej i konfiguracji serwera VPN.
...
Tworzenie wielu konfiguracji serwera o promieniu zewnętrznym, które będą używane do konfigurowania serwera P2S w nowej bramie sieci wirtualnej.
...
### -RadiusServerAddress
Adres serwera o promieniu zewnętrznym
...
### -RadiusServerScore
Wynik serwera o promieniu zewnętrznym
...
### -RadiusServerSecret
Zewnętrzny serwer promienia tajny
