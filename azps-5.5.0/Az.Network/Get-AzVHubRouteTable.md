...
## SYNOPSIS
Pobiera zasób tabeli trasy centrum skojarzonego z usługą VirtualHub.
...
## OPIS
Pobiera tabelę określonej trasy centrum skojarzonej z określonym centrum wirtualnym.
...
To polecenie pobiera tabelę tras centrum w centrum wirtualnym.
...
To polecenie wyświetla listę wszystkich tabel tras centrum w określonej aplikacji VirtualHub.
...
### -ResourceId
Identyfikator zasobu, który można pobrać.
