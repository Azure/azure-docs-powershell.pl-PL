...
Połączenie VPN tworzy połączenie IPsec, które łączy bramę VPN z zdalną gałąź klienta reprezentowaną na platformie Azure jako witryna VPN.
...
Lista połączeń VpnSiteLinkConnections, które musi mieć ta usługa VpnConnection.
