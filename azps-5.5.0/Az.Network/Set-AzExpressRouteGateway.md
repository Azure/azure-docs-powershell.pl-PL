...
Polecenie **cmdlet Set-AzExpressRouteGateway** umożliwia aktualizowanie jednostek skali dla istniejącej aplikacji ExpressRouteGateway lub aktualizowanie tagów zasobów.
...
### -InputObject
Brama expressroute, która wymaga zaktualizowania.
...
### -MaxScaleUnits
Maksymalna liczba jednostek skali dla tej bramy expressRouteGateway. Prawidłowy zakres > 2
...
### -ResourceGroupName
Nazwa grupy zasobów, która ma zostać zaktualizowana przez bramę expressRoute.
...
### -ResourceId
Identyfikator aplikacji ExpressRouteGateway, który należy zaktualizować.
