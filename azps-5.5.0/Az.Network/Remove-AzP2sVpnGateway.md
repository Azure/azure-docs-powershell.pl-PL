...
## OPIS
Polecenie **cmdlet Remove-AzP2sVpnGateway** umożliwia usunięcie istniejącej aplikacji P2SVpnGateway w obszarze VirtualHub. Po usunięciu aplikacji P2SVpnGateway cały punkt łączności klientów witryny nie powiedzie się.
...
Polecenie **cmdlet Remove-AzP2sVpnGateway** umożliwia usunięcie istniejącej aplikacji P2SVpnGateway w obszarze VirtualHub.
...
### -InputObject
Obiekt p2sVpnGateway do usunięcia.
...
### -ResourceId
Identyfikator zasobu Azure dla aplikacji p2sVpnGateway do usunięcia.
