...
## OPIS
Polecenie **cmdlet Get-AzApplicationGateway** otrzymuje bramę aplikacji.
...
To polecenie pobiera bramę aplikacji o nazwie ApplicationGateway01, która należy do grupy zasobów o nazwie ResourceGroup01, i przechowuje ją w zmiennej $AppGw zasobów.
...
To polecenie pobiera listę wszystkich bram aplikacji w grupie zasobów o nazwie ResourceGroup01 i przechowuje je w zmiennej $AppGwList zasobów.
...
To polecenie pobiera listę wszystkich bram aplikacji w subskrypcji i zapisuje je w $AppGwList zmienną.
...
To polecenie pobiera listę wszystkich bram aplikacji w subskrypcji, które zaczynają się od "ApplicationGateway01" i przechowuje je w zmiennej $AppGwList aplikacji.
...
### — Nazwa
Określa nazwę bramy aplikacji, która otrzymuje to polecenie cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów zawierającej bramę aplikacji.
