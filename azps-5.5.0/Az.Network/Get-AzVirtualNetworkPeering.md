...
## SYNOPSIS
Pobiera wirtualną sieć równorzędną.
...
## OPIS
Polecenie **cmdlet Get-AzVirtualNetworkPeering** pobiera połączenie równorzędne z siecią wirtualną.
...
### Przykład 2. Uzyskiwanie wszystkich komunikacji równorzędnych w sieci wirtualnej
```
...
### -ResourceGroupName
Określa nazwę grupy zasobów, do której należy komunikacja równorzędna sieci wirtualnej.
...
### -VirtualNetworkName
Określa nazwę sieci wirtualnej, która otrzymuje to polecenie cmdlet.
