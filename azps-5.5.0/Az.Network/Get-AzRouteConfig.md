...
## OPIS
Polecenie **cmdlet Get-AzRouteConfig** pobiera trasy z tabeli tras platformy Azure.
Trasę można określić według nazwy.
...
### — Nazwa
Określa nazwę trasy, do która otrzymuje to polecenie cmdlet.
...
### -RouteTable
Określa tabelę trasy, z której to polecenie cmdlet pobiera trasy.
