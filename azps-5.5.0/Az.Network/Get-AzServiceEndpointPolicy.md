...
To polecenie pobiera zasady punktu końcowego usługi o nazwie ServiceEndpointPolicy1, które należą do grupy zasobów o nazwie ResourceGroup01, i przechowuje je w zmiennej $policy zasobów.
