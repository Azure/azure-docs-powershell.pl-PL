...
### 1. Zmienianie adresu IP konfiguracji protokołu IP
```
...
Pierwsze dwa polecenia otrzymają wirtualną sieć o nazwie myvnet i podsieci o nazwie mysubnet i przechowaj ją w zmiennych$vnet i $subnet. Trzecie polecenie pobiera interfejs sieciowy nic1 skojarzony z konfiguracją protokołu IP, która wymaga aktualizacji. Trzecie polecenie ustawia prywatny adres IP podstawowej konfiguracji ipconfig1 na 10.0.0.11. Ostatnie polecenie aktualizuje interfejs sieciowy, upewniając się, że zmiany zostały wprowadzone pomyślnie.
...
Określa zbiór odwołań do puli adresów zaplecza równoważenia obciążenia, do której należy ta konfiguracja adresu IP interfejsu sieciowego.
...
Określa zbiór odwołań do reguł przychodzącego serwera NAT dla równoważenia obciążenia, do których należy ta konfiguracja adresu IP interfejsu sieciowego.
