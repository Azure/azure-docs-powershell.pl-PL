...
### ByVirtualHubRouteTableName (domyślna)
```
...
## OPIS
Usuwa określoną tabelę trasy skojarzoną z określonym centrum wirtualnym.
...
To polecenie usuwa tabelę routeTable1 centrum wirtualnego Westushub.
...
### -InputObject
Zasób, który można usunąć w wirtualnej usłudze.
...
### -ResourceId
Identyfikator zasobu, który można usunąć w wirtualnej aplikacjiHubroutetable.
