...
## OPIS
Polecenie **cmdlet New-AzFirewallThreatIntelWhitelist** tworzy obiekt analizy zagrożeń, którego można używać podczas tworzenia lub ustawiania zapory platformy Azure.
...
W tym przykładzie jest białą listę zagrożeń firmy Intel zawierającą białą listę FQDN zawierającą dwa wpisy oraz białą listę adresów IP zawierającą dwa wpisy.
...
### -IpAddress
Adresy IP listy zagrożeń" (Threat Intel Whitelist)
