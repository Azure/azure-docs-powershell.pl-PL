...
## SYNOPSIS
Aktualizacje poprawki CustomIpPrefix
...
## OPIS
Polecenie **cmdlet Update-AzCustomIpPrefix** umożliwia użytkownikowi prowizję lub zlikwidowanie jego poprawki CustomIpPrefix albo edytowanie tagów zasobu.

## PRZYKŁADY

### Przykład 1. Prowizja dla poprawki CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Commission
```

Powyższe polecenie rozpocznie proces uruchamiania poprawki CustomIpPrefix.

### Przykład 2. Zlikwidowanie poprawki CustomIpPrefix
```powershell
...
### Przykład 3. Aktualizowanie tagów dla poprawki CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Tag $tags
```

Powyższe polecenie zaktualizuje tagi dla poprawki CustomIpPrefix.
...
### -InputObject
Ustawienie niestandardowego rozwiązaniaIpPrefix.
