...
## OPIS
Polecenie **cmdlet Remove-AzApplicationGateway** usuwa bramę aplikacji.
...
To polecenie usuwa bramę aplikacji o nazwie ApplicationGateway01 z grupy zasobów o nazwie ResourceGroup01.
...
### — Wymuszanie
Wskazuje, że polecenie cmdlet wymusza usunięcie bramy aplikacji, niezależnie od tego, czy zasoby są do niego przypisane.
...
### — Nazwa
Określa nazwę bramy aplikacji do usunięcia.
