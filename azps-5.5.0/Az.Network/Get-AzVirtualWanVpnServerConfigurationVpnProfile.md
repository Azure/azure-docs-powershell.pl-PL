...
### ByVirtualWanNameByVpnServerConfigurationObject (Domyślne)
```
...
## OPIS
Polecenie **cmdlet Get-AzVirtualWanVpnServerConfigurationVpnProfile** umożliwia generowanie i pobieranie profilu vpn na VirtualWan-VpnServerConfiguration na poziomie klienta typu Point to site. Jest to wymagane do połączenia point-site z klienta point-site do usługi Azure P2SVpnGateway.
...
Powyższe polecenie wygeneruje i zwróci adres URL SAS klienta w celu pobrania profilu vpn na VirtualWan-VpnServerConfiguration konfiguracji klienta typu Wskaż witrynę.
...
### -ResourceId
Identyfikator zasobu Azure dla wirtualnej sieci Wan.
...
Konfiguracja VpnServerConfiguration, z którą jest skojarzona ta wirtualna zmiana.
...
Identyfikator obiektu serwera VPN konfiguruje ten wirtualny wan.
