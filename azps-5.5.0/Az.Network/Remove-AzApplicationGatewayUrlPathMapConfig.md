...
## OPIS
Polecenie **cmdlet Remove-AzApplicationGatewayUrlPathMapConfig** usuwa mapowania ścieżek adresów URL na pulę serwerów zaplecza.

## PRZYKŁADY

### Przykład 1. Usuwanie mapowania ścieżki adresu URL z bramy aplikacji
```
...
Drugie polecenie usuwa mapowanie ścieżki adresu URL o nazwie map01 z bramy aplikacji.
Trzecie polecenie aktualizuje bramę aplikacji.

## PARAMETERS

### - ApplicationGateway
Określa bramę aplikacji, do której to polecenie cmdlet usuwa konfigurację mapy ścieżki adresu URL.
...
### — Nazwa
Określa nazwę mapy ścieżki adresu URL, którą to polecenie cmdlet usuwa z serwera zaplecza.
