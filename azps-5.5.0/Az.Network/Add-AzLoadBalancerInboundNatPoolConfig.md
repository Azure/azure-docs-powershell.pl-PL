...
## OPIS
Polecenie **cmdlet Add-AzLoadBalancerInboundNatPoolConfig** dodaje pulę nat ruchu przychodzącego do równoważenia obciążenia.
...
Limit czasu dla bezczynne połączenie TCP. Wartość można ustawić między 4 a 30 minutami. Wartość domyślna to 4 minuty. Ten element jest używany tylko wtedy, gdy protokół ma ustawioną wartość TCP.
