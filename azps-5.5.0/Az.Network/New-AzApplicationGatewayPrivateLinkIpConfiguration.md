...
## OPIS
Polecenie cmdlet **New-AzApplicationGatewayPrivateLinkIpConfiguration** tworzy konfigurację adresu IP skojarzoną z konfiguracją privatelinku dla bramy aplikacji Azure.
...
To polecenie tworzy konfigurację ip privateLink o nazwie "ipConfig01" i zapisuje wynik w zmiennej o nazwie $PrivateLinkIpConfiguration. 
...
### -PrivateIpAddress
Prywatny adres IP konfiguracji ip, jeśli jest żądana alokacja statyczna.
