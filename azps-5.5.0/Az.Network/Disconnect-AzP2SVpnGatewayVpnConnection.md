...
## OPIS
Polecenie cmdlet **Disconnect-AzP2sVpnGatewayVpnConnection** umożliwia odłączenie od aplikacji P2SVpnGateway bieżącego punktu połączenia z witryną.
...
### -ResourceId
Identyfikator zasobu wirtualnej bramy sieciowej P2s
