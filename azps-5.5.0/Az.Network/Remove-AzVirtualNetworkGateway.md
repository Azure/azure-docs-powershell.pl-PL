...
### Przykład 1. Usuwanie bramy sieci wirtualnej
```powershell
Remove-AzVirtualNetworkGateway -Name myGateway -ResourceGroupName myRG
```

Usuwa obiekt wirtualnej bramy sieciowej o nazwie "myGateway" w grupie zasobów "myRG" Uwaga: Należy najpierw usunąć wszystkie połączenia z wirtualną bramą sieciową przy użyciu polecenia cmdlet **Remove-AzVirtualNetworkGatewayConnection.**
...
### — Nazwa
Określa nazwę bramy sieci wirtualnej, która jest usuwana przez to polecenie cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów zawierającej bramę sieci wirtualnej.
