...
## OPIS
Polecenie **cmdlet Remove-AzApplicationGatewayPrivateLinkConfiguration** usuwa konfigurację privateLink z bramy aplikacji Azure.

## PRZYKŁADY

### Przykład 1. Usuwanie konfiguracji privatelinku bramy aplikacji
```
