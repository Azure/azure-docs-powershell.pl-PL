...
W tym przykładzie jest obiektu ustawień dns z ustawieniem włączania serwera proxy dns.

### 2. Tworzenie pustych zasad przy użyciu trybu ThreatIntel
```powershell
PS C:\> $dnsServers = @("10.10.10.1", "20.20.20.2")
PS C:\> New-AzFirewallPolicyDnsSetting -EnableProxy -Server $dnsServers
```

W tym przykładzie jest tworzyć obiekty dns Setting z ustawieniem włączania serwera proxy DNS i ustawiania niestandardowych serwerów dns.
