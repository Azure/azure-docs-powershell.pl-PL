...
Powyższe spowoduje utworzenie grupy zasobów, Virtual WAN, Virtual Network, Virtual Hub w West Central US w grupie zasobów "testRG" na platformie Azure. Brama usługi ExpressRoute zostanie utworzona w centrum wirtualnym z 2 jednostkami skali.

Następnie pobiera ona bramę ExpressRouteGateway przy użyciu nazwy resourceGroupName i nazwy bramy.
...
To polecenie spowoduje uruchomienie wszystkich przejść przez wszystkie przejścia w uście expressRouteGateway, które zaczynają się od "testu".
