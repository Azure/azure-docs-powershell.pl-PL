...
Powyższe spowoduje utworzenie grupy zasobów: Virtual WAN, Virtual Network, Virtual Hub w centrum centralnym Stanów Zjednoczonych w tej grupie zasobów na platformie Azure. Jest również tworzone połączenie sieci wirtualnej, które jest równorzędne dla sieci wirtualnej z centrum wirtualnym. To połączenie sieci wirtualnej zostanie następnie zaktualizowane w celu włączenia zabezpieczeń internetowych.
