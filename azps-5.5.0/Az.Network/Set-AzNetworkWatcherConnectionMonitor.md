...
## OPIS
Polecenie Set-AzNetworkWatcherConnectionMonitor aktualizuje zasób monitora połączenia.

## PRZYKŁADY

### Przykład 1. Aktualizowanie monitora połączenia
```
...
W tym przykładzie aktualizujemy istniejący monitor połączenia, zmieniając adres docelowyAddress i dodając tagi.
