...
## SYNOPSIS
Pobiera szczegółowe informacje bieżącego punktu połączenia z witryną z aplikacji P2SVpnGateway.

## SKŁADNIA

### ByP2SVpnGatewayName (domyślna)
```
...
## OPIS
Polecenie **cmdlet Get-AzP2sVpnGatewayDetailedConnectionHealth** umożliwia uzyskiwanie szczegółowych informacji o bieżących połączeniach witryny z aplikacji P2SVpnGateway. Klient musi przekazać adres URL SAS, gdzie możemy umieścić te szczegółowe informacje o kondycji.
...
Polecenie **cmdlet Get-AzP2sVpnGatewayDetailedConnectionHealth** umożliwia uzyskiwanie szczegółowych informacji o bieżących połączeniach witryny z aplikacji P2SVpnGateway. Klient może pobrać szczegóły kondycji z przekazywanego adresu URL SAS. Spowoduje to pokazanie informacji o każdym punkcie połączenia z witryną z nazwami użytkownika, bajtami w bajtach, przydzielonym adresem IP itp.
...
### -OutputBlobSasUrl
Adres URL OutputBlob Sas, na który zostanie wpisana kondycja połączenia sieci vpn p2s.
...
### -VpnUserNamesFilter
Lista nazw użytkowników sieci vpn P2S do filtrowania.
