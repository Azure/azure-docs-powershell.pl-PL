...
W tym przykładzie jest pobierana zapora, a następnie pobierana jest kolekcja reguł według nazwy (metoda wywoływania: GetApplicationRuleCollectionByName) na obiekcie zapory. Nazwa zbioru reguł metody GetApplicationRuleCollectionByName jest bez uwzględniania liter.
...
W tym przykładzie jest pobierana zapora, a następnie usuwana jest kolekcja reguł według nazwy ( metoda wywoływania: RemoveApplicationRuleCollectionByName) na obiekcie zapory. Nazwa zbioru reguł metody RemoveApplicationRuleCollectionByName jest bez uwzględniania liter.
