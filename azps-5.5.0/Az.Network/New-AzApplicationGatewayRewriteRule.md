...
## OPIS
**Polecenie cmdlet New-AzApplicationGatewayRewriteRule** tworzy regułę ponownego tworzenia dla bramy aplikacji platformy Azure.

## PRZYKŁADY

### Przykład 1. Tworzenie reguły ponownego tworzenia dla bramy aplikacji
```powershell
PS C:\> $rule = New-AzApplicationGatewayRewriteRule -Name rule1 -ActionSet $action -RuleSequence 101 -Condition $condition
```

To polecenie tworzy regułę o nazwie reguła1 i zapisuje wynik w zmiennej o nazwie $rule.

## PARAMETERS

### - ActionSet
Zestaw akcji reguły ponownego edytowania
...
### — Warunek
Warunek wykonania reguły ponownego edytu
...
### -RuleSequence
Kolejność reguł tej reguły ponownego agowania w zestawie reguł ponownego edytowania
