...
## OPIS
Polecenie **cmdlet Set-AzNetworkSecurityRuleConfig** aktualizuje konfigurację reguły zabezpieczeń sieciowych dla grupy zabezpieczeń sieci.
...
Drugie polecenie przekaże grupę zabezpieczeń w programie $nsg do usługi Get-AzNetworkSecurityRuleConfig, która pobiera konfigurację reguł zabezpieczeń o nazwie rdp-rule.
Trzecie polecenie zmienia konfigurację dostępu reguły rdp na Odmów.
...
- Symbol wieloznaczny (*) w celu dopasowania dowolnego portu
