...
Pamiętaj, że przed uruchomieniem **set-azExpressRouteCircuitConnectionConfig** musisz dodać połączenie obwodu przy użyciu dodatku **AzExpressRouteCircuitConnectionConfig.** Ponadto po uruchomieniu **set-azExpressRouteCircuitPeeringConfig** musisz wywołać Set-AzExpressRouteCircuit cmdlet, aby aktywować konfigurację.
...
lub co najmniej /125 miejsca na adres klienta, aby utworzyć obwody VxLan między obwodami trasy expressowej dla adresów IPv6.
