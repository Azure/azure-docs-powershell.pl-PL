...
To polecenie pobiera grupę zabezpieczeń sieci platformy Azure o nazwie Nsg1 i dodaje regułę zabezpieczeń sieciowych o nazwie Rdp-Rule, aby zezwolić na ruch internetowy na porcie 3389 do pobranego obiektu grupy zabezpieczeń sieci przy użyciu dodatku Add-AzNetworkSecurityRuleConfig.
Polecenie będzie zachowywać zmodyfikowaną grupę zabezpieczeń sieci platformy Azure przy użyciu **polecenia Set-AzNetworkSecurityGroup.**
...
Określa obiekt grupy zabezpieczeń sieci reprezentujący stan, dla którego grupa zabezpieczeń sieci powinna zostać ustawiona.
