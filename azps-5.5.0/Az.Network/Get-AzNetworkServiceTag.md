...
### — Lokalizacja
Lokalizacja, która będzie używana jako odwołanie do wersji (nie jako filtr oparty na lokalizacji, zostanie wyświetlona lista tagów usługi ze szczegółami prefiksu we wszystkich regionach, ale ograniczona do chmury, do której należy Twoja subskrypcja).
