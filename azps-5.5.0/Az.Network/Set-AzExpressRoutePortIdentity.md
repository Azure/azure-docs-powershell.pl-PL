...
## OPIS
Polecenie **cmdlet Set-AzExpressRoutePortIdentity** aktualizuje lokalny obiekt Azure ExpressRoutePort. Użyj **wyrażenia Set-AzExpressRoutePort,** aby przypisać je do wyrażenia ExpressRoutePort.
...
Identyfikator Zasobu przypisanej tożsamości użytkownika, który ma zostać przypisany do portu ExpressRoutePort.
