...
## SYNOPSIS
Tworzy konfigurację SAF dla bramy aplikacji.
...
Pierwsze polecenie tworzy nową wyłączono konfigurację grupy reguł dla grupy reguł o nazwie "REQUEST-942-APPLICATION-ATTACK-SQLI" z wyłączonymi regułami 942130 i regułą 942140.
...
Ostatnie polecenie utworzy konfigurację aplikacji WAF z wyłączonymi regułami zapory skonfigurowanymi w $disabledRuleGroup 1 i $disabledRuleGroup 2. Nowa konfiguracja SAF jest przechowywana w $firewallConfig sieci.
...
### — włączone
Wskazuje, czy jest włączony SAF.
