...
### Przykład 3. Uzyskiwanie wszystkich planów ochrony przed DDoS w subskrypcji
```
...
To polecenie cmdlet zwraca wszystkie Plany DdosProtection, które zaczynają się od "test".
