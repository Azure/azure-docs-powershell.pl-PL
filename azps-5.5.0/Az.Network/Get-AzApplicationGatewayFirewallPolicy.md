...
To polecenie pobiera zasady zapory bramy aplikacji o nazwie FirewallPolicy1, które należą do grupy zasobów o nazwie ResourceGroup01, i przechowuje je w zmiennej $AppGwFirewallPolicy zasobów.
