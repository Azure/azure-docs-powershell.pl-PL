...
## OPIS
Polecenie **cmdlet Get-AzRouteTable** pobiera tabele tras platformy Azure.
Możesz pobrać jedną tabelę trasy lub pobrać wszystkie tabele tras w grupie zasobów lub w ramach subskrypcji.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie tabeli tras
```
...
### Przykład 2. Lista tabel tras przy użyciu filtrowania
```
...
To polecenie pobiera wszystkie tabele tras, których nazwa zaczyna się od "RouteTable"
...
### — Nazwa
Określa nazwę tabeli trasy, która będzie pobierana przez to polecenie cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów zawierającej tabele tras, które otrzymuje to polecenie cmdlet.
