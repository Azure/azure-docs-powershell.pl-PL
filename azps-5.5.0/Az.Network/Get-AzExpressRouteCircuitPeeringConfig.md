...
## OPIS
Polecenie **cmdlet Get-AzExpressRouteCircuitPeeringConfig** pobiera konfigurację relacji komunikacji równorzędnej dla obwodu usługi ExpressRoute.

## PRZYKŁADY

### Przykład 1. Wyświetlanie konfiguracji komunikacji równorzędnej dla obwodu usługi ExpressRoute
```
...
### -ExpressRouteCircuit
Obiekt obwodu usługi ExpressRoute zawierający konfigurację komunikacji równorzędnej.
