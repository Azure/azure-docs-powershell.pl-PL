...
## OPIS
Polecenie **cmdlet New-AzNetworkProfile** tworzy nowy zasób najwyższego poziomu profilu sieciowego.
...
Powoduje to utworzenie nowego zasobu najwyższego poziomu profilu sieciowego

### Przykład 2

Tworzy nowy profil sieciowy. (wygenerowane automatycznie)
...
### -ContainerNicConfig
Interfejs sieciowy kontenerów, który można dodać do tego profilu sieciowego.
