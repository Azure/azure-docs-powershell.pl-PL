...
## OPIS
Polecenie **cmdlet Add-AzApplicationGatewayRequestRoutingRule** dodaje regułę routingu żądania do bramy aplikacji.

## PRZYKŁADY

### Przykład 1. Dodawanie reguły routingu żądania do bramy aplikacji
```
...
Drugie polecenie dodaje regułę routingu żądania do bramy aplikacji.

## PARAMETERS

### - ApplicationGateway
Określa bramę aplikacji, do której to polecenie cmdlet dodaje regułę routingu żądania.
...
### -BackendAddressPool
Określa obiekt puli adresów back-end bramy aplikacji.
...
Określa identyfikator puli adresów dla bramy końcowej aplikacji.
...
### -BackendHttpSettings
Określa obiekt ustawień protokołu HTTP dla bramy aplikacji.
...
Określa identyfikator ustawień protokołu HTTP zaplecza dla bramy aplikacji.
...
### - HttpListener
Określa obiekt słuchacza HTTP bramy aplikacji.
...
### — Nazwa
Określa nazwę reguły routingu żądania, które dodaje to polecenie cmdlet.
...
### -UrlPathMapId
Określa identyfikator mapy ścieżki adresu URL reguły routingu.
