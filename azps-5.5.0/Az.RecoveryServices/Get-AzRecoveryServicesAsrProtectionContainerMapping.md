...
## OPIS
Polecenie cmdlet **Get-AzRecoveryServicesAsrProtectionContainerMapping** pobiera informacje o kontenerze ochrony do mapowania zasad replikacji(skojarzenia) w magazynie dla określonego kontenera ochrony asr.
...
Pobiera wszystkie mapowania kontenerów ochrony dla określonego kontenera ochrony.
...
### — Nazwa
Określa nazwę mapowania kontenerów ochrony do uzyskania.
...
### -ProtectionContainer
Uzyskaj mapowania kontenerów ochrony odpowiadające określoneowi obiektowi kontenera ochrony asr.
