...
## OPIS
To polecenie cmdlet służy do dodawania lub usuwania msi z magazynu usług odzyskiwania. Użyj paramu -IdentityType, aby przypisać tożsamość systemową do RSVault. Użyj identitytype none, aby usunąć msi z magazynu.
