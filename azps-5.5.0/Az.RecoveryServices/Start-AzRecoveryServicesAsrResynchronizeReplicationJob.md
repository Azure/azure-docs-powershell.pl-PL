...
## OPIS
Polecenie cmdlet **Start-AzRecoveryServicesAsrResynchronizeReplicationJob** rozpoczyna ponowne synchronizowanie replikacji dla określonego chronionego elementu, jeśli chroniony znajduje się w stanie wymaganej ponownej synchronizacji.
...
Uruchamia zadanie ponownej synchronizacji replikacji dla elementu chronionego replikacją przekazaną.
...
Element chroniony replikacją asr w celu ponownej synchronizacji replikacji.
...
### -ResourceId
Identyfikator zasobu elementu chronionego replikacją w celu ponownej synchronizacji.
