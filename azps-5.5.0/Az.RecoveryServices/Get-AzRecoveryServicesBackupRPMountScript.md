...
## OPIS
Polecenie Get-AzRecoveryServicesBackupRPMountScript cmdlet pobiera skrypt, który chowa woluminy punktu odzyskiwania na komputerze, na którym jest uruchamiany.

## PRZYKŁADY

### Przykład 1. Montuj punkt odzyskiwania
```powershell
...
Po uruchomieniu skrypt zainstaluje pliki punktu odzyskiwania dla $rp \[ 0\]

### Przykład 2

Pobiera skrypt, aby zainstalować wszystkie pliki punktu odzyskiwania. (wygenerowane automatycznie)
...
### — Ścieżka
Lokalizacja, w której plik powinien zostać pobrany w przypadku odzyskiwania pliku. Jeśli nie podano nazwy -Path, plik skryptu zostanie pobrany w bieżącym katalogu.
...
### Microsoft.Azure.Commands.RecoveryServices.Backup.Cmdlet.Models.SQLMountScriptDetails
