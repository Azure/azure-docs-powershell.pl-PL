...
## OPIS
Polecenie cmdlet **New-AzRecoveryServicesAsrNetworkMapping** rozpoczyna operację tworzenia mapowania sieci asr między dwiema sieciami i zwraca obiekt zadania asr dla zadania asr służącego do śledzenia operacji.
...
Rozpoczyna operację tworzenia mapowania sieci przy użyciu określonej nazwy, sieci podstawowych i sieci odzyskiwania, a następnie zwraca zadanie asr do śledzenia operacji.
...
Uruchamia mapowanie sieci na operację tworzenia przy użyciu określonej nazwy, sieci podstawowych i sieci odzyskiwania, a następnie zwraca zadanie asr do śledzenia operacji (scenariusz z Azure do Azure).

## PARAMETERS

### -AzureToAzure
Oflaguj, aby utworzyć scenariusz platformy AzureToAzure.
...
### — Nazwa
Nazwa mapowania sieci asr do utworzenia.
...
Określa identyfikator sieci wirtualnej platformy Azure sieci podstawowej dla mapowania.
...
### - PrimaryFabric
Określa szkielet ASR, w którym należy utworzyć mapowanie.
...
### — PrimaryNetwork
Określa podstawowy obiekt sieciowy dla mapowania sieci ASR.
...
Określa identyfikator sieci azure odzyskiwania dla mapowania sieci.
...
### -RecoveryFabric
Obiekt szkieletowy usługi Azure Site Recovery odpowiadający regionowi odzyskiwania platformy Azure.
...
### -RecoveryNetwork
Określa obiekt sieci odzyskiwania dla mapowania sieci ASR.
