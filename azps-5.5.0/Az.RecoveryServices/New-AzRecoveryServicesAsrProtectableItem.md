...
## OPIS
Element **New-AzRecoveryServicesAsrProtectableItem** dodaje nowy element, który można chronić, do listy wykrytych elementów, które można chronić, w kontenerze ochrony w obrębie materiału ASR (ma zastosowanie tylko do typu materiału V Następnie).

## PRZYKŁADY

### Przykład 1

Dodawanie (odnajdowanie) serwera fizycznego do listy elementów, które można chronić. (wygenerowane automatycznie)
...
### -FriendlyName
Przyjazna nazwa elementu, który można chronić.
...
### -IPAddress
Adres IP elementu, który można chronić.
...
### - OSType
Typ systemu operacyjnego (Windows/Linux) elementu, który można chronić.
...
### -ProtectionContainer
Obiekt kontenera ochrony asr, do którego powinien zostać dodany element, który można chronić.
