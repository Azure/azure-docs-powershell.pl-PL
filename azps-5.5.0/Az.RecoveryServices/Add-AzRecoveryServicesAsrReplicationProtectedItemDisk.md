...
## OPIS
Polecenie cmdlet **Add-AzRecoveryServicesAsrReplicationProtectedItem Jak** dodać dysk w celu ochrony już chronionej maszyny wirtualnej platformy Azure.
...
Uruchom operację, aby dodać określoną konfigurację dysku w celu ochrony.
...
Uruchom operację, aby dodać określoną konfigurację dysku w celu ochrony. Element chroniony replikacją danych wejściowych rurowych.

## PARAMETERS

### -AzureToAzureChatReplicationConfiguration
Określa konfigurację dysku, która ma być używana na wypadek ochrony dysku platformy Azure do scenariusza odzyskiwania po awarii platformy Azure.
...
### -InputObject
Obiekt wejściowy do polecenia cmdlet: obiekt elementu chronionego replikacją asr, odpowiadający noweowi dyskowi, który ma być chroniony.
