...
## OPIS
To polecenie umożliwia usłudze Azure Backup konwertowanie zasobu na kontener kopii zapasowej, który jest następnie rejestrowany w danym magazynie usług odzyskiwania. Usługa kopia zapasowa Azure może następnie wykrywać obciążenia danego typu obciążenia pracą w tym kontenerze, aby być później chronione.
...
Polecenie cmdlet rejestruje maszynę wirtualnej azure jako kontener dla msSQL obciążenia pracą.
...
### -WorkloadType
Typ obciążenia zasobu. Bieżąca obsługiwana wartość to AzureVM, WindowsServer, AzureFiles, MSSQL
