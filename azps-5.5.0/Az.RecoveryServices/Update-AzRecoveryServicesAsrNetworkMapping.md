...
## OPIS
Polecenie **cmdlet Update-AzRecoveryServicesAsrNetworkMapping** aktualizuje wskazane mapowanie sieci usługi Azure Site Recovery.
...
Rozpoczyna operację mapowania sieci aktualizacji przy użyciu określonych parametrów i zwraca zadanie asr służące do śledzenia operacji.
...
### -InputObject
Obiekt wejściowy: określa obiekt mapowania sieci asr odpowiadający zaktualizowanej funkcji asr.
