...
Drugie polecenie cmdlet określa nazwy LUN dysku, które mają zostać kopii zapasowej, i zapisuje je w $inclusionDiskLUNS zmienną.
Trzecie polecenie cmdlet ustawia zasady ochrony kopii zapasowej dla ARM wirtualnej o nazwie V2VM przy użyciu zasad w $Pol.
