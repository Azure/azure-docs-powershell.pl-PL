...
Polecenie **cmdlet Backup-AzRecoveryServicesBackupItem** pobiera dodatkową kopię zapasową chronionego elementu kopii zapasowej platformy Azure. Za pomocą tego polecenia cmdlet można wykonać początkową kopię zapasową natychmiast po włączeniu ochrony lub uruchomić kopię zapasową, jeśli zaplanowana kopia zapasowa zakończy się niepowodzeniem. To polecenie cmdlet może być również używane do niestandardowego przechowywania z datą wygaśnięcia lub bez tego terminu — aby uzyskać więcej szczegółowych informacji, zapoznaj się z tekstem pomocy parametrów. 
