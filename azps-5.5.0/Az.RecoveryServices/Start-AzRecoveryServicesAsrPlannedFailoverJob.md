...
Jeśli **jest określony forDowntime,** oznacza to, że dane są synchronizowane przed trybu failover w celu zminimalizowania przestojów.
...
Synchronizacja rozpoczyna się po zamknięciu w celu ukończenia operacji trybu failover.
