...
## SYNOPSIS
Aktualizacje agenta usługi wypychanej mobilności na komputerach chronionych.
...
## OPIS
Polecenie cmdlet **Update-AzRecoveryServicesAsrServiceService** próbuje wypychać aktualizacje agenta usługi mobilności na komputerach chronionych (jeśli jest dostępna aktualizacja).
...
Zadanie śledzenia agenta usługi mobilności chronionej replikacją aktualizacji.

## PARAMETERS

### — Konto
The run as account ID to be used to push the update. Musi znajdować się jedna z listy run as accounts in the ASR fabric odpowiadającej aktualizowanej maszynie.
...
Element chroniony replikacją usługi Azure Site Recovery do zaktualizowania.
