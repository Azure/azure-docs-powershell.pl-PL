...
## OPIS
Polecenie **cmdlet Update-AzRecoveryServicesAsrvCenter** aktualizuje szczegóły odnajdowania dla zarejestrowanego centrum vCenter.
...
### — Konto
konto poświadczeń logowania w centrum vCenter.
...
### -InputObject
Obiekt serwera vCenter w celu zaktualizowania szczegółów odnajdowania.
