...
## OPIS
Tworzy obiekt mapowania dysku, który mapuje dysk maszyny wirtualnej vMWare na konto pamięci podręcznej i docelowy zarządzany typ dysku (region odzyskiwania), który ma być używany do replikowania dysku.
...
Utwórz obiekt mapowania dysku, aby zreplikować dysk w maszynce wirtualnej vMWare. Używany podczas włączania ochrony dla komputera vMWare.
...
### - DiskId
Określ wartość DiskId dysku, do których odpowiada dane mapowanie.
...
### -DiskType
Określa typ dysku odzyskiwania.
...
### Microsoft.Azure.Commands.RecoveryServices.SiteRecovery.AsrInMageAzureV2ChatInput
