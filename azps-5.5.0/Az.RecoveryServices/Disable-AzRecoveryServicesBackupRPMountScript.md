...
## OPIS
To Disable-AzRecoveryServicesBackupRPMountScript cmdlet dezinstaluje pliki punktu odzyskiwania, które zostały wcześniej montowane przy użyciu Get-AzRecoveryServicesBackupRPMountScript cmdlet.

## PRZYKŁADY

### Przykład 1. Dezinstalowanie punktu odzyskiwania
```powershell
...
Dezinstaluje wszystkie pliki punktu odzyskiwania. (wygenerowane automatycznie)
