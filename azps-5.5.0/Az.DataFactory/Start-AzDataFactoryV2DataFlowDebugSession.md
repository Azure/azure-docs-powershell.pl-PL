...
## SYNOPSIS
Rozpoczynanie sesji debugowania przepływu danych w usłudze Azure Data Factory
...
## OPIS
To długo działające polecenie uruchamia sesję debugowania przepływu danych dla nadchodzących poleceń debugowania. To polecenie można dołączyć z definicją środowiska uruchomieniowego integracji, aby skonfigurować rozmiar i typ klastrów sesji debugowania.
...
Rozpoczyna sesję debugowania z flagą AsJob.
