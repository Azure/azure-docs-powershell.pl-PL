...
## OPIS
Polecenie Remove-AzDataFactoryV2IntegrationRuntimeNode cmdlet usuwa węzeł w środowisku uruchomieniowym integracji.

## PRZYKŁADY

### Przykład 1. Usuwanie węzła ze środowiska uruchomieniowego integracji

Usuń węzeł o podanej nazwie w środowisku uruchomieniowym integracji. (wygenerowane automatycznie)
