...
## OPIS
Polecenie **cmdlet Get-AzDataFactoryRun** pobiera uruchamiany fragment danych zestawu danych w usłudze Azure Data Factory.
...
W przypadku ponownego uruchomień wycinków może być jedno lub więcej uruchomień dla wycinków w przypadku ponownego uruchomień z powodu błędów.
