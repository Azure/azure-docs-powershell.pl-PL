...
## OPIS
Polecenie **cmdlet Start-AzDataFactoryV2IntegrationRuntime** uruchamia środowisko uruchomieniowe zarządzanej dedykowanej integracji. Zasób zostanie inicjowania obsługi administracyjnej, a po operacji będzie to stan "Uruchomiony".

## PRZYKŁADY

### Przykład 1. Uruchamianie środowiska uruchomieniowego integracji
```
...
To polecenie cmdlet uruchamia dedykowane środowisko uruchomieniowe zarządzanej integracji o nazwie "test-dedicated-ir".
