...
## OPIS
Polecenie **Get-AzDataFactoryV2PipelineRun zwraca** informacje o uruchomieniach dla określonego potoku. Jeśli określono wartość PipelineRunId, są w nim podane szczegóły dotyczące uruchomienia z tym identyfikatorem. Jeśli wartość PipelineRunId nie jest określona, wyświetla informacje o wszystkich uruchomieniach dla potoków, które się wydarzyły między wartościami LastUpdatedAfter i LastUpdatedBefore.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie informacji dotyczących uruchomienia potoku
```
...
### -LastUpdatedAfter
Godzina lub godzina, po której potok został zaktualizowany w formacie ISO8601.
...
### -LastUpdatedBefore
Godzina lub wcześniejsza aktualizacja potoku w formacie ISO8601.
