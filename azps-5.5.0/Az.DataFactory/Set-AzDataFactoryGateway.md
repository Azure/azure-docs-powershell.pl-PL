...
## OPIS
Polecenie **cmdlet Set-AzDataFactoryGateway** ustawia opis określonej bramy w usłudze Azure Data Factory.

## PRZYKŁADY

### Przykład 1. Ustawianie opisu bramy
```
...
To polecenie ustawia opis bramy o nazwie ContosoGateway w zakładzie danych o nazwie WikiADF.
...
To polecenie cmdlet ustawia opis bramy w zakładzie danych, który określa ten parametr.
...
### — Nazwa
Określa nazwę bramy, dla której ma być ustawiany opis.
...
To polecenie cmdlet ustawia opis bramy należącej do grupy, która jest określana przez ten parametr.
