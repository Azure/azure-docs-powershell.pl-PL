...
## OPIS
To Remove-AzDataFactoryV2IntegrationRuntime cmdlet usuwa środowisko uruchomieniowe integracji.

## PRZYKŁADY

### Przykład 1. Usuwanie środowiska uruchomieniowego integracji
```
...
To polecenie usuwa środowisko uruchomieniowe integracji o nazwie "test-reserved-ir" z fabryki danych o nazwie "test-df".
...
Nazwa połączonej fabrycznej usługi danych.
