...
To polecenie pobiera informacje o wszystkich połączonych usługach w zakładzie danych o nazwie WikiADF, Format-List następnie przekazuje połączone usługi do polecenia cmdlet Format-List przy użyciu operatora potoku.
Polecenie cmdlet programu Windows PowerShell formatuje wyniki.
Aby uzyskać więcej informacji, wpisz Get-Help Format-List.
Możesz skorzystać z jednej z następujących metod:
...
To polecenie pobiera informacje o połączonej usłudze o nazwie LinkedServiceCuratedWikiData w zakładzie danych o nazwie WikiADF.
...
To polecenie cmdlet pobiera usługi połączone, które należą do fabrycznej usługi danych, która jest określana przez ten parametr.
