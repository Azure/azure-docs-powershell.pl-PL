...
## OPIS
Polecenie **cmdlet New-AzDataFactoryGateway** tworzy bramę w usłudze Azure Data Factory.
...
To polecenie tworzy bramę o nazwie ContosoGateway w zakładzie danych o nazwie WikiADF w grupie zasobów O nazwie ADF.

## PARAMETERS

### -DataFactory
Określa obiekt **PSDataFactory.**
To polecenie cmdlet tworzy bramę dla fabrycznych danych określanych przez ten parametr.
...
### — Nazwa
Określa nazwę bramy do utworzenia.
...
To polecenie cmdlet tworzy bramę należącą do grupy, która jest określana przez ten parametr.
