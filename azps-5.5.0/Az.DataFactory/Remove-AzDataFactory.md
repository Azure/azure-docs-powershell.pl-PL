...
## OPIS
Polecenie **cmdlet Remove-AzDataFactory** usuwa fabryczne dane.
...
To polecenie usuwa z grupy zasobów o nazwie ADF fabryczne dane o nazwie WikiADF.
To polecenie zwraca wartość $True.

## PARAMETERS

### -DataFactory
Określa obiekt **PSDataFactory** do usunięcia.
...
### — Wymuszanie
Wskazuje, że to polecenie cmdlet powoduje usunięcie fabrycznych danych bez monitowania o potwierdzenie.
...
### — Nazwa
Określa nazwę fabryki danych do usunięcia.
...
To polecenie cmdlet usuwa grupę danych z grupy, która jest określana przez ten parametr.
