...
## OPIS
Polecenie **cmdlet Update-AzDataFactoryV2IntegrationRuntime** aktualizuje właściwości środowiska uruchomieniowego integracji. Obecnie polecenie cmdlet obsługuje tylko aktualizowanie plików "AutoUpdate" i "AutoUpdateDelayOffset" dla środowiska uruchomieniowego integracji samoobsługowej.

## PRZYKŁADY

### Przykład 1. Aktualizacja środowiska uruchomieniowego integracji
```
...
Polecenie cmdlet aktualizuje środowisko uruchomieniowe integracji samoobsługowej o nazwie "test-selfhost-ir".

## PARAMETERS

### -AutoUpdate
Włącz lub wyłącz automatyczną aktualizację środowiska integracji z własnym środowiskiem uruchomieniowym.
...
Czas w godzinie dnia na automatyczną aktualizację środowiska integracji z własnym środowiskiem uruchomieniowym.
