...
Polecenie cmdlet pobiera informacje o węźle o nazwie "Node_1" w środowisku integracji we własnym środowisku integracji "test-selfhost-ir" w usłudze Data Factory "test-df-eu2", łącznie z adresem IP.
...
### -IpAddress
Adres IP węzła integration runtime.
