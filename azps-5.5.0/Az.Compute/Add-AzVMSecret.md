...
Certyfikat jest kodowaniem Base64 następującego obiektu JavaScript Object Notation (JSON), który jest kodowany w formacie UTF-8: { "data": " \<Base64-encoded-file\> ", "dataType": " \<file-format\> ", ","password": " } Obecnie typ danych akceptuje tylko pliki \<pfx-file-password\> pfx.
