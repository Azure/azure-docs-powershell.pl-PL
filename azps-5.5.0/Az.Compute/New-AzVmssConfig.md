...
### - Rozszerzenie
Określa obiekt informacji o rozszerzeniu dla usługi maszyny wirtualnej. Aby dodać ten obiekt, możesz użyć polecenia cmdlet **Add-AzVmssExtension.**
...
"Low" jest również dla spot virtual machine, ale jest zastępowany przez "Spot". Użyj pozycji "Spot" zamiast "Low".
...
Konfigurowany czas (w minutach) usunięcie maszyny wirtualnej będzie musiało potencjalnie zatwierdzić zdarzenie Zakończ zaplanowane przed automatycznym zatwierdzeniem zdarzenia (przeocz tę godzinę).
...
### -ZoneBalance
Czy należy wymusić ściśle nawet rozpowszechnianie maszyn wirtualnych między strefami x w przypadku 30-dniowej ejsu.
