...
### Przykład 1. Usuwanie usługi kontenerowej
```
PS C:\> Remove-AzContainerService -ResourceGroupName "ResourceGroup17" -Name "CSResourceGroup17"
```

To polecenie usuwa usługę kontenerów o nazwie CSResourceGroup17.
...
### — Nazwa
Określa nazwę usługi kontenerów, która jest usuwana przez to polecenie cmdlet.
...
### -ResourceGroupName
Określa grupę zasobów usługi kontenerów, która jest usuwana przez to polecenie cmdlet.
