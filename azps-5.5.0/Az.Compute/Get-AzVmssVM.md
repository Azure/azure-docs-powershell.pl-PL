...
Określ parametr *Status,* aby uzyskać tylko widok wystąpienia maszyny wirtualnej.
...
Polecenie pobiera identyfikator wystąpienia przechowywany w zmiennej $ID, dla której można uzyskać widok wystąpienia.
