...
## OPIS
Polecenie **cmdlet Get-AzVMDscExtensionStatus** pobiera stan programu obsługi rozszerzenia Żądana konfiguracja stanu (DSC) dla maszyny wirtualnej w grupie zasobów.
...
Polecenie cmdlet Set-AzVMDscExtension ustawia tę nazwę na Microsoft.Powershell.DSC, która jest taka sama, jak wartość używana przez polecenie **Get-AzVMDscExtensionStatus.**
