...
## OPIS
Polecenie **cmdlet New-AzImageConfig** tworzy konfigurowalny obiekt obrazu.
...
Następne trzy polecenia przypiszą ścieżki dysku systemu operacyjnego i dwie dyskietki danych do zmiennych $osDiskVhdUri, $dataDiskVhdUri 1 i $dataDiskVhdUri 2. Ta metoda ma na celu tylko czytelność następujących poleceń.
...
### —HyperV Zwyrodnienie
Określa typ hipervgeneracji dla maszyny wirtualnej utworzonej na podstawie obrazu.  Dozwolone wartości to V1 i V2.
...
Określa identyfikator źródłowej maszyny wirtualnej.
...
### Microsoft.Azure.Management.Compute.Models.ImageOSGrafii

### Microsoft.Azure.Management.Compute.Models.ImageDataData[]
