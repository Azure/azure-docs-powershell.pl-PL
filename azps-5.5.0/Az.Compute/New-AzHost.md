...
To polecenie tworzy hosta danej sku w danej grupie hosta i danej lokalizacji.
...
Określa, czy w przypadku niepowodzenia host ma być automatycznie zamieniany. Wartość domyślna to "true", jeśli nie jest podana.
...
### -LicenseType
Określa typ licencji oprogramowania, który zostanie zastosowany do maszyn wirtualnych wdrożonych na hoście. Dopuszczalne wartości to: Brak, Windows_Server_Hybrid i Windows_Server_Perpetual.  Wartość domyślna to Brak.
...
### -PlatformFaultDomain
Określa liczbę domeny błędu platformy hosta.  Następnie wartość minimalna wynosi 0, a maksymalna 2.
