...
## OPIS
Polecenie **cmdlet Remove-AzAccessaccess** usuwa zasób dostępu do dysku.

## PRZYKŁADY

### Przykład 1. Usuwanie dostępu na dysku przy użyciu domyślnego zestawu parametrów
```
...
To polecenie usuwa dostęp do dysku za pomocą identyfikatora zasobu

### Przykład 3. Usuwanie dostępu do dysku przy użyciu obiektu input
```
PS C:\> $myDiskAccess = Get-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01"
PS C:\> Remove-AzDiskAccess -InputObject $myDiskAccess
```

To polecenie usuwa dostęp do dysku przez inputObject

### Przykład 4. Usuwanie dostępu na dysku za pomocą obiektu wprowadzania rurowego
```
PS C:\> Get-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01" | Remove-AzDiskAccess 
```

To polecenie usuwa dostęp na dysku przez usunięcie linii wejściaObject
...
### -InputObject
Obiekt programu PowerShell Disk Access
