...
Obiekt można Add-AzVMAdditionalUnattendContent za pomocą tego obiektu.
...
**Ograniczenie dostępne tylko w systemie Windows:** Nie może kończyć się \" na.\" <br>
...
Aby utworzyć obiekt, Add-AzVMSshPublicKey użyć polecenia cmdlet.
