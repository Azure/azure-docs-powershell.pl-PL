...
## OPIS
Polecenie **cmdlet Set-AzCmUpdateKeyEncryptionKey** ustawia właściwości klucza szyfrowania klucza w obiekcie aktualizacji dysku.
...
Pierwsze polecenie tworzy lokalny obiekt aktualizacji pustego dysku o rozmiarze 10 GB Premium_LRS typu konta magazynu.  Ustawia także typ systemu operacyjnego Windows i włącza ustawienia szyfrowania.
