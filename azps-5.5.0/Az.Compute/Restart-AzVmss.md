...
To polecenie cmdlet może być również używane do ponownego uruchamiania określonej maszyny wirtualnej w maszyny wirtualnej przy użyciu *parametru InstanceId.*
