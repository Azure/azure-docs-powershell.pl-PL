...
## SYNOPSIS
Anulowanie bieżącego zestawu skalowania maszyn wirtualnych, w przypadku których jest uaktualnianie.
...
## OPIS
Anulowanie bieżącego zestawu skalowania maszyn wirtualnych, które jest uaktualnianie.
...
To polecenie anuluje toczące się uaktualnianie zestawu skali maszyny wirtualnej "MASZYNY WIRTUALNE", który jest ustawiony jako "MASZYNY WIRTUALNE", w grupie zasobów "Group001".
