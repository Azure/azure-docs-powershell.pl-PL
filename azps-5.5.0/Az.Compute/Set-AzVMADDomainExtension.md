...
## OPIS
Polecenie **cmdlet Set-AzVMADDomainExtension** dodaje do maszyny wirtualnej rozszerzenie domeny usługi Azure Active Directory (AD).
To rozszerzenie umożliwia twojej maszynie wirtualnej dołączenie do domeny.
...
### -JoinOption
Określa opcję sprzężenia. Aby uzyskać informacje na temat opcji [sprzężenia, zobacz fJoinOptions](https://docs.microsoft.com/en-us/windows/desktop/api/lmjoin/nf-lmjoin-netjoindomain)
...
### — Nazwa
Określa nazwę rozszerzenia domeny do dodania.
...
### — OUPath
Określa jednostkę organizacyjną dla konta domeny.
Wprowadź pełną nazwę wyróżniającą użytkownika systemu operacyjnego w cudzysłowie.
Wartość domyślna to domyślna nazwa użytkownika obiektów komputerowych w domenie.
...
### — Uruchom ponownie
Wskazuje, że to polecenie cmdlet powoduje ponowne uruchomienie maszyny wirtualnej.
Aby wprowadzić zmianę w życie, często jest wymagane ponowne uruchomienie aplikacji.
...
### -TypeHandlerVersion
Określa wersję rozszerzenia domeny.
