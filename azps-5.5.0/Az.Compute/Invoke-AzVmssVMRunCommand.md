...
## SYNOPSIS
Polecenie Uruchom na maszyny wirtualnej z zestawem maszyn wirtualnych, ustaw maszyny wirtualnej.
...
## OPIS
Wywoływanie polecenia uruchom na maszyny wirtualnej z zestawem maszyn wirtualnych do pracy z zestawem maszyn wirtualnych.
...
Wywołaj polecenie uruchom skrypt RunPowerShellScript z zastąpieniem skryptu "sample.ps1" i parametrów maszyny wirtualnej IDENTYFIKATOR "0" w zestawie skali maszyny wirtualnej "nazwa maszyny wirtualnej" w grupie zasobów "rgname".
...
### -InstanceId
Identyfikator wystąpienia zestawu maszyny wirtualnej do skalowania maszyny wirtualnej.
...
### - ScriptPath
Ścieżka skryptu do wykonania.  Gdy ta wartość zostanie podana, dany skrypt zastąpi domyślny skrypt polecenia.
...
Obiekt ZESTAWU SKALA MASZYNY WIRTUALNEJ PS.
...
### -VMScaleSetName
Nazwa zestawu skalowania maszyny wirtualnej do maszyny wirtualnej.
