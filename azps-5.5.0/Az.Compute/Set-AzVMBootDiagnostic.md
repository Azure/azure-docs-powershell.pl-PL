...
Drugie polecenie umożliwia diagnostykę rozruchu maszyny wirtualnej w programie $VM.
...
### - Wyłącz
Wskazuje, że to polecenie cmdlet wyłącza diagnostykę rozruchu dla maszyny wirtualnej.
...
### — Włącz
Wskazuje, że to polecenie cmdlet umożliwia korzystanie z diagnostyki rozruchu dla maszyny wirtualnej.
...
### -StorageAccountName
Określa nazwę konta magazynu, na którym mają być zapisywanie danych diagnostycznych rozruchu.
...
### — MASZYNY WIRTUALNEJ
Określa maszynę wirtualną, dla której to polecenie cmdlet zmienia diagnostykę rozruchu.
