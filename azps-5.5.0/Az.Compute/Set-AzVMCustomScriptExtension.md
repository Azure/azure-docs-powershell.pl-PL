...
## OPIS
Polecenie **cmdlet Set-AzVMCustomScriptExtension** dodaje do maszyny wirtualnej niestandardowe rozszerzenie skryptu Virtual Machine.
To rozszerzenie umożliwia uruchamianie własnych skryptów na komputerze wirtualnym.
...
To polecenie powoduje dodanie skryptu niestandardowego do maszyny wirtualnej o nazwie VirtualMachine07.
Plik skryptu zostanie contososcript.exe.

### Przykład 2

Dodaje rozszerzenie skryptu niestandardowego do maszyny wirtualnej. (wygenerowane automatycznie)
...
### -FileName
Określa nazwę pliku skryptu. Jeśli plik jest przechowywany w magazynie obiektów blob platformy Azure, w nazwie pliku jest zróżnicowany wielkość liter. W nazwach plików przechowywanych w magazynie plików platformy Azure nie jest wielkość liter.
...
### - Uruchom
Określa polecenie, które ma być uruchamiane przez skrypt.
...
### - SecureExecution
Wskazuje, że to polecenie cmdlet zapewnia, że wartość parametru *Uruchom* nie jest rejestrowana na serwerze ani zwracana użytkownikowi za pomocą interfejsu API rozszerzenia GET.
Wartość polecenia *Uruchom może zawierać* tajemnice lub hasła, które mają zostać bezpiecznie przekazane do pliku skryptu.
...
### -StorageAccountName
Określa nazwę konta magazynu platformy Azure, na którym to polecenie cmdlet przechowuje skrypt.
...
Aby uzyskać wersję, uruchom Get-AzVMExtensionImage cmdlet z wartością Microsoft.Compute dla parametru *PublisherName* i CustomScriptExtension dla *parametru Type.*
...
To polecenie cmdlet dodaje rozszerzenie skryptu niestandardowego dla maszyny wirtualnej, które określa ten parametr.
