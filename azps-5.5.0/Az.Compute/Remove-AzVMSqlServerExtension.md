...
## OPIS
Polecenie **cmdlet Remove-AzVMSqlServerExtension** usuwa rozszerzenie AzureSQL Server z maszyny wirtualnej.
...
### — Nazwa
Określa nazwę serwera SQL, które usuwa to polecenie cmdlet.
