...
### NormalMeterParameterSetName (domyślna)
```
...
## OPIS
Polecenie **cmdlet New-AzVMDataData Umożliwia** utworzenie lokalnego obiektu dysku danych dla maszyny wirtualnej lub maszyny wirtualnej maszyny wirtualnej.
...
Tworzy lokalny obiekt dysku danych dla maszyny wirtualnej lub maszyny wirtualnej. (wygenerowane automatycznie)
...
### -DiskEncryptionSetId
Identyfikator zestawu szyfrowania dysku zarządzanego przez maszynę wirtualną.
...
### -Logicznej
Serwer danych maszyny wirtualnej.
...
### -Managed Jednakid
Identyfikator dysku zarządzanego przez maszynę wirtualną.
...
### -SourceImageUri
Uri źródła dysku systemu operacyjnego maszyny wirtualnej.
...
### - VhdUri
Wirtualny Uri na dysku danych maszyny wirtualnej.
...
### Microsoft.Azure.Commands.Compute.Models.PSVirtualMachineDataData1
