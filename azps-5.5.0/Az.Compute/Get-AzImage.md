...
To polecenie pobiera właściwości obrazu o nazwie "Obraz01" w grupie zasobów "Grupa Zasobów01".
...
To polecenie pobiera właściwości wszystkich obrazów w grupie zasobów "Grupa Zasobów01".
...
To polecenie pobiera właściwości wszystkich obrazów w ramach subskrypcji, które zaczynają się od "Obraz".
...
### — Rozwiń
Określa zapytanie wyrażenia rozwijania.
