...
Bieżące polecenie cmdlet ustawia automatyczne ustawienia kopii zapasowej $AutoBackupConfig dla maszyny wirtualnej.
Polecenie przekazuje maszynę wirtualną do Update-AzVM cmdlet.
...
### Przykład 4. Odinstalowywanie rozszerzenia programu SQL Server na określonej maszyny wirtualnej
```
