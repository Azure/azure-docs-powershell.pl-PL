...
Tworzy zestaw szyfrowania dysku przy użyciu danego aktywnego klucza w magazynie kluczy.
...
### - EncryptionType
Skorzystaj z tej funkcji, aby ustawić typ szyfrowania zestawu szyfrowania dysku. Dostępne wartości to: "EncryptionAtRestWithPlatformKey", "EncryptionAtRestWithCustomerKey".
...
### -IdentityType
Typ tożsamości zarządzanej używany przez zestaw DiskEncryptionSet. Obsługiwany jest tylko systemAssigned.
...
### -KeyUrl
Adres URL, który wskaże aktywny klucz w aplikacji KeyVault
...
### -SourceVaultId
Identyfikator zasobu usługi KeyVault zawierający klucz aktywny.
