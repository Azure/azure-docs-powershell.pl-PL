...
## OPIS
Polecenie **cmdlet Set-AzKeyEncryptionKey** ustawia właściwości klucza szyfrowania na obiekcie dysku.
...
Pierwsze polecenie tworzy lokalny pusty obiekt dysku o rozmiarze 5 GB w Standard_LRS typu konta magazynu.  Ustawia także typ systemu operacyjnego Windows i włącza ustawienia szyfrowania.
Drugie i trzecie polecenia ustawiają ustawienia klucza szyfrowania dysku i klucza klucza szyfrowania obiektu dysku.
