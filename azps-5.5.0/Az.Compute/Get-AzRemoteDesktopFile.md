...
## OPIS
Polecenie **cmdlet Get-AzRemoteDesktopFile** pobiera plik protokołu pulpitu zdalnego (rdp).
...
### — Launch
Wskazuje, że to polecenie cmdlet uruchamia pulpit zdalny po pobieraniu pliku rdp.
...
### — LocalPath
Określa pełną ścieżkę lokalną, w której to polecenie cmdlet przechowuje plik rdp.
...
### — Nazwa
Określa nazwę zestawu dostępności, który otrzymuje to polecenie cmdlet.
