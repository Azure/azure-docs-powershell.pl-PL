...
## OPIS
To polecenie cmdlet pobierze grupę hosta.
To polecenie cmdlet wyświetla również listę wszystkich grup hostów w grupie zasobów, jeśli nazwa grupy hosta nie zostanie nadana.
To polecenie cmdlet wyświetla również listę wszystkich grup hostów w subskrypcji, jeśli nie podano nazwy grupy ani nazwy grupy zasobów.
...
To polecenie zwraca grupę hosta.
...
To polecenie zwraca wszystkie grupy hostów w subskrypcji.
...
### -InstanceView
Rozwiń zwrócony obiekt, aby wyświetlić również widoki wystąpienia hosta. 
