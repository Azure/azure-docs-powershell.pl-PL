...
## OPIS
Polecenie **cmdlet Update-AzSnapshot** aktualizuje migawkę.
...
Pierwsze polecenie tworzy obiekt aktualizacji lokalnej pustej migawki o rozmiarze 10 GB Premium_LRS typu konta magazynu.  Ustawia także typ systemu operacyjnego Windows i włącza ustawienia szyfrowania.
Drugie i trzecie polecenia ustawiają ustawienia klucza szyfrowania dysku i klucza klucza szyfrowania obiektu aktualizacji migawki.
Ostatnie polecenie pobiera obiekt aktualizacji migawki i aktualizuje istniejącą migawkę za pomocą nazwy "Migawka01" w grupie zasobów "ResourceGroup01".
...
Te polecenia aktualizują również istniejącą migawkę o nazwie "Migawka01" w grupie zasobów "ResourceGroup01" do rozmiaru dysku 10 GB.
...
### -SnapshotUpdate
Określa obiekt aktualizacji lokalnej migawki.
