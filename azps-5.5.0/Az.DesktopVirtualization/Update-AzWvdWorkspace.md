...
### Przykład 1. Aktualizowanie obszaru roboczego pulpitu wirtualnego systemu Windows według nazwy
```powershell
...
To polecenie aktualizuje obszar roboczy pulpitu wirtualnego systemu Windows w grupie zasobów.

## PARAMETERS

### -ApplicationGroupReference
Lista linków applicationGroup.
