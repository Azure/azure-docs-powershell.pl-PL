...
### Przykład 1. Usuwanie grupy aplikacji pulpitu wirtualnego systemu Windows według nazwy
```powershell
PS C:\> Remove-AzWvdApplicationGroup -ResourceGroupName ResourceGroupName -Name ApplicationGroupName
```

To polecenie usuwa grupę aplikacji pulpitu wirtualnego systemu Windows z grupy zasobów.
