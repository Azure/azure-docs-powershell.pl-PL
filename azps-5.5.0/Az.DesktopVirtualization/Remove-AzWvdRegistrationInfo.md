...
### Przykład 1. Usuwanie tokenu rejestracji pulpitu wirtualnego systemu Windows
```powershell
PS C:\> Remove-AzWvdRegistrationInfo -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName
```

To polecenie usuwa token rejestracji pulpitu wirtualnego systemu Windows w puli hostów.
