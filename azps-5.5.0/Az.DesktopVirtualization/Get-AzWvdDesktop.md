...
To polecenie pobiera pulpit wirtualny systemu Windows w grupie aplikacji.

### Przykład 2. Lista pulpitów wirtualnych systemu Windows
```powershell
...
To polecenie wyświetla listę pulpitów wirtualnych programuWindows w grupie aplikacji.
...
### — Nazwa
Nazwa pulpitu w określonej grupie pulpitu
...
### Microsoft.Azure.PowerShell.Cmdlet.DesktopVirtualization.Models.Api20201102Preview.IDesktop

### Microsoft.Azure.PowerShell.Cmdlet.DesktopVirtualization.Models.Api20201102Preview.IDesktopList
