...
### Przykład 1. Uzyskiwanie sesji użytkowników pulpitu wirtualnego systemu Windows według nazwy
```powershell
...
To polecenie otrzymuje polecenie UserSession pulpitu wirtualnego systemu Windows na hoście sesji.

### Przykład 2. Lista użytkowników pulpitu wirtualnego systemu Windows
```powershell
...
To polecenie wyświetla listę użytkowników pulpitu wirtualnego systemu Windows na hoście sesji.

### Przykład 3. Lista użytkowników pulpitu wirtualnego systemu Windows w puli hostów
```powershell
...
To polecenie wyświetla listę użytkowników pulpitu wirtualnego systemu Windows na hoście sesji w puli hostów.
...
Prawidłowe właściwości filtrowania to userprincipalname (nazwa użytkownika) i sessionstate (Stan sesji).
...
### Microsoft.Azure.PowerShell.Cmdlet.DesktopVirtualization.Models.Api20201102Preview.IUserSession
