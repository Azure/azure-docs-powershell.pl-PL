...
### Przykład 1. Aktualizowanie hosta SessionHost pulpitu wirtualnego systemu Windows według nazwy
```powershell
...
To polecenie aktualizuje hosta SessionHost pulpitu wirtualnego systemu Windows w puli hostów.

## PARAMETERS

### -AllowNewSession
Zezwalanie na nową sesję.
...
### -AssignedUser
Użytkownik przypisany do hosta SessionHost.
