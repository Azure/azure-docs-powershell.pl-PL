...
## SYNOPSIS
Pobiera szczegóły prywatnych zasobów linków dla usługi Azure Cognitive Search.
...
## OPIS
Polecenie **cmdlet Get-AzSearchPrivateLinkResource** pobiera szczegóły prywatnych zasobów linków dla usługi Azure Cognitive Search.
...
W tym przykładzie pokazano, jak uzyskać dla wygody szczegóły prywatnego zasobu linku (w formularzu JSON) dla usługi Azure Cognitive Search.
