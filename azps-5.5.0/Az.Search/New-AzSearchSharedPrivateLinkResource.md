...
## OPIS
**New-AzSearchSharedPrivateLinkResource** tworzy udostępniony prywatny zasób linków dla usługi Azure Cognitive Search.
...
W tym przykładzie jest dzielony prywatny zasób linku do usługi obiektów blob konta magazynu dla usługi Azure Cognitive Search.
...
### - GroupId
Współużytkowanie identyfikatora grupy zasobów linku prywatnego
...
Udostępniony identyfikator zasobu docelowego linku prywatnego
...
### -RequestMessage
Udostępniony komunikat o żądaniu prywatnego zasobu linku
...
### -ResourceRegion
(Opcjonalnie) Udostępniony region zasobów linku prywatnego
