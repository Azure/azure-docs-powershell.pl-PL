...
Tworzy przypisanie rejestracji w domyślnym zakresie przy użyciu identyfikatora definicji rejestracji.
...
Tworzy zadanie rejestracji z obiektem definicji rejestracji jako wartością wejściową.
...
Aktualizuje zadanie rejestracji przy użyciu identyfikatora i nazwy definicji rejestracji.
...
### — Nazwa
Unikatowa nazwa Zadania rejestracji.
...
W pełni kwalifikowany identyfikator zasobu definicji rejestracji.
...
### — Zakres
Zakres, w którym należy utworzyć przypisanie rejestracji.
...
### Microsoft.Azure.PowerShell.Cmdlet.ManagedServices.Models.PSRegistrationAssignment
## NOTATKI
