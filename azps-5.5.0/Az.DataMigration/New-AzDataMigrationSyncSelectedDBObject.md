...
Polecenie New-AzDataMigrationSyncSelectedDB cmdlet tworzy obiekt informacyjny bazy danych specyficzny dla scenariusza synchronizacji, który zawiera informacje o źródłowej i docelowej bazie danych.
...
W tym przykładzie jest tworzyny obiekt metadanych bazy danych opisujący ustawienia migrowania $DatabaseName do $DatabaseName.  
...
### -SourceSetting
Ustawienia źródła w celu dostosowania zachowania migracji punktu końcowego źródła
...
### - TargetSetting
Ustawienia docelowe w celu dostosowania zachowania migracji punktu końcowego
