...
Uwaga: w ustawieniu HealthProbeMethod nie jest rozróżniana wielkość liter.
...
### -EnabledState
Czy należy włączyć ochronę kondycji względem zaplecza zdefiniowanych w ramach backendPools. Kondycję można wyłączyć tylko wtedy, gdy w jednej włączonej puli zaplecza jest włączona pojedyncza pula zaplecza.
...
### -HealthProbeMethod
Konfiguruje metodę HTTP, która ma być stosowana do blokowania zaplecza zdefiniowanego w ramach backendPools.
...
### — Ścieżka
Ścieżka do użycia dla kondycji.
Wartość domyślna to /
