...
## OPIS
Ustawienie **Disable-AzFrontDoorCustomDomainHttps** wyłącza protokół HTTPS dla domeny niestandardowej.

## PRZYKŁADY

### Przykład 1. Wyłączenie protokołu HTTPS dla domeny niestandardowej z wartościami FrontDoorName i ResourceGroupName.
```powershell
...
Wyłącz protokół HTTPS dla domeny niestandardowej "frontendpointname1-custom-xyz" z nazwą FrontDoorName jako "frontdoor1" i ResourceGroupName jako "resourcegroup1".

### Przykład 2. Wyłączenie protokołu HTTPS dla domeny niestandardowej z obiektem PSFrontendEndpoint.
```powershell
...
Wyłącz protokół HTTPS dla domeny niestandardowej za pomocą obiektu PSFrontendEndpoint.

### Przykład 3. Wyłączenie protokołu HTTPS dla domeny niestandardowej przy użyciu pola ResourceId.
```powershell
...
Wyłącz protokół HTTPS dla domeny niestandardowej "frontendpointname1-custom-xyz" przy użyciu parametru ResourceId jako $resourceId.
...
### -ResourceId
Identyfikator zasobu punktu końcowego drzwi frontowych w celu wyłączenia https
