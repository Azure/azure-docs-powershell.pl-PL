...
### -HeaderActionType
Jakiego rodzaju manipulowanie ma dotyczyć nagłówek.
...
### -HeaderName
Nazwa nagłówka, do których ta akcja będzie dotyczyć.
...
### — Wartość
Wartość, za pomocą która ma być podana nazwa nagłówka.
Ta wartość nie jest używana, jeśli typ akcji to Delete.
