...
## OPIS
Polecenie **cmdlet Get-AzFrontDoor** pobiera wszystkie istniejące drzwi frontowe w bieżącej subskrypcji, które są takie, jak podane informacje.

## PRZYKŁADY

### Przykład 1. Pobierz wszystkie frontdoory w bieżącej subskrypcji.
```powershell
...
Pobierz wszystkie frontoory w bieżącej subskrypcji.

### Przykład 2. Uzyskiwanie wszystkich frontoorów w grupie zasobów "rg1" w bieżącej subskrypcji.
```powershell
...
Pobierz wszystkich frontoorów w grupie zasobów "rg1" w bieżącej subskrypcji.

### Przykład 3. Pobierz frontdoory z grupy zasobów "rg1" o nazwie "frontDoor1" w bieżącej subskrypcji.
```powershell
...
Pobierz frontoory w grupie zasobów "rg1" o nazwie "frontDoor1" w bieżącej subskrypcji.
