...
## SYNOPSIS
Utwórz nową konfigurację aparatu reguł dla określonych drzwi przednich. 
...
Użyj polecenia cmdlet "New-AzFrontDoorRulesEngineRule", aby skonstruować reguły aparatu reguł w celu przekazania do parametru "-Rules" tego polecenia cmdlet.
