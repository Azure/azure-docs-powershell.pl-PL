...
### ByFieldsWithBackendPoolsSettingParameterSet (Domyślne)
```
...
## OPIS
Polecenie **cmdlet New-AzFrontDoor** tworzy nowy narzędzie do równoważenia obciążenia Front Door platformy Azure w określonej grupie zasobów w ramach bieżącej subskrypcji
...
### -EnabledState
EnabledState (Stan Front Door) równoważenia obciążenia.
