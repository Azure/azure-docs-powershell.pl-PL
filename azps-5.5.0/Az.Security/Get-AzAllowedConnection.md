...
## SYNOPSIS
Umożliwia wyświetlanie dozwolonego ruchu między zasobami dla subskrypcji
...
## OPIS
Pobiera listę całego możliwego ruchu między zasobami dla subskrypcji i lokalizacji w zależności od typu połączenia.
...
Pobiera listę całego możliwego ruchu między zasobami dla subskrypcji i lokalizacji na podstawie typu połączenia.
