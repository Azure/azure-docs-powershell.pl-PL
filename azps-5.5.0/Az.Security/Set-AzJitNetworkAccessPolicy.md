...
## SYNOPSIS
Aktualizuje zasady dostępu do sieci JIT.
...
## OPIS
Aktualizuje zasady dostępu sieciowego JIT.
...
Aktualizuje zasady dostępu sieciowego JIT przy użyciu nowych reguł maszyny wirtualnej.
