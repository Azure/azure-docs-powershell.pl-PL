...
## OPIS
Adaptacyjne połączenia sieciowe są obliczane automatycznie przez Azure Security Center. Za pomocą tego polecenia cmdlet można wymusić podane reguły dla NSG wymienionych w żądaniu.
