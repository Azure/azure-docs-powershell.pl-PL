...
## SYNOPSIS
Pobiera grupę maszyny wirtualnej/serwera kontrolki aplikacji.
...
## OPIS
Adaptacyjne kontrolki aplikacji są automatycznie obliczane przez Azure Security Center. To polecenie cmdlet umożliwia uzyskiwanie grupy sterowanie aplikacją/serwerem.
...
### -AscLocation
Lokalizacja, w której centrum asc przechowuje dane subskrypcji. można pobrać z lokalizacji Pobierania.
...
### -GroupName
Nazwa grupy maszyny wirtualnej/serwera kontrolki aplikacji.
