...
## SYNOPSIS
Tworzenie nowej niestandardowej reguły alertu progowego dla grupy zabezpieczeń urządzeń (Zabezpieczenia IoT)
...
## OPIS
Polecenie New-AzDeviceSecurityGroupThresholdCustomAlertRuleObject cmdlet tworzy nową listę próg niestandardowych reguł alertów dla grupy zabezpieczeń urządzeń w rozwiązaniu zabezpieczeń IoT.
...
Tworzenie nowej niestandardowej reguły alertu progu z typu "SomeRuleType" z włączonymi wartościamiantów stanu dla progu minimalnego i maksymalnego
