...
## SYNOPSIS
Otrzymuje zadania związane z zabezpieczeniami, które centrum zabezpieczeń Azure zaleca, aby zwiększyć poziom zabezpieczeń.
...
## OPIS
Usługa Azure Security Center skanuje zasoby w celu wykrycia potencjalnych problemów z zabezpieczeniami.
To polecenie cmdlet umożliwia odnajdowanie zadań zabezpieczeń, które zaleca Centrum zabezpieczeń Azure.
...
Pobiera wszystkie zadania związane z zabezpieczeniami, które zostały odkryte dla zasobów w ramach subskrypcji.
...
Pobiera wszystkie zadania związane z zabezpieczeniami, które zostały odkryte dla zasobów wewnątrz grupy zasobów.
...
Otrzymuje określone zadanie zabezpieczeń.
