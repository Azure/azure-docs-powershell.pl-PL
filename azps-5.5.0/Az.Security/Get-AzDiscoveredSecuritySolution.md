...
## SYNOPSIS
Pobiera rozwiązania zabezpieczeń odkryte przez Azure Security Center
...
## OPIS
Rozwiązania zabezpieczeń są automatycznie wykrywane przez Usługę Azure Security Center. To polecenie cmdlet umożliwia wyświetlenie wykrytych rozwiązań zabezpieczeń
...
Uzyskiwanie wszystkich wykrytych rozwiązań zabezpieczeń w subskrypcji
...
Uzyskiwanie konkretnego wykrytego rozwiązania zabezpieczającego
