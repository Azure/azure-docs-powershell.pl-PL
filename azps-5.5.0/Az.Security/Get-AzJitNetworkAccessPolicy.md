...
## SYNOPSIS
Pobiera zasady dostępu sieciowego JIT
...
## OPIS
Zasady dostępu sieciowego just In Time (JIT) umożliwiają definiowanie zasad, które umożliwią prostym użytkownikom utworzenie tymczasowego połączenia sieciowego z maszyną wirtualną.
Zasady określają, jakie porty, protokoły i źródłowe adresy IP mogą żądać połączenia z maszyną WIRTUALNEj oraz maksymalny czas trwania przed automatycznem zamknięciem połączenia.
W zasadach możesz również zobaczyć żądanie połączenia, które zostało wprowadzone przy użyciu tych zasad. 
...
Uzyskiwanie dostępu do wszystkich zaszeeń dostępu sieciowego JIT w ramach subskrypcji
...
Pobierz wszystkie grupę zasobów "myService1" do wszystkich zasad dostępu sieciowego JIT
...
Pobiera określone zasady dostępu do sieci JIT
