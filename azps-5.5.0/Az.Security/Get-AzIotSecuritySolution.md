...
## SYNOPSIS
Uzyskaj rozwiązanie zabezpieczeń IoT
...
## OPIS
Polecenie Get-AzIotSecuritySolution zwraca co najmniej jedno rozwiązanie zabezpieczeń iot. Rozwiązanie zabezpieczeń IoT zbiera dane zabezpieczeń i zdarzenia z urządzeń iot i centrum iot, aby chronić zagrożenia i je wykrywać.
...
Uzyskiwanie rozwiązania "MySample" w grupie zasobów "MyResourceGroup"
...
Uzyskiwanie listy wszystkich rozwiązań zabezpieczeń w grupie zasobów "MyResourceGroup"
