...
## OPIS
Polecenie Set-AzSecuritySetting aktualizuje określone ustawienie zabezpieczeń w Centrum zabezpieczeń platformy Azure.
...
Aktualizacja ustawienia eksportowania danych mcas   
...
### -SettingKind
Typ ustawienia. (DataExportSettings)
