...
## SYNOPSIS
Pobiera listę zasobów adaptacyjnego zdyseksowania sieci w zakresie rozszerzonego zasobu.
...
```
## OPIS
Adaptacyjne połączenia sieciowe są automatycznie obliczane przez Azure Security Center. To polecenie cmdlet pozwala uzyskać listę zasobów adaptacyjnego synchronizowania sieci w zakresie rozszerzonego zasobu.
...
Pobiera listę zasobów Adaptacyjne nasycanie sieci w zakresie rozszerzonego zasobu.
...
/subscriptions/3eeab341-f466-499c-a8be-85427e154baf7612f869/resourceGroups/myService1/providers/Microsoft.Compute/virtualMachines/myResource1/providers/Microsoft.Security/adaptiveNetworkHardenings/default default Microsoft.Security/adaptiveNetworkHardenings Microsoft.Azure.Commands.SecurityCenter.Models…
```
Uzyskaj jeden zasób Adaptive Network Nasadki
...
### Microsoft.Azure.Commands.Security.Models.AdaptiveNetworkInienings.PSSecurityAdaptiveNetworkDenings
