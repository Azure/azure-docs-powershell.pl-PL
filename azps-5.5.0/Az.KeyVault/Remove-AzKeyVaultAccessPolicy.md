...
To polecenie usuwa wszystkie uprawnienia, które użytkownik ma w magazynie kluczy o nazwie PattiFuller@contoso.com Contoso03Vault.  Jeśli jest określona wartość -PassThru, jest zwracany obiekt KeyVault.
...
Jeśli jest to określone, wyłącza pobieranie sekretów z tego magazynu kluczy przez dostawcę zasobów Microsoft.Compute, gdy odwołuje się do nich podczas tworzenia zasobów.
