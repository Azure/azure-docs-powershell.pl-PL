...
### Przykład 1. Uzyskiwanie stanu operacji certyfikatu
```powershell
...
To polecenie otrzymuje stan operacji certyfikatu dla certyfikatu TestCert01 w magazynie kluczy ContosoKV01.
