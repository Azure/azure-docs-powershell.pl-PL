...
## OPIS
Polecenie **cmdlet Backup-AzKeyVaultSecret** kopii zapasowej określonego klucza tajnego jest kopii zapasowej w magazynie kluczy, pobierając je i przechowując w pliku.
...
### Przykład 2. Kopię zapasową tajnego pliku o określonej nazwie pliku i nadpisanie istniejącego pliku bez monitu
```powershell
...
### -VaultName
Określa nazwę magazynu kluczy zawierającego klucz tajny, który ma być kopią zapasową.
