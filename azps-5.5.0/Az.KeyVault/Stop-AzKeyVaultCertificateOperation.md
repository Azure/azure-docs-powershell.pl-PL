...
## OPIS
Polecenie **cmdlet Stop-AzKeyVaultCertificateOperation** anuluje operację certyfikatu w usłudze magazynu kluczy platformy Azure.

## PRZYKŁADY

### Przykład 1. Anulowanie operacji certyfikatu
```powershell
