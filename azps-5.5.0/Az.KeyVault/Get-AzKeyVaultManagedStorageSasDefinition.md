...
Pobiera szczegóły "konta" w definicji SAS skojarzone z zarządzanym kontem magazynu magazynu kluczy "mystorageaccount" zarządzanym przez magazyn "myvault".
...
### -InRemovedState
Określa, czy w wynikach mają być wyświetlane definicje plików SAS wcześniej usuniętych magazynów.
