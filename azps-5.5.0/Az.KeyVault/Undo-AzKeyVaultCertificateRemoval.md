...
Odzyskany certyfikat będzie aktywny i będzie można go używać we wszystkich operacjach.
...
To polecenie spowoduje odzyskanie wcześniej usuniętego certyfikatu w stanie aktywnym i użytecznym.
