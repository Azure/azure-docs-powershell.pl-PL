...
Jeśli nie zostanie określona, istniejąca wartość nazwy aktywnego klucza konta magazynu zarządzanego pozostaje niezmieniona
...
### — Włącz
Jeśli istnieje, umożliwia użycie klucza konta magazynu zarządzanego dla generowania tokenu sas, jeśli wartość jest prawdziwa. Wyłącza używanie klucza konta magazynu zarządzanego do generowania tokenu sas, jeśli wartość jest fałszywa. Jeśli nie zostanie określona, wartość stanu włączone/wyłączonego konta magazynu pozostanie niezmieniona.
