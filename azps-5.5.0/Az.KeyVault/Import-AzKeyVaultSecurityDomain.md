...
## OPIS
To polecenie cmdlet importuje poprzednio wyeksportowane dane z domeny zabezpieczeń do zarządzanego modułu HSM.
...
Najpierw należy zapewnić klucze do odszyfrowania danych domeny zabezpieczeń.
Następnie polecenie **Import-AzKeyVaultSecurityDomain** przywraca poprzednią kopię zapasową danych domeny zabezpieczeń do zarządzanego hsm przy użyciu tych kluczy.
...
### -InputObject
Obiekt reprezentujący zarządzany moduł HSM.
...
### — Klawisze
Informacje o kluczach używanych do odszyfrowywania danych domeny zabezpieczeń.
Zobacz przykłady sposobu skonstruowania.
...
### -PassThru
Jeśli to zwrócę, wartość logiczna zostanie zwrócona, gdy polecenie cmdlet zakończy się powodzeniem.
...
### - SecurityDomainPath
Określ ścieżkę do zaszyfrowanych danych domeny zabezpieczeń.
