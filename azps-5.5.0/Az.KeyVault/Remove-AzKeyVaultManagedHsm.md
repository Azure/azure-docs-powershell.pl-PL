...
### RemoveManagedHsmByName (Domyślna)
```
...
## OPIS
Polecenie **cmdlet Remove-AzKeyVaultManagedHsm** usuwa określony zarządzany moduł HSM.
Usuwa też wszystkie klucze zawarte w tym wystąpieniu.
...
### Przykład 1. Usunięcie zarządzanego hsm
```powershell
...
To polecenie usuwa z bieżącej subskrypcji zarządzane polecenie hsm o nazwie myhsm.

### Przykład 2. Usunięcie zarządzanego hsm z określonej grupy zasobów
```powershell
...
To polecenie usuwa zarządzane hsm o nazwie myhsm z grupy zasobów o nazwie myrg1.
Jeśli nazwa grupy zasobów nie zostanie wykreślona, polecenie cmdlet wyszuka nazwany zarządzany moduł HSM do usunięcia w bieżącej subskrypcji.
...
Domyślnie to polecenie cmdlet wyświetla monit o potwierdzenie usunięcia zarządzanego modułu HSM.
...
### -InputObject
Zarządzany obiekt HSM do usunięcia.
...
### — Nazwa
Określa nazwę zarządzanego modułu HSM do usunięcia.
...
### -ResourceGroupName
Określa nazwę grupy zasobów zarządzanej przez system Azure HSM do usunięcia.
...
### -ResourceId
Identyfikator zasobu zarządzanego zarządzania.
