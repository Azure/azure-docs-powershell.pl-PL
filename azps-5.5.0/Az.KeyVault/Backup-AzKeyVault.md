...
## OPIS
Pełne tworzenie kopii zapasowej zarządzanego modułu HSM na koncie magazynu.
Użyj, `Restore-AzKeyVault` aby przywrócić kopię zapasową.
...
Polecenie cmdlet utworzy folder (o nazwie zwykle nazwanej) w kontenerze magazynu, przechowa kopię zapasową w tym folderze i wyprowadzi `mhsm-{name}-{timestamp}` URI folderu.
