...
### Przykład 1. Usuwanie operacji certyfikatu
```powershell
...
To polecenie usuwa operację certyfikatu o nazwie TestCert01 z magazynu kluczy ContosoKV01 bez monitu o potwierdzenie.
