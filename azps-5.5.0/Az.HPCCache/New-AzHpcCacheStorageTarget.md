...
## OPIS
Polecenie **cmdlet New-azHpcCacheStorageTarget** dodaje element docelowy magazynu do pamięci podręcznej Azure HPC Cache.
...
### — CLFS
Aktualizowanie typu docelowego magazynu usługi CLFS.
...
### — Wymuszanie
Wskazuje, że polecenie cmdlet nie wyświetla monitu o potwierdzenie. Domyślnie to polecenie cmdlet monituje o potwierdzenie, że chcesz opróżnić pamięć podręczną.
...
### -NFS
Aktualizowanie typu docelowego miejsca do magazynowania systemu NFS.
...
### -ResourceGroupName
"Nazwa grupy zasobów, w ramach której chcesz utworzyć miejsce docelowe miejsca do magazynowania dla danej pamięci podręcznej.
