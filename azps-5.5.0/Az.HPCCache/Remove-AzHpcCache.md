...
## OPIS
Polecenie **cmdlet Remove-AzHpcCache** usuwa pamięć podręczną Azure HPC Cache.
...
### — Wymuszanie
Wskazuje, że polecenie cmdlet nie wyświetla monitu o potwierdzenie. Domyślnie to polecenie cmdlet wyświetla monit o potwierdzenie usunięcia pamięci podręcznej.
...
### -ResourceGroupName
Nazwa grupy zasobów, w ramach której chcesz usunąć pamięć podręczną.
