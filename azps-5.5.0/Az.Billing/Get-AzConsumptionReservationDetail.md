...
## OPIS
Polecenie **cmdlet Get-AzConsumptionReservationDetail** pobiera szczegóły rezerwacji dla podanego zakresu dat.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie szczegółów rezerwacji z identyfikatorem zamówienia rezerwacji dla podanego zakresu dat
```powershell
...
### Przykład 2. Uzyskiwanie szczegółów rezerwacji z identyfikatorem zamówienia rezerwacji i identyfikatorem rezerwacji dla podanego zakresu dat
```powershell
...
### -EndDate
Dane końcowe (YYYY-MM-DD w czasie UTC) szczegółów rezerwacji.
...
### -StartDate
Dane rozpoczęcia (YYYY-MM-DD w czasie UTC) szczegółów rezerwacji.
