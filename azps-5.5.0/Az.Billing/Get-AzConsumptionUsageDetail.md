...
## OPIS
Polecenie **cmdlet Get-AzConsumptionUsageDetail** pobiera szczegóły użycia subskrypcji. 

## PRZYKŁADY

### Przykład 1. Uzyskiwanie szczegółów użycia dzięki rozwinięciu funkcji SzczegółyMetra
```powershell
...
### Przykład 2. Uzyskiwanie szczegółów użycia za pomocą zakresu dat
```powershell
...
### Przykład 3. Uzyskiwanie szczegółów użycia nazwy BillingPeriodName za pomocą filtru InstanceName
```powershell
...
### -BillingPeriodName
Nazwa konkretnego okresu rozliczeniowego w celu uzyskania szczegółów użycia, z którym jest skojarzony.
...
### -EndDate
Data zakończenia (w czasie UTC) użycia do filtrowania.
...
### — Rozwiń
Rozwiń użycie na podstawie danych MeterDetails lub AdditionalInfo.
...
Uwzględnij dodatkowe właściwości w zastosowaniach.
...
### -IncludeMeterDetails
Uwzględnij szczegóły dotyczące licznika w zastosowaniach.
...
### -InstanceId
Identyfikator wystąpienia użycia do filtrowania.
...
### -InstanceName
Nazwa wystąpienia użycia do filtrowania.
...
### -ResourceGroup
Grupa zasobów, w przypadku których mają być filtrowane dane.
...
### - StartDate
Data rozpoczęcia (w czasie UTC) użycia do filtrowania.
