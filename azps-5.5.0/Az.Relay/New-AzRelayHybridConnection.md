...
## OPIS
To New-AzRelayHybridConnection cmdlet tworzy połączenie hybrydowe w określonej przestrzeni nazw przekazywania.
...
Tworzy nowy program \` TestHybirdConnection TestHybirdConnection2 w określonej przestrzeni nazw \` \` Relay TestNameSpace-HybirdConnection. \`
...
Tworzy nowy program \` TestHybirdConnection TestHybirdConnection1 w określonej przestrzeni nazw \` \` Relay TestNameSpace-HybirdConnection. \`
...
### — Nazwa
Nazwa usługi HybridConnections.
...
prawda, jeśli dla tych połączeń hybrydowych jest potrzebna autoryzacja klienta; w przeciwnym razie fałsz
