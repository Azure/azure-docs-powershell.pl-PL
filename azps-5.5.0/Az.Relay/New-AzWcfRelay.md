...
## OPIS
Polecenie New-AzWcfRelay cmdlet tworzy WcfRelay w określonej przestrzeni nazw przekazywania.
...
Tworzy nową nazwę WcfRelay TestWCFRelay2 w określonej przestrzeni nazw \` \` Relay \` TestNameSpace-Relay. \`

### Przykład 2. Właściwości
```
...
Tworzy nową nazwę WcfRelay \` TestWCFRelay w określonej przestrzeni nazw \` \` Przekazywania TestNameSpace-Relay1. \`
...
### - WymagaClientAuthorization
prawda, jeśli do tego przekazywania jest potrzebna autoryzacja klienta; w przeciwnym razie fałsz
...
### — WymagaTransportSecurity
prawda, jeśli dla tego przekazywania jest wymagane bezpieczeństwo transportu; w przeciwnym razie fałsz
...
### -WcfRelayType
Typ WcfRelay.
Możliwe wartości: "NetTcp" lub "Http"
