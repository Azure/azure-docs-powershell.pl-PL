...
## OPIS
Polecenie **cmdlet Remove-AzWcfRelay** usuwa plik WcfRelay z określonej przestrzeni nazw przekazywania.
...
Usuwa wcfRelay `TestWCFRelay1` z przestrzeni `TestNameSpace-Relay1` nazw.
