...
## OPIS
Polecenie **cmdlet New-AzRelayKey** generuje podstawowe i pomocnicze parametry połączenia dla danych obiektów przekazywania (Przestrzeń nazw/WcfRelay/HybridConnection).
...
Ponowne generowanie podstawowych lub pomocniczych ciągów połączenia dla danej Relay-Namespace danych.

### Przykład 1.1 . Podany klucz przestrzeni nazw
```
...
generuje podstawowe lub pomocnicze parametry połączenia dla danej jednostki Relay-Namespace z podaną wartością klucza
...
Ponowne generowanie podstawowych lub pomocniczych ciągów połączenia dla danej Relay-WcfRelay encji.

### Przykład 2.1 — WcfRelay KeyValue Provided
```
...
generuje podstawowe lub pomocnicze parametry połączenia dla danej jednostki Relay-WcfRelay z podaną wartością klucza
...
### Przykład 3.1 . HybridConnection KeyValue Provided
```
...
generuje podstawowe lub pomocnicze parametry połączenia dla danej jednostki Relay-HybridConnection z podaną wartością klucza
...
### -KeyValue
Zakodowany w bazie danych klucz 256-bitowy do podpisywania i sprawdzania poprawności tokenu SAS.
...
### -RegenerateKey
Ponownie generuj klucze — "KluczPodstawowy"/"Klucz Pomocniczy".
