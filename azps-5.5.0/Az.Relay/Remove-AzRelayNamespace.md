...
## OPIS
Polecenie **cmdlet Remove-AzRelayNamespace** usuwa przestrzeń nazw z określonej grupy zasobów.
...
Usuwa przestrzeń nazw Przekazywanie `TestNameSpace-Relay1` z określonej grupy `Default-ServiceBus-WestUS` zasobów.
