...
## OPIS
Polecenie Set-AzRelayHybridConnection aktualizuje opis połączenia hybrydowego w określonej przestrzeni nazw przekazywania.
...
Aktualizuje określony program HybridConnection o nowy opis w określonej przestrzeni nazw.
W tym przykładzie właściwość UserMetadata jest aktualizowana przy użyciu nowej wartości.
