...
## OPIS
Polecenie **cmdlet Remove-AzSentinelIncident** trwale usuwa zdarzenie z określonego obszaru roboczego.
Obiekt Incident **można** przekazać za pomocą operatora potoku lub ewentualnie określić wymagane parametry.
