...
W tym przykładzie **jest określonej** reguły alertu, która jest określana przy użyciu właściwości aplikacji logiki, a następnie jest ona przechowywała w $AlertRuleAction alertu.
