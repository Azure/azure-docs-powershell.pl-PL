...
## OPIS
Polecenie **cmdlet Update-AzSentinelBookmark** aktualizuje zakładkę w określonym obszarze roboczym.
Obiekt Bookmark można **przekazać** jako parametr lub za pomocą operatora potoku, a także określić wymagane parametry *bookmarkId.*
...
Polecenie aktualizuje zakładkę, ustawiając właściwość *Notatki.*  Wszystkie pozostałe proprety pozostają takie same.
...
Pierwsze polecenie pobiera pole Zakładka według *wartości BookmarkId* z określonego obszaru roboczego, a następnie zapisuje je w $Bookmark obszarze roboczym.
Drugie polecenie aktualizuje właściwość Notatki.   Wszystkie pozostałe proprety pozostają takie same.
