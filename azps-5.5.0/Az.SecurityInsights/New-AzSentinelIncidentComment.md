...
## OPIS
Polecenie **cmdlet New-AzSentinelIncidentComment** tworzy komentarz zdarzenia z określonego obszaru roboczego.
...
W tym przykładzie w określonym obszarze roboczym jest określonej wartości typu **IncidentComment,** a następnie jest on $IncidentComment zmienną.
