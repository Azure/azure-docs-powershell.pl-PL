...
W tym przykładzie zmieniono ustawienie wartości **AlertRule** na *Disabled* (Wyłączone) i zmieniono nazwę na *Disabled-AlertRuleDisplayName (Wyłączono AlertRuleDisplayName).*  Wszystkie pozostałe właściwości pozostaną takie same.
