...
## OPIS
Polecenie **cmdlet Update-AzSentinelIncident** aktualizuje zdarzenie w określonym obszarze roboczym.
Obiekt Incident **można** przekazać jako parametr lub za pomocą operatora potoku albo określić wymagane parametry.
...
Polecenie pobiera wartość Incident by *IncidentId* i ustawia dla *właściwości Ważność* wartość *Wysoka.*  Wszystkie pozostałe właściwości pozostają takie same.
