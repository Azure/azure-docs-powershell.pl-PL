...
### Przykład 1. Wdrażanie lokalnego skompilowanego jar w usłudze według nazwy.
```powershell
...
Wdrażanie lokalnego skompilowanego jar w usłudze według nazwy.
...
### — JarPath
Ścieżka słoika musi zostać wycofana.
