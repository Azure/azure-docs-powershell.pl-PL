...
### Przykład 1. Uzyskiwanie aplikacji Spring Cloud według nazwy.
```powershell
...
Pobierz aplikację Spring Cloud według nazwy.

### Przykład 2. Lista wszystkich aplikacji w ramach danej wiosennej usługi w chmurze.
```powershell
...
Lista wszystkich aplikacji w ramach danej wiosennej usługi w chmurze.
