...
### Przykład 1. Uzyskiwanie usługi Spring Cloud Service według nazwy
```powershell
...
Uzyskiwanie usługi Spring Cloud Według nazwy

### Przykład 2. Lista wszystkich wiosennych usług w chmurze w grupie zasobów.
```powershell
...
Lista wszystkich wiosennych usług w chmurze w ramach grupy zasobów.
