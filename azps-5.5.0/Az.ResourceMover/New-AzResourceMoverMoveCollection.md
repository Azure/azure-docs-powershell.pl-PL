...
### Przykład 1. Tworzenie nowej kolekcji Przenieś.
```powershell
...
Utwórz nową kolekcję Przenieś w ramach subskrypcji.
...
### -IdentityPrincipalId
Pobiera lub ustawia identyfikator dyrektora.
...
### -IdentityType
Typ tożsamości używany dla usługi przenoszenia regionu.
...
### Microsoft.Azure.PowerShell.cmdlet.ResourceMover.Models.Api20191001Preview.IMoveCollection
