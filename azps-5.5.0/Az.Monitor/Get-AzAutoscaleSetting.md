...
## OPIS
Polecenie **cmdlet Get-AzAutoscaleSetting** pobiera wszystkie ustawienia skalowania automatycznego skojarzone z grupą zasobów lub określonym ustawieniem autoskalowania.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie ustawień skalowania automatycznego
```
...
To polecenie pobiera ustawienia skalowania automatycznego przypisane do grupy zasobów Default-Web-EastUS.

### Przykład 2. Uzyskiwanie ustawienia skalowania automatycznego według nazwy
```
...
To polecenie pobiera ustawienie skalowania automatycznego o nazwie DefaultServerFarm-Default-Web-EastUS.
...
### -DetailedOutput
Oznacza, że ta operacja wyświetla pełne szczegóły w wynikach.
...
### — Nazwa
Określa nazwę ustawienia do uzyskania.
