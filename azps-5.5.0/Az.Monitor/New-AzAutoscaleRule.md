...
## OPIS
Polecenie **cmdlet New-AzAutoscaleRule** tworzy regułę skalowania automatycznego.
...
Pierwsze polecenie tworzy regułę dla metryki Żądania, a następnie przechowuje ją w zmiennej $Rule 1.
Drugie polecenie tworzy drugą regułę dla metryki Żądania, a następnie przechowuje ją w zmiennej $Rule 2.

### Przykład 3

Tworzy regułę skalowania automatycznego. (wygenerowane automatycznie)
...
### -MetricResourceId
Określa metryyczny identyfikator zasobu.
...
### -ScaleActionCooldown
Określa czas odnowienia akcji autoskalowania.
...
Określa kierunek akcji skalowania.
Dopuszczalne wartości dla tego parametru to:
- Brak
- Zwiększ
- Zmniejszanie
...
### — próg
Określa próg wartości metryczne.
