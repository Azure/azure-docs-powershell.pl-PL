...
## OPIS
Aktualizuje regułę alertu dziennika semantyką PUT

## PRZYKŁADY

### Przykład 1. Ustawianie według nazwy reguły
```powershell
...
### Przykład 2. Ustawianie według obiektu input
```powershell
...
### Przykład 3. Ustawianie według identyfikatora zasobu
```powershell
...
### — akcja
Zaplanowane działanie alertu reguły kwerendy
...
### — Planowanie
Harmonogram reguł kwerend planowanych
...
### — Źródło
Źródło reguł kwerendy zaplanowanej
