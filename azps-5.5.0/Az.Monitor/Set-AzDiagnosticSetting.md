...
Flaga oznaczaca, że eksport do la musi zostać wykonane dla tabeli specyficznej dla zasobu, czyli dedykowanej lub stałej tabeli  schematów, a nie domyślnej tabeli schematów dynamicznych **o nazwie AzureDiagnostics.**
