...
## OPIS
Tworzenie obiektu PSServiceDiagnosticSettings.
Ten parametr może być używany jako parametr dla `-InputObject``Set-AzDiagnosticSetting`
...
Tworzenie obiektu PSServiceDiagnosticSettings. Następnie utwórz ustawienie diagnostyczne dla zasobu docelowego.

## PARAMETERS

### -DedicatedLogAnalyticsDestinationType
Wartość wskazująca, czy eksportować (do ods) do określonego zasobu (jeśli występuje), czy do narzędzia AzureDiagnostics (domyślnie nie występuje)
...
### — Ustawienie
Ustawienia metryczne lub ustawienia dziennika
...
### Microsoft.Azure.Commands.Insights.OutputClasses.PSDianossticDetailSettings[]
