...
## OPIS
Polecenie **cmdlet New-AzAutoscaleProfile** tworzy profil autoskalowania.

## PRZYKŁADY

### Przykład 1. Tworzenie jednego profilu ze stałą datą
```
...
Pierwsze polecenie tworzy regułę automatycznego skalowania o nazwie Żądania, a następnie zapisuje ją w $Rule zmienną.
Drugie polecenie tworzy profil o nazwie Profile01 o stałej dacie przy użyciu reguły w $Rule.
...
Pierwsze polecenie tworzy regułę skalowania automatycznego o nazwie Żądania, a następnie zapisuje ją w $Rule zmienną.
Drugie polecenie tworzy profil o nazwie SecondProfileName z harmonogramem cyklicznym przy użyciu reguły w $Rule.

### Przykład 3. Tworzenie profilów z dwiema regułami
```
...
Pierwsze dwa polecenia tworzą reguły i przechowują je w zmiennych, $Rule 1 i $Rule 2.
Trzecie polecenie tworzy profil o nazwie ProfileName przy użyciu reguł z reguły 1 i 2, a następnie zapisuje go w zmiennej $Profile 1.
Ostatnie polecenie tworzy profil o nazwie SecondProfileName przy użyciu reguł z reguły 1 i 2, a następnie zapisuje go w zmiennej $Profile 2.

### Przykład 4. Tworzenie profilu bez harmonogramu i ustalonej daty
```
PS C:\>$Rule = New-AzAutoscaleRule -MetricName "Requests" -MetricResourceId "/subscriptions/b93fb07a-6f93-30be-bf3e-4f0deca15f4f/resourceGroups/Default-Web-EastUS/providers/microsoft.web/sites/mywebsite" -Operator GreaterThan -MetricStatistic Average -Threshold 10 -TimeGrain 00:01:00 -ScaleActionCooldown 00:05:00 -ScaleActionDirection Increase -ScaleActionScaleType ChangeCount -ScaleActionValue "1" 
...
Pierwsze polecenie tworzy regułę automatycznego skalowania o nazwie Żądania, a następnie zapisuje ją w $Rule zmienną.
Drugie polecenie tworzy profil bez harmonogramu lub ustalonej daty, a następnie zapisuje go w $Profile danych.

## PARAMETERS

### -DefaultCapacity
Określa domyślną pojemność.
...
### — Nazwa
Określa nazwę profilu do utworzenia.
...
### — reguła
Określa listę reguł do dodania do profilu.
...
### -TimeWindowTimeZone
Określa strefę czasową w oknie czasowym.
...
### System.Collections.generic.List'1[[Microsoft.Azure.Management.Monitor.Management.Models.ScaleRule, Microsoft.Azure.PowerShell.Cmdlet.Monitor, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]]
