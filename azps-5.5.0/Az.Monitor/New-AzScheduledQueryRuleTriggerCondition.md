...
## OPIS
Tworzy obiekt typu Warunek wyzwalacza.
Ten obiekt ma zostać przekazany do polecenia tworzącego obiekt Akcji alertu
...
### - MetricTrigger
Warunek wyzwalacza reguły zapytania metryki
...
### — próg
Próg, powyżej którego jest zwalniany alert
...
### -ThresholdOperator
Operator progu: GreaterThan, LessThan lub Equal
