...
### Przykład 2. Uzyskiwanie metryki ze szczegółowymi danymi wyjściowmi
```
...
### - TimeGrain
Określa grain czasu metryki jako obiekt **TimeSpan** w formacie gg:mm:ss.
...
Więcej informacji o obsługiwanych metrykach można znaleźć na stronie: https://docs.microsoft.com/en-us/azure/azure-monitor/platform/metrics-supported
