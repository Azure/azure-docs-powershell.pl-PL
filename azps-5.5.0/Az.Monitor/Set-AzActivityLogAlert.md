...
Pierwsze polecenie przypomina nop i ustawia alert z tymi samymi wartościami, które zawierały już pozostałe polecenia, pobierz regułę alertu, zmień opis i wyłącz go, a następnie użyj parametru InputObject, aby utrzymać te zmiany.
...
### — Tag
Ustawia właściwość tagów zasobu alertów dziennika aktywności.
