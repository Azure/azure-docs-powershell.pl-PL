...
## SYNOPSIS
To polecenie cmdlet pobiera bieżącą wartość wygenerowanego numeru kontrolki wymiany na umowę.
...
## OPIS
To polecenie cmdlet jest przeznaczone do użycia w scenariuszach odzyskiwania po awarii w celu pobrania bieżącej wartości wygenerowanego numeru kontrolki wymiany w celu odpisania zwiększonej wartości za pomocą polecenia Set-AzIntegrationAccountGeneratedIcn.
Należy zwiększyć numer kontroli wymiany, aby uniknąć zduplikowanych numerów kontroli wymiany dla numerów, których nie można było jeszcze zreplikować do regionu pasywnego w przypadku awarii w aktywnym regionie.
...
To polecenie pobiera numer kontrolki wymiany X12 wygenerowany na koncie integracji według nazwy umowy. Upewnij się, że określona umowa jest typu "X12"
...
To polecenie pobiera numer kontroli wymiany Edifact wygenerowany na koncie integracji według nazwy umowy. Upewnij się, że określona umowa jest typu "Edifact"
...
To polecenie pobiera wszystkie wygenerowane numery kontroli wymiany X12 według nazwy konta integracji.
