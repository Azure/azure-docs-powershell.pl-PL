...
## OPIS
Polecenie **cmdlet Set-AzIntegrationAccountMap** modyfikuje mapę konta integracji.
...
### Przykład 1. Modyfikowanie mapy konta integracji
```powershell
...
To polecenie modyfikuje mapę konta integracji w określonej grupie zasobów.
To polecenie określa definicję mapy przechowywaną w $MapContent danych za pomocą poprzedniego polecenia.

### Przykład 2

Modyfikuje mapę konta integracji. (wygenerowane automatycznie)
...
### -MapFilePath
Określa ścieżkę pliku definicji mapy konta integracji.
