...
## SYNOPSIS
Modyfikuje zestaw konta integracji.

## SKŁADNIA

### ByIntegrationAccountAndFilePath (domyślne)
```
...
## OPIS
Polecenie **cmdlet Set-AzIntegrationAccountAssembly** modyfikuje zestaw konta integracji.
...
Modyfikuje zestaw o nazwie "sampleAssembly" przy użyciu pliku lokalnego znajdującego się w ścieżce pliku zawartej w pliku "$localAssemblyFilePath".

### Przykład 2. Modyfikowanie zestawu przy użyciu danych bajtowych
```powershell
...
### Przykład 3. Modyfikowanie zestawu przy użyciu linku zawartości
```powershell
...
Modyfikuje zestaw o nazwie "sampleAssembly" przy użyciu danych bajtowych znajdujących się w adresie URL "$assemblyUrl". Jest to sugerowana metoda tworzenia dużych zestawów.

## PARAMETERS

### -AssemblyData
Dane bajtowe zestawu konta integracji.
...
### - ContentLink
Publicznie dostępny link do danych zestawu konta integracji.
...
### — Metadane
Metadane zestawu kont integracji.
