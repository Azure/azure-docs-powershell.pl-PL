...
## SYNOPSIS
Anulowanie uruchomienia aplikacji logiki.
...
## OPIS
Polecenie **cmdlet Stop-AzLogicAppRun** anuluje uruchomienie aplikacji logiki.
...
### Przykład 1. Anulowanie uruchomienia aplikacji logiki
```
PS C:\>Stop-AzLogicAppRun -ResourceGroupName "ResourceGroup11" -Name "LogicApp03" -RunName "08587489104702792076" -Force
```

To polecenie anuluje uruchomienie aplikacji logiki o nazwie LogicApp03.
...
### — Nazwa
Określa nazwę aplikacji logiki, dla której to polecenie cmdlet anuluje uruchomienie.
...
### -RunName
Określa nazwę uruchamiania aplikacji logiki, które to polecenie cmdlet anuluje.
