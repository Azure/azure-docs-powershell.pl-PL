...
## SYNOPSIS
Otrzymuje partnerów kont integracji.
...
## OPIS
Polecenie **cmdlet Get-AzIntegrationAccountPartner** pobiera partnerów konta integracji z grupy zasobów.
...
### Przykład 1. Uzyskiwanie partnera konta integracji
```
...
To polecenie pobiera partnera konta integracji o nazwie IntegrationAccountPartner22.

### Przykład 2. Uzyskiwanie partnerów konta integracji przy użyciu nazwy konta integracji
```
...
To polecenie pobiera partnerów kont integracji dla konta integracji o nazwie IntegrationAccount31.
