...
## SYNOPSIS
Modyfikuje partnera konta integracji.
...
## OPIS
Polecenie **cmdlet Set-AzIntegrationAccountPartner** modyfikuje partnera konta integracji.
To polecenie cmdlet zwraca obiekt reprezentujący partnera konta integracji.
...
### Przykład 1. Modyfikowanie partnera konta integracji
```powershell
...
To polecenie modyfikuje partnera konta integracji o nazwie IntegrationAccountPartner22 w określonej grupie zasobów.

### Przykład 2

Modyfikuje partnera konta integracji. (wygenerowane automatycznie)
...
### —BusinessIdentities
Określa tożsamości biznesowe partnera konta integracji.
Określ tabelę skrótu.
...
### -PartnerName
Określa nazwę partnera konta integracji.
