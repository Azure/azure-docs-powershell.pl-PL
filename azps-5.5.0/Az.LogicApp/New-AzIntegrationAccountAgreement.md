...
## SYNOPSIS
Tworzy umowę na konto integracji.
...
## OPIS
Polecenie **cmdlet New-AzIntegrationAccountAgreement** tworzy umowę na konto integracji.
To polecenie cmdlet zwraca obiekt reprezentujący umowę konta integracji.
Określ nazwę konta integracji, nazwę grupy zasobów, nazwę umowy, typ, nazwę partnera, kwalifikatorów partnera i zawartość umowy.
...
### Przykład 1. Tworzenie umowy o koncie integracji
```powershell
...
To polecenie tworzy umowę konta integracji w określonej grupie zasobów platformy Azure.

### Przykład 2

Tworzy umowę na konto integracji. (wygenerowane automatycznie)
...
### - AgreementContent
Określa zawartość umowy w formacie JSON (JavaScript Object Notation) dla umowy.
Określ ten parametr lub *parametr AgreementContentFilePath.*
...
Określa ścieżkę pliku zawartości umowy.
Określ ten parametr lub *parametr AgreementContent.*
...
### -AgreementType
Określa typ umowy konta integracji. Dopuszczalne wartości dla tego parametru to:
- X12 
- AS2
- Edifact
...
Określa kwalifikator tożsamości biznesowej nazwy dla partnera gościa.
...
Wartość kwalifikatora tożsamości gościa w umowie integracji.
...
Określa kwalifikator tożsamości biznesowej nazwy partnera hosta.
...
Wartość kwalifikatora tożsamości hosta umowy integracji.
