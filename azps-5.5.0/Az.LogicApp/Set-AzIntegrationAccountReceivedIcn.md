...
To polecenie cmdlet pozwala zaktualizować stan przetwarzania wiadomości otrzymanego dla konta integracji z numerem kontrolki wymiany.
Możesz zaktualizować numer kontroli wymiany odebranego konta integracji, określając nazwę konta integracji, nazwę grupy zasobów, nazwę umowy, wartość numeru i stan przetwarzania wiadomości.
...
To polecenie aktualizuje numer kontroli wymiany X12 otrzymanego konta integracji dla konkretnej umowy konta integracji oraz wartość ze stanem przetwarzania wiadomości nie powiodło się.
