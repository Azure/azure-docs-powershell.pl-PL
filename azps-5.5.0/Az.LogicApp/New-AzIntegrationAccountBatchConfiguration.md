...
## SYNOPSIS
Tworzy konfigurację partii konta integracji.

## SKŁADNIA

### ByIntegrationAccountAndParameters (domyślne)
```
...
## OPIS
Polecenie **cmdlet Get-AzIntegrationAccountBatchConfiguration** tworzy nową konfigurację partii na koncie integracji.

## PRZYKŁADY

### Przykład 1. Tworzenie nowej konfiguracji partii przy użyciu pliku lokalnego
```powershell
...
Tworzy nową konfigurację partii przy użyciu pliku lokalnego znajdującego się w ścieżce pliku zawartej w pliku "$batchConfigurationFilePath".

### Przykład 2. Tworzenie nowej konfiguracji partii przy użyciu ciągu JSON
```powershell
...
Tworzy nową konfigurację partii przy użyciu ciągu JSON zawartego w ciągu "$batchConfigurationContent".

### Przykład 3. Tworzenie nowej konfiguracji partii przy użyciu parametrów
```powershell
...
Tworzy nową konfigurację partii, ręcznie podając wszystkie niezbędne parametry.

## PARAMETERS

### -BatchConfigurationDefinition
Definicja partii partii konta integracji.
...
Ścieżka pliku konfiguracji partii konta integracji.
...
### -BatchGroupName
Nazwa grupy konfiguracji partii konta integracji.
...
### -BatchSize
Rozmiar partii partii konfiguracji konta integracji.
...
### - MessageCount
Liczba komunikatów konfiguracji partii konta integracji.
...
### -ScheduleFrequency
Częstotliwość harmonogramu konfiguracji partii konta integracji.
...
### -ScheduleInterval
Interwał harmonogramu konfiguracji partii konta integracji.
...
### -ScheduleStartTime
Godzina rozpoczęcia harmonogramu konfiguracji partii konta integracji.
...
### -ScheduleTimeZone
Strefa czasowa harmonogramu konfiguracji partii konta integracji.
