...
Zmodyfikuj konfigurację partii o nazwie "sampleBatchConfig" przy użyciu pliku lokalnego znajdującego się w ścieżce pliku zawartej w pliku "$batchConfigurationFilePath".
...
Zmodyfikuj konfigurację partii o nazwie "sampleBatchConfig" przy użyciu ciągu JSON zawartego w ciągu "$batchConfigurationContent".
...
Zmodyfikuj konfigurację partii o nazwie "sampleBatchConfig", ręcznie podając wszystkie niezbędne parametry.
