...
## SYNOPSIS
Pobiera adres URL zwrotnego połączenia zwrotnego konta integracji.
...
## OPIS
Polecenie **cmdlet Get-AzIntegrationAccountCallbackUrl** pobiera adres URL zwrotnego konta integracji z grupy zasobów.
To polecenie cmdlet zwraca obiekt **CallbackUrl** reprezentujący adres URL zwrotnego konta integracji.
...
### Przykład 1. Uzyskiwanie adresu URL zwrotnego konta integracji
```
...
To polecenie otrzymuje adres URL zwrotnego wywołania zwrotnego konta integracji.
...
### -NotAfter
Określa datę wygaśnięcia adresu URL zwrotnego.
