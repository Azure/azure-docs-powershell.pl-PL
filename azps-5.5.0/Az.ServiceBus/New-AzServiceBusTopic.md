...
## OPIS
Polecenie **cmdlet New-AzServiceBusTopic** tworzy nowy temat "Service Bus" (Autobus usługi) w określonej przestrzeni nazw tego typu.
...
Tworzy nowy temat autobusu usług w określonej przestrzeni nazw tej usługi. (wygenerowane automatycznie)
...
### -AutoDeleteOnIdle
Określa interwał [bezczynności przedziału](https://msdn.microsoft.com/library/system.timespan.aspx) czasu, po którym temat jest automatycznie usuwany. Minimalny czas trwania to 5 minut.
