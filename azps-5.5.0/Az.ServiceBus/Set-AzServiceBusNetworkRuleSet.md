...
## OPIS
Zaktualizuj zestaw netwrokruleSet owej przestrzeni nazw w bieżącej subskrypcji platformy Azure.
...
Aktualizowanie zestawu NetworkRuleSet przy użyciu parametrów -IPRule i -VirtualNetworkRule
...
Aktualizowanie zestawu NetworkRuleSet przy użyciu funkcji -InputObject
...
Zaktualizuj zestaw NetworkRuleSet, używając nazwy -ResourceId innej przestrzeni nazw.

## PARAMETERS

### -DefaultAction
Akcja domyślna dla zestawu NetworkRuleSet
...
### -InputObject
Obiekt konfiguracji zestawu sieci
...
### - VirtualNetworkRule
Lista elementów VirtualNetworkRules
