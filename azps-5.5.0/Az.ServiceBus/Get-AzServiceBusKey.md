...
## OPIS
Polecenie **cmdlet Get-AzServiceBusKey** zwraca podstawowe i pomocnicze parametry połączenia dla danej przestrzeni nazw lub kolejki, tematu lub aliasu (konfiguracje GeoDR).
