...
## OPIS
Polecenie **cmdlet New-AzServiceBusNamespace** tworzy nową przestrzeń nazw autobusu usług. Po utworzeniu manifestu zasobu przestrzeni nazw jest nieumiejętny. Ta operacja jest idempotentna.
...
Tworzy nową przestrzeń nazw autobusu usług w obrębie określonej grupy zasobów.
...
### — Lokalizacja
Lokalizacja przestrzeni nazw autobusu usług.
...
### -SkuCapacity
Jednostki przepływności przestrzeni nazw typu Premium usługi, dozwolone wartości 1 lub 2 lub 4
...
### -SKUName
Nazwa SKU przestrzeni nazw autobusu usług.
