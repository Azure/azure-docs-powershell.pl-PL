...
## OPIS
Polecenie **cmdlet Start-AzServiceBusMigration** tworzy nową konfigurację migracji i rozpoczyna migrację jednostek z przestrzeni nazw Standard do Premium
...
Tworzy nową konfigurację migracji dla nazw "TestingNamespaceStandardMigration" do przestrzeni nazw "TestingNamespacePremiumMigration"
...
### -PostMigrationName
Nazwa po migracji dla standardowej przestrzeni nazw w migracji
...
### -TargetNameSpace
Identyfikator ARM przestrzeni ARM Premium
