...
## SYNOPSIS
Pobiera definicję istniejącej reguły w danej subskrypcji tematu. 
...
## OPIS
Polecenie **cmdlet Get-AzServiceBusRule** pobiera opis określonej reguły w danej subskrypcji tematu.
...
Zwraca określony opis reguły dla określonej subskrypcji.
...
Zwraca listę opisów reguł dla określonej subskrypcji.  Domyślnie zostanie zwrócona reguła 100, jeśli zostanie zwróconych więcej niż 100 reguł, użyj parametru -MaxCount.
...
Zwraca listę pierwszych 150 opisów reguł dla określonej subskrypcji.
...
### -MaxCount
Określ maksymalną liczbę reguł do zwrócenia.
