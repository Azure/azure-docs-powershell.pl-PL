...
## OPIS
Polecenie **cmdlet Get-AzServiceBusSubscription** zwraca opis subskrypcji dla określonego tematu typu usługi.
...
Zwraca opis subskrypcji dla określonego tematu "Service Bus" (Autobus usług).
...
Zwraca listę subskrypcji dla określonego tematu "Service Bus". Domyślnie zostanie zwróconych 100 subskrypcji, dla liczby subskrypcji użyj parametru -MaxCount
...
Zwraca listę pierwszych 150 subskrypcji dla określonego tematu "Service Bus" (Autobus usług).
...
### -MaxCount
Określ maksymalną liczbę subskrypcji do zwrócenia.
