...
## OPIS
Polecenie **cmdlet Set-AzServiceBusGeoDRConfigurationBreakPair** wyłącza odzyskiwanie po awarii i przestaje replikować zmiany z podstawowych do pomocniczych przestrzeni nazw
...
### -InputObject
Obiekt konfiguracji geodru typu service bus
