...
## OPIS
Polecenie **cmdlet Set-AzServiceBusQueue** aktualizuje opis kolejki autobusu usług w określonej przestrzeni nazw tego typu.
...
Aktualizuje określoną kolejkę przy użyciu nowego opisu w określonej przestrzeni nazw. W tym przykładzie właściwość **DeadLetteringOnMessageExpiration jest** aktualizowana na **prawda,** a **właściwość SupportOrdering ma** wartość **true.**
