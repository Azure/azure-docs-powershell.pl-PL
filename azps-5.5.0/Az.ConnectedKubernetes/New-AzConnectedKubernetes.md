...
## SYNOPSIS
Interfejs API do rejestrowania nowego klastru K8s, a tym samym tworzenia śledzonego zasobu w ARM
...
### Przykład 1. Tworzenie połączonych sieci kubernetes
```powershell
...
To polecenie tworzy połączone kubernety.

### Przykład 1. Tworzenie połączonych kubernetes z parametrami kubeConfig i kubeContext
```powershell
...
To polecenie tworzy połączone witryny kubernetes z parametrami kubeConfig i kubeContext.
