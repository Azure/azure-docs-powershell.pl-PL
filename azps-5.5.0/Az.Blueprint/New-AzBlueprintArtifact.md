...
### CreateTemplateArtifact (domyślne)
```
...
Utwórz nowy artefakt za pomocą pliku JSON artefaktu.
...
Tworzenie nowego artefaktu przy użyciu parametrów w tekście.
...
Utwórz nowy artefakt za pomocą pliku ARM szablonu.
...
### - DependsOn
Lista nazw artefaktów, które muszą zostać utworzone przed utworzeniam bieżącego artefaktu.
