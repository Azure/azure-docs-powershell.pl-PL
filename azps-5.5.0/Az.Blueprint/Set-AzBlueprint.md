...
### UpdateBlueprintBySubscription (domyślne)
```
...
## OPIS
Zaktualizuj definicję planu i zapisz ją w ramach określonej subskrypcji lub grupy zarządzania.
...
Zaktualizuj definicję planu przy użyciu nowych parametrów.
