...
INPUTOBJECT: <IKubernetesConfigurationIdentity> Parametr tożsamości
  ...
  - `[ClusterResourceName <String>]`: Nazwa zasobu klastrów Kubernetes — zarządzaneclusery (dla klastrów AKS) lub połączone klastry (dla klastrów OnPrem K8S).
