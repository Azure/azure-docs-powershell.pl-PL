...
### -CacheDuration
Czas trwania, przez jaki zawartość musi być buforowana.
...
### - CustomFragment
Fragment, aby dodać do adresu URL przekierowania.
...
### -RedirectType
Podczas przekierowywania ruchu użyje ona typu przekierowywania
