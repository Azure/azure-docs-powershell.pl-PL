...
## OPIS
Polecenie **cmdlet New-AzCdnCustomDomain** tworzy domenę niestandardową dla punktu końcowego usługi Azure Content Delivery Network (CDN).
...
### -CdnEndpoint
Określa obiekt punktu końcowego sieci CDN, do którego dodano domenę niestandardową.
