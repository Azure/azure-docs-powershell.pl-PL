...
## OPIS
Polecenie **cmdlet Stop-AzCdnEndpoint** zatrzymuje punkt końcowy usługi Azure Content Delivery Network (CDN).
...
### -CdnEndpoint
Określa obiekt punktu końcowego, który ma być stopowany przez to polecenie cmdlet.
...
### -EndpointName
Określa nazwę punktu końcowego, który ma być stopowany przez to polecenie cmdlet.
