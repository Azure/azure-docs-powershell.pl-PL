...
## OPIS
Grupa New-AzCdnOriginGroup utworzy nową grupę pochodzenia w określonym punkcie końcowym. Jeśli jest to pierwsza grupa pochodzenia dla punktu końcowego, należy również ustawić właściwość DefaultOriginGroup.
...
```
To polecenie cmdlet utworzy nową grupę pochodzenia w określonym punkcie końcowym. Spowoduje to wykorzystanie podanych identyfikatorów pochodzenia jako zestawu pochodzenia.

## PARAMETERS

### -CdnOriginGroup
Obiekt grupy pochodzenia sieci CDN.
...
### -OriginGroupName
Nazwa grupy pochodzenia sieci Azure CDN.
