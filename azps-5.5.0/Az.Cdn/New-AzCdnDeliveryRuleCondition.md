...
### -MatchValue
Lista możliwych wartości dopasowań.
...
### -NegateCondition
W tym artykule opisano, czy wynik tego warunku powinien zostać negowany.
...
Dopuszczalne wartości to małe i wielkie litery
