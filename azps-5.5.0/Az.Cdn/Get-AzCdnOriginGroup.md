...
## OPIS
Polecenie Get-AzCdnOriginGroup pobiera grupę pochodzenia sieci CDN.
...
To polecenie pobierze grupę pochodzenia w określonym punkcie końcowym.
...
### -ResourceId
Identyfikator zasobu dla grupy pochodzenia
