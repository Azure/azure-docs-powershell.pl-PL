...
## SYNOPSIS
Generuje token SAS dla reguły autoryzacji usługi Azure eventhub przestrzeni nazw/aplikacji eventhub. 
...
## OPIS
Polecenie New-AzEventHubAuthorizationRuleSASToken cmdlet generuje token SAS (Shared Access Signature) dla usługi Azure Eventhub Namesapce lub Azure Eventhub
...
Wygeneruj token SAS dla danej reguły autoryzacji dla przestrzeni nazw z czasem rozpoczęcia i wygaśnięcia.
...
Wygeneruj token SAS dla danej reguły autoryzacji dla przestrzeni nazw z czasem wygaśnięcia.

## PARAMETERS

### -AuthorizationRuleId
ARM ResourceId reguły autoryzowania
