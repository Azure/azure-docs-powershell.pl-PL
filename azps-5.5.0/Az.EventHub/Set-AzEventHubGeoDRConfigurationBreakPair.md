...
## SYNOPSIS
Ta operacja powoduje wyłączenie odzyskiwania po awarii i zatrzymanie replikowania zmian z podstawowej na pomocniczą przestrzeń nazw

## SKŁADNIA

### GeoDRParameterSet (domyślne)
```
...
## OPIS
Polecenie **cmdlet Set-AzEventHubGeoDRConfigurationBreakPair** wyłącza odzyskiwanie po awarii i przestaje replikować zmiany z podstawowych do pomocniczych przestrzeni nazw
...
### -InputObject
Obiekt konfiguracji GeoDR aplikacji Eventhub
...
### —Przestrzeń nazw
Nazwa przestrzeni nazw — podstawowa przestrzeń nazw
