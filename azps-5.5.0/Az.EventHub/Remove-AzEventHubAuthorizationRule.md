...
## OPIS
Polecenie Remove-AzEventHubAuthorizationRule cmdlet usuwa określoną regułę autoryzacji z danego centrum zdarzeń.
...
Usuwa regułę autoryzacji \` MyAuthRuleName \` z przestrzeni nazw \` MyNamespaceName. \`
...
Usuwa regułę autoryzacji \` MyAuthRuleName z centrum zdarzeń \` \` MyEventHubName. \`
