...
## OPIS
Polecenie Remove-AzEventHub cmdlet usuwa określone centrum zdarzeń z danej przestrzeni nazw.
...
Usuwa nazwę \` MyEventHubName centrum \` zdarzeń.
...
### Przykład 3. InputObject using Piping:
```powershell
...
### Przykład 5. ResourceId — używanie ciągu:
```powershell
...
### -ResourceId
Identyfikator zasobu aplikacji Eventhub
