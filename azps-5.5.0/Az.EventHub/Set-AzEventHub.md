...
## OPIS
Polecenie Set-AzEventHub cmdlet aktualizuje właściwości określonego centrum zdarzeń.

## PRZYKŁADY

### Przykład 1
Aby zaktualizować program Eventhub za pomocą właściwości Rejestruj opis, wykonaj poniższe czynności. 
...
Aktualizuje nazwę MyEventHubName centrum zdarzeń reprezentowaną przez obiekt \` \` \` MyCreatedEventHub, ustawiając \` właściwości CaptureDescription
...
Aktualizuje nazwę MyEventHubName centrum zdarzeń reprezentowaną przez obiekt \` \` \` MyCreatedEventHub, ustawiając okres przechowywania wiadomości na 4 dni, a liczbę partycji \` na 2.
