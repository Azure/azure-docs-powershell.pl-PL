...
## OPIS
Usunięcie punktu końcowego serwera jest operacją szkodliwej. Ta lokalizacja serwera zatrzyma synchronizację. Tej operacji nie należy wykonywać, aby rozwiązać problemy z synchronizacją. Jeśli ta lokalizacja serwera (łącznie z plikami) zostanie ponownie dodana do tej samej grupy synchronizacji co punkt końcowy serwera, może to prowadzić do konfliktu plików i innych niezamierzonych konsekwencji. To polecenie jest przeznaczone tylko do zlikwidowania.
