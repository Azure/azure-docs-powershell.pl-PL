...
## OPIS
To polecenie zawiera listę wszystkich serwerów zarejestrowanych w danej usłudze synchronizacji przestrzeni dyskowej. Za jego pomocą można również wyświetlić listę atrybutów każdego zarejestrowanego serwera.
...
To polecenie pobiera wszystkie serwery zarejestrowane w określonej usłudze synchronizacji przestrzeni dyskowej.
