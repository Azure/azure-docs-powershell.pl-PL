...
W tym przykładzie wykrywanie zmian jest uruchamiane w przypadku zestawu plików, które zostały zmienione przez obiekt wywołujący polecenie. Celem jest także wykrywanie i synchronizowanie tych zmian przez synchronizację plików na platformie Azure.
