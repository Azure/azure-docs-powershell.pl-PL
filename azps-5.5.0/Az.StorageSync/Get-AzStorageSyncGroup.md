...
## OPIS
To polecenie zawiera listę wszystkich grup synchronizacji w ramach danej usługi synchronizacji przestrzeni dyskowej. Za jego pomocą można również wyświetlić listę atrybutów poszczególnych grup synchronizacji.
...
To polecenie pobiera wszystkie grupy synchronizacji zawarte w określonej usłudze synchronizacji przestrzeni dyskowej. Specify -Name to return a specific one.
