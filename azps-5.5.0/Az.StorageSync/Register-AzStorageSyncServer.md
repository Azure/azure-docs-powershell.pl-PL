...
## SYNOPSIS
To polecenie rejestruje serwer w usłudze synchronizacji magazynu, co tworzy relację zaufania. Następnie można skonfigurować synchronizację na tym serwerze za pomocą programu PowerShell lub portalu Azure Portal.
...
Polecenie musi być uruchamiane lokalnie na serwerze, który ma zostać zarejestrowany — może być wykonane bezpośrednio lub za pośrednictwem zdalnej sesji programu PowerShell. Nie można zaakceptować obiektu komputera zdalnego.
