...
### Przykład 1. Uzyskiwanie wszystkich usług BotServices
```powershell
...
Uzyskaj wszystkie usługi BotServices

### Przykład 2. Uzyskiwanie usługi BotService według nazwy i nazwy grupy zasobów
```powershell
...
Uzyskiwanie usługi BotService według pola ResourceGroupName i Name

### Przykład 3. Uzyskiwanie wszystkich usług BotServices według nazwy ResourceGroupName
```powershell
...
Uzyskiwanie wszystkich usług BotServices według resourcegroupname

### Przykład 4. Uzyskiwanie usługi BotService przez inputObject
```powershell
...
Uzyskiwanie usługi BotService przez inputObject
