...
### ListRegistriesParameterSet (Domyślne)
```
...
## OPIS
Polecenie Get-AzContainerRegistry pobiera określony rejestr kontenera lub wszystkie rejestry kontenerów w grupie zasobów lub w subskrypcji.
...
### Przykład 3. Uzyskiwanie wszystkich rejestrów kontenerów w subskrypcji
```powershell
...
To polecenie pobiera wszystkie rejestry kontenerów w subskrypcji.
...
### - IncludeDetail
Pokaż więcej szczegółów na temat rejestru kontenera.
