...
## OPIS
Aktualizowanie manifestu usługi ACR.
Aby użyć tego polecenia cmdlet, uruchom polecenie `Update-AzContainerRegistryRepository -RegistryName XXX -Repository XXX -WriteEnable $true`
.
...
Aktualizuj atrybuty dla manifestu przy użyciu tagu najnowsze w rejestrze.
