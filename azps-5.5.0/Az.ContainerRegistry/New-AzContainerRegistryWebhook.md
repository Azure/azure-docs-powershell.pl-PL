...
## OPIS
Polecenie New-AzContainerRegistryWebhook cmdlet tworzy webhook rejestru kontenera.

## PRZYKŁADY

### Przykład 1. Tworzenie kontenera rejestru webhook.
```
...
Utwórz webhook rejestru kontenera.

## PARAMETERS

### — akcja
Rozdzielona odstępami lista akcji, które powodują, że aplikacja WebHook może publikować powiadomienia.
...
### — Nagłówek
Nagłówki niestandardowe, które zostaną dodane do powiadomień aplikacji WebHook.
...
### — Lokalizacja
Lokalizacja w aplikacji Webhook.
Domyślna lokalizacja rejestru.
...
### — Status
Stan webhook, wartość domyślna jest włączona
