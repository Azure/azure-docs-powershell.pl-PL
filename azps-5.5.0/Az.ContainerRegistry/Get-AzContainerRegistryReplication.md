...
### ListReplicationByNameResourceGroupParameterSet (Domyślne)
```
...
## OPIS
Polecenie Get-AzContainerRegistryReplication pobiera określoną replikację rejestru kontenera lub wszystkich replikacji rejestru kontenera.
