...
## SYNOPSIS
Usuwa ustawienia aplikacji z aplikacji funkcyjnej.
...
### -AppSettingName
Lista ustawień aplikacji funkcji do usunięcia z aplikacji funkcji.
...
### — Wymuszanie
Wymusza usunięcie ustawienia aplikacji funkcji przez polecenie cmdlet bez monitowania o potwierdzenie.
