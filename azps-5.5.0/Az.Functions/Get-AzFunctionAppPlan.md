...
### Przykład 1. Pobierz wszystkie plany aplikacji funkkcyjnej.
```powershell
...
To polecenie pobiera wszystkie plany aplikacji funkcji.

### Przykład 2. Uzyskiwanie planów aplikacji funkowych według nazwy grupy zasobów.
```powershell
...
To polecenie pobiera plany aplikacji funkcji według nazwy grupy zasobów.

### Przykład 3. Uzyskiwanie planów aplikacji funkowych dla danej subskrypcji.
```powershell
...
To polecenie pobiera plany aplikacji funkcji dla danej subskrypcji.

### Przykład 4. Uzyskiwanie planów aplikacji funkowych według lokalizacji.
```powershell
...
To polecenie pobiera plany aplikacji funkcji według lokalizacji.
...
### — Lokalizacja
Lokalizacja planu aplikacji funkcji.
