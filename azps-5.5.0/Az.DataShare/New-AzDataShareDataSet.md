...
## OPIS
Polecenie **cmdlet New-AzDataShareDataSet** umożliwia dodawanie zestawów danych w usłudze Azure Data Share Account. Możesz dodać zestawy danych typu Obiekt blob, ADLS Gen2 i ADLS Gen1.
...
To polecenie dodaje zestaw danych o nazwie AdsDataSet typu kontener obiektów blob do usługi Azure Data Share AdsShare.
...
### -AdlsGen1FolderPath
Ścieżka folderu usługi ADLS w usłudze Azure Storage
...
### -FileName
Nazwa pliku adls (1) magazynu platformy Azure
