...
## OPIS
Polecenie **cmdlet New-AzDataShare** tworzy udział danych w określonym koncie udziału danych platformy Azure, podając nazwę grupy zasobów, nazwę konta, nazwę udostępniania i rodzaj udziału. Opis i warunki użytkowania to opcjonalne parametry, które można ustawiać podczas tworzenia udziału danych.

## PRZYKŁADY

### Przykład 1. Tworzenie udziału danych
```
...
To polecenie umożliwia utworzenie udziału danych o nazwie AdsShare typu CopyBased in data share account WikiAdsAccount w grupie zasobów ADS z opisem i warunkami użytkowania.
...
### — Opis
Opis udziału danych platformy Azure
...
### -TermsOfUse
Warunki użytkowania dla udostępniania danych platformy Azure
