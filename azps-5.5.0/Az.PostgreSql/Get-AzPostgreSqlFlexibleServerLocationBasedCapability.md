...
### Przykład 1. Uzyskiwanie funkcji lokalizacji według nazwy lokalizacji
```powershell
...
To polecenie cmdlet wyświetla podstawowe informacje o wersji SKU podanej lokalizacji.
...
### Microsoft.Azure.PowerShell.Cmdlet.PostgreSql.Models.Api20200214Preview.ICapabilityProperties
