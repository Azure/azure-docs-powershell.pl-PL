...
### Przykład 2. Tworzenie nowego serwera elastycznego PostgreSql z ustawieniem domyślnym
```powershell
...
Pamiętaj, że podsieci zostanie delegowana do witryny Microsoft.DBforPostgreSQL/flexibleServers.
