...
### Przykład 1. Aktualizowanie reguły wirtualnej sieci postgresql według nazwy
```powershell
...
To polecenie cmdlet aktualizuje regułę PostgreSql Virtual Network Rule według nazwy.
