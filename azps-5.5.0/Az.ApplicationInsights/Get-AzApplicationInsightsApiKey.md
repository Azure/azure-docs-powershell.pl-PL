...
## SYNOPSIS
Uzyskiwanie kluczy interfejsu API szczegółowych informacji o aplikacji dla zasobu szczegółowych informacji o aplikacjach
...
### Przykład 1. Uzyskiwanie kluczy interfejsu API dla zasobu szczegółowych informacji o aplikacji
```
...
Uzyskaj klucze interfejsu API analizy aplikacji dla "testu" zasobu w grupie zasobów "testGroup".

### Przykład 2. Uzyskiwanie określonego klucza interfejsu API dla zasobu szczegółowych informacji aplikacji
```
...
Uzyskaj konkretny klucz interfejsu API insights aplikacji, który ma identyfikator "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" dla zasobu "test" w grupie zasobów "testGroup".

## PARAMETERS

### -ApiKeyId
Identyfikator klucza interfejsu API aplikacji Insights.
