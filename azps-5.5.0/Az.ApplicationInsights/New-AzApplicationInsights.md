...
### Przykład 1. Tworzenie nowego zasobu szczegółowych informacji o aplikacjach
```
...
Dodawanie nowego zasobu szczegółowych informacji o nazwie "test" w grupie zasobów "grupa testowa" z rodzajem "java"
...
### — Lokalizacja
Lokalizacja zasobu szczegółowych informacji o aplikacji.
...
Typ dostępu sieciowego do uzyskiwania dostępu do aplikacji Insights ingestion. Wartość powinna być "Włączona" lub "Wyłączona"
...
Typ dostępu sieciowego do uzyskiwania dostępu do zapytania Szczegółowe informacje o aplikacji. Wartość powinna być "Włączona" lub "Wyłączona"
