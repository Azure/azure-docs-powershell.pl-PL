...
### Przykład 1. Usuwanie zasobu szczegółowych informacji o aplikacji
```
PS C:\> Remove-AzApplicationInsights -ResourceGroupName "testgroup" -Name "test" -PassThru
True
```

Usuwanie zasobu szczegółowych informacji aplikacji o nazwie "test" w grupie zasobów "grupa testowa"
...
### -PassThru
Jeśli zostanie określona, na wypadek, gdyby operacja zakończyła się powodzeniem. Ten parametr jest opcjonalny. Wartość domyślna to fałsz.
