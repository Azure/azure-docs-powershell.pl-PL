...
## SYNOPSIS
Tworzenie klucza interfejsu API szczegółowych informacji aplikacji dla zasobu szczegółowych informacji aplikacji
...
## OPIS
Tworzenie kluczy interfejsu API szczegółowych informacji aplikacji dla zasobu szczegółowych informacji aplikacji

## PRZYKŁADY

### Przykład 1. Tworzenie nowego klucza interfejsu API dla zasobu szczegółowych informacji aplikacji
```
...
Utwórz opis klucza klucza interfejsu API insights aplikacji jako "testapiKey" z uprawnieniami "ReadTelemetry", "WriteAnnotations" dla zasobu "test" w grupie zasobów "testGroup".
...
### — Opis
Opis ułatwiający zidentyfikowanie tego klucza interfejsu API.
...
### — Uprawnienia
Uprawnienia, na które zezwalają aplikacje przy użyciu klucza interfejsu API.
