...
## OPIS
Uzyskiwanie zasobów szczegółowych informacji o aplikacjach w grupie zasobów lub określonym zasobie

## PRZYKŁADY

### Przykład 1. Uzyskiwanie zasobów szczegółowych informacji o aplikacjach
```
...
Uzyskiwanie zasobu szczegółowych informacji o nazwie "test" w grupie zasobów "grupa testowa"

### Przykład 2. Uzyskiwanie zasobów szczegółowych informacji o aplikacjach z informacjami o planie cen
```
...
Uzyskiwanie zasobów szczegółowych informacji o aplikacjach i dołączanie informacji o planie cenowym dla zasobu o nazwie "test" w grupie zasobów "grupa testowa"
...
### — Pełne
Jeśli zostanie określona, zostanie ponownie określony plan cenowy/dzienny limit i stan składnika szczegółowych informacji o aplikacjach.
...
### — Nazwa
Nazwa zasobu szczegółowych informacji o aplikacji.
