...
## OPIS
Polecenie **cmdlet Remove-AzApiManagement** usuwa usługę Azure API Management.
...
### — Nazwa
Określa nazwę wdrożenia zarządzania interfejsem API, które usuwa to polecenie cmdlet.
