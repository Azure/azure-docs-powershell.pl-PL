...
## OPIS
Polecenie cmdlet **Set-AzApiManagementDiagnostic** aktualizuje diagnostykę skonfigurowaną w zakresie globalnym lub api.
...
Modyfikuje diagnostykę zarządzania interfejsem API w zakresie globalnym lub api. (wygenerowane automatycznie)
...
### -InputObject
Wystąpienie programu PsApiManagementDiagnostic.
Ten parametr jest wymagany.
...
### -PassThru
Jeśli określono, wówczas wystąpienie microsoft.azure.commands.apiManagement.ServiceManagement.Models.PsApiManagementDiagnostic type representing the set Diagnostic (Diagnostyka zestawu).
...
### -ResourceId
Arm ResourceId of Diagnostic or Api Diagnostic. Ten parametr jest wymagany.
