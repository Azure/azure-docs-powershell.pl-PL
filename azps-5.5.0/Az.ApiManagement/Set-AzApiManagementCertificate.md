...
## SYNOPSIS
Modyfikuje certyfikat zarządzania interfejsem API, który jest skonfigurowany do uwierzytelniania wspólnego z zapleczam.
...
## OPIS
Polecenie **cmdlet Set-AzApiManagementCertificate** modyfikuje certyfikat usługi Azure API Management.
