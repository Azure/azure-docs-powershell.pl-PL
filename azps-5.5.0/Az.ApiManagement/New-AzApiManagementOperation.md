...
## OPIS
Polecenie **cmdlet New-AzApiManagementOperation** umożliwia utworzenie operacji interfejsu API.
...
### Przykład 2. Tworzenie operacji zarządzania interfejsem API ze szczegółami żądania i odpowiedzi
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
W tym przykładzie jest zapytanie o operację zarządzania interfejsem API ze szczegółami żądania i odpowiedzi.
...
### -ApiRevision
Identyfikator poprawki interfejsu API. Ten parametr jest opcjonalny. Jeśli nie zostanie określona, operacja zostanie dołączona do aktualnie aktywnej poprawki interfejsu API.
...
### — Opis
Określa opis nowej operacji interfejsu API.
...
### — Metoda
Określa metodę HTTP nowej operacji zarządzania interfejsem API.
...
### — Odpowiedzi
Określa tablicę możliwych odpowiedzi na operację zarządzania interfejsem API.
...
### -TemplateParameters
Określa tablicę parametrów zdefiniowaną w parametrze *UrlTemplate.*
Jeśli nie określisz tego parametru, na podstawie parametru *UrlTemplate* zostanie wygenerowana wartość domyślna.
