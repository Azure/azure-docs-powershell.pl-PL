...
## OPIS
Polecenie **cmdlet Remove-AzApiManagementGateway** odłącza interfejs API od bramy.

## PRZYKŁADY

### Przykład 1. Usuwanie istniejącej bramy
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementGateway -Context $apimContext -GatewayId "g0001" -Force
```

To polecenie usuwa istniejącą bramę i nie monituje użytkownika o potwierdzenie.
