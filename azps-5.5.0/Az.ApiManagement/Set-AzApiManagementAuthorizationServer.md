...
To polecenie modyfikuje określony serwer autoryzacji zarządzania interfejsami API.

### Przykład 2

Modyfikuje serwer autoryzacji. (wygenerowane automatycznie)
...
psdx_paramvalues POBIERZ i OPUBLIKUJ.
...
### -ClientSecret
Określa klucz tajny klienta konsoli dewelopera, która jest aplikacją kliencyjną.
...
### — Nazwa
Określa nazwę serwera autoryzacji do modyfikowania.
...
Ten parametr należy określić, jeśli parametr ResourceOwnerPassword został określony przez parametr *GrantTypes.*
...
### - ServerId
Określa identyfikator serwera autoryzacji do modyfikowania.
...
### -TokenEndpointUrl
Określa punkt końcowy tokenu dla klientów w celu uzyskania tokenów dostępu w zamian za prezentowanie autoryzacji lub odświeżanie tokenów.
