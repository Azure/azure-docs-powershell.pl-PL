...
## OPIS
Polecenie **cmdlet New-AzApiManagementLog tworzy** **Loglogowanie** zarządzania interfejsem API platformy Azure.
...
### - ConnectionString
Określa parametrów połączenia usług Azure Event Hubs, które zaczynają się od następujących parametrów: `Endpoint=endpoint and key from Azure classic portal`
Klucz z prawami do wysyłania w ciągu połączenia musi być skonfigurowany.
...
### -LogId
Określa identyfikator dla rejestratora.
