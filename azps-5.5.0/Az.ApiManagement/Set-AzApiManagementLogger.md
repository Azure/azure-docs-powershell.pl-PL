...
## OPIS
Polecenie cmdlet **Set-AzApiManagementLog** modyfikuje ustawienia narzędzia Azure API Management **Loglog.**

## PRZYKŁADY

### Przykład 1. Modyfikowanie loglogii aplikacji EventHub
```powershell
...
To polecenie modyfikuje rejestratora, który ma identyfikator Informacje123.

### Przykład 2

Modyfikuje błąd zarządzania interfejsem API. (wygenerowane automatycznie)
...
### - ConnectionString
Określa ciąg połączenia centrum zdarzeń platformy Azure, który zawiera prawa do wysyłania zasad.
...
### -Logid
Określa identyfikator loglogii do zaktualizowania.
...
### -PassThru
Wskazuje, że to polecenie cmdlet zwraca polecenie  **PsApiManagement Informacji,** które to polecenie cmdlet modyfikuje.
