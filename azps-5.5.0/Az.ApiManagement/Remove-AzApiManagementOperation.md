...
### -ApiRevision
Identyfikator poprawki interfejsu API. Ten parametr jest opcjonalny. Jeśli nie zostanie określona, operacja zostanie usunięta z obecnie aktywnej poprawki interfejsu API.
