...
## OPIS
Polecenie cmdlet **Restore-AzApiManagement** przywraca usługę zarządzania interfejsem API z określonej kopii zapasowej, która jest magazynowana w obiekcie blob azurestorage.
...
To polecenie przywraca usługę zarządzania interfejsami API z obiektu blob magazynu platformy Azure.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, w której istnieje zarządzanie interfejsami API.
...
### -SourceBlobName
Określa nazwę obiektu blob źródłowego kopii zapasowej magazynu platformy Azure.
...
### -SourceContainerName
Określa nazwę kontenera źródłowego kopii zapasowej magazynu platformy Azure.
