...
## OPIS
Polecenie **cmdlet Remove-AzApiManagementGroup** usuwa istniejącą grupę zarządzania interfejsem API.

## PRZYKŁADY

### Przykład 1. Usuwanie istniejącej grupy zarządzania
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementGroup -Context $apimContext -GroupId "Group0001" -Force
```

To polecenie usuwa istniejącą grupę zarządzania o nazwie Group0001 i nie monituje użytkownika o potwierdzenie.
...
### -PassThru
Wskazuje, że to polecenie cmdlet zwraca wartość $True się powiedzie, lub wartość $False w przeciwnym razie.
