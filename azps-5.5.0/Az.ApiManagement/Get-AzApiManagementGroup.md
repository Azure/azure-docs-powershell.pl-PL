...
### Przykład 1. Pobierz wszystkie grupy
```
...
### Przykład 2. Uzyskiwanie grupy według identyfikatora
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### Przykład 3. Uzyskiwanie grupy według nazwy
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### Przykład 4. Pobierz wszystkie grupy użytkowników
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGroup -Context $apimContext -UserId "0123456789"
```

To polecenie pobiera wszystkie grupy użytkowników o identyfikatorze użytkownika 0123456789.
...
Jeśli jest to określone, polecenie cmdlet próbuje znaleźć grupę według identyfikatora.
...
Jeśli zostanie określona, zostaną zwrócone wszystkie grupy, do których przypisano produkt.
...
Jeśli to określono, polecenie cmdlet zwróci wszystkie grupy, do których przypisano produkt.
