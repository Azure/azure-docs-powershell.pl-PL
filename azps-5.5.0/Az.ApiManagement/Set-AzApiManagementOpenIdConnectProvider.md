...
## OPIS
Polecenie **cmdlet Set-AzApiManagementOpenIdConnectProvider** modyfikuje dostawcę OpenID Connect w usłudze Azure API Management.

## PRZYKŁADY

### Przykład 1. Zmienianie tajemnicy klienta dostawcy
```powershell
...
To polecenie modyfikuje dostawcę, który ma identyfikator OICProvider01.
To polecenie określa klucz tajny klienta dostawcy.

### Przykład 2

Modyfikuje dostawcę OpenID Connect. (wygenerowane automatycznie)
...
### -MetadataEndpointUri
Określa URI punktu końcowego metadanych dostawcy.
...
Określa identyfikator dostawcy, dla których to polecenie cmdlet modyfikuje.
...
### -PassThru
Wskazuje, że to polecenie cmdlet zwraca wartość polecenia **PsApiManagementOpenIdConnectProvider,** który został zmodyfikowany przez to polecenie cmdlet.
