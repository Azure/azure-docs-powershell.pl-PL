...
## OPIS
Polecenie cmdlet **Remove-AzApiManagementApiRevision** usuwa określoną poprawkę interfejsu API.
...
To polecenie usuwa poprawkę `2` interfejsu API z `echo-api` usługi zarządzania interfejsami API.

### Przykład 2

To polecenie usuwa 2 poprawki interfejsu API echo-api z usługi zarządzania interfejsami API. (wygenerowane automatycznie)
...
### -InputObject
Wystąpienie obiektu PsApiManagementApiRelease. Ten parametr jest wymagany.
