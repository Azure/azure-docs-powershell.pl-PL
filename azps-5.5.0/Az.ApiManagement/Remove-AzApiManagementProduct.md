...
## OPIS
Polecenie **cmdlet Remove-AzApiManagementProduct** usuwa istniejący produkt zarządzania interfejsami API.

## PRZYKŁADY

### Przykład 1. Usuwanie istniejącego produktu i wszystkich subskrypcji
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementProduct -Context $apimContext -ProductId "0123456789" -DeleteSubscriptions
```

To polecenie usuwa istniejący produkt i wszystkie subskrypcje.
...
### - DeleteSubscriptions
Wskazuje, czy chcesz usunąć subskrypcje produktu.
Jeśli ten parametr nie zostanie ustawiony, a subskrypcje już istnieją, występuje wyjątek.
...
### -PassThru
Wskazuje, że to polecenie cmdlet zwraca wartość $True, jeśli się powiedzie, lub wartość $False, jeśli się nie powiedzie.
