...
W związku z tym polecenie cmdlet używa wartości domyślnej Deweloper.
...
### - AdminEmail
Określa adres e-mail dla wszystkich powiadomień przesyłanych przez system zarządzania interfejsami API.
...
- "External" (Wdrożenie apiManagement jest konfigurowanie wewnątrz sieci wirtualnej mającej punkt końcowy skierowany do Internetu)
