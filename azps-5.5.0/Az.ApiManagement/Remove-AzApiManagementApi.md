...
## OPIS
Polecenie **cmdlet Remove-AzApiManagementApi** usuwa istniejący interfejs API.
...
To polecenie usuwa interfejs API z określonym identyfikatorem.

## PARAMETERS

### -ApiId
Określa identyfikator usuwania interfejsu API.
