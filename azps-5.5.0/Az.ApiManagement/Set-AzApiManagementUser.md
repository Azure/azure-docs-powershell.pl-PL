...
## OPIS
Polecenie **cmdlet Set-AzApiManagementUser** ustawia szczegóły użytkownika.

## PRZYKŁADY

### Przykład 1. Zmienianie hasła, adresu e-mail i stanu użytkownika
```powershell
...
Ustawia szczegóły użytkownika. (wygenerowane automatycznie)
...
Ten parametr musi mieć od 1 do 100 znaków.
...
### — Uwaga
Określa notatkę na temat użytkownika.
Ten parametr jest opcjonalny.
