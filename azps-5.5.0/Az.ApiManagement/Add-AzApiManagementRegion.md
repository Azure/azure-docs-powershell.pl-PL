...
Aby zaktualizować wdrożenie zarządzania interfejsem API, przekaż zmodyfikowane wystąpienie **zarządzania interfejsem PsApiManagement** do ustawienia Set-AzApiManagement.
