...
### Przykład 1. Lista wszystkich szablonów w ramach subskrypcji
```powershell
...
To polecenie wyświetla listę wszystkich szablonów w ramach subskrypcji.

### Przykład 2. Lista wszystkich szablonów w grupie zasobów
```powershell
...
To polecenie wyświetla listę wszystkich szablonów w grupie zasobów.
...
To polecenie pobiera szablon w grupie zasobów.
