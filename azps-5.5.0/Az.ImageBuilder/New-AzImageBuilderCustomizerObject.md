...
### -CustomizerName
Przyjazna nazwa w celu zapewnienia kontekstu dla czynności w ramach tego kroku dostosowywania.
...
Odpowiada inicjatorowi pliku Packer.
...
Pomiń lub określ pustą tablicę, aby użyć wartości domyślnej (bez filtru).
