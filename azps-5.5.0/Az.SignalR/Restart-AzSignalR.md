...
### Ponowne uruchamianie określonej usługi SignalR
```powershell
...
Domyślną grupę zasobów można ustawić za pomocą ustawienia \` Set-AzDefault -ResourceGroupName myResourceGroup. \`
