...
Aby utworzyć funkcję, możesz użyć definicji domyślnej New-AzStreamAnalyticsFunction polecenia cmdlet.
Można zmodyfikować definicję domyślną przed utworzeniem funkcji.
...
### — Nazwa
Określa nazwę funkcji Analiza strumienia, dla której to polecenie cmdlet uzyskuje domyślną definicję.
