...
Jeśli określisz parametr *Force* i określisz nazwę istniejącej transformacji, przekształcenie zostanie zastąpione bez potwierdzenia.
...
### — Plik
Określa ścieżkę do pliku JSON zawierającego reprezentację JSON przekształcenia usługi Azure Stream Analytics do utworzenia.
...
### — JobName
Określa nazwę zadania Azure Stream Analytics, w ramach którego ma być tworzyć transformację usługi Azure Stream Analytics.
