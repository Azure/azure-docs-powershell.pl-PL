...
Definicja zadania i metadane pozostają dostępne w ramach subskrypcji za pośrednictwem interfejsów API portalu Azure i zarządzania, dzięki co można edytować i ponownie uruchomić zadanie.
Opłata za zadanie w stanie zatrzymana nie zostanie naliczona.
...
### — Nazwa
Określa nazwę zadania Azure Stream Analytics do zatrzymania.
