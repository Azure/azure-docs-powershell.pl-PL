...
To polecenie aktualizuje monitor SAP według nazwy.

### Przykład 2. Aktualizowanie monitora SAP według obiektu
```powershell
...
To polecenia aktualizuje monitor SAP według obiektów.
