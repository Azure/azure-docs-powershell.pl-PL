...
### Przykład 1. Uzyskiwanie wszystkich wystąpień w monitorze SAP
```powershell
...
To polecenie pobiera wystąpienia monitora SAP według nazwy.

### Przykład 3. Uzyskiwanie wystąpień monitora SAP według obiektów
```powershell
...
To polecenie pobiera wystąpienia monitora SAP według obiektów.

### Przykład 4. Uzyskiwanie wystąpień monitora SAP według potoku
```powershell
...
To polecenie pobiera wystąpienia monitora SAP według potoku.
