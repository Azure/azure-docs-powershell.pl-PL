...
## OPIS
Polecenie **cmdlet New-AzOperationalInsightsLinuxSyslogDataSource** dodaje źródło danych syslog do połączonych komputerów z systemem Linux w obszarze roboczym.
Usługa Azure Operational Insights może zbierać dane syslogu.

## PRZYKŁADY

### Przykład 1. Tworzenie źródeł danych syslogu
```
$FacilityNames       = @()
$FacilityNames      += 'auth'
...
### - CollectAlert
Wskazuje, że informacje operacyjne zbierają komunikaty alertów.
...
### - CollectCritical
Wskazuje, że szczegółowe informacje operacyjne zbierają krytyczne wiadomości.
...
### - CollectDebug
Wskazuje, że szczegółowe informacje operacyjne zbierają komunikaty debugowania.
...
### - CollectEmergency
Wskazuje, że szczegółowe informacje operacyjne zbierają wiadomości alarmowe.
...
### - CollectError
Wskazuje, że szczegółowe informacje operacyjne zbierają komunikaty o błędach.
...
### - CollectInformational
Wskazuje, że szczegółowe informacje operacyjne zbierają komunikaty informacyjne.
...
### - CollectNotice
Wskazuje, że informacje operacyjne zbierają komunikaty o powiadomieniach.
...
### - CollectWarning
Wskazuje, że syslog zawiera komunikaty ostrzegawcze.
...
### — Nazwa
Określa nazwę źródła danych. Nazwa nie jest ujawniona w portalu Azure Portal i można jej używać, jeśli jest unikatowa.
