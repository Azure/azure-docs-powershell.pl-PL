...
## OPIS
Uzyskiwanie połączonego konta magazynu, lista wszystkich połączonych kont magazynu, gdy nie określono "-DataSourceType"
...
Lista połączonych ułanów magazynu dla obszaru roboczego {workspace-name}
