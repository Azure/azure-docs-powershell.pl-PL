...
## OPIS
Polecenie **cmdlet Set-AzOperationalInsightsIntelligencePack** włącza określony  pakiet analizy, jeśli jest włączony,  jest ustawiony na $True i wyłącza go, jeśli dla ustawienia Włączone ustawiono $False.

## PRZYKŁADY

### Przykład 1. Ustawianie pakietów analizy
```
PS C:\>Set-AzOperationalInsightsIntelligencePack -ResourceGroupName "ContosoResourceGroup" -WorkspaceName "ContosoWorkspace" -IntelligencePackName "ContosoWorkspace" -Enabled $True
```

To polecenie włącza określony pakiet analiz.
