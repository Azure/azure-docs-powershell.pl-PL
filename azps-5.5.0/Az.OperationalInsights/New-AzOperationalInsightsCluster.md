...
### -IdentityType
typu tożsamości, wartością może być "SystemAssigned", "Brak".
...
### — Lokalizacja
Region geograficzny, w który ma zostać wdrożony klastr.
...
### -SkuCapacity
Pojemność sku, wartość musi być wielokrotnością 100 i należy do zakresu od 1000 do 2000.
