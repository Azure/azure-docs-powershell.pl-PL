...
To polecenie nie określa *parametru Force,* dlatego wyświetla monit o potwierdzenie przed usunięciem szczegółowych informacji o magazynie.
...
Pierwsze polecenie używa Get-AzOperationalInsightsWorkspace cmdlet w celu uzyskania obszaru roboczego o nazwie MyWorkspace, a następnie zapisuje go w $Workspace danych. Drugie polecenie usuwa z usługi Szczegółowe informacje o magazynie o nazwie MyStorageInsight $Workspace monit o potwierdzenie.
