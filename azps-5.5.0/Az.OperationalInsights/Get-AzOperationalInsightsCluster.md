...
## OPIS
Uzyskiwanie lub lista klastrów, klastry list w grupie zasobów, gdy nie podano "-ClusterName", klastry list w ramach subskrypcji, gdy nie zostały podane wartości "-ClusterName" i "ResourceGroupName".
