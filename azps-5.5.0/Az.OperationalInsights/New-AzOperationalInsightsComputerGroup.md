...
## OPIS
Polecenie **cmdlet New-AzOperationalInsightsComputerGroup** tworzy grupę komputerową w grupie zasobów i lokalizacji.

## PRZYKŁADY

### Przykład 1

Tworzy grupę komputerów. (wygenerowane automatycznie)
...
Polecenie cmdlet tworzy grupę komputerów w tej grupie zasobów.
