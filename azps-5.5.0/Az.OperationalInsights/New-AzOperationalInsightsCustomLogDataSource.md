...
## OPIS
Polecenie **cmdlet New-AzOperationalInsightsCustomLogDataSource** definiuje niestandardowe zasady kolekcji dziennika.
...
### -CustomLogRawJson
Określa zasady kolekcji niestandardowej jako nieprzetworzoną notację obiektów JavaScript (JSON).
