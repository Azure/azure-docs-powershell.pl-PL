...
### Przykład 2. Uzyskiwanie obiektu obszaru roboczego i tworzenie źródła danych szczegółowych informacji aplikacji przy zastosowaniu identyfikatora zasobu aplikacji
```
...
### — Obszar roboczy
Obszar roboczy, który będzie zawierał źródło danych.
