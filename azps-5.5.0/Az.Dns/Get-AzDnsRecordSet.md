...
To polecenie pobiera tablicę wszystkich zestawów rekordów typu A w strefie myzone.com w grupie zasobów o nazwie MyResourceGroup, a następnie przechowuje je w $RecordSets zmienną.
...
- SOA
- SRV
- TXT Jeśli nie określisz *parametru RecordType,* musisz również pominąć parametr *Name.* To polecenie cmdlet zwraca wszystkie zestawy rekordów w strefie (wszystkie nazwy i typy).
