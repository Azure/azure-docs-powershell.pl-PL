...
## OPIS
W połączeniu z funkcją Update-AzPeering jest to operacja w pamięci, która będzie trwała tylko `Update-AzPeering` przez. 

## PRZYKŁADY

### Przepustowość uaktualnienia
```powershell
...
Uaktualnia przepustowość pierwszego połączenia w obiekcie komunikacji równorzędnej w pamięci. 
...
Aktualizuje adres komunikacji równorzędnej dla pierwszego połączenia w obiekcie komunikacji równorzędnej w pamięci. 

### Używanie aktualizacji do komunikacji równorzędnej
```powershell
...
Aktualizuje połączenie do użycia z usługą komunikacji równorzędnej
...
### -InputObject
Obiekt połączenia bezpośredniego
