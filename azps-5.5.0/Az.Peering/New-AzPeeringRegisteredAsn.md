...
## OPIS
Tworzenie zarejestrowanych sieci ASN dla obiektów komunikacji równorzędnej.

## PRZYKŁADY

### Uzyskiwanie komunikacji równorzędnej i tworzenie zarejestrowanej asn
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredAsn -Name $asnName -Asn $asn
```

Pobierz komunikacji równorzędnej, którą chcesz dodać zarejestrowaną asn. Następnie przekaż je do polecenia polecenia.

### Tworzenie zarejestrowanego asn przy użyciu elementu resourceId komunikacji równorzędnej
```powershell
...
### Microsoft.Azure.PowerShell.Cmdlet.Peering.Models.PSPeeringRegisteredAsn
