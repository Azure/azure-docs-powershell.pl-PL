...
### — GeoMapping
Lista regionów zamapowanych na ten punkt końcowy podczas korzystania z metody routingu ruchu geograficznego. Aby uzyskać pełną listę zaakceptowanych wartości, zapoznaj się z [dokumentacją menedżera ruchu.](https://docs.microsoft.com/en-us/azure/traffic-manager/traffic-manager-geographic-regions)
