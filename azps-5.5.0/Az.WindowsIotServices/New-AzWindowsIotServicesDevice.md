...
## SYNOPSIS
Utwórz lub zaktualizuj metadane usługi urządzeń IoT systemu Windows.
...
### Przykład 1. Tworzenie nowych usług IoT systemu Windows
```powershell
...
To polecenie tworzy nowe usługi IoT systemu Windows.
...
### -IfMatch
Tag ETag usługi urządzenia z systemem Windows IoT.
Nie należy określać tworzenia nowej usługi urządzeń IoT systemu Windows.
