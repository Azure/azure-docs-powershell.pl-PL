...
Ostatnie polecenie przypisuje zasady w programie $Policy w grupie zasobów wskazanej przez właściwość **ResourceId** programu $ResourceGroup przy użyciu pliku parametru zasad, który AllowedLocations.jsz lokalnego katalogu roboczego.
...
### -PolicySetDefinition
Obiekt definicji ustawiany przez zasady.
