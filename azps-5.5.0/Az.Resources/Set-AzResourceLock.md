...
## OPIS
Polecenie cmdlet **Set-AzResourceLock** modyfikuje blokadę zasobów.

## PRZYKŁADY

### Przykład 1. Aktualizowanie notatek dla blokady
```
...
### - LockId
Określa identyfikator blokady, która ma być zmieniana przez to polecenie cmdlet.
...
### -LockName
Określa nazwę blokady, która ma być zmieniana przez to polecenie cmdlet.
...
### - LockNotes
Określa uwagi dotyczące kłódki.
...
Aby na przykład określić bazę danych, użyj następującego formatu: Server `/` Database
