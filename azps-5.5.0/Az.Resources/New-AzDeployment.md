...
Zasób platformy Azure to jednostka platformy Azure zarządzana przez użytkowników. Zasób może mieszkać w grupie zasobów, na przykład w bazie danych, na serwerze bazy danych, w witrynie internetowej, na komputerze wirtualnym lub na koncie magazynu.
...
Aby dodać wdrożenie w ramach subskrypcji, określ lokalizację i szablon.
...
Ostatnie polecenie używa *parametru TemplateObject* w celu określenia tej tabeli skrótów i parametru *TemplateParameterFile* w celu określenia pliku zawierającego parametry i wartości parametrów.
Używa ona *parametru TemplateVersion* do określenia wersji szablonu.
