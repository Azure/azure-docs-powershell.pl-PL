...
### MemberObjectIdWithGroupObjectId (domyślne)
```
...
Dodaje użytkownika o identyfikatorze obiektu "D9076BBC-D62C-4105-9C78-A7F5BC4A3405" do grupy o identyfikatorze obiektu '85F89C90-780E-4AA6-9F4F-6F268D322EEEE'.

### Przykład 2. Dodawanie użytkownika do grupy za pomocą funkcji rurowych

```powershell
PS C:\> Get-AzADGroup -ObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE | Add-AzADGroupMember -MemberObjectId D9076BBC-D62C-4105-9C78-A7F5BC4A3405
```

Pobiera grupę o identyfikatorze obiektu "85F89C90-780E-4AA6-9F4F-6F268D322EEE" i potokuje ją do polecenia cmdlet Add-AzADGroupMember, aby dodać użytkownika do tej grupy.
...
Dodaje użytkownika do grupy i zawiera listę członków grupy.
...
UpN członków, których chcesz dodać do grupy.
...
Nazwa wyświetlana grupy, do których chcesz dodać członków.
...
### -TargetGroupObject
Object representation of the group to add the member(s) to.
...
### -TargetGroupObjectId
Identyfikator obiektu grupy, do których mają być dodawania członków.
