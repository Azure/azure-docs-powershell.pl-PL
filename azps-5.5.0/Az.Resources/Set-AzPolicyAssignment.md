...
Drugie polecenie pobiera przypisanie zasad o nazwie PolicyAssignment za pomocą Get-AzPolicyAssignment cmdlet.
...
### -AssignIdentity
Wygeneruj i przypisz tożsamość usługi Azure Active Directory dla tego przydziału zasad. Tożsamość będzie używana podczas wykonywania wdrożeń zasad "deployIfNotExists". Podczas przypisywania tożsamości wymagana jest lokalizacja.
...
Obiekt parametrów nowych zasad dla przypisania zasad.
