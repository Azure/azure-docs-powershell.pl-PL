...
## OPIS
Polecenie **cmdlet New-AzResource** tworzy zasób platformy Azure, taki jak witryna internetowa, serwer Azure SQL Database lub baza danych Azure SQL Database, w grupie zasobów.
...
Zasób można umieścić w dowolnej lokalizacji obsługującej zasoby tego typu. Grupy zasobów mogą zawierać zasoby z różnych lokalizacji. Aby określić, które lokalizacje obsługują poszczególne typy zasobów, użyj Get-AzLocation cmdlet.
