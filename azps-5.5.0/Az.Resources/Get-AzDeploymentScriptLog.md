...
### GetDeploymentScriptLogByName (domyślne)
```
...
Pobiera dziennik skryptu wdrożenia o nazwie MyDeploymentScript w grupie zasobów DS-TestRG.
...
Pobiera 3 ostatnie wiersze dziennika skryptu wdrożenia o nazwie MyDeploymentScript w grupie zasobów DS-TestRG.
...
Pierwsze polecenie otrzymuje skrypt wdrożenia o nazwie MyDeploymentScript w grupie zasobów DS-TestRG.
Drugie polecenie pobiera dziennik danego skryptu wdrożenia.
