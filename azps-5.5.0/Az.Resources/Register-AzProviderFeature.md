...
Powoduje to dodanie do konta funkcji AllowApplicationSecurityGroups dla witryny Microsoft.Network.
...
### -FeatureName
Określa nazwę funkcji, która rejestruje to polecenie cmdlet.
...
### -ProviderNamespace
Określa przestrzeń nazw, dla której to polecenie cmdlet rejestruje funkcję dostawcy.
