...
To polecenie pobiera wszystkie zasoby, których grupa zasobów należy do istot, z "innymi".
...
### — Nazwa
Nazwy zasobów do pobrania. Ten parametr obsługuje symbole wieloznaczne na początku i/lub końcu ciągu.
...
### -ResourceGroupName
Grupa zasobów, do której są pobierane zasoby. Ten parametr obsługuje symbole wieloznaczne na początku i/lub końcu ciągu.
