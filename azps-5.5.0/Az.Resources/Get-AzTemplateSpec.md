...
**Uwaga:** podczas wymieniania wszystkich specyfikacji szablonów w ramach subskrypcji lub grupy zasobów każda zwrócona specyfikacja szablonu jest *". Właściwość Versions"* będzie mieć wartość *null.* Informacje o wersji są uwzględniane tylko wtedy, gdy podano parametry -Name lub -ResourceId (np.: żądasz określonej specyfikacji/wersji szablonu).
...
**Uwaga:** Wszystkie wersje specyfikacji szablonów będą dostępne w ramach "*. Właściwość Versions*" obiektu zwracanego.
