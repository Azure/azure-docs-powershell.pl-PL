...
### ExportByNameParameterSet (domyślne)
```
...
Eksportuje wersję "1.0" specyfikacji szablonu o nazwie "MyTemplateSpec" w grupie zasobów "myRG" do lokalnego folderu wyjściowego "v1".
...
Eksportuje wersję "1.0" specyfikacji szablonu o nazwie "MyTemplateSpec" w grupie zasobów "myRG" podid subskrypcji do lokalnego folderu wyjściowego \{ \} "v1".
...
### -OutputFolder
Ścieżka do folderu, do którego będzie wyprowadzona wersja specyfikacji szablonu.
