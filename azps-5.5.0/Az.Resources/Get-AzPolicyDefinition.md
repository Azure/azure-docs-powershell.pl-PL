...
## OPIS
Polecenie **cmdlet Get-AzPolicyDefinition** pobiera kolekcję definicji zasad lub określoną definicję zasad identyfikowaną za pomocą nazwy lub identyfikatora.

## PRZYKŁADY

### Przykład 1. Pobierz wszystkie definicje zasad
```
...
### Przykład 2. Uzyskiwanie definicji zasad z bieżącej subskrypcji według nazwy
```
...
### Przykład 3. Uzyskiwanie definicji zasad z grupy zarządzania według nazwy
```
PS C:\> Get-AzPolicyDefinition -Name 'VMPolicyDefinition' -ManagementGroupName 'Dept42'
```

To polecenie pobiera definicję zasad o nazwie VMPolicyDefinition z grupy zarządzania o nazwie Sprz42.

### Przykład 4. Uzyskiwanie wszystkich wbudowanych definicji zasad z subskrypcji
```
...
### Przykład 5. Pobierz definicje zasad z danej kategorii
```
PS C:\> Get-AzPolicyDefinition | where-object {$_.Properties.metadata.category -eq "Virtual Machine"}
```

To polecenie pobiera wszystkie definicje zasad w kategorii "Maszyny wirtualnej".
...
### — Niestandardowe
Ogranicza listę wyników tylko do definicji zasad niestandardowych.
...
### — Identyfikator
Określa w pełni kwalifikowany identyfikator zasobu dla definicji zasad, która otrzymuje to polecenie cmdlet.
...
### -ManagementGroupName
Nazwa grupy zarządzania, które mają otrzymać definicje zasad.
...
### — Nazwa
Określa nazwę definicji zasad pobieraną przez to polecenie cmdlet.
...
### - SubscriptionId
Identyfikator subskrypcji definicji zasad do uzyskania.
