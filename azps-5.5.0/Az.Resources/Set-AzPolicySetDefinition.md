...
Pierwsze polecenie otrzymuje definicję zestawu zasad przy użyciu Get-AzPolicySetDefinition cmdlet.
Polecenie przechowuje ten obiekt w $PolicySetDefinition zmienną.
Drugie polecenie aktualizuje opis definicji zestawu zasad zidentyfikowanych przez właściwość **ResourceId** $PolicySetDefinition.
...
To polecenie aktualizuje metadane definicji zestawu zasad o nazwie VMPolicySetDefinition, aby wskazać, że jej kategoria to "Maszyny wirtualne".
...
To polecenie aktualizuje grupy definicji zestawu zasad o nazwie VMPolicySetDefinition, używając tabeli skrótów do konstruowania grup.
...
### -GroupDefinition
Grupy definicji zasad w definicji zaktualizowanego zestawu zasad. Może to być ścieżka do pliku zawierającego grupy lub grupy jako ciąg JSON.
...
### — Id
W pełni kwalifikowany identyfikator definicji zasad, łącznie z subskrypcją.
...
### -InputObject
Zasady ustawiają obiekt definicji w celu aktualizowania danych wyjściowych z innego polecenia cmdlet.
...
### — Metadane
Metadane definicji zaktualizowanego zestawu zasad. Może to być ścieżka do nazwy pliku zawierającej metadane lub metadane jako ciąg JSON.
...
### - Parametr
Deklaracja parametrów definicji zaktualizowanego zestawu zasad. Może to być ścieżka do nazwy pliku lub uri zawierającej deklarację parametrów albo deklaracja parametrów jako ciąg JSON.
