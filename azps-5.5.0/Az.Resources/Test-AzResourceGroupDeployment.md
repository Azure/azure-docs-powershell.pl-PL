...
## OPIS
Polecenie cmdlet **Test-AzResourceGroupDeployment** określa, czy szablon wdrażania grupy zasobów platformy Azure i jego wartości parametrów są prawidłowe.

## PRZYKŁADY

### Przykład 1. Testowanie wdrożenia z niestandardowym obiektem szablonu i plikiem parametrów
...
To polecenie służy do testowania wdrożenia w danej grupie zasobów przy użyciu skrótu w pamięci utworzonego na podstawie pliku danego szablonu i pliku parametru.

### Przykład 2. Testowanie wdrożenia za pośrednictwem pliku szablonu i pliku parametru
...
To polecenie służy do testowania wdrożenia w danej grupie zasobów i zasobie przy użyciu dostarczonego pliku szablonu i pliku parametru.
...
### -TemplateUri
Określa URI pliku szablonu JSON.
