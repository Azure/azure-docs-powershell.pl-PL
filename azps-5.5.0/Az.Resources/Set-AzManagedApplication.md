...
### SetByNameAndResourceGroup (domyślne)
```
...
## OPIS
Polecenie **cmdlet Set-AzManagedApplication** aktualizuje aplikacje zarządzane

## PRZYKŁADY

### Przykład 1. Aktualizowanie opisu zarządzanej definicji aplikacji
```
...
### — Identyfikator
W pełni kwalifikowany identyfikator aplikacji zarządzanej, łącznie z subskrypcją. np. /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName
...
### — Rodzaj
Zarządzany rodzaj aplikacji.
Jeden z portali handlowych lub serwisowych
...
### - Parametr
Sformatowany ciąg parametrów JSON dla aplikacji zarządzanej.
Może to być ścieżka do nazwy pliku lub uri zawierającej parametry albo parametry jako ciąg.
...
### — planowanie
Tabela skrótów reprezentująca właściwości planu aplikacji zarządzanej.
