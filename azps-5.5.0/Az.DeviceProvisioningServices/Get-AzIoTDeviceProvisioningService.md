...
### ListIotDpsByResourceGroup (domyślna)
```
...
Lista wszystkich usług inicjowania obsługi urządzeń w centrum Azure IoT Hub w ramach subskrypcji.
...
W grupie zasobów "myresourcegroup" (grupa zasobów) należy wyświetlić listę wszystkich usług inicjowania obsługi urządzeń w centrum Azure IoT Hub.
...
Pokaż szczegóły dotyczące usługi inicjowania obsługi urządzeń w centrum IoT Azure "myiotdps".
