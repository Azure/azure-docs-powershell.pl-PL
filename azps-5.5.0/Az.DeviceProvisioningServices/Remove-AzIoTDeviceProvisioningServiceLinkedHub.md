...
Usuń połączone centrum IoT "myiothub" w usłudze inicjowania obsługi urządzeń w centrum Azure IoT Hub.
...
Usuń połączone centrum IoT "myiothub" w usłudze inicjowania obsługi urządzeń w usłudze Azure IoT Hub przy użyciu potoku.
