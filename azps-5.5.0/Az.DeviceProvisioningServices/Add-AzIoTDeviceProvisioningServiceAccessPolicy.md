...
## OPIS
Aby uzyskać wprowadzenie do usługi inicjowania obsługi urządzeń w centrum IoT Azure, https://docs.microsoft.com/en-us/azure/iot-dps/about-iot-dps zobacz.
...
Dodaj nowe zasady dostępu udostępnionego w usłudze inicjowania obsługi administracyjnej urządzenia w centrum IoT Azure za pomocą praw EnrollmentWrite i ServiceConfig.
...
Dodaj nowe zasady dostępu udostępnionego w usłudze inicjowania obsługi urządzeń w centrum IoT Azure z prawej strony enrollmentread.
...
### -KeyName
Nazwa klucza dostępu usługi inicjowania obsługi urządzeń IoT
...
### — Uprawnienia
Uprawnienia dostępu do usługi inicjowania obsługi urządzeń IoT
