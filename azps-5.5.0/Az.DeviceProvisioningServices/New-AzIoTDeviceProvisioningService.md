...
Utwórz usługę obsługi administracyjnej urządzeń w centrum IoT Azure przy użyciu standardowej warstwy cenowej S1 i tagów w regionie grupy zasobów.
...
Utwórz usługę inicjowania obsługi urządzeń w centrum IoT Azure za pomocą standardowej warstwy cenowej S1 w regionie "eastus".
...
### — Tag
Tagi wystąpienia usługi inicjowania obsługi urządzeń IoT. Worku właściwości w parach klucz-wartość w postaci tabeli skrótu.
