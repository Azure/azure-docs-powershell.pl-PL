...
Pokaż szczegóły dotyczące "mycertificate" w usłudze inicjowania obsługi urządzeń w centrum Azure IoT Hub.
...
Lista wszystkich certyfikatów w "myiotdps" przy użyciu potoku.
