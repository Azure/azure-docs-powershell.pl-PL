...
### AgreementAcceptParameterSet (domyślne)
```
...
## OPIS
Polecenie **cmdlet Set-AzMarketplaceTerms** zapisuje obiekt terms dla podanego identyfikatora wydawcy(Publisher), identyfikatora oferty(produktu) i krotki identyfikator planu (Nazwa).

## PRZYKŁADY

### Przykład 1
Uzyskiwanie umowy wydawcy w witrynie Marketplace
...
### Przykład 2
Ustaw umowę wydawcy na "Zaakceptuj". Uzyskiwanie wartości parametru "Terms" z polecenia cmdlet "Get-AzMarketplaceTerms"
...
### — Zaakceptuj
Zaakceptuj to, aby zaakceptować postanowienia prawne.
...
### -InputObject
Obiekt Terms zwrócony w Get-AzMarketplaceTerms cmdlet. Jest to parametr obowiązkowy, jeśli parametr Accepted ma wartość True (Zaakceptowane).
...
### — Produkt
Zaoferuj ciąg identyfikatora obrazu wdrażany.
...
### — Publisher
Wdrożony ciąg identyfikatora wydawcy obrazu.
...
### — Odrzuć
Przejmij to, aby odrzucić postanowienia prawne.
...
### — Warunki
Obiekt Terms zwrócony w Get-AzMarketplaceTerms cmdlet. Jest to parametr obowiązkowy, jeśli parametr Accepted ma wartość True (Zaakceptowany parametr).
