...
### Tworzenie puli węzła z parametrami domyślnymi
```powershell
PS C:\> New-AzAksNodePool -ResourceGroupName myResouceGroup -ClusterName myCluster -Name mydefault
```

### Tworzenie kontenera systemu Windows Server na serwerze AKS
```powershell
...
### -ClusterName
Nazwa zarządzanego zasobu klastrów.
...
### - ClusterObject
Określ obiekt klastrów, w którym ma być tworzyć pulę węzła.
...
### — Wymuszanie
Tworzenie puli węzła, nawet jeśli już istnieje
...
### - OsType
Typ OsType używany do określania typu systemu operacyjnego.
Do wyboru są systemy Linux i Windows.
Domyślnie linux.
...
ScaleSetEvictionPolicy, która ma być używana do określania zasad wywrócenia dla zestawu skali maszyny wirtualnej o niskim priorytecie.
Domyślnie usuń.
...
### -ScaleSetPriority
ScaleSetPriority, która ma być używana do określania priorytetu zestawu skali maszyny wirtualnej.
Domyślnie jest to zwykły.
...
### -VmSetType
Reprezentuje typy puli węzła.
Możliwe wartości: "VirtualMachineScaleSets", "AvailabilitySet"
