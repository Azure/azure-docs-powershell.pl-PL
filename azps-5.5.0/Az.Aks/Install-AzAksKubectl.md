...
### Pobieranie i instalowanie najnowszej wersji pliku kubectl
```powershell
...
### — miejsce docelowe
Ścieżka instalacji pliku kubectl.
Domyślne instalowanie w ~/.azure-kubectl/
...
### -DownloadFromMirror
Pobierz z witryny lustrzanej: https://mirror.azure.cn/kubernetes/kubectl/
...
### — Wymuszanie
Zastępowanie istniejącego kubectla bez monitu
...
### — Wersja
Wersja kubectl do zainstalowania, np. '1.17.2'.
