...
### Zmienianie liczby minimunów na 5 dla określonej puli węzła
```powershell
...
### — Wymuszanie
Aktualizowanie puli węzła bez monitu
...
### — Id
Identyfikator puli węzła w zarządzanym klastrze Kubernetes
...
### -InputObject
Obiekt PSAgentPool, który normalnie przeszedł przez potok.
