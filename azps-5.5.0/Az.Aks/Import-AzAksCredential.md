...
### — Administrator
Pobierz konfigurację kubectl "clusterAdmin" zamiast domyślnego "clusterUser".
...
### -ConfigPath
Plik konfiguracji programu Kubectl do utworzenia lub zaktualizowania.
Zamiast tego należy użyć "-", aby wydrukować yaml jako stdout.
Domyślne: %Home%/.kube/config.
...
### — Wymuszanie
Importowanie konfiguracji Kubernetesa, nawet jeśli jest to ustawienie domyślne
...
### -PassThru
Jeśli importowanie się powiedzie, zwraca wartość prawda.
