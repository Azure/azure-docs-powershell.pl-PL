...
## SYNOPSIS
Łączy Centrum powiadomień Azure z tą usługą komunikacji.

## SKŁADNIA

### LinkExpanded (domyślne)
```
...
### Przykład 1. Interakcyjne podanie szczegółów centrum powiadomień
```powershell
...
Połączone centrum powiadomień umożliwia zasobowi ACS wysyłanie powiadomień dotyczących określonych zdarzeń.
...
Opis centrum powiadomień azure w celu utworzenia linku do usługi do komunikacji W celu skonstruowania zobacz sekcję NOTATKI dla właściwości LINKNOTIFICATIONHUBPARAMETERS I utwórz tabelę skrótów.
...
### Microsoft.Azure.PowerShell.Cmdlet.Communication.Models.Api200820Preview.ILinkNotificationHubParameters
...
LINKNOTIFICATIONHUBPARAMETERS: Opis centrum powiadomień platformy Azure w <ILinkNotificationHubParameters> celu połączenia z usługą komunikacji
  - `ConnectionString <String>`: parametrów połączenia dla centrum powiadomień
