...
## SYNOPSIS
Operacja aktualizacji istniejącej usługi CommunicationService.
...
### Przykład 1. Aktualizowanie istniejącego zasobu ACS w celu użycia tagów
```powershell
...
Dołącza podane tagi do określonego zasobu ACS.
