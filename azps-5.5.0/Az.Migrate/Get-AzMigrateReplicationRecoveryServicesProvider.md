...
### Przykład 1. Uzyskiwanie wszystkich dostawców w magazynie
```powershell
...
### -ProviderName
Nazwa dostawcy usług odzyskiwania
...
### Microsoft.Azure.PowerShell.Cmdlet.Migrate.Models.Api20180110.IRecoveryServicesProvider
