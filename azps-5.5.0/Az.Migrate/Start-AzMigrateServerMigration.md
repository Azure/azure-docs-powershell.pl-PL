...
### -InputObject
Określa serwer replikowania, dla którego należy zainicjować migrację.
...
### -TargetObjectID
Określa serwer, dla którego należy zainicjować migrację.
...
### -TurnOffSourceServer
Określa, czy po migracji serwer źródłowy powinien zostać wyłączony.
...
INPUTOBJECT: <IMigrationItem> Określa serwer replikowania, dla którego należy zainicjować migrację. Obiekt serwera można pobrać za pomocą Get-AzMigrateServerReplication cmdlet.
