...
### Przykład 1. Lista wszystkich kontenerów ochrony w magazynie i w materiałach
```powershell
...
### Microsoft.Azure.PowerShell.cmdlet.migrate.models.api20180110.IProtectionContainer
