...
## OPIS
Polecenie **cmdlet New-AzWebAppCertificate** tworzy certyfikat zarządzany usługi aplikacji Azure
## PRZYKŁADY
...
To polecenie umożliwia utworzenie certyfikatu zarządzanego usługi aplikacji dla danej aplikacji WebApp
...
To polecenie tworzy certyfikat zarządzany przez usługę aplikacji i powiąza się z danym slotem aplikacji WebApp.
...
To polecenie tworzy certyfikat zarządzany przez usługę aplikacji i powiąza się z tą aplikacją WebApp.

## PARAMETERS

### -AddBinding
Aby dodać utworzony certyfikat do aplikacji WebApp/slot.
...
### -HostName
Niestandardowe nazwy hostów skojarzone z aplikacją sieci Web/slotem.
...
### -SslState
Opcja stanu ssl.
Użyj albo "SniEnabled", albo "IpBasedEnabled".
Opcja domyślna to "SniEnabled".
