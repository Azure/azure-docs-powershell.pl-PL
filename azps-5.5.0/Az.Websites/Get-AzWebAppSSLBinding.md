...
Polecenia w tym przykładzie również uzyskają powiązania SSL dla aplikacji sieci Web ContosoWebApp; Jednak w tym przypadku zamiast nazwy aplikacji Web App i nazwy skojarzonej grupy zasobów jest używane odwołanie do obiektu.
