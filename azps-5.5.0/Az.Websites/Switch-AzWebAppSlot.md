...
## SYNOPSIS
Zamiana dwóch miejsc za pomocą aplikacji sieci Web
...
## OPIS
Przełącznik **AzWebAppSlot** przełącza dwa miejsca skojarzone z aplikacją Azure Web App.
...
To polecenie przełączy slot "sourceslot" na "destinationslot" w aplikacji Web App ContosoWebApp skojarzonej z grupą zasobów Default-Web-WestUS
