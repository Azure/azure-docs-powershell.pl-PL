...
Poniższy przykład tworzy ciąg połączenia o nazwie myConnectionString for Web App ContosoWebApp. To zastąpi wszystkie istniejące parametry połączenia dla aplikacji Sieci Web ContosoWebApp.
...
### - AlwaysOn
Upewnij się, że aplikacja sieci Web jest ładowana cały czas, a nie zwolniona po czasie bezczynności.
...
### -HostNames
Tablica ciągów nazw hostów aplikacji WebApp
