...
## SYNOPSIS
Tworzy obiekt reprezentujący ścieżkę magazynu platformy Azure, którą należy zmieścić w aplikacji sieci Web. Ma być używany jako parametr (-AzureStoragePath) do Set-AzWebApp i Set-AzWebAppSlot
...
### — Wpisz
Typ konta magazynu platformy Azure.
