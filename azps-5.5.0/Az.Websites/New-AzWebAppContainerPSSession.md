...
## SYNOPSIS
New-AzWebAppContainerPSSession utworzy nową zdalną sesję programu PowerShell do kontenera systemu Windows określonego w określonej witrynie lub miejscu i w danej grupie zasobów
...
Spowoduje to utworzenie nowej zdalnej sesji programu PowerShell w aplikacji kontenera systemu Windows ContosoASP i pokazanie procesów uruchomionych w kontenerze ContosoASP
