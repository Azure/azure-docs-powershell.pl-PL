...
Tworzy kopię zapasową określonej aplikacji ContosoWebApp, która znajduje się w grupie zasobów Default-Web-WestUS w https://storageaccount.file.core.windows.net

### Przykład 2

Polecenie New-AzWebAppBackup cmdlet tworzy kopię zapasową aplikacji Azure Web App. (wygenerowane automatycznie)
