...
Tworzy ustawienie kopii zapasowej bazy danych (parametrów połączenia) typu SqlAzure dla określonej aplikacji ContosoWebApp, która znajduje się w grupie zasobów Default-Web-WestUS.

### Przykład 2

Polecenie New-AzWebAppDatabaseBackupSetting cmdlet tworzy nowe ustawienie kopii zapasowej aplikacji Azure Web App. (wygenerowane automatycznie)
...
### -DatabaseType
Typ bazy danych (np. "SqlAzure" lub "MySql" )
