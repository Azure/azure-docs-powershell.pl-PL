...
## SYNOPSIS
Przekaż pliki dziennika usługi węzła obliczeniowego do kontenera magazynu platformy Azure.

## SKŁADNIA

### AzureBatchComputeNodeServiceLogUpload (domyślne)
```
...
## OPIS
To polecenie cmdlet zbiera pliki dziennika usługi wsadowej platformy Azure z węzłów obliczeniowych, jeśli występuje błąd i chcesz eskalować do obsługi platformy Azure. Pliki dziennika usługi wsadowej platformy Azure powinny być udostępniane pomocy technicznej platformy Azure w zakresie debugowania problemów z usługą wsadową. 
...
Przekaż dzienniki usługi węzła obliczeniowego napisane po 1 stycznia 2018 r. o północy, uzyskane z węzła obliczeniowego, z identyfikatorem puli, w której znajduje się węzeł obliczeniowy, oraz identyfikator węzła obliczeniowego.
...
Przekaż dzienniki usługi węzła obliczeniowego napisane po 1 stycznia 2018 r. (północ) i przed 10 stycznia 2018 r., które zostały uzyskane z węzła obliczeniowego z identyfikatorem puli, w której znajduje się węzeł obliczeniowy, oraz identyfikator węzła obliczeniowego.
...
Przekaż dzienniki usługi węzła obliczeniowego napisane 1 stycznia 2018 r. (północ) i przed 10 stycznia 2018 r., uzyskane z obiektu węzła obliczeniowego.
...
### -ComputeNode
Określa obiekt **PSComputeNode,** z którego są pobierane dzienniki usługi.
...
### -ContainerUrl
Adres URL kontenera do usługi Azure Storage.
...
### - EndTime
Czas zakończenia przekazywanego dziennika usługi (opcjonalnie).
...
### — StartTime
Godzina rozpoczęcia przekazywanego dziennika usługi.
