...
Pierwsze polecenie uzyskuje zadanie za pomocą polecenia **Get-AzBatchJob,** a następnie przechowuje je w $Job zmienną.
Drugie polecenie modyfikuje specyfikację priorytetu dla $Job obiektu.
Ostatnie polecenie aktualizuje usługę Batch, aby dopasować obiekt lokalny w $Job.
