...
Określa czas (w minutach), po upływie których rozmiar puli zostanie automatycznie dostosowany zgodnie z formułą Autoskalowanie.
...
### - ResizeTimeout
Określa przekłot na przydzielanie węzłów obliczeniowych do puli.
...
Zadanie startowe jest uruchamiane, gdy węzeł obliczeniowy dołącza do puli lub gdy węzeł obliczeniowy jest ponownie uruchamiany lub ponownie uruchamiany.
...
Określa docelową liczbę węzłów obliczeniowych o niskim priorytecie do przydzielenia do puli.
...
Określa zasady planowania zadań, takie jak typ ComputeNodeFillType.
