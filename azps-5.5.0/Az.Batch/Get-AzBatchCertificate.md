...
## OPIS
Polecenie **cmdlet Get-AzBatchCertificate** pobiera certyfikaty z konta usługi Azure Batch, które określa parametr *BatchContext.*
Aby uzyskać określony certyfikat, określ parametry *ThumbprintAlgorithm* i *Thumbprint.*
Określ parametr *filtru,* aby uzyskać certyfikaty zgodne z filtrem protokołu Open Data (OData).

## PRZYKŁADY

### Przykład 1. Uzyskiwanie certyfikatu za pomocą kciuka
```
...
To polecenie otrzymuje pojedynczy certyfikat z określonym znakiem usbprint.
Algorytm kciuka certyfikatu to sha1.

### Przykład 2. Uzyskiwanie odfiltrowanych certyfikatów
```
...
Jeśli określisz ten parametr, to polecenie cmdlet pobiera certyfikaty zgodne z filtrem.
...
### -MaxCount
Określa maksymalną liczbę certyfikatów do zwrócenia.
...
### - Thumbprint
Określa thumbprint certyfikatu, który otrzymuje to polecenie cmdlet.
