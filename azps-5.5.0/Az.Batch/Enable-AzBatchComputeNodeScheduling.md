...
Drugie polecenie używa następnie tego odwołania do obiektu i polecenia cmdlet **Enable-AzBatchComputeNodeScheduling** w celu połączenia się z pulą myPool i włączenia planowania zadań w programie tvm-1783593343_34-20151117t222514z.
...
Te polecenia umożliwiają planowanie zadań we wszystkich węzłach obliczeniowych dostępnych w puli pool06.
...
To odwołanie do obiektu jest przechowywane w zmiennej o nazwie $context.
Drugie polecenie w tym przykładzie używa następnie tego odwołania do obiektu i polecenia **Get-AzBatchComputeNode** w celu zwrócenia kolekcji wszystkich węzłów obliczeniowych znalezionych w aplikacji Pool06.
