...
## OPIS
Polecenie **cmdlet Get-AzBatchTask** pobiera zadania partii platformy Azure dla zadania wsadowego.
Określ zadanie za pomocą parametru *JobId* lub *parametru Job.*
Aby uzyskać jedno zadanie, określ *parametr Id.*
Możesz określić parametr *filtru,* aby uzyskać zadania zgodne z filtrem protokołu Open Data (OData).

## PRZYKŁADY

### Przykład 1. Uzyskiwanie zadania według identyfikatora
```
...
To polecenie pobiera zadanie o identyfikatorze Zadanie03 w obszarze Zadanie01.
Użyj Get-AzBatchAccountKey cmdlet, aby przypisać kontekst do zmiennej $Context danych.

### Przykład 2. Uzyskiwanie wszystkich ukończonych zadań z określonego zadania
```
...
To polecenie pobiera wykonane zadania z zadania o identyfikatorze Zadanie02.
...
### — Rozwiń
Określa klauzulę rozwijania danych OData.
...
Jeśli filtr nie zostanie określony, to polecenie cmdlet zwróci wszystkie zadania dla konta lub zadania Batch.
...
### - JobId
Określa identyfikator zadania zawierającego zadania, które otrzymuje to polecenie cmdlet.
