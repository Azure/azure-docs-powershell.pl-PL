...
## OPIS
Polecenie **cmdlet Remove-AzBatchPool** usuwa określoną pulę partii platformy Azure.
Zostanie wyświetlony monit o potwierdzenie, chyba że używasz *parametru Force.*
...
To polecenie usuwa pulę o identyfikatorze MyPool.
Przed rozpoczęciem operacji usuwania użytkownik jest monitowany o potwierdzenie.

### Przykład 2. Usuwanie wszystkich pul partii według wymuszania
```
PS C:\>Get-AzBatchPool -BatchContext $Context | Remove-AzBatchPool -Force -BatchContext $Context
```

To polecenie usuwa wszystkie pule wsadowe.
Parametr *Force jest* wyświetlany, dlatego monit o potwierdzenie jest pomijany.
...
### — Identyfikator
Określa identyfikator puli do usunięcia.
