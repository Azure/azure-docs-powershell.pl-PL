...
## OPIS
Polecenie **cmdlet New-AzBatchApplicationPackage** tworzy pakiet aplikacji na koncie usługi Azure Batch.
...
To polecenie tworzy i aktywuje wersję 1.0 aplikacji Litware oraz przekaże zawartość litware.1.0.zip jako zawartość pakietu aplikacji.

## PARAMETERS

### -AccountName
Określa nazwę konta usługi Batch, do którego to polecenie cmdlet dodaje pakiet aplikacji.
...
### - ActivateOnly
Wskazuje, że to polecenie cmdlet aktywuje pakiet aplikacji, który został już przekazany.
...
### - FilePath
Określa plik do przesłania jako plik binarny pakietu aplikacji.
