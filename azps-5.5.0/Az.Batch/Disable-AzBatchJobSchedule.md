...
## OPIS
Polecenie **cmdlet Disable-AzBatchJobSchedule** wyłącza harmonogram zadań partii platformy Azure.
Jeśli wyłączysz harmonogram, zadania nie będą tworzone zgodnie z tym harmonogramem.
Wyłączony harmonogram można włączyć później.
...
To polecenie wyłącza harmonogram zadań z identyfikatorem Harmonogram zadań17.
...
### — Id
Określa identyfikator harmonogramu zadań, który to polecenie cmdlet wyłącza.
