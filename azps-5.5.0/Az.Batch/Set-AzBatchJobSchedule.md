...
## OPIS
Polecenie **cmdlet Set-AzBatchJobSchedule** ustawia harmonogram zadań w usłudze wsadowej platformy Azure.
...
Pierwsze polecenie otrzymuje zadanie za pomocą polecenia **Get-AzBatchJobSchedule,** a następnie zapisuje je w $JobSchedule danych.
Drugie polecenie modyfikuje interwał cyklu `$JobSchedule.Schedule` obiektu.
Ostatnie polecenie aktualizuje usługę Batch tak, aby dopasowała się do obiektu lokalnego w $JobSchedule.
...
### — Harmonogram zadań
Określa **obiekt PSCloudJobSchedule** reprezentujący harmonogram zadań.
