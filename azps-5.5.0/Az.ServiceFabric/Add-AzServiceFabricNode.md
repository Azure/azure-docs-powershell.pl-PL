...
## OPIS
Użyj **funkcji Add-AzServiceFabricNode,** aby dodać węzły do określonego typu węzła. Wystarczy określić liczbę węzłów, które chcesz dodać do typu węzła.
...
To polecenie spowoduje dodanie 2 węzłów do typu węzła "n1".
