...
Należy zachować ostrożność, ponieważ może to spowodować utratę danych, jeśli w węzłach są uruchomione obciążenia pracą o stanie, lub jeśli po upływie węzłów nasadowych nie ma wystarczającej ilości węzłów inicjałów.
