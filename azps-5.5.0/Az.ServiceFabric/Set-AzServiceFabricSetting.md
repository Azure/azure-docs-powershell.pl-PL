...
## OPIS
Użyj **ustawienia Set-AzServiceFabricSetting,** aby dodać lub zaktualizować ustawienia usługi Service Fabric w klastrze.
...
To polecenie ustawi wartość "MaxFileOperationTimeout" na "5000" w sekcji "NazewnictwoService".
...
To polecenie wyzwoli uaktualnienie w celu ustawienia wielu elementów szkieletowych przy użyciu parametru SettingsSectionDescription.
...
### - Parametr
Nazwa parametru ustawienia materiału
...
### — Sekcja
Nazwa sekcji ustawienia materiału
...
### — Wartość
Wartość parametru ustawienia materiału
