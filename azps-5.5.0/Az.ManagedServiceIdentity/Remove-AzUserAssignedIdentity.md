...
## SYNOPSIS
Usuwa tożsamość przypisaną przez użytkownika.

## SKŁADNIA

### ResourceGroupAndNameParameterSet (domyślne)
```
...
## OPIS
Wartość **Remove-AzUserAssignedIdentity** usuwa określoną tożsamość przypisaną przez użytkownika.
...
W tym przykładzie polecenie cmdlet usuwa identyfikator **tożsamości 1** w grupie zasobów **PSRG.**
True (Prawda)
...
### -ResourceId
Identyfikator zasobu tożsamości.
