...
## SYNOPSIS
Aktualizuje zasady migawki usługi Azure NetApp Files (ANF) na opcjonalne modyfikatory.
...
To polecenie zmienia zasady tworzenia kopii zapasowej ANF "MySnapshotPolicy", tak aby mieć podaną godzinową kopię zapasową.
...
### - Harmonogram dzienny
Tablica z hasztagami reprezentująca dzienny harmonogram
...
### -HourlySchedule
Tablica z hasztagami reprezentująca harmonogram godzinowy
...
### -MonthlySchedule
Tablica z hasztagami reprezentująca harmonogram montly
...
### -ResourceId
Identyfikator zasobu zasad migawki ANF
