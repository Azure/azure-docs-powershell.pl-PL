...
## SYNOPSIS
Aktualizuje konto usługi Azure NetApp Files (ANF) zgodnie z dostępnymi opcjonalnymi modyfikatorami.
...
## OPIS
Polecenie **cmdlet Update-AzNetAppFilesAccount** modyfikuje konto ANF.

## PRZYKŁADY

### Przykład 1. Aktualizacja konta ANF
```
...
To polecenie wykonuje aktualizację na danym koncie, modyfikując tagi do podanych.
