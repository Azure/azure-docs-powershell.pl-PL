...
## SYNOPSIS
Usuwa konfigurację usługi Azure NetApp Files (ANF) w usłudze Active Directory.
...
## OPIS
Polecenie **cmdlet Remove-AzNetAppFilesActiveDirectory** usuwa konfigurację usługi Active Directory ANF.
...
To polecenie usuwa nową konfigurację usługi Active Directory ANF o nazwie "MyADName".
