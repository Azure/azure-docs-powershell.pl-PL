...
## OPIS
Polecenie **cmdlet Get-AzNetAppFilesActiveDirectory** pobiera szczegółowe informacje o konfiguracji usługi Active Directory dla kont ANF.
...
To polecenie pobiera konfigurację usługi AD o nazwie MyADConfigName dla konta Azure NetApp Files (ANF) o nazwie MyAnfAccount.
