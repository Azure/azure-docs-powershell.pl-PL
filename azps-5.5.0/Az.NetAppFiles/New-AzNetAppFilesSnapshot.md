...
## SYNOPSIS
Tworzy nową migawkę programu Azure NetApp Files (ANF).
...
## OPIS
Polecenie **cmdlet New-AzNetAppFilesSnapshot** tworzy migawkę ANF.
...
To polecenie tworzy nową migawkę ANF "MyAnfSnapshot" w ramach woluminu "MyAnfVolume".
