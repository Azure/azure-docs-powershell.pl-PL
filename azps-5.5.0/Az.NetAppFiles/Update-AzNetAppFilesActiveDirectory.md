...
## SYNOPSIS
Aktualizuje konfigurację usługi Active Directory (ANF, Azure NetApp Files) na opcjonalne modyfikatory.
...
To polecenie wykonuje aktualizację danej konfiguracji usługi Active Directory, modyfikując nazwę użytkownika na podaną nazwę użytkownika.
...
### — Dns
Rozdzielona przecinkami lista adresów IP serwera DNS (tylko IPv4) dla domeny usługi Active Directory
...
Gdy protokół LDAP przez SSL/TLS jest włączony, klient LDAP musi mieć zakodowany certyfikat głównego urzędu certyfikacji usługi Active Directory z podpisem własnym, ten parametr opcjonalny jest używany tylko w przypadku dwóch protokołów z woluminami mapowania użytkowników LDAP.
...
### -SmbServerName
Nazwa serwera SMB firmy NetBIOS.
