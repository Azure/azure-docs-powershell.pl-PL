...
## SYNOPSIS
Pobiera szczegółowe informacje o migawki plików ANF (Azure NetApp Files).
...
## OPIS
Polecenie **cmdlet Get-AzNetAppFilesSnapshot** pobiera szczegóły migawki ANF.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie migawki ANF
```
...
To polecenie pobiera migawkę o nazwie MyAnfSnapshot z poziomu woluminu "MyAnfVolume".
...
### -ResourceId
Identyfikator zasobu migawki ANF
...
### — VolumeObject
Obiekt głośności zawierający migawkę do zwrócenia
