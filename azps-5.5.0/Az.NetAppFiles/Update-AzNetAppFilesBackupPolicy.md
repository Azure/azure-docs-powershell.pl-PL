...
## SYNOPSIS
Aktualizuje zasady kopii zapasowej usługi Azure NetApp Files (ANF) na opcjonalne modyfikatory.
...
## OPIS
Polecenie **cmdlet Update-AzNetAppFilesBackupPolicy** modyfikuje zasady kopii zapasowej ANF.
...
To polecenie zmienia zasady kopii zapasowej ANF "MyBackupPolicy", tak aby mieć podaną politykę DailyBackupsToKeep.
...
### -AccountObject
Obiekt Account zawierający zasady kopii zapasowej do zaktualizowania
