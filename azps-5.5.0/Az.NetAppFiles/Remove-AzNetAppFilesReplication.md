...
## SYNOPSIS
Usuwanie/usuwanie połączenia replikacji w woluminie docelowym i wysyłanie zwolnienia do replikacji źródła
...
To polecenie usuwa połączenie replikacji ANF dla woluminu "MyDestinationAnfVolume".
...
### -InputObject
Głośność miejsca docelowego ANF z replikacją do usunięcia
...
### -PassThru
Zwracanie, czy określona replikacja ANF została pomyślnie usunięta
