...
## SYNOPSIS
Usuwa pulę plików Azure NetApp Files (ANF).
...
## OPIS
Polecenie **cmdlet Remove-AzNetAppFilesPool** usuwa pulę ANF.
...
To polecenie usuwa pulę ANF "MyAnfPool".
...
### -AccountObject
Obiekt konta zawierający pulę do usunięcia
...
### -PassThru
Zwracanie, czy określona pula została pomyślnie usunięta
