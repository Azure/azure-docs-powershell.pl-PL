...
## SYNOPSIS
Tworzy nowe zasady migawki plików ANF (Azure NetApp Files) dla konta ANF.
...
## OPIS
Polecenie **cmdlet New-AzNetAppFilesActiveDirectory** tworzy nowe zasady migawki dla konta ANF.
...
To polecenie tworzy nowe zasady migawki ANF dla konta ANF o nazwie konto "MyAccount".
