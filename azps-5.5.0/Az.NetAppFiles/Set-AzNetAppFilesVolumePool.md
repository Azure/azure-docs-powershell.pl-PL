...
## SYNOPSIS
Zmień pulę dla liczby plików AZURE NetApp (ANF).
...
To zmieni pulę woluminu MyVolume na pulę o identyfikatorze 7d6e4069-6c78-6c61-7bf6-c60968e45fbf
...
### -InputObject
Obiekt głośności do przeniesienia
...
### -NewPoolResourceId
ZasóbId puli pojemności, do która ma być przesunana.
UUID w wersji 4 używanej do identyfikowania puli
...
### - PoolObject
Obiekt puli zawierający wielkość
