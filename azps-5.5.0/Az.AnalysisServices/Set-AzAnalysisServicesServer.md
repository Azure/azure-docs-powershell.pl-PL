...
## SYNOPSIS
Modyfikuje wystąpienie serwera usług Analysis Services
...
## OPIS
Polecenie Set-AzAnalysisServicesServer modyfikuje wystąpienie serwera usług Analysis Services
...
Modyfikuje serwer o nazwie serwer testowy w grupie testowej grupy zasobów, aby ustawić tagi jako klucz1:wartość1 i wartość2:wartość2, a administrator do testuser1@contoso.com

## PARAMETERS

### — Administrator
Ciąg reprezentujący rozdzieloną przecinkami listę użytkowników lub grup, które mają zostać ustawione jako administratorzy na serwerze.
Użytkownikom lub grupom należy określić format UPN, user@contoso.com np. groups@contoso.com
...
### -DisableBackup
Przełącznik, aby wyłączyć zapasowy kontener obiektów blob.
Aby ponownie włączyć zapasowy kontener obiektów blob, podaj zapasowy kontener obiektów blob Uri jako -BackupBlobContainerUri.
...
### -DisasssociateGateway
Disasssociate Gateway resource from an Analysis server
...
### -PassThru
Jeśli operacja zostanie pomyślnie ukończona, zostaną zwrócone szczegóły usuniętego serwera.
