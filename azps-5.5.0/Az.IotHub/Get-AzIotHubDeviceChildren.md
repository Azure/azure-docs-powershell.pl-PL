...
## OPIS
Wyświetlanie wszystkich przypisanych urządzeń niebędące krawędziami jako rozdzielonych przecinkami listy wszystkich urządzeń brzegowych lub określonych urządzeń.
...
Pokaż wszystkie przypisane urządzenia, które nie mają brzegów, jako listę rozdzielaną przecinkami.
...
Pokaż wszystkie przypisane urządzenia nie edge jako rozdzieloną przecinkami listę wszystkich urządzeń brzegowych.
...
### Microsoft.Azure.Commands.Management.IotHub.Models.PSDdyseksjadowa

### Microsoft.Azure.Commands.Management.IotHub.Models.PSDevices Jednakowy[]
