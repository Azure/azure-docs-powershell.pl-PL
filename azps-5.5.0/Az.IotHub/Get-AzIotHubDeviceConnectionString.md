...
## OPIS
Lista parametrów połączenia wszystkich urządzeń lub docelowego urządzenia IoT zawartego w centrum Azure IoT Hub.
...
Pokazywanie wszystkich parametrów połączenia urządzeń w centrum Iot.
...
Uzyskaj dodatkowe parametrów połączenia urządzenia IoT.
...
### -KeyType
Typ klucza zasad dostępu udostępnionego dla uwierzytelniania.
