...
## OPIS
Aktualizowanie określonych właściwości wdrożenia programu IoT Edge.
...
Zaktualizuj metryki i etykiety wdrożenia IoT Edge.
...
### — Wymuszanie
Pozwala na zamienianie obiektu wdrożenia, nawet jeśli został zaktualizowany od czasu ostatniego pobrania.
...
### — Metryka
Kolekcja zapytań dla definicji wdrażania IoT Edge.
