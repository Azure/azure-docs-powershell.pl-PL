...
## OPIS
Tworzy grupę klienta w witrynie Eventhub skojarzoną z określoną usługą IotHub.

## PRZYKŁADY

### Przykład 1. Dodawanie grupy konsumentów do aplikacji Eventhub telemetrii
```
...
Dodaje nową grupę konsumentów o nazwie "myconsumergroup" do aplikacji Eventhub na wypadek zdarzeń telemetrii w aplikacji iothub o nazwie "myiothub"
...
Nazwa grupy konsumenckiej aplikacji EventHub, którą chcesz dodać.
