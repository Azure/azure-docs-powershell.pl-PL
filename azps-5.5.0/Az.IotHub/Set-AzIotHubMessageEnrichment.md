...
Aktualizuje wartość wzbogacenia o wartość "updatedValue" dla klucza "newKey".
Aby uzyskać szczegółowe objaśnienie wzbogacania wiadomości w centrum Azure IoT Hub, zobacz https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
...
Aktualizuje punkt końcowy wzbogacenia o "endpoint1, endpoint2, endpoint3" dla klucza "newKey".
Aby uzyskać szczegółowe objaśnienie wzbogacania wiadomości w centrum Azure IoT Hub, zobacz https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
