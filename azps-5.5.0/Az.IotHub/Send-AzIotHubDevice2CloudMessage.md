...
## OPIS
To polecenie obsługuje wysyłanie wiadomości z właściwościami aplikacji i systemu.
...
Wysyłanie wiadomości urządzenia do chmury przy użyciu domyślnego typu transportu.
...
Wysyłanie wiadomości z urządzenia mqtt do chmury.
