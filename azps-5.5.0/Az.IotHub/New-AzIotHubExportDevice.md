...
## OPIS
Tworzy nowe zadanie eksportowania urządzeń dla usługi IotHub.
Spowoduje to wyeksportowanie wszystkich urządzeń do określonego kontenera. Zobacz poniższy artykuł na temat sposobu generowania URI SAS.
https://docs.microsoft.com/azure/iot-hub/iot-hub-bulk-identity-mgmt#get-the-container-sas-uri .

## PRZYKŁADY

### Przykład 1. Problem z żądaniem urządzenia eksportu.
```
...
Tworzy nowe żądanie urządzenia eksportu dla aplikacji IotHub "myiothub" z wyjątkiem kluczy.
...
### - ExcludeKeys
Umożliwia eksportowanie urządzeń bez kluczy.
