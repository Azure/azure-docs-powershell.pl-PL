...
## OPIS
Polecenie **cmdlet Invoke-AzSynapseSparkStatement** wywołuje instrukcja Synapse Analytics Spark.
...
Te polecenia uruchom sesję przebiegu w trakcie, a następnie wywołaj w tekście instrukcja Przebiegu w przebiegu w potoku.
...
Te polecenia uruchom sesję przebiegu w przebiegu w trakcie, a następnie wywołaj w tekście instrukcja Spark.
...
Te polecenia uruchamiają sesję przebiegu w trakcie, a następnie wywołują instrukcje przebiegu w przebiegu w pliku.
