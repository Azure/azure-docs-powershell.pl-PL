...
## OPIS
Polecenie Remove-AzSynapseSqlPoolSensitivityClassification cmdlet usuwa typy informacji i etykiety wrażliwości kolumn w puli sql.

## PRZYKŁADY

### Przykład 1. Usunięcie typu informacji i etykiety wrażliwości kolumny w puli sql Synapse Azure.
```powershell
...
### Przykład 2. Usuwanie bieżących typów informacji i etykiet wrażliwości kolumn w puli języka SQL Azure Synapse przy użyciu połączenia rurowego.
```powershell
...
### Przykład 3. Usuwanie typu informacji i etykiety wrażliwości kolumny w puli sql Synapse Azure przy użyciu połączenia rurowego.
```powershell
