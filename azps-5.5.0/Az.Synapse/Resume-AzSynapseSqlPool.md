...
### ResumeByNameParameterSet (domyślne)
```
...
## OPIS
Polecenie **cmdlet Resume-AzSynapseSqlPool** wznawia pulę sql usługi Azure Synapse Analytics.
...
To polecenie wznawia zawieszoną pulę sql usługi Azure Synapse Analytics.
