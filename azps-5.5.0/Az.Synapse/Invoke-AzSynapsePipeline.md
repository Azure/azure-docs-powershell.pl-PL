...
## OPIS
Polecenie **Invoke-AzSynapsePipeline** uruchamia uruchomienie w określonym potoku i zwraca identyfikator tego uruchomienia. Ten identyfikator GUID może zostać przekazany do użytkownika **Get-AzSynapsePipelineRun** lub **Get-AzSynapseActivityRun,** aby uzyskać szczegółowe informacje na temat tego uruchomienia.
