...
### NewByWorkspaceNameAndNameParameterSet (Domyślne)
```
...
## OPIS
Polecenie **cmdlet New-AzSynapseRoleAssignment** tworzy przypisanie roli usługi Azure Synapse Analytics.
...
To polecenie przypisuje nazwę ContosoRole użytkownikowi, którego główna nazwa to ContosoName.
...
To polecenie przypisuje użytkownikowi ContosoRole, którego główna nazwa to ContosoName za pośrednictwem potoku.
