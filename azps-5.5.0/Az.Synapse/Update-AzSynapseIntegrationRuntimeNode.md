...
## OPIS
Polecenie **cmdlet Update-AzSynapseIntegrationRuntimeNode** aktualizuje właściwości węzła środowiska uruchomieniowego integracji samoobsługowej w obszarze roboczym. Obecnie obsługuje tylko aktualizowanie "ConcurrentJobsLimit".
...
Polecenie cmdlet aktualizuje "ConcurrentJobsLimit" na 3 dla węzła "Node_1" w środowisku integracji samoobsługowej "test-selfhost-ir".

## PARAMETERS

### -ConcurrentJobsLimit
Liczba jednoczesnych zadań dozwolonych do uruchamiania w węźle środowiska uruchomieniowego integracji.
