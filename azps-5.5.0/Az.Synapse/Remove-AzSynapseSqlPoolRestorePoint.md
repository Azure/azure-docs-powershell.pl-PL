...
## OPIS
Polecenie cmdlet **Remove-AzSynapseSqlPoolRestorePoint** trwale usuwa punkt przywracania puli sql usługi Azure Synapse Analytics.
...
To polecenie usuwa punkt przywracania puli sql usługi Azure Synapse Analytics z potoku.
...
### -InputObject
Obiekt wejściowy czasu przywracania puli SQL (czas tworzenia punktów), który zwykle przechodził przez potok.
...
Nazwa daty utworzenia punktu przywracania języka SQL Synapse.
