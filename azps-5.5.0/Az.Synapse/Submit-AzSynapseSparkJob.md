...
### RunSparkJobParameterSetName (domyślna)
```
...
## OPIS
Polecenie cmdlet **Submit-AzSynapseSparkJob** przesyła zadanie analizy Synapse Analytics Spark.
...
To polecenie przesyła zadanie analizy Synapse Analytics Spark.
...
To polecenie przesyła zadanie .NET analizy Synapse Analytics.
...
To polecenie przesyła zadanie aplikacji Synapse Analytics PySpark.

## PARAMETERS

### -CommandLineArgument
Argumenty opcjonalne dla zadania. np. "-iteracja 10000 --limit czasu 20s"
...
### — Konfiguracja
Właściwości konfiguracji przebiegu w przebiegu w sieci.
...
### -ExecutorCount
Liczba executorów, którzy mają zostać przydzieleni w określonej puli przebiegu w czasie dla zadania.
...
### -MainClassName
W pełni kwalifikowany identyfikator lub główna klasa, która znajduje się w pliku definicji głównej.
Wymagane dla zadania spark i .NET Spark.
np. "org.org.spark.examples.SparkPi"
...
### -MainDefinitionFile
Główny plik używany w zadaniu.
np. " abfss://filesystem@account.dfs.core.windows.net/mySpark.jar "
...
### — Nazwa
Nazwa zadania przebiegu w przebiegu w imieniu użytkownika.
...
### -ReferenceFile
Dodatkowe pliki używane w celach referencyjnych w głównym pliku definicji. Lista URI magazynu rozdzielana przecinkami. np. " abfss://filesystem@account.dfs.core.windows.net/file1.txt , abfss://filesystem@account.dfs.core.windows.net/result/ "
