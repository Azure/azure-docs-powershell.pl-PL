...
# Moduł Az.Synapse
## Opis
Tematy w tej sekcji dokumentuj polecenia cmdlet programu Azure PowerShell dla usługi Azure Synapse Analytics.
...
Eksportuje podręczniki.

### [Get-AzSynapseActivityRun](Get-AzSynapseActivityRun.md)
Pobiera informacje o działaniach uruchamianych dla uruchomienia potoku.
...
Pobiera zaawansowane ustawienia ochrony przed zagrożeniami dla obszaru roboczego.

### [Get-AzSynapseSqlAuditSetting](Get-AzSynapseSqlAuditSetting.md)
Pobiera ustawienia inspekcji w obszarze roboczym analizy Azure Synapse Analytics.

### [Get-AzSynapseSqlDatabase](Get-AzSynapseSqlDatabase.md)
Ta funkcja jest dostępna w ograniczonym podglądzie i jest początkowo dostępna tylko dla niektórych subskrypcji. Pobiera bazę danych SQL Synapse Analytics.

### [Get-AzSynapseSqlPool](Get-AzSynapseSqlPool.md)
Pobiera pulę języka SQL Synapse Analytics.

### [Get-AzSynapseSqlPoolAdvancedThreatProtectionSetting](Get-AzSynapseSqlPoolAdvancedThreatProtectionSetting.md)
Pobiera zaawansowane ustawienia ochrony przed zagrożeniami dla puli SQL.
...
Pobiera odrębne punkty przywracania, z których można przywrócić pulę sql Synapse Analytics.

### [Get-AzSynapseSqlPoolSensitivityClassification](Get-AzSynapseSqlPoolSensitivityClassification.md)
Pobiera bieżące typy informacji i etykiety wrażliwości kolumn w puli sql.

### [Get-AzSynapseSqlPoolSensitivityRecommendation](Get-AzSynapseSqlPoolSensitivityRecommendation.md)
Pobiera zalecane typy informacji i etykiety wrażliwości kolumn w puli sql.
...
Pobiera ustawienia oceny luk w zabezpieczeniach puli sql.

### [Get-AzSynapseSqlVulnerabilityAssessmentSetting](Get-AzSynapseSqlVulnerabilityAssessmentSetting.md)
Pobiera ustawienia oceny luk w zabezpieczeniach obszaru roboczego.
...
Uzyskiwanie stanu subskrypcji wyzwalacza zdarzenia dla określonych zdarzeń usługi zewnętrznej.

### [Get-AzSynapseWorkspace](Get-AzSynapseWorkspace.md)
Pobiera obszar roboczy analizy Synapse.

### [Invoke-AzSynapseIntegrationRuntimeUpgrade](Invoke-AzSynapseIntegrationRuntimeUpgrade.md)
Uaktualnienie środowiska integracji samoobsługowej.

### [Invoke-AzsynapsePipeline](Invoke-AzSynapsePipeline.md)
Wywołuje potok, aby rozpocząć jego uruchamianie.

### [Invoke-AzSynapseSparkStatement](Invoke-AzSynapseSparkStatement.md)
Wywoływanie instrukcji Synapse Analytics Spark.
...
Generuj samodzielnie hostowany klucz środowiska uruchomieniowego integracji.

### [New-AzSynapseRoleAssignment](New-AzSynapseRoleAssignment.md)
Tworzy przypisanie roli Analizy Synapse.

### [New-AzSynapseSparkPool](New-AzSynapseSparkPool.md)
Tworzy pulę przebiegu w czasie analizy Synapse.

### [New-AzSynapseSqlDatabase](New-AzSynapseSqlDatabase.md)
Ta funkcja jest dostępna w ograniczonym podglądzie i jest początkowo dostępna tylko dla niektórych subskrypcji. Tworzy bazę danych SQL Synapse Analytics.

### [New-AzSynapseSqlPool](New-AzSynapseSqlPool.md)
Tworzy pulę SQL Synapse Analytics.
...
Tworzy obszar roboczy analizy Synapse.

### [Remove-AzSynapseDataFlow](Remove-AzSynapseDataFlow.md)
Usuwa przepływ danych z obszaru roboczego.

### [Remove-AzSynapseDataset](Remove-AzSynapseDataset.md)
Usuwa zestaw danych z obszaru roboczego.
...
Usuń węzeł o podanej nazwie w środowisku uruchomieniowym integracji.
...
Usuwa notes z obszaru roboczego.

### [Remove-AzSynapsePipeline](Remove-AzSynapsePipeline.md)
Usuwa potok z obszaru roboczego.
...
Usuwa pulę przebiegu w czasie analizy Synapse.

### [Remove-AzSynapseSqlActiveDirectoryAdministrator](Remove-AzSynapseSqlActiveDirectoryAdministrator.md)
Usuwa administratora usługi Azure AD dla obszaru roboczego analizy Synapse.

### [Remove-AzSynapseSqlDatabase](Remove-AzSynapseSqlDatabase.md)
Ta funkcja jest dostępna w ograniczonym podglądzie i jest początkowo dostępna tylko dla niektórych subskrypcji. Usuwa bazę danych Synapse Analytics SQL.

### [Remove-AzSynapseSqlPool](Remove-AzSynapseSqlPool.md)
Usuwa pulę języka SQL Synapse Analytics.

### [Remove-AzSynapseSqlPoolRestorePoint](Remove-AzSynapseSqlPoolRestorePoint.md)
Usuwa punkt przywracania puli języka SQL Synapse Analytics.

### [Remove-AzSynapseSqlPoolSensitivityClassification](Remove-AzSynapseSqlPoolSensitivityClassification.md)
Usuwa typy informacji i etykiety wrażliwości kolumn w puli sql.

### [Remove-AzSynapseTrigger](Remove-AzSynapseTrigger.md)
Usuwa wyzwalacz z obszaru roboczego.
...
Usuwa obszar roboczy analizy Synapse.

### [Reset-AzsynapseSparkSessionTimeout](Reset-AzSynapseSparkSessionTimeout.md)
Resetuje limit czasu sesji analizy Synapse Analytics.
...
Wznawia pulę języka SQL Synapse Analytics.

### [Set-AzSynapseDataFlow](Set-AzSynapseDataFlow.md)
Tworzy lub aktualizuje przepływ danych w obszarze roboczym.

### [Set-AzsynapseDataset](Set-AzSynapseDataset.md)
Tworzy lub aktualizuje zestaw danych w obszarze roboczym.
...
Tworzy potok w obszarze roboczym.
...
Zmiana ustawień inspekcji w obszarze roboczym analizy Azure Synapse Analytics.
...
Ustawia typy informacji i etykiety wrażliwości kolumn w puli sql.
...
Rozpoczyna sesję analizy Synapse Analytics.

### [Start-AzsynapseTrigger](Start-AzSynapseTrigger.md)
Uruchamia wyzwalacz w obszarze roboczym.

### [Stop-AzsynapsePipelineRun](Stop-AzSynapsePipelineRun.md)
Zatrzymuje uruchomienie potoku w obszarze roboczym.
...
Anulowanie instrukcji Synapse Analytics Spark.
...
Przesyła zadanie analizy Synapse Analytics Spark.

### [Suspend-AzSynapseSqlPool](Suspend-AzSynapseSqlPool.md)
Zawiesza pulę języka SQL Synapse Analytics.

### [Sync-AzSynapseIntegrationRuntimeCredential](Sync-AzSynapseIntegrationRuntimeCredential.md)
Synchronizuje poświadczenia między węzłami środowiska uruchomieniowego integracji.

### [Test-AzSynapseSparkPool](Test-AzSynapseSparkPool.md)
Sprawdza, czy istnieje pula przebiegu w czasie analizy Synapse.

### [Test-AzSynapseSqlDatabase](Test-AzSynapseSqlDatabase.md)
Ta funkcja jest dostępna w ograniczonym podglądzie i jest początkowo dostępna tylko dla niektórych subskrypcji. Sprawdza, czy istnieje baza danych Synapse Analytics SQL.
...
Sprawdza, czy istnieje obszar roboczy analizy Synapse.
...
Aktualizuje węzeł środowiska uruchomieniowego integracji samoobsługowej.
...
Aktualizuje zaawansowane ustawienia ochrony przed zagrożeniami w obszarze roboczym.

### [Update-AzSynapseSqlDatabase](Update-AzSynapseSqlDatabase.md)
Ta funkcja jest dostępna w ograniczonym podglądzie i jest początkowo dostępna tylko dla niektórych subskrypcji. Aktualizuje bazę danych Synapse Analytics SQL.

### [Update-AzSynapseSqlPool](Update-AzSynapseSqlPool.md)
Aktualizuje pulę języka SQL Synapse Analytics.

### [Update-AzSynapseSqlPoolAdvancedThreatProtectionSetting](Update-AzSynapseSqlPoolAdvancedThreatProtectionSetting.md)
Ustawia zaawansowane ustawienia ochrony przed zagrożeniami w puli SQL.

### [Update-AzSynapseSqlPoolVulnerabilityAssessmentSetting](Update-AzSynapseSqlPoolVulnerabilityAssessmentSetting.md)
Aktualizuje ustawienia oceny luk w zabezpieczeniach puli sql.

### [Update-AzSynapseSqlVulnerabilityAssessmentSetting](Update-AzSynapseSqlVulnerabilityAssessmentSetting.md)
Aktualizuje ustawienia oceny luk w zabezpieczeniach obszaru roboczego.

### [Update-AzSynapseWorkspace](Update-AzSynapseWorkspace.md)
Aktualizuje obszar roboczy analizy Synapse.

### [Wait-AzsynapseSparkJob](Wait-AzSynapseSparkJob.md)
Czeka na ukończenie zadania analizy Synapse Analytics.
