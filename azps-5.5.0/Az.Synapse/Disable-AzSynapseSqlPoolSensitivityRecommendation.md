...
### Przykład 1. Wyłącz zalecenia dotyczące wrażliwości dla danej kolumny w puli SQL Synapse azure.
```powershell
...
### Przykład 2. Wyłącz zalecenia dotyczące wrażliwości dla kolumn, które mają zalecenia wrażliwości w puli sql Synapse platformy Azure przy użyciu funkcji Piping.
```powershell
...
### Przykład 3. Wyłączanie rekomendacji wrażliwości dla danej kolumny w puli sql Synapse Azure przy użyciu funkcji Piping.
```powershell
