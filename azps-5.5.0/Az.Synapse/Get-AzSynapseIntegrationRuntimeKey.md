...
## SYNOPSIS
Pobiera klucze dla środowiska integracji z własnym hostem.
...
## OPIS
Polecenie **cmdlet Get-AzSynapseIntegrationRuntimeKey** pobiera klucze środowiska uruchomieniowego integracji. Klucze są używane do rejestrowania węzła środowiska uruchomieniowego integracji.
