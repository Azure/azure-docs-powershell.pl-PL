...
## OPIS
Polecenie **cmdlet Get-AzSynapseSqlPool** pobiera informacje o puli sql usługi Azure Synapse Analytics.
...
To polecenie pobiera wszystkie pule języka SQL w obszarze roboczym.
...
To polecenie pobiera pulę sql w obszarze roboczym ContosoWorkspace o nazwie ContosoSqlPool.
...
To polecenie pobiera wszystkie pule SQL w obszarze roboczym za pośrednictwem potoku.
...
To polecenie pobiera pulę SQL o określonym identyfikatorze zasobu.
...
### — Wersja
[Ta funkcja jest w ograniczonym podglądzie, początkowo dostępna tylko dla niektórych subskrypcji.] Wersja puli języka SQL Synapse. Na przykład 2 lub 3.
