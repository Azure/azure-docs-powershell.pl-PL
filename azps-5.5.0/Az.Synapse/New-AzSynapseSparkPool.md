...
### CreateByNameAndEnableAutoScaleParameterSet (Domyślne)
```
...
## OPIS
Polecenie **cmdlet New-AzSynapseSparkPool** tworzy pulę przebiegu w czasie usługi Azure Synapse Analytics.
...
To polecenie tworzy pulę przebiegu w czasie analizy Azure Synapse.
...
To polecenie tworzy pulę przebiegu w czasie analizy Synapse Azure z włączoną automatyczną skalą.
...
To polecenie tworzy pulę przebiegu w czasie analizy Azure Synapse Analytics za pośrednictwem potoku.
...
To polecenie tworzy pulę przebiegu w czasie analizy Synapse Azure z włączoną automatyczną skalą za pośrednictwem potoku.
