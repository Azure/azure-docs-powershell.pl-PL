...
## OPIS
Polecenie **cmdlet New-AzSynapseWorkspace** tworzy obszar roboczy usługi Azure Synapse Analytics.
...
To polecenie tworzy obszar roboczy analizy Synapse o nazwie ContosoWorkspace, który korzysta ze sklepu danych ContosoAdlGenStorage, w grupie zasobów o nazwie ContosoResourceGroup.
...
Domyślna nazwa konta magazynu usługi ADLS Gen2.
...
Domyślny system plików ADLS Gen2.
...
### — Lokalizacja
Region platformy Azure, w którym należy utworzyć zasób.
...
Nazwa zarządzanej przez zespół Synapse sieci wirtualnej dedykowanej dla obszaru roboczego programu Azure Synapse.
...
Poświadczenia administratora języka SQL.
