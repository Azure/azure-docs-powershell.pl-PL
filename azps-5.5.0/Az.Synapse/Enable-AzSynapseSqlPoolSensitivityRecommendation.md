...
## SYNOPSIS
Umożliwia wyświetlanie rekomendacji wrażliwości dotyczących kolumn (zalecenia są domyślnie włączone we wszystkich kolumnach) w puli SQL.
...
## OPIS
Polecenie Enable-AzSynapseSqlPoolSensitivityRecommendation cmdlet umożliwia wyświetlanie rekomendacji wrażliwości dotyczących kolumn w puli sql.
...
### Przykład 2. Włączanie rekomendacji wrażliwości dla danej kolumny Pula SQL Azure Synapse przy użyciu połączenia pipingowego.
```powershell
