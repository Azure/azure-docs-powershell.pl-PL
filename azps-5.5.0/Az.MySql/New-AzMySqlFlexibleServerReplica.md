...
MASTER: <IServerAutoGenerated> obiekt serwera źródłowego, na którym ma być tworzyć repliki.
  ...
  - `[InfrastructureEncryption <InfrastructureEncryptionEnum?>]`: Stan pokazujący, czy szyfrowanie infrastruktury włączone dla serwera.
