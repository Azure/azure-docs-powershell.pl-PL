...
### Przykład 2. Tworzenie nowej reguły zapory MySql przy użyciu ciągu -ClientIPAddress.
```powershell
...
Te polecenia cmdlet tworzą regułę zapory MySql przy użyciu clientIPAddress.

### Przykład 3. Tworzenie nowej reguły zapory MySql w celu zezwalania na wszystkie połączenia IP
```powershell
...
To polecenie cmdlet tworzy nową regułę zapory mysql, aby zezwolić na wszystkie ip.
