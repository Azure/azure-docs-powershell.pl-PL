...
### Przykład 1. Aktualizowanie reguły zapory MySql według nazwy
```powershell
...
To polecenie cmdlet aktualizuje regułę zapory mysql według nazwy.
...
Te polecenia cmdlet aktualizują regułę zapory MySql według tożsamości.

### Przykład 3. Aktualizowanie reguły zapory MySql przez -ClientIPAddress.
```powershell
PS C:\> $ID = "/subscriptions/<SubscriptionId>/resourceGroups/PowershellMySqlTest/providers/Microsoft.DBforMySQL/servers/mysql-test/firewallRules/rule"
...
Te polecenia cmdlet aktualizują regułę zapory MySql przez -ClientIPAddress.
