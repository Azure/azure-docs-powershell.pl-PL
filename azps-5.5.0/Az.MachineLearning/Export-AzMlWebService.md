...
## OPIS
Eksportuje obiekt definicji dla określonej usługi sieci Web jako ciąg sformatowany JSON.
Możesz od razu zwrócić ciąg lub zapisać go w pliku.
...
### -ToJsonString
Określa, że definicja zostanie wyeksportowana jako ciąg JSON.
...
### - WebService
Obiekt definicji usługi sieci Web do wyeksportowania.
