...
## OPIS
Tworzy właściwości regionalne usługi Azure Machine Learning dla istniejącej usługi sieci Web.

## PRZYKŁADY

### Przykład 1. Dodawanie nowych właściwości regionalnych dla Regionów Środkowych Stanów Zjednoczonych

```
Add-AzMlWebServiceRegionalProperty -ResourceGroupName "myresourcegroup" -Name "mywebservicename" -Region westcentralus
```

To przykładowe polecenie tworzy właściwość regionalną dla usługi sieci Web w regionie "Zachód Środkowe Stany Zjednoczone".
...
### — Region
Region, w którym mają być tworzyć właściwości usługi sieci Web.
