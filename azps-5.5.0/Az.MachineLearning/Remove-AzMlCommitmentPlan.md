...
## OPIS
Usuwa plan zobowiązania usługi Azure Machine Learning. Należy pamiętać, że nie można usuwać planów zobowiązania, które mają skojarzenia ze zobowiązaniami. Skojarzenia zobowiązania mogą być usuwane tylko przez ich zasób docelowy. Na przykład usunięcie usługi sieci Web Azure Machine Learning spowoduje usunięcie skojarzenia zobowiązania, które skojarzy usługę sieci Web z planem zobowiązania.
