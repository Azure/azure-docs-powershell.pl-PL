...
### Przykład 1. Usuwanie komunikacji równorzędnej w sieci VNET z danymibricks według nazwy
```powershell
PS C:\> Remove-AzDatabricksVNetPeering -WorkspaceName databricks-test01 -ResourceGroupName lucas-manual-test -Name vnetpeering-t01

```

To polecenie usuwa komunikacji równorzędnej w sieci VNET z danymibricks według nazwy

### Przykład 2. Usuwanie komunikacji równorzędnej w sieci VNET z przechyłki danych według obiektu
```powershell
PS C:\> Get-AzDatabricksVNetPeering -ResourceGroupName lucas-manual-test -WorkspaceName databricks-test01 -PeeringName MyPeering-test01 | Remove-AzDatabricksVNetPeering

```

To polecenie usuwa komunikacji równorzędnej w sieci VNET z danymibricks według obiektu
