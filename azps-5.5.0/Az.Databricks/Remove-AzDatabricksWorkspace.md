...
### Przykład 1. Usuwanie obszaru roboczego programu Databricks
```powershell
PS C:\> Remove-AzDatabricksWorkspace -ResourceGroupName testgroup -Name databricks-test
```

To polecenie powoduje usunięcie obszaru roboczego programu Databricks z grupy zasobów.

### Przykład 2. Usuwanie obszaru roboczego z obszaru roboczego danych według obiektu
```powershell
