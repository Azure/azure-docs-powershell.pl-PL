...
Jeśli flaga ma wartość True (Prawda), a funkcja allowGatewayTransit w zdalnej komunikacji równorzędnej również jest prawdziwa, do przesyłania w sieci wirtualnej będą używać bram zdalnej sieci wirtualnej.
