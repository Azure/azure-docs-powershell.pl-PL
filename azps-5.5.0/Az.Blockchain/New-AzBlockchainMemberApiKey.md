...
### Przykład 1. Generuj klucze interfejsu Api dla członka zespołu używającego nazwy
```powershell
...
To polecenie ponownie generuje klucze interfejsu Api dla członka zespołu korzystającego z nazwy, grupy zasobów.

### Przykład 2. Generuj klucze interfejsu Api dla członka zespołu korzystającego z idenity
```powershell
PS C:\> $keyPair = Get-AzBlockchainMemberApiKey -BlockchainMemberName myblockchainhlqc92 -ResourceGroupName bc-rg
...
To polecenie ponownie generuje klucze interfejsu Api dla użytkownika korzystającego z tożsamości.
