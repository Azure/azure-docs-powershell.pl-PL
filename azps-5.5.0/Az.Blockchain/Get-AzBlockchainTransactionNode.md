...
### Przykład 1. Lista węzłów transakcji dla członka zespołu
```powershell
...
To polecenie zawiera listę węzłów transakcji dla członka zespołu.

### Przykład 2. Uzyskiwanie węzła transakcji
```powershell
...
To polecenie pobiera węzeł transakcji.

### Przykład 3. Uzyskiwanie węzła transakcji
```powershell
...
### Microsoft.Azure.PowerShell.cmdlet.udziec.models.api20180601Preview.ITransactionNode
