...
## OPIS
Polecenie cmdlet **Unregister-AzAutomationScheduledRunbook** usuwa skojarzenie między podręcznikiem Azure Automation a harmonogramem.
Harmonogram nie uruchamia już podręcznika.

## PRZYKŁADY

### Przykład 1. Usunięcie skojarzenia między podręcznikiem uruchamiania a harmonogramem
```
...
To polecenie usuwa skojarzenie między podręcznikiem Runbk01 a harmonogramem o nazwie Runbk01Sched.
...
### -JobScheduleId
Określa identyfikator zaplanowanego podręcznika.
...
### -RunbookName
Określa nazwę podręcznika, który ma być kojarzony z harmonogramem przez to polecenie cmdlet.
...
### -ScheduleName
Określa nazwę harmonogramu, z którego to polecenie cmdlet powoduje skojarzenie podręcznika.
