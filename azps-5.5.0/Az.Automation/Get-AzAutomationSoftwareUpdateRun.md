...
## OPIS
Polecenie cmdlet Get-AzAutomationSoftwareUpdateRun listę uruchamianych aktualizacji oprogramowania. Ponieważ konfiguracja aktualizacji oprogramowania ma skojarzony harmonogram, harmonogram ten może być wyzwalany wiele razy. Po każdym wyzwoleniu harmonogramu zostanie utworzona aktualizacja. Uruchomienie aktualizacji to zagregowany wynik uruchomienia wszystkich maszyn. Aby uruchamiać określoną konfigurację aktualizacji oprogramowania, można użyć parametru SoftwareUpdateConfigurationName. Aby uzyskać określone uruchamia, musisz przekazać parametr nazwy. Lista może również mieć określony stan, jest uruchamiana pod określonym systemem operacyjnym lub jest uruchamiana po określonym czasie przez podanie odpowiedniego parametru.

## PRZYKŁADY

### Przykład 1
Ta przykładowa lista wszystkich aktualizacji jest uruchamiana przez określoną konfigurację aktualizacji oprogramowania.
...
### — Id
Identyfikator uruchomienia konfiguracji aktualizacji oprogramowania.
...
Uruchomienie było wyzwalane przez konfigurację aktualizacji oprogramowania.
...
Uruchomienie było wyzwalane przez nazwę konfiguracji aktualizacji oprogramowania.
...
### — StartTime
Minimalny czas rozpoczęcia uruchomienia.
