...
## OPIS
To polecenie cmdlet usunąło konfigurację aktualizacji oprogramowania azure Automation.

## PRZYKŁADY

### Przykład 1
W tym przykładzie pokazano, jak usunąć "MyUpdateConfiguration" z konta automatyzacji
...
### -PassThru
Funkcja PassThru zwraca obiekt reprezentujący element, z którym pracujesz. Domyślnie to polecenie cmdlet nie generuje żadnych danych wyjściowych.
