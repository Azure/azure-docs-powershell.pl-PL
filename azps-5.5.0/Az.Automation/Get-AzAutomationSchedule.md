...
## OPIS
Polecenie **cmdlet Get-AzAutomationSchedule** otrzymuje harmonogram azure automation.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie harmonogramu
```
PS C:\>Get-AzAutomationSchedule -AutomationAccountName "Contoso17" -Name "DailySchedule08" -ResourceGroupName "ResourceGroup01"
```

To polecenie pobiera harmonogram o nazwie DziennySchedule08.

## PARAMETERS

### -AutomationAccountName
Określa nazwę konta automatyzacji, dla którego to polecenie cmdlet pobierze harmonogram.
...
### — Nazwa
Określa nazwę harmonogramu, który otrzymuje to polecenie cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, dla której to polecenie cmdlet uzyskuje harmonogram.
