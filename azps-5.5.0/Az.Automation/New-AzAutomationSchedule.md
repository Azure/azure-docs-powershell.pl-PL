...
### Przykład 1. Tworzenie harmonogramu czasowego w czasie lokalnym
```
...
Pierwsze polecenie pobiera identyfikator strefy czasowej z systemu i przechowuje je w zmiennej $TimeZone czasowej.
Drugie polecenie tworzy harmonogram uruchamiany raz w bieżącej dacie o godzinie 23:00 w określonej strefie czasowej.
...
Pierwsze polecenie tworzy obiekt daty przy użyciu polecenia cmdlet **Get-Date,** a następnie zapisuje ten obiekt w $StartDate danych.
Określ czas, który w przyszłości wynosi co najmniej pięć minut.
Drugie polecenie tworzy obiekt daty przy użyciu polecenia cmdlet **Get-Date,** a następnie zapisuje ten obiekt w $EndDate danych.
To polecenie określa czas w przyszłości.
Ostatnie polecenie tworzy harmonogram dzienny o nazwie Harmonogram02, który rozpoczyna się w czasie przechowywanym w $StartDate i wygasa w czasie przechowywanym w $EndDate.
...
Pierwsze polecenie tworzy obiekt daty przy użyciu polecenia cmdlet **Get-Date,** a następnie zapisuje ten obiekt w $StartDate danych.
Drugie polecenie tworzy tablicę dni tygodnia zawierającą poniedziałek, wtorek, środę, czwartek i piątek.
Ostatnie polecenie tworzy harmonogram dzienny o nazwie Harmonogram03, który będzie uruchamiany od poniedziałku do piątku każdego tygodnia o 13:00. Harmonogram nigdy nie wygaśnie.

## PARAMETERS

### -AutomationAccountName
Określa nazwę konta automatyzacji, dla którego to polecenie cmdlet tworzy harmonogram.
...
### -DayOfWeekOccurrence
Określa wystąpienie tygodnia w miesiącu, w który jest uruchamiany harmonogram.
psdx_paramvalues
- 1
- 2
- 3
...
### -MonthInterval
Określa w miesiącu interwał dla harmonogramu.
...
### — OneTime
Określa, że polecenie cmdlet tworzy harmonogram jeden raz.
...
### — StartTime
Określa czas rozpoczęcia harmonogramu jako obiekt **DateTimeOffset.**
Możesz określić ciąg, który może zostać przekonwertowany na prawidłowy **dateTimeOffset.**
Jeśli parametr *TimeZone* jest określony, przesunięcie zostanie zignorowane i zostanie użyta określona strefa czasowa.
