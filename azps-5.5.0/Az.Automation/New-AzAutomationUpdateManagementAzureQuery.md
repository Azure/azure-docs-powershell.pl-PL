...
## SYNOPSIS
Tworzy obiekt azure Automation Software Update Configuration Azure Query.
...
## OPIS
Tworzy obiekt zapytań azure konfiguracji aktualizacji oprogramowania, który będzie używany do tworzenia konfiguracji aktualizacji oprogramowania, która będzie uruchamiana zgodnie z harmonogramem w celu zaktualizowania listy dynamicznie rozwiązywanych list maszyn wirtualnych platformy Azure.
...
### — Lokalizacja
Lista lokalizacji maszyn wirtualnych platformy Azure.
...
### — Tag
Tag dla maszyn wirtualnych platformy Azure.
