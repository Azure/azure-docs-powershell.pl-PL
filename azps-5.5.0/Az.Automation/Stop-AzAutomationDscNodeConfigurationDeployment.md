...
## SYNOPSIS
Zatrzymuje wdrożenie konfiguracji węzła dsc w automatyzacji. Powoduje jedynie zatrzymanie bieżącego zadania wdrażania, ale nie powoduje przypisania już przypisanych konfiguracji węzła.
