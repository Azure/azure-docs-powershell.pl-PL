...
## OPIS
Polecenie New-AzAutomationSourceControl tworzy konfigurację w celu połączenia konta usługi Azure Automation z moim poleceniem VSTS TFVC, VSTS Git lub GitHub.

## PRZYKŁADY

### Przykład 1
Utwórz konfigurację kontrolki źródła, aby połączyć moje konto usługi Azure Automation z moim projektem VSTS TFVC. Projekty TFVC nie mają gałęzi, dlatego parametr Branch nie jest określony.
...
### Przykład 2
Utwórz konfigurację kontrolki źródła, aby połączyć moje konto usługi Azure Automation z projektem VSTS Git.
...
### Przykład 3
Utwórz konfigurację kontrolki źródła, aby połączyć moje konto usługi Azure Automation z projektem GitHub.
...
### - AccessToken
Token dostępu kontrolki źródłowej.
...
### -DoNotPublishRunbook
Właściwość publishRunbook kontrolki źródła.
Jeśli jest ustawiony obiekt DoNotPublishRunbook, oznacza to, że podręczniki użytkownika zostaną zaimportowane jako "Wersja robocza".
...
### -EnableAutoSync
Właściwość autoSync kontrolki źródłowej.
...
### - FolderPath
Ścieżka folderu kontrolki źródłowej.
...
### -RepoUrl
Adres URL ponownego adresu url kontrolki źródłowej.
