...
## OPIS
Tworzy konfigurację aktualizacji oprogramowania uruchamianą zgodnie z harmonogramem w celu zaktualizowania listy komputerów. Komputery zawierają zarówno maszyny wirtualne azure, jak i komputery inne niż az.

## PRZYKŁADY

### Przykład 1
Tworzy konfigurację aktualizacji oprogramowania w celu instalowania krytycznych aktualizacji na dwóch maszynach wirtualnych platformy Windows Azure raz w sobotę o 9:00. W tym przykładzie czas trwania aktualizacji jest ustawiony na 2 godziny.
...
### — AzureQuery
Zapytanie azure grupy dynamicznej.
...
### -ExcludedKbNumber
Numery KB wykluczonych aktualizacji.
...
Uwzględniono klasyfikacje pakietów dla systemu Linux.
...
Dołączone maski pakietów dla systemu Linux.
...
Uwzględniono klasyfikacje usługi Windows Update.
...
### — Linux
Wskazuje, że konfiguracja aktualizacji oprogramowania skierowana na komputery z systemem operacyjnym Linux.
...
### -NonAzureQuery
Zapytanie grupy dynamicznej niezwiązywącej z platformą Azure.
...
### -PostTaskRunbookParameters
Parametr opublikuj zadanie.
...
### -PreTaskRunbookParameters
Parametr zadania wstępnego.
...
### - RebootOnly
Wskazuje, że konfiguracja aktualizacji oprogramowania spowoduje tylko ponowne uruchomienie komputera.
...
### — Planowanie
Zaplanuj obiekt używany do konfiguracji aktualizacji oprogramowania.
...
### — Windows
Wskazuje, że konfiguracja aktualizacji oprogramowania skierowana na komputery z systemem operacyjnym Windows.
