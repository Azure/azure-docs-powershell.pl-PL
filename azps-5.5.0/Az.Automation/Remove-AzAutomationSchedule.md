...
## OPIS
Polecenie **cmdlet Remove-AzAutomationSchedule** usuwa harmonogram z automatyzacji platformy Azure.

## PRZYKŁADY

### Przykład 1. Usuwanie harmonogramu
```
PS C:\>Remove-AzAutomationSchedule -AutomationAccountName "Contoso17" -Name "Schedule01" -ResourceGroupName "ResourceGroup01"
```

To polecenie usuwa harmonogram o nazwie Harmonogram01 w koncie automatyzacji Contoso17 w grupie zasobów ResourceGroup01.

## PARAMETERS

### -AutomationAccountName
Określa nazwę konta automatyzacji, dla którego to polecenie cmdlet usuwa harmonogram.
...
### — Nazwa
Określa nazwę harmonogramu usunięcia tego polecenia cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, dla której to polecenie cmdlet usuwa harmonogram.
