...
### Przykład 2. Usuwanie rozszerzenia za pośrednictwem potoku
```powershell
PS C:\> Get-AzConnectedMachineExtension -ResourceGroupName contoso-connected-machines -MachineName myMachine | Remove-AzConnectedMachineExtension

```

Usuwa wszystkie rozszerzenia na określonym komputerze.
...
### — Nazwa_komputera
Nazwa komputera, na którym rozszerzenie powinno zostać usunięte.
