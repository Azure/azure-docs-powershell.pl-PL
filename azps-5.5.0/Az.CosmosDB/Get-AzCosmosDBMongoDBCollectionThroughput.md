...
## SYNOPSIS
Pobiera właściwości przepływności Pliku ADB kolekcji MongoDB.
...
### -InputObject
Jeśli zostanie podany, polecenie cmdlet zwraca kolekcję o odpowiedniej wartości przepływności.
