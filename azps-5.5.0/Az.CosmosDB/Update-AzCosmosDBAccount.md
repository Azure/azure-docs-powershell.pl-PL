...
Automatyczna funkcja trybu failover spowoduje nowy region zapisu dla konta i zostanie wybrany na podstawie priorytetów trybu failover skonfigurowanych dla konta.
...
Umożliwia korzystanie z sieci wirtualnej na koncie bazy danych Db firmy Ws.
Zaakceptowane wartości: fałsz, prawda
...
### -MaxStalenessPrefix
W przypadku korzystania z spójności powiązanej nieaktualności ta wartość oznacza liczbę stale powiązanych żądań.
...
### -PublicNetworkAccess
Określa, czy dla tego serwera dozwolony jest dostęp do publicznego punktu końcowego. Możliwe wartości: "Włączone", "Wyłączone"
