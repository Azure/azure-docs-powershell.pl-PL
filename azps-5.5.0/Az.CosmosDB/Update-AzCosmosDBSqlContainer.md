...
## SYNOPSIS
Aktualizuje kontener sql dla firmy DossDB. Wykonuje operację poprawiania po stronie klienta, odczytując istniejący kontener.
...
### -UniqueKeyPolicy
Obiekt UniqueKeyPolicy typu Microsoft.Azure.Commands.PspsDB.PSSqlUniqueKeyPolicy.
