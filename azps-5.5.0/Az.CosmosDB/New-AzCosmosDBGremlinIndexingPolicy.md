...
## SYNOPSIS
Tworzy nowy obiekt ADB IndexingPolicy.
...
### - CompositePath
Tablica obiektów typu Microsoft.Azure.Commands.AlejaDB.PSCompositePath
...
### -ExcludedPath
Tablica ciągów zawierających ciągi excludedPath(Określa ścieżkę w dokumencie JSON w celu wykluczenia jej w usłudze Azure Gams DB).  .
...
### - IncludedPath
Tablica ciągów zawierających ciągi includedPath (Określa ścieżkę w dokumencie JSON, która ma zostać uwzględniona w elementach usługi Azure Gams DB).
...
Możliwe wartości: "Spójne", "Leniwe", "Brak"
...
### -SpatialSpec
Tablica obiektów typu Microsoft.Azure.Commands.Dosdb.PSSpatialSpec
...
### Microsoft.Azure.Commands.Dosdb.Models.PSIndexingPolicy
