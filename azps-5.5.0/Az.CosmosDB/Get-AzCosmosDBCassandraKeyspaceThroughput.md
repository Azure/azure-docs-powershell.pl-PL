...
## SYNOPSIS
Pobiera wartość przepływności klawiszy Cassandra.
...
## OPIS
Polecenie **cmdlet Get-AzCosmosDBCassandraKeyspaceThroughput** pobiera obiekt przepływności odpowiadający podanej klawiszowi Keyspace.
