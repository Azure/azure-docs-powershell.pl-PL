...
## SYNOPSIS
Aktualizuje kolekcję ZakonuDB MongoDB. Wykonuje operację poprawki po stronie klienta, odczytując istniejącą kolekcję.
...
TTL for Analytical Storage (Czas wygaśnięcia dla magazynu analitycznego).
