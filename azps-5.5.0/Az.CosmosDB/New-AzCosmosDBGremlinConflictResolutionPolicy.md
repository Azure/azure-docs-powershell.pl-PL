...
## SYNOPSIS
Tworzy nowy obiekt typu PSConflictResolutionPolicy. Może być przekazywana jako wartość parametru Set-AzCosmosDBGremlinGraph.
...
## OPIS
Obiekt odpowiadający interfejsowi API Gremlin conflictResolutionPolicy.
