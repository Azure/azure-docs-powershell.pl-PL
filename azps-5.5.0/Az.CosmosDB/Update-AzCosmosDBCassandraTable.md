...
## SYNOPSIS
Aktualizuje tabelę Cassandrydy Dosdb. Wykonuje operację poprawiania po stronie klienta, odczytując istniejącą tabelę.
...
TTL (Czas wygaśnięcia magazynu analitycznego).
...
### Microsoft.Azure.Commands.DoceńDB.Models.PSCassandraSchema
