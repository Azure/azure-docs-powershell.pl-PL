...
## SYNOPSIS
Pobiera bazę danych DoSDB MongoDB
...
## OPIS
Polecenie **cmdlet Get-AzCosmosDBMongoDBDatabase** pobiera bazę danych DosDB MongoDB.
...
Obiekt zasobu _rid, _ts, _etag właściwości.
