...
## SYNOPSIS
Tworzy nowy obiekt typu PSSqlConflictResolutionPolicy. Może być przekazywana jako wartość parametru Set-AzCosmosDBSqlContainer.
...
## OPIS
Obiekt odpowiadający obiektowi interfejsu API Sql ConflictResolutionPolicy.
