...
## SYNOPSIS
Tworzy nowy obiekt typu PSSpatialSpec. Może być przekazywana jako wartość parametru Set-AzCosmosDBGremlinIndexingPolicy.
...
## OPIS
Tworzy obiekt odpowiadający parametrowi SpatialSpec interfejsu API Gremlin.
...
### — Wpisz
Tablica ciągów z dopuszczalnymi wartościami: punkt, ciąg liniowy, wielokąt, wielopolon.
