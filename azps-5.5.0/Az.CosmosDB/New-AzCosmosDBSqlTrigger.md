...
## SYNOPSIS
Tworzy nowy wyzwalacz sql dla firmy ADB.
...
### -TriggerOperation
Operacja, z pomocą która jest skojarzona z wyzwalaczem.
Możliwe wartości: "Wszystko", "Utwórz", "Aktualizacja", "Usuń", "Zamień"
...
### -TriggerType
Typ wyzwalacza.
Możliwe wartości: "Przed", "Opublikuj"
...
### Microsoft.Azure.Commands.DoceńDB.Models.PSSqlContainerGetResults

## DANE WYJŚCIOWE

### Microsoft.Azure.Commands.DoceńDB.Models.PSSqlTriggerGetResults

### Microsoft.Azure.Commands.DoceńDB.Exceptions.ConflictingResourceException
