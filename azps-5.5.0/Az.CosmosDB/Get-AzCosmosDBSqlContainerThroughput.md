...
## SYNOPSIS
Pobiera ustawienia przepływności odpowiadające kontenerowi sql w formacie AADB.
...
## OPIS
Polecenie **cmdlet Get-AzCosmosDBSqlContainerThroughput** pobiera ustawienia przepływności odpowiadające kontenerowi sql Dla firmy ADB. 
