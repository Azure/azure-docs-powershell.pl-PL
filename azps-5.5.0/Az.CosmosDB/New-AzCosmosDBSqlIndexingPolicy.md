...
## SYNOPSIS
Tworzy nowy obiekt ADB Sql IndexingPolicy.
...
### - IncludedPath
Tablica ciągów zawierających ciągi includedPath (Określa ścieżkę w dokumencie JSON, która ma zostać uwzględniona w elementach usługi Azure Dokumencie DB).
