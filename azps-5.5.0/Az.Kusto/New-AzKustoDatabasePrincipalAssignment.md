...
### Przykład 1. Tworzenie dyrektora bazy danych klastrów Kusto
```powershell
...
Powyższe polecenie tworzy przypisanie podmiotu bazy danych klastrów Kusto
...
### -PrincipalId
Identyfikator dyrektora przypisany do podmiotu zabezpieczeń bazy danych.
...
### Microsoft.Azure.PowerShell.Cmdlet.Kusto.Models.Api20200918.IDatabasePrincipalAssignment
