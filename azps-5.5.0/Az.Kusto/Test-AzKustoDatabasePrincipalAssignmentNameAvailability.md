...
### Przykład 1. Sprawdzanie dostępności nazwy podmiotu zabezpieczeń bazy danych, która jest w użyciu
```powershell
...
Powyższe polecenie zwraca, czy istnieje w bazie danych "mykustodatabase" jednostki PrincipalAssignment o nazwie "myprincipal" z grupy "testnewkustocluster".

### Przykład 2. Sprawdzanie dostępności nazwy podmiotu zabezpieczeń bazy danych, która nie jest w użyciu
```powershell
...
### — Wpisz
Typ zasobu, Microsoft.Kusto/Clusters/Databases/principalAssignments.
