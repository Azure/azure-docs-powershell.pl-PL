...
### Przykład 1. Usuwanie istniejącego przypisania głównego grupowania Kusto według nazwy
```powershell
...
Powyższe polecenie usuwa przypisanie dyrektora o nazwie "kustoprincipal1" w klastrze Kusto "testnewkustocluster".
