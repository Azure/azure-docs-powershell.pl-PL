...
### Przykład 1. Lista wszystkich funkcji głównych grupowania Kusto
```powershell
...
Powyższe polecenie zawiera listę wszystkich funkcji principalAssignment w klastrze "testnewkustocluster".

### Przykład 2. Pobiera przypisanie podmiotu głównego grupowania Kusto według nazwy
```powershell
...
Powyższe polecenie zwraca wartość jednostki zabezpieczeń klastrów Kusto o nazwie "kustoprincipal1" w klastrze "testnewkustocluster".
