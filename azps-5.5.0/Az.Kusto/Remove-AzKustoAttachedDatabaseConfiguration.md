...
### Przykład 1. Usuwanie istniejącej konfiguracji AttachedDatabaseConfiguration według nazwy
```powershell
...
Powyższe polecenie usuwa bazę danych obserwowaną zdefiniowaną w konfiguracji AttachedDatabaseConfiguration "myfollowerconfiguration" z klastry "testnewkustoclusterf".
