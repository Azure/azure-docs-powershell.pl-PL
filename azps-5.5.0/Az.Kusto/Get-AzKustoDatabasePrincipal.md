...
### Przykład 1. Lista głównych użytkowników bazy danych danego klastra Kusto i bazy danych
```powershell
...
Powyższe polecenie zwraca listę głównych użytkowników bazy danych danego klastra Kusto i bazy danych.
