...
### Przykład 1. Lista kwalifikujących się jednostki SKU
```powershell
...
Powyższe polecenie wyświetla listę uprawnionych jednostki SKU.

### Przykład 2. Lista kwalifikujących się jednostki SKU dla określonego klastra
```powershell
...
Powyższe polecenie wyświetla listę kwalifikujących się jednostki SKU dla określonego klastra
...
### Microsoft.Azure.PowerShell.Cmdlet.Kusto.Models.Api20200918.IAzureResourceSku

### Microsoft.Azure.PowerShell.cmdlet.kusto.models.api20200918.iSkuDescription
