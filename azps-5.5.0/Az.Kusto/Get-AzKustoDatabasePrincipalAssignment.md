...
### Przykład 1. Lista wszystkich podpisów głównych w bazie danych według nazwy
```powershell
...
Powyższe polecenie zwraca wszystkie funkcje PrincipalAssignment w bazie danych "mykustodatabase" znalezionej w klastrze "testnewkustocluster".

### Przykład 2. Uzyskiwanie określonego przypisania Dyrektora w bazie danych według nazwy
```powershell
...
Powyższe polecenie zwraca wszystkie funkcje PrincipalAssignment o nazwie "kustoprincipal1" w bazie danych "mykustodatabase" w klastrze "testnewkustocluster".
