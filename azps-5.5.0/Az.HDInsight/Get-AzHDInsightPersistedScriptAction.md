...
## OPIS
Polecenie **cmdlet Get-AzHDInsightPersistedScriptAction** pobiera utrwalone akcje skryptów dla klastru usługi Azure HDInsight i wyświetla je w porządku chronologicznym lub zawiera szczegółowe informacje dotyczące określonej, utrwalonej akcji skryptu.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie utrwalonych akcji skryptu w klastrze
```
PS C:\>Get-AzHDInsightPersistedScriptAction -ClusterName "your-hadoop-001"
```

To polecenie jest zachowywane w ramach akcji skryptu w klastrze o nazwie Twoja-hadoop-001.
...
### — Nazwa
Określa nazwę akcji utrwalonego skryptu.
