...
## OPIS
Polecenie **cmdlet Get-AzHDInsightJobOutput** pobiera dane wyjściowe dziennika dla zadania z konta magazynu skojarzonego z klastrem usługi Azure HDInsight.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie danych wyjściowych dziennika dla zadania
```
PS C:\># Cluster info
...
To polecenie pobiera dane wyjściowe dziennika z klastra o nazwie Twoja-hadoop-001.
...
### - JobId
Określa identyfikator zadania, którego dane wyjściowe zostaną pobrane.
