...
## OPIS
Polecenie **cmdlet Get-AzHDInsightScriptActionHistory** pobiera historię akcji skryptów dla klastru usługi Azure HDInsight i wyświetla go w odwrotnej kolejności chronologicznej lub zawiera szczegóły wcześniej wykonanej akcji skryptu.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie historii wykonywania akcji skryptów dla klastra
```
PS C:\>Get-AzHDInsightScriptActionHistory -ClusterName "your-hadoop-001"
```

To polecenie pobiera historię akcji skryptów dla twojego-hadoop-001 klastra.
...
### -ScriptExecutionId
Określa identyfikator wykonywania wykonanej akcji skryptu.
