...
## SYNOPSIS
Dodaje bazę danych SQL, która ma pełnić funkcję metastore Oozie lub Gałąź do obiektu konfiguracji klastrów.
...
## OPIS
Polecenie cmdlet **Add-AzHDInsightMetastore** dodaje magazyn Metastore w umacie HDInsight utworzonym za pomocą polecenia cmdlet New-AzHDInsightClusterConfig Oozie.
...
To polecenie powoduje dodanie metastore bazy danych SQL do klastra o nazwie Twoja-hadoop-001.
...
### -DatabaseName
Określa bazę danych w wystąpieniu programu AzureSQL Server do użycia w tym metastore.
...
Dopuszczalne wartości to: JużMetastore lub OozieMetastore.
