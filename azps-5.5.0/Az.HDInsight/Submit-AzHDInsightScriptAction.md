...
Użyj *funkcji PersistOnSuccess,* aby akcja skryptu była uruchamiana za każdym razem, gdy klastr jest skalowany w górę, o ile akcja skryptu początkowo się powiedzie.
