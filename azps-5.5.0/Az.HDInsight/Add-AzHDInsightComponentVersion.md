...
## OPIS
Polecenie Add-AzHDInsightComponentVersion cmdlet dodaje wersję dla usługi uruchomionej w klastrze do obiektu konfiguracji usługi Azure HDInsight utworzonego za pomocą New-AzHDInsightClusterConfig cmdlet.

## PRZYKŁADY

### Przykład 1. Dodawanie wersji dla usługi Spark do obiektu konfiguracji klastrów.
```
...
To polecenie dodaje wersję programu Spark do klastrów USŁUGI HDInsight o nazwie "Twój-spark-001".
