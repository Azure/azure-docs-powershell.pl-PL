...
## SYNOPSIS
Ustawia konfigurację automatycznego skalowania klastrów usługi Azure HDInsight.
...
### Przykład 1. Ustawianie konfiguracji automatycznego skalowania na podstawie obciążenia klastrów HDInsight
```powershell
...
### -MinWorkerNodeCount
Pobiera lub ustawia minimalną liczbę pracowników w przypadku skalowania automatycznego opartego na ładowanych danych.
