...
## OPIS
Obróć klucz szyfrowania dysku określonego klastra usługi HDInsight. W przypadku tej operacji klaster musi mieć dostęp zarówno do bieżącego, jak i zamierzonego nowego klucza, w przeciwnym razie operacja obracania klucza nie powiedzie się.
...
[Szyfrowanie dysków zarządzane przez klienta](https://docs.microsoft.com/en-us/azure/hdinsight/disk-encryption)
