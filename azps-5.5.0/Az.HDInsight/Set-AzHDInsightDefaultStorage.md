...
## OPIS
Polecenie cmdlet **Set-AzHDInsightDefaultStorage** ustawia domyślne ustawienie konta magazynu w obiekcie konfiguracji grup usługi Azure HDInsight utworzonym za pomocą polecenia cmdlet New-AzHDInsightClusterConfig magazynu.

## PRZYKŁADY

### Przykład 1. Ustawianie domyślnego konta magazynu dla obiektu konfiguracji klastrów
```
...
To polecenie ustawia domyślne konto magazynu dla obiektu konfiguracji klastrów.
...
### -StorageAccountKey
Określa klucz konta dla domyślnego konta usługi Azure Storage, które będzie używać klastra HDInsight.
...
### -StorageAccountType
Pobiera lub ustawia typ domyślnego konta magazynu. Wartość domyślna to AzureStorage
