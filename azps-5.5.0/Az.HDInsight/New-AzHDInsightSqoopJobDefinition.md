...
## OPIS
Polecenie cmdlet **New-AzHDInsightSqoopJobDefinition** definiuje obiekt zadania Sqoop do użytku z klastrem usługi Azure HDInsight.

## PRZYKŁADY

### Przykład 1. Tworzenie definicji stanowiska sqoop
```
PS C:\># Cluster info
...
### -LibDir
Określa katalog biblioteki dla zadania Sqoop.
