...
## OPIS
Polecenie **cmdlet Remove-AzHDInsightClusterAutoscaleConfiguration** usuwa konfigurację skalowania automatycznego klastru HDInsight.

## PRZYKŁADY

### Przykład 1. Usunięcie konfiguracji automatycznego skalowania klastra USŁUGI HDInsight.
```powershell
...
To polecenie usuwa konfigurację skalowania automatycznego klastrów HDInsight.
