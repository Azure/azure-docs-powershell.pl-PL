...
### -AssignIdentity
Wygeneruj i przypisz tożsamość usługi Azure Active Directory dla tego serwera do używania z usługami zarządzania kluczami, np. Azure KeyVault.
