...
## OPIS
Polecenie **cmdlet Remove-AzSqlServerAudit** usuwa ustawienia inspekcji serwera Azure SQL.
Określ parametry *ResourceGroupName (Nazwa Grupy Zasobów)* i *ServerName (Nazwa Serwera),* aby zidentyfikować serwer.

## PRZYKŁADY

### Przykład 1. Usunięcie ustawień inspekcji serwera Azure SQL Server
```
PS C:\>Remove-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
```

### Przykład 2. Usuwanie za pośrednictwem potoku ustawień inspekcji serwera Azure SQL
```
