...
## OPIS
Polecenie New-AzSqlElasticJob cmdlet tworzy nowe zadanie

## PRZYKŁADY

### Przykład 1. Tworzenie nowego zadania
```powershell
...
Tworzy nowe zadanie. (wygenerowane automatycznie)
...
### - EndTime
Czas zakończenia harmonogramu zadania
...
### -RunOnce
Flaga wskazująca, że zadanie zostanie uruchomione raz
...
### — StartTime
Czas rozpoczęcia harmonogramu zadania
