...
## OPIS
Polecenie **cmdlet Remove-AzSqlElasticPool** usuwa pulę elastyczną usługi Azure SQL Database.

## PRZYKŁADY

### Przykład 1. Usuwanie puli elastycznej
```
PS C:\>Remove-AzSqlElasticPool -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

To polecenie usuwa elastyczną pulę o nazwiePoolpool01.
...
Określa nazwę elastycznej puli usuwaną przez to polecenie cmdlet.
