...
## OPIS
Pobiera określoną grupę wystąpienia trybu failover lub wyświetla grupy wystąpienia trybu failover w regionie w ramach subskrypcji użytkownika.
...
### — Nazwa
Nazwa grupy trybu failover wystąpienia do pobrania.
