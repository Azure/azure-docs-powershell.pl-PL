...
## OPIS
Polecenie Enable-AzSqlInstanceDatabaseSensitivityRecommendation cmdlet umożliwia wyświetlanie rekomendacji wrażliwości kolumn w bazie danych azure SQL managed instance database.

## PRZYKŁADY

### Przykład 1. Włączanie rekomendacji wrażliwości dla danej kolumny w bazie danych azure SQL managed instance.
```powershell
...
### Przykład 2. Włączanie rekomendacji wrażliwości dla danej kolumny w bazie danych azure SQL managed instance database za pomocą funkcji Piping.
```powershell
