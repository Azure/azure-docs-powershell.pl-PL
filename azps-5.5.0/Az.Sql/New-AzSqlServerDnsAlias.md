...
## OPIS
Tworzy nowy alias DNS programu Azure SQL Server, który wskaże określony serwer.
...
To polecenie tworzy alias DNS programu Azure SQL Server z nazwą aliasname, która wskazuje nazwę serwera
