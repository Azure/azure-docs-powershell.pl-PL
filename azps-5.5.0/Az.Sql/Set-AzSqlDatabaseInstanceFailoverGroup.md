...
### SetInstanceFailoverGroupDefaultSet (Domyślne)
```
...
## OPIS
To polecenie modyfikuje konfigurację grupy trybu failover wystąpienia.

Do wykonania polecenia należy użyć podstawowego obszaru grupy trybu failover wystąpienia.
...
Ustawia zasady trybu failover grupy trybu failover wystąpienia na wartość "Ręcznie", korzystając z funkcji rurowych w grupie trybu failover.

## PARAMETERS

### -AllowReadOnlyFailoverToPrimary
Czy czas awarii na serwerze pomocniczym powinien wyzwalać automatyczne trybu failover punktu końcowego tylko do odczytu.
...
### -InputObject
Obiekt Grupy trybu failover wystąpienia, który ma być ustawiony
...
### -ResourceId
Identyfikator zasobu grupy trybu failover wystąpienia, który należy ustawić.
