...
### RemoveInstanceFromInputParameters (domyślne)
```
...
## OPIS
Polecenie **cmdlet Remove-AzSqlInstance** usuwa wystąpienie zarządzane usługi Azure SQL Database.
...
To polecenie usuwa wystąpienie o nazwie managedInstance1.
...
### -ResourceId
Identyfikator zasobu obiektu wystąpienia do usunięcia
