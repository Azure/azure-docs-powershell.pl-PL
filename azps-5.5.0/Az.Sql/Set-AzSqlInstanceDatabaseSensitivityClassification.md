...
## OPIS
Polecenie Set-AzSqlInstanceDatabaseSensitivityClassification cmdlet ustawia typy informacji i etykiety wrażliwości kolumn w bazie danych azure SQL managed instance database.

## PRZYKŁADY

### Przykład 1. Ustawianie typu informacji i etykiety wrażliwości kolumny w bazie danych azure SQL managed instance.
```powershell
...
### Przykład 2. Ustawianie zalecanych typów informacji i etykiet wrażliwości kolumn w bazie danych azure SQL managed instance.
```powershell
...
### Przykład 3. Ustawianie typu informacji i etykiety wrażliwości kolumny w bazie danych zarządzanych wystąpień języka SQL Azure przy użyciu połączenia rurowego.
```powershell
...
Obiekt reprezentujący klasyfikację wrażliwości zarządzanego wystąpienia SQL.
...
### -InformationType
Nazwa opisującą typ informacji przechowywanych w kolumnie.
...
### -SensitivityLabel
Nazwa opisującą charakter danych przechowywanych w kolumnie.
