...
## OPIS
Polecenie cmdlet **New-AzSqlDatabaseImport** importuje plik bacpac z konta magazynu platformy Azure do nowej bazy danych Azure SQL Database.
Żądanie pobrania importowej bazy danych może zostać wysłane w celu pobrania informacji o stanie dla tego żądania.
...
To polecenie tworzy żądanie importu w celu zaimportowania pliku bacpac do nowej bazy danych.
...
Ten parametr domyślnie ma wartość SQL, jeśli nie ustawiono typu uwierzytelniania.
Dopuszczalne wartości dla tego parametru to:
- SQL.
Uwierzytelnianie SQL.
Ustaw parametry *AdministratorLogin* i *AdministratorLoginPassword* na nazwę użytkownika i hasło administratora SQL. 
- ADPassword.
Uwierzytelnianie w usłudze Azure Active Directory.
Ustaw *hasło AdministratorLogin* i *AdministratorLoginPassword na* nazwę użytkownika i hasło administratora usługi Azure Active Directory.
...
Określa maksymalny rozmiar nowo zaimportowanych baz danych.
...
Określa nazwę celu usługi, który ma zostać przypisany do usługi Azure SQL Database.
...
- SharedAccessKey.
Używa klawisza SAS (Shared Access Signature).
...
### — StorageUri
Określa URI obiektu blob pliku bacpac.
