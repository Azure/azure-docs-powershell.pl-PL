...
To polecenie usuwa administratora usługi Azure AD dla serwera o nazwie Serwer01 skojarzonego z grupą zasobów ResourceGroup01.
...
### -ServerName
Określa nazwę programu SQL Server, dla którego to polecenie cmdlet usuwa administratora.
