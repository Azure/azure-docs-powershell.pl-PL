...
## OPIS
Polecenie **cmdlet Set-AzSqlServerFirewallRule** modyfikuje regułę zapory na serwerze usługi Azure SQL Database.
...
To polecenie modyfikuje regułę zapory o nazwie Rule01 na serwerze o nazwie Serwer01.
To polecenie modyfikuje adresy IP początku i końca.
...
### -FirewallRuleName
Określa nazwę reguły zapory, która ma być zmieniana przez to polecenie cmdlet.
