...
## OPIS
Polecenie cmdlet **Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy** ustawia długoterminowe zasady przechowywania dla tej zarządzanej bazy danych.
...
Konfiguruje tygodniowe zasady przechowywania długoterminowego bazy danych na jeden tydzień.
...
To polecenie usuwa z bazy danych zasady przechowywania długoterminowych.

### Przykład 3

Polecenie Set-AzSqlInstanceDatabaseLongTermRetentionBackup cmdlet ustawia długoterminowe zasady przechowywania zarządzanej bazy danych. (wygenerowane automatycznie)
...
### -DatabaseName
Nazwa zarządzanej bazy danych Azure do użycia.
...
### -InstanceName
Nazwa zarządzanego wystąpienia platformy Azure, do którego należy baza danych.
...
### -RemovePolicy
Jeśli zostanie to podane, zasady bazy danych zostaną wyczyszone.
