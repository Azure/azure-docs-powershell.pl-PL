...
## OPIS
Polecenie **cmdlet Remove-AzSqlServerFirewallRule** usuwa regułę zapory z określonego serwera usługi Azure SQL Database.
...
To polecenie usuwa regułę zapory o nazwie Rule01 na serwerze o nazwie Serwer01.
...
### -FirewallRuleName
Określa nazwę reguły zapory, która jest usuwana przez to polecenie cmdlet.
