...
## SYNOPSIS
Pobiera szczegółowe informacje dotyczące importu lub eksportu bazy danych Azure SQL Database.
...
## OPIS
Polecenie cmdlet **Get-AzSqlDatabaseImportExportStatus** pobiera szczegóły dotyczące importu pliku bacpac z konta magazynu do bazy danych Azure SQL Database lub eksportu bazy danych Azure SQL Database jako pliku bacpac do konta magazynu.
...
To polecenie pobiera stan żądania importu lub eksportu dla bazy danych pod określonym adresem URL.
...
### -OperationStatusLink
Określa link stanu zwracany z New-AzSqlDatabaseExport lub New-AzSqlDatabaseImport cmdlet.
