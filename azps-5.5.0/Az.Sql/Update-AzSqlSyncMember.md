...
## OPIS
Polecenie **cmdlet Update-AzSqlSyncGroup** modyfikuje właściwości członka synchronizacji usługi Azure SQL Database.
...
To polecenie powoduje zresetowanie hasła administratora bazy danych członków.
...
Czy podczas nawiązywania połączenia z tym członkiem synchronizacji użyć linku prywatnego.
