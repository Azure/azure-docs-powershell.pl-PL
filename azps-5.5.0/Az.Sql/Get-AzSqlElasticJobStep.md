...
## OPIS
Polecenie cmdlet Get-AzSqlElasticJobStep co najmniej jeden krok zadania z zadania

## PRZYKŁADY

### Przykład 1. Pobiera instrukcje z zadania
```powershell
...
Otrzymuje od zadania etap pracy
...
### Microsoft.Azure.Commands.Sql.NajbłędszaJobs.Model.AzureSqlElasticJobModel
