...
## OPIS
To polecenie usuwa grupę wystąpienia trybu failover o określonej nazwie, pozostawiając wszystkie bazy danych bez zmian. Punkt końcowy słuchacza nie zostanie wyrejestrowany z systemu DNS.
...
Usuwanie grupy trybu failover wystąpienia.
...
### — Nazwa
Nazwa grupy trybu failover wystąpienia do usunięcia.
...
### -PassThru
Określa, czy dane wyjściowe wykonywania polecenia cmdlet mają być przechodzą przez ten proces.
