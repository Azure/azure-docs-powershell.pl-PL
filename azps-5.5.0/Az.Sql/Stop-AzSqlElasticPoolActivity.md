...
## OPIS
Polecenie **cmdlet Stop-AzSqlElasticPoolActivity** anuluje asynchroniczną operację aktualizacji na puli elastycznej.

## PRZYKŁADY

### Przykład 1. Anulowanie asynchronicznej operacji aktualizacji na puli elastycznej
```
...
To polecenie anuluje asynchroniczne operacje aktualizacji na puli elastycznej.
...
### -ServerName
Nazwa puli elastycznej programu Azure SQL Server, w którym znajduje się pula elastyczna.
...
### Microsoft.Azure.Commands.Sql.NawiązkaDkiPooli.Model.AzureSqlElasticPoolActivityModel
