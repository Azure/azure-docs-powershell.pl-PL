...
## OPIS
Polecenie **cmdlet Get-AzSqlSyncSchema** zwraca informacje o schemacie synchronizacji bazy danych członka lub bazy danych centrum.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie schematu synchronizacji bazy danych centrum
```powershell
...
To polecenie pobiera schemat synchronizacji dla bazy danych centrum w grupie synchronizacji Group syncGroup01.

### Przykład 2. Uzyskiwanie schematu synchronizacji bazy danych centrum i rozwijanie tabel
```powershell
...
To polecenie pobiera schemat synchronizacji dla bazy danych centrum w grupie synchronizacjiGroup01 i rozwija właściwość Tabele.
...
To polecenie pobiera schemat synchronizacji dla bazy danych członków w pliku syncMember01 członka synchronizacji.
