...
## SYNOPSIS
Zwraca informacje o wystąpieniu zarządzanej bazy danych Azure SQL.
...
## OPIS
Polecenie **cmdlet Get-AzSqlInstance** zwraca informacje dotyczące co najmniej jednego wystąpienia zarządzanego języka Azure SQL.
Określ nazwę wystąpienia, aby wyświetlić informacje tylko dla tego wystąpienia.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie wszystkich wystąpień przypisanych do grupy zasobów
```powershell
...
To polecenie pobiera informacje o wszystkich wystąpieniach przypisanych do grupy zasobów ResourceGroup01.

### Przykład 2. Uzyskiwanie informacji o wystąpieniu
```powershell
...
To polecenie pobiera informacje o wystąpieniu o nazwie managedInstance1.

### Przykład 3. Uzyskiwanie wszystkich wystąpień przypisanych do grupy zasobów przy użyciu filtrowania
```powershell
...
To polecenie pobiera informacje o wszystkich wystąpieniach przypisanych do grupy zasobów ResourceGroup01, których wartości zaczynają się od "managedInstance".

### Przykład 4. Uzyskiwanie wszystkich wystąpień w puli wystąpień
```powershell
...
To polecenie pobiera informacje o wszystkich wystąpieniach w puli wystąpień "instancePool0".

### Przykład 5. Uzyskiwanie wszystkich wystąpień w puli wystąpień przy użyciu obiektu pula wystąpień
```powershell
...
### Przykład 6. Uzyskiwanie wszystkich wystąpień w puli wystąpień przy użyciu identyfikatora zasobu puli wystąpień
```powershell
...
### Przykład 7. Uzyskiwanie wystąpienia zarządzanego przy użyciu jego identyfikatora zasobu
```powershell
...
### -ResourceId
Identyfikator zasobu zarządzanego wystąpienia.
