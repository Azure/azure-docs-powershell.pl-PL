...
## OPIS
Polecenie cmdlet **Disable-AzSqlServerActiveDirectoryOnlyAuthentication** wyłącza wymaganie uwierzytelniania usługi Azure Active Directory (Azure AD) tylko dla serwera AzureSQL Server w bieżącej subskrypcji.
