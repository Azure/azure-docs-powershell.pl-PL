...
### Przykład 1. Uzyskiwanie wszystkich wystąpień programu Azure SQL Sync Agent przypisanego do serwera Azure SQL Server
```
...
To polecenie pobiera informacje o wszystkich agentach synchronizacji języka Azure SQL przypisanych do serwera Azure SQL Server.
