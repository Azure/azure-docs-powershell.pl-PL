...
## OPIS
Polecenie **cmdlet New-AzSqlInstancePool** tworzy pulę wystąpień języka Azure SQL.
...
To polecenie tworzy nową pulę wystąpień języka Azure SQL.
...
Możliwe wartości to Cena Bazowa (z rabatem AHB) i LicenseIncluded (bez rabatu AHB).
...
### — Lokalizacja
Lokalizacja tworzenia puli wystąpień.
...
### -SubnetId
Identyfikator podsieci do użycia podczas tworzenia puli wystąpień.
...
### — VCore
Określa, ile vcore ma skojarzyć z wystąpieniem.
