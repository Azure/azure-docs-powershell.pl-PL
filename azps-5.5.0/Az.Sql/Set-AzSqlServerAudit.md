...
## OPIS
Polecenie **cmdlet Set-AzSqlServerAudit** zmienia ustawienia inspekcji serwera Azure SQL.
...
### Przykład 1. Włączanie zasad inspekcji magazynu obiektów blob serwera Azure SQL
```powershell
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -BlobStorageTargetState Enabled -StorageAccountResourceId "/subscriptions/7fe3301d-31d3-4668-af5e-211a890ba6e3/resourceGroups/resourcegroup01/providers/Microsoft.Storage/storageAccounts/mystorage"
```

### Przykład 2. Wyłączenie zasad inspekcji magazynu obiektów blob serwera Azure SQL Server
```powershell
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -BlobStorageTargetState Disabled
```

### Przykład 3. Włączanie zasad inspekcji magazynu obiektów blob na serwerze Azure SQL z zaawansowanym filtrowaniem przy użyciu predykatu T-SQL
```powershell
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -BlobStorageTargetState Enabled -StorageAccountResourceId "/subscriptions/7fe3301d-31d3-4668-af5e-211a890ba6e3/resourceGroups/resourcegroup01/providers/Microsoft.Storage/storageAccounts/mystorage" -PredicateExpression "statement <> 'select 1'"
```

### Przykład 4. Usunięcie zaawansowanego ustawienia filtrowania z zasad inspekcji serwera Azure SQL
```powershell
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -PredicateExpression ""
```

### Przykład 5. Włączanie zasad inspekcji centrum zdarzeń serwera Azure SQL
```powershell
...
### Przykład 6. Wyłączenie zasad inspekcji centrum zdarzeń serwera Azure SQL
```powershell
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -EventHubTargetState Disabled
```

### Przykład 7. Włączanie zasad inspekcji analizy dziennika na serwerze Azure SQL
```powershell
...
### Przykład 8. Wyłączenie zasad inspekcji analizy dziennika na serwerze Azure SQL
```powershell
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -LogAnalyticsTargetState Disabled
```

### Przykład 9. Wyłączanie w potoku zasad inspekcji analizy dziennika serwera Azure SQL
```powershell
...
### Przykład 10. Wyłącz wysyłanie rekordów inspekcji serwera Azure SQL do magazynu obiektów blob i włącz wysyłanie ich do analizy dziennika.
```powershell
...
### Przykład 11. Włączanie wysyłania rekordów inspekcji serwera Azure SQL do magazynu obiektów blob, centrum zdarzeń i analizy dziennika.
```powershell
...
### -StorageKeyType
Określa, których kluczy dostępu magazynu należy użyć.
