...
## OPIS
Polecenie Stop-AzSqlElasticJob cmdlet zatrzymuje uruchomione wykonywanie zadania.
Zwraca bieżący stan wykonania zadania.

## PRZYKŁADY

### Przykład 1. Zatrzymanie zadania z uruchomionym wykonaniem zadania
```powershell
...
Zatrzymuje uruchamianie zadania i zwraca jego bieżący stan
...
### - ParentObject
Obiekt bazy danych kontrolki agenta
