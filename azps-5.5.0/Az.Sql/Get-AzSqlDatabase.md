...
## OPIS
Polecenie **cmdlet Get-AzSqlDatabase** pobiera jedną lub więcej baz danych Azure SQL z serwera Azure SQL Database Server.
To polecenie cmdlet jest również obsługiwane przez usługę SQL Server Stretch Database na platformie Azure.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie wszystkich baz danych na serwerze
```
...
To polecenie pobiera wszystkie bazy danych na serwerze o nazwie serwer01.

### Przykład 2. Uzyskiwanie bazy danych według nazwy na serwerze
```
...
To polecenie pobiera bazę danych o nazwie Database02 z serwera o nazwie Serwer01.

### Przykład 3. Uzyskiwanie wszystkich baz danych na serwerze przy użyciu filtrowania
```
...
To polecenie pobiera wszystkie bazy danych na serwerze o nazwie serwer01, które zaczynają się od "bazy danych".
...
### -ResourceGroupName
Określa nazwę grupy zasobów, do której jest przypisany serwer bazy danych.
...
### -ServerName
Określa nazwę serwera, do którego jest przypisana baza danych.
