...
### Przykład 1. Wyłącz zalecenia dotyczące wrażliwości dla danej kolumny w usłudze Azure SQL Database.
```powershell
...
### Przykład 2. Wyłącz zalecenia dotyczące wrażliwości kolumn, które mają zalecenia wrażliwości w bazie danych Azure SQL, używając funkcji Piping.
```powershell
