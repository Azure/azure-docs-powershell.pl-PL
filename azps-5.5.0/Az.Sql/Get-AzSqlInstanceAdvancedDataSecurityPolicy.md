...
## OPIS
Polecenie **cmdlet Get-AzSqlInstanceAdvancedDataSecurityPolicy** pobiera zasady advanced data security zarządzanego wystąpienia.

## PRZYKŁADY

### Przykład 1. Pobiera zarządzane wystąpienie Zaawansowane zabezpieczenia danych
```powershell
...
### Przykład 2. Pobiera zaawansowane zabezpieczenia danych zarządzanego wystąpienia z zasobu zarządzanych wystąpień
```powershell
