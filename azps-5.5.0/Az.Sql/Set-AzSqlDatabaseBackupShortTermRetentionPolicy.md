...
## OPIS
Polecenie **cmdlet Set-AzSqlDatabaseBackupShortTermRetentionPolicy** pobiera do tej bazy danych zasady przechowywania krótkookresowe.
...
To polecenie ustawia zasady przechowywania krótkiego terminu dla bazy danych na 35 dni za pośrednictwem linii rurowych w obiekcie bazy danych.

## PARAMETERS

### -AzureSqlDatabaseObject
Obiekt bazy danych do uzyskania zasad.
