...
Pobiera użycie dla puli wystąpień wystąpienia języka Azure SQL przy użyciu obiektu puli wystąpień.

### Przykład 3. Pobiera użycie puli wystąpień języka Azure SQL przy użyciu identyfikatora zasobu puli wystąpień
```powershell
...
### -Expand Zszybki
Flaga wskazująca, czy należy rozszerzyć użycie tej puli wystąpień wraz z użyciem dzieci.
