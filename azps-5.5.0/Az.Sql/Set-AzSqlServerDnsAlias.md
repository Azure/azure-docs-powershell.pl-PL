...
## OPIS
To polecenie aktualizuje serwer, na który jest wskazują alias. To polecenie musi zostać wydane po zalogowaniu się do subskrypcji, na którym znajduje się nowy serwer, do którego ma zostać wskażony alias.
...
To polecenie aktualizuje alias, który wcześniej wskaże stary serwer w celu wskazania nowego serwera serwera
...
### -SourceServerName
Nazwa serwera Azure Sql Server, do którego obecnie wskazuje alias.
...
### -TargetServerName
Nazwa serwera Azure Sql Server, do którego ma być wskaż alias.
