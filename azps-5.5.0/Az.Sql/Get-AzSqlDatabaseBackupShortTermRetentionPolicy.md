...
## SYNOPSIS
Otrzymuje zasady przechowywania kopii zapasowej przez krótki okres.

## SKŁADNIA

### PolicyByResourceServerDatabaseSet (Domyślne)
```
...
## OPIS
Polecenie **cmdlet Get-AzSqlDatabaseBackupShortTermRetentionPolicy** pobiera do tej bazy danych zasady przechowywania dotyczące krótkich okresów przechowywania.
...
To polecenie pobiera zasady przechowywania krótkich okresów dla bazy danych01.
...
Obiekt bazy danych, dla których mają być pobierze się zasady.
