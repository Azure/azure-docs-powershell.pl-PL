...
## SYNOPSIS
Otrzymuje cele usługi dla serwera azure SQL Database.
...
## OPIS
Polecenie **cmdlet Get-AzSqlServerServiceObjective** uzyskuje cele usługi dostępne dla serwera usługi Azure SQL Database.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie celów usługi
```
...
### Przykład 2. Uzyskiwanie celów usługi przy użyciu filtrowania
```
...
To polecenie pobiera cele usługi dla serwera o nazwie Server01, który zaczyna się od "System".
...
To polecenie pobiera cele usługi dla określonego regionu platformy Azure.
...
### — Lokalizacja
Nazwa lokalizacji, dla której mają być zdane cele usługi.
...
To polecenie cmdlet uzyskuje cele usługi dla serwera bazy danych SQL przydzielonego do tego zasobu.
...
### -ServerName
Określa nazwę serwera bazy danych SQL DATABASE.
...
Określa nazwę celu usługi dla serwera azure SQL Database.
Dopuszczalne wartości dla tego parametru to: Basic, S0, S1, S2, P1, P2 i P3.
