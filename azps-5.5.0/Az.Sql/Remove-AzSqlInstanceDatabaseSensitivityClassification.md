...
### ClassificationObjectParameterSet (domyślne)
```
Remove-AzSqlInstanceDatabaseSensitivityClassification
...
## OPIS
Polecenie Remove-AzSqlInstanceDatabaseSensitivityClassification cmdlet usuwa typy informacji i etykiety wrażliwości kolumn w bazie danych azure SQL managed instance database.

## PRZYKŁADY

### Przykład 1. Usuwanie typu informacji i etykiety wrażliwości kolumny w bazie danych azure SQL managed instance.
```powershell
...
### Przykład 2. Usuwanie bieżących typów informacji i etykiet wrażliwości kolumn w bazie danych azure SQL managed instance database za pomocą funkcji Piping.
```powershell
...
### Przykład 3. Usuwanie typu informacji i etykiety wrażliwości kolumny w bazie danych wystąpienia zarządzanego przez język SQL Azure za pomocą funkcji Piping.
```powershell
...
Obiekt reprezentujący klasyfikację wrażliwości zarządzanego wystąpienia SQL w bazie danych.
...
### -DatabaseObject
Obiekt bazy danych zarządzanych wystąpień języka Azure SQL.
