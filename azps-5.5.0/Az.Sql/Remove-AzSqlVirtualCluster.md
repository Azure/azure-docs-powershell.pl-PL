...
### RemoveVirtualClusterFromInputParameters (domyślne)
```
...
## OPIS
Polecenie **cmdlet Remove-AzSqlVirtualCluster** usuwa klaster wirtualny języka Azure SQL.
...
To polecenie usuwa klaster wirtualny o nazwie VirtualCluster1 przypisany do grupy zasobów ResourceGroup01.
