...
## OPIS
Polecenie **cmdlet Remove-AzSqlDatabaseAudit** usuwa ustawienia inspekcji bazy danych Azure SQL.
Aby użyć polecenia cmdlet, określ bazę danych za pomocą parametrów *ResourceGroupName,* *ServerName* i *DatabaseName.*

## PRZYKŁADY

### Przykład 1. Usunięcie ustawień inspekcji bazy danych Azure SQL Database
```
PS C:\>Remove-AzSqlDatabaseAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

### Przykład 2. Usuwanie ustawień inspekcji bazy danych Azure SQL za pośrednictwem potoku
```
