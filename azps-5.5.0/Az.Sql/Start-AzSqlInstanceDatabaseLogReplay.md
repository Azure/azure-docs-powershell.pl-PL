...
### LogReplayInstanceDatabaseFromInputParameters (Domyślne)
```
...
## OPIS
Polecenie **cmdlet Start-AzSqlInstanceDatabaseLogReplay** inicjuje uruchomienie usługi ponownego odtwarzania dziennika.
...
To polecenie spowoduje utworzenie nowej zarządzanej bazy danych i rozpoczęcie przywracania kopii zapasowych z danego kontenera do momentu przywrócenia pliku last_backup.bak.
...
To polecenie utworzy nową zarządzaną bazę danych i rozpocznie przywracanie kopii zapasowych z danego kontenera, Complete-AzSqlInstanceDatabaseLogReplay zostanie wywołana ostatnia poszukiwana kopia zapasowa.
...
### -AutoCompleteRestore
Wskaźnik, czy autouzupełniać przywracanie po ukończeniu, czy nie.
...
### — sortowanie
Sortowanie bazy danych wystąpienia, która ma być w użyciu.
...
### -LastBackupName
Nazwa ostatniego pliku kopii zapasowej do przywrócenia.
...
### -PassThru
Określa, czy grupa synchronizacji ma być zwracana.
