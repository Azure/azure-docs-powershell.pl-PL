...
## OPIS
Polecenie **cmdlet Get-AzSqlSyncGroup** zwraca informacje o co najmniej jednej grupie synchronizacji bazy danych Azure SQL.
Określ nazwę grupy synchronizacji, aby wyświetlić informacje tylko dla tej grupy synchronizacji.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie wszystkich wystąpień grupy azure SQL Sync Group przypisanej do bazy danych Azure SQL Database
```
...
To polecenie pobiera informacje o wszystkich grupach synchronizacji usługi Azure SQL Database przypisanych do usługi Azure SQL Database.

### Przykład 2. Uzyskiwanie informacji o grupie synchronizacji usługi Azure SQL Database
```
...
To polecenie pobiera informacje o grupie synchronizacji bazy danych Azure SQL o nazwie "SyncGroup01"

### Przykład 3. Uzyskiwanie wszystkich wystąpień grupy Azure SQL Sync Group przypisanej do bazy danych Azure SQL Database przy użyciu filtrowania
```
...
To polecenie pobiera informacje o wszystkich grupach synchronizacji usługi Azure SQL Database przypisanych do bazy danych Azure SQL Database, których nazwa rozpoczyna się od "SyncGroup".
