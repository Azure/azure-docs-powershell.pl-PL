...
## SYNOPSIS
Zwraca informacje o nadmiarowej kopii zapasowej bazy danych zarządzanego przez sql azure.
...
## OPIS
Polecenie **cmdlet Get-AzSqlInstanceDatabaseGeoBackup** pobiera co najmniej jedną nadmiarową kopię zapasową baz danych Azure SQL z zarządzanego wystąpienia usługi Azure SQL Database.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie wszystkich nadmiarowych kopii zapasowych bazy danych w wystąpieniu
```
...
To polecenie pobiera wszystkie nadmiarowe kopie zapasowe baz danych w wystąpieniu o nazwie managedInstance1.

### Przykład 2. Uzyskiwanie nadmiarowej kopii zapasowej bazy danych według nazwy w wystąpieniu zarządzanym
```
...
To polecenie pobiera nadmiarowe kopie zapasowe bazy danych o nazwie managedDatabase1 z wystąpienia o nazwie managedInstance1.

### Przykład 3. Uzyskiwanie wszystkich nadmiarowych kopii zapasowych bazy danych w wystąpieniu przy użyciu filtrowania
```
...
To polecenie pobiera wszystkie nadmiarowe kopie zapasowe baz danych w wystąpieniu o nazwie managedInstance1, które zaczyna się od "managedDatabase".
...
### — Nazwa
Nazwa wystąpienia bazy danych do pobrania.
