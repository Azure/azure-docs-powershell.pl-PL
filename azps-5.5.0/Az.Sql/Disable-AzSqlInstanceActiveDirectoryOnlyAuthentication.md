...
## OPIS
Polecenie cmdlet **Disable-AzSqlInstanceActiveDirectoryOnlyAuthentication** wyłącza wymaganie uwierzytelniania tylko usługi Azure Active Directory (Azure AD) dla wystąpienia zarządzanego AzureSQL w bieżącej subskrypcji.
...
To polecenie wyłącza wymaganie uwierzytelniania tylko w usłudze Azure Active Directory (Azure AD) dla zarządzanego wystąpienia usługi AzureSQL o nazwie ManagedInstance01 skojarzonego z grupą zasobów o nazwie ResourceGroup01.
...
### -InstanceName
Nazwa wystąpienia zarządzanego przez usługę Azure SQL zawiera uwierzytelnianie tylko w usłudze Azure Active Directory.
