...
## OPIS
Polecenie **cmdlet Get-AzSqlDatabaseAdvisor** pobiera co najmniej jednego doradcę usługi Azure SQL Database database dla usługi Azure SQL Database.

## PRZYKŁADY

### Przykład 1. Lista wszystkich doradców w określonej bazie danych
```
...
To polecenie pobiera listę wszystkich doradców bazy danych o nazwie WIRunner, który należy do serwera o nazwie wi-sprinter-australia-east.

### Przykład 2. Uzyskiwanie pojedynczego doradcy dla określonej bazy danych
```
...
To polecenie pobiera doradcę o nazwie CreateIndex dla bazy danych o nazwie WIRunner.
...
To polecenie pobiera wszystkich doradców bazy danych o nazwie "WIRunner" z ich zalecanymi działaniami uwzględnionymi w odpowiedzi.
Ponieważ to polecenie używa *parametru ExpandRecomctions,* polecenie cmdlet pobiera zalecane akcje wraz z odpowiedzią.
...
To polecenie pobiera doradcę o nazwie CreateIndex z bazy danych o nazwie WIRunner z zalecanymi akcjami uwzględnionymi w odpowiedzi.
Ponieważ to polecenie używa *parametru ExpandRecomctions,* polecenie cmdlet pobiera zalecane akcje wraz z odpowiedzią.

### Przykład 5. Lista wszystkich doradców w określonej bazie danych przy użyciu filtrowania
```
...
To polecenie pobiera listę wszystkich doradców bazy danych o nazwie WIRunner, który należy do serwera o nazwie wi-sprinter-australia-east i zaczyna się od litery "d".
...
### -DatabaseName
Określa nazwę bazy danych, dla której to polecenie cmdlet żąda doradcy.
...
Wskazuje, że to polecenie cmdlet pobiera zalecane akcje wraz z odpowiedzią.
...
### -ResourceGroupName
Określa nazwę grupy zasobów serwera zawierającego tę bazę danych.
...
## NOTATKI
* Słowa kluczowe: azure, azurerm, arm, resource, management, manager, sql, database, mssql, advisor
