...
## OPIS
Polecenie **cmdlet Remove-AzStackEdgeStorageAccount** usuwa skojarzone konto magazynu edge dla urządzenia Stack Edge. Możesz określić nazwę konta magazynu dla usługi Edge, które ma zostać usunięte jako parametr w poleceniach cmdlet.
