...
## OPIS
Polecenie **cmdlet Get-AzStackEdgeTriger** pobiera wyzwalacze dla urządzenia. Nazwę można określić jako parametr w poleceniach cmdlet w celu zdalnego dostępu do szczegółów określonych wyzwalaczy.
