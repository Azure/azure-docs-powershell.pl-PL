...
### ConnectionStringParameterSet (domyślne)
```
...
## OPIS
Polecenie **cmdlet New-AzStackEdgeRole** tworzy nową rolę dla urządzenia Stack Edge.
...
### -IotDeviceAccessKey
Klawisz dostępu urządzenia Iot
...
Podaj ciąg połączenia urządzenia IOT
...
Klawisz dostępu urządzenia iot Edge
...
Podaj ciąg połączenia urządzenia Edge
...
### -IotEdgeDeviceId
Identyfikator urządzenia Edge Iot
...
### — Platforma
Udostępnij platformę, na przykład: Linux
...
### Microsoft.Azure.PowerShell.Cmdlet.StackEdge.Models.PSStackEdgeRole
