...
## OPIS
Polecenie **cmdlet New-AzStackEdgeUser** tworzy nowego użytkownika dla urządzenia Stack Edge. Obsługiwane jest tworzenie tylko `Share` użytkowników tego typu.
