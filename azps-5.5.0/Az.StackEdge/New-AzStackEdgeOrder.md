...
## OPIS
Polecenie **cmdlet New-AzStackEdgeOrder** tworzy nowe zamówienie dla urządzenia Stack Edge. Przed utworzeniem zamówienia należy najpierw utworzyć zasób urządzenia Stack Edge. Możesz określić szczegóły, takie jak osoba kontaktowa, nazwa firmy, adres e-mail, adres itp. jako parametry tworzenia zamówienia.
...
### — Poczta e-mail
Lista wiadomości e-mail do odbierania aktualizacji, akceptuje maksymalnie 10 wiadomości e-mail
...
### Microsoft.Azure.PowerShell.Cmdlet.StackEdge.Models.PSStackEdgeOrder
