...
### Przykład 1. Tworzenie zestawu danych odwoływać się do określonego środowiska  
```powershell
...
To polecenie tworzy zestaw danych referencyjnych dla określonego środowiska.

## PARAMETERS

### -DataStringComparisonBehavior
Zachowanie porównywania kluczy zestawu danych referencyjnych można ustawić przy użyciu tej właściwości.
Domyślnie wartość to "Porządkowa" — co oznacza, że podczas łączenia danych referencyjnych ze zdarzeniami lub dodawania nowych danych referencyjnych zostanie przeprowadzone porównanie z kluczem z rozróżnianą wielkością liter.
Gdy zostanie ustawiona wartość "OrdinalIgnoreCase", zostanie użyte porównanie bez uwzględniania liter.
...
### -KeyProperty
Lista właściwości kluczy dla zestawu danych odwoływać się.
Aby skonstruować, zobacz sekcję NOTATKI dla właściwości KEYPROPERTY i utwórz tabelę skrótu.
...
KEYPROPERTY <IReferenceDataSetKeyProperty[]>: Lista właściwości klucza dla zestawu danych odwołania.
