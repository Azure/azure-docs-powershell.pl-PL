...
Polecenie przekaże plik o nazwie ContosoPlanning jako Planowanie2015.
...
Pierwsze polecenie tworzy tabelę skrótu zawierającą metadane dla obiektu blob i przechowuje tabelę tego skrótu w $Metadata tabeli.
...
### Przykład 6. Przekazanie pliku do obiektu blob z określonymi właściwościami obiektu blob i ustawienie standardowegoBlobTier jako cool
```
...
### - EncryptionScope
Zakres szyfrowania, który ma być używany podczas żądania do obiektu blob.
