...
### Przykład 6. Ustawianie źródła klucza szyfrowania na wartość "Microsoft.Storage"
```
PS C:\>Set-AzStorageAccount -ResourceGroupName "MyResourceGroup" -AccountName "mystorageaccount" -StorageEncryption
```

To polecenie ustawiło źródło klucza szyfrowania na "Microsoft.Storage"
...
Polecenie uaktualnij konto magazynu za pomocą rodzaju "Magazyn" lub "BlobStorage" do konta magazynu typu "StorageV2".

### Przykład 10. Aktualizowanie konta magazynu przez włączenie uwierzytelniania usług Azure Files AAD DS.
```
...
### Przykład 11. Aktualizowanie konta magazynu przez włączenie uwierzytelniania usługi domenowej Active Directory w plikach, a następnie wyświetlanie ustawienia uwierzytelniania opartego na tożsamości plików
```
...
### Przykład 12. Ustawianie wartości MinimumTlsVersion i AllowBlobPublicAccess
```
...
Polecenie ustawia wartości MinimumTlsVersion i AllowBlobPublicAccess, a następnie wyświetla 2 właściwości konta. 
...
Włącz uwierzytelnianie usługi domenowej Active Directory plików Azure dla konta magazynu.
...
### — Wymuszanie
Wymusza na wymusze wpisienie zmiany na koncie magazynu.
...
### -KeyvaultEncryption
Wskazuje, czy podczas korzystania z szyfrowania usługi magazynowania należy używać funkcji Microsoft KeyVault do kluczy szyfrowania. Jeśli wszystkie wartości to KeyName, KeyVersion i KeyVaultUri, wartość KeySource zostanie ustawiona na Microsoft.Keyvault niezależnie od tego, czy ten parametr jest ustawiony. 
...
### -KeyVaultUri
Podczas korzystania z szyfrowania magazynu kluczy przez określenie parametru -KeyvaultEncryption użyj tej opcji, aby określić URI do magazynu kluczy.
