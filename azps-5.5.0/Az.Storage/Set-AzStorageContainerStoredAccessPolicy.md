...
## OPIS
Polecenie **cmdlet Set-AzStorageContainerStoredAccessPolicy** ustawia zasady dostępu przechowywanego dla kontenera magazynu platformy Azure.

## PRZYKŁADY

### Przykład 1. Ustawianie przechowywanych zasad dostępu w kontenerze magazynu z pełnymi uprawnieniami
```
PS C:\>Set-AzStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy06" -Permission rwdl
```

To polecenie ustawia zasady dostępu o nazwie Zasady06 dla kontenera magazynu o nazwie MyContainer.
...
### -NoExpiryTime
Oznacza, że zasady dostępu nie mają daty wygaśnięcia.
...
### — Uprawnienie
Określa uprawnienia w przechowywanych zasadach dostępu do uzyskiwania dostępu do kontenera magazynu.
