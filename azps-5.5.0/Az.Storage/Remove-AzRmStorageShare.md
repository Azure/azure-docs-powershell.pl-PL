...
### Przykład 1. Usuwanie udziału plików magazynu z nazwą konta magazynu i nazwą udostępniania
```
PS C:\>Remove-AzRmStorageShare -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount" -Name "myshare"
```

To polecenie usuwa udział plików magazynu z nazwą konta magazynu i nazwą udostępniania.

### Przykład 2. Usuwanie udziału plików magazynu z obiektem konta magazynu i nazwą udostępniania
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount"
PS C:\>Remove-AzRmStorageShare -StorageAccount $accountObject -Name "myshare"
```

To polecenie usuwa udział plików magazynu z obiektem konta magazynu i nazwę udostępniania.

### Przykład 3. Usuwanie wszystkich udziałów plików magazynu w koncie magazynu z potokiem
```
PS C:\>Get-AzStorageShare -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount" | Remove-AzRmStorageShare -Force
```

To polecenie usuwa wszystkie udziały plików magazynu w koncie magazynu z potokiem.
...
### — Wymuszanie
Wymuszanie usunięcia udostępniania i całej jego zawartości
