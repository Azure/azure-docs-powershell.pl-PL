...
Zobacz szczegóły uwierzytelniania usługi magazynu https://docs.microsoft.com/en-us/rest/api/storageservices/authorization-for-the-azure-storage-services w.
...
Drugie polecenie tworzy kontekst dla konta o nazwie ContosoGeneral, które korzysta z określonego klucza, a następnie przechowuje ten kontekst w zmiennej $Context 02.
...
Pierwsze polecenie generuje token SAS przy użyciu polecenia cmdlet **New-AzStorageContainerSASToken** dla kontenera o nazwie ContosoMain, a następnie przechowuje ten token w $SasToken danych.
...
### — Anonimowe
Wskazuje, że to polecenie cmdlet tworzy kontekst magazynu platformy Azure dla logowania anonimowego.
