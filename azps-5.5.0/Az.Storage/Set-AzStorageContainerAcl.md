...
To polecenie pobiera wszystkie kontenery magazynu, których nazwa zaczyna się od kontenera, a następnie przekazuje wynik w potoku w celu ustawienia dla nich wszystkich uprawnień dostępu do obiektów blob.
...
Aby udzielić użytkownikom anonimowym uprawnień do odczytu do kontenera i jego obiektów blob, możesz ustawić uprawnienia kontenera w celu włączenia dostępu publicznego.
