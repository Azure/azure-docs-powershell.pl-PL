...
### Przykład 1. Dodawanie tagów przechowywania prawnego do kontenera obiektów blob magazynu z nazwą konta magazynu i nazwą kontenera
```
...
### Przykład 2. Dodawanie tagów prawnych hold do kontenera obiektów blob magazynu z obiektem konta magazynu i nazwą kontenera
```
...
To polecenie dodaje tagi przechowywania ze względu na prawo do wszystkich kontenerów obiektów blob magazynu na koncie magazynu z potokiem.
