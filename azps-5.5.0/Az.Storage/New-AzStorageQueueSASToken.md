...
## OPIS
Polecenie **cmdlet New-AzStorageQueueSASToken** generuje token podpisu dostępu udostępnionego dla kolejki magazynu platformy Azure.

## PRZYKŁADY

### Przykład 1. Generowanie tokenu SAS kolejki z pełnymi uprawnieniami
```
PS C:\>New-AzStorageQueueSASToken -Name "Test" -Permission raup
```

W tym przykładzie jest generowany token SAS kolejki z pełnymi uprawnieniami.

## PARAMETERS

### — kontekst
Określa kontekst magazynu platformy Azure.
Możesz go utworzyć, New-AzStorageContext cmdlet.
...
### -ExpiryTime
Określa, kiedy podpis dostępu udostępnionego jest już nieprawidłowy.
...
### — Uprawnienie
Określa uprawnienia dla kolejki magazynu.
...
### — StartTime
Określa, kiedy podpis dostępu udostępnionego stanie się prawidłowy.
