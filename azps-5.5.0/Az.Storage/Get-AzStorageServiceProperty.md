...
## OPIS
Polecenie **cmdlet Get-AzStorageServiceProperty** otrzymuje właściwości usług magazynu platformy Azure.

## PRZYKŁADY

### Przykład 1. Pobierz właściwość usług Azure Storage usługi blob
```
