...
## OPIS
Polecenie **cmdlet Remove-AzStorageAccountManagementPolicy** usuwa zasady zarządzania konta magazynu platformy Azure.

## PRZYKŁADY

### Przykład 1. Usunięcie zasad zarządzania konta magazynu.
```
PS C:\>Remove-AzStorageAccountManagementPolicy -ResourceGroupName "MyResourceGroup" -AccountName "mystorageaccount"
```

To polecenie usuwa zasady zarządzania konta magazynu.
...
### -InputObject
Obiekt zarządzania do usunięcia
