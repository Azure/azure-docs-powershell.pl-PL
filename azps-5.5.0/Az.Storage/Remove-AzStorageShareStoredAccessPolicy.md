...
## OPIS
Polecenie **cmdlet Remove-AzStorageShareStoredAccessPolicy** usuwa przechowywane zasady dostępu z udziału magazynu platformy Azure.

## PRZYKŁADY

### Przykład 1. Usuwanie przechowywanych zasad dostępu z udziału magazynu platformy Azure
```
PS C:\>Remove-AzStorageShareStoredAccessPolicy -ShareName "ContosoShare" -Policy "GeneralPolicy"
```

To polecenie usuwa przechowywane zasady dostępu o nazwie GeneralPolicy z programu ContosoShare.
...
### — Zasady
Określa nazwę przechowywanych zasad dostępu usuwanych przez to polecenie cmdlet.
...
### -ShareName
Określa nazwę udziału magazynu, dla którego to polecenie cmdlet usuwa zasady.
