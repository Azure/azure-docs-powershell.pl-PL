...
To polecenie tworzy token SAS na poziomie konta dla żądań HTTPS tylko z określonego zakresu adresów IP.
...
### — Protokół
Określa dozwolony protokół dla żądania dokonanego za pomocą sygnatury SAS konta.
