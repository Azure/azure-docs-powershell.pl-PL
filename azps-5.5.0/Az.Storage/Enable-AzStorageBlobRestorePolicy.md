...
## OPIS
Polecenie **cmdlet Enable-azStorageBlobRestorePolicy** włącza zasady przywracania obiektów blob dla usługi obiektów blob magazynu platformy Azure.

## PRZYKŁADY

### Przykład 1. Włączenie zasad przywracania obiektów blob dla usługi obiektów blob magazynu platformy Azure na koncie magazynu
```powershell
...
To polecenie najpierw włącza właściwości softdelete i changefeed obiektów blob, a następnie włącza zasady przywracania obiektów blob, a na koniec sprawdza ustawienie we właściwościach usługi obiektów blob.
Usługa obiektów blob RestorePolicy.Days musi być mniejsza niż DeleteRetentionPolicy.Days.
Przed włączeniem zasad przywracania obiektów blob należy włączyć program Softdelete i ChangeFeed.
Jeśli ustawienia softdelete i Changefeed są właśnie włączone, może być konieczne zaczekanie przez pewien czas na obsługę ustawienia przez serwer, zanim zasady przywracania obiektów blob zostaną włączone.
...
### -PassThru
Wyświetlanie właściwości usługi
...
### -RestoreDays
Ustawia liczbę dni, przez które można przywrócić obiekt blob.
