...
To polecenie najpierw tworzy obiekt ACL z 3 wpisami acl, a następnie ustawia pozycję ACL rekurencyjnie w katalogu.
...
Ten skrypt ustawia wartość ACL w sposób powtarzany dla fragmentu katalogu według fragmentu, z rozmiarem fragmentu batchsize * MaxBatchCount. W tym skrypcie rozmiar fragmentu wynosi 200.
...
To polecenie najpierw ustawia pozycję ACL rekurencyjnie do katalogu z ciągiem ContinueOnFailure, a niektóre elementy nie powiodły się, a następnie wznawiaj elementy, których niepowodzenie nie powiodło się, jeden po drugiej.
