...
## OPIS
Polecenie **cmdlet Get-AzStorageFileHandle** wyświetla listę uchwytów pliku udziału plików, katalogu plików lub pliku.
...
### — Katalog
Obiekt CloudFileDirectory wskazywał folder bazowy, w którym będą wyświetlane pliki/katalogi.
