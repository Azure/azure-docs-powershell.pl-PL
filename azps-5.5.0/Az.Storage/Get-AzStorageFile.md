...
## OPIS
Polecenie **cmdlet Get-AzStorageFile** zawiera listę katalogów i plików dla określonego przez Ciebie udziału lub katalogu.
...
Najpierw pobiera wystąpienie katalogu, a następnie potokuje je do polecenia cmdlet **Get-AzStorageFile,** aby wyświetlić listę katalogu.
...
Jeśli uwzględnisz parametr *Path,* **funkcja Get-AzStorageFile** zwróci wystąpienie katalogu lub pliku w określonej ścieżce.
