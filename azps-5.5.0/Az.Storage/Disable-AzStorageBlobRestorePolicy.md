...
## OPIS
Polecenie **cmdlet Disable-AzStorageBlobRestorePolicy** wyłącza zasady przywracania obiektów blob dla usługi obiektów blob magazynu platformy Azure.

## PRZYKŁADY

### Przykład 1. Wyłącza zasady przywracania obiektów blob dla usługi obiektów blob magazynu platformy Azure na koncie magazynu
```powershell
PS C:\> Disable-AzStorageBlobRestorePolicy -ResourceGroupName "myresourcegoup" -StorageAccountName "mystorageaccount"
```

To polecenie wyłącza zasady przywracania obiektów blob dla usługi obiektów blob magazynu platformy Azure na koncie magazynu.
