...
### Przykład 2. Cykliczne aktualizowanie listy ACL w katalogu i wznawianie po niepowodzeniu przy użyciu kontynuacji
```
...
To polecenie najpierw rekurencyjnie aktualizowało ACL do katalogu z ciągiem ContinueOnFailure, a niektóre elementy nie powiodły się, a następnie wznawiaj elementy, których niepowodzenie nie powiodło się, jeden po drugiej.
...
Wielkość partii powinna być między 1 a 2000.
