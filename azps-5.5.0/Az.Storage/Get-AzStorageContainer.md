...
## OPIS
Polecenie **cmdlet Get-AzStorageContainer** wyświetla listę kontenerów magazynu skojarzonych z kontem magazynu na platformie Azure.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie obiektu blob magazynu platformy Azure według nazwy
```
PS C:\>Get-AzStorageContainer -Name container*
```

W tym przykładzie do zwrócenia listy wszystkich kontenerów o nazwie, która zaczyna się od kontenera, jest używany symbol wieloznaczny.

### Przykład 2. Pobierz kontener magazynu platformy Azure według prefiksu nazwy kontenera
```
PS C:\>Get-AzStorageContainer -Prefix "container"
```

W tym przykładzie użyto *parametru Prefix* w celu zwrócenia listy wszystkich kontenerów o nazwie, która rozpoczyna się od kontenera.
...
Uprawnienia kontenera nie zostaną pobrane w przypadku użycia kontekstu magazynu utworzonego za pomocą tokenu SAS, ponieważ uprawnienia kontenera zapytań wymagają uprawnień klucza konta magazynu.
...
Jeśli nazwa kontenera jest pusta, polecenie cmdlet wyświetla listę wszystkich kontenerów.
W przeciwnym razie wyświetla listę wszystkich kontenerów, które pasują do określonej nazwy lub zwykłego wzorca nazw.
...
### —Prefiks
Określa prefiks używany w nazwie kontenera lub kontenerów, które mają zostać użyte.
Dzięki temu można znaleźć wszystkie kontenery, które zaczynają się od tego samego ciągu znaków, na przykład "my" lub "test".
