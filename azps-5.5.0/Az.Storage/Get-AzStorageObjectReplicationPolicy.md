...
## OPIS
Polecenie **cmdlet Get-AzStorageObjectReplicationPolicy** pobiera lub wyświetla zasady replikacji obiektów konta magazynu.

## PRZYKŁADY

### Przykład 1. Pobierz zasady replikacji obiektu z określonym identyfikatorem zasad i pokaż jego reguły.
```
...
### Przykład 2.Lista zasad replikacji obiektów z konta magazynu
```
...
To polecenie zawiera listę zasad replikacji obiektów z konta magazynu.
