...
## OPIS
Aktualizacje polecenia cmdlet **Set-AzStorageShareStoredAccessPolicy** przechowywane w zasadach dostępu w magazynie platformy Azure.

## PRZYKŁADY

### Przykład 1. Aktualizowanie zasad dostępu przechowywanego w magazynie
```
PS C:\>Set-AzStorageShareStoredAccessPolicy -ShareName "ContosoShare" -Policy "GeneralPolicy" -Permission "rwdl"
```

To polecenie aktualizuje przechowywane zasady dostępu, które mają pełne uprawnienia do udziału.
...
### -ExpiryTime
Określa czas, w którym przechowywane zasady dostępu stają się nieprawidłowe.
...
### -NoExpiryTime
Wskazuje, że to polecenie cmdlet wyczyści właściwość **ExpiryTime** w przechowywanych zasadach dostępu.
...
### -NoStartTime
Wskazuje, że to polecenie cmdlet wyczyści właściwość **StartTime** w przechowywanych zasadach dostępu.
...
### — Uprawnienie
Określa uprawnienia w przechowywanych zasadach dostępu do uzyskiwania dostępu do udziału lub plików w jej obszarze.
...
### — StartTime
Określa czas, w którym przechowywane zasady dostępu stają się prawidłowe.
