...
## OPIS
**Aktualizacja-AzDataLakeAnalyticsComputePolicy** aktualizuje określoną regułę zasad obliczania dla określonej jednostki AAD na koncie usługi Azure Data Lake Analytics.
...
### — Konto
Nazwa konta, na które mają być aktualizowane zasady obliczania.
...
### -MinPriorityPerJob
Minimalny obsługiwany priorytet dla każdego zadania w tych zasadach. Musi zostać określony parametr MaxAnalyticsUnitsPerJob lub oba parametry.
