...
## OPIS
Polecenie Remove-AzDataLakeAnalyticsCatalogCredential usuwa poświadczenia katalogu Azure Data Lake Analytics.

## PRZYKŁADY

### Przykład 1. Usuwanie poświadczeń
```
...
### -DatabaseName
Określa nazwę bazy danych, w których są przechowywane poświadczenia.
...
### -PassThru
Wskazuje, że to polecenie cmdlet nie czeka na ukończenie operacji.
...
### — Hasło
Hasło poświadczenia.
Jest to wymagane, jeśli dzwoniący nie jest właścicielem konta.
...
### - Rekurencie
Wskazuje, że ta operacja usunięcia powinna zostać przebyna, a także usunąć i upuścić wszystkie zasoby zależne od tego poświadczenia.
