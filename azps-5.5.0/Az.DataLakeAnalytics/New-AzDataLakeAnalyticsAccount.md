...
### Przykład 1. Tworzenie konta usługi Data Lake Analytics
```
...
To polecenie tworzy konto usługi Data Lake Analytics o nazwie ContosoAdlAccount, które korzysta ze sklepu danych ContosoAdlStore, w grupie zasobów o nazwie ContosoOrg.

## PARAMETERS

### -DefaultDataLakeStore
Określa nazwę konta magazynu Data Lake Store, które ma być ustawiane jako domyślne źródło danych.
...
### — Lokalizacja
Określa lokalizację, w której ma być tworzyć konto Data Lake Analytics.
Obecnie obsługiwany jest tylko region Wschód STANÓW Zjednoczonych 2.
...
### - MaxAnalyticsUnits
Opcjonalne maksymalna liczba obsługiwanych jednostek analizy dla tego konta.
...
### -MaxJobCount
Opcjonalne maksymalna liczba obsługiwanych zadań uruchomionych w tym samym czasie w ramach konta. Jeśli nie zostanie określony, wartość domyślna to 3.
...
### -QueryStoreRetention
Opcjonalna liczba dni zachowywania metadanych zadania. Jeśli nie zostanie określona, wartością domyślną jest 30 dni.
...
Aby utworzyć grupę zasobów, użyj New-AzResourceGroup cmdlet.
