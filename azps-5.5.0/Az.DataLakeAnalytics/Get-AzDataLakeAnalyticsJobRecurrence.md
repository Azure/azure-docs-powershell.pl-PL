...
## OPIS
Reguła **Get-AzDataLakeAnalyticsJobRecurrence** pobiera określony cykl zadania usługi Azure Data Lake Analytics lub listę cyklu.
...
To polecenie pobiera określony cykl zadania o identyfikatorze "83cb7ad2-3523-4b82-b909-d478b0d8aea3" w koncie "contosoadla".

### Przykład 2. Uzyskiwanie listy wszystkich cyklu na koncie
```
PS C:\>Get-AzDataLakeAnalyticsJobRecurrence -AccountName "contosoadla"
```

To polecenie pobiera listę wszystkich cyklu na koncie "contosoadla"

## PARAMETERS

### — Konto
Nazwa konta usługi Data Lake Analytics, pod którą chcesz pobrać cykl zadania.
...
### -RecurrenceId
Identyfikator konkretnego cyklu zadania, dla których mają być zwracane informacje.
...
### -SubmittedAfter
Filtr opcjonalny, który zwraca cykle zadań przesyłane tylko po określonym czasie.
...
### -SubmittedBefore
Filtr opcjonalny, który zwraca cykle zadań przesłane tylko przed określonym czasem.
