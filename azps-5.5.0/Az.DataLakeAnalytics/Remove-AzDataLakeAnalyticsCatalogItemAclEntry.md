...
### Przykład 2. Usuwanie listy ACL użytkownika dla bazy danych
```powershell
...
To polecenie usuwa listę ACL bazy danych dla Patti Fuller z konta contosoadla.
...
### — Grupowanie
Usuwanie wpisu listy ACL wykazu dla grupy.
