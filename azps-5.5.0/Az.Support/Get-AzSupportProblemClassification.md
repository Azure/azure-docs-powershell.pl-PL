...
## SYNOPSIS
Uzyskaj klasyfikacje problemów dla określonej usługi.
...
### Przykład 1. Uzyskiwanie wszystkich opisów problemów dla usługi przy użyciu parametru identyfikatora usługi.
```powershell
...
### Przykład 2. Uzyskiwanie wszystkich opisów problemów dla usługi używającej nadrzędnego obiektu usługi
```powershell
...
### Przykład 3. Uzyskiwanie szczegółowych informacji o pojedynczym problemie classificaiton by id przez obiekt usługi piping
```powershell
...
### — Id
Identyfikator klasyfikacji problemu.
...
### - ServiceId
Identyfikator usługi, dla którego są pobierane wszystkie klasyfikacje problemów.
...
### -ServiceObject
Obiekt usługi, dla którego są pobierane klasyfikacje problemów.
