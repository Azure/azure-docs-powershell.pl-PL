...
### Przykład 1. Ponowne uruchamianie wystąpienia roli usługi w chmurze
```powershell
PS C:\> Restart-AzCloudService -ResourceGroupName "ContosOrg" -CloudServiceName "ContosoCS" -RoleInstanceName "ContosoFrontEnd_IN_0"
```

To polecenie powoduje ponowne uruchomienie wystąpienia roli o ContosoFrontEnd_IN_0 o nazwie ContosoCS, która należy do grupy zasobów o nazwie ContosOrg.
