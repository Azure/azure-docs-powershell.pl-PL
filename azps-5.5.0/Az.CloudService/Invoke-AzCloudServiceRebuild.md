...
### Przykład 1. Odbudowywanie wystąpień ról usługi w chmurze
```powershell
...
To polecenie odbuduje 2 wystąpienia ról ContosoFrontEnd_IN_0 i ContosoBackEnd_IN_1 usługi w chmurze o nazwie ContosoCS, które należą do grupy zasobów o nazwie ContosOrg.

### Przykład 2. Odbudowywanie wszystkich ról usługi w chmurze
```powershell
PS C:\> Invoke-AzCloudServiceRebuild -ResourceGroupName "ContosOrg" -CloudServiceName "ContosoCS" -RoleInstance "*"
```

To polecenie odbuduje wszystkie wystąpienia ról usługi w chmurze o nazwie ContosoCS, które należą do grupy zasobów o nazwie ContosOrg.
