...
## OPIS
Polecenie **cmdlet Remove-AzDeploymentManagerService** usuwa usługę w topologii usługi.
...
To polecenie usuwa usługę o nazwie ContosoService1 w topologii usługi ContosoServiceTopology w grupie ContosoResourceGroup.

### Przykład 2. Usuwanie usługi przy użyciu identyfikatora zasobu.
```powershell
...
### Przykład 3. Usuwanie usługi przy użyciu obiektu usługi.
```powershell
PS C:\> Remove-AzDeploymentManagerService -InputObject $serviceObject
```

To polecenie usuwa usługę, której nazwa, nazwa topologii usługi i grupa zasobów są zgodne odpowiednio z właściwościami Name (Nazwa_usługi) i NazwaGrupy Zasobów $serviceObject Grupy Zasobów.
...
Identyfikator zasobu topologii usługi, w którym powinna zostać utworzona usługa.
