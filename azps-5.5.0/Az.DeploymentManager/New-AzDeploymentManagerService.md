...
## OPIS
Polecenie **cmdlet New-AzDeploymentManagerService** tworzy usługę w topologii usługi i zwraca obiekt reprezentujący usługę.
Określ usługę według jej nazwy, topologii usługi oraz nazwy grupy zasobów. 

Polecenie cmdlet zwraca obiekt Service. Możesz zmodyfikować ten obiekt lokalnie, a następnie zastosować zmiany do usługi za pomocą Set-AzDeploymentManagerService cmdlet.
...
Tworzy nową usługę o nazwie ContosoService1 w topologii usługi ContosoServiceTopology w grupie zasobów ContosoResourceGroup w lokalizacji (Centralna usługa STANÓW Zjednoczonych). Właściwość TargetLocation wskazuje, że usługa ContosoService1 powinna zostać wdrożona w regionie Wschodnioazjatyckim w określonej subskrypcji.
...
### -ServiceTopologyName
Nazwa topologii usługi, do której należy ta usługa.
...
### -TargetLocation
Określa lokalizację, w której zostaną wdrożone zasoby w ramach usługi.
...
Określa subskrypcję, w której zostaną wdrożone zasoby w ramach usługi.
