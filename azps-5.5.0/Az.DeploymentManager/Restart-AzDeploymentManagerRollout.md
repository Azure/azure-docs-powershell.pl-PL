...
To polecenie powoduje ponowne uruchomienie zadania o nazwie ContosoRollout w grupie ContosoResourceGroup. Flaga SkipSucceed (Pomijanie) wskazuje, że wszystkie kroki, które już zostały ukończone pomyślnie, powinny zostać pominięte, a realizacja powinna być kontynuowana od miejsca, w którym ostatnio nie powiodło się.
...
To polecenie powoduje ponowne uruchomienie uruchomienia o nazwie ContosoRollout w grupie ContosoResourceGroup.
