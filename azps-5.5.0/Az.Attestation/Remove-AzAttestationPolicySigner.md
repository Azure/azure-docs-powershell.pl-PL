...
## OPIS
Polecenie Remove-AzAttestationPolicySigner cmdlet usuwa zaufanego podpiszącego zasady dla dzierżawy w atestacjach platformy Azure.
...
Usuń zaufanego podpisatora dla dostawcy poświadczenia o *nazwie pshtest.*
...
### — Podpis
Określa token sieci Web JSON JSON RFC7519 zawierający żądanie o nazwie "maa-policyCertificate", którego wartość jest kluczem sieci Web JSON JSON RFC7517 zawierającym zaufany klucz podpisywania do usunięcia.
