...
## OPIS
Polecenie Get-AzAttestationPolicySigners pobiera zaufanych osób podpisujących zasady z dzierżawy w usługach Azure Attestation.
...
Pobiera zaufanych osób podpisujących zasady do testu *pshtestu* dostawcy poświadczenia w grupie zasobów *psh-test-rg.*  Zwróć uwagę, że w przypadku tego dostawcy poświadczenia nie ma żadnych zaufanych osób podpisujących.
...
Pobiera zaufanych osób podpisujących zasady dla dostawcy poświadczenia *pshtest2* w grupie zasobów *psh-test-rg.*  Zwróć uwagę, że dla tego dostawcy poświadczenia istnieje jeden zaufany podpis.
...
Pobiera zaufanych osób podpisujących zasady dla domyślnego dostawcy poświadczenia w lokalizacji *w centrum usa.*  Pamiętaj, że nie ma żadnych zaufanych osób podpisujących w przypadku domyślnego dostawcy usług Attestation.
...
### -DefaultProvider
Określa to żądanie domyślnego dostawcy poświadczenia.
...
### — Lokalizacja
Określa lokalizację domyślnego dostawcy atestacji.
