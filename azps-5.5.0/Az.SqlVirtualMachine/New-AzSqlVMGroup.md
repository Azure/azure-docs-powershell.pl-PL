...
## OPIS
Polecenie New-AzSqlVMGroup cmdlet tworzy grupę maszyn wirtualnych języka Azure SQL.
...
Tworzy nową grupę maszyn wirtualnych języka Azure SQL z maszyną wirtualnej grupy testowej w grupie zasobów ResourceGroup01.
$profile obiekt typu Microsoft.Azure.Management.SqlVirtualMachine.Models.WsfcDomainProfile
...
### — Lokalizacja
Lokalizacja grupy maszyn wirtualnych języka SQL.
...
### — Oferta
Oferta grupy maszyn wirtualnych języka SQL.
...
### - SKU
Typ wersji sql virtual machine group.
