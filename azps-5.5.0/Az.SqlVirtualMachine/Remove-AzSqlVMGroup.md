...
## OPIS
Polecenie Remove-AzSqlVMGroup cmdlet usuwa grupę maszyn wirtualnych języka SQL.
...
Usuwa grupę maszyn wirtualnych języka Azure SQL "test-group" w grupie zasobów ResourceGroup01.
...
### -PassThru
Określa, czy usunięty zasób ma być wyprowadzony na koniec wykonywania polecenia cmdlet.
