...
## SYNOPSIS
Utwórz nowy kontroler Azure DevSpaces.
...
Utwórz kontroler DevSpaces w grupie zasobów devSpaceResourceGroup o nazwie devSpaceName. Użyj klastru clusterName jako obiektu docelowego dla tego kontrolera.
...
### -TargetClusterName
Target Cluster Name (Nazwa klastrów docelowych).
...
Nazwa grupy zasobów docelowych.
