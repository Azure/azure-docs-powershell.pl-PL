...
## SYNOPSIS
Pobierz lub przygotuj listę kontrolera Azure DevSpaces.

## SKŁADNIA

### ListDevSpacesControllerParameterSet (Domyślne)
```
...
Lista wszystkich kontrolerów w ramach subskrypcji.
...
Uzyskaj kontrolery DevSpaces w ramach subskrypcji.
