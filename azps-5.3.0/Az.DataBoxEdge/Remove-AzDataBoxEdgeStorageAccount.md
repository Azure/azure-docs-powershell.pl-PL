...
## Opis
Polecenie cmdlet **Remove-AzDataBoxEdgeStorageAccount** usuwa powiązane konto magazynu Edge dla urządzenia z krawędzią pola danych. Możesz określić nazwę konta magazynu granicznego, które ma zostać usunięte jako parametr w poleceniu cmdlet.
