...
## Opis
Polecenie cmdlet **New-AzDataBoxEdgeUser** umożliwia utworzenie nowego użytkownika dla urządzenia z krawędzią pola danych. Możliwość tworzenia tylko użytkowników typu `Share` jest obsługiwana.
