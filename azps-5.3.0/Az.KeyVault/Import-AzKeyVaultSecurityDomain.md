...
## Opis
To polecenie cmdlet umożliwia zaimportowanie uprzednio wyeksportowanych danych domeny zabezpieczeń do zarządzanego modułu HSM.
...
Najpierw należy podać klucze, aby odszyfrować dane domeny zabezpieczeń.
Następnie polecenie **Import-AzKeyVaultSecurityDomain** przywraca poprzednie kopie zapasowe danych domeny zabezpieczeń w zarządzanym obszarze HSM przy użyciu tych kluczy.
...
### -Inputobject
Obiekt reprezentujący zarządzany element HSM.
...
### -Keys
Informacje o kluczach używanych do odszyfrowania danych domeny zabezpieczeń.
Zobacz przykłady ich konstruowania.
...
### -PassThru
Po określeniu wartość logiczna zostanie zwrócona, gdy polecenie cmdlet zostanie wykonane pomyślnie.
...
### -SecurityDomainPath
Określ ścieżkę do danych zaszyfrowanej domeny zabezpieczeń.
