...
## STRESZCZENIe
Pobiera profil SSL bramy Application Gateway.
...
## Opis
Polecenie cmdlet **Get-AzApplicationGatewaySslProfile** pobiera profil SSL bramy Application Gateway.
...
Pierwsze polecenie uzyskuje bramkę Application Gateway o nazwie ApplicationGateway01 w grupie zasobów o nazwie ResourceGroup01 i zapisuje ją w zmiennej $AppGw. Drugie polecenie pobiera profil SSL SslProfile01 dla $AppGw i zapisuje go w zmiennej $profile.
