...
## Opis
Polecenie cmdlet **Add-AzApplicationGatewayTrustedRootCertificate** umożliwia dodanie zaufanego certyfikatu głównego do bramy aplikacji platformy Azure.
...
Drugie polecenie dodaje nowy zaufany certyfikat główny do ścieżki usługi Application Gateway z głównego certyfikatu jako danych wejściowych.
Trzecie polecenie tworzy nowe ustawienie http zaplecza przy użyciu zaufanego certyfikatu głównego, aby sprawdzić poprawność certyfikatu serwera zaplecza.
Czwarte polecenie aktualizuje bramę Application Gateway.
