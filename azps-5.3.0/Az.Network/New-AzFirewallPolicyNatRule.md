...
## Opis
Polecenie cmdlet **New-AzFirewallPolicyNatRule** tworzy regułę NAT dla zasad zapory platformy Azure.
...
W tym przykładzie przedstawiono tworzenie reguły NAT z adresem źródłowym, protokołem, adresem docelowym, portem docelowym, adresem przetłumaczonym i przetłumaczonym portem.
...
W tym przykładzie przedstawiono tworzenie reguły NAT z adresem źródłowym, protokołem, adresem docelowym, portem docelowym, przetłumaczoną nazwą FQDN i przetłumaczonym portem.
...
### -DestinationAddress
Adresy docelowe reguły. Ten adres musi być publicznym adresem IP zapory.
...
### -TranslatedAddress
Adres przetłumaczony tej reguły NAT
...
### -TranslatedFqdn
Przetłumaczona nazwa FQDN dla tej reguły NAT
...
### -TranslatedPort
Przetłumaczony port dla tej reguły NAT
