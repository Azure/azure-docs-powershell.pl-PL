...
### Przykład 2: Wyświetlanie listy modułów równoważenia obciążenia przy użyciu funkcji filtrowania
```
...
To polecenie pobiera wszystkie moduły równoważenia obciążenia o nazwie rozpoczynającej się od tekstu "MyLoadBalancer".
