...
## STRESZCZENIe
Zwraca konfigurację adresu zaplecza modułu równoważenia obciążenia. 

## POLECENIA

### SetByResourcePublicIpAddress (domyślny)
```
...
### Przykład 1: Nowa konfiguracja adresu usługi równoważenia obciążenia z odwołaniem do sieci wirtualnej
```powershell
PS C:\> $virtualNetwork = Get-AzVirtualNetwork -Name $vnetName -ResourceGroupName $resourceGroup
New-AzLoadBalancerBackendAddressConfig -IpAddress "10.0.0.5" -Name "TestVNetRef" -VirtualNetworkId $virtualNetwork.Id
```

### Przykład 2: Nowa konfiguracja adresu usługi równoważenia obciążenia z adresem IP frontonu modułu równoważenia obciążenia
```powershell
...
### -Adres_IP
Adres IP dodawany do puli zaplecza
...
Konfiguracja adresu IP frontonu modułu równoważenia obciążenia skojarzona z konfiguracją adresów zaplecza
...
### -Name (nazwa)
Nazwa konfiguracji adresu zaplecza
...
### -VirtualNetworkId
Sieć wirtualna skojarzona z konfiguracją adresu zaplecza
