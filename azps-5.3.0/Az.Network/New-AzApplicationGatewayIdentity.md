...
## Opis
Polecenie cmdlet **New-AzApplicationGatewayIdentity** tworzy obiekt tożsamości bramy aplikacji.
...
W tym przykładzie tworzymy tożsamość przydzieloną użytkownikowi, a następnie odwołujesz się do niej w obiekcie Identity (tożsamość), który jest wykorzystywany z bramą Application Gateway.
