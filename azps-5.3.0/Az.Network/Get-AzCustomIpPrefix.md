...
## Opis
Polecenie cmdlet **Get-AzCustomIpPrefix** pobiera co najmniej jeden CustomIpPrefixes z danym zestawem parametrów wejściowych
...
To polecenie pobiera zasób CustomIpPrefix o nazwie myCustomIpPrefix w grupie zasobów myRg
