...
## Opis
Polecenie cmdlet **Get-AzPrivateEndpoint** pobiera jeden lub więcej prywatnych punktów końcowych.

## Przykłady

### Przykład 1: pobieranie prywatnego punktu końcowego
```powershell
...
To polecenie uzyskuje prywatny punkt końcowy o nazwie MyPrivateEndpoint1 w grupie zasób TestResourceGroup

### Przykład 2: wyświetlanie wszystkich prywatnych punktów końcowych w obszarze zasobów
```powershell
...
To polecenie powoduje wyświetlenie wszystkich prywatnych punktów końcowych w grupie zasobów TestResourceGroup
