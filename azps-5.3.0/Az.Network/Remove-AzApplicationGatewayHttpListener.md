...
## Opis
Polecenie cmdlet **Remove-AzApplicationGatewayHttpListener** usuwa odbiornik http z bramy aplikacji platformy Azure.

## Przykłady

### Przykład 1: usuwanie odbiornika HTTP bramy aplikacji
```
...
Drugie polecenie usuwa odbiornik HTTP o nazwie Listener02 z bramy aplikacji przechowywanej w $AppGw.

## PARAMETRÓW

### -ApplicationGateway
Określa bramę aplikacji, z której ma zostać usunięty odbiornik HTTP.
...
### -Name (nazwa)
Określa nazwę odbiornika HTTP, który usuwa ten polecenie cmdlet.
