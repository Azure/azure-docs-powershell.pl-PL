...
## Opis
To polecenie wylicza elementy równorzędne protokołu BGP brama usługi Azure Virtual Network jest skonfigurowana jako peer. Stan każdego elementu równorzędnego jest również podany.
...
Pobiera elementy równorzędne BGP dla bramy sieci wirtualnej platformy Azure o nazwie gatewayname w grupie zasobów Resource Group.
W tym przykładzie pokazano, który połączony element równorzędny BGP ma adres IP 10.0.0.254.
...
### -Peer
IP elementu równorzędnego, aby pobrać stan
