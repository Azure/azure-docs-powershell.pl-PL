...
## STRESZCZENIe
Pobieranie dokumentu autoryzacji dla portu usługi Express Route.
...
## Opis
New-AzExpressRoutePortLOA polecenia cmdlet pobiera dokument autoryzacji listu w formacie PDF dla portu Express Route.
...
Pobierz dokument autoryzacji listu "Moja port" obiektu "mójMagazyn" i Zapisz go w pliku "loa.pdf".
...
### -CustomerName
Nazwa klienta, do którego jest przypisany dany port Express Route.
...
### -Miejsce docelowe
Ścieżka wyjściowa w celu zapisania listy autoryzacji.
...
### -ExpressRoutePort
Zasób portów usługi Express Route.
...
### -ResourceGroupName
Nazwa grupy zasobów portu usługi Express Route.
