...
## Opis
Polecenie cmdlet New-AzDdosProtectionPlan tworzy plan ochrony DDoS.

## Przykłady

### Przykład 1: Tworzenie i kojarzenie planu ochrony DDoS z nową siecią wirtualną
```
...
Następnie tworzymy nową sieć wirtualną z **nowymi — AzVirtualNetwork** i określimy identyfikator nowo utworzonego planu w parametrze **DdosProtectionPlanId**. W tym przypadku ze względu na to, że kojarzy sieć wirtualną z planem, możemy także określić parametr **EnableDdoSProtection**.

### Przykład 2: Tworzenie i kojarzenie planu ochrony DDoS z istniejącą siecią wirtualną
```
D:\> $ddosProtectionPlan = New-AzDdosProtectionPlan -ResourceGroupName ResourceGroupName -Name DdosProtectionPlanName -Location "West US"
...
Najpierw tworzymy nowy plan ochrony DDoS za pomocą polecenia **New-AzDdosProtectionPlan** .
Następnie uzyskujemy najnowszą wersję sieci wirtualnej, którą chcemy skojarzyć z planem. Aktualizacja właściwości **DdosProtectionPlan** z obiektem **PSResourceId** zawierającym odwołanie do identyfikatora nowo utworzonego planu. W tym przypadku, jeśli skojarzię sieć wirtualną z planem ochrony DDoS, możemy również ustawić flagę **EnableDdosProtection** na true (prawda).
Na koniec nowy stan utrzymuje się, gdy zmienna lokalna jest ustawiona na **Set-AzVirtualNetwork**.
...
### — Lokalizacja
Określa lokalizację planu ochrony DDoS, który ma zostać utworzony.
...
### -Name (nazwa)
Określa nazwę planu ochrony DDoS, który ma zostać utworzony.
...
### -ResourceGroupName
Określa grupę zasobów dla planu ochrony DDoS, który ma zostać utworzony.
