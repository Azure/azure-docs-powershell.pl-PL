...
Polecenie cmdlet **Remove-AzVpnClientIpsecParameter** usuwa niestandardowe parametry IPsec sieci VPN ustawione na bramie sieci wirtualnej, które z kolei ustawia domyślne zasady IPSec sieci VPN w BRAMie VPN na podstawie przekazana nazwy VirtualNetworkGateway i grupy zasobów.

## Przykłady

### Przykład 1: usuwa ustawienia Ustawianie parametrów IPsec sieci VPN ustawione w bramie sieci wirtualnej
```powershell
