...
### Przykład 2: Tworzenie zewnętrznej konfiguracji adresów IP dla modułu równoważenia obciążenia przy użyciu prefiksu IP
```
...
Pierwsze polecenie powoduje utworzenie publicznego prefiksu adresu IP o nazwie MyPublicIP w grupie zasobów o nazwie NazwaMojejZmiennej, a następnie zapisanie go w zmiennej $publicipprefix.
Drugie polecenie tworzy konfigurację adresu IP frontonu o nazwie FrontendIpConfig01 przy użyciu publicznego prefiksu IP w $publicipprefix.
