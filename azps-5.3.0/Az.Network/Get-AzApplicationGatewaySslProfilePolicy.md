...
## STRESZCZENIe
Pobiera zasady SSL profilu SSL bramy aplikacji.
...
## Opis
Polecenie cmdlet **Get-AzApplicationGatewaySslProfilePolicy** pobiera zasady SSL profilu SSL bramy Application Gateway.
...
Pierwsze polecenie uzyskuje bramkę Application Gateway o nazwie ApplicationGateway01 w grupie zasobów o nazwie ResourceGroup01 i zapisuje ją w zmiennej $AppGw. Drugie polecenie pobiera profil SSL o nazwie SslProfile01 dla $AppGw i zapisuje go $SslProfile zmiennej. Ostatnie polecenie pobiera zasady SSL z profilu SSL $SslProfile i zapisuje je w zmiennej $sslpolicy.
...
[Nowe — AzApplicationGatewaySslProfilePolicy](./New-AzApplicationGatewaySslProfilePolicy.md)

[Dodaj-AzApplicationGatewaySslProfilePolicy](./Add-AzApplicationGatewaySslProfilePolicy.md)
