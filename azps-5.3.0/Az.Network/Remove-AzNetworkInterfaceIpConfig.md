...
### Przykład 1: Usuwanie konfiguracji adresów IP z interfejsu sieciowego
```powershell
...
Pierwsze polecenie uzyskuje interfejs sieciowy o nazwie mynic i zapisuje go w zmiennej $nic. Drugie polecenie usuwa konfigurację IP o nazwie IPConfig-1 skojarzoną z tym interfejsem sieciowym. Trzy polecenia ustawiają zmiany wprowadzone w interfejsie sieciowym.
