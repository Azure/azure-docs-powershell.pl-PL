...
## Opis
Polecenie cmdlet Remove-AzApplicationGatewayBackendHttpSetting usuwa ustawienia protokołu HTTP (Hypertext Transfer Protocol) z bramy aplikacji platformy Azure.

## Przykłady

### Przykład 1: usuwanie ustawień wewnętrznych protokołu HTTP z bramy aplikacji
```
...
Drugie polecenie usuwa ustawienie HTTP zaplecza o nazwie BackEndSetting02 od bramy aplikacji przechowywanej w $AppGw.

## PARAMETRÓW

### -ApplicationGateway
Określa bramę aplikacji, z której to polecenie cmdlet usuwa ustawienia HTTP zaplecza.
...
### -Name (nazwa)
Określa nazwę ustawienia HTTP zaplecza, które zostanie usunięte przez to polecenie cmdlet.
