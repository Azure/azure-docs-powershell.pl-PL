...
Powyższa grupa utworzy grupę zasobów, wirtualną sieć WAN i VpnSite z 1 VpnSiteLinks w zachodnim stanie Stanów Zjednoczonych w grupie zasobów "testRG" na platformie Azure.

### Przykład 2

Tworzy obiekt Azure VpnSiteLink. (autogenerowana)
...
### -BGPAsn
Protokół BGP ASN dla tego VpnSiteLink.
...
### -BGPPeeringAddress
Adres równorzędny BGP dla tego VpnSiteLink.
