...
Polecenie cmdlet **Set-AzExpressRouteGateway** umożliwia zaktualizowanie jednostek skali dla istniejącej ExpressRouteGateway lub aktualizowanie znaczników zasobów.
...
### -Inputobject
ExpressRouteGateway, który należy zaktualizować.
...
### -ResourceGroupName
Nazwa grupy zasobów ExpressRouteGateway, która ma zostać zaktualizowana.
...
### -ResourceId
Identyfikator ExpressRouteGateway, który należy zaktualizować.
