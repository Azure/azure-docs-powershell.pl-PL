...
### -PassThru
Po ustawieniu polecenie cmdlet zwróci obiekt reprezentujący definicję eksportowanego elementu. Domyślnie to polecenie cmdlet nie generuje żadnych danych wyjściowych.
