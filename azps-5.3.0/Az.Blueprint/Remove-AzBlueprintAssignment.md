...
### BySubscriptionAndName (domyślny)
```
...
### -ManagementGroupId
Identyfikator grupy zarządzania, w której jest zapisywane zadanie tworzenia pozycji plan.
...
### -PassThru
Po ustawieniu polecenie cmdlet zwróci obiekt reprezentujący usunięte zadanie tworzenia planów. Domyślnie to polecenie cmdlet nie generuje żadnych danych wyjściowych.
