...
### Przykład 1. Uruchom serwer według nazwy zasobu
```powershell
PS C:\> Start-AzMySqlFlexibleServer -ResourceGroupName PowershellMySqlTest -Name mysql-test
```

Uruchamianie serwera za pomocą nazwy

### Przykład 2: uruchamianie serwera za pomocą tożsamości
```powershell
...
Uruchamianie serwera za pomocą tożsamości
