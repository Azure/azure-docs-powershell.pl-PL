...
### Przykład 1: zatrzymywanie serwera według nazwy zasobu
```powershell
PS C:\> Stop-AzMySqlFlexibleServer -ResourceGroupName PowershellMySqlTest -Name mysql-test
```

Zatrzymywanie serwera za pomocą nazwy

### Przykład 2: zatrzymywanie serwera za pomocą tożsamości
```powershell
...
Zatrzymywanie serwera za pomocą tożsamości
