...
Umożliwia zaktualizowanie określonego obszaru nazw koncentratora zdarzeń. (autogenerowana)

```powershell <!-- Aladdin Generated Example --> 
Set-AzEventHubNamespace -Location 'WestUS' -Name MyNamespaceName -ResourceGroupName MyResourceGroupName -SkuName Basic
```

### Przykład 5: Tworzenie i aktualizowanie obszaru nazw za pomocą zarządzania tożsamością w klastrze 
```powershell
...
### -Identity (tożsamość)
Włączanie lub wyłączanie tożsamości obszaru nazw
...
### -Właściwość
Lista właściwości klucza, @ (@ (NazwaKlucza, KeyVaultUri, wersja klawiszowa), @ (NazwaKlucza, KeyVaultUri, wersja klawiszowa))
...
### System. Nullable "1 [[Microsoft. Azure. Commands. EventHub. MODELES. NamespaceState; Microsoft. Azure. PowerShell. PowerShell. w usłudze EventHub, Version = 1.4.3.0, Culture = neutral, PublicKeyToken = null]]
