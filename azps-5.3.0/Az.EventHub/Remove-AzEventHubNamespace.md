...
## Opis
Polecenie cmdlet Remove-AzEventHubNamespace powoduje usunięcie i usunięcie określonego obszaru nazw koncentratora zdarzeń.
...
### Przykład 5: ResourceId — korzystanie z połączeń rurowych:
```powershell
