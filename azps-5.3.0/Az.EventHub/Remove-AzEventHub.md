...
## Opis
Polecenie cmdlet Remove-AzEventHub powoduje usunięcie i usunięcie określonego centrum zdarzeń z danego obszaru nazw.
...
### Przykład 3: wejście przy użyciu połączeń rurowych:
```powershell
