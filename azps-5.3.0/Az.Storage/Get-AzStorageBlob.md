...
### Przykład 5: pobieranie wszystkich obiektów BLOB w kontenerze Uwzględnij wersję BLOB
```
...
To polecenie pobiera wszystkie obiekty blob w kontenerze include w wersji BLOB.

### Przykład 6: uzyskiwanie pojedynczej wersji obiektu BLOB
```
...
To polecenie pobiera pojedyncze obiekty blob verion z VersionId.

### Przykład 7: uzyskiwanie pojedynczej migawki obiektu BLOB
```
...
To polecenie pobiera pojedynczą migawkę obiektów blob z SnapshotTime.
...
### -IncludeVersion
Wersje obiektu BLOB będą wyświetlane tylko wtedy, gdy ten parametr jest obecny, domyślnie funkcja Pobierz obiekt BLOB nie będzie zawierać wersji obiektu BLOB.
