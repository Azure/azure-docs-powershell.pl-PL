...
### Przykład 1: pobieranie właściwości usługi plików magazynu platformy Azure określonego konta magazynu
```powershell
...
To polecenie pobiera właściwość usługi plików określonego konta magazynu.
