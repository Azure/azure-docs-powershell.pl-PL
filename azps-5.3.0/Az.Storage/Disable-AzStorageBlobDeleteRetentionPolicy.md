...
## Opis
Polecenie cmdlet **disable-AzStorageBlobDeleteRetentionPolicy** wyłącza zasady dotyczące przechowywania obiektów BLOB usługi Azure Storage.

## Przykłady

### Przykład 1. Wyłącz zasady usuwania zasad przechowywania dla usługi BLOB
```
...
To polecenie wyłącza zasady usuwania zasad przechowywania dla usługi BLOB.
