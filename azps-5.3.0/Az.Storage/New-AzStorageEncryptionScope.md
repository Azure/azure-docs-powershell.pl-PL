...
## Opis
Polecenie cmdlet **New-AzStorageEncryptionScope** umożliwia utworzenie zakresu szyfrowania dla konta magazynu.
...
To polecenie tworzy zakres szyfrowania z szyfrowaniem magazynu.

### Przykład 2: Tworzenie zakresu szyfrowania z szyfrowaniem za pomocą magazynu klucza
```
...
To polecenie tworzy zakres szyfrowania z szyfrowaniem za pomocą magazynu klucza.
