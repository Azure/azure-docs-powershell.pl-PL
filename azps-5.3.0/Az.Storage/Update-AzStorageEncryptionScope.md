...
### Przykład 3: aktualizowanie zakresu szyfrowania w celu użycia szyfrowania magazynu
```
...
To polecenie umożliwia zaktualizowanie zakresu szyfrowania w celu użycia szyfrowania magazynu.

### Przykład 4: aktualizowanie zakresu szyfrowania w celu używania szyfrowania opartego na magazynie
```
...
To polecenie updtaes zakres szyfrowania w celu korzystania z szyfrowania magazynu.
Tożsamość konta magazynu musi mieć uprawnienia Get, wrapkey, unwrapkey dla klucza magazynu kluczy.
...
### -KeyvaultEncryption
Tworzenie zakresu szyfrowania za pomocą źródła klucza Microsoft.
...
### -State
Aktualizuj stan zakresu szyfrowania, możliwe wartości obejmują: "włączony", "wyłączony".
...
### -StorageEncryption
Utwórz zakres szyfrowania za pomocą źródła klucza Microsoft. Storage.
