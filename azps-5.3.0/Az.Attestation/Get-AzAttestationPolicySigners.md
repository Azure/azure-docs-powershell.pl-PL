...
## Opis
Polecenie cmdlet Get-AzAttestationPolicySigners uzyskuje osoby z listy zaufanych zasad od dzierżawy w zaświadczeniu platformy Azure.
...
Pobiera zaufane osoby podpisujące zasad dla dostawcy zaświadczania *pshtest* w grupie zasób *PSH-test-RG*.  Pamiętaj, że nie ma żadnych zaufanych podpisujących dla tego dostawcy zaświadczania.
...
Pobiera zaufane osoby podpisujące zasad dla dostawcy zaświadczania *pshtest2* w grupie zasób *PSH-test-RG*.  Pamiętaj, że istnieje jedno zaufanego podpisującego tego dostawcę zaświadczania.
...
Pobiera zaufane osoby podpisujące zasad dla domyślnego dostawcy zaświadczania w polu Lokalizacja *Centralna my*.  Pamiętaj, że nie istnieją zaufane osoby podpisujące domyślnego dostawcę zaświadczania.
