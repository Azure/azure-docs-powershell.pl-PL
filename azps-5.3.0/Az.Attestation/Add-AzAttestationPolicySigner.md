...
### -Osoba podpisująca
Określa token sieci Web JSON RFC7519 zawierający oświadczenie o nazwie "Maa-policyCertificate", którego wartość jest kluczem sieci Web kodu JSON usługi RFC7517, który zawiera nowy zaufany klucz podpisywania do dodania.
