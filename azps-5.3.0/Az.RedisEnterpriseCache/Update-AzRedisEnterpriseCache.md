...
### Przykład 1: Aktualizacja pamięci podręcznej w usłudze Redis Enterprise
```powershell
...
To polecenie powoduje zaktualizowanie minimalnej wersji protokołu TLS i dodanie znacznika do pamięci podręcznej Redis Enterprise o nazwie moja pamięć podręczna.
