...
To polecenie umożliwia zaimportowanie pliku bazy danych do bazy danych pamięci podręcznej usługi Redis Enterprise o nazwie moja pamięć podręczna.
...
### -SasUri
Identyfikator URI SAS dla docelowego obiektu BLOB do zaimportowania
