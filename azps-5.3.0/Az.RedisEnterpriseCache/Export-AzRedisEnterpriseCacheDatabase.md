...
To polecenie eksportuje bazę danych pamięci podręcznej usługi Redis Enterprise o nazwie moja pamięć podręczna do pliku bazy danych.
...
### -SasUri
Identyfikator URI SAS dla katalogu docelowego do wyeksportowania
