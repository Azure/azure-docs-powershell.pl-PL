...
### Przykład 1. Usuń pulpit nawigacyjny
```powershell
...
### Przykład 2: usuwanie pulpitu nawigacyjnego za pomocą potoku
```powershell
PS C:\> Get-AzPortalDashboard -ResourceGroupName my-rg -DashboardName dashbase02 | Remove-AzPortalDashboard
```

Usuń pulpit nawigacyjny zwrócony przez Get-AzDashboard połączenie.
