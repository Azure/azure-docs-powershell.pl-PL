...
## Opis
Polecenie cmdlet **New-AzPowerBIWorkspaceCollection** tworzy kolekcję obszarów roboczych usługi Power BI dla subskrypcji platformy Azure w określonej grupie zasobów i lokalizacji.
...
To polecenie tworzy kolekcję obszarów roboczych o nazwie WCN11 w określonej lokalizacji w grupie zasobów.
...
### — Lokalizacja
Określa lokalizację platformy Azure, w której to polecenie cmdlet tworzy kolekcję obszarów roboczych.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, w której to polecenie cmdlet tworzy kolekcję obszarów roboczych.
...
Określa nazwę kolekcji obszaru roboczego usługi Power BI.
