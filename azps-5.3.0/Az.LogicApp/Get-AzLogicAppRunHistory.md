...
## Opis
Polecenie cmdlet **Get-AzLogicAppRunHistory** pobiera historię przebiegu aplikacji logicznej.
...
### Przykład 1: uzyskiwanie historii uruchamiania aplikacji logicznej
```powershell
...
To polecenie pobiera historię przebiegu aplikacji logicznej o nazwie LogicApp03.

### Przykład 2: uzyskiwanie uruchamiania aplikacji logicznej
```powershell
...
To polecenie pobiera określoną aplikację logiczną w celu uruchomienia aplikacji logicznej o nazwie LogicApp03.
...
To polecenie pobiera całą historię przebiegu aplikacji logicznej o nazwie LogicApp03, wykonując NextPageLink.
...
To polecenie umożliwia pobieranie pierwszych dwóch stron historii uruchamiania aplikacji logicznej o nazwie LogicApp03, wykonując NextPageLink i ograniczając rozmiar wyniku do dwóch stron.
Każda Strona zawiera trzydzieści wyników.
...
### -FollowNextPageLink
Wskazuje, że polecenie cmdlet powinno śledzić linki Następna strona.
...
Określa, ile razy należy śledzić łącza Następna strona, jeśli FollowNextPageLink jest używana.
...
### -Name (nazwa)
Określa nazwę aplikacji logicznej, dla której to polecenie cmdlet pobiera historię uruchamiania.
...
### -ResourceGroupName
Określa nazwę grupy zasobów zawierającej aplikację logiczną.
...
To polecenie cmdlet umożliwia uruchomienie przepływu pracy, który określa ten aplet polecenia.
...
### Microsoft. Azure. Management. Logic. MODELES. WorkflowRun
