...
## STRESZCZENIe
Aktualizuje grupę źródeł sieci CDN
...
## Opis
Set-AzCdnOriginGroup zaktualizuje określoną grupę pochodzenia w danym punkcie końcowym. 
...
```
To polecenie cmdlet spowoduje zaktualizowanie właściwości ProbeIntervalInSeconds w grupie pochodzenie. 
