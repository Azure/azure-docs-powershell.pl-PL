...
### -Miejsce docelowe
Zdefiniuj względny adres URL, do którego będą ponownie zapisywane powyższe żądania.
...
### -PreservePath
Czy zachować niedopasowaną ścieżkę.
...
### -QueryParameter
Parametry zapytań do dołączania lub wykluczania (rozdzielany przecinkami).
...
### -QueryStringBehavior
Zachowanie kwerendy QueryString dla żądań
...
### -SourcePattern
Zdefiniuj wzorzec adresu URL żądania określający typ żądań, które mogą być ponownie zapisane. Jeśli wartość jest pusta, są dopasowywane wszystkie ciągi.
