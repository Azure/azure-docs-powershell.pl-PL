...
## STRESZCZENIe
Pobiera poświadczenia DATAbox określonego zadania
...
## Opis
Polecenie cmdlet **Get-AzDataBoxCredential** Pobiera poświadczenia DATAbox określonego zadania. Wewnętrzne Właściwości zwróconego obiektu poświadczenia będą inne dla różnych typów jednostek SKU.
...
To retuns JobSecrets określonego zadania
...
### System. Collections. Generic. IEnumerable ' 1 [[Microsoft. Azure. Management. DataBox. MODELES. UnencryptedCredentials, Microsoft. Azure. Management. DataBox, Version = 1.0.0.0, Culture = neutral, PublicKeyToken = 31bf3856ad364e35]]
