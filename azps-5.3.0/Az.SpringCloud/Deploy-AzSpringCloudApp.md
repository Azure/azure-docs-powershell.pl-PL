...
### Przykład 1: wdrażanie lokalnego skompilowanego jar w celu obsługi według nazwy.
```powershell
...
Wdrażanie lokalnego skompilowanego jar w celu obsługi według nazwy.
