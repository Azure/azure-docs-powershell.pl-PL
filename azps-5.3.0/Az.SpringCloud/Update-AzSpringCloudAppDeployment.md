...
### Przykład 1: aktualizowanie wdrożenia w chmurze wiosennej według nazwy.
```powershell
...
Aktualizowanie wdrożenia w chmurze wiosennej według nazwy.

### Przykład 2: aktualizowanie wdrożenia chmury wiosennej z poziomu potoku.
```powershell
...
Aktualizowanie wdrożenia chmury wiosennej z poziomu potoku.
...
### -SourceArtifactSelector
Selektor dla artefaktu, który ma być wykorzystywany do wdrożenia projektów z wieloma modułami.
Powinno to Bethe względną ścieżkę do docelowego modułu/projektu.
...
### -SourceRelativePath
Ścieżka względna miejsca do magazynowania, w którym jest przechowywany źródłowy
...
### Microsoft. Azure. PowerShell. polecenia. SpringCloud. models. Api20200701. IDeploymentResource
