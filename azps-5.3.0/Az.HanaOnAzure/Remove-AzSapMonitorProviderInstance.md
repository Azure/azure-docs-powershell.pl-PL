...
### Przykład 1: usuwanie wystąpienia monitora protokołu SAP według nazwy
```powershell
PS C:\> Remove-AzSapMonitorProviderInstance -ResourceGroupName nancyc-hn1 -SapMonitorName ps-spamonitor-t01 -Name ps-sapmonitorins-t02

```

To polecenie powoduje usunięcie wystąpienia monitora protokołu SAP według nazwy.

### Przykład 2: usuwanie wystąpienia monitora protokołu SAP według obiektów
```powershell
...
To polecenie powoduje usunięcie wystąpienia monitora protokołu SAP według obiektu.
