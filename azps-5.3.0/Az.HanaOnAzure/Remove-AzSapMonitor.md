...
### Przykład 1: usuwanie monitora SAP według nazwy
```powershell
PS C:\> Remove-AzSapMonitor -ResourceGroupName nancyc-hn1 -Name ps-sapmonitor-t02

```

To polecenie usuwa Monitor protokołu SAP według nazwy.

### Przykład 2: usuwanie monitora SAP według obiektów
```powershell
...
To polecenie usuwa Monitor protokołu SAP według obiektu.
