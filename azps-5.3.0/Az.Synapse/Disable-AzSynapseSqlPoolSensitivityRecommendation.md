...
## STRESZCZENIe
Wyłączenie (odrzucanie) rekomendacji dotyczących wrażliwości na kolumny w puli SQL.
...
## Opis
Polecenie cmdlet Disable-AzSynapseSqlPoolSensitivityRecommendation wyłącza (odrzuca) zalecenia dotyczące wrażliwości na kolumny w puli SQL.

## Przykłady

### Przykład 1: wyłączanie rekomendacji dotyczących wrażliwości dla danej kolumny w puli usługi Azure Synapse SQL.
```powershell
...
### Przykład 2: wyłączanie zaleceń dotyczących wrażliwości na kolumny, które mają rekomendacje dotyczące wrażliwości w puli usługi Azure Synapse SQL, korzystając z połączeń rurowych.
```powershell
...
### Przykład 3: wyłączanie rekomendacji dotyczących wrażliwości dla danej kolumny w puli usługi Azure Synapse SQL przy użyciu połączeń rurowych.
```powershell
...
### -Inputobject
Obiekt reprezentujący klasyfikację wrażliwości puli SQL.
