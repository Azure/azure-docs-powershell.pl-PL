...
### StopSparkJobByIdParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **stop-AzSynapseSparkJob** anuluje zadanie usługi Synapse Analytics Spark.
...
To polecenie anuluje zadanie programu Synapse Analytics Spark.
...
To polecenie anuluje zadanie Synapse analiza zapłonu za pośrednictwem rurociągu.
