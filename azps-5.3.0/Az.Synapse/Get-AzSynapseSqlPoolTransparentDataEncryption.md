...
## Opis
Polecenie cmdlet **Get-AzSynapseSqlPoolTransparentDataEncryption** Pobiera stan przezroczystego szyfrowania danych (TDE) dla puli platformy Azure Synapse Analytics SQL.
...
To polecenie pobiera stan TDE dla puli SQL o nazwie ContosoSqlPool w obszarze roboczym o nazwie ContosoWorkspace.
