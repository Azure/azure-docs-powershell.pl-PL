...
## STRESZCZENIe
Usuwa typy informacji i etykiety liter kolumn w puli SQL.
...
## Opis
Polecenie cmdlet Remove-AzSynapseSqlPoolSensitivityClassification usuwa typy informacji oraz etykiety liter kolumn w puli SQL.

## Przykłady

### Przykład 1: usuwanie typu informacji i etykiety wrażliwości kolumny w puli platformy Azure Synapse SQL.
```powershell
...
### Przykład 2: usuwanie bieżących typów informacji i etykiet liter kolumn w puli usługi Azure Synapse SQL przy użyciu połączeń rurowych.
```powershell
...
### Przykład 3: usuwanie typu informacji i etykiety wrażliwości kolumny w puli usługi Azure Synapse SQL przy użyciu połączeń rurowych.
```powershell
