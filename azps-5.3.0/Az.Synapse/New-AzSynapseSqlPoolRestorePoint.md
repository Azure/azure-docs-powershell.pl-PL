...
## Opis
Polecenie cmdlet **New-AzSynapseSqlPoolRestorePoint** tworzy nowy punkt przywracania, z którego można przywrócić pulę SQL usługi Azure Synapse Analytics.
...
To polecenie tworzy punkt przywracania dla puli SQL o nazwie ContosoSqlPool w obszarze roboczym ContosoWorkspace.
...
### -RestorePointLabel
Etykieta, z którą jest skojarzony punkt przywracania, nie może być unikatowa.
