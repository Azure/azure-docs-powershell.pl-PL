...
## STRESZCZENIe
Ustawia typy informacji i oznakowań liter kolumn w puli SQL.
...
## Opis
Polecenie cmdlet Set-AzSynapseSqlPoolSensitivityClassification ustawia typy informacji oraz etykiety liter kolumn w puli SQL.

## Przykłady

### Przykład 1: Ustawianie typu informacji i etykiety wrażliwości kolumny w puli platformy Azure Synapse SQL.
```powershell
...
### Przykład 2: Ustawianie zalecanych typów informacji i etykiet wrażliwości kolumn w puli usługi Azure Synapse SQL.
```powershell
...
### Przykład 3: Ustawianie typu informacji i etykiety wrażliwości kolumny w puli usługi Azure Synapse SQL, przy użyciu połączeń rurowych.
```powershell
