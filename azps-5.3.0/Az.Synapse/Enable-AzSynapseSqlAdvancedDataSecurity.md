...
## STRESZCZENIe
Włączanie zaawansowanych zabezpieczeń danych w obszarze roboczym.

## POLECENIA

### EnableByNameParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **enable-AzSynapseSqlAdvancedDataSecurity** włącza zaawansowane zabezpieczenia danych w obszarze roboczym. Zaawansowane zabezpieczenia danych to ujednolicony pakiet zabezpieczeń, który obejmuje klasyfikację danych, ocenę luk w zabezpieczeniach i zaawansowaną ochronę przed zagrożeniami dla obszaru roboczego. (Nowe konto magazynu zostanie automatycznie utworzone w celu zapisania ocen dotyczących luk. Jeśli w tym celu utworzono wcześniej konto magazynu, zamiast tego zostanie użyte to polecenie.
...
To polecenie włącza zaawansowane zabezpieczenia danych w obszarze przestrzeń robocza.
...
To polecenie umożliwia zaawansowane bezpieczeństwo danych w obszarze roboczym za pośrednictwem rurociągu.
...
To polecenie umożliwia zaawansowane zabezpieczenie danych w obszarze roboczym za pośrednictwem rurociągu i nie powoduje automatycznego włączenia oceny luki w zabezpieczeniach.
