...
### Przykład 1: wyświetlanie wszystkich szablonów w ramach abonamentu
```powershell
...
To polecenie wyświetla listę wszystkich szablonów objętych abonamentem.

### Przykład 2: wyświetlanie wszystkich szablonów w grupie zasobów
```powershell
...
To polecenie wyświetla listę wszystkich szablonów znajdujących się w grupie zasobów.

### Przykład 3: uzyskiwanie szablonu pod grupą zasobów
```powershell
...
To polecenie pobiera szablon pod grupą zasobów.

### Przykład 4: uzyskiwanie szablonu pod grupą zasobów
```powershell
...
### Microsoft. Azure. PowerShell. polecenia. ImageBuilder. models. IImageBuilderIdentity
...
INPUTobject <IImageBuilderIdentity> : parametr Identity
  - `[Id <String>]`: Ścieżka tożsamości zasobu
  - `[ImageTemplateName <String>]`: Nazwa szablonu obrazu
  - `[ResourceGroupName <String>]`: Nazwa grupy zasobów.
  - `[RunOutputName <String>]`: Nazwa wyjścia do uruchomienia
