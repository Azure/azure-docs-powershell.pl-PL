...
## Opis
Polecenie cmdlet **Get-AzConsumptionUsageDetail** pobiera dane dotyczące użycia subskrypcji. 

## Przykłady

### Przykład 1: uzyskiwanie szczegółowych informacji o użyciu po rozszerzeniu MeterDetails
```powershell
...
### Przykład 2: pobieranie szczegółów użycia z zakresem dat
```powershell
...
### Przykład 3: uzyskiwanie szczegółowych informacji o użyciu BillingPeriodName przy użyciu filtru InstanceName
```powershell
...
### -EndDate
Data zakończenia (w formacie UTC) użycia do filtrowania.
...
### -Expand
Rozwijanie użycia na podstawie MeterDetails lub AdditionalInfo.
...
### -ResourceName
Grupa zasobów użycia do filtrowania.
...
### -DataRozpoczęcia
Data rozpoczęcia (w formacie UTC) użycia do filtrowania.
...
### -Tag
Znacznik użycia do filtrowania.
...
### Microsoft. Azure. Commands.. models. PSUsageDetail
