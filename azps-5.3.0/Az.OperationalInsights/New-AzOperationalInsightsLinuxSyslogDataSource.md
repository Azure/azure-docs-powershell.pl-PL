...
## Opis
Polecenie cmdlet **New-AzOperationalInsightsLinuxSyslogDataSource** umożliwia dodanie źródła danych dziennika systemowego do połączonych komputerów z systemem Linux w obszarze roboczym.
Usługa Azure Operational Insights może zbierać dane dziennika systemowego.

## Przykłady

### Przykład 1. Tworzenie źródeł danych dziennika systemowego
```
$FacilityNames       = @()
$FacilityNames      += 'auth'
