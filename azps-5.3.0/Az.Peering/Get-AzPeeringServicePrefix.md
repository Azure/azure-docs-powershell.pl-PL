...
## Opis
Wyświetlanie prefiksów usługi peer resystems dla obiektów usługi peer
...
Pobiera prefiksy dla usługi peer na podstawie poleceń połączeń rurowych.
...
Pobiera określony prefiks usługi peer na identyfikator zasobu.
...
Pobiera określony prefiks usługi peer with rozszerzone atrybuty
...
### -Expand
Wyświetlanie zdarzeń dotyczących prefiksu usługi peer
...
### -PeeringServiceName
Nazwa usługi peer. Użyj polecenia cmdlet New-AzPeeringService dla nowej usługi peer lub Get-AzPeeringService listy.
