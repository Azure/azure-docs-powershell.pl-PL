...
## Opis
Umożliwia utworzenie konfiguracji aktualizacji oprogramowania działającej według harmonogramu w celu zaktualizowania listy komputerów. Komputery obejmują zarówno maszyny wirtualne platformy Azure, jak i niedrukowalne komputery.

## Przykłady

### Przykład 1
Umożliwia utworzenie konfiguracji aktualizacji oprogramowania w celu zainstalowania aktualizacji krytycznych na dwóch maszynach wirtualnych z systemem Windows Azure po każdej soboty 9PM. W tym przykładzie jako czas trwania aktualizacji jest ustawiona wartość 2 godzin.
...
### -AzureQuery
Dynamiczna kwerenda grupowa Azure.
...
### -IncludedKbNumber
Liczba uwzględnionych aktualizacji: KB.
...
Uwzględniono klasyfikacje pakietów Linux.
...
Dołączono maski pakietów systemu Linux.
...
Uwzględnione klasyfikacje aktualizacji systemu Windows.
...
### -Linux
Wskazuje, że konfiguracja aktualizacji oprogramowania przekierowania komputerów systemu operacyjnego Linux.
...
### -NonAzureComputer
Nazwy komputerów, które nie są przez nią AZ.
...
### -NonAzureQuery
Grupa dynamiczna bez usługi Azure Query.
...
### -Schedule
Obiekt harmonogramu służący do konfiguracji aktualizacji oprogramowania.
...
### -Windows
Wskazuje, że konfiguracja aktualizacji oprogramowania ukierunkowana na komputery z systemem operacyjnym Windows.
