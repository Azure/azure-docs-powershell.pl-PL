...
## Opis
To polecenie cmdlet zwraca listę uruchomień komputera. Każde uruchomienie aktualizacji oprogramowania wyzwoli uruchomienie komputera na każdym komputerze docelowym konfiguracji aktualizacji oprogramowania. Aby uruchomić określony komputer, należy przejść do parametru ID. Możesz wyświetlić listę wszystkich uruchomionych komputerów, wszystkie są uruchamiane dla określonego komputera, wszystkie działają z określonym stanem przez przekazanie odpowiednich parametrów.

## Przykłady

### Przykład 1
W tym przykładzie jest zwracana wartość wszystkich nieudanych uruchomień komputera dla określonej maszyny wirtualnej platformy Azure.
...
### -ID
Identyfikator uruchomienia komputera aktualizacji oprogramowania.
...
### -SoftwareUpdateRunId
Identyfikator procesu aktualizacji oprogramowania.
...
### -TargetComputer
komputer docelowy jest uruchomiony na komputerze.
Może być albo nazwą komputera, albo identyfikatorem zasobu maszyny wirtualnej platformy Azure.
...
### System. Nullable "1 [[Microsoft. Azure. Commands. Automation. model. UpdateManagement. SoftwareUpdateMachineRunStatus, Microsoft. Azure. PowerShell. polecenia cmdlet. Automatyzacja, Version = 1.0.0.0, Culture = neutral; PublicKeyToken = null]]
