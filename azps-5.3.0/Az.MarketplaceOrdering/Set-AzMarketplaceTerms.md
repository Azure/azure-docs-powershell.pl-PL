...
## Opis
Polecenie cmdlet **Set-AzMarketplaceTerms** zapisuje obiekt terminy dla danego identyfikatora wydawcy (wydawcy), identyfikatora oferty (produktu) i identyfikatora planu (Name).
...
### Przykład 2
Ustaw umowę o wydawcy na "zaakceptuj". Pobierz wartość parametru "warunki" z polecenia cmdlet "Get-AzMarketplaceTerms"
...
### -Inputobject
Obiekt terms zwrócony w Get-AzMarketplaceTerms polecenia cmdlet. Jest to parametr obowiązkowy, jeśli parametr zaakceptowany ma wartość PRAWDA.
