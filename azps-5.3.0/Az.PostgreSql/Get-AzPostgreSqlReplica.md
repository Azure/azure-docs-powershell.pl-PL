...
### Przykład 1: pobieranie repliki serwera PostgreSql według grupy zasobów i nazwy serwera
```powershell
...
To polecenie cmdlet umożliwia pobieranie repliki serwera PostgreSql według grupy zasobów i nazwy serwera.
