...
### Przykład 1: Uzyskaj PostgreSql serwer z kontekstem domyślnym
```powershell
...
To polecenie cmdlet umożliwia pobieranie serwera PostgreSql z domyślnym kontekstem.

### Przykład 2: Uzyskaj PostgreSql serwer na podstawie grupy zasobów i nazwy serwera
```powershell
...
To polecenie cmdlet pobiera serwer PostgreSql według grupy zasobów i nazwy serwera.

### Przykład 3: Wyświetla listę wszystkich serwerów PostgreSql w określonej grupie zasobów.
```powershell
...
Te listy poleceń cmdlet uzyskują PostgreSql serwer na podstawie tożsamości.
