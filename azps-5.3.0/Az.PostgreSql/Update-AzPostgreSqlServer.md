...
### Przykład 1: aktualizowanie serwera PostgreSql według grupy zasobów i nazwy serwera
```powershell
...
To polecenie cmdlet aktualizuje PostgreSql serwer według grupy zasobów i nazwy serwera.
...
To polecenie cmdlet aktualizuje PostgreSql serwera za pomocą tożsamości.
