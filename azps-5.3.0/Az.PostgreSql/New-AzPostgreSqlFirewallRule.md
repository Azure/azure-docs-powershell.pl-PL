...
Te polecenia cmdlet tworzą regułę zapory serwera PostgreSql.

### Przykład 2: Tworzenie nowej reguły zapory PostgreSql przy użyciu funkcji-ClientIPAddress.
```powershell
...
Te polecenia cmdlet tworzą PostgreSqlą regułę zapory przy użyciu funkcji-ClientIPAddress.

### Przykład 3: Utwórz nową regułę zapory PostgreSql, aby zezwolić na wszystkie adresy IP
```powershell
...
Te polecenia cmdlet tworzą nową regułę zapory PostgreSql zezwalającą na wszystkie adresy IP.
...
### Microsoft. Azure. PowerShell. polecenia. PostgreSql. models. Api20171201. IFirewallRule
