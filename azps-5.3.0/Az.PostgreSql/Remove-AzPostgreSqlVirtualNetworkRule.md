...
### Przykład 1: Usuwanie reguły sieci wirtualnej serwera PostgreSql według nazwy
```powershell
PS C:\> Remove-AzPostgreSqlVirtualNetworkRule -Name vnet -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

To polecenie cmdlet usuwa regułę sieci wirtualnej serwera PostgreSql według nazwy.

### Przykład 2: Usuwanie reguły sieci wirtualnej serwera PostgreSql według tożsamości
```powershell
...
Te polecenia cmdlet usuwają zasadę sieci wirtualnej serwera PostgreSql według tożsamości.
