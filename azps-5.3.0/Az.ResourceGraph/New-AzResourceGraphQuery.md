...
## STRESZCZENIe
Tworzenie nowej kwerendy wykresu.
...
### Przykład 1. Tworzenie zapytania dotyczącego wykresu zasobu według parametru zapytania
```powershell
...
To polecenie tworzy zapytanie wykresu zasobu według parametru zapytania.

### Przykład 2: Tworzenie zapytania dotyczącego wykresu zasobów według parametru pliku
```powershell
...
To polecenie tworzy zapytanie wykresu zasobu według parametru pliku.
