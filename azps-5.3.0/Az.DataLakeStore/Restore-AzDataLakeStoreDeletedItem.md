...
## Opis
Polecenie cmdlet **Restore-AzDataLakeStoreDeletedItem** przywraca usunięty plik lub folder w usłudze Data Lake Store. Wymaga ścieżki elementu usuniętego w koszu zwracanym przez polecenie Get-AzDataLakeStoreDeletedItem.
...
### Przykład 1: Przywracanie pliku z opcji Data Lake Store using-Force
```
...
### -Miejsce docelowe
Ścieżka docelowa, w której ma zostać przywrócony usunięty plik lub folder. 
...
### -PassThru
Zwraca wartość logiczną PRAWDA po powodzeniu.
...
### -RestoreAction
Akcja wykonywana w przypadku konfliktów nazw docelowych — "kopia" lub "zastępowanie"
...
### -Type
Typ przywracanego wpisu — "plik" lub "folder"
