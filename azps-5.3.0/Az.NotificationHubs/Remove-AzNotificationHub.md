...
## Opis
Polecenie cmdlet **Remove-AzNotificationHub** Usuwa istniejącego centrum powiadomień.
...
Możesz usunąć istniejącego centrum powiadomień za pomocą polecenia cmdlet **Remove-AzNotificationHub** .
