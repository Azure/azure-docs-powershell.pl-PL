...
## Opis
Polecenie cmdlet **Remove-AzStreamAnalyticsOutput** asynchronicznie usuwa dane wyjściowe z zadania Stream Analytics na platformie Azure.
...
To polecenie usuwa dane wyjściowe z StreamingJob zadań.
...
### -Name (nazwa)
Określa nazwę danych wyjściowych funkcji Analiza strumienia Azure do usunięcia.
