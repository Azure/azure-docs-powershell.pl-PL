...
ms.locfileid: "98503315"
---
# <span data-ttu-id="ae8e5-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="ae8e5-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="ae8e5-102">STRESZCZENIe</span><span class="sxs-lookup"><span data-stu-id="ae8e5-102">SYNOPSIS</span></span>
<span data-ttu-id="ae8e5-103">Pobiera informacje o konfiguracji serwera.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="ae8e5-104">POLECENIA</span><span class="sxs-lookup"><span data-stu-id="ae8e5-104">SYNTAX</span></span>

### <span data-ttu-id="ae8e5-105">Lista (domyślna)</span><span class="sxs-lookup"><span data-stu-id="ae8e5-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="ae8e5-106">Pobierz</span><span class="sxs-lookup"><span data-stu-id="ae8e5-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="ae8e5-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="ae8e5-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="ae8e5-108">Opis</span><span class="sxs-lookup"><span data-stu-id="ae8e5-108">DESCRIPTION</span></span>
<span data-ttu-id="ae8e5-109">Pobiera informacje o konfiguracji serwera.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="ae8e5-110">Przykłady</span><span class="sxs-lookup"><span data-stu-id="ae8e5-110">EXAMPLES</span></span>

### <span data-ttu-id="ae8e5-111">Przykład 1: wyświetlanie wszystkich konfiguracji pod MariaDB</span><span class="sxs-lookup"><span data-stu-id="ae8e5-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="ae8e5-112">To polecenie wyświetla listę wszystkich konfiguracji pod MariaDB.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="ae8e5-113">Przykład 2: Uzyskiwanie konfiguracji MariaDB</span><span class="sxs-lookup"><span data-stu-id="ae8e5-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="ae8e5-114">To polecenie pobiera konfigurację MariaDB.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="ae8e5-115">PARAMETRÓW</span><span class="sxs-lookup"><span data-stu-id="ae8e5-115">PARAMETERS</span></span>

### <span data-ttu-id="ae8e5-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="ae8e5-116">-DefaultProfile</span></span>
<span data-ttu-id="ae8e5-117">Poświadczenia, konto, dzierżawa i subskrypcja używane do komunikacji z usługą Azure.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="ae8e5-118">-Inputobject</span><span class="sxs-lookup"><span data-stu-id="ae8e5-118">-InputObject</span></span>
<span data-ttu-id="ae8e5-119">Parametr Identity, aby skonstruować, zobacz sekcja notatki dla właściwości INPUTobject i tworzenie tabeli skrótów.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="ae8e5-120">-Name (nazwa)</span><span class="sxs-lookup"><span data-stu-id="ae8e5-120">-Name</span></span>
<span data-ttu-id="ae8e5-121">Nazwa konfiguracji serwera.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="ae8e5-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="ae8e5-122">-ResourceGroupName</span></span>
<span data-ttu-id="ae8e5-123">Nazwa grupy zasobów zawierającej dany zasób.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="ae8e5-124">Tę wartość można uzyskać z interfejsu API Menedżera zasobów platformy Azure lub portalu.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="ae8e5-125">-Nazwa_serwera</span><span class="sxs-lookup"><span data-stu-id="ae8e5-125">-ServerName</span></span>
<span data-ttu-id="ae8e5-126">Nazwa serwera.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-126">The name of the server.</span></span>
...
### <span data-ttu-id="ae8e5-127">-Subskrypcji</span><span class="sxs-lookup"><span data-stu-id="ae8e5-127">-SubscriptionId</span></span>
<span data-ttu-id="ae8e5-128">Identyfikator subskrypcji identyfikujący subskrypcję platformy Azure.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="ae8e5-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="ae8e5-129">CommonParameters</span></span>
<span data-ttu-id="ae8e5-130">To polecenie cmdlet obsługuje typowe parametry:-Debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-unvariable,-subbuffer,-PipelineVariable,-verbose,-WarningAction i-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="ae8e5-131">Aby uzyskać więcej informacji, zobacz [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="ae8e5-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="ae8e5-132">WEJŚCIOWE</span><span class="sxs-lookup"><span data-stu-id="ae8e5-132">INPUTS</span></span>

### <span data-ttu-id="ae8e5-133">Microsoft. Azure. PowerShell. polecenia. MariaDb. models. IMariaDbIdentity</span><span class="sxs-lookup"><span data-stu-id="ae8e5-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="ae8e5-134">WYSYŁA</span><span class="sxs-lookup"><span data-stu-id="ae8e5-134">OUTPUTS</span></span>

### <span data-ttu-id="ae8e5-135">Microsoft. Azure. PowerShell. polecenia. MariaDb. models. Api20180601Preview. IConfiguration</span><span class="sxs-lookup"><span data-stu-id="ae8e5-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="ae8e5-136">INFORMACYJN</span><span class="sxs-lookup"><span data-stu-id="ae8e5-136">NOTES</span></span>

<span data-ttu-id="ae8e5-137">PISUJE</span><span class="sxs-lookup"><span data-stu-id="ae8e5-137">ALIASES</span></span>

<span data-ttu-id="ae8e5-138">ZŁOŻONE WŁAŚCIWOŚCI PARAMETRÓW</span><span class="sxs-lookup"><span data-stu-id="ae8e5-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="ae8e5-139">Aby utworzyć opisane poniżej parametry, Skonstruuj tablicę skrótów zawierającą odpowiednie właściwości.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="ae8e5-140">Aby uzyskać informacje na temat tabel skrótów, uruchom Get-Help about_Hash_Tables.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="ae8e5-141">INPUTobject <IMariaDbIdentity> : parametr Identity</span><span class="sxs-lookup"><span data-stu-id="ae8e5-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="ae8e5-142">`[ConfigurationName <String>]`: Nazwa konfiguracji serwera.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="ae8e5-143">`[DatabaseName <String>]`: Nazwa bazy danych.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="ae8e5-144">`[FirewallRuleName <String>]`: Nazwa reguły zapory serwera.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="ae8e5-145">`[Id <String>]`: Ścieżka tożsamości zasobu</span><span class="sxs-lookup"><span data-stu-id="ae8e5-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="ae8e5-146">`[LocationName <String>]`: Nazwa lokalizacji.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="ae8e5-147">`[ResourceGroupName <String>]`: Nazwa grupy zasobów zawierającej dany zasób.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="ae8e5-148">Tę wartość można uzyskać z interfejsu API Menedżera zasobów platformy Azure lub portalu.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="ae8e5-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: Nazwa zasad alertów zabezpieczeń.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="ae8e5-150">`[ServerName <String>]`: Nazwa serwera.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="ae8e5-151">`[SubscriptionId <String>]`: Identyfikator subskrypcji identyfikujący subskrypcję platformy Azure.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="ae8e5-152">`[VirtualNetworkRuleName <String>]`: Nazwa reguły sieci wirtualnej.</span><span class="sxs-lookup"><span data-stu-id="ae8e5-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="ae8e5-153">LINKI POKREWNE</span><span class="sxs-lookup"><span data-stu-id="ae8e5-153">RELATED LINKS</span></span>
