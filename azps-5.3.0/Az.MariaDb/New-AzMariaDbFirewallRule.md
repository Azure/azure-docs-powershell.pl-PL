...
### Przykład 1. Tworzenie reguły zapory w obszarze MariaDB
```powershell
...
To polecenie powoduje utworzenie reguły zapory pod MariaDB.

### Przykład 2: Tworzenie nowej reguły zapory MariaDB przy użyciu funkcji-ClientIPAddress.
```powershell
...
Te polecenia cmdlet tworzą MariaDBą regułę zapory przy użyciu funkcji-ClientIPAddress.

### Przykład 3: Utwórz nową regułę zapory MariaDB, aby zezwolić na wszystkie adresy IP
```powershell
...
Te polecenia cmdlet tworzą nową regułę zapory MariaDB zezwalającą na wszystkie adresy IP.

## PARAMETRÓW

### -AllowAll
Prezentuj, aby zezwolić na wszystkie adresy IP zakresu od 0.0.0.0 do 255.255.255.255.
...
Jeśli nie określono tego parametru, wartość domyślna jest niezdefiniowana.
Jeśli AllowAll jest obecny, nazwa domyślna to AllowAll_yyyy-MM-dd_HH-mm-SS.
...
### Microsoft. Azure. PowerShell. polecenia. MariaDb. models. Api20180601Preview. IFirewallRule
