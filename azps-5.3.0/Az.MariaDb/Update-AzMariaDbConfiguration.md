...
Zamiast tego użyj Update-AzMariaDbServer, jeśli chcesz zaktualizować AdministratorLoginPassword, SKU itd.
...
### Przykład 1: aktualizowanie konfiguracji MariaDB
```powershell
...
To polecenie aktualizuje konfigurację MariaDB.
