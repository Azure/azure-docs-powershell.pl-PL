...
To polecenie testuje wdrożenie w bieżącym zakresie subskrypcji przy użyciu obiektu Hashtable w pamięci utworzonej z danego pliku szablonu i pliku parametrów.
