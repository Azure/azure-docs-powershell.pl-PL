...
## Opis
Polecenie cmdlet **Remove-AzManagementGroupDeployment** powoduje usunięcie wdrożenia platformy Azure w grupie zarządzania i wszelkich skojarzonych operacjach.
...
To polecenie powoduje usunięcie wdrożenia "RolesDeployment" w grupie zarządzania "myMG".
...
To polecenie pobiera wdrożenie "RolesDeployment" w grupie zarządzania "myMG" i usuwa je.
