...
### RoleAssignmentParameterSet (domyślny)
```
...
## Opis
Użyj polecenia New-AzRoleAssignment, aby zmodyfikować istniejące zadanie.  
Opisy mogą być dowolną prawidłową postacią, z której można diferentiate.  
Jeśli warunek jest ustawiony jako, należy ustawić wersję warunkową, ale jeśli jest aktualizowany warunek, który nie jest potrzebny.
Wersja warunkowa może zostać uaktualniona z 1,0 do 2,0, ale nie można jej ponownie obniżyć. Należy zachować ostrożność, ponieważ 2,0 nie retrocompatible z 1,0.
...
Aktualizowanie istniejącego zadania roli przez zmodyfikowanie obiektu
...
Aktualizowanie istniejącego zadania roli za pomocą pliku
...
### -Plik_wejściowy
Nazwa pliku zawierającego pojedynczą definicję roli.
