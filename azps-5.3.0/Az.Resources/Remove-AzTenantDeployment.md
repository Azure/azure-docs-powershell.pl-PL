...
## Opis
Polecenie cmdlet **Remove-AzTenantDeployment** usuwa wdrożenie platformy Azure w bieżącym zakresie dzierżawy i wszystkich skojarzonych operacjach.
...
To polecenie powoduje usunięcie wdrożenia "RolesDeployment" w bieżącym zakresie dzierżawy.
