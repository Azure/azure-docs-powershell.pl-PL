...
## Opis
Polecenie cmdlet **Remove-AzSentinelAlertRule** powoduje trwałe usunięcie reguły alertu z określonego obszaru roboczego.
Obiekt **AlertRule** można przekazać za pomocą operatora potoku lub można też określić parametry wymagane.
