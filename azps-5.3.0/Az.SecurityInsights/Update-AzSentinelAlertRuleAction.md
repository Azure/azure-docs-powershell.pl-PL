...
## Opis
Polecenie cmdlet **Update-AzSentinelAlertRuleAction** umożliwia zaktualizowanie zakładki w określonym obszarze roboczym.
Obiekt **AlertRuleAction** można przekazać jako parametr lub za pomocą operatora potoku albo też określić parametry *AlertRuleId* i *ActionID* .
...
W tym przykładzie Zaktualizowano **AlertRuleAction** zastąpienie istniejącej *akcji* nowymi właściwościami.
...
W tym przykładzie Zaktualizowano **AlertRuleAction** przy użyciu funkcji inputobject zastępując istniejącą *akcję* nowymi właściwościami.
...
### -TriggerUri
Identyfikator URI wyzwalacza aplikacji logiki akcji.
