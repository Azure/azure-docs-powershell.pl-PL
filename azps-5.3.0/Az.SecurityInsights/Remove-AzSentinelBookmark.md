...
## Opis
Polecenie cmdlet **Remove-AzSentinelBookmark** powoduje trwałe usunięcie zakładki z określonego obszaru roboczego.
Obiekt **Bookmark** można przekazać przy użyciu operatora potoku lub można też określić parametry wymagane.
...
To polecenie umożliwia usunięcie zakładki z obszaru roboczego.
