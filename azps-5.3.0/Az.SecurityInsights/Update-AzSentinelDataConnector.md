...
## STRESZCZENIe
Aktualizowanie łącznika danych.
...
## Opis
Polecenie cmdlet **Update-AzSentinelDataConnector** umożliwia zaktualizowanie łącznika danych w określonym obszarze roboczym.
Obiekt programu **Dataconnecter** można przekazać jako parametr lub za pomocą operatora potoku albo też określić parametry wymagane.
...
Polecenie pobiera Łącznik danych przez *DataConnectorId* i ustawia stan *alertów* na *wyłączony*.  Pozostałe właściwości pozostają bez zmian.
...
### -DiscoveryLogs
Dzienniki odnajdowania łączników danych
...
### -Program SharePoint
Łącznik danych programu SharePoint
