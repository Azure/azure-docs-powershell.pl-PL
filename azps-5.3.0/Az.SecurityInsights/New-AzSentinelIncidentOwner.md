...
## Opis
Polecenie cmdlet **New-AzSentinelIncidentOwner** tworzy obiekt właściciel zdarzenia w pamięci w celu zaktualizowania incydentu.
...
W tym przykładzie przedstawiono tworzenie **IncidentOwner** i aktualizowanie zdarzenia nowemu właścicielowi.

## PARAMETRÓW

### -AssignedTo
Właściciel incydentu przypisany do
...
### -Mail
Właściciel incydentu — adres E-mail
