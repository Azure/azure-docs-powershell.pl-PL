...
Musisz dostarczyć identyfikator URI aplikacji resorce, który można znaleźć przy użyciu modułu aplikacji logiki.
...
W tym przykładzie przedstawiono tworzenie **AlertRuleAction** dla określonej reguły alertu przy użyciu właściwości aplikacji logicznej, a następnie zapisanie jej w zmiennej $AlertRuleAction.
