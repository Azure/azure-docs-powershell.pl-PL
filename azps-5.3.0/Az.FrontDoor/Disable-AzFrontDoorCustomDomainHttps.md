...
## Opis
**Element Disable-AzFrontDoorCustomDomainHttps** wyłącza HTTPS dla domeny niestandardowej.

## Przykłady

### Przykład 1: wyłączanie protokołu HTTPS dla domeny niestandardowej z FrontDoorName i ResourceGroupName.
```powershell
...
Wyłącz protokół HTTPS dla domeny niestandardowej "frontendpointname1-Custom-XYZ" z FrontDoorName jako "frontdoor1" i ResourceGroupName jako "resourcegroup1".

### Przykład 2: wyłączanie protokołu HTTPS dla domeny niestandardowej z obiektem PSFrontendEndpoint.
```powershell
...
Wyłącz protokół HTTPS dla domeny niestandardowej z obiektem PSFrontendEndpoint.

### Przykład 3: wyłączanie protokołu HTTPS dla domeny niestandardowej z identyfikatorem zasobu ResourceId.
```powershell
...
Wyłącz protokół HTTPS dla domeny niestandardowej "frontendpointname1-Custom-XYZ" z identyfikatorem ResourceId jako $resourceId.
...
### -ResourceId
Identyfikator zasobu punktu końcowego z przednim Drzwiczkeniem w celu wyłączenia protokołu https
