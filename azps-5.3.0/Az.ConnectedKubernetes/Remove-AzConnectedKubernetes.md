...
## STRESZCZENIe
Usuń podłączony klaster, usuwając prześledzony zasób w Menedżerze zasobów Azure (ARM).
...
### Przykład 1: usuwanie połączonego Kubernetes
```powershell
PS C:\> Remove-AzConnectedKubernetes -ResourceGroupName azureps-manual-test -ClusterName ps-connaks-t01

```

To polecenie usuwa podłączony Kubernetes

### Przykład 2: usuwanie połączonego Kubernetes przez obiekt
```powershell
...
To polecenie usuwa połączony Kubernetes przez obiekt
