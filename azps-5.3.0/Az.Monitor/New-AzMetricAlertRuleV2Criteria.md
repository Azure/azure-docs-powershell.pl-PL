...
### StaticThresholdParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **New-AzMetricAlertRuleV2Criteria** tworzy obiekt Local Metric kryteriów, który ma być wykorzystywany jako wejściowy polecenie cmdlet [Add-AzMetricAlertRuleV2](https://docs.microsoft.com/en-us/powershell/module/az.monitor/add-azmetricalertrulev2) , które tworzy nową regułę alertu metryki.

## Przykłady

### Przykład 1. Tworzenie prostych kryteriów alertów metrycznych
...
### Przykład 2: Tworzenie kryteriów dynamicznego alertu metrycznego
...
To polecenie tworzy dynamiczne kryteria alertów metrycznych, które mogą być używane w regule alertu metryki

### Przykład 3: tworzenie bardziej złożonych kryteriów alertów metrycznych
...
Ten zestaw poleceń tworzy bardziej złożone kryteria alertów metryki, które zawierają zaznaczenie wymiarów.

### Przykład 4: Tworzenie kryteriów dostępności WebTest
...
To polecenie tworzy kryteria dostępności WebTest, których można użyć w regule alertu metryki
...
### -DynamicThreshold
Parametr Switch umożliwiający używanie typu progu dynamicznego
...
Łączna liczba punktów badanych
...
### -FailedLocationCount
Minimalna liczba nieudanych lokalizacji, dla których ma zostać poddany alert.
...
Umożliwia utworzenie reguły alertu na niestandardową metryki, która nie jest jeszcze emitowana, powodując Pominięcie sprawdzania poprawności metryki.
...
### -TimeAggregation
Operacja agregacji używana do rzutowania wielu wartości metrycznych w interwale okien
...
### -ViolationCount
Minimalna liczba nieprawidłowych naruszeń w wybranym przedziale czasu lookback wymaganym do podniesienia poziomu alertu
...
### -WebTest
Parametr przełącznika umożliwiający używanie kryteriów dostępności typu
...
### -WebTestId
Identyfikator testu w sieci Web usługi Application Insights.
