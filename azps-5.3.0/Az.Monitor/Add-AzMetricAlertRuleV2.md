...
## STRESZCZENIe
Dodaje lub aktualizuje regułę alertu opartą na metryce w wersji 2 (nieklasycznej).

## POLECENIA

### CreateAlertByResourceId (domyślny)
```
...
## Opis
Dodaje lub aktualizuje **regułę alertu opartą na metryce w wersji 2 (nieklasycznej)**. Dodana reguła jest skojarzona z grupą zasobów i ma nazwę. To polecenie cmdlet implementuje wzorzec ShouldProcess, tzn. może zażądać potwierdzenia od użytkownika przed faktycznym utworzeniem, zmodyfikowaniem lub usunięciem zasobu.

## Przykłady

### Przykład 1: Dodawanie reguły alertu metryki do maszyny wirtualnej
...
To polecenie tworzy regułę alertu metryki dla wszystkich maszyn wirtualnych w subskrypcji, które znajdują się na Wschodzie.

### Przykład 3: wyłączanie reguły alertu metryki
```powershell
...
Aby utworzyć bardziej skomplikowaną regułę alertu metryki, taką jak te, które obejmują Wybieranie wartości wymiaru lub mających wiele kryteriów, można użyć poleceń cmdlet dla pomocnika [New-AzMetricAlertRuleV2DimensionSelection](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azmetricalertrulev2dimensionselection) i [New-AzMetricAlertRuleV2Criteria](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azmetricalertrulev2criteria).

Powyżej zestaw poleceń cmdlet utworzy regułę alertu metryki z wymiarami.

## PARAMETRÓW

### -Action
Grupa akcji dla reguły
...
### -ActionGroupId
Identyfikator grupy akcji dla reguły
...
### -Częstotliwość
Częstotliwość obliczania dla reguły
...
### -TargetResourceId
Identyfikator zasobu docelowego dla reguły
...
### -TargetResourceRegion
Docelowy region zasobów dla reguły
...
### -TargetResourceScope
Zakres zasobów docelowych dla reguły
...
### -TargetResourceType
Typ zasobu docelowego dla reguły
...
### System. Collections. Generic. list "1 [[Microsoft. Azure. polecenia. info............ w. OutputClasses. IPSMultiMetricCriteria, Microsoft. Azure. PowerShell. cmdlets. Monitor, Version = 1.0.1.0

### Microsoft. Azure. Management. Monitor. MODELES. ActivityLogAlertActionGroup []
