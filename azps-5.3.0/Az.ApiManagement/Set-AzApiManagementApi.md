...
## Opis
Polecenie cmdlet **Set-AzApiManagementApi** modyfikuje interfejs API zarządzania interfejsem Azure API.
...
### Przykład 2: Dodawanie interfejsu API do istniejącego ApiVersionSet
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### Przykład 3: Zmienianie wewnętrznej bazy danych ServiceUrl, w której wskazuje interfejs API
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
W tym przykładzie Zaktualizowano ServiceUrl, `echo-api` do której wskazuje.
