...
To polecenie ustawia szczegóły operacji zarządzania interfejsem API.

### Przykład 2

Ustawia szczegóły operacji interfejsu API. (autogenerowana)
...
### -ApiRevision
Identyfikator wersji interfejsu API. Ten parametr jest opcjonalny. Jeśli argument nie zostanie określony, operacja zostanie zaktualizowana w wersji obecnie aktywnej funkcji API.
...
### -Odpowiedzi
Określa tablicę możliwych odpowiedzi na operacje.
...
### -TemplateParameters
Określa tablicę lub parametry zdefiniowane w parametrach *UrlTemplate*.
Jeśli wartość nie zostanie określona, zostanie wygenerowana wartość domyślna na podstawie UrlTemplate.
Za pomocą tego parametru można uzyskać więcej informacji na temat parametrów, takich jak opis, typ i inne możliwe wartości.
...
Na przykład: Customers/{CID}/Orders/{OID}/? Date = {Date}.
