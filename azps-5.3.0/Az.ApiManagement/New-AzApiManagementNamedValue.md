...
## Opis
Polecenie cmdlet **New-AzApiManagementNamedValue** tworzy funkcję zarządzania interfejsem Azure API **o nazwie Value**.

## Przykłady

### Przykład 1. Tworzenie nazwanej wartości obejmującej znaczniki
```
...
Drugie polecenie tworzy nazwaną wartość i przypisuje ciągi w $Tags jako znaczniki we właściwości.

### Przykład 2: Tworzenie nazwanej wartości, która ma wartość tajną
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>New-AzApiManagementNamedValue -Context $apimContext -NamedValueId "Property12" -Name "Secret Property" -Value "Secret Property Value" -Secret
```

To polecenie tworzy **nazwaną wartość** z zaszyfrowaną wartością.
...
### -Tag
Znaczniki, które mają być skojarzone z nazwaną wartością.
Ten parametr jest opcjonalny.
