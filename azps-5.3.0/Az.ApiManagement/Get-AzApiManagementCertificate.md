...
## Opis
Polecenie cmdlet **Get-AzApiManagementCertificate** pobiera wszystkie określone certyfikaty zarządzania platformy Azure API lub certyfikaty.
...
### -ResourceId
Identyfikator zasobu ARM certyfikatu. Jeśli zostanie określona, spróbuje znaleźć certyfikat według identyfikatora. Ten parametr jest wymagany.
