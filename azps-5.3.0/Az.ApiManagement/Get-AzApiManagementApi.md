...
## Opis
Polecenie cmdlet **Get-AzApiManagementApi** pobiera co najmniej jeden interfejs API zarządzania interfejsem API platformy Azure.
...
### Przykład 4: uzyskiwanie interfejsu API zarządzania przez GatewayId
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementApi -Context $ApiMgmtContext -GatewayId "g01"
```

To polecenie pobiera interfejs API dla określonego GatewayId.
...
### -GatewayId
Jeśli zostanie określona, spróbuje pobrać wszystkie interfejsy API bramy.
