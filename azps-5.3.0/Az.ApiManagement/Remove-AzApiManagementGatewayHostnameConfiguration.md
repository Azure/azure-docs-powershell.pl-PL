...
## Opis
Polecenie cmdlet **Remove-AzApiManagementGatewayHostnameConfiguration** usuwa konfigurację hosta z istniejącej bramy.
...
To polecenie usuwa istniejącą konfigurację hosta bramy i nie monituje użytkownika o potwierdzenie.
...
Identyfikator istniejącej konfiguracji hosta bramy.
Ten parametr jest wymagany.
...
### -Inputobject
Wystąpienie PsApiManagementGatewayHostnameConfiguration. Ten parametr jest wymagany.
...
### -ResourceId
Identyfikator zasobu ARM GatewayHostnameConfiguration. Ten parametr jest wymagany.
