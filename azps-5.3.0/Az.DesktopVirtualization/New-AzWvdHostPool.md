...
### Przykład 1. tworzenie pulpitu wirtualnego systemu HostPool według nazwy
```powershell
...
To polecenie tworzy wirtualny pulpit systemu Windows HostPool w grupie zasobów.
...
### -DesktopAppGroupName
Nazwa grupy aplikacji klasycznej
...
### -HostPoolType
Typ HostPool dla komputerów stacjonarnych.
...
Zakodowany ciąg Base64 tokenu rejestracji.
...
### -SsoadfsAuthority
Adres URL do serwera usług ADFS dla klientów w celu podpisywania WVD certyfikatów SSO.
...
### -SsoClientId
ClientId dla zarejestrowanej jednostki uzależnionej używanej do wystawiania certyfikatów SSO usługi WVD.
...
Ścieżka do magazynu kluczy platformy Azure przechowującego klucz tajny służący do komunikacji z ADFS.
...
### -StartVMOnConnect
Flaga włączenia/wyłączenia funkcji StartVMOnConnect.
...
### -VMTemplate
Szablon maszyny wirtualnej na potrzeby konfiguracji sessionhosts w hostpool.
...
### Microsoft. Azure. PowerShell. polecenia. DesktopVirtualization. models. Api20201102Preview. IHostPool
