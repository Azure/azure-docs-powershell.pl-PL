...
### Przykład 1: usuwanie pulpitu wirtualnego systemu SessionHost według nazwy
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

To polecenie usuwa pulpit wirtualny systemu Windows SessionHost z puli hostów.
...
### -Force
Wymuszaj flagę w celu wymuszenia usunięcia sessionHost nawet wtedy, gdy userSession istnieje.
