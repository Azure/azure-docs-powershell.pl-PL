...
### Przykład 1: rozwija określoną ścieżkę obrazu i pobiera metadane pakietu Znalezione w AppxManifest.xml
```powershell
...
To polecenie zwraca metadane pakietu MSIX znalezionego w podanej ścieżce obrazu.
...
### -MsixImageUri
Reprezentuje identyfikator URI dotyczący MSIX obraz do skonstruowania, zobacz sekcję Uwagi dla właściwości MSIXIMAGEURI i Utwórz tablicę skrótów.
...
### Microsoft. Azure. PowerShell. polecenia. DesktopVirtualization. models. Api20201102Preview. IMsixImageUri

### Microsoft. Azure. PowerShell. polecenia. DesktopVirtualization. models. IDesktopVirtualizationIdentity

## WYSYŁA

### Microsoft. Azure. PowerShell. polecenia. DesktopVirtualization. models. Api20201102Preview. IExpandMsixImage
...
MSIXIMAGEURI <IMsixImageUri> : reprezentuje identyfikator URI odwołujący się do obrazu MSIX
  - `[Uri <String>]`: Identyfikator URI do obrazu
