...
### Przykład 1: uzyskiwanie wirtualnego pulpitu systemu Windows HostPool według nazwy
```powershell
...
To polecenie pobiera wirtualny pulpit systemu Windows HostPool w grupie zasobów.

### Przykład 2: Wyświetlanie listy pulpitów wirtualnych systemu HostPools
```powershell
...
To polecenie umożliwia wyświetlenie listy pulpitów wirtualnych systemu HostPools w grupie zasobów.
