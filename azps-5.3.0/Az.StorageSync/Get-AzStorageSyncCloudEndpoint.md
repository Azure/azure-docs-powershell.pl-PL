...
## Opis
To polecenie umożliwia wyświetlenie wszystkich chmurowych punktów końcowych w danej grupie synchronizacji. Za pomocą tej funkcji można również wyświetlić listę atrybutów każdego punktu końcowego w chmurze.
...
To polecenie pobiera wszystkie chmury punktów końcowych zawarte w określonej grupie synchronizacji. Określ — CloudEndpointName, aby zwrócić określoną wartość.
