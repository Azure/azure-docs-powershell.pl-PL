...
## Opis
Jeśli parametr **RuleName** jest podany, polecenie cmdlet **Get-AzRedisCacheFirewallRule** pobiera szczegóły dotyczące określonej reguły zapory w pamięci podręcznej usługi Azure Redis. Jeśli określono tylko **nazwę** , ta operacja pobiera wszystkie reguły zapory dostępne w tej pamięci podręcznej Redis.
