...
### Przykład 1. Tworzenie nowej kolekcji Move.
```powershell
...
Tworzenie nowej kolekcji Przenieś w ramach abonamentu.
...
### -IdentityType
Typ tożsamości używanej przez usługę przenoszenia regionów.
