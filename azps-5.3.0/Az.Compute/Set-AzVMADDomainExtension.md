...
## Opis
Polecenie cmdlet **Set-AzVMADDomainExtension** dodaje rozszerzenie maszyny wirtualnej domeny usługi Azure Active Directory (AD) do maszyny wirtualnej.
To rozszerzenie umożliwia dołączenie maszyny wirtualnej do domeny.
...
### -JoinOption
Określa opcję sprzężenia. Opcje dołączania zobacz [fJoinOptions](https://docs.microsoft.com/en-us/windows/desktop/api/lmjoin/nf-lmjoin-netjoindomain)
...
### -Name (nazwa)
Określa nazwę rozszerzenia domeny, które należy dodać.
...
### -OUPath
Określa jednostkę organizacyjną (OU) dla konta domeny.
Wprowadź pełną nazwę wyróżniającą jednostki organizacyjnej w cudzysłowie.
Wartość domyślna to domyślna jednostka organizacyjna dla obiektów komputera w domenie.
...
Ponowne uruchomienie jest często wymagane do wprowadzenia zmiany.
