...
## Opis
Polecenie cmdlet **New-AzSnapshotConfig** tworzy obiekt o konfigurowalnej migawce.
...
Umożliwia utworzenie obiektu migawki z możliwością konfigurowania. (autogenerowana)
...
### -DiskAccessId
Pobiera lub ustawia identyfikator ARM zasobu DiskAccess na potrzeby używania prywatnych punktów końcowych.
...
### -ImageReference
Określa odwołanie do obrazu w migawce.
...
### -Przyrostowy
Określa migawkę przyrostową. Przyrostowe migawki na tym samym dysku zajmują mniej miejsca niż pełne migawki i można je powiększyć.
