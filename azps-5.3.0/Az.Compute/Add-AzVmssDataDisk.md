...
## Opis
Polecenie cmdlet **Add-AzVmssDataDisk** dodaje dysk danych do wystąpienia zestawu skali maszyny wirtualnej (VMSS).
...
### -DiskIOPSReadWrite
Określa Read-Write IOPS dla zarządzanego dysku. Należy użyć tylko wtedy, gdy StorageAccountType jest UltraSSD_LRS. Jeśli nie określono tej wartości, przypisze się wartość domyślna na podstawie diskSizeGB.
...
### -DiskMBpsReadWrite
Określa szerokość pasma (w MB/s) dla dysku zarządzanego. Należy użyć tylko wtedy, gdy StorageAccountType jest UltraSSD_LRS. Jeśli nie określono tej wartości, przypisze się wartość domyślna na podstawie diskSizeGB.
