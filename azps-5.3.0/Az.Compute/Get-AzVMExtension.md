...
### Przykład 3: pobieranie wszystkich rozszerzeń zainstalowanych na maszynie wirtualnej
```
...
To polecenie powoduje wyświetlenie listy rozszerzeń zainstalowanych na maszynie wirtualnej o nazwie VirtualMachine22 w ResourceGroup11 grupy zasobów.
