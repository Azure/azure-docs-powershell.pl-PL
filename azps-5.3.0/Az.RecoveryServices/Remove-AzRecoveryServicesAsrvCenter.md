...
## Opis
Polecenie cmdlet **Remove-AzRecoveryServicesAsrvCenter** umożliwia usunięcie serwera vCenter z sieci szkieletowej ASR i zatrzymanie wykrywania maszyn wirtualnych z serwera vCenter.
...
Usuwa serwer vCenter z sieci szkieletowej ASR.

### Przykład 2

Umożliwia usunięcie serwera vCenter z sieci szkieletowej ASR i zatrzymanie wykrywania maszyn wirtualnych z serwera vCenter. (autogenerowana)
...
### -Inputobject
Obiekt vCenter programu ASR reprezentujący serwer vCenter, który ma zostać usunięty.
...
### -ResourceId
Określa identyfikator zasobu vCenter do usunięcia.
