...
Dołącza grupę do istniejącego planu odzyskiwania witryny platformy Azure i zwraca zaktualizowany plan odzyskiwania w pamięci. 

### Przykład 2

Umożliwia edytowanie planu odzyskiwania witryny. (autogenerowana)
