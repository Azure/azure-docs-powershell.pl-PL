...
## Opis
Polecenie cmdlet Get-AzRecoveryServicesBackupRPMountScript Pobiera skrypt instalujący woluminy punktu odzyskiwania na komputerze, na którym jest uruchomiony.

## Przykłady

### Przykład 1: Instalowanie punktu odzyskiwania
```powershell
...
Po uruchomieniu skryptu spowoduje to zainstalowanie plików punktu odzyskiwania $rp \[ 0\]

### Przykład 2

Umożliwia pobranie skryptu w celu zainstalowania wszystkich plików punktu odzyskiwania. (autogenerowana)
...
### -Path
Lokalizacja, w której plik ma zostać pobrany w przypadku odzyskiwania plików. Jeśli nie podano ścieżki, plik skryptu zostanie pobrany w bieżącym katalogu.
