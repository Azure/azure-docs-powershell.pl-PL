...
## Opis
Polecenie cmdlet **Remove-AzDataFactory** umożliwia usunięcie fabryki danych.
...
### -DataFactory
Określa obiekt **PSDataFactory** , który ma zostać usunięty.
...
### -Force
Wskazuje, że to polecenie cmdlet usunie fabrykę danych bez monitowania o potwierdzenie.
