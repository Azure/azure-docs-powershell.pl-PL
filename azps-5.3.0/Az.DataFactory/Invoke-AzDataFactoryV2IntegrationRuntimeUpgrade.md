...
## Opis
Polecenie cmdlet **Invoke-AzDataFactoryV2IntegrationRuntimeUpgrade** umożliwia uaktualnienie programu obsługi integracji obsługiwanego automatycznie, jeśli jest dostępna nowa wersja.

## Przykłady

### Przykład 1: uaktualnianie samodzielnego środowiska uruchomieniowego integracji
```
...
Polecenie cmdlet umożliwia uaktualnienie środowiska wykonawczego integracji obsługiwanego pod nazwą "test-SelfHost-IR" w fabryce danych "test-DF-EU2".
