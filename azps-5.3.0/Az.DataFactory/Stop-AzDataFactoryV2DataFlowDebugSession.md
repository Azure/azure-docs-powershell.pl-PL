...
## Opis
To polecenie zatrzymuje sesję debugowania, w przeciwnym razie sesja będzie automatycznie wyłączana w zależności od czasu na ustawienie sesji debugowania.
...
```
Zatrzymuje sesję debugowania przepływu danych "fd76cd0d-8b37-4dc0-A370-3f9d43ac686d" w fabryce danych "WikiADF".
