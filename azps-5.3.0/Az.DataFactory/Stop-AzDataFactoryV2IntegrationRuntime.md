...
## Opis
Polecenie cmdlet **stop-AzDataFactoryV2IntegrationRuntime** zatrzymuje zarządzane dedykowane środowisko uruchomieniowe integracji w stanie uruchomionym, który został uruchomiony przez polecenie cmdlet Start-AzDataFactoryV2IntegrationRuntime. Zasoby są zwalniane i przetransferowano stan do "Zatrzymano".
...
Stan programu Managed Integration Runtime "test-reserlved-IR" jest w stanie "uruchomiony". Po uruchomieniu polecenia cmdlet Stop-AzDataFactoryV2IntegrationRuntime zasoby są zwalniane, a transfery stanowe są przekazywane do "zatrzymane".
