...
## STRESZCZENIe
Zatrzymuje działanie wyzwalacza w fabryce danych.
...
## Opis
Polecenie cmdlet **stop-AzDataFactoryV2TriggerRun** zatrzymuje uruchamianie wyzwalacza w fabryce danych określonej przy użyciu nazwy wyzwalacza i identyfikatora uruchomienia wyzwalacza.
Obecnie obsługiwane tylko dla TumblingWindowTriggers w stanie WaitingOnDependency.
...
To polecenie zatrzymuje uruchamianie wyzwalacza z identyfikatorem "08586002468005888497807248799CU16" w WikiADF fabryki.
...
### -Inputobject
Informacje na temat uruchomienia wyzwalacza.
...
### -PassThru
Jeśli określono polecenie cmdlet Write-in polecenia "in" w przypadku powodzenia.
