...
### Przykład 1: Pobierz wszystkie plany aplikacji funkcji.
```powershell
...
### Przykład 2: Pobieranie funkcji planów aplikacji według nazw grup zasobów.
```powershell
...
To polecenie pobiera za pomocą nazwy grupy zasobów funkcji plany aplikacji.

### Przykład 3: Pobieranie funkcji planów aplikacji dla podanych subskrypcji.
```powershell
...
To polecenie pobiera plany aplikacji dotyczące danej subskrypcji.

### Przykład 4: Pobieranie funkcji planów aplikacji według lokalizacji.
```powershell
...
To polecenie pobiera za pomocą funkcji plany aplikacji według lokalizacji.
