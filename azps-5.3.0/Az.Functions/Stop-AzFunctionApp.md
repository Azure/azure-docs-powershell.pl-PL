...
### Przykład 1: Uzyskaj aplikację funkcyjną według nazwy i zatrzymaj ją.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Stop-AzFunctionApp -Force
```

To polecenie pobiera aplikację funkcyjną według nazwy i zatrzymuje ją.

### Przykład 2: zatrzymywanie aplikacji funkcji według nazwy.
```powershell
...
### -Force
Wymusza zatrzymanie aplikacji funkcji bez monitowania o potwierdzenie.
