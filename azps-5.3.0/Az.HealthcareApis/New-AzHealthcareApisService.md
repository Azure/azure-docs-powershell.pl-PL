...
### Przykład 2: tworzy nową nową usługę Azure healthcareapis fhir o nazwie Moja usługa w grupie zasób w lokalizacji westus2 ze cosmosdb ofertą = 400 i identyfikatorem URI klucza magazynu kluczy "https:// \<my-keyvault> . Vault.Azure.NET/Keys/ \<my-key> "
```powershell
...
### -CorsHeader
Lista usługi HealthcareApis Fhir nagłówka CORS.
...
### -CorsMaxAge
Maksymalny wiek usługi HealthcareApis Fhir service cors.
...
### -CorsOrigin
HealthcareApis Fhir Service (lista pochodzenia CORS).
