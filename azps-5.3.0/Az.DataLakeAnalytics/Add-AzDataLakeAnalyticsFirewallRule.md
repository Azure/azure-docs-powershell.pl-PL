...
## Opis
Polecenie cmdlet **Add-AzDataLakeAnalyticsFirewallRule** umożliwia dodanie reguły zapory do konta usługi Azure Data Lake Analytics.

## Przykłady

### Przykład 1: Dodawanie reguły zapory
```
...
To polecenie dodaje regułę zapory o nazwie "Moja Reguła zapory" z konta "ContosoAdlAcct" z zakresem adresów IP: 127.0.0.1-127.0.0.10

## PARAMETRÓW

### — Konto
Konto usługi Data Lake Analytics, do którego ma zostać dodana reguła zapory
