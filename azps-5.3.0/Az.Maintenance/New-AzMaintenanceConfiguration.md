...
Tworzenie konfiguracji obsługi za pomocą hosta zakresu
...
### -ExpirationDateTime
ExpirationDateTime harmonogramu w formacie RRRR-MM-DD hh: mm
...
### -ExtensionProperty
Właściwości rozszerzenia dla zasobu.
...
### -StartDateTime
StartDateTime harmonogramu w formacie RRRR-MM-DD hh: mm
