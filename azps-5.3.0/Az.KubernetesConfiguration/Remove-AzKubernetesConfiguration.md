...
### Przykład 1: usuwanie configuation Kubernetes klastra według nazwy
```powershell
...
To polecenie usuwa configuation klastra Kubernetes według nazwy.

### Przykład 2: usuwanie configuation Kubernetes klastra według obiektu
```powershell
...
To polecenie usuwa configuation klastra Kubernetes według obiektu.
