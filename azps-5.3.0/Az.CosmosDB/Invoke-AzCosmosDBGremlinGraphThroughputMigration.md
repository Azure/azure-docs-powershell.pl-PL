...
## STRESZCZENIe
Za pomocą tej operacji można migrować przepływność automatycznego skalowania do przepustowości ręcznej i odwrotnie.
...
## Opis
Parametr ThroughpyteType określa przepływność, do którego ma zostać dokonana migracja.
...
### -Produktywność
Typ przepustowości, do którego ma zostać dokonana migracja.
Możliwe wartości: automatyczne skalowanie, ręczne.
