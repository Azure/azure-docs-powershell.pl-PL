...
## Opis
Polecenie cmdlet **Get-AzBatchSupportedImage** umożliwia pobieranie obsługiwanych obrazów maszyny wirtualnej dostępnych na koncie usługi Azure Batch.
Określ konto przy użyciu parametru *BatchContext* .

## Przykłady

### Przykład 1: pobieranie wszystkich dostępnych obsługiwanych obrazów
...
Pierwsze polecenie pobiera kontekst konta wsadowego zawierający klucze dostępu dla subskrypcji przy użyciu polecenia **Get-AzBatchAccountKey**.
Polecenie zapisuje kontekst w zmiennej $Context do użycia w następnym poleceniu.
Drugie polecenie pobiera wszystkie dostępne obrazy dla tego konta wsadowego.
...
Jeśli nie określisz filtru, to polecenie cmdlet zwróci wszystkie obrazy obsługiwane przez konto wsadowe.
...
### -MaxCount
Określa maksymalną liczbę obsługiwanych obrazów, które należy zwrócić.
...
### Microsoft.Azure.Commands.Batch. Modele. PSImageInformation
