...
To polecenie uzyskuje węzeł obliczeniowy o nazwie ComputeNode01 przy użyciu polecenia cmdlet **Get-AzBatchComputeNode** .
...
Polecenie tworzy konto użytkownika zawierające nazwę użytkownika TestUser i hasło hasła.
