...
### Przykład 1: aktualizowanie bota za pomocą nazwy i ResourceGroupName
```powershell
...
Aktualizowanie bota za pomocą nazwy i ResourceGroupName

### Przykład 2: aktualizowanie bota za pomocą narzędzia Inputobject
```powershell
...
Aktualizowanie bota za pomocą narzędzia Inputobject
...
Klucz interfejsu API usługi Application Insights
...
### -LuisAppId
Kolekcja identyfikatorów aplikacji LUIS
...
### -Tag
Zawiera znaczniki zasobów zdefiniowane jako pary klucz/wartość.
