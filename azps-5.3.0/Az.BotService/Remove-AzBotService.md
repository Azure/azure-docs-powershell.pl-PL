...
### Przykład 1. Usuń BotService za pomocą nazwy i ResourceGroupName
```powershell
PS C:\> Remove-AzBotService -Name youri-bot -ResourceGroupName youriBotTest

```

Usuń BotService według nazwy i ResourceGroupName

### Przykład 2: usuwanie BotService za pomocą narzędzia Inputobject
```powershell
...
Usuwanie BotService przez wejście
