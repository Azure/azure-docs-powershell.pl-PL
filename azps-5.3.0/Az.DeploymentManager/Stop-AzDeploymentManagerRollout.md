...
## Opis
Polecenie cmdlet **stop-AzDeploymentManagerRollout** zatrzymuje wprowadzanie w toku i zwraca obiekt reprezentujący bieżący stan wdrożenia.
...
### -Inputobject
Rozszerzenie, które ma zostać usunięte.
