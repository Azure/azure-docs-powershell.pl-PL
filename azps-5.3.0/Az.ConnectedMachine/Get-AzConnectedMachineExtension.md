...
### Przykład 1: wyświetlanie wszystkich rozszerzeń komputera
```powershell
...
Lista wszystkich rozszerzeń określonego komputera.

### Przykład 2: uzyskiwanie określonego rozszerzenia na komputerze
```powershell
...
Pobiera określone rozszerzenie na komputerze.
...
### -NazwaKomputera
Nazwa komputera zawierającego rozszerzenie.
