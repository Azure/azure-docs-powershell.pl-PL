...
### Przykład 1: Dodawanie nowego rozszerzenia do komputera
```powershell
...
### Przykład 2: Dodawanie nowego rozszerzenia z parametrami rozszerzenia określonymi za pośrednictwem rurociągu
```powershell
...
Spowoduje to utworzenie nowego rozszerzenia z parametrami rozszerzenia dostarczonymi przez obiekt przekazany za pośrednictwem rurociągu.
Jest to przydatne, jeśli chcesz poszukać parametrów jednego komputera i zastosować go do innego komputera.

### Przykład 3: Dodawanie nowego rozszerzenia z lokalizacją określoną za pośrednictwem rurociągu
```powershell
...
Spowoduje to utworzenie nowego rozszerzenia komputera przy użyciu tożsamości podanej za pośrednictwem rurociągu.
Prawdopodobnie nie będzie to możliwe.

### Przykład 4: Dodawanie nowego rozszerzenia za pomocą obiektu rozszerzenia jako lokalizacji i parametrów do zaktualizowania
```powershell
...
Spowoduje to utworzenie nowego rozszerzenia komputera przy użyciu tożsamości podanej za pośrednictwem rurociągu oraz informacji o rozszerzeniu dostarczonych przez obiekt przekazanego rozszerzenia.
Prawdopodobnie nie będzie to możliwe.
