...
## Opis
Polecenie cmdlet **New-AzRelayAuthorizationRule** tworzy nową regułę autoryzacji dla określonych jednostek przekazujących (Namespace/WcfRelay/HybridConnection).
...
Tworzy `AuthoRule1` prawa do **odsłuchiwania** dla połączenia hybrydowego `TestHybridConnection` .
