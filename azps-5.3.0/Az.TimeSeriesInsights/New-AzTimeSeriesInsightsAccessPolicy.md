...
### Przykład 1: Tworzenie zasad dostępu dla określonego środowiska
```powershell
...
To polecenie tworzy zasady dostępu dla określonego środowiska.
...
### -PrincipalObjectId
Identyfikator obiektu (objectId) podmiotu zabezpieczeń w usłudze Azure Active Directory.
...
### -Rola
Lista ról, do których podmiot zabezpieczeń jest przydzielony w środowisku.
...
### Microsoft. Azure. PowerShell. polecenia. TimeSeriesInsights. models. Api20200515. IAccessPolicyResource
