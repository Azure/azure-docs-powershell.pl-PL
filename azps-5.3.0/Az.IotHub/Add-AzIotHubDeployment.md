...
## Opis
W przypadku obliczania na żądanie można utworzyć wyniki wdrażania programu Edge za pomocą metryk zdefiniowanych przez użytkownika.
...
Utwórz wdrożenie krawędziowe z metadanymi domyślnymi.
...
Utwórz wdrożenie krawędziowe o priorytecie 3, które obowiązują w sytuacji, gdy urządzenie jest oznakowane w budynku 9, a środowisko to "test".
...
Utwórz wdrożenie na podstawie metryki użytkownika.
...
Utwórz wdrożenie krawędzi z etykietami.
...
Utwórz wdrożenie na krawędzi z zawartością.
...
### -ModulesContent
Zawartość wdrożenia modułów na urządzeniach IoT Edge.
