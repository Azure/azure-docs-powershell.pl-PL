...
## Opis
Zbadaj Centrum IoT za pomocą wydajnego języka SQL, aby pobrać informacje dotyczące urządzeń i modułów Twins, zadań i routingu wiadomości.
https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-languageAby uzyskać więcej informacji, zobacz.
...
Badanie wszystkich danych dotyczących sznurka urządzenia w usłudze Azure IoT Hub.
...
Badanie na urządzeniu docelowym dwóch pierwszych danych dotyczących sznurów modułowych 2.
...
Domyślnie w kwerendzie nie ma końca.
