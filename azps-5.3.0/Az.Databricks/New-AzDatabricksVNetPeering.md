...
## STRESZCZENIe
Tworzy komunikację równorzędną vNet dla obszaru roboczego.
...
### Przykład 1. Tworzenie komunikacji równorzędnej wirtualnej dla kostek
```powershell
...
To polecenie tworzy komunikację równorzędną wirtualnej dla datakostki.
...
### -AllowGatewayTransit
Jeśli linki bramy mogą być używane w zdalnej wirtualnej sieci, aby połączyć się z tą siecią wirtualną.
...
Czy maszyny wirtualne w lokalnej wirtualnej przestrzeni sieciowej będą mogły uzyskiwać dostęp do maszyn wirtualnych w zdalnej przestrzeni sieci wirtualnej.
...
Identyfikator sieci wirtualnej datakostek.
...
### -Name (nazwa)
Nazwa komunikacji równorzędnej w obszarze roboczym sieci wirtualnej.
...
### -UseRemoteGateway
Jeśli bramy zdalne mogą być używane w tej sieci wirtualnej.
