...
### Przykład 1: uzyskiwanie obszaru roboczego datakostki z nazwą
```powershell
...
To polecenie umożliwia pobieranie obszaru roboczego datakostki w grupie zasobów.

### Przykład 2: wyświetlanie wszystkich obszarów roboczych datacegły w subskrypcji
```powershell
...
To polecenie wyświetla listę wszystkich obszarów roboczych datacegły w subskrypcji.

### Przykład 3: wyświetlanie wszystkich obszarów roboczych datakostek w grupie zasobów
```powershell
...
To polecenie wyświetla listę wszystkich obszarów roboczych datakostek w grupie zasobów.
