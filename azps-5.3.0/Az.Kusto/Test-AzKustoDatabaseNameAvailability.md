...
### Przykład 1: Sprawdzanie dostępności nazwy bazy danych Kusto, która jest w użyciu
```powershell
...
Powyższe polecenie zwraca informację o tym, czy w klastrze "testnewkustocluster" istnieje Kusto baza danych o nazwie "mykustodatabase".

### Przykład 2: Sprawdzanie dostępności nazwy bazy danych Kusto, która nie jest używana
```powershell
...
Powyższe polecenie zwraca informację o tym, czy w klastrze "testnewkustocluster" istnieje Kusto baza danych o nazwie "mykustodatabase2".
...
### -Type
Typ zasobu, na przykład Microsoft. Kusto/klastry/bazy danych.
...
### Microsoft. Azure. PowerShell. polecenia. Kusto. models. Api20200918. ICheckNameResult
