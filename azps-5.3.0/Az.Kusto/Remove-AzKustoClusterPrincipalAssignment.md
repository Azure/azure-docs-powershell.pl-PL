...
### Przykład 1: Usuwanie istniejącego PrincipalAssignment klastra Kusto według nazwy
```powershell
...
Powyższe polecenie usuwa PrincipalAssignment o nazwie "kustoprincipal1" w Kusto klastrze "testnewkustocluster".
