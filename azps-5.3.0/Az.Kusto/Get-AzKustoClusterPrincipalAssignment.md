...
### Przykład 1: Lista wszystkich Kusto klastra principalAssignment
```powershell
...
Powyższe polecenie wyświetla listę wszystkich principalAssignment w klastrze "testnewkustocluster".

### Przykład 2: Pobiera Kusto klastra principalAssignment według nazwy
```powershell
...
Powyższe polecenie zwraca Kusto klastra principalAssignment o nazwie "kustoprincipal1" w klastrze "testnewkustocluster".
...
### Microsoft. Azure. PowerShell. polecenia. Kusto. models. Api20200918. IClusterPrincipalAssignment
