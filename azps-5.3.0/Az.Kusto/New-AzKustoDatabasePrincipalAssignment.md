...
### Przykład 1: Tworzenie Kusto bazy danych klastra principalAssignment
```powershell
...
Powyższe polecenie tworzy Kusto bazy danych klastra principalAssignment
...
### -PrincipalId
Identyfikator podmiotu zabezpieczeń przypisany do podmiotu zabezpieczeń bazy danych.
...
### -Dzierżawy
Identyfikator dzierżawy głównej
...
### Microsoft. Azure. PowerShell. polecenia. Kusto. models. Api20200918. IDatabasePrincipalAssignment
