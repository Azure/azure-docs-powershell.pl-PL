...
### Przykład 1: Tworzenie Kusto klastra principalAssignment
```powershell
...
Powyższe polecenie tworzy principalAssignment klastra Kusto
...
### -PrincipalId
Identyfikator podmiotu zabezpieczeń przypisany do podmiotu zabezpieczeń klastra.
