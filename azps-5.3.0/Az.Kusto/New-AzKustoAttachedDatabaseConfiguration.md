...
### Przykład 1. Utwórz nowy AttachedDatabaseConfiguration
```powershell
...
Powyższe polecenie tworzy bazę danych tylko do odczytu "mykustodatabase" w klastrze "testnewkustoclusterf".
Jest on zgodny z bazą danych "mykustodatabase" z poziomu klastra "testnewkustocluster"
...
### -ClusterResourceId
Identyfikator zasobu klastra, w którym znajdują się bazy danych, które chcesz dołączyć.
...
### -DatabaseName
Nazwa bazy danych, którą chcesz dołączyć, użyj *, jeśli chcesz śledzić wszystkie bieżące i przyszłe bazy danych.
...
Rodzajowe modyfikacje podmiotów domyślnych
...
### Microsoft. Azure. PowerShell. polecenia. Kusto. models. Api20200918. IAttachedDatabaseConfiguration
