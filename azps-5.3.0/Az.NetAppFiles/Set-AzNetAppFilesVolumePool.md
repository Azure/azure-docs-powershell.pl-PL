...
## Opis
Polecenie cmdlet **Set-AzNetAppFilesVolumePool** zmienia pulę woluminu ANF.
...
Spowoduje to zmianę puli woluminu na wolumin o identyfikatorze 7d6e4069-6c78-6c61-7bf6-c60968e45fbf.
...
### -Inputobject
Obiekt woluminu do przeniesienia
...
### -NewPoolResourceId
Identyfikator zasobu puli zdoln. do przeniesienia.
Identyfikator UUID (wersja 4) służący do identyfikowania puli
...
### -Poolobject
Obiekt Pool zawierający wolumin
