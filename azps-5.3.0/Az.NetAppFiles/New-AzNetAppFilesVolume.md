...
### — Kopia zapasowa
Tablica Hashtable przedstawiająca obiekt kopii zapasowej
...
### -BackupId
Identyfikator kopii zapasowej. Identyfikator UUID (wersja 4) lub identyfikator zasobu służący do identyfikowania kopii zapasowej
...
### -ExportPolicy
Tablica Hashtable, która reprezentuje zasady eksportu
...
### -KerberosEnabled
Opis, czy dla woluminu jest włączony protokół Kerberos
...
### -Poolobject
Pula dla nowego obiektu woluminu
...
### -ReplicationObject
Tablica Hashtable przedstawiająca obiekt replikacji
...
### -Migawka
Tablica Hashtable przedstawiająca obiekt Snapshot
...
Jeśli ta funkcja jest włączona (prawda), wolumin będzie zawierać katalog Snapshot (tylko do odczytu), który zapewnia dostęp do każdej migawki woluminu (domyślnie prawda).
...
### -SnapshotId
Utwórz wolumin na podstawie migawki. Identyfikator UUID (wersja 4) lub identyfikator zasobu służący do identyfikowania migawki
...
### -SubnetId
Identyfikator URI zasobu platformy Azure dla delegowanej podsieci
...
### -ThroughputMibps
Maksymalna produktywność w Mibps, którą można osiągnąć w tym woluminie
...
### -UsageThreshold
Maksymalny przydział przestrzeni dyskowej dozwolony dla systemu plików w bajtach
