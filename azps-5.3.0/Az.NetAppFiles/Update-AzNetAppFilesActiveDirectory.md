...
## Opis
Polecenie cmdlet **Update-AzNetAppFilesAccount** modyfikuje konfigurację usługi ANF Active Directory.
...
To polecenie wykonuje aktualizację dla danej konfiguracji usługi Active Directory, modyfikując tę nazwę użytkownika.
...
### -ActiveDirectoryId
Identyfikator usługi ANF Active Directory
