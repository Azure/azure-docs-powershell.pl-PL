...
## Opis
Przywracanie/przywracanie woluminu do migawki określonej w parametrze SnapshotId
...
To polecenie przywraca/przywraca głośność woluminu do jednej z migawek z snapshotIdą 7d6e4069-6c78-6c61-7bf6-c60968e45fbf
...
### -PassThru
Zwracanie, czy określony wolumin został pomyślnie przywrócony/przywrócony
...
### -Poolobject
Obiekt Pool zawierający wolumin do usunięcia
...
### -SnapshotId
SnapshotId migawki.
Identyfikator UUID (wersja 4) służący do identyfikowania migawki
