...
## Opis
Polecenie cmdlet **Update-AzNetAppFilesBackupPolicy** modyfikuje zasady tworzenia kopii zapasowych ANF.
...
To polecenie powoduje zmianę zasad tworzenia kopii zapasowej ANF "MyBackupPolicy", aby uzyskać dane DailyBackupsToKeep.
...
### -Accountobject
Obiekt konta zawierający zasady tworzenia kopii zapasowych do zaktualizowania
...
### -DailyBackupsToKeep
Liczba codziennych kopii zapasowych do zachowania
...
### -Inputobject
Obiekt BackupPolicy do usunięcia
...
Liczba comiesięcznych kopii zapasowych do zachowania
...
### -ResourceId
Identyfikator zasobu zasad tworzenia kopii zapasowej ANF
...
### -Tag
Tablica Hashtable przedstawiająca znaczniki zasobów
...
### -WeeklyBackupsToKeep
Tygodniowa liczba kopii zapasowych do zachowania
...
### -YearlyBackupsToKeep
Roczna liczba kopii zapasowych do zachowania
