...
To polecenie zawiesza połączenie replikacji ANF w woluminie "MyDestinationAnfVolume".
...
### -ForceBreak
Jeśli replikacja jest w stanie transferowania i chcesz wymusić zerwanie replikacji, ustaw wartość PRAWDA
...
### -Inputobject
Obiekt woluminu docelowego ANF z replikacją do podziału
...
### -PassThru
Zwraca, czy przerwano wykonywanie replikacji woluminu.
