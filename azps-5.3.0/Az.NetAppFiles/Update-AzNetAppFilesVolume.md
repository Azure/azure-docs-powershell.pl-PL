...
### Przykład 1: aktualizowanie woluminu ANF
```
...
To polecenie aktualizuje wolumin ANF "MyAnfVolume" przy użyciu nowego rozmiaru UsageThreshold.
...
### -Inputobject
Obiekt woluminu do zaktualizowania
...
### -Poolobject
Obiekt Pool zawierający wolumin do zaktualizowania
