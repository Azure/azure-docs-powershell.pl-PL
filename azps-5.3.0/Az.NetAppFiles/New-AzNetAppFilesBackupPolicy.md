...
## Opis
Polecenie cmdlet **New-AzNetAppFilesActiveDirectory** tworzy nowe zasady tworzenia kopii zapasowych dla konta usługi ANF.
...
To polecenie tworzy nowe zasady ANF kopii zapasowej dla konta ANF o nazwie Account (Moje konto).
...
### -Accountobject
Obiekt konta dla nowych zasad tworzenia kopii zapasowych
