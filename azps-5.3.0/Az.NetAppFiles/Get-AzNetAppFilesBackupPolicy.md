...
## Opis
Polecenie cmdlet **Get-AzNetAppFilesBackupPolicy** pobiera szczegółowe informacje o ANFych zasadach tworzenia kopii zapasowych.
...
To polecenie pobiera zasady tworzenia kopii zapasowych o nazwie "MyBackupPolicy" dla konta "MyAnfAccount".
...
### -Accountobject
Obiekt konta zawierający zasady tworzenia kopii zapasowych do zwrócenia
