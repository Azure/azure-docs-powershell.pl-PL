...
### Przykład 1: uzyskiwanie schematu synchronizacji dla bazy danych centrum
```powershell
...
### Przykład 2: uzyskiwanie schematu synchronizacji dla bazy danych centrum i rozszerzanie tabel
```powershell
...
### Przykład 3: uzyskiwanie schematu synchronizacji dla bazy danych członka
```powershell
