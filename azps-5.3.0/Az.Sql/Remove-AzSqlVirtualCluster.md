...
### RemoveVirtualClusterFromInputParameters (domyślny)
```
...
## Opis
Polecenie cmdlet **Remove-AzSqlVirtualCluster** usuwa klaster wirtualny Azure SQL.
...
To polecenie usuwa klaster wirtualny o nazwie VirtualCluster1 przypisany do ResourceGroup01 grupy zasobów.
...
### -Inputobject
Obiekt wystąpienia do usunięcia
