...
### Przykład 3: Włączanie zasad inspekcji magazynu obiektów BLOB bazy danych Azure SQL z filtrowaniem przy użyciu predykatu T-SQL
```powershell
...
### Przykład 4: usuwanie filtrowania z zasad inspekcji bazy danych Azure SQL Database
```powershell
