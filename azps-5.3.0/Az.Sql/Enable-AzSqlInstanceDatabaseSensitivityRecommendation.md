...
## Opis
Polecenie cmdlet Enable-AzSqlInstanceDatabaseSensitivityRecommendation włącza rekomendacje dotyczące wrażliwości na kolumny w bazie danych wystąpienia zarządzanego SQL Azure.

## Przykłady

### Przykład 1: Włączanie rekomendacji dotyczących wrażliwości dla danej kolumny w bazie danych wystąpienia zarządzanego SQL Azure.
```powershell
...
### Przykład 2: Włączanie rekomendacji dotyczących wrażliwości dla danej kolumny w bazie danych wystąpienia zarządzanego SQL Azure z potokiem.
```powershell
