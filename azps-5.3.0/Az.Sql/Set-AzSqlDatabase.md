...
### Przykład 4: aktualizowanie istniejącej bazy danych ogólnego przeznaczenia w celu przeskalowania warstwy usługi
```
...
To polecenie aktualizuje bazę danych o nazwie Database01 w ogólnym celu w celu przedskalowania warstwy usługi.
...
### -ComputeModel
Obliczony model bazy danych Azure SQL Database. Serwer lub Zainicjowano obsługę administracyjną
...
Liczba replik pomocniczych tylko do odczytu skojarzonych z bazą danych.  Dotyczy tylko wersji z podskalą.
