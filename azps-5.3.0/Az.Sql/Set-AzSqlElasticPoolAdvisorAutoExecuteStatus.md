...
## Opis
Polecenie cmdlet **Set-AzSqlElasticPoolAdvisorAutoExecuteStatus** ustawia właściwość AutoExecute dla klasyfikatora Elastic Pool SQL platformy Azure.
...
To polecenie ustawia stan automatycznego wykonania klasyfikatora o nazwie "Moja indeks" na włączony.

## PARAMETRÓW

### -Klasyfikatorname
Określa nazwę klasyfikatora, dla którego to polecenie cmdlet aktualizuje stan automatycznego wykonywania.
...
### -AutoExecuteStatus
Określa nową wartość, na którą to polecenie cmdlet aktualizuje stan automatycznego wykonywania.
...
## INFORMACYJN
* Słowa kluczowe: Azure, azurerm, ARM, Resource, Management, Manager, SQL, elastyczna Pula, MSSQL, Doradca
