...
## Opis
Polecenie cmdlet **Set-AzSqlDatabaseBackupLongTermRetentionPolicy** ustawia zasady przechowywania terminów długoterminowych zarejestrowane w tej bazie danych.
...
### Przykład 5: usuwanie zasad przechowywania długich terminów
```powershell
...
### Przykład 6: usuwanie zasad przechowywania długich terminów
```powershell
