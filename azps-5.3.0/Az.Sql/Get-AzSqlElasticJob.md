...
## Opis
Polecenie cmdlet Get-AzSqlElasticJob powoduje wyświetlenie jednego lub większej liczby zadań

## Przykłady

### Przykład 1: Pobiera zadanie
```powershell
...
Pobiera jedno lub więcej zadań. (autogenerowana)
