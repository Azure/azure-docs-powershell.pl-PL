...
## Opis
Polecenie cmdlet **Invoke-AzSqlInstanceFailover** w trybie failover wystąpienia zarządzanego SQL Azure.
...
To polecenie przejdzie w tryb failover replika podstawowa wystąpienia o nazwie "ManagedInstance01".
...
To polecenie przejdzie w tryb failover do czytelnej repliki pomocniczej zarządzanego wystąpienia "ManagedInstance01".
...
### -Name (nazwa)
Nazwa wystąpienia SQL Azure, które ma zostać usunięte.
...
### -ReadableSecondary
Przejmowanie awaryjnej repliki pomocniczej zamiast domyślnej repliki podstawowej
