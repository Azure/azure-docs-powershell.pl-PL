...
## Opis
Polecenie cmdlet **New-AzHDInsightClusterAutoscaleScheduleCondition** umożliwia utworzenie warunku automatycznego skalowania opartego na harmonogramie.
...
To polecenie tworzy warunek, w którym klaster automatycznie przeskaluje się do 5 węzłów roboczych o godzinie 09:00 co poniedziałek, środa.

### Przykład 2: włączenie automatycznego skalowania klastra na podstawie harmonogramu za pomocą warunku automatycznego skalowania.
```powershell
...
### -Day
Pobiera lub ustawia liczbę dni warunku harmonogramu autoskalowania.
...
### -Time (czas)
Pobiera lub ustawia godzinę warunku harmonogramu autoskalowania.
...
### -WorkerNodeCount
Pobiera lub ustawia liczbę workernode harmonogramu o warunku harmonogramu automatycznego skalowania.
...
### Microsoft. Azure. Commands. HDInsight. modele. AzureHDInsightAutoscaleCondition
