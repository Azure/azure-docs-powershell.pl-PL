...
### Przykład 1: aktualizowanie węzła transkationowego
```powershell
...
To polecenie powoduje zaktualizowanie węzła transakcji.

### Przykład 2: aktualizowanie węzła transkationowego
```powershell
