...
### Przykład 1: Lista członków Blockchain
```powershell
...
To polecenie wyświetla listę członków Blockchain w ramach abonamentu.

### Przykład 2: Lista członków Blockchain
```powershell
...
To polecenie wyświetla listę członków Blockchain w grupie zasobów.

### Przykład 3: uzyskiwanie członka Blockchain
```powershell
...
To polecenie pobiera członka Blockchain w ramach grupy zasobów.

### Przykład 4: uzyskiwanie członka Blockchain
```powershell
