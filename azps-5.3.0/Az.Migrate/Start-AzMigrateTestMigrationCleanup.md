...
## STRESZCZENIe
Czyści migrację testową dla serwera replikowanego.
...
### Przykład 1: Identyfikator komputera.
```powershell
...
### -Inputobject
Określa serwer replikacji, dla którego należy zainicjować oczyszczanie migracji testowej.
Obiekt serwera można pobrać przy użyciu polecenia cmdlet Get-AzMigrateServerReplication do skonstruowania, zobacz sekcja notatki dla właściwości INPUTobject i tworzenie tabeli skrótów.
...
INPUTobject <IMigrationItem> : Określa serwer replikacji, dla którego należy zainicjować oczyszczanie migracji testów. Obiekt serwera można pobrać przy użyciu polecenia cmdlet Get-AzMigrateServerReplication
