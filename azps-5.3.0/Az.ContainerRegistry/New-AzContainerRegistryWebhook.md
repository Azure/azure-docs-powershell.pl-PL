...
## Opis
Polecenie cmdlet New-AzContainerRegistryWebhook tworzy element webhook rejestru kontenera.

## Przykłady

### Przykład 1: Tworzenie elementu webhook rejestru kontenera.
```
...
Tworzenie elementu webhook rejestru kontenera.
...
### — Lokalizacja
Lokalizacja elementu webhook.
Domyślną lokalizacją rejestru.
...
### -Status
Stan elementu webhook, wartość domyślna jest włączona
