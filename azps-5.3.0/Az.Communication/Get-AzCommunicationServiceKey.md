...
## STRESZCZENIe
Uzyskiwanie klawiszy dostępu do zasobu CommunicationService.
...
### Przykład 1: Pobieranie klucza dla określonej usługi komunikacji
```powershell
...
Wyświetla parametry ConnectionString i Key określonej usługi komunikacji.
