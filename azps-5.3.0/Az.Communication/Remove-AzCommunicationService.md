...
## STRESZCZENIe
Operacja usuwania CommunicationService.
...
### Przykład 1: usuwanie określonego zasobu komunikacyjnego platformy Azure
```powershell
PS C:\> Remove-AzCommunicationService -Name ContosoAcsResource1 -ResourceGroupName ContosoResourceProvider1
```

Usuwanie lub usuwanie zasobu komunikacyjnego platformy Azure.
