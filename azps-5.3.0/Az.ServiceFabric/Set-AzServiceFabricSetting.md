...
## Opis
Aby dodać lub zaktualizować ustawienia sieci szkieletowej usług w klastrze, użyj **Ustawienia Set-AzServiceFabricSetting** .
...
W tym poleceniu w sekcji "NamingService" zostanie ustawiona wartość "MaxFileOperationTimeout" równa "5000".
...
To polecenie wyzwoli uaktualnienie w celu ustawienia wielu ustawień sieci szkieletowej przy użyciu parametru SettingsSectionDescription.
...
### -Parameter
Nazwa parametru ustawienia sieci szkieletowej
...
### Sekcja
Nazwa sekcji Ustawienia sieci szkieletowej
...
Tablica ustawień sieci szkieletowej
...
### -Value
Wartość parametru ustawienia sieci szkieletowej
...
### Microsoft. Azure. Commands. servicefabric. MODELES. PSSettingsSectionDescription []
