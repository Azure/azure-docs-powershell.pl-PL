...
## STRESZCZENIe
Usuwanie usługi Fabric typ aplikacji z klastra. Spowoduje to usunięcie wszystkich wersji typów w obszarze ten zasób. Obsługuje tylko typy aplikacji rozmieszczone w ARM.
...
## Opis
To polecenie cmdlet umożliwia usunięcie typu aplikacji z klastra i usunięcie całej wersji tego typu w ramach tego zasobu, ale przed uruchomieniem tego polecenia wszystkie aplikacje w jego ramach powinny zostać usunięte.
...
W tym przykładzie zostanie usunięty typ aplikacji "testAppType" i cała jej wersja. Jeśli istnieją jakieś aplikacje utworzone za pomocą tego typu, polecenie generuje wyjątek.
...
### -ResourceId
Identyfikator zasobu ARM dla typu aplikacji.
...
### Microsoft. Azure. Commands. servicefabric. MODELES. PSApplicationType
