...
## Opis
Przenosi zasób skojarzenia zobowiązań z planu zobowiązań nadrzędnych do innego planu zobowiązań.

## Przykłady

### Przykład 1: przenoszenie powiązania zobowiązań
```
...
### -DestinationPlanId
Identyfikator zasobu platformy Azure docelowego planu zobowiązań usługi Azure ML.
