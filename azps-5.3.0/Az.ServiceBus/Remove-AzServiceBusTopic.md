...
## Opis
Polecenie cmdlet **Remove-AzServiceBusTopic** usuwa temat z określonego obszaru nazw usługi Service Bus.
...
Usuwa temat `SB-Topic_exampl1` z obszaru nazw `SB-Example1` .
...
### Przykład 4: Identyfikator zasobu przy użyciu zmiennej:
```powershell
PS C:\> $resourceid = Get-AzServiceBusTopic <params>
PS C:\> Remove-AzServiceBusTopic -ResourceId $resourceid.Id
```

### Przykład 5: ResourceId przy użyciu wartości ciągu
```powershell
...
### -ResourceId
Identyfikator zasobu tematu magistrali usług
