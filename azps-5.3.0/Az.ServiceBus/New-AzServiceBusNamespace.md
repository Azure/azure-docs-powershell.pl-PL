...
## Opis
Polecenie cmdlet **New-AzServiceBusNamespace** tworzy nowy obszar nazw usługi Service Bus. Po utworzeniu manifest zasobów przestrzeni nazw jest niezmienny. Ta operacja jest idempotent.
...
Tworzy nowy obszar nazw usługi Service Bus w określonej grupie zasobów.
...
### — Lokalizacja
Lokalizacja obszaru nazw usługi Service Bus.
...
### -SkuCapacity
Jednostki przepływów pracy w usłudze Service Bus Premium, dozwolone wartości 1 lub 2 lub 4
...
### -SkuName
Nazwa SKU obszaru nazw usługi Service Bus.
