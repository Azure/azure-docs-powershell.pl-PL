...
## Opis
Polecenia cmdlet **stop-AzServiceBusMigration** kończą migrację między standardowym obszarem nazw Premium
...
Polecenie cmdlet powoduje zakończenie migracji między standardową przestrzenią nazw a obszarem nazw Premium podanym podczas tworzenia konfiguracji migracji.
...
### -Inputobject
Obiekt Namespace konfiguracji migracji usługi Service Bus Standard
...
### -ResourceId
Identyfikator zasobu standardowej przestrzeni nazw konfiguracji migracji usługi Service Bus
