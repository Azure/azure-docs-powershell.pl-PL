...
### Przykład 1: domyślnie Utwórz AzDigitalTwinsInstance.
```powershell
...
Domyślnie Utwórz AzDigitalTwinsInstance

### Przykład 2: Tworzenie AzDigitalTwinsInstance za pomocą obiektu AzDigitalTwins.
```powershell
...
Tworzenie AzDigitalTwinsInstance za pomocą obiektu AzDigitalTwins
...
Aby skonstruować, zobacz sekcję notatki dla właściwości DIGITALTWINSCREATE i Utwórz tablicę skrótów.
...
DIGITALTWINSCREATE <IDigitalTwinsDescription> : Opis usługi DigitalTwins.
  - `Location <String>`: Lokalizacja zasobu.
  - `[Tag <IDigitalTwinsResourceTags>]`: Znaczniki zasobów.
