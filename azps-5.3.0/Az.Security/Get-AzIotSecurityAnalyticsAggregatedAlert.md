...
## Opis
Polecenie cmdlet Get-AzIotSecurityAnalyticsAggregatedAlert zwraca co najmniej jedno zagregowane ostrzeżenie na urządzeniu Centrum IoT.
Nazwa zagregowanych alertów to kombinacja typu alertu i daty aggragted alertu rozdzielonej znakiem "/".
...
Uzyskiwanie zagregowanego alertu "IoT_Bruteforce_Fail/2019-02-02" (nazwa połączona z typu alertu i jego zagregowaną datą) w rozwiązaniu "Moje rozwiązanie" i "Grupa zasobów"
...
Wyświetlanie listy wszystkich zagregowanych alertów w rozwiązaniu "Moje rozwiązanie" i Grupa zasobów "Moja zasobów"
