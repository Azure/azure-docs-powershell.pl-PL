...
Pobiera plany usługi Azure Defender dla subskrypcji w centrum zabezpieczeń platformy Azure.
...
Za pomocą tego polecenia cmdlet możesz wyświetlić każdy plan usługi Azure Defender, na abonament.
...
Pobiera stan każdego planu usługi Azure Defender dla subskrypcji.
...
Pobiera szczegóły cennika dotyczące określonego identyfikatora zasobu. Gdzie ResourceId jest jednym z identyfikatorów zwróconych przez `Get-AzSecurityPricing` .
...
Pobiera szczegóły cennika dla nazwanego planu usługi Azure Defender. Gdzie `name` jest jedna z nazw zwracanych przez `Get-AzSecurityPricing` .
