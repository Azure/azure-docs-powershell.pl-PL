...
## STRESZCZENIe
Pobiera grupę VM/serwer w formancie aplikacji.
...
## Opis
Kontrolki aplikacji adaptacyjnych są obliczane automatycznie przez usługę Azure Security Center, użyj tego polecenia cmdlet, aby uzyskać grupę obiektów VM/serwer w formancie aplikacji.
...
### -AscLocation
Miejsce, w którym są przechowywane dane subskrypcji w polu ASC. można pobrać z lokalizacji Uzyskaj lokalizacje.
...
### -GroupName
Nazwa grupy kontrolek VM/serwer w aplikacji.
