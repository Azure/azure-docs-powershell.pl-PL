...
## Opis
Polecenie cmdlet **New-AzStackEdgeOrder** tworzy nowe zamówienie na urządzeniu z krawędzią stosu. Aby utworzyć zamówienie, należy najpierw utworzyć zasób urządzenia z krawędzią stosu. Możesz określić szczegóły, takie jak osoba kontaktowa, nazwa firmy, e-mail, adres itd., jako parametry tworzenia zamówienia.
...
### -Mail
Lista wiadomości E-mail, które mają otrzymywać aktualizacje, akceptuje maksymalnie 10 wiadomości e-mail
...
### -Phone
Numer telefonu osoby do kontaktów
...
### Microsoft. Azure. PowerShell. polecenia. StackEdge. models. PSStackEdgeOrder
