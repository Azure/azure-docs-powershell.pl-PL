...
## Opis
Polecenie cmdlet **New-AzStackEdgeUser** tworzy nowego użytkownika dla urządzenia ze stosem. Możliwość tworzenia tylko użytkowników typu `Share` jest obsługiwana.
