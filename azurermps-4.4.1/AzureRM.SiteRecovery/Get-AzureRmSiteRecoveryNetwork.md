...
## Opis
Polecenie cmdlet **Get-AzureRmSiteRecoveryNetwork** pobiera informacje o sieciach usługi Azure Site Recovery dla bieżącego magazynu usługi Azure Site Recovery.
...
### -FriendlyName
Określa przyjazną nazwę sieci maszyny wirtualnej.
...
### -Name (nazwa)
Określa nazwę sieci maszyny wirtualnej.
...
### Ciąg
Parametr "FriendlyName" akceptuje wartość typu "String" z procesu
