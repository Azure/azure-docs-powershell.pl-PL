...
## Opis
Polecenie cmdlet **New-AzureRmSiteRecoveryPolicy** tworzy zasady replikacji odzyskiwania witryny platformy Azure.
...
Określa częstotliwość spójnej migawki aplikacji w godzinach.
...
### -Name (nazwa)
Określa przyjazną nazwę identyfikującą zasady replikacji odzyskiwania witryny.
...
Określa identyfikator konta usługi Azure Storage dla lokalizacji docelowej replikacji.
