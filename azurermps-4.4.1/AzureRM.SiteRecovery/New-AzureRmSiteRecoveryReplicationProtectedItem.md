...
## Opis
Polecenie cmdlet **New-AzureRmSiteRecoveryReplicationProtectedItem** tworzy nowy element chroniony replikacji.
Użyj tego polecenia cmdlet, aby włączyć replikację dla elementu chronionego.
...
### -Name (nazwa)
Określa nazwę elementu chronionego replikacji za pomocą usługi Azure Site Recovery.
...
### -ProtectableItem
Określa element ochrona przed odzyskiwaniem witryny Azure.
...
Określa obiekt mapowania kontenera ochrony usługi Azure Site Recovery, który ma być używany do replikacji.
...
Określa identyfikator konta usługi Azure Storage, do którego jest replikowana to polecenie cmdlet.
...
### -WaitForCompletion
Wskazuje, że polecenie cmdlet oczekuje na ukończenie.
