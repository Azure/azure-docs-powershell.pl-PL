...
## Opis
Polecenie cmdlet **Set-AzureRmSiteRecoveryProtectionEntity** włącza lub wyłącza ochronę jednostki ochrony przed odzyskiwaniem witryny Azure.
...
Określa identyfikator docelowego konta usługi Azure Storage.
...
### -WaitForCompletion
Wskazuje, że polecenie oczekuje na ukończenie przed zwróceniem.
