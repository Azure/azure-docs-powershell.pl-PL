...
## Opis
Polecenie cmdlet **Get-AzureRmSiteRecoveryProtectableItem** Pobiera elementy, które należy chronić w kontenerze ochrona odzyskiwania witryny platformy Azure.
...
### -FriendlyName
Określa przyjazną nazwę elementu ochrony przed odzyskiwaniem witryny platformy Azure.
...
### -Name (nazwa)
Określa nazwę elementu do ochrony przed odzyskiwaniem witryny platformy Azure.
