...
## STRESZCZENIe
Umożliwia zaktualizowanie określonego mapowania sieci funkcji ASR.
...
### -Inputobject
Obiekt wejściowy: określa obiekt mapowania sieci funkcji ASR odpowiadający mapowaniu sieci funkcji ASR, który ma zostać zaktualizowany 
