...
## Opis
Polecenie cmdlet **Get-AzureKeyVaultCertificateOperation** Pobiera stan operacji certyfikatu.

## Przykłady

### Przykład 1: uzyskiwanie stanu operacji na certyfikacie
```
...
To polecenie uzyskuje stan operacji certyfikatu dla TestCert01 w magazynie kluczy ContosoKV01.
