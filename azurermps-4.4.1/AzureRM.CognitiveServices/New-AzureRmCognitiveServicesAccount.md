...
Aby uzyskać więcej informacji, zobacz [interfejsy API usług poznawczych](https://www.microsoft.com/cognitive-services/en-us/apis).
...
### -Type
Określa typ konta, które ma zostać utworzone. Dopuszczalne wartości tego parametru to:
