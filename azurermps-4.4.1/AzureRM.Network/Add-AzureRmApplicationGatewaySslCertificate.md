...
## Opis
Polecenie cmdlet **Add-AzureRmApplicationGatewaySslCertificate** dodaje certyfikat SSL do bramy aplikacji.

## Przykłady

### Przykład 1. Dodaj certyfikat SSL do bramy aplikacji.
```
