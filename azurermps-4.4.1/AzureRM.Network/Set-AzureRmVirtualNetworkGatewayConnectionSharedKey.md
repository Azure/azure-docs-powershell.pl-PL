...
## Opis
Polecenie cmdlet **Set-AzureRmVirtualNetworkGatewayConnectionSharedKey** konfiguruje klucz współużytkowany połączenia bramy sieci wirtualnej.
...
### -Name (nazwa)
Określa nazwę klucza udostępnionego bramy sieci wirtualnej.
