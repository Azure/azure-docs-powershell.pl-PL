...
## Opis
Polecenie cmdlet **Remove-AzureRmServiceBusQueueAuthorizationRule** usuwa regułę autoryzacji kolejki z określonego obszaru nazw usługi Service Bus.
...
Usuwa `SBAuthoRule1` z obszaru nazw regułę autoryzacji kolejki `SB-Queue_exampl1` `SB-Example1` .
...
### -Name (nazwa)
Nazwa AuthorizationRule kolejki.
