...
## Opis
Polecenie cmdlet **New-AzureRmServiceBusTopicAuthorizationRule** tworzy nową regułę autoryzacji dla określonego tematu magistrali usług.
...
Tworzy regułę autoryzacji `SBTopicAuthoRule1` z uprawnieniami **odsłuchiwania** i **wysyłania** dla tematu `SB-Topic_exampl1` .
