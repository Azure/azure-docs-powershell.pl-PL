...
## Opis
Polecenie cmdlet **Remove-AzureRmServiceBusNamespaceAuthorizationRule** usuwa regułę autoryzacji obszaru nazw magistrali usług dla określonej grupy zasobów.
...
### -Name (nazwa)
Nazwa AuthorizationRule obszaru nazw.
