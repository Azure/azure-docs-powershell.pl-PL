...
## Opis
Polecenie cmdlet **Set-AzureRmServiceBusTopicAuthorizationRule** umożliwia zaktualizowanie opisu określonej reguły autoryzacji określonego tematu magistrali usług.
...
Dodaje do sekcji **Zarządzanie** prawami dostępu w ramach reguły autoryzacji `SBTopicAuthoRule1` `SB-Topic_exampl1` .
...
### -Prawa
Intelektualn na przykład @ ("nasłuchuj"; "Wyślij"; "Zarządzaj"). Wymagane, jeśli nie podano parametru **-AuthruleObj** .
...
### -InputObj
ServiceBus temat AuthorizationRule obiekt.
