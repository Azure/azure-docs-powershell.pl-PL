...
## Opis
Polecenie cmdlet **Set-AzureRmServiceBusQueueAuthorizationRule** umożliwia zaktualizowanie opisu określonej reguły autoryzacji danej kolejki usługi Service Bus.
...
Dodaje do **zarządzania** prawa dostępu do reguły autoryzacji `SBAuthoRule1` kolejki `SB-Queue_exampl1` .

## PARAMETRÓW

### -AuthorizationRuleName
Nazwa reguły autoryzacji. Wymagane, jeśli nie podano parametru **-AuthruleObj** .
...
### -AuthRuleObj
Obiekt reguły autoryzacji kolejki usługi Service Bus.
...
### -Prawa
Prawa; na przykład @ ("nasłuchuj", "Wyślij", "Zarządzaj"). Wymagany, jeśli nie podano parametru "AuthruleObj".
