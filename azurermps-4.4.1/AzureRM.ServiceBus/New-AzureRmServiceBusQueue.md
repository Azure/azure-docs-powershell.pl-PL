...
Tworzy nową kolejkę usługi Service Bus `SB-Queue_exampl1` w określonym obszarze nazw usługi Service Bus `SB-Example1` .
...
Określa, czy wiadomości są deadletteredne po wygaśnięciu.
...
Określa domyślny czas wygaśnięcia (TTL) dla wiadomości.
...
Określa, czy są włączone operacje wsadowe po stronie serwera.
...
### -EnableExpress
Określa, czy jednostki ekspresowe są włączone. Kolejka ekspresowa przechowuje wiadomość w pamięci, zanim zapisze ją do magazynu trwałego.
...
### -EnablePartitioning
Określa, czy EnablePartitioning jest włączony.
...
Określa, czy wiadomość jest anonimowo dostępna.
...
### -MaxDeliveryCount
Określa maksymalną liczbę dostaw. Po tej liczbie dostaw automatycznie deadlettered wiadomość.
...
### -MaxSizeInMegabytes
Określa maksymalny rozmiar kolejki w megabajtach, czyli rozmiar pamięci przydzielonej kolejki.
...
### -MessageCount
Określa liczbę wiadomości w kolejce.
...
Określa, czy kolejka wymaga wykrywania duplikatów.
...
### -RequiresSession
Określa, czy ta Kolejka obsługuje sesje.
...
Nazwa: SB-Queue_exampl1 lokalizacji: zachodni stan LockDuration: AccessedAt: AutoDeleteOnIdle: 10675199.02:48:05.4775807 EntityAvailabilityStatus: CreatedAt: 1/20/2017 2:51:36 AM DefaultMessageTimeToLive: 10675199.02:48:05.4775807 DuplicateDetectionHistoryTimeWindow: EnableBatchedOperations: prawda DeadLetteringOnMessageExpiration: false EnableExpress: EnablePartitioning 16384: IsAnonymousAccessible MaxDeliveryCount: MaxSizeInMegabytes: MessageCount: false CountDetails: FAŁSZ RequiresDuplicateDetection: 1/20/2017 2:51:37 AM
