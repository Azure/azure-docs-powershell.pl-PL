...
## Opis
Polecenie cmdlet **Get-AzureRMSqlDatabaseReplicationLink** zastępuje polecenie cmdlet **Get-AzureSqlDatabaseCopy** .
...
###  
To polecenie cmdlet umożliwia akceptowanie wystąpień **ReplicationLink** lub obiektu **bazy danych** dla podstawowej lub pomocniczej bazy danych.

## WYSYŁA

###  
To polecenie cmdlet zwraca obiekt **ReplicationLink** .
