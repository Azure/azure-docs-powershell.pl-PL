...
## Opis
Stan aktualizacji polecenia cmdlet **Set-AzureRmSqlElasticPoolRecommendedActionState** w przypadku zalecanej akcji puli elastycznej w usłudze Azure SQL.
To polecenie cmdlet powoduje zastosowanie zalecanej akcji, która została przywrócona lub odrzucona na podstawie nowego stanu.

## Przykłady

### Przykład 1: aktualizowanie stanu zalecanej akcji na oczekujące
```
...
To polecenie powoduje zaktualizowanie stanu zalecanej akcji puli elastycznej o nazwie IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893 na oczekujące.
...
### -State
Określa wartość, na którą to polecenie cmdlet aktualizuje zalecany stan akcji.
