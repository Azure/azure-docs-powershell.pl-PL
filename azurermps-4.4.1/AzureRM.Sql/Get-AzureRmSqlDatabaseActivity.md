...
## Opis
Polecenie cmdlet **Get-AzureRmSqlDatabaseActivity** Pobiera stan elastycznych baz danych, które są przenoszone do lub poza pulę Elastic Database w usłudze Azure SQL Database.
...
### -Nazwa_serwera
Określa nazwę programu Microsoft SQL Server obsługującego pulę Elastic Database.
