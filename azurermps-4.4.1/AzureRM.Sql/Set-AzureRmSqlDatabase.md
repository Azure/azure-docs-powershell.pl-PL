...
## Opis
Polecenie cmdlet **Set-AzureRmSqlDatabase** ustawia właściwości dla bazy danych SQL Azure.
Ponadto można określić parametr *ElasticPoolName* , aby przenieść bazę danych do puli elastycznej.
Jeśli baza danych znajduje się już w puli elastycznej, można użyć parametru *RequestedServiceObjectiveName* , aby przypisać poziom wydajności.
...
Możesz określić ten parametr lub *MaxSizeGB*.
Zapoznaj się z parametrem *MaxSizeGB* , aby uzyskać dopuszczalne wartości dla wersji.
