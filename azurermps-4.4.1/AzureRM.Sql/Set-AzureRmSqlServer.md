...
### -Tagi
Określa słownik tagów, które to polecenie cmdlet kojarzy z serwerem. Pary klucz-wartość w formie tabeli skrótów ustawione jako znaczniki na serwerze. Na przykład:
