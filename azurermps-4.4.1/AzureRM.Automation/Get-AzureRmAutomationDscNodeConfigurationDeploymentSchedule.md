...
## Opis
Polecenie cmdlet **Get-AzureRmAutomationDscNodeConfigurationDeployment** umożliwia wdrożenie konfiguracji węzła APS (Konfiguracja stanu żądanego) w usłudze Azure Automation.

## Przykłady

### Przykład 1. Pobierz wszystkie harmonogramy wdrażania
```
...
### Przykład 2: pobieranie harmonogramu wdrażania
```
...
### -JobScheduleId
Określa identyfikator harmonogramu zadań istniejącego zaplanowanego zadania wdrażania.
