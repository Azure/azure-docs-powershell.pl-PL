...
## Opis
Polecenie cmdlet **Start-AzureRmAutomationDscNodeConfigurationDeployment** wdraża konfigurację węzła konfiguracji stanu (DSC) w usłudze Azure Automation.
...
Powyższe polecenie wdraża konfigurację węzła DSC o nazwie "Config01. Node1" na podstawie dwuwymiarowej tablicy nazw węzłów. Wdrożenie przebiega w sposób stopniowy.

### Przykład 2: Planowanie wdrożenia konfiguracji węzła platformy Azure DSC w automatyzacji
```
...
Powyższe polecenie planuje wdrożenie konfiguracji węzła DSC o nazwie "Config01. Node1" na podstawie dwuwymiarowej tablicy nazw węzłów. Wdrożenie przebiega w sposób stopniowy i zostanie wykonany na podstawie harmonogramu.
...
Określa nazwę konfiguracji węzła DSC, którą to polecenie cmdlet wdraża.
...
### -Nodename
Określa nazwy węzłów, na których ma zostać wdrożona konfiguracja węzła.
...
### -Schedule
Obiekt harmonogramu automatyzacji umożliwiający zaplanowanie zadania wdrażania.
...
[Zatrzymaj — AzureRmAutomationDscNodeConfigurationDeployment](./Stop-AzureRmAutomationDscNodeConfigurationDeployment.md)
