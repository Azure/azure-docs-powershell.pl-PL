...
### Zestaw parametrów dla parametrów pól
```
...
## Opis
Polecenie cmdlet **Remove-AzureRmCdnProfile** usuwa profil sieci dostarczania zawartości Azure (CDN, Content Delivery Network).
...
### -CdnProfile
Określa profil, który jest usuwany przez to polecenie cmdlet.
...
### -Refilename
Określa nazwę profilu usuniętego przez ten aplet polecenia.
