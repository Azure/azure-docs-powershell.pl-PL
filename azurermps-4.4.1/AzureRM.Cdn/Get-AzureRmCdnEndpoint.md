...
## Opis
Polecenie cmdlet **Get-AzureRMCdnEndpoint** umożliwia pobranie punktu końcowego sieci dostarczania zawartości platformy Azure (CDN) i skojarzonych z nim danych konfiguracji.
...
### -CdnProfile
Określa obiekt profilu sieci CDN, do którego należy punkt końcowy.
...
Nazwa punktu końcowego nie jest nazwą hosta punktu końcowego.
...
###  
To polecenie cmdlet zwraca obiekt punktu końcowego.
