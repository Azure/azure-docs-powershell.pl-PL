...
## Opis
Polecenie cmdlet **Remove-AzureRmTrafficManagerEndpoint** umożliwia usunięcie punktu końcowego z usługi Azure Traffic Manager.

To polecenie cmdlet umożliwia przekazanie każdej zmiany do usługi Traffic Manager.
Aby usunąć wiele punktów końcowych z obiektu profilu lokalnego Menedżera ruchu i przekazać zmiany w ramach jednej operacji, użyj polecenia cmdlet Remove-AzureRmTrafficManagerEndpointConfig.
