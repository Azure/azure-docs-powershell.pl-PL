...
## Opis
Polecenie cmdlet **Get-AzureBatchNodeAgentSku** Pobiera jednostki SKU agenta węzłów dostępne na koncie usługi Azure Batch.
Określ konto przy użyciu parametru *BatchContext* .
Wyszukiwanie można zawęzić do jednostek SKU zgodnych z filtrem Open Data Protocol (OData).

## Przykłady

### Przykład 1. Pobierz wszystkie dostępne jednostki SKU agenta węzłów
```
...
Drugie polecenie pobiera wszystkie dostępne jednostki SKU agenta, które obsługują partię.
...
### -Filter
Określa klauzulę filtru OData dla jednostek SKU agenta węzła.
Jeśli nie określisz filtru, to polecenie cmdlet zwróci wszystkie jednostki SKU agenta, które obsługują partię.
...
### -MaxCount
Określa maksymalną liczbę jednostek SKU agenta węzła, które mają zostać zwrócone.
...
### Microsoft.Azure.Commands.Batch. Modele. PSNodeAgentSku
