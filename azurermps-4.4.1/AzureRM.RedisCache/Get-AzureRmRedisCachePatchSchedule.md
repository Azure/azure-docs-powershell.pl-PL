...
## Opis
Polecenie cmdlet **Get-AzureRmRedisCachePatchSchedule** pobiera harmonogram poprawek pamięci podręcznej w pamięci podręcznej platformy Azure Redis.

## Przykłady

### Przykład 1: pobieranie harmonogramu poprawek
```
