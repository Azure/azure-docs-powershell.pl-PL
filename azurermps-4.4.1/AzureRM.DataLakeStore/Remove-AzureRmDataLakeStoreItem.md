...
### -Clean
Wskazuje, że ta operacja powoduje usunięcie całej zawartości folderu docelowego i zachowanie folderu.
Ten parametr jest używany z parametrem *rekursywowanie* .
