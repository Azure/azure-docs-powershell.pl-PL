...
## Opis
Polecenie cmdlet **New-AzureRmOperationalInsightsCustomLogDataSource** definiuje niestandardowe zasady zbierania dziennika.
...
### -CustomLogRawJson
Określa niestandardową zasadę zbierania danych w postaci nieprzetworzonego ciągu JSON (kod JSON).
