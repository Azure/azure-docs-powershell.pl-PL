...
## Opis
Polecenie cmdlet **Set-AzureRmOperationalInsightsStorageInsight** umożliwia zmianę konfiguracji gromadzenia danych.

## Przykłady

### Przykład 1: modyfikowanie miejsca do magazynowania po nazwie
```
...
To polecenie modyfikuje tabele, z których dane składowe o nazwie MyStorageInsight odczytuje.

### Przykład 2: modyfikowanie informacji o przestrzeni dyskowej przy użyciu obiektu obszaru roboczego
```
...
Drugie polecenie modyfikuje kontenery, na podstawie których miejsce do magazynowania o nazwie MyStorageInsight odczytuje.

## PARAMETRÓW

### -Kontenery
Określa listę kontenerów, które dostarczają dane.
...
### -Name (nazwa)
Określa nazwę gromadzenia danych.
...
### -Tabele
Określa listę tabel zawierających dane.
