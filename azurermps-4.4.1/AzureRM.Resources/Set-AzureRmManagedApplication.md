...
### Zestaw parametrów nazwa aplikacji zarządzanej. Domyślne
```
...
### Zestaw parametrów zarządzany identyfikator aplikacji.
```
...
## Opis
Polecenie cmdlet **Set-AzureRmManagedApplication** aktualizuje zarządzane aplikacje
...
To polecenie aktualizuje opis aplikacji zarządzanej
...
### -Kind
Rodzaj zarządzanej aplikacji.
Jedna z rynków lub usługi katalogowej
...
### -Parameter
Ciąg sformatowany w notacji JSON parametrów dla aplikacji zarządzanej.
Może to być ścieżka do nazwy pliku lub identyfikatora URI zawierającego parametry lub parametry jako ciąg.
...
### -Plan
Tabela skrótów reprezentująca właściwości zarządzanego planu aplikacji.
...
### -ID
W pełni kwalifikowany identyfikator zarządzanej aplikacji, w tym abonament. na przykład/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}
