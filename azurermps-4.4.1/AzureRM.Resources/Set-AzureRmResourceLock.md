...
### Blokada w określonym zakresie. Domyślne
```
...
### Blokada zakresu zasobów grupy zasobów.
```
Set-AzureRmResourceLock -LockName <String> -LockLevel <LockLevel> [-LockNotes <String>] [-Force]
...
### Blokada w zakresie zasobów subskrypcji.
```
Set-AzureRmResourceLock -LockName <String> -LockLevel <LockLevel> [-LockNotes <String>] [-Force]
...
### Blokada w zakresie zasobów dzierżawy.
```
Set-AzureRmResourceLock -LockName <String> -LockLevel <LockLevel> [-LockNotes <String>] [-Force]
...
### Blokada za pomocą identyfikatora.
```
...
## Opis
Polecenie cmdlet **Set-AzureRmResourceLock** modyfikuje blokadę zasobu.
...
`/subscriptions/`Identyfikator subskrypcji nazwa `/resourceGroups/` grupy zasobów nazwa `/providers/Microsoft.Sql/servers/` serwera nazwa `/databases/` bazy danych

Aby określić grupę zasobów, użyj następującego formatu: 
