...
### Przykład 2: uzyskiwanie obiektu BLOB za pomocą potoku
```
PS C:\>Get-AzureStorageContainer -Name container* | Get-AzureStorageBlob
```

To polecenie używa potoku w celu uzyskania obiektu BLOB.

### Przykład 3: uzyskiwanie obiektu BLOB według prefiksu nazwy
```
PS C:\>Get-AzureStorageBlob -Container "ContainerName" -Prefix "blob"
```

To polecenie używa prefiksu nazwy w celu uzyskania obiektu BLOB.
