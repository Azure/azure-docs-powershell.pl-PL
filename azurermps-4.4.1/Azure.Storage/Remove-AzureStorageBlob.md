...
## Opis
Polecenie cmdlet **Remove-AzureStorageBlob** umożliwia usunięcie określonego obiektu BLOB z konta magazynu na platformie Azure.
...
Możesz użyć polecenia cmdlet Get-AzureStorageContainer, aby go pobrać.
