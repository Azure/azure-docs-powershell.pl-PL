...
## Opis
Polecenie cmdlet **New-AzureStorageContainerStoredAccessPolicy** tworzy zapisane zasady dostępu dla kontenera magazynu platformy Azure.

## Przykłady

### Przykład 1. Tworzenie zapisanych zasad dostępu w kontenerze magazynu
```
PS C:\>New-AzureStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy01"
```

To polecenie tworzy zasady dostępu o nazwie Policy01 w kontenerze magazynu o nazwie.
...
### -Uprawnienie
Określa uprawnienia w przechowywanych zasadach dostępu w celu uzyskiwania dostępu do kontenera.
