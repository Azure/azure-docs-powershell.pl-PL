...
### --------------------------Przykład 1: Uzyskaj historię użycia dla określonego planu zobowiązań--------------------------
@ {Paragraph = PS C: \\ \> }
...
### Microsoft. Azure. Management. MachineLearning. CommitmentPlans. MODELES. PlanUsageHistory []
