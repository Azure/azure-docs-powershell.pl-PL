...
## Opis
Polecenie cmdlet **Get-AzureRmIntegrationAccount** pobiera konta integracji z grupy zasobów. Określ nazwę konta integracji i nazwę grupy zasobów.
...
### Przykład 1: Uzyskaj konto integracyjne według nazwy
```
...
To polecenie otrzymuje konto integracyjne o nazwie IntegrationAccount31 z określonej grupy zasobów.

### Przykład 2: uzyskiwanie kont integracyjnych w grupie zasobów
```
...
To polecenie pobiera wszystkie konta integracji w ramach Twojej subskrypcji platformy Azure.
