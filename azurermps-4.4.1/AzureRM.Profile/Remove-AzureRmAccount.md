...
## STRESZCZENIe
Usuwanie wszystkich poświadczeń i kontekstów skojarzonych z danym kontem.
...
## Opis
Usuń wszystkie poświadczenia i konteksty (informacje o subskrypcji i dzierżawie) skojarzone z danym kontem.  Po wykonaniu tego polecenia musisz zalogować się ponownie przy użyciu Add-AzureRmAccount

## Przykłady

### Logowanie się do konta curent
```
PS C:\> Remove-AzureRmAccount
```

Wylogowuje konto skojarzone z bieżącym kontekstem.

### Wylogowywanie konta skojarzonego z określonym kontekstem
```
