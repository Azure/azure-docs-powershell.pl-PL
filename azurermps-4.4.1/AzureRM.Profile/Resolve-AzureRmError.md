...
Uzyskiwanie szczegółowych informacji o ostatnim błędzie.
...
Uzyskiwanie szczegółowych informacji o wszystkich błędach, które wystąpiły w bieżącej sesji.
...
Uzyskiwanie szczegółowych informacji o określonym błędzie.
...
### -Błąd
Jeden lub więcej rekordów błędów do rozpoznajenia.  Jeśli nie określono żadnych parametrów, zostaną rozwiązane wszystkie błędy w sesji.
...
### -Last
Usuń tylko ostatni błąd, który wystąpił w sesji.
...
Informacje o błędzie programu PowerShell, który nie obejmuje excpetion.

### Microsoft. Azure. Commands. profile. Errors. AzureExceptionRecord
Informacje o błędzie, w tym szczegółowe informacje o wyjątku, który spowodował błąd.

### Microsoft. Azure. Commands. profile. Errors. AzureRestExceptionRecord
Informacje o błędach w komunikacji z cleint/serwerem.  To często zawiera ważne informacje o błędzie z serwera.
