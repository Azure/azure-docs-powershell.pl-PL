...
Jeśli masz aplikację sieci Web w grupie zasobów A i chcesz powiązać tę aplikację sieci Web z certyfikatem w grupie zasobów B, jedynym sposobem na przekazanie kopii certyfikatu do grupy zasobów A.

Jeśli przekazujesz nowy certyfikat, pamiętaj o następujących wymaganiach dotyczących certyfikatu SSL usługi Azure: 
...
### Przykład 2: przekazywanie certyfikatu i wiązanie go z aplikacją sieci Web
```
...
Przykład 2 powoduje także powiązanie certyfikatu E3A38EBA60CAA1C162785A2E1C44A15AD450199C3 z aplikacją sieci Web o nazwie ContosoWebApp.
Jednak w tym przypadku certyfikat nie został jeszcze przekazany na platformie Azure.
Z tego powodu parametr *CertificateFilePath* jest wykorzystywany do określenia lokalnej kopii certyfikatu. Plik PFX.
Ten certyfikat zostanie przekazany na platformę Azure, a następnie zostaną utworzone nowe powiązania SSL.
