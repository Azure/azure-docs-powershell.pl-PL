...
### Domyślne parametry dotyczące wyłączania alertu dziennika aktywności
```
Disable-AzureRmActivityLogAlert -Name <String> -ResourceGroupName <String>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Parametry wyłączania alertów dziennika aktywności z przeprowadzoną wartością z potoku
```
Disable-AzureRmActivityLogAlert -InputObject <PSActivityLogAlertResource>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Parametry wyłączania alertów dziennika aktywności przyjmujących wartość ResourceId z potoku
```
