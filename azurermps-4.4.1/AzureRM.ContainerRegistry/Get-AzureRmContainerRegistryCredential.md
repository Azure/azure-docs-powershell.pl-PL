...
## Opis
Polecenie cmdlet **Get-AzureRmContainerRegistryCredential** Pobiera poświadczenia logowania do rejestru kontenera.

## Przykłady

### Przykład 1: uzyskiwanie poświadczeń logowania do rejestru kontenera
```
...
To polecenie pobiera poświadczenia logowania dla określonego rejestru kontenera. Użytkownik administracyjny musi być włączony dla rejestru kontenera, `MyRegistry` Aby uzyskać poświadczenia logowania.
...
### PSContainerRegistry
Parametr "Registry" przyjmuje wartość typu "PSContainerRegistry" z rurociągu
