...
Możesz określić ten parametr, aby znaleźć wszystkie zadania w toku lub wszystkie zadania zakończone niepowodzeniem.
...
### AzureRmBackupJob[]
To polecenie cmdlet zwraca co najmniej jedno zadanie kopii zapasowej.
