...
### Przykład 1. Usunięcie pola AzDigitalTwinsInstance według nazwy
```powershell
...
To polecenie usuwa element AzDigitalTwinsInstance według nazwy

### Przykład 2. Usuwanie pola AzDigitalTwinsInstance przez inputObject
```powershell
