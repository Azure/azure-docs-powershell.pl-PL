...
### Przykład 1. Aktualizacja Nierozwiązywalna (domyślna)
```powershell
...
Aktualizowanie określonego rekordu DigitalTwinsInstance przez nazwę ResourceGroupName

### Przykład 2. Aktualizowanie ciągu AzDigitalTwinsInstance przez inną aktualizację AzDigitalTwinsInstance
```powershell
...
Aby skonstruować, zobacz sekcję NOTES dla właściwości DIGITALTWINSPATCHDESCRIPTION i utwórz tabelę skrótów.
...
### Microsoft.Azure.PowerShell.cmdlet.DigitalTwins.Models.Api20201031.IDigitalTwinsPatchDescription

### Microsoft.Azure.PowerShell.Cmdlet.DigitalTwins.Models.IDigitalTwinsIdentity

## DANE WYJŚCIOWE

### Microsoft.Azure.PowerShell.Cmdlet.DigitalTwins.Models.Api20201031.IDigitalTwinsDescription
...
DIGITALTWINSPATCHDESCRIPTION: <IDigitalTwinsPatchDescription> Opis usługi DigitalTwins.
  - `[Tag <IDigitalTwinsPatchDescriptionTags>]`: Tagi wystąpienia
