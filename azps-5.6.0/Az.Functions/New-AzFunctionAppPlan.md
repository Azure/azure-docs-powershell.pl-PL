...
### Przykład 1. Tworzenie planu aplikacji premium dla systemu Windows w Europie Zachodniej z możliwością tworzenia nawet 10 wystąpień.
```powershell
...
To polecenie tworzy plan aplikacji premium systemu Windows w Europie Zachodniej z możliwością tylko 10 wystąpień.
