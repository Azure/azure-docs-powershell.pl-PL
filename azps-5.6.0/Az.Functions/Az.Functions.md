...
# Moduł Az.Functions
## Opis
Program Microsoft Azure PowerShell — polecenia cmdlet usługi Azure Functions dla usługi Azure Resource Manager w programach Windows PowerShell i PowerShell Core.\n\nFor informacji o funkcjach platformy Azure odwiedź następujące strony: https://docs.microsoft.com/azure/azure-functions/

## Polecenia cmdlet funkcji Az.Functions
...
Pobiera aplikacje funkcyjne w ramach subskrypcji.

### [Get-AzFunctionAppAvailableLocation](Get-AzFunctionAppAvailableLocation.md)
Pobiera lokalizację, w której jest dostępna aplikacja funkcji dla danego systemu operacyjnego i typu planu.

### [Get-AzFunctionAppPlan](Get-AzFunctionAppPlan.md)
Pobierz plany aplikacji funkowych w ramach subskrypcji.
...
Pobiera wartość parametru systemAssignedIdentity w określonym zakresie funkcji TOAssignedIdentity.

### [GetAzWebAppConfig](GetAzWebAppConfig.md)


### [Get-AzWebAppFunctionKey](Get-AzWebAppFunctionKey.md)
Opis funkcji Uzyskaj klawisze funkcyjne dla funkcji w witrynie sieci Web lub w miejscu wdrożenia.
...
Opis aplikacji Pobiera informacje o ustawieniach i stanie aplikacji w związku z konfiguracją

### [Get-AzWebAppSyncStatus](Get-AzWebAppSyncStatus.md)
Opis tej funkcji umożliwia dzwonienie za pomocą programu PowerShell ARM szablonu.
...
Tworzy plan usługi aplikacji funkcyjnej.
...
### [NormalizowanieSku](NormalizeSku.md)
...
Opis funkcji synchronizacji wyzwalania metadanych w bazie danych zarządzania

### [Test-Az](Test-Az.md)
Opis sprawdzania, czy można utworzyć zasób.
