...
## OPIS
Polecenie **cmdlet New-AzStackEdgeUser** tworzy nowego użytkownika dla urządzenia Stack Edge. Obsługiwane jest tworzenie tylko użytkowników `Share` tego typu.
