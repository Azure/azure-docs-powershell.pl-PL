...
## OPIS
Polecenie **cmdlet New-AzStackEdgeStorageAccountCredential** tworzy nowe poświadczenia konta magazynu edge dla urządzenia Stack Edge.
...
### -StorageAccountType
Możliwy typ dostępu do magazynu GeneralPurposeStorage, BlockStorage
