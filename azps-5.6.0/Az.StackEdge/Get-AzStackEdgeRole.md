...
## OPIS
Polecenie **cmdlet Get-AzStackEdgeRole** pobiera dostępne role IoT dla urządzenia Stack Edge. Możesz wspomnieć o parametrze Name, aby uzyskać szczegółowe informacje dotyczące konkretnej roli IoT.
