...
## OPIS
Polecenie **cmdlet New-AzStackEdgeOrder** tworzy nową kolejność dla urządzenia Stack Edge. Przed utworzeniem zamówienia należy najpierw utworzyć zasób urządzenia Stack Edge. Możesz określić szczegóły, takie jak osoba kontaktowa, nazwa firmy, adres e-mail, adres itp. jako parametry tworzenia zamówienia.
