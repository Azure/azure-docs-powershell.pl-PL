...
## OPIS
Polecenie **cmdlet Get-AzStackEdgeUser** wyświetla listę użytkowników skonfigurowanych dla urządzenia Stack Edge. Możesz wspomnieć nazwę w parametrach, aby uzyskać szczegółowe informacje o określonym użytkowniku.
