...
### InvokeBlockForUpdateParameterSet (Domyślne)
```
...
### Invoke JednakchUpdatesByDeviceObjectParameterSet
```
...
## OPIS
Polecenie cmdlet **Invoke-AzStackEdgeDevice** wywoła akcje skanowania, pobierania i instalowania aktualizacji na urządzeniu Ze stosem Edge. Automatyczne skanowanie jest uruchamiane na urządzeniu codziennie. Możesz jawnie wyzwolić skanowanie, uruchamiając to polecenie cmdlet.
...
### -FetchUpdate
Pobieranie aktualizacji na urządzeniu z krawędzią/bramą stosową
...
### -InstallUpdate
Instaluje aktualizacje na urządzeniu z krawędzią/bramą stosową
...
### -ScanForUpdate
Skanuje w poszukiwaniu aktualizacji na urządzeniu z bramą/krawędzią stosu.
