...
### UnlimitedBandwidthParameterSet (domyślne)
```
...
## OPIS
Polecenie **cmdlet New-AzStackEdgeBandwidthSchedule** tworzy nowy harmonogram przepustowości dla urządzenia Stack Edge, aby ułatwić zarządzanie użyciem przepustowości.
...
### -UnlimitedBandwidth
Ustawi przepustowość jako nieograniczoną
