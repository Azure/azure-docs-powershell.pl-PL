...
## OPIS
Polecenie **cmdlet Remove-AzStackEdgeUser** usuwa użytkownika z urządzenia Stack Edge. Obsługiwane jest tworzenie tylko użytkowników `Share` tego typu.
...
### Microsoft.Azure.PowerShell.Cmdlet.StackEdge.Models.PSStackEdgeUser
