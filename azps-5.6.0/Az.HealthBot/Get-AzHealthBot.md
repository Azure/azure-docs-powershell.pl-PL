...
Uzyskaj wszystkie korzyści HealthBot

### Przykład 2. Uzyskiwanie wszystkich danych HealthBot według nazwa_grupy zasobów
```powershell
...
Uzyskiwanie usługi HealthBot według pola ResourceGroupName i Name
