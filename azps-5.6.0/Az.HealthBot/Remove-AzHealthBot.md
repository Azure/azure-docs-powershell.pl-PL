...
### Przykład 1. Usuwanie robota HealthBot według nazwy i nazwy grupy zasobów
```powershell
...
### Przykład 2. Usuwanie robota HealthBot przez inputObject
```powershell
