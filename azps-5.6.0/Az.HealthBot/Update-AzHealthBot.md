...
## SYNOPSIS
Popraw poprawki robota HealthBot.
...
### Przykład 1. Aktualizowanie pliku HealthBot według nazwy grupy zasobów i nazwy
```powershell
...
aktualizowanie pola HealthBot według nazw i nazw grup zasobów

### Przykład 2. Aktualizowanie robota HealthBot przez InputObject
```powershell
...
aktualizowanie robota HealthBot przez InputObject
