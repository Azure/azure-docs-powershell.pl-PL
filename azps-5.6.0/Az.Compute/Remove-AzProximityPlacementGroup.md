...
## OPIS
To polecenie cmdlet spowoduje usunięcie zasobu grupy położenie odległości.
...
To polecenie usuwa grupę położenia danej odległości.

### Przykład 2

To polecenie usuwa grupę położenia danej odległości. (wygenerowane automatycznie)
...
### -InputObject
Obiekt grupy Położenie odległości PS
