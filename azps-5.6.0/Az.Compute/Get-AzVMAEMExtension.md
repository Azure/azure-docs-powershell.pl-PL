...
## OPIS
Polecenie **cmdlet Get-AzVMAEMExtension** pobiera informacje o rozszerzeniu Azure Enhanced Monitoring (AEM).
...
To polecenie pobiera informacje dotyczące rozszerzenia AEM dla maszyny wirtualnej o nazwie contoso-server.
...
To polecenie cmdlet pobiera informacje dotyczące rozszerzenia AEM na maszyny wirtualnej, które określa to polecenie cmdlet.
...
To polecenie cmdlet pobiera informacje dotyczące rozszerzenia AEM na tej maszyny wirtualnej.
...
Określa nazwę maszyny wirtualnej.
To polecenie cmdlet pobiera informacje o rozszerzeniu AEM dla maszyny wirtualnej, które określa ten parametr.
