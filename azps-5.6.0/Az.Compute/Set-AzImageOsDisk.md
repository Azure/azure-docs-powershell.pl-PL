...
## OPIS
Polecenie **cmdlet Set-AzImageOsCm ustawia** właściwości dysku systemu operacyjnego w obiekcie obrazu.
...
### -BlobUri
Określa wartość Uri obiektu blob.
...
### -StorageAccountType
Typ konta magazynu dysku obrazu systemu operacyjnego
