...
### Przykład 1. Ustawianie właściwości profilu diagnostycznego rozruchu dla usługi MASZYNY WIRTUALNE
```
...
To polecenie ustawia właściwość profilu diagnostycznego rozruchu dla usług maszyny wirtualnej o nazwie ContosoVMSS.
