...
Wywołaj polecenie uruchom skrypt RunPowerShellScript z zastąpieniem skryptu "sample.ps1" i parametrów maszyny wirtualnej IDENTYFIKATOR "0" w zestawie skali "maszyny wirtualnej" w grupie zasobów "rgname".
