...
## OPIS
Polecenie **cmdlet Remove-AzVMCustomScriptExtension** usuwa z maszyny wirtualnej rozszerzenie skryptu niestandardowego.

## PRZYKŁADY

### Przykład 1

Usuwa rozszerzenie skryptu niestandardowego z maszyny wirtualnej. (wygenerowane automatycznie)
...
### — Nazwa
Określa nazwę niestandardowego rozszerzenia skryptu, które usuwa to polecenie cmdlet.
...
Określa nazwę maszyny wirtualnej, z której to polecenie cmdlet usuwa rozszerzenie skryptu niestandardowego.
