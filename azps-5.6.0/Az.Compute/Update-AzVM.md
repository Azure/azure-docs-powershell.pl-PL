...
Odwołania do tożsamości użytkownika ARM identyfikatorami zasobów w postaci: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/identities/{identityName}"
...
### -UltraSSDEnabled
Flaga umożliwiająca włączenie lub wyłączenie możliwości, aby jedna lub więcej zarządzanych dysków danych UltraSSD_LRS typ konta magazynu na maszyny wirtualnej.
...
### — MASZYNY WIRTUALNEJ
Określa obiekt lokalnej maszyny wirtualnej.
