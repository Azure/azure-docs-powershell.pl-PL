...
## OPIS
Polecenie **cmdlet Update-AzImage** aktualizuje obraz.
Obecnie można aktualizować tylko znaczniki.
...
To polecenie aktualizuje wartość tagu istniejącego obrazu "Image01" w grupie zasobów "ResourceGroup01".
...
### -ResourceId
Identyfikator zasobu dla obrazu
