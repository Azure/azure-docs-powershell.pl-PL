...
Linux: Parametr **VolumeType** jest wymagany podczas szyfrowania maszyn wirtualnych systemu Linux i musi mieć ustawioną wartość ("System operacyjny", "Dane" lub "Wszystkie") obsługiwaną przez dystrybucję Systemu Linux. 

Windows: Parametr **VolumeType** może zostać pominięty — w takim przypadku operacja ma wartość domyślną All (Wszystko); Jeśli parametr VolumeType jest dostępny dla maszyny wirtualnej systemu Windows, musi mieć ustawioną wartość All (Wszystkie) lub OS (Wszystkie).
...
### Przykład 4. Włączanie szyfrowania przy użyciu identyfikatora klienta usługi Azure AD i identyfikatora certyfikacji klienta thumbprint
```
$RGName = "MyResourceGroup"
$VMName = "MyTestVM"
...
### Przykład 6. Włączanie szyfrowania przy użyciu identyfikatora klienta usługi Azure AD, klucza szyfrowania cert klienta i klucza szyfrowania zawijania dysku
```
$RGName = "MyResourceGroup"
$VMName = "MyTestVM"
#The KeyVault must have enabledForDiskEncryption property set on it
...
Wstępnie wymagane jest, aby certyfikat klienta usługi Azure AD był wcześniej wdrożony w magazynie certyfikatów komputera lokalnego na komputerze `my` wirtualnym.
...
Określa algorytm używany do zawijania i cofania szyfrowania klucza maszyny wirtualnej.
...
Ten adres URL musi być w pełnej wersji.
...
### — Nazwa
Określa nazwę zasobu usługi Azure Resource Manager reprezentującą to rozszerzenie. Jeśli parametr *Name* zostanie pominięty, zainstalowane rozszerzenie będzie nosiło nazwę AzureCryption na komputerach wirtualnych systemu Windows i Azure PrzyszłaNacryptionForLinux w komputerach wirtualnych systemu Linux.
