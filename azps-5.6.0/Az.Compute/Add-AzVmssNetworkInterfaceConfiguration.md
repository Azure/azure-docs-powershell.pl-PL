...
## OPIS
Polecenie **cmdlet Add-AzVmssNetworkInterfaceConfiguration** dodaje konfigurację interfejsu sieciowego do zestawu skal maszyny wirtualnej (VIRTUAL Machine Scale Set).

## PRZYKŁADY

### Przykład 1. Dodawanie konfiguracji interfejsu sieciowego do usług MASZYNY WIRTUALNEJ
```
PS C:\> Add-AzVmssNetworkInterfaceConfiguration -VirtualMachineScaleSet $VMSS -Name "Test" -Primary $True -IPConfiguration $IPCfg
```

To polecenie dodaje konfigurację interfejsu sieciowego do usług MASZYNY WIRTUALNE.
...
Lista adresów IP serwera DNS dla ustawień dns.
...
Określa, czy interfejs sieciowy ma być przyspieszony z włączoną obsługą sieci.
...
### -EnableIPForwarding
Określa, czy dla tej nic nic nie jest włączone przesyłanie dalej adresów IP.
...
### — podstawowy
Wskazuje, czy interfejsy sieciowe utworzone na podstawie konfiguracji interfejsu sieciowego będą podstawowym centrum informacyjnym sieciowym (NIC) maszyny wirtualnej.
