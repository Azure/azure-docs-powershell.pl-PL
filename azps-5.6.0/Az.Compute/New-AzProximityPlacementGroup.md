...
## OPIS
To polecenie cmdlet utworzy zasób grupy położenie odległości.
...
To polecenie tworzy grupę lokalizacji zbliżeniowej w danej lokalizacji.

### Przykład 2

Tworzenie zasobu grupy położenie odległości. (wygenerowane automatycznie)
...
Określa typ grupy położenia odległości.  Dopuszczalne wartości: Standardowy lub Ultra
