...
## SYNOPSIS
Pobiera listę zasobów skojarzonych z określonym zestawem szyfrowania dysku.
...
## OPIS
Polecenie **cmdlet Get-AzCmEncryptionSetAssociatedResource** pobiera listę zasobów skojarzonych z określonym zestawem szyfrowania dysku.
...
Polecenie cmdlet pobiera dwa zasoby, "example Jednak01" i "example Jednak02", skojarzone z dostarczonym zestawem szyfrowania dysku
