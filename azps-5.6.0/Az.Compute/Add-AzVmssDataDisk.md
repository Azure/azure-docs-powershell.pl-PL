...
## OPIS
Polecenie **cmdlet Add-AzVmssDataDataDlet** dodaje dysk danych do wystąpienia zestawu skal maszyny wirtualnej (VMSS).

## PRZYKŁADY

### Przykład 1. Dodawanie dysku danych
```
...
To polecenie powoduje dodanie pustego dysku danych do obiektu maszyny wirtualnej.

## PARAMETERS

### — buforowanie
Określa typ pamięci buforowania dysku.
...
### -DiskIOPSReadWrite
Określa Read-Write IOPS dla dysku zarządzanego. Powinien być używany tylko wtedy, gdy typ StorageAccountType UltraSSD_LRS. Jeśli nie zostanie określona, zostanie przypisana wartość domyślna na podstawie rozmiaru dysku DiskSizeGB.
...
### -DiskMBpsReadWrite
Określa przepustowość w MB na sekundę dla dysku zarządzanego. Powinien być używany tylko wtedy, gdy typ StorageAccountType UltraSSD_LRS. Jeśli nie zostanie określona, zostanie przypisana wartość domyślna na podstawie rozmiaru dysku DiskSizeGB.
...
### -StorageAccountType
Określa typ konta magazynu dysku.
