...
## OPIS
Polecenie **cmdlet Get-AzCm** pobiera właściwości dysku zarządzanego.
...
To polecenie pobiera właściwości dysku o nazwie "Dysk01" w grupie zasobów "Grupa zasobów01".
...
To polecenie pobiera właściwości wszystkich dysków w ramach subskrypcji.
...
To polecenie pobiera właściwości wszystkich dysków pod nazwą subskrypcji, zaczynając od win1_OsDisk.
