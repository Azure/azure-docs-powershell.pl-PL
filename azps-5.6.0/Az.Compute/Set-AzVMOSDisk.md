...
Pierwsze polecenie pobiera zestaw dostępności o nazwie AvailabilitySet13 w grupie zasobów o nazwie ResourceGroup11, a następnie przechowuje ten obiekt w zmiennej $AvailabilitySet zasobów.
...
### — CreateOption
Określa, czy to polecenie cmdlet tworzy dysk na maszynie wirtualnej z platformy lub obrazu użytkownika, czy dołącza istniejący dysk.
Prawidłowe wartości to: 
- Dołączanie.
...
### -SourceImageUri
Określa identyfikator URI pliku VHD dla scenariuszy obrazów użytkowników.
...
### — MASZYNY WIRTUALNEJ
Określa lokalny obiekt maszyny wirtualnej, na którym mają być ustawiane właściwości dysku systemu operacyjnego.
