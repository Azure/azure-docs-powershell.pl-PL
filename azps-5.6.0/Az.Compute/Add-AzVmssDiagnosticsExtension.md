...
## OPIS
Polecenie **cmdlet Add-AzVmssDiagnosticsExtension** dodaje rozszerzenie diagnostyczne do wystąpienia zestawu skal maszyny wirtualnej (VMSS).

## PRZYKŁADY

### Przykład 1. Dodawanie rozszerzenia diagnostycznego do usługi MASZYNY.WIRTUALNE
```
PS C:\> Add-AzVmssDiagnosticsExtension -VirtualMachineScaleSet $VMSS -SettingFilePath $publicConfigPath -ProtectedSettingFilePath $privateConfigPath -Name $extName -TypeHandlerVersion $typeVersion -AutoUpgradeMinorVersion $True -Force
```

To polecenie dodaje rozszerzenie diagnostyki do usługi maszyny wirtualnej.
...
### -SettingFilePath
Określa ścieżkę publicznego pliku konfiguracji.
...
Aby uzyskać wersję, uruchom polecenie cmdlet [Get-AzVMExtensionImage](./Get-AzVMExtensionImage.md) z wartością parametru Microsoft.Azure.Diagnostics dla parametru *PublisherName* i IaaSDiagnostics dla *parametru Type.*
