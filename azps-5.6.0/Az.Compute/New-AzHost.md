...
### -LicenseType
Określa typ licencji oprogramowania, który będzie stosowany do maszyn wirtualnych wdrożonych na hoście. Dopuszczalne wartości to: Brak, Windows_Server_Hybrid i Windows_Server_Perpetual.  Wartość domyślna to Brak.
