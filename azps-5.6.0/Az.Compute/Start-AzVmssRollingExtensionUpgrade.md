...
## SYNOPSIS
To polecenie cmdlet rozpoczyna uaktualnianie w celu uaktualnienia do najnowszej dostępnej wersji dla wszystkich rozszerzeń dla danego zestawu skal maszyn wirtualnych. 
...
## OPIS
Rozpoczyna uaktualnianie, aby przenieść wszystkie rozszerzenia na tej skali maszyny wirtualnej do najnowszej dostępnej wersji.
Nie ma to wpływu na rozszerzenia, które już działają w najnowszej dostępnej wersji.
...
W tym przykładzie istniejący zestaw skali maszyny wirtualnej "MyVmssName" jest zwiększany i dodaje do niego rozszerzenie. Ostatnie polecenie uruchamia proces uaktualniania w trakcie uaktualniania rozszerzenia. 
...
### -ResourceId
Identyfikator zasobu obiektu zestawu skali MASZYNY WIRTUALNEj. 
...
Obiekt zestawu skali MASZYNY WIRTUALNEj.
