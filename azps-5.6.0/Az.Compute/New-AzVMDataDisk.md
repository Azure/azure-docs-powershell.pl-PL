...
## OPIS
Polecenie **cmdlet New-AzVMDataDataCm** tworzy obiekt dysku danych lokalnych dla maszyny wirtualnej lub maszyny wirtualnej maszyny wirtualnej.
...
### -SourceImageUri
Uri obrazu źródłowego dysku maszyn wirtualnych systemu operacyjnego.
...
### - VhdUri
Uri vhd dysku danych maszyny wirtualnej.
