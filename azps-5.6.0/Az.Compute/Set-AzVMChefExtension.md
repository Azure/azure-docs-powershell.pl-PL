...
To polecenie dodaje rozszerzenie Do maszyny wirtualnej systemu Windows o nazwie WindowsVM001.
Gdy zaczyna się maszyny wirtualnej, Bootstraps maszyny wirtualnej, aby uruchomić Oprogramowanie.
...
### -Daemon
Konfiguruje usługę po stronie klienta w celu wykonywania bez nadzoru. Platforma węzła powinna być systemem Windows.
...
zadanie — konfiguruje klienta uruchamiany automatycznie w tle jako zaplanowane zadanie.
...
### - Tajna
Klucz szyfrowania używany do szyfrowania i odszyfrowywania wartości elementów tob.
...
To polecenie cmdlet dodaje rozszerzenie Do tej maszyny wirtualnej, które określa ten parametr.
