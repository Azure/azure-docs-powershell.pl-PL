...
### -JoinOption
Określa opcję sprzężenia. Aby uzyskać informacje na temat opcji [sprzężenia, zobacz fJoinOptions](https://docs.microsoft.com/windows/desktop/api/lmjoin/nf-lmjoin-netjoindomain)
...
Wartość domyślna to domyślna nazwa użytkownika OU dla obiektów maszynowych w domenie.
