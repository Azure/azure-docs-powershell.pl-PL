...
* Szóste polecenie używa polecenia cmdlet **New-AzVirtualNetwork** w celu utworzenia sieci wirtualnej i przechowuje wynik w zmiennej o nazwie $VNet.
...
* 14. polecenie tworzy aprobefikę za pomocą polecenia **New-AzLoadBalancerProbeConfig,** a informacje o tym pliku są przechowywane w zmiennej o nazwie $Probe.
...
* To polecenie używa polecenia cmdlet **New-AzLoadBalancer** w celu utworzenia równoważenia obciążenia i przechowuje wynik w zmiennej o nazwie $ActualLb.
...
* Polecenie w programie **New-AzVmssIPConfig używa polecenia cmdlet New-AzVmssIPConfig** w celu utworzenia konfiguracji ip programu VMSS i przechowuje informacje w zmiennej o nazwie $IPCfg.
...
### -InstanceCount
Liczba obrazów maszyny wirtualnej w zestawie skal.  Jeśli nie podano żadnej wartości, zostaną utworzone 2 wystąpienia.
...
### -SecurityGroupName
Nazwa grupy zabezpieczeń sieci, która ma być stosowane do tego zestawu skali.  Jeśli nie podano żadnej wartości, do zestawu skali zostanie utworzona domyślna grupa zabezpieczeń sieci o takiej samej nazwie jak zestaw skali.
...
### -SubnetName
Nazwa podsieci, która ma być używania z tym zestawem skal.  Jeśli nie podano żadnej wartości, zostanie utworzona nowa podsieci o takiej samej nazwie jak zestaw skali.
...
Jeśli parametr jest obecny, to maszyny wirtualne w zestawie skali mają przypisaną automatycznie wygenerowaną tożsamość systemu zarządzanego.
...
### -UpgradePolicyMode
Tryb zasad uaktualniania dla wystąpień maszyny wirtualnej w tym zestawie skali.  Zasady uaktualniania mogą określać uaktualnienia automatyczne, ręczne lub uaktualnianie stopniowe.
...
### -VMScaleSetName
Określa nazwę programu VMSS, który tworzy to polecenie cmdlet.
