...
Włącz funkcję autozazysowania poświadczeń dla bieżącego użytkownika. Przy każdym otwarciu okna programu PowerShell bieżący kontekst jest pamiętany bez logowania się.
