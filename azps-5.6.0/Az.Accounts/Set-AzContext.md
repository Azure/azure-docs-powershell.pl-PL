...
## OPIS
Polecenie Set-AzContext ustawia informacje o uwierzytelnianiu dla polecenia cmdlet uruchomionego w bieżącej sesji.
Kontekst obejmuje informacje o dzierżawie, subskrypcji i środowisku.
...
To polecenie ustawia kontekst do korzystania z określonej subskrypcji.
...
### — Wymuszanie
Zastąp istniejący kontekst o tej samej nazwie (jeśli taki sam).
...
### — Subskrypcja
Nazwa lub identyfikator subskrypcji, dla których należy ustawić kontekst. Ten parametr ma aliasy to -SubscriptionName i -SubscriptionId, więc w celu zachowania przejrzystości można użyć każdego z nich zamiast nazwy i identyfikatora zamiast nazwy —Subscription.
