...
## OPIS
Polecenie **cmdlet Remove-AzNetworkProfile** usuwa profil sieciowy, jeśli nie utworzono interfejsów sieciowych kontenerów (w odróżnieniu od konfiguracji kontenera interfejsu sieciowego).
...
Spowoduje to usunięcie profilu sieciowego o nazwie np1 z grupy zasobów rg1.
