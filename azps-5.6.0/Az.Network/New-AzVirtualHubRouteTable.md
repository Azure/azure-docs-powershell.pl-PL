...
Powyższe spowoduje utworzenie tabeli trasy składającej się z wielu tras i dołączonej do nowego centrum wirtualnego.

Jest to obiekt w pamięci, za pomocą których można dodać tabelę Trasy do nowej lub istniejącej aplikacji VirtualHub.
