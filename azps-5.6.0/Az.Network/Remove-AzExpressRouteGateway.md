...
W tym przykładzie jest grupę zasobów, wirtualna sieć WAN, centrum wirtualne, skalowalna brama usługi ExpressRoute w centrum STANÓW Zjednoczonych, a następnie natychmiast ją usuwa. Aby pominąć monit podczas usuwania bramy wirtualnej, użyj flagi -Force.
Spowoduje to usunięcie dołączonej do niej bramy ExpressRouteGateway i wszystkich połączonych z nim połączeń usługi ExpressRoute.
...
### -InputObject
Obiekt ExpressRouteGateway do usunięcia.
...
### — Nazwa
Nazwa aplikacji ExpressRouteGateway.
...
### -ResourceId
Identyfikator zasobu Azure dla usługi ExpressRouteGateway do usunięcia.
