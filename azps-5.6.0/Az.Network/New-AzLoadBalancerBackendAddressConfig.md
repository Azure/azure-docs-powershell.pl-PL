...
## SYNOPSIS
Zwraca adres zaplecza równoważenia obciążenia. 

## SKŁADNIA

### SetByResourcePublicIpAddress (Domyślna)
```
...
### Przykład 1. Nowy konfiguracja adresu równoważenia obciążenia z odwołaniem do sieci wirtualnej
```powershell
PS C:\> $virtualNetwork = Get-AzVirtualNetwork -Name $vnetName -ResourceGroupName $resourceGroup
New-AzLoadBalancerBackendAddressConfig -IpAddress "10.0.0.5" -Name "TestVNetRef" -VirtualNetworkId $virtualNetwork.Id
```

### Przykład 2. Nowy adres konfiguracji równoważenia obciążenia z odwołaniem do konfiguracji frontendu ip loadbalancer
```powershell
...
### -IpAddress
Adres IPAddress, który należy dodać do puli zaplecza
...
Konfiguracja frontendu ip równoważenia obciążenia skojarzona z konfiguracją adresu zaplecza
