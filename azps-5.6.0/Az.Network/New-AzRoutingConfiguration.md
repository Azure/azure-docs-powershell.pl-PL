...
### — Identyfikator
Lista identyfikatorów zasobów wszystkich tabel tras centrum w celu anonsowania tras do właściwości PropagatedRouteTables.
...
### - StaticRoute
Lista tras sterujących routingiem z aplikacji VirtualHub do wirtualnego połączenia sieciowego.
...
### Microsoft.Azure.Commands.Network.Models.PS ZSzybkiRoute
...
[New-AzFiltrRoute](./New-AzStaticRoute.md)
