...
Polecenie **cmdlet Get-AzP2sVpnGatewayDetailedConnectionHealth** umożliwia uzyskiwanie szczegółowych informacji o bieżących połączeniach witryny z aplikacji P2SVpnGateway. Klient może pobrać szczegółowe informacje o kondycji z przekazywanego adresu URL SAS. Spowoduje to pokazanie informacji o każdym punkcie połączenia z witryną z nazwami użytkownika, bajtami w bajtach, przydzielonym adresem IP itp.
