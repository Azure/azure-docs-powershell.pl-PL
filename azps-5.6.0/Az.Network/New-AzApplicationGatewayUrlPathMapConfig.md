...
## OPIS
Polecenie **cmdlet New-AzApplicationGatewayUrlPathMapConfig** tworzy tablicę mapowań ścieżek adresu URL na pulę serwerów zaplecza.

## PRZYKŁADY

### Przykład 1. Tworzenie tablicy mapowań ścieżek adresu URL na pulę serwerów zaplecza
```
PS C:\>New-AzApplicationGatewayUrlPathMapConfig -Name $UrlPathMapName -PathRules $VideoPathRule, $ImagePathRule -DefaultBackendAddressPool $Pool -DefaultBackendHttpSettings $PoolSetting02
```

To polecenie tworzy tablicę mapowań ścieżek adresu URL na pulę serwerów zaplecza.
...
### — Nazwa
Określa nazwę mapy ścieżki adresu URL, którą tworzy to polecenie cmdlet.
