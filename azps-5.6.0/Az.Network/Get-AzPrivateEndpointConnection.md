...
Ten przykład zwraca listę wszystkich prywatnych połączeń punktu końcowego należy do serwera sql o nazwie Mysql.
...
W tym przykładzie jest uzyskiwanie prywatnego połączenia punktu końcowego o nazwie MyPrivateEndpointConnection1 należy do prywatnej usługi linków o nazwie MyPrivateLinkService
...
Identyfikator menedżera zasobów platformy Azure prywatnego zasobu linku, do którego należy prywatne połączenie punktu końcowego.
