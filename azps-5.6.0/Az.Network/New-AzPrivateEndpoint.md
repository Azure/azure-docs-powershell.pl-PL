...
W poniższym przykładzie jest tworzyny prywatny punkt końcowy z określonym identyfikatorem usługi łączenia prywatnego w określonej podsieci w sieci wirtualnej.
...
Aby nawiązać połączenie, użyj ręcznego żądania.
...
Nie należy prosić o potwierdzenie zastąpienia zasobu.
...
Określa lokalizację dla prywatnego punktu końcowego. Użyj [funkcji Get-AzLocation](/powershell/module/az.resources/get-azlocation) do określenia prawidłowych wartości dla tego parametru.
...
Identyfikator zasobu do połączenia z prywatnym punktem końcowym.
...
Podsieci prywatnego punktu końcowego.
