...
## OPIS
Polecenie **cmdlet New-AzPrivateDnsZoneGroup** umożliwia utworzenie nowej prywatnej grupy stref DNS.
...
Po `test-pr-endpoint` utworzeniu prywatnego punktu końcowego w powyższym przykładzie jest tworzona grupa strefy DNS w ramach tego prywatnego punktu końcowego.
