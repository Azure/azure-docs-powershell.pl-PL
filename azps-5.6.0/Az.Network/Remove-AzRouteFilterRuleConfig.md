...
## OPIS
Polecenie **cmdlet Remove-AzRouteFilterRuleConfig** usuwa regułę filtrowania trasy z filtru trasy.
...
Pierwsze polecenie pobiera filtr trasy o nazwie RouteFilter01, który należy do grupy zasobów o nazwie ResourceGroup01 i przechowuje go w $rf danych.
Drugie polecenie usuwa regułę filtrowania tras o nazwie Rule01 z filtru trasy przechowywanego w $rf.
