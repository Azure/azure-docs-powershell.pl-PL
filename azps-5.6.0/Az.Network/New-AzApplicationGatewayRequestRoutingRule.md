...
Określa identyfikator puli adresów końcowych reguły routingu żądania, która ma być tworzyć.
...
### - HttpListener
Określa słuchacza http na końcu, który ma tworzyć regułę routingu żądania.
