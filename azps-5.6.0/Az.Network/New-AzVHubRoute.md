...
```
Powyższe polecenia uzyskają konfigurację RoutingConfiguration istniejącej już usługi AzVHubRoute, a następnie dodają trasę statyczną na połączeniu. Ewentualnie, jeśli masz nadzieję na utworzenie nowego połączenia za pomocą trasy statycznej w tym programie, zobacz przykład 1 [tutaj.](New-AzRoutingConfiguration.md)
## PARAMETERS
