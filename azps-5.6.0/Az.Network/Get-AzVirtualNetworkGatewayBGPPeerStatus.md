...
## OPIS
To polecenie wylicza, że równorzędne BGP są konfigurowane do komunikacji równorzędnej bramy wirtualnej platformy Azure. Podano również stan każdej równorzędnej komunikacji równorzędnej.
...
Pobiera współpracowników BGP dla bramy sieci wirtualnej platformy Azure o nazwie nazwana nazwa_bramy w grupie zasobów resourceGroup.
W tym przykładzie dane wyjściowe przedstawia jeden połączony element równorzędny BGP o adresie IP 10.0.0.254.
...
### — Peer
Adres IP elementu równorzędnego, dla których ma zostać pobrany stan
