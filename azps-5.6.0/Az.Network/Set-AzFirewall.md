...
$firewall | Set-AzFirewall
```
W tym przykładzie zapora z publicznym adresem IP zarządzania i podsiecią zarządzania jest przydzielana w scenariuszach z wymuszonym rozdzielaniem. Sieć VNet musi zawierać podsieci o nazwie "AzureFirewallManagementSubnet".
...
W tym przykładzie publiczny adres IP "azFwPublicIp1" jako odłączony od Zapory.
