...
To polecenie otrzymuje listę wszystkich bram aplikacji w subskrypcji, których nazwy zaczynają się od "ApplicationGateway01" i są przechowywane w zmiennej $AppGwList aplikacji.
