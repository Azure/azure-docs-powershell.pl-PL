...
Po utworzeniu brama jest połączona z usługą ExpressRouteSite za pomocą New-AzExpressRouteConnection usługi.

Następnie usuwa połączenie za pomocą nazwy połączenia.
...
Taki sam jak w przykładzie 1, ale teraz usuwa połączenie przy użyciu obiektu potokowego z get-AzExpressRouteConnection.
