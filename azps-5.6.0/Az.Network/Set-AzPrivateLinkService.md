...
## OPIS
Polecenie **cmdlet Set-AzPrivateLinkService** aktualizuje prywatną usługę linków.

## PRZYKŁADY

### 1. Tworzy prywatną usługę linków i aktualizuje
```
...
W tym przykładzie jest wana prywatna usługa linków o nazwie mojepls. Następnie zamienia swoje konfiguracje ipConfigurations z obiektu ipConfiguratiuon w pamięci. To Set-AzPrivateLinkService cmdlet służy do pisania zmodyfikowanego stanu usługi prywatnego linku po stronie usługi. 
...
### -PrivateLinkService
Określa obiekt usługi łączenia prywatnego reprezentujący stan, dla którego należy ustawić prywatną usługę łączenia.
