...
## OPIS
Polecenie **cmdlet Add-AzApplicationGatewayCustomError** powoduje dodanie błędu niestandardowego do słuchacza http bramy aplikacji.

## PRZYKŁADY

### Przykład 1. Dodaje błąd niestandardowy do poziomu słuchacza http
```powershell
...
To polecenie dodaje niestandardowy błąd o kodzie stanu http 502 do odbiorcy http $listener 01 i zwraca zaktualizowanego słuchacza.
