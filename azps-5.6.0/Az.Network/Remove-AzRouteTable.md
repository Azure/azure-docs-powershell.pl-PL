...
## OPIS
Polecenie **cmdlet Remove-AzRouteTable** usuwa tabelę trasy platformy Azure.

## PRZYKŁADY

### Przykład 1. Usuwanie tabeli trasy
```
...
To polecenie usuwa tabelę tras o nazwie RouteTable01 w grupie zasobów o nazwie ResourceGroup11.
Polecenie cmdlet wyświetli monit o potwierdzenie przed usunięciem tabeli.
...
### — Nazwa
Określa nazwę tabeli trasy, która zostanie usuwana przez to polecenie cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów zawierającej tabelę tras usuwaną przez to polecenie cmdlet.
