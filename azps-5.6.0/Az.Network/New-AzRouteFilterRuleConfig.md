...
## OPIS
Polecenie New-AzRouteFilterRuleConfig cmdlet tworzy regułę filtru trasy dla filtru trasy platformy Azure.
...
Polecenie tworzy nową regułę filtrowania trasy i zapisuje ją w zmiennym $rule 1.
...
### — Nazwa
Określa nazwę reguły filtrowania tras.
