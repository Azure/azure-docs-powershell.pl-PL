...
### ByVirtualWanNameByVpnSiteObject (domyślne)
```
...
Konfiguracja zostanie pobrana za pomocą tego polecenia commandlet.

Jeśli polecenie polecenia powiedzie się, konfiguracja pobierania zostanie napisana w obiekcie blob wskazanym przez obiekt SignedSasUrl.
...
### - StorageSasUrl
Adres URL SAS lokalizacji przechowywania, w której ma zostać wygenerowana konfiguracja.
...
### - VpnSite
Lista identyfikatorów zasobów vpnsite, dla których ma być generowana konfiguracja.
