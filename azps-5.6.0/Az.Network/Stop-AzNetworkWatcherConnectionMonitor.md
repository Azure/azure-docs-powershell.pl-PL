...
## OPIS
Polecenie Stop-AzNetworkWatcherConnectionMonitor zatrzymuje określony monitor połączenia.

## PRZYKŁADY

### Przykład 1. Zatrzymywanie monitora połączenia
```powershell
PS C:\> Stop-AzNetworkWatcherConnectionMonitor -NetworkWatcher $nw -Name cm
```

W tym przykładzie przerywamy monitorowanie połączenia określone przez nazwę i obserwowanie sieci

### Przykład 2

Zatrzymywanie monitora połączenia. (wygenerowane automatycznie)
