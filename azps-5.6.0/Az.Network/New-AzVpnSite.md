...
### ByVirtualWanNameByVpnSiteIpAddress (Domyślna)
```
...
Powyższe spowoduje utworzenie grupy zasobów — wirtualnej sieci WAN we wschodnich usa w grupie zasobów "nonlinkSite" na platformie Azure. 

Następnie tworzy witrynę VpnSite reprezentującą gałąź klienta i łączy ją z wirtualną siecią WAN.

Połączenie IPSec można następnie skonfigurować przy użyciu tej gałęzi i aplikacji VpnGateway za pomocą New-AzVpnConnection sieci.
...
Powyższe spowoduje utworzenie grupy zasobów, wirtualnej sieci WAN i witryny VpnSite z 1 siecią VpnSiteLinks we wschódch Stanów Zjednoczonych w grupie zasobów "multilink" na platformie Azure.

### Przykład 3

Tworzy nowy zasób usługi Azure VpnSite. (wygenerowane automatycznie)
...
### -BgpPeeringAddress
Adres komunikacji równorzędnej BGP dla tej lokacji vpn.
...
### -BgpPeeringWeight
Waga komunikacji równorzędnej BGP dla tej lokacji vpn.
...
### — DeviceModel
Model urządzenia zdalnego połączenia vpn.
...
### - DeviceVendor
Dostawca urządzenia zdalnego połączenia vpn.
...
### -IpAddress
Adres IPAddress tej lokacji vpn.
...
### —O365Policy
Zasady dotyczące przerw w ruchu usługi Office 365 dla tej lokacji vpn.
...
### — VirtualWan
Należy połączyć użytkownika VirtualWan z tą lokacją vpn.
...
### — VirtualWanId
Z wirtualnym urządzeniem ResourceId VirtualWan musi być połączona ta lokacja vpn.
...
### -VirtualWanName
Nazwa użytkownika VirtualWan, z który jest połączona ta vpnsite, musi być połączona.
...
Nazwa grupy zasobów dla użytkownika VirtualWan, z który jest połączona ta lokacja vpn, musi być połączona.
...
### -VpnSiteLink
Lista vpnsitelinków, które ta vpnsite ma.
