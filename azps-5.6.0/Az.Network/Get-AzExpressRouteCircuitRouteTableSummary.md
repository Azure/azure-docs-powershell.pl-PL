...
## OPIS
Polecenie **cmdlet Get-AzExpressRouteCircuitRouteTableSummary** pobiera podsumowanie informacji sąsiadów BGP dla określonego kontekstu routingu. Te informacje są przydatne do określenia, jak długo został ustalony kontekst routingu i liczba prefiksów tras ogłaszanych przez router komunikacji równorzędnej.
