...
## OPIS
Polecenie **cmdlet Get-AzLoadBalancerFrontendIpConfig** otrzymuje konfigurację frontoronu IP lub listę konfiguracji frontoronu IP w równoważeniu obciążenia.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie konfiguracji frontoronu ip w równoważeniu obciążenia
```
...
Drugie polecenie pobiera skojarzoną z tym równoważeniem obciążenia konfigurację frontonu adresu IP.
...
### -LoadBalancer
Określa, który równoważenie obciążenia jest skojarzony z konfiguracją frontonu ip, która ma być skojarzona z konfiguracją frontonu ip.
...
### — Nazwa
Określa nazwę urządzenia do równoważenia obciążenia, które zawiera konfigurację frontoronu IP do uzyskania.
