...
## OPIS
Polecenie New-AzTrafficSelectorPolicy cmdlet tworzy propozycję zasad selektora ruchu, która ma być używana w połączeniu z wirtualną bramą sieciową.
...
Tworzy wystąpienie zasad selektora ruchu i dodaje je jako parametr podczas tworzenia połączenia wirtualnej bramy sieciowej za pomocą protokołu IKEv2.
...
### -LocalAddressRange
Kolekcja zakresów adresów CIDR
