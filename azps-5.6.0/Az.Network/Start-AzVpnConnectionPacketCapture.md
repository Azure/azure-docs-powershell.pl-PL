...
## SYNOPSIS
Rozpoczyna operację przechwytywania pakietów w połączeniu vpn.
...
### -FilterData
Opcje filtrowania służące do uruchamiania przechwytywania pakietów przy połączeniu Vpn.
...
### — Nazwa
Nazwa połączenia Vpn, pod którym ma zostać rozpoczęte przechwytywanie pakietów.
...
### -ParentResourceName
Nazwa nadrzędnej sieci Vpngateway.
