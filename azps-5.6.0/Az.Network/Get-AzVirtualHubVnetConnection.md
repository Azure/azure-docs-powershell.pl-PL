...
Po utworzeniu połączenia sieci wirtualnej centrum otrzymuje ono połączenie z siecią wirtualną centrum przy użyciu nazwy grupy zasobów, nazwy centrum i nazwy połączenia.
...
Po utworzeniu połączenia sieci wirtualnej centrum wyświetla ono listę wszystkich połączeń sieci wirtualnej centrum przy użyciu nazwy grupy zasobów i nazwy centrum.
...
To polecenie cmdlet wyświetla listę wszystkich połączeń sieci wirtualnej centrum, rozpoczynając od "testu" przy użyciu nazwy grupy zasobów i nazwy centrum.
