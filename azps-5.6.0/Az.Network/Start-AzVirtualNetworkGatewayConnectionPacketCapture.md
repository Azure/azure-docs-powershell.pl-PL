...
```
### Przykład 3
Przykład przechwytywania pakietów dla wszystkich pakietów wewnętrznych i zewnętrznych
```powershell
...
### -FilterData
Opcje filtrowania służące do uruchamiania przechwytywania pakietów w połączeniu z wirtualną bramą sieciową.
...
### -InputObject
Obiekt połączenia wirtualnej bramy sieciowej, w którym ma zostać rozpoczęte przechwytywanie pakietów.
...
### — Nazwa
Nazwa połączenia wirtualnej bramy sieciowej, w której ma zostać rozpoczęte przechwytywanie pakietów.
...
### -ResourceId
Identyfikator zasobu Azure w usłudze VirtualNetworkGatewayConnection, w którym ma zostać rozpoczęte przechwytywanie pakietów.
