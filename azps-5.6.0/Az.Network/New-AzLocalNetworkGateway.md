...
Polecenie cmdlet **New-AzLocalNetworkGateway** tworzy obiekt reprezentujący lokalną bramę na podstawie nazwy, nazwy grupy zasobów, lokalizacji i adresu IP bramy, a także prefiksu adresu sieci lokalnej, która będzie nawiązywać połączenie z platformą Azure.

## PRZYKŁADY

### Przykład 1. Tworzenie bramy sieci lokalnej
```powershell
New-AzLocalNetworkGateway -Name myLocalGW -ResourceGroupName myRG -Location "West US" -GatewayIpAddress 23.99.221.164 -AddressPrefix "10.5.51.0/24"
```

Tworzy obiekt lokalnej bramy sieciowej o nazwie "myLocalGW" w grupie zasobów "myRG" w lokalizacji "Zachód US" z adresem IP "23.99.221.164" i prefiksem adresu "10.5.51.0/24" w zamowie.
...
### -ResourceGroupName
Określa grupę zasobów, do której należy brama sieci lokalnej.
