...
## OPIS
Polecenie **cmdlet Remove-AzServiceEndpointPolicy** usuwa zasady punktu końcowego usługi.

## PRZYKŁADY

### Przykład 1. Usuwanie zasad punktu końcowego usługi przy użyciu nazwy
```
Remove-AzServiceEndpointPolicy -Name "Policy1" -ResourceGroup "resourcegroup1"
```

To polecenie usuwa zasady punktu końcowego usługi o nazwie Zasady1, które należą do grupy zasobów o nazwie "grupa zasobów1".

### Przykład 2. Usuwanie zasad punktu końcowego usługi przy użyciu obiektu wejściowego
```
Remove-AzServiceEndpointPolicy -InputObject $Policy1 -ResourceGroup "resourcegroup1"
```

To polecenie usuwa obiekt Zasad1 zasad punktu końcowego usługi, który należy do grupy zasobów o nazwie "resourcegroup1"
...
### -InputObject
Obiekt zasad punktu końcowego usługi.
