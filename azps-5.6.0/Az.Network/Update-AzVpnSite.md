...
### ByVpnSiteNameNoVirtualWanUpdate (Domyślne)
```
...
## OPIS
Polecenie **cmdlet Update-AzVpnSite** aktualizuje witrynę VPN.
...
Powyższe spowoduje utworzenie grupy zasobów o wirtualnej sieci WAN w Zachód USA w grupie zasobów "testRG" na platformie Azure. 

Następnie tworzy witrynę VpnSite reprezentującą gałąź klienta i łączy ją z wirtualną siecią WAN.

Po utworzeniu witryny aktualizuje ona adres IpAddress witryny przy użyciu Set-AzVpnSite adresu.

## PARAMETERS

### -AddressSpace
Prefiksy adresów sieci wirtualnej.
Użyj tej lub AddressSpaceObject, ale nie obu.
...
### -InputObject
Obiekt witryny vpn do zmodyfikowania
...
### -IpAddress
Adres IP lokalnej bramy sieciowej.
...
### -ResourceId
Identyfikator zasobu Azure dla witryny vpn.
