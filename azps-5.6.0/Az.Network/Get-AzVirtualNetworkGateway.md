...
### Przykład 1. Uzyskiwanie bramy sieci wirtualnej
```powershell
Get-AzVirtualNetworkGateway -Name myGateway1 -ResourceGroupName myRG
```

Zwraca obiekt wirtualnej bramy sieciowej o nazwie "myGateway1" w grupie zasobów "myRG".

### Przykład 2. Uzyskiwanie bramy sieci wirtualnej
```powershell
Get-AzVirtualNetworkGateway -Name myGateway* -ResourceGroupName myRG
```

Zwraca wszystkie bramy sieci wirtualnej, których wartość rozpoczyna się od ciągu "myGateway" w grupie zasobów "myRG".
