...
### GetByResourceNameNoExpandParameterSet (Domyślne)
```
...
## OPIS
Polecenie **cmdlet Get-AzNetworkProfile** pobiera istniejący zasób najwyższego poziomu profilu sieciowego
...
To pobiera profil sieciowy np1 w grupie zasobów nr rg1
...
W ten sposób są pobierane profile sieciowe, które zaczynają się od "np".
