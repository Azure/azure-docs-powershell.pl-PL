...
## OPIS
Polecenie **cmdlet Get-AzPrivateDnsZoneGroup** pobiera co najmniej jedną prywatną grupę strefy DNS.

## PRZYKŁADY

### Przykład 1. Pobieranie prywatnej grupy stref DNS
```powershell
...
Powyższy przykład pobiera prywatną grupę strefy DNS o nazwie dnsgroup1 w obszarze rg grupy zasobów.
