...
## OPIS
Wylicza trasy poznane przez bramę sieci wirtualnej platformy Azure z różnych źródeł. Obejmuje to trasy poznane za pośrednictwem BGP, a także trasy statyczne. 
...
Dla bramy sieci wirtualnej platformy Azure o nazwie nazwana nazwa bramy w grupie zasobów grupy zasobów pobiera trasy, które zna brama azure. Brama sieci wirtualnej Azure w tym przypadku ma dwie trasy statyczne (10.1.0.0/16 i 10.0.0.254/32) oraz jedną trasę poznaną za pośrednictwem BGP (10.0.0.0/16).
