...
## SYNOPSIS
Pobiera profil SSL bramy aplikacji.
...
## OPIS
Polecenie **cmdlet Get-AzApplicationGatewaySslProfile** pobiera profil SSL bramy aplikacji.
...
Pierwsze polecenie pobiera bramę aplikacji o nazwie ApplicationGateway01 w grupie zasobów o nazwie ResourceGroup01 i zapisuje ją w $AppGw zmienną. Drugie polecenie pobiera profil SSL SslProfile01 for $AppGw i zapisuje go w $profile pliku.
