...
## OPIS
Polecenie **cmdlet Update-AzVpnConnection** aktualizuje połączenie VPN.  
Połączenie VPN tworzy połączenie IPsec łączące bramę VPN z zdalną gałąź klienta reprezentowaną na platformie Azure jako witryna VPN.
...
Połączenie zostanie zaktualizowane, aby przy użyciu polecenia Set-AzVpnConnection IpSecPolicy Set-AzVpnConnection nowe.
...
Połączenie zostanie zaktualizowane w celu utworzenia nowego klucza udostępnionego przy użyciu konstrukcji bezpiecznego ciągu.
...
Przepustowość, która musi zostać obsługina przez to połączenie w mb/s.
...
### -InputObject
Obiekt VpnConnection do zaktualizowania.
...
### -ResourceId
Identyfikator zasobu obiektu VpnConnection do usunięcia.
...
### -SharedKey
Klucz udostępniony wymagany do skonfigurowania tego połączenia.
...
Użyj lokalnego adresu IP platformy Azure jako adresu źródłowego podczas inicjowania połączenia.
...
Dla tego połączenia użyj selektorów ruchu opartych na zasadach.
...
Lista elementów VpnSiteLinkConnections, które musi mieć ta usługa VpnConnection.
