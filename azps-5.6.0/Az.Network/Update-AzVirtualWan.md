...
Powyższe spowoduje utworzenie grupy zasobów "testRG" w regionie "Zachód Usa" i wirtualnej sieci WAN platformy Azure w tej grupie zasobów na platformie Azure. VirtualWan został zaktualizowany o nowe właściwości.

## PARAMETERS

### -AllowBranchToBranchTraffic
Zezwalaj na ruch gałęzi dla VirtualWan.
...
Zezwalaj na ruch w sieci vnet dla virtualWan.
...
### -InputObject
Obiekt wirtualny wan do modyfikacji
