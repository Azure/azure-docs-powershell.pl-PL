...
## OPIS
Adresy IP assoicated do zapory w centrum wirtualnym. Mogą to być adresy publiczne i prywatne
...
W tym przykładzie jest tworzenie obiektu adresu IP centrum z liczną 2 publicznymi adresami IP. Obiekt HubIPAddress jest skojarzony z zaporą w centrum wirtualnym.
...
### -PrivateIPAddress
Prywatny adres IP zapory dołączonej do centrum
