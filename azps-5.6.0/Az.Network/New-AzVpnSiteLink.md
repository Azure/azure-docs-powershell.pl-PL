...
Powyższe spowoduje utworzenie grupy zasobów, wirtualnej sieci WAN i witryny VpnSite z 1 łączami VpnSiteLinks w Zachód w grupie zasobów "testRG" na platformie Azure.

### Przykład 2

Tworzy obiekt Azure VpnSiteLink. (wygenerowane automatycznie)
...
### -BGPPeeringAddress
Adres komunikacji równorzędnej BGP dla tego łącza vpnSiteLink.
