...
## OPIS
Polecenie **cmdlet Remove-AzPrivateDnsZoneGroup** usuwa grupę strefy DNS. 
...
Powyższy przykład usuwa grupę strefy DNS o nazwie dnsgroup1 z punktu końcowego test-pr-endpoint.
