...
## OPIS
Polecenie **cmdlet Get-AzVirtualWanVpnServerConfigurationVpnProfile** umożliwia generowanie i pobieranie profilu vpn na VirtualWan-VpnServerConfiguration konfiguracji klienta typu Point to site. Jest to wymagane do połączenia point-site z klienta point-site do usługi Azure P2SVpnGateway.
