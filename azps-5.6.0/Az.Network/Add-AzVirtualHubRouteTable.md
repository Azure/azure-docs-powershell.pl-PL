...
## OPIS
Zasób tabeli tras wirtualnego centrum zawiera listę tras oraz listę połączeń, do których można go dołączyć, i służy do rozsyłania ruchu w centrum wirtualnym.
...
Powyższe polecenie utworzy zasób tabeli tras wirtualnego centrum z tras do niego przekazanych, a ten obiekt może być używany do routingu ruchu w centrum wirtualnym.  

## PARAMETERS

### — Połączenie
Lista połączeń, do których jest dołączona tabela trasy.
...
### — Trasuj
Lista tras centrum wirtualnego.
