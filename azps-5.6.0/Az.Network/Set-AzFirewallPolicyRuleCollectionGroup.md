...
## OPIS
Polecenie **cmdlet Set-AzFirewallPolicyRuleCollectionGroup** aktualizuje grupy zbioru reguł w zasadach zapory platformy Azure.
...
W tym przykładzie grupa zbioru reguł w zasadach zapory jest aktualizowana $fp

### Przykład 2

zapisuje zmodyfikowaną grupę zbioru reguł zasad zapory platformy Azure. (wygenerowane automatycznie)
...
### -ResourceId
Identyfikator zasobu grupy Zbioru reguł
