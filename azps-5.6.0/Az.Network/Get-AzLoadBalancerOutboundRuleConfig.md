...
## OPIS
Polecenie **cmdlet Get-AzLoadBalancerOutboundRuleConfig** pobiera konfigurację reguły ruchu wychodzącego lub listę konfiguracji reguł ruchu wychodzącego w równoważeniu obciążenia.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie konfiguracji reguły ruchu wychodzącego w równoważeniu obciążenia
```powershell
...
Drugie polecenie pobiera konfigurację reguły ruchu wychodzącego o nazwie MyRule skojarzoną z tym równoważeniem obciążenia.
