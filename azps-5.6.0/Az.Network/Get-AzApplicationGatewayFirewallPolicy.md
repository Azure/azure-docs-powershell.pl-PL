...
## OPIS
Polecenie **cmdlet Get-AzApplicationGatewayFirewallPolicy** otrzymuje zasady zapory bramy aplikacji.
...
To polecenie pobiera zasady zapory bramy aplikacji o nazwie FirewallPolicy1, które należą do grupy zasobów o nazwie ResourceGroup01, i zapisuje je w zmiennej $AppGwFirewallPolicy zasobów.
