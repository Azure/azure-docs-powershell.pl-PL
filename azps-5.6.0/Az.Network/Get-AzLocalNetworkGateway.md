...
Polecenie **cmdlet Get-AzLocalNetworkGateway** zwraca obiekt reprezentujący wejściową bramę na podstawie nazwy i nazwy grupy zasobów.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie bramy sieci lokalnej
```powershell
...
Zwraca obiekt lokalnej bramy sieciowej o nazwie "myLocalGW1" w grupie zasobów "myRG".

### Przykład 2. Uzyskiwanie lokalnych bram sieciowych przy użyciu filtrowania
```powershell
...
Zwraca obiekt lokalnej bramy sieciowej o nazwie zaczynającej się od ciągu "myLocalGW" w grupie zasobów "myRG".
