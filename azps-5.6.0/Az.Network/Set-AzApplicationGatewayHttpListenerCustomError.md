...
## OPIS
Polecenie **cmdlet Set-AzApplicationGatewayCustomError** aktualizuje błąd niestandardowy w słuchaczu http bramy aplikacji.

## PRZYKŁADY

### Przykład 1. Aktualizacja błędu niestandardowego od słuchacza http
```powershell
...
To polecenie aktualizuje niestandardowy błąd kodu stanu http 502 w interfejsie $listener 01 http i zwraca zaktualizowanego słuchacza.
