...
## OPIS
Polecenie **cmdlet Set-AzExpressRouteConnection** aktualizuje połączenie trasy express utworzonej między bramą trasy expressowej i lokalnym obwodem trasy express route.
...
Powyższe utworzy grupę zasobów, wirtualną sieć WAN, sieć wirtualną, centrum wirtualne i usługę ExpressRouteSite w Zachód w grupie zasobów "testRG" na platformie Azure. Brama usługi ExpressRoute zostanie utworzona w centrum wirtualnym z 2 jednostkami skali.
