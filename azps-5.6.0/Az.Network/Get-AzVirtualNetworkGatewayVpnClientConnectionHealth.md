...
## OPIS
Lista wszystkich kondycji połączenia klienta sieci vpn. Dotyczy to: vpnConnectionId vpnConnectionDuration vpnConnectionTime publicIpAddress privateIpAddress vpnUserName maxBandwidth egressPacketsTransferred egressBytesTransferred ingressPacketsTransferred ingressBytesTransferred maxPacketsPerSecond
...
W przypadku bramy sieci wirtualnej platformy Azure o nazwie nazwana nazwa bramy w grupie zasobów resourceGroup pobiera obecnie połączone połączenie klienta vpn przy użyciu połączenia OpenVpn. 

### Przykład 2

Uzyskaj listę kondycji połączenia klienta vpn bramy sieci wirtualnej Azure dla każdego połączenia klienta vpn. (wygenerowane automatycznie)
