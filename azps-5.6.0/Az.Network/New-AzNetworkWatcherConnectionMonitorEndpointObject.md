...
## OPIS
New-AzNetworkWatcherConnectionMonitorEndpointObject cmdlet tworzy punkt końcowy monitora połączenia.
...
Nazwa: workspaceEndpoint Typ: MMAWorkspaceMachine ResourceId : /subscriptions/00000000-0000-0000-0000-0000000000000/resourcegroups/myresourceGroup/providers/Microsoft.OperationalInsights/workspaces/myworkspace Address: Scope : { "Include": [ { "Address": "WIN-P0HGNDO2S1B" } ] }
...
### — AzureVNet
Przełącznik punktu końcowego sieci Vnet platformy Azure.
...
### -CoverageLevel
Zakres testów dla punktu końcowego.
Obsługiwane wartości to Domyślne, Niskie, Średnia, Średnia, NadAvergae, Pełne.
...
### -ExcludeItem
Lista elementów, które należy wykluczyć z zakresu punktu końcowego.
...
### - IncludeItem
Lista elementów, które należy ujmować w zakres końcowejponty.
...
### -MMAWorkspaceMachine
Przełącznik punktu końcowego programu MMA Workspace Machine.
...
### -MMAWorkspaceNetwork
Przełącznik punktu końcowego sieci obszarów roboczych programu MMA.
