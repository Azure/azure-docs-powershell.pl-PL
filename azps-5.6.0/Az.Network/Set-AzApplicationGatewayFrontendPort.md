...
## OPIS
Polecenie **cmdlet Set-AzApplicationGatewayFrontendPort** modyfikuje port frontoronu bramy aplikacji.

## PRZYKŁADY

### Przykład 1. Ustawianie portu frontoronu bramy aplikacji na wartość 80
```
...
Drugie polecenie modyfikuje bramę w programie $AppGw w celu użycia portu 80 dla portu frontoronu o nazwie FrontEndPort01.

## PARAMETERS

### -ApplicationGateway
Określa obiekt bramy aplikacji, z którym to polecenie cmdlet skojarzy port frontoronu.
...
### — Nazwa
Określa nazwę portu frontoronu, który ma być modyfikowany.
...
### — Port
Określa numer portu, który ma być numer portu frontonie.
