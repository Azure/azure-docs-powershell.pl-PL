...
### VirtualRouterPeerNameParameterSet (Domyślne)
```
...
## OPIS
Polecenie **cmdlet Remove-AzVirtualRouterPeer** usuwa element równorzędny VirtualRouter z wirtualnego przekierowania platformy Azure
...
### -InputObject
Obiekt wejściowy równorzędny routera wirtualnego.
...
### -PeerName
Nazwa komputera równorzędnego routera wirtualnego.
...
### -ResourceGroupName
Nazwa grupy zasobów routera/elementu równorzędnego wirtualnego.
...
### -VirtualRouterName
Router wirtualny, na którym istnieje serwer równorzędny.
