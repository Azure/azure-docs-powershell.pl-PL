...
## OPIS
Polecenie **cmdlet Add-AzVirtualNetworkPeering** tworzy komunikacji równorzędne między dwiema sieciami wirtualnymi.
...
Zwróć uwagę, że aby komunikacja równorzędna działała, należy utworzyć link komunikacji równorzędnej z sieci vnet1 do vnet2 i odwrotnie.
...
Tutaj "myVnet1" w us West Central jest równorzędny z "myVnet2" w Canada Central.

## PARAMETERS

### -AllowForwardedTraffic
Wskazuje, że to polecenie cmdlet umożliwia przesyłanie dalej ruchu z maszyn wirtualnych w zdalnej sieci wirtualnej.
...
### -AllowGatewayTransit
Flaga zezwala na połączenia bramy w linkach zdalnej sieci wirtualnej do tej sieci wirtualnej
...
Wskazuje, że to polecenie cmdlet blokuje maszyny wirtualne w połączonym wirtualnym przestrzeni sieciowym w celu uzyskania dostępu do wszystkich maszyn wirtualnych w lokalnym wirtualnym miejscu sieciowym.
...
### — UseRemoteGateway
Wskazuje, że to polecenie cmdlet umożliwia bramom zdalnym w tej sieci wirtualnej.
