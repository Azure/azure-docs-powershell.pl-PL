...
## OPIS
Polecenie **cmdlet Set-AzApplicationGatewayIdentity** aktualizuje tożsamość przypisaną do bramy aplikacji.
...
W tym przykładzie przypiszemy tożsamość przypisaną do użytkownika do istniejącej bramy aplikacji.
Uwaga: Ta tożsamość powinna mieć dostęp do kluczowej informacji, do której będą odwoływowane się certyfikaty/tajemnice.
