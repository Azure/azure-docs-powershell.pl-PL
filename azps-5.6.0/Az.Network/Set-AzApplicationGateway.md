...
## OPIS
Polecenie **cmdlet Set-AzApplicationGateway** aktualizuje bramę aplikacji platformy Azure.
...
Te polecenia aktualizują bramę aplikacji o ustawienia zmiennej $AppGw i zapisuje zaktualizowaną bramę w $UpdatedAppGw zmienną.

## PARAMETERS

### -ApplicationGateway
Określa obiekt bramy aplikacji reprezentujący stan, dla którego powinna zostać ustawiona brama aplikacji.
