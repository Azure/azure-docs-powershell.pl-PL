...
## OPIS
Polecenie **cmdlet Set-AzApplicationGatewayRewriteRuleSet** modyfikuje regułę routingu żądania.
...
Drugie polecenie modyfikuje zestaw reguł ponownego agwania dla bramy aplikacji w celu używania reguł ponownego określonej w $rule aplikacji.
