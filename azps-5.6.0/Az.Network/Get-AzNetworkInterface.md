...
### NoExpandStandAloneNic (domyślne)
```
...
## OPIS
Polecenie **cmdlet Get-AzNetworkInterface** otrzymuje interfejs sieciowy platformy Azure lub listę interfejsów sieciowych platformy Azure w grupie zasobów.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie wszystkich interfejsów sieciowych
```
...
To polecenie pobiera wszystkie interfejsy sieciowe w grupie zasobów o nazwie ResourceGroup1, w przypadku których stan inicjowania obsługi administracyjnej zakończył się pomyślnie.

### Przykład 3. Uzyskiwanie interfejsów sieciowych przy użyciu filtrowania
```
...
To polecenie pobiera wszystkie interfejsy sieciowe dla bieżącej subskrypcji, które zaczynają się od "testu".
...
### — Nazwa
Określa nazwę interfejsu sieciowego, który otrzymuje to polecenie cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, z której to polecenie cmdlet uzyskuje interfejsy sieciowe.
...
### -VirtualMachineIndex
Określa indeks maszyny wirtualnej zestawu skali maszyny wirtualnej, z którego to polecenie cmdlet uzyskuje interfejsy sieciowe.
...
Określa nazwę zestawu skali maszyny wirtualnej, z którego to polecenie cmdlet uzyskuje interfejsy sieciowe.
