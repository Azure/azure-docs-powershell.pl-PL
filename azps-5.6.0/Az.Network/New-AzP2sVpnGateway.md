...
### ByVirtualHubNameByVpnServerConfigurationObject (Domyślne)
```
...
## OPIS
Polecenie New-AzP2sVpnGateway cmdlet umożliwia utworzenie nowej aplikacji P2SVpnGateway w obszarze VirtualHub for Point to site connectivity z klienta point-site do azure VirtualWan.
...
Polecenie New-AzP2sVpnGateway cmdlet umożliwia utworzenie nowej aplikacji P2SVpnGateway w obszarze VirtualHub for Point to site connectivity.
...
### — VirtualHub
Z tą aplikacją P2SVpnGateway musi być skojarzona usługa VirtualHub.
...
### - VirtualHubId
Identyfikator tej aplikacji P2SVpnGateway w aplikacji VirtualHub musi być skojarzony.
...
Oflaguj, aby włączyć internet preferencji routingu w tej aplikacji P2SVpnGateway.
