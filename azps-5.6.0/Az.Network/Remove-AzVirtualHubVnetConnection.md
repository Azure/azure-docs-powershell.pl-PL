...
Po utworzeniu połączenia sieci wirtualnej centrum usuwa ono połączenie z siecią wirtualną centrum za pomocą połączeń rurowych programu PowerShell na danych wyjściowych z platformy Get-AzHubVirtualNetworkConnection.
