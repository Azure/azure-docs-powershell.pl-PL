...
W tym przykładzie są tworzyć dwie nowe konfiguracje podsieci przy New-AzVirtualSubnetConfig cmdlet, a następnie używać ich do tworzenia sieci wirtualnej. Szablon New-AzVirtualSubnetConfig tworzy jedynie reprezentację podsieci w pamięci. W tym przykładzie frontendSubnet ma kod CIDR 10.0.1.0/24 i odwołuje się do grupy zabezpieczeń sieci, która zezwala na dostęp za ich względów. W przypadku podsieci wewnętrznej ma kod CIDR 10.0.2.0/24 i odwołuje się do tej samej grupy zabezpieczeń sieci.
...
### -RouteTable
Określa tabelę trasy skojarzoną z konfiguracją podsieci.
...
### -RouteTableId
Określa identyfikator tabeli trasy skojarzonej z konfiguracją podsieci.
