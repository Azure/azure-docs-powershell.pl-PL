...
## OPIS
Polecenie **cmdlet Set-AzApplicationGatewayRequestRoutingRule** modyfikuje regułę routingu żądania.

## PRZYKŁADY

### Przykład 1. Aktualizowanie reguły routingu żądania
```
...
Pierwsze polecenie pobiera bramę aplikacji o nazwie ApplicationGateway01 i zapisuje ją w zmiennej $AppGw aplikacji.
Drugie polecenie modyfikuje regułę routingu żądania dla bramy aplikacji w celu używania ustawień protokołu HTTP typu back-end określonych w zmiennej $Setting, słuchacza HTTP określonego w zmiennej $Listener oraz puli adresów back-end określonej w zmiennej $Pool.

## PARAMETERS

### -ApplicationGateway
Określa obiekt bramy aplikacji, z którym to polecenie cmdlet skojarzy regułę routingu żądania.
...
### -BackendAddressPool
Określa pulę adresów back-end bramy aplikacji.
...
Określa identyfikator puli adresów back-end bramy aplikacji.
...
### -BackendHttpSettings
Określa ustawienia protokołu HTTP zaplecza bramy aplikacji.
...
Określa identyfikator ustawień protokołu HTTP bramy aplikacji.
...
### - HttpListener
Określa słuchacza HTTP bramy aplikacji.
...
### -HttpListenerId
Określa identyfikator słuchacza HTTP bramy aplikacji.
...
### — Nazwa
Określa nazwę reguły routingu żądania, która zostanie zmodyfikowana przez to polecenie cmdlet.
