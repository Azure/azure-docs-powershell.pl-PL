...
## OPIS
Polecenie **cmdlet New-AzLoadBalancerProbeConfig** tworzy konfigurację usługi Azure load balancer.

## PRZYKŁADY

### Przykład 1. Tworzenie konfiguracji
```powershell
PS C:\>New-AzLoadBalancerProbeConfig -Name "MyProbe" -Protocol "http" -Port 80 -IntervalInSeconds 15 -ProbeCount 15
```

To polecenie tworzy konfigurację o nazwie MyProbe przy użyciu protokołu HTTP.
Nowa usługa połączy się z usługą równoważenia obciążenia na porcie 80.

### Przykład 2

Tworzy konfigurację konfiguracji sprzętu do równoważenia obciążenia. (wygenerowane automatycznie)
...
### — Nazwa
Określa nazwę konfiguracji, która ma być tworzyć.
...
### — Port
Określa port, z którym nowy kontakt powinien łączyć się z usługą z obciążeniem.
...
### — Protokół
Określa protokół, który ma być używany dla konfiguracji konfiguracji konfigurację.
