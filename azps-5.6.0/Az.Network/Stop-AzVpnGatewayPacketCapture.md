...
## SYNOPSIS
Zatrzymuje operację przechwytywania pakietów w bramie vpn.
...
## OPIS
Zatrzymuje operację przechwytywania pakietów w bramie vpn i przekaże wynik na dany adres SasUrl kontenera magazynu.
...
### -InputObject
Obiekt Vpn Gateway, w którym ma zostać rozpoczęte przechwytywanie pakietów.
...
### — Nazwa
Nazwa bramy vpn, na której ma zostać rozpoczęte przechwytywanie pakietów.
...
### -ResourceId
Identyfikator zasobu Azure w usłudze VpnGateway, w którym ma zostać rozpoczęte przechwytywanie pakietów.
...
### - SasUrl
Przechwytywanie pakietów w adresie URL SAS w bramie vpn.
