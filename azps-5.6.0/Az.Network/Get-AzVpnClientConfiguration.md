...
## OPIS
Adres Get-AzVpnClientConfiguration URL, z którego można pobrać klienta SIECI VPN.
...
Pobiera adres URL, aby pobrać profil usługi VpnClient, który został wcześniej wygenerowany przy użyciu New-AzVpnClientConfiguration sieci.
