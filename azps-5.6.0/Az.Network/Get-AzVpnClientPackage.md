...
Pakiety klientów zawierają dane konfiguracji, które umożliwiają klientowi nawiązaniu połączenia VPN z siecią wirtualną platformy Azure; aby można było nawiązaniu połączenia VPN, komputery klienckie muszą mieć zainstalowany właściwy pakiet konfiguracyjnych.
