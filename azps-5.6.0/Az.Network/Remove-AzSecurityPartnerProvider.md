...
## OPIS
Polecenie **cmdlet Remove-AzSecurityPartnerProvider** usuwa element Azure SecurityPartnerProvider
...
### -ResourceId
Identyfikator zasobu securityPartnerProvider.
...
Obiekt wejściowy securityPartnerProvider.
