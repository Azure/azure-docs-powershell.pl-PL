...
Brama Azure VPN to zdefiniowana przez oprogramowanie łączność witryny z witryną w aplikacji VirtualHub. Ta brama zmienia rozmiar i skale na podstawie jednostki skali określonej przez użytkownika. Połączenie można skonfigurować z gałęzi/witryny sieci VPN do skalowalnej bramy. Każde połączenie składa się z 2 Active-Active i podkołowych
