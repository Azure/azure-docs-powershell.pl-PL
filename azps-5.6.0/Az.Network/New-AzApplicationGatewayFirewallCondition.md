...
Polecenie tworzy nowy warunek dopasowania przy użyciu zmiennej zgodnej zdefiniowanej w $variable, operator zawiera, a warunek negacji ma wartość fałszywą, transfroms, w tym małe litery i przycinanie, wartość dopasowania to abc i cde. Nowy warunek dopasowania zostanie zapisany w $condition.
