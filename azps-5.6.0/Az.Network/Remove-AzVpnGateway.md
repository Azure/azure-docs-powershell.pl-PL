...
W tym przykładzie jest grupę zasobów ( Wirtualna sieć WAN, wirtualne centrum — skalowalna brama VPN) w centrum Stanów Zjednoczonych, a następnie natychmiast ją usuwa. To usunięcie odbywa się przy użyciu linii rurowej programu PowerShell, która korzysta z obiektu VpnGateway zwróconego przez Get-AzVpnGateway połączenia.
