...
## OPIS
Zatrzymuje operację przechwytywania pakietów w wirtualnej bramie sieciowej i przekaże wynik na dany adres SasUrl kontenera magazynu.
...
### -InputObject
Obiekt bramy sieci wirtualnej, w którym ma zostać rozpoczęte przechwytywanie pakietów.
...
### — Nazwa
Nazwa wirtualnej bramy sieciowej, w której ma zostać rozpoczęte przechwytywanie pakietów.
...
### -ResourceId
Identyfikator zasobu Azure w witrynie VirtualNetworkGateway, w której ma zostać rozpoczęte przechwytywanie pakietów.
...
### - SasUrl
Przechwytywanie pakietów w adresie URL sas w wirtualnej bramie sieciowej.
