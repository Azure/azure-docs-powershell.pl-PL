...
## OPIS
Zatrzymuje operację przechwytywania pakietów dla połączenia wirtualnej bramy sieciowej i przekaże wynik dla danego sasurl kontenera magazynu.
...
### — Nazwa
Nazwa połączenia wirtualnej bramy sieciowej, na której ma zostać rozpoczęte przechwytywanie pakietów.
...
### - SasUrl
Adres URL sas do zatrzymania przechwytywania pakietów w bramie sieci wirtualnej.
