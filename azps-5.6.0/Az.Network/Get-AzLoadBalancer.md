...
## OPIS
Polecenie **cmdlet Get-AzLoadBalancer** pobiera co najmniej jedno narzędzie do równoważenia obciążenia platformy Azure, które są zawarte w grupie zasobów.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie równoważenia obciążenia
```
...
To polecenie pobiera równoważenie obciążenia o nazwie MyLoadBalancer.
Aby można było uruchomić to polecenie cmdlet, musi istnieć równoważenie obciążenia.

### Przykład 2. Lista elementów równoważenia obciążenia przy użyciu filtrowania
```
...
To polecenie pobiera wszystkie równoważenie obciążenia o nazwie, która zaczyna się od "MyLoadBalancer"
