...
## OPIS
**Polecenie cmdlet AzApplicationGatewayRewriteRuleCondition** tworzy warunek reguły ponownego w przypadku bramy aplikacji platformy Azure.
...
```
To polecenie tworzy warunek w regułę ponownego agwania i zapisuje wynik w zmiennej o nazwie $condition.
...
### -IgnoreCase
Ustaw tę flagę tak, aby zignorować literę we wzorcu
...
### - Negate
Ustawienie tej flagi w celu negacji sprawdzania poprawności warunków
...
### — Deseń
Wzorzec wyszukiwania w nagłówku zmiennych
...
### —Zmienna
Nazwa nagłówka, który ma być ustawiony jako warunek
