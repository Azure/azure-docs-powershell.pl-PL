...
## OPIS
Polecenie New-AzApplicationGatewayBackendHttpSetting cmdlet tworzy ustawienia protokołu HTTP dla bramy aplikacji.
Ustawienia protokołu HTTP typu Back-end są stosowane do wszystkich serwerów back-end w puli.

## PRZYKŁADY

### Przykład 1. Tworzenie ustawień protokołu HTTP wt. back-end
```powershell
...
To polecenie tworzy ustawienia protokołu HTTP na porcie 80 o nazwie Setting01 (Ustawienie01), korzystając z protokołu HTTP, z wyłączonym chciwością opartą na plikach cookie.
Ustawienia są przechowywane w zmiennej $Setting danych.

### Przykład 2

Tworzy ustawienie protokołu HTTP na zawęzie dla bramy aplikacji. (wygenerowane automatycznie)
...
### - CookieBasedAffinity
Określa, czy ffinity oparte na plikach cookie powinny być włączone, czy wyłączone dla puli serwerów back-end.
...
### — Nazwa
Określa nazwę ustawień protokołu HTTP, które tworzy to polecenie cmdlet.
...
### — Dor.
Określa wartość do skojarzenia z pulą serwerów back-end.
...
### - NaiwnyId
Określa identyfikator współpracownika, który ma skojarzyć z pulą serwerów typu back-end.
