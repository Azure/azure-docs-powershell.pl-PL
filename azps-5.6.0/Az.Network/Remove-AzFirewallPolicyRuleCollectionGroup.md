...
## OPIS
Polecenie **cmdlet Remove-AzFirewallPolicyRuleCollectionGroup** usuwa grupę zbioru reguł z zasad zapory platformy Azure.
...
W tym przykładzie grupa reguł zasad zapory o nazwie "testRcGroup" jest usuwana z grupy reguł zapory o nazwie "testRcGroup" w obiekcie zasad zapory $fp
...
W tym przykładzie usuwa grupę kolelction reguł zasad zapory o nazwie "testRcGroup" w zaporze o nazwie "fpName" frpm nazwy grupy zasobów "testRg".
...
### -InputObject
Obiekt grupy zbioru reguł zasad zapory
