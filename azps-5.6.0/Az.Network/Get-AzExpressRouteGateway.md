...
Następnie pobiera ona bramę ExpressRouteGateway przy użyciu nazwy grupy zasobów i nazwy bramy.
...
To polecenie spowoduje, że wszystkie przejścia w uście ExpressRouteGateway, które zaczynają się od "testu".
