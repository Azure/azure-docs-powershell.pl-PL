...
## OPIS
**Set-AzNetworkInterfaceTapConfig** aktualizuje konfigurację naciśnięcia interfejsu sieciowego.

## PRZYKŁADY

### Przykład 1. Ustawianie konfiguracji tapconfiguration przy użyciu zaktualizowanej nazwy konfiguracji tapconfig
```
...
Konfiguracja usługi NetworkInterface Tap
