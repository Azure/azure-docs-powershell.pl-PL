...
W tym przykładzie usuwa się autoryzację obwodu z obwodu w układzie ExpressRoute. Pierwsze polecenie używa polecenia cmdlet **Get-AzExpressRouteCircuit** w celu utworzenia odwołania do obiektu obwodu usługi ExpressRoute o nazwie ContosoCircuit i przechowuje wynik w zmiennej o nazwie $Circuit.
