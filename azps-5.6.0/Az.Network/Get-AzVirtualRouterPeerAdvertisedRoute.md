...
## SYNOPSIS
Lista tras ogłaszanych przez określonego wirtualnego routera równorzędnego
...
## OPIS
Jeśli dany router wirtualny jest równorzędny według nazwy lub obiektu, wylicza trasy ogłaszane do tej równorzędnej przez konkretny router wirtualny.
...
### -PeerName
Nazwa równorzędnego routera wirtualnego
...
### -ResourceGroupName
Nazwa grupy zasobów równorzędnych routera wirtualnego
