...
Drugie polecenie pobiera ustawienia serwera HTTP o nazwie Ustawienia01 dla protokołu $AppGw i zapisuje ustawienia w $Settings sieci.
Ostatnie polecenie modyfikuje konfigurację opróżniania połączenia obiektu ustawień protokołu HTTP na zawęzie przechowywanego w programie $Settings przez ustawienie wartości Enabled (Fałsz) i DrainTimeoutInSec (Wyczerpanie) na 3600.
