...
## SYNOPSIS
Zatrzymuje operację przechwytywania pakietów przy połączeniu Vpn
...
## OPIS
Zatrzymuje operację przechwytywania pakietów na połączeniu vpn i przekaże wynik na danym pliku SasUrl kontenera magazynu.
...
### -InputObject
Obiekt połączenia Vpn, w którym ma zostać rozpoczęte przechwytywanie pakietów.
...
### -LinkConnectionName
Nazwy witryny SiteLinkConnection.
...
### — Nazwa
Nazwa połączenia VPN, na którym ma zostać rozpoczęte przechwytywanie pakietów.
...
### -ResourceId
Identyfikator zasobu Azure połączenia VpnConnection, w którym ma zostać rozpoczęte przechwytywanie pakietów.
...
### - SasUrl
Adres URL sas do zatrzymania przechwytywania pakietów w sieci Vpn.
