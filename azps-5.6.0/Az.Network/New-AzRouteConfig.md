...
## OPIS
Polecenie **cmdlet New-AzRouteConfig** tworzy trasę dla tabeli trasy platformy Azure.

## PRZYKŁADY

### Przykład 1. Tworzenie trasy
```powershell
...
Pierwsze polecenie tworzy trasę o nazwie Route07, a następnie zapisuje ją w $Route zmienną.
Ta trasa przesyła pakiety do lokalnej sieci wirtualnej.
Drugie polecenie wyświetla właściwości trasy.

### Przykład 2

Tworzy trasę dla tabeli trasy. (wygenerowane automatycznie)
...
### -NextHopIpAddress
Określa adres IP urządzenia wirtualnego, które dodaje się do sieci Azurevirtual.
