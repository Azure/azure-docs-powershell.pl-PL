...
## OPIS
Polecenie **cmdlet New-AzExpressRoutePort** tworzy raport usługi Azure ExpressRoutePort
...
### - BandwidthInGbps
Przepustowość dla procured ports in Gb/s
...
### - Encapsulation
Metoda enkulacji w portach fizycznych.
...
### — Tożsamość
Tożsamość przypisana do użytkownika do odczytu konfiguracji komputera MacSec
...
### — Link
Zestaw fizycznych łączy zasobu ExpressRoutePort
...
### -PeeringLocation
Nazwa lokalizacji komunikacji równorzędnej, która fizycznie jest mapowana na usługę ExpressRoutePort.
...
### -ResourceGroupName
Nazwa grupy zasobów dlaportu ExpressRoutePort.
...
### -ResourceId
ResourceId portu trasy ekspresowej.
