...
### Przykład 1. Aktualizowanie istniejącego certyfikatu SSL w bramie aplikacji
```
...
### Przykład 2. Aktualizowanie istniejącego certyfikatu SSL przy użyciu klucza KeyVault Secret (klucz tajny bez wersji) w bramie aplikacji
```
...
Uzyskaj klucz tajny i zaktualizuj istniejący certyfikat SSL przy `Set-AzApplicationGatewaySslCertificate` użyciu.

### Przykład 3. Aktualizowanie istniejącego certyfikatu SSL przy użyciu klucza Klucz Tajny w bramie aplikacji
```
PS C:\> $secret = Get-AzKeyVaultSecret -VaultName "keyvault01" -Name "sslCert01"
...
### -ApplicationGateway
Określa bramę aplikacji, z którą jest skojarzony certyfikat SSL (Secure Socket Layer).
