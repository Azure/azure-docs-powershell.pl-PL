...
## SYNOPSIS
Modyfikuje łańcuch certyfikatów zaufanego urzędu certyfikacji klienta bramy aplikacji.
...
## OPIS
Polecenie **cmdlet Set-AzApplicationGatewayTrustedClientCertificate** modyfikuje łańcuch certyfikatów zaufanego urzędu certyfikacji klienta bramy aplikacji.
...
Powyżej przykładowych scenariuszy pokazano, jak zaktualizować istniejący obiekt łańcucha certyfikatów zaufanego urzędu certyfikacji klienta. Pierwsze polecenie otrzymuje bramę aplikacji i zapisuje je w $gw aplikacji. Drugie polecenie modyfikuje istniejący obiekt łańcucha certyfikatów zaufanego urzędu certyfikacji klienta przy użyciu nowego pliku łańcucha certyfikatów urzędu certyfikacji. Trzecie polecenie aktualizuje bramę aplikacji na platformie Azure.
