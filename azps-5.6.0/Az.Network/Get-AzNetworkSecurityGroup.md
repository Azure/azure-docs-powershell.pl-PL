...
## OPIS
Polecenie **cmdlet Get-AzNetworkSecurityGroup** otrzymuje grupę zabezpieczeń sieci platformy Azure.

## PRZYKŁADY

### Przykład 1. Pobieranie istniejącej grupy zabezpieczeń sieci
```powershell
...
To polecenie zwraca zawartość grupy zabezpieczeń sieci platformy Azure "nsg1" w grupie zasobów "rg1"

### Przykład 2. Lista istniejących grup zabezpieczeń sieci przy użyciu filtrowania
```powershell
...
To polecenie zwraca zawartość grup zabezpieczeń sieci platformy Azure, których zawartość rozpoczyna się od "nsg"
...
### — Nazwa
Określa nazwę grupy zabezpieczeń sieci, do których otrzymuje to polecenie cmdlet.
