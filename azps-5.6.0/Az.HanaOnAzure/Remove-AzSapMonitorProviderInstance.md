...
### Przykład 1. Usuwanie wystąpienia monitora SAP według nazwy
```powershell
PS C:\> Remove-AzSapMonitorProviderInstance -ResourceGroupName nancyc-hn1 -SapMonitorName ps-spamonitor-t01 -Name ps-sapmonitorins-t02

```

To polecenie usuwa wystąpienie monitora SAP według nazwy.

### Przykład 2. Usuwanie wystąpienia monitora SAP przez obiekt
```powershell
...
To polecenie usuwa wystąpienie monitora SAP według obiektów.
