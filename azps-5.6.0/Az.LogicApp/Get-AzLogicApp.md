...
## OPIS
Polecenie **cmdlet Get-AzLogicApp** pobiera aplikację logiki.
...
### Przykład 1. Uzyskiwanie aplikacji logiki z grupy zasobów
```
...
To polecenie pobiera aplikację logiczną z grupy zasobów o nazwie Grupa Zasobów11.
...
### — Nazwa
Określa nazwę aplikacji logiki, która pobiera to polecenie cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, w której to polecenie cmdlet pobiera aplikację logiki.
...
### — Wersja
Określa wersję aplikacji logiki.
