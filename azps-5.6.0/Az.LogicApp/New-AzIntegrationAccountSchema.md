...
## SYNOPSIS
Tworzy schemat konta integracji.
...
## OPIS
Polecenie **cmdlet New-AzIntegrationAccountSchema** tworzy schemat konta integracji.
...
To polecenie tworzy schemat konta integracji o nazwie IntegrationAccountSchema1 w określonej grupie zasobów.

## PARAMETERS

### - ContentType
Określa typ zawartości schematu konta integracji.
...
### — Metadane
Określa obiekt metadanych schematu.
...
### - SchemaDefinition
Określa obiekt definicji dla schematu konta integracji.
...
### -SchemaFilePath
Określa ścieżkę pliku definicji schematu konta integracji.
...
### -SchemaType
Określa typ schematu konta integracji.
Ten parametr obsługuje typ danych Xml.
