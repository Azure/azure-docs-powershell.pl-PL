...
## SYNOPSIS
Pobiera wyzwalacze aplikacji logiki.
...
Określanie przepływu pracy, grupy zasobów i wyzwalacza.
...
### Przykład 1. Uzyskiwanie wyzwalacza aplikacji logiki
```
...
### Przykład 2. Uzyskiwanie wszystkich wyzwalaczy aplikacji logiki
```
...
To polecenie pobiera wyzwalacze aplikacji logiki o nazwie LogicApp07.
...
### — Nazwa
Określa nazwę aplikacji logiki, z której to polecenie cmdlet uzyskuje wyzwalacz.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, w której to polecenie cmdlet uzyskuje wyzwalacz.
...
### -TriggerName
Określa nazwę wyzwalacza, który otrzymuje to polecenie cmdlet.
