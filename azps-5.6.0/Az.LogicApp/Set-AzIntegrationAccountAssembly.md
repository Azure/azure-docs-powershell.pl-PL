...
Modyfikuje zestaw o nazwie "sampleAssembly" przy użyciu danych bajtowych znajdujących się w adresie URL "$assemblyUrl". Jest to sugerowana metoda tworzenia zespołów o dużych rozmiarach.
