...
## OPIS
Polecenie **cmdlet Set-AzLogicApp** modyfikuje aplikację logiki przy użyciu funkcji aplikacje logiki.
...
Aplikację logiki można modyfikować, określając nazwę, lokalizację, definicję aplikacji logiki, grupę zasobów i plan.
...
### Przykład 1. Modyfikowanie aplikacji logiki
```
...
To polecenie modyfikuje aplikację logiki.
...
### -UseConsumptionModel
Wskazuje, że w rozliczeniach aplikacji logicznych jest oparty na modelu zużycia.
