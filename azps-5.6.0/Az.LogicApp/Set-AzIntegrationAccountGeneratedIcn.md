...
## SYNOPSIS
Aktualizuje numer ICN (Interchange Control Number) wygenerowany dla konta integracji w grupie zasobów platformy Azure.
...
## OPIS
Polecenie Set-AzIntegrationAccountGeneratedIcn aktualizuje numer istniejącej kontrolki wymiany wygenerowanego konta integracji (ICN) i zwraca obiekt reprezentujący numer kontrolki wygenerowanej na koncie integracji.
To polecenie cmdlet pozwala zaktualizować numer kontrolki wymiany wygenerowany na koncie integracji.
Możesz zaktualizować numer kontroli wymiany wygenerowanego dla konta integracji, określając nazwę konta integracji, nazwę grupy zasobów i nazwę umowy.
Za pomocą tego polecenia nie można utworzyć nowego konta integracji wygenerowanego numeru kontroli wymiany.
...
To polecenie pobiera numer kontrolki wymiany X12 wygenerowanego na koncie integracji dla konkretnej umowy konta integracji, zwiększa wartość o 100, a następnie zapisuje zaktualizowaną wartość.
...
To polecenie pobiera numer kontroli wymiany EdifactIntegrationAccountAgreement dla konkretnego konta integracji, zwiększa jego wartość o 100, a następnie zapisuje zaktualizowaną wartość.
...
### -ControlNumber
Wygenerowana kontrolka numeruje nową wartość.
