...
## SYNOPSIS
Tworzy certyfikat konta integracji.
...
## OPIS
Polecenie **cmdlet New-AzIntegrationAccountCertificate** tworzy certyfikat konta integracji.
To polecenie cmdlet zwraca obiekt reprezentujący certyfikat konta integracji.
Określ nazwę konta integracji, nazwę grupy zasobów, nazwę certyfikatu, nazwę klucza, wersję klucza i identyfikator magazynu klucza.
...
### Przykład 1. Tworzenie certyfikatu konta integracji
```
...
To polecenie tworzy certyfikat konta integracji w określonej grupie zasobów.
...
### -KeyVaultId
Określa identyfikator magazynu klucza.
