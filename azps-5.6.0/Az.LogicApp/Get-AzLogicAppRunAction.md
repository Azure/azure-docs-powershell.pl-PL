...
Pobiera akcję z uruchomienia aplikacji logiki.
...
Polecenie **cmdlet Get-AzLogicAppRunAction** pobiera akcję z uruchomienia aplikacji logiki.
To polecenie cmdlet zwraca obiekty **WorkflowRunAction.**
Określanie aplikacji logiki, grupy zasobów i uruchamianie.
...
### Przykład 1. Uzyskiwanie akcji z uruchomienia aplikacji logiki
...
To polecenie pobiera określoną akcję aplikacji logiki z aplikacji logiki o nazwie LogicApp05 dla uruchomienia z identyfikatorem 08585925184423369718380498702CU26.

### Przykład 2. Uzyskiwanie wszystkich akcji z uruchomienia aplikacji logiki
...
To polecenie pobiera wszystkie akcje aplikacji logiki z uruchomienia z identyfikatorem 08585925184423369718380498702CU26 aplikacji logiki o nazwie LogicApp05.

## PARAMETERS

### -ActionName

Określa nazwę akcji w uruchomieniu aplikacji logiki.
To polecenie cmdlet pobiera akcję określaną przez ten parametr.
...
Określa nazwę aplikacji logiki, dla której to polecenie cmdlet uzyskuje akcję.
...
Określa nazwę grupy zasobów, w której to polecenie cmdlet pobiera akcję.
...
To polecenie cmdlet pobiera akcję dla uruchomienia, które określa ten parametr.
