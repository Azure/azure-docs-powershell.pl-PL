...
Jeśli nadal dostępnych jest więcej tematów dotyczących domeny, wartość w programie NextLink powinna być używana w następnym wywołaniu w celu uzyskania następnej strony tematów dotyczących domen.
