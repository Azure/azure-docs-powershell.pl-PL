...
### Przykład 1. Usuwanie konfiguracji eksportu ciągłego w zasobie analizy aplikacji
```
PS C:\> Remove-AzApplicationInsightsContinuousExport -ResourceGroupName "testgroup" -Name "test" -ExportId "uGOoki0jQsyEs3IdQ83Q4QsNr4=" -PassThru
True
```

Usuń konfigurację ciągłego eksportu aplikacji Insights z identyfikatorem eksportu "uGOoki0jQsyEs3IdQ83Q4QsNr4=" dla zasobu o nazwie "test" w grupie zasobów "grupa testowa"
