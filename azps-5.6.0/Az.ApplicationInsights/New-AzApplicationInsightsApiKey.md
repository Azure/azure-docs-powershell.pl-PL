...
Utwórz opis klucza interfejsu API insights aplikacji jako "testapiKey" z uprawnieniami "ReadTelemetry", "WriteAnnotations" dla zasobu "test" w grupie zasobów "testGroup".
