...
### Przykład 1. Usunięcie klucza interfejsu API Insights aplikacji dla zasobu szczegółowych informacji aplikacji
```
...
Usuń określony klucz interfejsu API insights aplikacji, który ma identyfikator "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" dla zasobu "test" w grupie zasobów "testGroup".
...
### -PassThru
Jeśli zostanie określona, w przypadku gdy operacja zakończy się powodzeniem. Ten parametr jest opcjonalny. Wartość domyślna to fałsz.
