...
### Przykład 1. Lista wszystkich kluczy funkcji BitLocker w określonym zadaniu ImportExport
```powershell
...
To polecenie cmdlet wyświetla listę wszystkich kluczy funkcji BitLocker w określonym zadaniu ImportExport.
...
### Microsoft.Azure.PowerShell.cmdlet.ImportExport.Models.Api20161101.IDriveBitLockerKey
