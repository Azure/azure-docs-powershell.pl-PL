...
### Przykład 1. Tworzenie nowego zadania Lista dysków dla zadania ImportExport
```powershell
...
Te polecenia cmdlet tworzą nowe zadanie Lista dysków dla zadania ImportExport.

## PARAMETERS

### -BitLockerKey
Klawisz BitLocker używany do szyfrowania dysku.
...
### -BytesSucceed
Bajty zostały pomyślnie przeniesione dla dysku.
...
To pole nie jest zwracane w odpowiedzi, dopóki dysk nie znajduje się w stanie Przenoszenia.
...
### -ManifestHash
Skrót MD5 zakodowany w bazie danych Base16 pliku manifestu na dysku.
...
### Microsoft.Azure.PowerShell.cmdlet.ImportExport.Models.Api20161101.IDriveStatus
