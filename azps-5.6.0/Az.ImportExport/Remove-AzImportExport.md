...
### Przykład 1. Usuwanie zadania ImportExport według nazwy serwera i grupy zasobów
```powershell
PS C:\> Remove-AzImportExport -Name test-job -ResourceGroupName ImportTestRG
```

To polecenie cmdlet usuwa zadanie ImportExport według nazwy serwera i grupy zasobów.
...
To polecenie cmdlet usuwa zadanie ImportExport według tożsamości.
