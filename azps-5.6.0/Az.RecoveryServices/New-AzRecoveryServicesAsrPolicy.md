...
### -HyperVToAzure
Parametr przełącznika w celu określenia zasad ma być używany do replikowania maszyn wirtualnych hyper-V do platformy Azure
...
Parametr przełącznika określający zasady ma być używany do replikowania między witrynami hyper-V zarządzanymi przez serwer maszyny wirtualnej.
