...
## OPIS
Polecenie **cmdlet Disable-AzRecoveryServicesBackupProtection** wyłącza ochronę elementu chronionego za pomocą kopii zapasowej platformy Azure.
To polecenie cmdlet zatrzymuje regularną zaplanowaną kopię zapasową elementu.
To polecenie cmdlet może również usunąć istniejące punkty odzyskiwania elementu kopii zapasowej, jeśli jest wykonywane za pomocą parametru RemoveRecoveryPoints.
...
Ostatnie polecenie wyłącza ochronę kopii zapasowej elementu w $PI \[ 0, ale \] zachowuje dane.

### Przykład 2

Wyłącza ochronę elementu chronionego kopią zapasową. (wygenerowane automatycznie)
