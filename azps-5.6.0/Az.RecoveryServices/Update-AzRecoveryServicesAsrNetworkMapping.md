...
Uruchamia operację mapowania sieci aktualizacji przy użyciu określonych parametrów i zwraca zadanie funkcji ASR służące do śledzenia operacji.
...
### -InputObject
Obiekt wejściowy: określa obiekt mapowania sieci ASR odpowiadający zaktualizowanej funkcji mapowania sieci asr.
