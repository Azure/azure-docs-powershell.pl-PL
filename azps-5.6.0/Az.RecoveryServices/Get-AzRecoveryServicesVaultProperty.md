...
## OPIS
Polecenie **cmdlet Get-AzRecoveryServicesVaultProperty** zwraca właściwości magazynu usług odzyskiwania.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie właściwości magazynu
```
...
Drugie polecenie pobiera właściwości magazynu. Następnie uzyskujemy dostęp do właściwości szyfrowania magazynu.
