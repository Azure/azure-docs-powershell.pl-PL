...
### — Ścieżka
Lokalizacja, w której plik powinien zostać pobrany w przypadku odzyskiwania pliku. Jeśli nie podano nazwy Ścieżka, plik skryptu zostanie pobrany w bieżącym katalogu.
