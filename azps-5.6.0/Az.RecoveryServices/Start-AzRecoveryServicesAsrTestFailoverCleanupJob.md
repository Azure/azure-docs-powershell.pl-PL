...
## OPIS
Polecenie cmdlet **Start-AzRecoveryServicesAsrTestFailoverCleanupJob** uruchamia testową operację oczyszczania trybu failover dla elementu chronionego replikacją lub planu odzyskiwania, na którym wykonano test trybu failover.

## PRZYKŁADY

### Przykład 1

Zadanie śledzenia testowania oczyszczania w trybie failover planu odzyskiwania witryn platformy Azure.
...
Rozpoczyna test operacji oczyszczania trybu failover. (wygenerowane automatycznie)
...
### — Komentarz
Komentarz użytkownika testowego trybu failover.
...
### -RecoveryPlan
Plan odzyskiwania na wykonanie testowego oczyszczania trybu failover.
...
Element chroniony replikacją w celu wykonania testowego oczyszczania trybu failover.
...
### -ResourceId
Identyfikator zasobu elementu chronionego replikacją/planu odzyskiwania na celu oczyszczanie testów trybu failover.
