...
Możesz przywrócić cały udział plików lub określone/wiele plików/folderów w danym udostępniniu. Możesz przywrócić pierwotną lokalizację lub lokalizację alternatywną.
...
Czwarte polecenie pobiera bieżącą datę, a następnie zapisuje je w $EndDate zmienną.
...
### Przykład 6. Przywracanie bazy danych SQL w usłudze Azure VM do innej docelowej maszyny wirtualnej w celu pełnego punktu odzyskiwania
...
Użyj tego przełącznika, aby wyzwolić przywracanie regionu krzyżowego do regionu pomocniczego.
