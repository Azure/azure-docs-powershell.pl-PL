...
Drugie polecenie cmdlet pobiera odpowiednią pozycję SQLInstance, która jest elementem, który można chronić. Trzecie polecenie konfiguruje automatyczną ochronę dla tego wystąpienia przy użyciu zasad w programie $Pol.
