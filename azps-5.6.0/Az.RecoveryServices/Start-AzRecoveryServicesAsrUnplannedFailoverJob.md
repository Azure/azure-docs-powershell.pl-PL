...
## OPIS
Polecenie cmdlet **Start-AzRecoveryServicesAsrUnplannedFailoverJob** uruchamia niezaplanowane trybu failover elementu chronionego replikacją lub planu odzyskiwania witryny azure.
Możesz sprawdzić, czy zadanie zakończyło się pomyślnie za pomocą Get-AzRecoveryServicesAsrJob cmdlet.
...
Rozpoczyna niezaplanowaną operację trybu failover planu odzyskiwania z określonymi parametrami i zwraca zadanie asr służące do śledzenia operacji.

### Przykład 2

Rozpoczyna niezaplanowaną operację trybu failover. (wygenerowane automatycznie)
...
Przed rozpoczęciem niezaplanowanego trybu failover należy wykonać operację po stronie źródłowej.
...
### - RecoveryPoint
Określa niestandardowy punkt odzyskiwania dla trybu failover chronionego komputera.
...
### -RecoveryTag
Określa tag odzyskiwania do trybu failover.
...
Określa element chroniony replikacją odzyskiwania witryn platformy Azure.
