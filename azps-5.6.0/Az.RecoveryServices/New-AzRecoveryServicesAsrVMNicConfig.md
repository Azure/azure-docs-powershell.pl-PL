...
Tworzy obiekt ASRVmNicConfig z testowymi ustawieniami sieci skonfigurowanymi dla zmiany nazwy przez nic. Każda właściwość, która nie jest przekazywana powyżej, jest pobierana z przekazywanego elementu chronionego.


### Przykład 3

Tworzy konfigurację ASR NIC zawierającą szczegóły konfiguracji związanej z trybu failover i testowanie. (wygenerowane automatycznie)
...
Określa identyfikator publicznego adresu IP skojarzonego z kartą NIC odzyskiwania.
...
### -TfoNicName
Określa nazwę testowej nic trybu failover.
