...
Określa nazwę magazynu, dla których ma być kwerenda.
...
Określa nazwę grupy zasobów platformy Azure, z której ma zostać pobrany określony obiekt Usług odzyskiwania.
...
Określa tagi, dla których ma być kwerenda
...
Określa klucz tagu do zapytania dla
...
Określa wartość tagu dla zapytania
...
## NOTATKI
Get-AzRecoveryServicesVault w starej wersji usługi Az.RecoveryServices(<=2.10.0) nie może pracować z az.accounts(>=1.8.1) z powodu nieprawidłowego odwołania do zestawu. Moduł Az.RecoveryServices wymaga uaktualnienia do wersji 2.11.0 lub nowszej, jeśli używasz najnowszej wersji az lub az.accounts.
