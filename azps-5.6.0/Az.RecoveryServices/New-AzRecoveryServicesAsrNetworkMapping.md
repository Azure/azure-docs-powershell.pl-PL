...
Uruchamia mapowanie sieci na operację tworzenia przy użyciu określonej nazwy, sieci podstawowych i sieci odzyskiwania, a następnie zwraca zadanie asr do śledzenia operacji (scenariusz z platformy Azure do platformy Azure).
...
### -RecoveryFabric
Obiekt szkieletowy odzyskiwania witryny platformy Azure odpowiadający regionowi odzyskiwania platformy Azure.
