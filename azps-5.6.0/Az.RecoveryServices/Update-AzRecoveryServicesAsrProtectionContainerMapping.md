...
### AzureToAzureEnableAutoUpdate (domyślne)
```
...
## OPIS
Polecenie **cmdlet Update-AzRecoveryServicesAsrProtectionContainerMapping** aktualizuje wskazane mapowanie kontenera ochrony usługi Azure Site Recovery.
...
Uruchom operację, aby wyłączyć automatyczną aktualizację dla kontenera.
...
Aby wyłączyć automatyczne aktualizowanie kontenera, rozpocznij operację.

## PARAMETERS

### -AutomationAccountId
Określa wartość automatyzacji accountId używaną do automatycznego udpatowania.
...
### -AzureToAzure
Określa kontener platformy Azure do usługi Azure Protection.
...
### -DisableAutoUpdate
Przełącz parametr, aby wyłączyć automatyczną aktualizację.
...
### -EnableAutoUpdate
Przełącz parametr, aby włączyć automatyczną aktualizację.
...
### -InputObject
Obiekt do mapowania kontenerów ochrony.
