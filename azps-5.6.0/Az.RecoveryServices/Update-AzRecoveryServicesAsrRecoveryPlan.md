...
### -InputObject
Obiekt input do polecenia cmdlet: Określa obiekt planu odzyskiwania asr, którego zawartość służy do aktualizowania planu odzyskiwania, do którego ten obiekt się odnosi.
