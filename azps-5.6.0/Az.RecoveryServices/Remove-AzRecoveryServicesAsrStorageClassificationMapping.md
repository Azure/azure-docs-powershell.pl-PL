...
## OPIS
Polecenie **cmdlet Remove-AzRecoveryServicesAsrStorageClassificationMapping** usuwa wskazane mapowanie klasyfikacji magazynu odzyskiwania witryny platformy Azure.
...
Rozpoczyna usuwanie mapowania określonej klasyfikacji magazynu i zwraca zadanie asr służące do śledzenia operacji.
...
### -InputObject
Obiekt wejściowy do polecenia cmdlet: Obiekt mapowania klasyfikacji magazynu asr odpowiadający mapowaniu klasyfikacji magazynu asr do usunięcia.
