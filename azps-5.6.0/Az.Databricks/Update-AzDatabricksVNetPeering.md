...
### Przykład 1. Aktualizowanie allowForwardedTraffic komunikacji równorzędnej vnet
```powershell
...
To polecenie aktualizuje polecenie AllowForwardedTraffic komunikacji równorzędnej w sieci vnet.

### Przykład 2. Aktualizowanie właściwości AllowForwardedTraffic komunikacji równorzędnej w sieci vnet według obiektu
```powershell
...
To polecenie aktualizuje obiekt allowForwardedTraffic komunikacji równorzędnej sieci vnet.

## PARAMETERS

### -AllowForwardedTraffic
[System.Management.Automation.SwitchParameters] Czy ruch przesyłany dalej z maszyn wirtualnych w lokalnej sieci wirtualnej będzie dozwolony/zabronione w zdalnej sieci wirtualnej.
...
### -AllowGatewayTransit
[System.Management.Automation.SwitchParameters] Jeśli łącza bramy mogą być używane w zdalnej sieci wirtualnej do łączenia się z tą siecią wirtualną.
...
[System.Management.Automation.SwitchParameters] Czy maszyny wirtualne w lokalnym wirtualnym przestrzeni sieciowym będą mogły uzyskać dostęp do maszyn wirtualnych w zdalnym wirtualnym miejscu sieciowym.
...
### — UseRemoteGateway
[System.Management.Automation.SwitchParameters] Jeśli w tej sieci wirtualnej można używać bram zdalnych.
