...
## SYNOPSIS
Pobiera komunikacji równorzędnej vNet obszaru roboczego.
...
### Przykład 1. Lista wszystkich komunikacji równorzędnej w sieci VNET w obszarze sesji danych
```powershell
...
To polecenie zawiera listę wszystkich komunikacji równorzędnej w sieci VNET w obszarze danych.

### Przykład 2. Uzyskiwanie komunikacji równorzędnej w sieci VNET
```powershell
...
To polecenie pobiera komunikacji równorzędnej w sieci VNET.

### Przykład 3. Uzyskiwanie komunikacji równorzędnej przez obiekt w sieci VNET
```powershell
...
To polecenie pobiera obiekt w komunikacji równorzędnej sieci vnet.
