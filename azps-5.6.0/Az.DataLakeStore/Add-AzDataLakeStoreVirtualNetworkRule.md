...
## OPIS
Polecenie **cmdlet Add-AzDataLakeStoreVirtualNetworkRule** dodaje regułę sieci wirtualnej do określonego konta usługi Data Lake Store.
...
Powoduje to utworzenie nowej reguły sieci wirtualnej o nazwie "myVNET" w "dls" konta z identyfikatorem podsieci "testId"

## PARAMETERS

### — Konto
Konto usługi Data Lake Store w celu dodania reguły sieci wirtualnej do
