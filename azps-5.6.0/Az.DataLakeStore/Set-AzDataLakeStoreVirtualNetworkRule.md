...
## OPIS
Polecenie **cmdlet Set-AzDataLakeStoreVirtualNetworkRule** modyfikuje określoną regułę sieci wirtualnej w określonym magazynie Data Lake Store.
...
Aktualizacja identyfikatora podsieci wirtualnej reguły sieci wirtualnej "myVNET" w "dls" konta na "updatedId"

## PARAMETERS

### — Konto
Konto usługi Data Lake Store w celu zaktualizowania reguły sieci wirtualnej w
...
### -SubnetId
Początek prawidłowego zakresu adresów IP reguły sieci wirtualnej
