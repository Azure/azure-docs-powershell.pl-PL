...
## OPIS
**Get-AzDataLakeStoreChildItemSummary** pobiera podsumowanie zawartości dla danej ścieżki. Rekurencyjnie oblicza całkowitą liczbę plików, katalogów i całkowity rozmiar wszystkich plików w danej ścieżce.
