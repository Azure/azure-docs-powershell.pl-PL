...
## OPIS
Polecenie **cmdlet Get-AzDataLakeStoreItemPermission** pobiera ósemkową ósemkę uprawnień pliku lub folderu w magazynie Data Lake Store.

## PRZYKŁADY

### Przykład 1. Ustawianie ósemkowej uprawnień dla pliku
```
PS C:\>Get-AzDataLakeStoreItemPermission -AccountName "ContosoADL" -Path "/file.txt"
```

To polecenie pobiera ósemkową ósemkową uprawnienie do pliku.
