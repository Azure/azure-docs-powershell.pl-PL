...
### Przykład 1. Aktualizowanie usługi AzADDomainService według nazwy i nazwy grupy zasobów
```powershell
...
Aktualizowanie usługi AzADDomainService według nazwy i nazwy grupy zasobów

### Przykład 2. Aktualizowanie usługi AzADDomainService przez inputobject
```powershell
...
Aktualizowanie usługi AzADDomainService przez Inputobject
