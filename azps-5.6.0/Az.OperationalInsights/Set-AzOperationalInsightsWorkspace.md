...
To polecenie używa polecenia cmdlet Get-AzOperationalInsightsWorkspace w celu uzyskania obszaru roboczego o nazwie MyWorkSpace, Get-AzOperationalInsightsWorkspace następnie przekazuje je do polecenia cmdlet **Set-AzOperationalInsightsWorkspace** przy użyciu operatora potoku w celu ustawienia wersji Premium tej wersji.
