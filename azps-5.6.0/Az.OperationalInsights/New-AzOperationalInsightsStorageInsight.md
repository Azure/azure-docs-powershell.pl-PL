...
### Przykład 1. Tworzenie szczegółowych informacji o magazynie według nazwy
```
...
Drugie polecenie używa Get-AzStorageAccount cmdlet w celu uzyskania określonego konta magazynu, a następnie zapisuje je w $Storage danych.
...
### — Containers
Określa listę kontenerów, które zawierają dane.
