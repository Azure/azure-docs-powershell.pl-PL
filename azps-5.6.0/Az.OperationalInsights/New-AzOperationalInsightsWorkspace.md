...
Pierwsze polecenie używa polecenia cmdlet Get-AzOperationalInsightsLinkTargets do uzyskania celów docelowych linku konta do szczegółowych informacji operacyjnych, a następnie przechowuje je w $OILinkTargets danych.
Drugie polecenie przekazuje pierwszy element docelowy linku do konta w programie $OILinkTargets do polecenia cmdlet **New-AzOperationalInsightsWorkspace** przy użyciu operatora potoku.
...
### - SKU
Określa warstwę usługi obszaru roboczego. Aby uzyskać więcej informacji dotyczących wartości, której należy użyć, https://docs.microsoft.com/azure/azure-monitor/platform/manage-cost-storage#legacy-pricing-tiers sprawdź.
