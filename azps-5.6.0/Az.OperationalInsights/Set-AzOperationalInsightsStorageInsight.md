...
## OPIS
Polecenie **cmdlet Set-AzOperationalInsightsStorageInsight** zmienia konfigurację szczegółowych informacji o magazynie.

## PRZYKŁADY

### Przykład 1. Modyfikowanie informacji o magazynie według nazwy
```
...
To polecenie modyfikuje tabele, z których odczytuje szczegółowe informacje o magazynie o nazwie MyStorageInsight.

### Przykład 2. Modyfikowanie szczegółowych informacji o magazynie przy użyciu obiektu obszaru roboczego
```
...
Drugie polecenie modyfikuje kontenery, z których odczytuje szczegółowe informacje o magazynie o nazwie MyStorageInsight.
