...
---
# Moduł Az.OperationalInsights
## Opis
Ten temat zawiera tematy pomocy dotyczące polecenia cmdlet Azure Operational Insights.
...
Zatrzymuje zbieranie dzienników usług IIS z komputerów.
...
Zatrzymuje zbieranie danych syslogu z komputerów z systemem Linux.

### [Enable-AzOperationalInsightsIISLogCollection](Enable-AzOperationalInsightsIISLogCollection.md)
Uruchamia zbieranie dzienników usług IIS z komputerów w obszarze roboczym.
...
Uzyskiwanie lub lista połączonych usług dla obszaru roboczego programu Groove

### [Get-AzOperationalInsightsLinkedStorageAccount](Get-AzOperationalInsightsLinkedStorageAccount.md)
Uzyskiwanie połączonego konta magazynu lub lista kont magazynu połączonego
...
Pobiera informacje o szczegółowych informacjach o przestrzeni dyskowej.
...
Zbierz dziennik aktywności platformy Azure z danej subskrypcji.
...
Tworzenie połączonego konta magazynu dla obszaru roboczego
...
Tworzy nowe zapisane wyszukiwanie z określonymi parametrami.
...
Dzienniki zdarzeń są zbierane z komputerów z systemem operacyjnym Windows.
...
Dodaje źródło danych licznika wydajności systemu Windows dla połączonych komputerów z systemem operacyjnym Windows.
...
Włącza lub wyłącza określony pakiet analiz.
...
Ustawianie połączonego konta magazynu dla obszaru roboczego
...
Aktualizuje szczegółowe informacje o przestrzeni dyskowej.
