...
### ByWorkspaceNameByKind (Domyślne)
```
...
Możesz określić źródło danych do uzyskania.
Wyniki można filtrować według rodzaju źródła danych.
...
### — Rodzaj
Określa rodzaj źródeł danych do uzyskania.
...
### — Nazwa
Określa nazwę źródła danych do uzyskania.
...
### -ResourceGroupName
Określa nazwę grupy zasobów zawierającej źródła danych do uzyskania.
