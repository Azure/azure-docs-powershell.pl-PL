...
## OPIS
Remove-AzCdnOrigin źródła sieci CDN z danego punktu końcowego. Jeśli pochodzenie jest jedynym pochodzeniem w określonym punkcie końcowym, usunięcie nie powiedzie się, ponieważ jest wymagane co najmniej 1 pochodzenie. 
