...
## OPIS
Polecenie **cmdlet New-AzCdnProfile** tworzy profil usługi Azure Content Delivery Network (CDN).

## PRZYKŁADY

### Przykład 1

Tworzy profil sieci CDN. (wygenerowane automatycznie)
...
### — Tag
Tagi, które należy skojarzyć z profilem azure CDN.
