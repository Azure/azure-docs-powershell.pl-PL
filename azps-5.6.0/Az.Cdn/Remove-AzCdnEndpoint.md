...
## OPIS
Polecenie **cmdlet Remove-AzCdnEndpoint** usuwa punkt końcowy usługi Azure Content Delivery Network (CDN).
...
### -CdnEndpoint
Określa punkt końcowy usuwany przez to polecenie cmdlet.
...
### -EndpointName
Określa nazwę punktu końcowego, który usuwa to polecenie cmdlet.
