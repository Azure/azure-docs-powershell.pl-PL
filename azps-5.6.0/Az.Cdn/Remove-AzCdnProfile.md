...
## OPIS
Polecenie **cmdlet Remove-AzCdnProfile** usuwa profil usługi Azure Content Delivery Network (CDN).
...
### -CdnProfile
Określa profil, który usuwa to polecenie cmdlet.
...
### -ProfileName
Określa nazwę profilu, który usuwa to polecenie cmdlet.
