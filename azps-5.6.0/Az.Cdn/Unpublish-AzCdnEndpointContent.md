...
## OPIS
Polecenie **cmdlet Unpublish-AzCdnEndpointContent** czyści zawartość z punktu końcowego usługi Azure Content Delivery Network (CDN).
...
### -CdnEndpoint
Określa punkt końcowy, który będzie czyszczony przez to polecenie cmdlet.
...
### -EndpointName
Określa nazwę punktu końcowego, który czyści to polecenie cmdlet.
...
### - PurgeContent
Określa tablicę ścieżek względnych dla zawartości na serwerze pochodzenia, która jest czyszczona przez to polecenie cmdlet.
