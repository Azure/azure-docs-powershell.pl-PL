...
## OPIS
Polecenie cmdlet **Publish-AzCdnEndpointContent** ładuje zawartość z serwera pochodzenia dla punktu końcowego usługi Azure Content Delivery Network (CDN).
...
### - LoadContent
Określa tablicę ścieżek względnych dla zawartości na serwerze pochodzenia publikowanym przez to polecenie cmdlet.
