...
## OPIS
Polecenie **cmdlet Set-AzCdnOrigin** aktualizuje serwer pochodzenia usługi Azure Content Delivery Network (CDN).
...
### -CdnOrigin
Określa serwer pochodzenia, który ma być aktualizowany przez to polecenie cmdlet.
