...
To polecenie tworzy grupę kontenerów przy użyciu najnowszego obrazu nginx i żąda publicznego adresu IP z otwarciem portu 8000.
...
### Przykład 4. Tworzenie grupy kontenerów przy użyciu obrazu w rejestrze kontenerów platformy Azure
```
...
To polecenie tworzy grupę kontenerów, w ramach których jest chowyszyny podany udział plików platformy `/mnt/azfile` Azure.
