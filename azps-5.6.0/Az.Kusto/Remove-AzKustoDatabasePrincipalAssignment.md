...
### Przykład 1. Usuwanie istniejącej bazy danych Kusto PrincipalAssignment według nazwy
```powershell
...
Powyższe polecenie usuwa przypisanie główne o nazwie "kustoprincipal1" w bazie danych Kusto "mykustodatabase".
