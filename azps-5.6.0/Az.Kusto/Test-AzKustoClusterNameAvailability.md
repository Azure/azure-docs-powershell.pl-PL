...
### Przykład 1. Sprawdzanie dostępności nazwa klastra Kusto, która jest w użyciu
```powershell
...
Powyższe polecenie zwraca, czy w regionie "Wschód US" istnieje klaster Kusto o nazwie "testnewkustocluster".

### Przykład 2. Sprawdzanie dostępności nazwy klastra Kusto, która nie jest w użyciu
```powershell
...
Powyższe polecenie zwraca, czy w regionie "Wschód US" istnieje klaster Kusto o nazwie "availablekustocluster".
...
### — Wpisz
Typ zasobu, Microsoft.Kusto/clusters.
