...
### Przykład 1. Sprawdzanie dostępności nazwy podmiotu zabezpieczeń klastrów, która jest w użyciu
```powershell
...
Powyższe polecenie zwraca, czy w klastrze "testnewkustocluster" istnieje funkcja PrincipalAssignment o nazwie "myprincipal".

### Przykład 2. Sprawdzanie dostępności nazwy podmiotu zabezpieczeń klastrów, która nie jest w użyciu
```powershell
...
Powyższe polecenie zwraca, czy w klastrze "testnewkustocluster" istnieje funkcja PrincipalAssignment o nazwie "newprincipal".
...
### — Nazwa
Nazwa zasobu przydziału głównego.
...
### — Wpisz
Typ zasobu, Microsoft.Kusto/Clusters/principalAssignments.
...
### Microsoft.Azure.PowerShell.cmdlet.kusto.models.api20200918.iCheckNameResult
