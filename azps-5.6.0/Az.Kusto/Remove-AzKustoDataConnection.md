...
### Przykład 1. Usuwanie istniejącego połączenia danych według nazwy
```powershell
...
Powyższe polecenie usuwa połączenie danych o nazwie "mykustodataconnection" w bazie danych "mykustodatabase" istniejącego klastra "testnewkustocluster" znalezione w grupie zasobów "testrg"
