...
### Przykład 1. Usuwanie listy rozszerzeń językowych z klastrów
```powershell
PS C:\> Remove-AzKustoClusterLanguageExtension -ResourceGroupName testrg -ClusterName testnewkustocluster -Value (@{Name="R"})
```

Powyższe polecenie usuwa listę rozszerzeń językowych, które można uruchamiać w zapytaniach KQL.
...
VALUE <ILanguageExtension[]>: Lista rozszerzeń językowych.
