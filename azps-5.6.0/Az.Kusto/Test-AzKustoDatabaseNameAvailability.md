...
Powyższe polecenie zwraca, czy baza danych Kusto o nazwie "mykustodatabase" istnieje w klastrze "testnewkustocluster".

### Przykład 2. Sprawdzanie dostępności nazwy bazy danych Kusto, która nie jest w użyciu
```powershell
...
Powyższe polecenie zwraca, czy baza danych Kusto o nazwie "mykustodatabase2" istnieje w klastrze "testnewkustocluster".
...
### — Wpisz
Typ zasobu, na przykład Microsoft.Kusto/Clusters/databases.
