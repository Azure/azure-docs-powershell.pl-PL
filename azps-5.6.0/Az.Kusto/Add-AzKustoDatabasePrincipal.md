...
### Przykład 1. Dodawanie uprawnień głównych użytkowników bazy danych
```powershell
...
Powyższe polecenie dodaje uprawnienia głównych użytkowników bazy danych
...
VALUE <IDatabasePrincipal[]>: Lista głównych podmiotów bazy danych Kusto.
