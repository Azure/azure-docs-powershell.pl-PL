...
### Przykład 1. Odłączanie bazy danych obserwowanych
```powershell
...
Powyższe polecenie odłącza bazę danych obserwowaną zdefiniowaną w określonej przez attachedDatabaseConfiguration "myfo followwerconfiguration" od cluster "testnewkustoclusterf".
...
Nazwa zasobu dołączonej konfiguracji bazy danych w klastrze śledzącym.
...
### -ClusterResourceId
Identyfikator zasobu klastra, który jest następujący po bazie danych należącej do tego klastra.
