...
## OPIS
Polecenie Get-AzPowerBIEmbeddedCapacity cmdlet pobiera szczegółowe informacje dotyczące osadzonej pojemności usługi PowerBI.

## PRZYKŁADY

### Przykład 1. Wykorzystanie zasobów w grupie zasobów
```
...
To polecenie pobiera całą osadzoną wydajność usługi Azure PowerBI w grupie zasobów o nazwie testRG

### Przykład 2. Uzyskiwanie pojemności
```
...
To polecenie pobiera osadzoną wydajność usługi Azure PowerBI o nazwie testcapacity w grupie zasobów o nazwie testRG.
