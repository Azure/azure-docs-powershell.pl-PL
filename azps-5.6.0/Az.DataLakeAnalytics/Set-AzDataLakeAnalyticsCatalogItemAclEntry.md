...
## OPIS
Polecenie cmdlet **Set-AzDataLakeAnalyticsCatalogItemAclEntry** dodaje lub modyfikuje wpis (ACE) na liście kontroli dostępu (ACL, Access Control List) wykazu lub elementu wykazu w uściślaniu danych Lake Analytics.
...
To polecenie modyfikuje wykaz ace, aby inne miał uprawnienia do odczytu.
...
To polecenie ustawia uprawnienia właściciela dla konta na odczyt.
