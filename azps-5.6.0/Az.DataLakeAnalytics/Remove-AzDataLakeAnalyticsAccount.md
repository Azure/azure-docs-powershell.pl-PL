...
## OPIS
Polecenie **cmdlet Remove-AzDataLakeAnalyticsAccount** trwale usuwa konto usługi Azure Data Lake Analytics.

## PRZYKŁADY

### Przykład 1. Usuwanie konta
```
PS C:\>Remove-AzDataLakeAnalyticsAccount -Name "ContosoAdlAccount"
```

To polecenie usuwa określone konto Data Lake Analytics.
