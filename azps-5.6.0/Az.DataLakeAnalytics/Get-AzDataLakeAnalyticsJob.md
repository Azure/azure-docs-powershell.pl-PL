...
### — Uwzględnij
Określa opcje wskazujące typ dodatkowych informacji o zadaniu, które mają zostać pobrane.
...
### -PipelineId
Powinien zostać zwrócony identyfikator opcjonalny, który wskazuje, że mają być zwracane tylko zadania w ramach określonego potoku.
