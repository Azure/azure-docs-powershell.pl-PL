...
## OPIS
Polecenie cmdlet **Wait-AzDataLakeAnalyticsJob** czeka na ukończenie zadania usługi Azure Data Lake Analytics.
...
Poniższe polecenie czeka na ukończenie zadania z określonym identyfikatorem.
...
### - JobId
Określa identyfikator zadania, dla którego ma być oczekiwana.
...
### -TimeoutInSeconds
Określa liczbę sekund oczekiwania przed zamknięciem operacji oczekiwania.
...
Określ liczbę sekund, które upłyną między każdym sprawdzeniem stanu zadania.
