...
## OPIS
Polecenie **cmdlet Get-AzDataLakeAnalyticsCatalogItemAclEntry** pobiera listę pozycji ( ACEs) na liście kontroli dostępu (ACL, Access Control List) wykazu lub elementu wykazu w narzędziu Data Lake Analytics.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie listy ACL dla wykazu
```powershell
...
To polecenie pobiera wartość ACL dla wykazu określonego konta Data Lake Analytics

### Przykład 2. Uzyskiwanie wpisu listy ACL właściciela katalogu
```powershell
...
To polecenie pobiera wpis ACL właściciela użytkownika w wykazie określonego konta Data Lake Analytics

### Przykład 3. Uzyskiwanie wpisu ACL właściciela grupy dla wykazu
```powershell
...
To polecenie pobiera wpis ACL właściciela grupy dla katalogu określonego konta Data Lake Analytics

### Przykład 4. Uzyskiwanie listy ACL dla bazy danych
```powershell
...
To polecenie pobiera wartość ACL dla bazy danych określonego konta Data Lake Analytics

### Przykład 5. Uzyskiwanie wpisu ACL właściciela bazy danych
```powershell
...
To polecenie pobiera wpis ACL właściciela użytkownika dla bazy danych określonego konta Data Lake Analytics

### Przykład 6. Uzyskiwanie wpisu ACL właściciela grupy bazy danych
```powershell
...
To polecenie pobiera wpis ACL właściciela grupy dla bazy danych określonego konta Data Lake Analytics
...
### -GroupOwner
Uzyskiwanie wpisu listy ACL wykazu dla właściciela grupy
...
### -UserOwner
Uzyskaj wpis listy ACL wykazu dla właściciela użytkownika.
