...
## OPIS
Polecenie **cmdlet Add-AzDataLakeAnalyticsFirewallRule** dodaje regułę zapory do konta usługi Azure Data Lake Analytics.
...
To polecenie dodaje regułę zapory o nazwie "reguła mojej zapory" z konta "ContosoAdlAcct" z zakresem adresów IP: 127.0.0.1 – 127.0.0.10

## PARAMETERS

### — Konto
Konto Data Lake Analytics, aby dodać regułę zapory do
