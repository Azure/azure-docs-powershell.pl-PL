...
## SYNOPSIS
Usuwa wpis z listy ACL wykazu lub elementu wykazu w uścisce Data Lake Analytics.

## SKŁADNIA

### RemoveCatalogAclEntryForUser (Domyślne)
```
...
## OPIS
Polecenie cmdlet **Remove-AzDataLakeAnalyticsCatalogItemAclEntry** usuwa wpis (ACE) z listy kontroli dostępu (ACL, Access Control List) wykazu lub elementu wykazu w narzędziu Data Lake Analytics.

## PRZYKŁADY

### Przykład 1. Usuwanie listy ACL użytkownika dla wykazu
```powershell
...
To polecenie usuwa listę ACL wykazu dla Patti Fuller z konta contosoadla.

### Przykład 2. Usuwanie listy ACL użytkownika bazy danych
```powershell
...
To polecenie usuwa listę ACL bazy danych dla PattiEgo Fullera z konta contosoadla.
...
### — Grupowanie
Usuwanie wpisu listy ACL wykazu grupy.
...
### -ObjectId
Tożsamość użytkownika do usunięcia.
...
### — Użytkownik
Usuwanie wpisu listy ACL wykazu dla użytkownika.
