...
## OPIS
Polecenie **cmdlet Add-AzDataLakeAnalyticsDataSource** dodaje źródło danych do konta usługi Azure Data Lake Analytics.
...
To polecenie powoduje dodanie źródła danych Data Lake Store do konta usługi Data Lake Analytics.

### Przykład 2

Dodaje źródło danych do konta usługi Data Lake Analytics. (wygenerowane automatycznie)
...
### -AccessKey
Określa klucz dostępu konta magazynu obiektów blob platformy Azure do dodania.
...
### — obiekt blob
Określa nazwę konta magazynu obiektów blob platformy Azure do dodania.
...
### -DataLakeStore
Określa nazwę konta usługi Azure Data Lake Store do dodania.
