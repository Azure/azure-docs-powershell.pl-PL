...
## OPIS
Polecenie **cmdlet Remove-AzDataLakeAnalyticsDataSource** usuwa źródło danych z konta usługi Azure Data Lake Analytics.
...
### — obiekt blob
Określa nazwę konta magazynu usługi AzureBlob do usunięcia.
...
### -DataLakeStore
Określa nazwę konta azureData Lake Store do usunięcia.
