...
W tym przykładzie na podstawie szablonu zaawansowanego wykrywania ataków wielosetapowych jest tworzenie alertu typu **Rule,** a następnie jest on przechowywał w zmiennej $AlertRule danych. 
