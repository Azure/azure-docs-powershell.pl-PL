...
## OPIS
Polecenie **cmdlet Update-AzSentinelDataConnector** aktualizuje łącznik danych w określonym obszarze roboczym.
Obiekt **DataConnector** można przekazać jako parametr lub za pomocą operatora potoku albo też określić wymagane parametry.
...
Polecenie pobiera łącznik danych według *danychConnectorId* i ustawia stan *Alerty* na *Wyłączone.*  Wszystkie pozostałe właściwości pozostają takie same.
