...
### Przykład 1. Usuwanie organizacji, która się ujmuje, według nazwy
```powershell
PS C:\> Remove-AzConfluentOrganization -ResourceGroupName azure-rg-test -Name confluentorg-01-portal

```

To polecenie usuwa organizację, która się ułozyła, według nazwy

### Przykład 2. Usuwanie organizacji sypkiej według potoku
```powershell
...
To polecenie usuwa organizację, która się ujmuje, według potoku.
