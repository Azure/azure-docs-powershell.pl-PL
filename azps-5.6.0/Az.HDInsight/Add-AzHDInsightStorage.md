...
## OPIS
Polecenie **cmdlet Add-AzHDInsightStorage** dodaje wpis konta usługi Azure Storage do obiektu konfiguracji usługi Azure HDInsight utworzonego za pomocą New-AzHDInsightClusterConfig cmdlet.

## PRZYKŁADY

### Przykład 1. Dodawanie klucza magazynu platformy Azure do obiektu konfiguracji klastrów
```
...
To polecenie dodaje wpis konta magazynu obiektów blob do konfiguracji usługi HDInsight o nazwie Twoja-hadoop-001.
...
### -StorageAccountKey
Określa klucz konta magazynu dla konta magazynu, które ma zostać dodane do nowego klastra.
...
### -StorageAccountName
Określa nazwę konta magazynu, które ma zostać dodane do klastrów.
