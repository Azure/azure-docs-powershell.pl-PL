...
## OPIS
To **polecenie cmdlet Restart-AzHDInsightHost** powoduje ponowne uruchomienie określonych hostów klastrów HDInsight.
...
To polecenie powoduje ponowne uruchomienie dwóch hostów klastra: worknode1 i worknode2.
...
To polecenie pokazuje, jak współpracować przy użyciu polecenia cmdlet "Get-AzHDInsightHost".
