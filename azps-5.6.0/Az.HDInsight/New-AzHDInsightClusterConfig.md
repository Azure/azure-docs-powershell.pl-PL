...
## OPIS
Polecenie **cmdlet New-AzHDInsightClusterConfig** tworzy nietrwale obiekt opisujący konfigurację klastrów usługi Azure HDInsight.

## PRZYKŁADY

### Przykład 1. Tworzenie obiektu konfiguracji klastrów
```
...
To polecenie tworzy obiekt konfiguracji klastrów.
...
### - GałąźMetastore
Określa magazyn metadanych, w których mają być przechowywane metadane.
...
### -OozieMetastore
Określa magazyn metadanych do przechowywania metadanych Oozie.
