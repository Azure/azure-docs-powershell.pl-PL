...
## OPIS
Polecenie cmdlet **New-AzHDInsightStreamingMapReduceJobDefinition** definiuje obiekt zadania Streaming MapReduce do użytku z klastrem usługi Azure HDInsight.

## PRZYKŁADY

### Przykład 1. Tworzenie definicji zadania przesyłania strumieniowego MapReduce
```
PS C:\># Cluster info
...
To polecenie tworzy definicję zadania przesyłania strumieniowego MapReduce.

## PARAMETERS

### — Argumenty
Określa tablicę argumentów dla zadania.
Argumenty są przekazywane do każdego zadania jako argumenty wiersza polecenia.
...
### -CommandEnvironment
Określa tablicę zmiennych środowiska wiersza polecenia, które mają być ustawiane podczas pracy w węzłach pracowników.
...
### - OutputPath
Określa ścieżkę dla wyniku zadania.
...
### - Redufikator
Określa nazwę pliku Redufikatora.
