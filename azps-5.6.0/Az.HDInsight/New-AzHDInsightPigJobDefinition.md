...
## OPIS
Polecenie **cmdlet New-AzHDInsightPigJobDefinition** definiuje obiekt zadania Świnka do użycia z klastrem usługi Azure HDInsight.

## PRZYKŁADY

### Przykład 1. Tworzenie definicji zadania świnka
```
PS C:\># Cluster info
...
To polecenie tworzy definicję zadania świnki.
