...
### LoadAutoscaleByNameParameterSet (domyślne)
```
...
## OPIS
To polecenie cmdlet **Set-AzHDInsightClusterAutoscaleConfiguration** ustawia konfigurację automatycznego skalowania klastrów usługi Azure HDInsight.

## PRZYKŁADY

### Przykład 1. Ustawianie konfiguracji automatycznego skalowania opartego na ładowarce klastru HDInsight
```powershell
...
To polecenie ustawia konfigurację automatycznego skalowania opartego na ładowaniu klastrów usługi Azure HDInsight.

### Przykład 2. Ustawianie automatycznego skalowania opartego na harmonogramie klastrów HDInsight
```powershell
...
To polecenie ustawia konfigurację automatycznego skalowania opartego na harmonogramie klastra HDInsight.

### Przykład 3. Konfigurowanie konfiguracji skalowania automatycznego klastra HDInsight opartego na innym klastrze, który ma ustawioną konfigurację automatycznego skalowania
```powershell
...
To polecenie ustawia konfigurację automatycznego skalowania klastrów HDInsight na podstawie innego klastra.
