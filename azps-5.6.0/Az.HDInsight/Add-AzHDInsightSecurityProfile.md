...
## OPIS
Profil zabezpieczeń służy do tworzenia bezpiecznego klastrów przez kerberyzowanie go.
Profil zabezpieczeń zawiera konfigurację związaną z dołączanie klastrem do domeny usługi Active Directory.

## PRZYKŁADY

### Przykład 1. Dodawanie profilu zabezpieczeń do obiektu konfiguracji klastrów
```
...
To polecenie dodaje wartość profilu zabezpieczeń do klastra o nazwie Twoja-hadoop-001.

## PARAMETERS

### -ClusterUsersGroupDNs
Nazwy odróżniane grup usługi Active Directory, które będą dostępne w zakresach Ambari i Ranger
...
### -DomainResourceId
Identyfikator zasobu domeny usługi Active Directory dla klastrów.
...
Poświadczenia konta użytkownika domeny z wystarczającymi uprawnieniami do tworzenia klastrów.
...
### -LdapsUrls
Adresy URL jednego lub wielu serwerów LDAPS dla usługi Active Directory
...
Wyróżniona nazwa jednostki organizacyjnej w usłudze Active Directory, w której będą tworzone konta użytkowników i komputerów
