...
## OPIS
Polecenie cmdlet **New-AzHDInsightMapReduceJobDefinition** definiuje nowe zadanie MapReduce do użytku z klastrem usługi Azure HDInsight.
...
### -JarFile
Określa plik JAR do użycia w zadaniu.
...
### - LibJars
Określa bibliotekę JARS dla zadania.
