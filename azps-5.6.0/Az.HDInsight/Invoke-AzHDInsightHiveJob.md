...
Użyj tego Use-AzHDInsightCluster cmdlet przed wywołaniem **invoke-AzHDInsightHiveJob,** aby określić klaster, który będzie używany dla zapytania.
...
Określa klucz konta domyślnego konta magazynu używanego przez klaster HDInsight.
