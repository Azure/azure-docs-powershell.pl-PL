...
## OPIS
Utwórz podskok SSH firmy Kubectl na pulpicie nawigacyjnym zarządzanego klastra. Podkoszowy SSH jest konfigurowany w zadaniu programu PowerShell o nazwie Kubectl-Tunnel można go znaleźć po `Get-Job` uruchomieniu. Ten podjadek powinien być dostępny za [http://127.0.0.1:8001](http://127.0.0.1:8001) pośrednictwem.

## PRZYKŁADY

### Rozpoczynanie pracy z panelem SSH i otwieranie przeglądarki na pulpicie nawigacyjnym Kubernetes
```
...
### -DisableBrowser
Nie otwieraj przeglądarki po nawiązyniu port-forward kubectl.
...
### - ListenPort
Port nasłuchiwania pulpitu nawigacyjnego. Wartość domyślna to 8003.
...
### -PassThru
Polecenie cmdlet zwraca wartość błędu KubeTunnelJob, jeśli minął.
