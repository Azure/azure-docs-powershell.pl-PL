...
## OPIS
Polecenie **cmdlet Get-AzDataBoxEdgeUser** wyświetla listę użytkowników skonfigurowanych dla urządzenia z krawędzią pola danych. Możesz wspomnieć nazwę w parametrach, aby uzyskać szczegółowe informacje o określonym użytkowniku.
