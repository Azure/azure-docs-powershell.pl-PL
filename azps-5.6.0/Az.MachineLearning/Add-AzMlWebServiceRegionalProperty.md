...
### Przykład 1. Dodawanie nowych właściwości regionalnych dla Stanów Zjednoczonych Środkowych Zachód

```
Add-AzMlWebServiceRegionalProperty -ResourceGroupName "myresourcegroup" -Name "mywebservicename" -Region westcentralus
```

To przykładowe polecenie tworzy właściwość regionalną usługi sieci Web w regionie "Zachód Środkowe Stany Zjednoczone".
