...
## OPIS
Polecenie **cmdlet Set-AzServiceBusAuthorizationRule** aktualizuje opis określonej reguły autoryzacji w danej przestrzeni nazw, kolejce lub temacie autobusu usługi.
...
Usuwa zarządzanie **z** praw dostępu reguły autoryzacji w `AuthoRule1` przestrzeni `SB-Example1` nazw.
...
Usuwa zarządzanie **z** praw dostępu reguły autoryzacji w `AuthoRule1` `SBQueue` kolejce.
...
Usuwa zarządzanie **z** praw dostępu do reguły autoryzacji w `AuthoRule1` tym `SBTopic` temacie.
...
### -InputObject
Obiekt ServiceBus AuthorizationRule
