...
## OPIS
Polecenie **cmdlet Remove-AzServiceBusAuthorizationRule** usuwa regułę autoryzacji przestrzeni nazw, kolejki lub tematu autobusu usług dla określonej grupy zasobów.
...
Usuwa regułę autoryzacji `SBAuthoRule1` przestrzeni nazw `SB-Example1` z określonej grupy zasobów.
...
Usuwa regułę autoryzacji `SBAuthoRule1` tematu `SBTopic` z określonej grupy zasobów.
