...
## OPIS
Polecenie **cmdlet Set-AzServiceBusGeoDRConfigurationFailOver** wywoła failover funkcji DR GEO i ponownie skonfiguruj alias tak, aby wskazał pomocniczą przestrzeń nazw.
...
Wywołuje nazwę trybu failover za pomocą aliasu "SampleDRConfigName", ponownie konfiguruje i wskaż pomocniczą przestrzeń nazw "SampleNamespace_Secondary".
...
### -InputObject
Obiekt konfiguracji geodru autobusu usługowego
...
### —Przestrzeń nazw
Nazwa przestrzeni nazw — pomocnicza przestrzeń nazw
