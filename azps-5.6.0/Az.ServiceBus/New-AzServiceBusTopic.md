...
## OPIS
Polecenie **cmdlet New-AzServiceBusTopic** tworzy nowy temat autobusu usługi w określonej przestrzeni nazw typu Bus usługi.
...
Tworzy nowy temat autobusu usług `SB-Topic_exampl1` w określonej przestrzeni nazw autobusu `SB-Example1` usług.

### Przykład 2

Tworzy nowy temat autobusu usług w określonej przestrzeni nazw tego autobusu usług. (wygenerowane automatycznie)
...
### -AutoDeleteOnIdle
Określa interwał [bezczynności przedziału](https://msdn.microsoft.com/library/system.timespan.aspx) czasu, po upływie którego temat zostanie automatycznie usunięty. Minimalny czas trwania to 5 minut.
...
Określa czas trwania, po upływie którego wiadomość wygasa, rozpoczynając od czasu wysłania wiadomości do autobusu serwisowego.
...
Wskazuje, czy operacje wsadowe po stronie serwera są włączone.
...
### -EnableExpress
Wskazuje, czy encje ekspresowe są włączone. W kolejce ekspresowej wiadomość jest tymczasowo w pamięci przed jej napisem w pamięci trwałej.
...
### -EnablePartitioning
Określa, czy można włączyć podział tematu na wielu maklerzy wiadomości. 
...
### -MaxSizeInMegabytes
Maksymalny rozmiar tematu w megabajtach, czyli rozmiar pamięci przydzielonej do tego tematu.
...
Wskazuje, czy temat wymaga wykrywania duplikacji.
...
### -SupportOrdering
Wskazuje, czy temat obsługuje zamawianie.
