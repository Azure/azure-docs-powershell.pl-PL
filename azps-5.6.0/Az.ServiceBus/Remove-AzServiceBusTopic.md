...
## OPIS
Polecenie **cmdlet Remove-AzServiceBusTopic** usuwa temat z określonej przestrzeni nazw bus usługi.
...
Usuwa temat z `SB-Topic_exampl1` przestrzeni `SB-Example1` nazw.
...
### Przykład 5. Użycie wartości ciągu ResourceId
```powershell
...
### -InputObject
Obiekt tematu w usłudze Service Bus
...
### -ResourceId
Identyfikator zasobu tematu w usłudze Service Bus
