...
## OPIS
Polecenie **cmdlet Set-AzServiceBusSubscription** aktualizuje opis subskrypcji dla tematu Autobus usługi w określonej przestrzeni nazw tego typu.
...
Aktualizuje opis określonej subskrypcji dla danego tematu. W tym przykładzie właściwość **DeadLetteringOnMessageExpiration ma wartość** **true,** a **funkcja MaxDeliveryCount** ma wartość 9.
