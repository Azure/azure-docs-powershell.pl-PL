...
## OPIS
Polecenie **cmdlet Set-AzServiceBusTopic** aktualizuje obiekt opisu tematu autobusu usług w określonej przestrzeni nazw typu bus usługi.
...
Aktualizuje określony temat o nowy opis w określonej przestrzeni nazw. W tym przykładzie właściwość **EnableExpress** jest aktualizowana na **prawda.** 
...
### -InputObject
Definicja tematu usługi ServiceBus.
