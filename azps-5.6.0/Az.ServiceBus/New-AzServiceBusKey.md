...
## OPIS
Polecenie **cmdlet New-AzServiceBusKey** generuje nowe podstawowe lub pomocnicze parametry połączenia dla określonej przestrzeni nazw, kolejki lub tematu i reguły autoryzacji.
...
Ponownie generuje podstawowe lub pomocnicze parametry połączenia przy użyciu podanej wartości klucza dla kolejki.
...
Ponowne generowanie podstawowych lub pomocniczych ciągów połączeń z podaną wartością klucza tematu.
