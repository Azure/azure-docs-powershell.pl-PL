...
## OPIS
Polecenie **cmdlet Remove-AzServiceBusQueue** usuwa kolejkę z określonej przestrzeni nazw autobusu usług.
...
Usuwa kolejkę usługi bus `SB-Queue_exampl1` z przestrzeni `SB-Example1` nazw.
...
Usuwa kolejkę service bus podaną w parametrze $inputobject -InputObject
...
Usuwa kolejkę service bus podaną w identyfikatorze ARM w ciągu $resourceid/string dla parametru -ResourceId

### Przykład 5. ResourceId — przechodząc jako ciąg:
```powershell
...
### -InputObject
Obiekt kolejki autobusu usługowego
...
### -ResourceId
Identyfikator zasobu kolejki serwisowej
