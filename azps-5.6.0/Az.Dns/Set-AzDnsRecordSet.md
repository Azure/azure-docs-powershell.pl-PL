...
Ostatnie polecenie propaguje aktualizację w $RecordSet za pomocą polecenia cmdlet **Set-AzDnsRecordSet.**
...
Zestaw rekordów nie zostanie zaktualizowany, jeśli został zmieniony w usłudze Azure DNS od czasu pobrania lokalnego obiektu **RecordSet.**
Zapewnia to ochronę w przypadku jednoczesnych zmian.
Aby pominąć to zachowanie, można użyć parametru *Zastąp,* co powoduje zaktualizowanie zestawu rekordów bez względu na jednoczesne zmiany.
