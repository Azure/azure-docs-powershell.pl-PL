...
W tym przykładzie wszystkie strefy DNS w określonej grupie zasobów są przechowywane w $Zones zasobów.
...
### -ResourceGroupName
Określa nazwę grupy zasobów zawierającej strefę DNS do uzyskania.
