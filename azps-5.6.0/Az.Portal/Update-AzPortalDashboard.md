...
Aktualizowanie tagów na pulpicie nawigacyjnym.
Tagi są reprezentowane jako wbudowane skróty.

### Przykład 2. Aktualizowanie tagów pulpitu nawigacyjnego przy użyciu potoku
```powershell
...
Aktualizowanie tagów na pulpicie nawigacyjnym ponoszy za pomocą narzędzia Get-AzPortalDashboard.
Umożliwia to aktualizowanie tagów na jednym pulpicie nawigacyjnym lub wielu pulpitach nawigacyjnych.
