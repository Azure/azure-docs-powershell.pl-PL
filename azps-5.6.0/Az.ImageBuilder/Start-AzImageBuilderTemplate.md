...
### Przykład 1. Uruchamianie szablonu obrazu
```powershell
PS C:\> Start-AzImageBuilderTemplate -ResourceGroupName wyunchi-imagebuilder -Name template-name-sn78hg

```

To polecenie pozwala na rozpoczęcie pracy z szablonem obrazu.

### Przykład 2. Uruchamianie szablonu obrazu
```powershell
