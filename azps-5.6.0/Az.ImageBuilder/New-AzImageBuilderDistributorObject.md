...
### Przykład 1. Tworzenie zarządzanego dystrybutora obrazów
```powershell
...
To polecenie tworzy zarządzanego dystrybutora obrazów.
...
To polecenie tworzy dystrybutor VHD.

### Przykład 3. Tworzenie udostępnionego dystrybutora obrazów
```powershell
...
To polecenie tworzy dystrybutora obrazów udostępnionych.

## PARAMETERS

### -ArtifactTag
Tagi, które będą stosowane do artefaktu po jego utworzeniu/zaktualizowaniu przez dystrybutora.
...
### -ExcludeFromLatest
Flaga wskazująca, czy utworzona wersja obrazu powinna być wykluczana z najnowszej wersji.
...
### -GalleryImageId
Identyfikator zasobu w galerii obrazów udostępnionych.
...
### — Lokalizacja
Lokalizacja obrazu na platformie Azure powinna być taka, jeśli obraz już istnieje.
...
Rozpowszechnij jako obraz dysku zarządzanego.
...
### -RunOutputName
Nazwa, która ma być używana dla skojarzonego RunOutput.
...
### -SharedImageDistributor
Rozpowszechnianie za pomocą udostępnionej galerii obrazów.
...
### -StorageAccountType
Typ konta magazynu używanego do przechowywania udostępnionego obrazu.
Pomiń, aby użyć wartości domyślnej (Standard_LRS).
...
### -VhdDistributor
Rozpowszechniaj za pośrednictwem VHD na koncie magazynu.
...
### Microsoft.Azure.PowerShell.Cmdlet.ImageBuilder.Models.Api20200214.IImageTemplateDistributor
