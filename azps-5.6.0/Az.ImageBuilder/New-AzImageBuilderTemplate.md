...
Aby utworzyć tabelę, zobacz sekcję NOTATKI, aby uzyskać informacje o właściwościach DISTRIBUTE i utworzyć tabelę skrótów.
...
CUSTOMIZE <IImageTemplateCustomizer[]>: Określa właściwości używane do opisywania kroków dostosowywania obrazu, takie jak źródło obrazów itp.
  ...
  - `[Name <String>]`: Przyjazna nazwa w celu zapewnienia kontekstu na temat tego kroku dostosowywania

DISTRIBUTE <IImageTemplateDistributor[]>: Miejsce docelowe rozkładu, do którego należy przejść do wyniku obrazu.
