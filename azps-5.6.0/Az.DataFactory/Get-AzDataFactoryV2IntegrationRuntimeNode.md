...
## OPIS
Polecenie **cmdlet Get-AzDataFactoryV2IntegrationRuntimeNode** pobiera szczegółowe informacje węzła środowiska uruchomieniowego integracji.

## PRZYKŁADY

### Przykład 1. Pobiera szczegółowe informacje o węźle środowiska uruchomieniowego integracji.
```
...
Polecenie cmdlet pobiera informacje o węźle o nazwie "Node_1" w środowisku integracji samoobsługowej "test-selfhost-ir" w data factory "test-df-eu2".

### Przykład 2. Pobiera szczegółowe informacje węzła środowiska uruchomieniowego integracji z adresem IP.
```
...
Polecenie cmdlet pobiera informacje o węźle o nazwie "Node_1" w środowisku integracji samoobsługowej "test-selfhost-ir" w środowisku danych factory "test-df-eu2", łącznie z adresem IP.
...
### — Nazwa
Nazwa węzła integracji środowiska uruchomieniowego.
