...
## OPIS
Polecenie **cmdlet Remove-AzDataFactoryDataset** usuwa zestaw danych z usługi Azure Data Factory.
...
To polecenie cmdlet usuwa zestaw danych z fabrycznych danych określany przez ten parametr.
...
### — Wymuszanie
Wskazuje, że to polecenie cmdlet usuwa zestaw danych bez monitowania o potwierdzenie.
...
### — Nazwa
Określa nazwę zestawu danych do usunięcia.
...
To polecenie cmdlet usuwa zestaw danych z grupy, która określa ten parametr.
