...
## OPIS
Polecenie **cmdlet Start-AzDataFactoryV2Trigger** uruchamia wyzwalacz w fabrycznej bazie danych. Jeśli wyzwalacz znajduje się w stanie "Zatrzymano", polecenie cmdlet uruchamia wyzwalacz i ostatecznie wywołuje potoki na podstawie jego definicji. Jeśli wyzwalacz znajduje się już w stanie "Uruchomiliśmy", to polecenie cmdlet nie ma wpływu. Jeśli parametr Force jest określony, polecenie cmdlet nie wyświetla monitu przed uruchomieniem wyzwalacza.

## PRZYKŁADY

### Przykład 1. Uruchamianie wyzwalacza
```
...
Uruchamia wyzwalacz o nazwie "ScheduledTrigger" w fabrycznej układzie danych "WikiADF".
...
### -InputObject
Wyzwalanie obiektu do uruchomienia.
