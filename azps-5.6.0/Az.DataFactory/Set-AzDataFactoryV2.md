...
To polecenie umożliwia utworzenie w grupie zasobów O nazwie ADF w lokalizacji EastUS fabryki danych o nazwie WikiADF z konfiguracją kontroli źródła programu Azure DevOps.
...
### — Lokalizacja
W tym regionie zostanie utworzona fabryczna data.
