...
## OPIS
Polecenie cmdlet Get-AzDataFactoryV2IntegrationRuntime uzyskać informacje o środowiskach uruchomieniowych integracji w factory danych.
Jeśli określisz nazwę środowiska uruchomieniowego integracji, to polecenie cmdlet pobiera informacje o tym środowisku uruchomieniowym integracji.
Jeśli nie określisz nazwy, to polecenie cmdlet pobiera informacje o wszystkich środowiskach uruchomieniowych integracji w factory danych.

## PRZYKŁADY

### Przykład 1. Lista wszystkich środowisk uruchomieniowych integracji w factory danych
```
...
Lista wszystkich środowisk uruchomieniowych integracji w factory danych o nazwie "test-df-eu2".
...
To polecenie wyświetla informacje o środowisku uruchomieniowym integracji o nazwie "test-dedicated-ir" w subskrypcji dla grupy zasobów o nazwach "rg-test-dfv2" i data factory o nazwie "test-df-eu2".

### Przykład 3. Uzyskiwanie dedykowanego środowiska uruchomieniowego integracji zarządzanej ze stanem szczegółów
```
...
### Przykład 4. Uzyskiwanie środowiska uruchomieniowego integracji z własnym hostem
```
...
### Przykład 5. Uzyskiwanie środowiska integracji we własnym środowisku uruchomieniowym ze stanem szczegółów
```
