...
## OPIS
Polecenie New-AzDataFactoryV2LinkedServiceEncryptedCredential szyfrowania poświadczeń w połączonej usłudze w określonym środowisku uruchomieniowym integracji.

Upewnij się, że są spełnione następujące wymagania wstępne:
* **Opcja dostępu zdalnego** jest włączona w środowisku integracji samoobsługowej.
