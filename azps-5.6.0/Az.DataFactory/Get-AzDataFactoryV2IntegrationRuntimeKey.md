...
## OPIS
Uzyskaj klucze środowiska uruchomieniowego integracji. Klucze służą do rejestrowania węzła środowiska uruchomieniowego integracji.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie kluczy środowiska uruchomieniowego integracji
```
...
Polecenie cmdlet pobiera klucze środowiska uruchomieniowego integracji o nazwie "test-selfhost-ir".
