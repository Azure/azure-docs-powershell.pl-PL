...
## OPIS
Polecenie **cmdlet Update-AzDataFactoryV2IntegrationRuntimeNode** aktualizuje właściwości węzła środowiska uruchomieniowego integracji samoobsługowej w fabrycznej bazie danych. Obecnie obsługuje tylko aktualizowanie "ConcurrentJobsLimit".

## PRZYKŁADY

### Przykład 1. Aktualizacje węzła środowiska uruchomieniowego integracji z własnym środowiskiem uruchomieniowym
```
...
Polecenie cmdlet aktualizuje "ConcurrentJobsLimit" na 3 dla węzła "Node_1" w środowisku integracji samodzielnej "test-selfhost-ir".

## PARAMETERS

### -ConcurrentJobsLimit
Liczba jednoczesnych zadań, które mogą być uruchamiane w węźle środowiska uruchomieniowego integracji.
Dozwolone są wartości od 1 do maxConcurrentJobs.
