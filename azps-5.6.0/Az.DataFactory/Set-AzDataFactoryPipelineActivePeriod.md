...
Jeśli użyjesz polecenia cmdlet Set-AzDataFactorySliceStatus w celu zmodyfikowania stanu wycinków dla zestawu danych, upewnij się, że godzina rozpoczęcia i godzina zakończenia wycinka znajdują się w aktywnym okresie potoku.
...
Przetwarzanie danych odbywa się lub wycinki danych są przetwarzane w tym okresie.
*Wartość StartDateTime* musi zostać określona w formacie ISO8601.
