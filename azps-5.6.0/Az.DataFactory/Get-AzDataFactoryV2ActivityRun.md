...
## OPIS
Polecenie **cmdlet Get-AzDataFactoryV2ActivityRun** pobiera informacje o uruchamianiu w usłudze Azure Data Factory określonego uruchomienia potoku, które miało miejsce w określonym przedziale czasu. Ponadto można określić filtry dla nazwy działania, połączonej nazwy usługi, która wykonała uruchomienie, oraz stanu uruchomienia.
...
To polecenie pobiera szczegółowe informacje o wszystkich działaniach uruchamianych w potoku uruchomionym przy użyciu identyfikatora "f288712d-fb08-4cb8-96ef-82d3b9b30621", który wydarzył się między "2017-09-01" a "2017-09-30".
