...
## OPIS
Polecenie **cmdlet Stop-AzDataFactoryV2IntegrationRuntime** zatrzymuje zarządzane dedykowane środowisko integracji w stanie "Uruchomiono", który został uruchomiony przez Start-AzDataFactoryV2IntegrationRuntime cmdlet. Zasoby zostaną wydane, a stan zostanie "zatrzymany".

## PRZYKŁADY

### Przykład 1. Zatrzymanie zarządzanego środowiska uruchomieniowego integracji, które znajduje się w stanie "Uruchomiliśmy".
```
...
Środowisko uruchomieniowe integracji zarządzanej "test-reserlved-ir" ma stan "Uruchomiony". Po uruchomieniu Stop-AzDataFactoryV2IntegrationRuntime cmdlet zasoby są zwalniane, a stan przenosi się do stanu "Zatrzymano".
