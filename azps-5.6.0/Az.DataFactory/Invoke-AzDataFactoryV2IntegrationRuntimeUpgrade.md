...
## OPIS
Polecenie cmdlet **Invoke-AzDataFactoryV2IntegrationRuntimeUpgrade** uaktualni środowisko uruchomieniowe integracji samoobsługowej, jeśli jest dostępna nowa wersja.

## PRZYKŁADY

### Przykład 1. Uaktualnienie środowiska integracji z własnym hostem
```
...
Polecenie cmdlet uaktualnia środowisko uruchomieniowe integracji z własnym hostem o nazwie "test-selfhost-ir" w środowisku data factory 'test-df-eu2".
