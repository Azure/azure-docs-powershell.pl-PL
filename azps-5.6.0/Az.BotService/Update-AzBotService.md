...
### Przykład 1. Aktualizowanie bota według nazw i nazw grupy zasobów
```powershell
...
Aktualizowanie bota według nazw i nazw grupy zasobów

### Przykład 2. Aktualizowanie bota przez InputObject
```powershell
...
Aktualizowanie bota przez InputObject
...
Klucz interfejsu API szczegółowych informacji aplikacji
...
Identyfikator aplikacji Szczegółowe informacje o aplikacji
...
### -LuisAppId
Kolekcja identyfikatorów aplikacji USŁUGI LUIS
...
### - MsaAppId
Identyfikator aplikacji Firmy Microsoft dla bota
...
### — Tag
Tagi zasobów zdefiniowane jako pary klucz/wartość.
