...
### Przykład 1. Usuwanie aplikacji pulpitu wirtualnego systemu Windows według nazwy
```powershell
PS C:\> Remove-AzWvdApplication -ResourceGroupName ResourceGroupName -ApplicationGroupName ApplicationGroupName -Name ApplicationName
```

To polecenie usuwa aplikację pulpitu wirtualnego systemu Windows w grupie aplikacji.
