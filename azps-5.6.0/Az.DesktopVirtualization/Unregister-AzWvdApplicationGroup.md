...
### Przykład 1. Wyrejestrowanie grupy aplikacji pulpitu wirtualnego systemu Windows
```powershell
...
To polecenie wyrejestruje grupę aplikacji pulpitu wirtualnego systemu Windows do obszaru roboczego.
