...
### Przykład 1. Tworzenie tokenu rejestracji pulpitu wirtualnego systemu Windows
```powershell
...
To polecenie tworzy token rejestracji pulpitu wirtualnego systemu Windows w puli hostów.
...
### Microsoft.Azure.PowerShell.cmdlet.DesktopVirtualization.Models.Api20201102Preview.IRegistrationInfo
