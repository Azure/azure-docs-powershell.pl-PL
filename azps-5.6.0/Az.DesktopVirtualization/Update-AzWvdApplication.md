...
### Przykład 1. Aktualizowanie aplikacji pulpitu wirtualnego systemu Windows
```powershell
...
To polecenie aktualizuje aplikację pulpitu wirtualnego systemu Windows w grupie aplikacji.
