...
### Przykład 2. Lista elementów menu Start pulpitu wirtualnego systemu Windows
```powershell
...
To polecenie wyświetla listę elementów menu Start pulpitu wirtualnego systemu Windows w grupie aplikacji.
...
### Microsoft.Azure.PowerShell.Cmdlet.DesktopVirtualization.Models.Api20201102Preview.IStartMenuItem
