...
### Przykład 1. Tworzenie aplikacji pulpitu wirtualnego systemu Windows
```powershell
...
To polecenie tworzy aplikację pulpitu wirtualnego systemu Windows w grupie aplikacji.

## PARAMETERS

### -AppAlias
Pozycja menu Alias aplikacji z menu Start
...
### - CommandLineSetting
Określa, czy tę opublikowaną aplikację można uruchomić z argumentami wiersza polecenia dostarczonymi przez klienta, argumentami wiersza polecenia określonymi w czasie publikowania, czy też w ogóle nie ma argumentów wiersza polecenia.
...
### - FilePath
Określa ścieżkę pliku wykonywalnego dla aplikacji.
...
### — Nazwa
Nazwa aplikacji w obrębie określonej grupy aplikacji
...
### -ShowInPortal
Określa, czy program RemoteApp ma być pokazywany na serwerze RD Web Access.
...
### Microsoft.Azure.PowerShell.Cmdlet.DesktopVirtualization.Models.Api20201102Preview.IApplication
