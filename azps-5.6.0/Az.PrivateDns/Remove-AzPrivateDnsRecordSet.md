...
Pierwsze polecenie otrzymuje określony zestaw rekordów. Drugie polecenie usuwa zestaw rekordów, nawet jeśli zmienił się w międzyczasie. Monity o potwierdzenie są pomijane.
...
### — Zastąp
W przypadku optymistycznych testów współbieżności nie należy używać pola ETag parametru RecordSet.
