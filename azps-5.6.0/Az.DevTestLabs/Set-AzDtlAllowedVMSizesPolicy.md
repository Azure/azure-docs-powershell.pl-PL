...
## OPIS
Polecenie **cmdlet Set-AzDtlAllowedVMSizesPolicy** ustawia zasady dozwolonych rozmiarów maszyn wirtualnych, określając listę dozwolonych rozmiarów maszyn wirtualnych w laboratorium.
...
### — LabName
Określa nazwę laboratorium, dla którego to polecenie cmdlet określa zasady rozmiarów maszyn wirtualnych.
...
### -VmSizes
Określa jako tablicę ciągów listę dozwolonych rozmiarów maszyn wirtualnych w laboratorium.
