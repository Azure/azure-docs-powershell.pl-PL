...
## OPIS
Polecenie **cmdlet Set-AzDtlVMsPerUserPolicy** ustawia zasady maszyn wirtualnych na użytkownika w laboratorium, które ustawia maksymalną dozwoloną liczbę maszyn wirtualnych dla każdego użytkownika.
...
### — LabName
Określa nazwę laboratorium, dla którego to polecenie cmdlet ustawia maszyny wirtualne na zasady użytkownika.
