...
Określ profil do usunięcia za pomocą parametrów *Name (Nazwa)* i *ResourceGroupName (Nazwa* grupy zasobów).
Możesz również określić obiekt **TrafficManagerProfile** przy użyciu parametru *TrafficManagerProfile* lub użyć potoku.

## PRZYKŁADY

### Przykład 1. Usuwanie profilu określonego przez nazwę
```
PS C:\>Remove-AzTrafficManagerProfile -Name "ContosoProfile" -ResourceGroupName "ResourceGroup11"
```

To polecenie usuwa profil o nazwie ContosoProfile z grupy ResourceGroup11.
Polecenie wyświetli monit o potwierdzenie.

### Przykład 2. Usuwanie profilu przy użyciu potoku
```
...
To polecenie cmdlet usuwa ten profil.
...
### — Nazwa
Określa nazwę profilu menedżera ruchu, który zostanie usunięty przez to polecenie cmdlet.
...
To polecenie cmdlet usuwa profil menedżera ruchu w grupie, która jest określana przez ten parametr.
