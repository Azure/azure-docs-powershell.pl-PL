...
## OPIS
Polecenie **cmdlet Remove-AzTrafficManagerExpectedStatusCodeRange** usuwa zakres kodów stanu z lokalnego obiektu profilu usługi Azure Traffic Manager.
...
### Przykład 1. Usuwanie z profilu oczekiwanego zakresu kodów stanu
```
...
Drugie polecenie usuwa zakres oczekiwanego kodu stanu z profilu przechowywanego w $TrafficManagerProfile.
...
### — Minimum
Określa najniższą wartość w zakresie kodów stanu do usunięcia.
