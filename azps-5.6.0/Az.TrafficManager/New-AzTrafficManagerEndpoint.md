...
Punkt końcowy platformy Azure wskazuje aplikację Azure Web App, której identyfikator Azure Resource Manager jest podawany przez ścieżkę identyfikatora URI *w identyfikatorze TargetResourceId.*
