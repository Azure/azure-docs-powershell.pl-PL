...
## OPIS
Polecenie **cmdlet Add-AzTrafficManagerExpectedStatusCodeRange** dodaje zakres kodów stanu do lokalnego obiektu profilu usługi Azure Traffic Manager.
...
### Przykład 1. Dodawanie do profilu oczekiwanego zakresu kodów stanu
```
...
Drugie polecenie dodaje zakres oczekiwanego kodu stanu do profilu przechowywanego w $TrafficManagerProfile.
...
### — Max
Określa najwyższą wartość w zakresie kodów stanu do dodania.
...
### — Minimum
Określa najniższą wartość w zakresie kodów stanu do dodania.
