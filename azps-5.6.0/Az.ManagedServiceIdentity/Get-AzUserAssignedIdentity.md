...
## SYNOPSIS
Pobiera tożsamości/tożsamości przypisane przez użytkowników.

## SKŁADNIA

### SuscriptionParameterSet (ustawienie domyślne)
```
...
## OPIS
Identyfikator **Get-AzUserAssignedIdentity** pobiera istniejące tożsamości przypisane do użytkownika.

## PRZYKŁADY

### Przykład 1
To przykładowe polecenie cmdlet pobiera tożsamość przypisaną przez użytkownika o nazwie **ID1** w grupie zasobów **PSRG**
...
### Przykład 2
To przykładowe polecenie cmdlet pobiera wszystkie tożsamości przypisane przez użytkownika w grupie zasobów **PSRG**
...
### Przykład 3
To przykładowe polecenie cmdlet pobiera wszystkie tożsamości przypisane przez użytkownika w ramach subskrypcji.
