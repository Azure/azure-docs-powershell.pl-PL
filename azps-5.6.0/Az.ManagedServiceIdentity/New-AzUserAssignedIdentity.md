...
## SYNOPSIS
Tworzy nową tożsamość przypisaną do użytkownika lub aktualizuje istniejącą tożsamość przypisaną przez użytkownika.
...
## OPIS
Polecenie **cmdlet New-AzUserAssignedIdentity** tworzy nową tożsamość przypisaną do użytkownika. W przypadku korzystania z istniejącej tożsamości zaktualizowano ją.
Aby dodać tagi usługi Azure Resource Manager do tożsamości, użyj Set-AzResource cmdlet.

## PRZYKŁADY

### Przykład 1
W tym przykładzie polecenie cmdlet tworzy nową tożsamość przypisaną przez użytkownika o nazwie **ID1** w grupie zasobów **PSRG** w lokalizacji grupy Zasobów.
...
### Przykład 2
W tym przykładzie polecenie cmdlet tworzy nową tożsamość przypisaną do użytkownika o nazwie **ID1** w grupie zasobów **PSRG** w regionie zachód.
...
### — Lokalizacja
Nazwa regionu platformy Azure, w którym powinna zostać utworzona tożsamość.
...
### — Tag
Tagi usługi Azure Resource Manager skojarzone z tożsamością.
