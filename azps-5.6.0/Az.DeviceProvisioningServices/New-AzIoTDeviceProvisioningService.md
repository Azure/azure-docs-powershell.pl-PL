...
Utwórz usługę obsługi administracyjnej urządzeń centrum IoT Azure przy użyciu standardowej warstwy cenowej S1 i tagów w regionie grupy zasobów.
...
### — Tag
Tagi wystąpienia usługi inicjowania obsługi urządzeń IoT. Work property bag in key-value pairs in the form of a hash table.
