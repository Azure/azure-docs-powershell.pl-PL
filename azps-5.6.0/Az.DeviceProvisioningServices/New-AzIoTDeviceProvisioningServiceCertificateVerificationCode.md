...
## OPIS
Ten kod weryfikacyjny służy do ukończenia dowodu posiadania certyfikatu. Użyj tego kodu weryfikacyjnego jako kodu CN nowego certyfikatu podpisanego za pomocą klucza prywatnego certyfikatów głównych.
...
Wygeneruj kod weryfikacyjny dla "mycertificate".
...
Wygeneruj kod weryfikacyjny dla "mycertificate" przy użyciu potoku.
