...
## OPIS
Zweryfikuj certyfikat, przesyłając certyfikat weryfikacji zawierający kod weryfikacyjny uzyskany przez dzwonienie na kod weryfikacji wygenerowania. Jest to ostatni krok w procesie dowodu posiadania.
Aby uzyskać szczegółowe objaśnienie certyfikatów urzędu certyfikacji w usłudze inicjowania obsługi urządzeń w centrum Azure IoT, zobacz https://docs.microsoft.com/azure/iot-dps/how-to-verify-certificates
