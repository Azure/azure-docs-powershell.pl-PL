...
W grupie zasobów "myresourcegroup" (moja grupa zasobów) należy wyświetlić listę wszystkich usług inicjowania obsługi urządzeń centrum IoT Azure.
...
Pokaż szczegóły usługi inicjowania obsługi urządzeń w centrum IoT Azure "myiotdps".
