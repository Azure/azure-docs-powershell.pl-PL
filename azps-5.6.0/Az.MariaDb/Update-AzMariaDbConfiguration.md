...
Użyj Update-AzMariaDbServer, jeśli chcesz zaktualizować hasło AdministratorLoginPassword, sku itp.
...
### Przykład 1. Aktualizowanie konfiguracji bazy danych MariaDB
```powershell
...
To polecenie aktualizuje konfigurację bazy danych MariaDB.
