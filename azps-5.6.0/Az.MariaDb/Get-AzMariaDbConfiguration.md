...
### Przykład 1. Lista wszystkich konfiguracji w obszarze bazy danych MariaDB
```powershell
...
To polecenie zawiera listę wszystkich konfiguracji w obszarze bazy danych MariaDB.

### Przykład 2. Uzyskiwanie konfiguracji bazy danych MariaDB
```powershell
...
To polecenie pobiera konfigurację bazy danych MariaDB.
...
### Microsoft.Azure.PowerShell.cmdlet.MariaDb.Models.Api20180601Preview.IConfiguration
