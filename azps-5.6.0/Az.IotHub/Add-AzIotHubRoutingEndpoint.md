...
## OPIS
Dodaj nowy punkt końcowy w Centrum IoT. Aby dowiedzieć się więcej o obsługiwanych punktach końcowych, zobacz https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-endpoints
...
Dodaj nowy punkt końcowy "E2" typu Aplikacja EventHub do centrum IoT "myiothub".
...
Dodaj nowy punkt końcowy "S1" typu AzureStorageContainer do centrum IoT "myiothub".
...
Grupa zasobów zasobu punktu końcowego
...
SubscriptionId zasobu Endpoint
...
### — Kodowanie
Wybierz format, w którym chcesz rozsyłać dane. Możesz wybrać JSON lub AVRO. Wartość domyślna to AVRO.
