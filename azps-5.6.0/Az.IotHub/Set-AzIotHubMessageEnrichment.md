...
Aktualizuje wartość wzbogacenia klucza "newKey" o wartość "updatedValue".
Aby uzyskać szczegółowe objaśnienie wzbogacania wiadomości w centrum Azure IoT Hub, zobacz https://docs.microsoft.com/azure/iot-hub/iot-hub-message-enrichments-overview
...
Aktualizuje punkt końcowy wzbogacenia o "punkt końcowy1, punkt końcowy2, punkt końcowy3" dla klucza "newKey".
Aby uzyskać szczegółowe objaśnienie wzbogacania wiadomości w centrum Azure IoT Hub, zobacz https://docs.microsoft.com/azure/iot-hub/iot-hub-message-enrichments-overview
