...
## OPIS
Oceń docelową metrykę niestandardową lub systemową zdefiniowaną w konfiguracji urządzenia IoT.
Istnieją wstępnie zdefiniowane metryki systemu, które są obliczane przez centrum Iot i nie można ich dostosować.
- "Targeted" określa liczbę urządzeń, które pasują do warunku docelowego.
- "Zastosowano" określa liczbę urządzeń zmodyfikowanych przez konfigurację. 
...
Oceń metrykę niestandardowego zdefiniowanego parametru "warningLimit".
...
Oceń metrykę "zastosowanego" systemu.
...
### -MetricType
Wskazuje, która kolekcja metryki powinna być używana do wyszukiwania metryki.
