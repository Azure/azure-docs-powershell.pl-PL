...
## OPIS
Aktualizowanie określonych właściwości konfiguracji automatycznego zarządzania urządzeniami IoT.
Uwaga: nie można zmylić zawartości konfiguracji. Właściwości konfiguracji, które można aktualizować, to"etykiety", "metryki", "priorytet" i "targetCondition".
Aby https://docs.microsoft.com/azure/iot-hub/iot-hub-automatic-device-management uzyskać więcej informacji, zobacz te informacje.
...
Zmienianie priorytetu konfiguracji urządzenia i aktualizowanie jej warunku docelowego
...
Aktualizowanie metryk i etykiet konfiguracji urządzenia
...
### — Wymuszanie
Pozwala na zamienianie obiektu konfiguracyjne, nawet jeśli został zaktualizowany od czasu ostatniego pobrania.
