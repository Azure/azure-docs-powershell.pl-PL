...
Aby https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language uzyskać więcej informacji, zobacz te informacje.
...
Wykonywanie zapytań dotyczących wszystkich danych urządzenia w centrum Azure IoT Hub.
