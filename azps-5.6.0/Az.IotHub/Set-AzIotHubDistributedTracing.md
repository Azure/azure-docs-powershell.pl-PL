...
### -SamplingMode
Umożliwia włączenie i wyłączenie próbkowania w celu śledzenia rozłożonego.
...
### -SamplingRate
Określa ilość wiadomości, do których pobrano próbkę, aby dodać kontekst śledzenia.
Ta wartość jest wartością procentową.
Dozwolone są tylko wartości od 0 do 100 (włącznie).
