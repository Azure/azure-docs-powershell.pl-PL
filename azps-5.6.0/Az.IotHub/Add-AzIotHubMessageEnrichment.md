...
## OPIS
Dodaj maksymalnie 10 wzbogacania wiadomości na centrum IoT. Są one dodawane jako właściwości aplikacji do wiadomości wysyłanych do wybranych punktów końcowych.
Aby dowiedzieć się więcej, zobacz https://docs.microsoft.com/azure/iot-hub/iot-hub-message-enrichments-overview
...
Dodaj nowe wzbogacanie o klucz "newKey" i wartość "newValue". To nowe wzbogacanie jest stosowane do punktów końcowych "endpoint1" i "endpoint2".
...
### - Punkt końcowy
Punkty końcowe, do których można zastosować wzbogacenie.
