...
## OPIS
Powoduje zastosowanie zawartości konfiguracji podanych modułów do określonego urządzenia brzegowego.
Uwaga: Po wykonaniu polecenie wyprowadzi kolekcję modułów zastosowanych do urządzenia.
...
### — DeviceId
Identyfikator urządzenia target Edge.
...
### -ModulesContent
Zawartość konfiguracji modułów dla urządzeń przeglądarki IoT Edge.
