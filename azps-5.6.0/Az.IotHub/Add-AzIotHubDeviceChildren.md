...
## OPIS
Dodaj określoną listę rozdzieloną przecinkami identyfikatory urządzeń niebędące krawędzią jako dzieci określonego urządzenia brzegowego.
...
Niezależnie od tego, czy urządzenia nieo edge będą dodawać urządzenia nieo edge jako dzieci, niezależnie od tego, czy urządzenie bez krawędzi jest już urządzeniem podrzędnym innego urządzenia brzegowego.
...
### — Wymuszanie
Zastępuje urządzenie nadrzędne urządzenia niebędące krawędzią.
