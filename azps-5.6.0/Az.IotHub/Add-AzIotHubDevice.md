...
## OPIS
Utwórz urządzenie o innym typie autoryzacji w centrum IoT.
...
Utwórz urządzenie IoT z obsługą przeglądarki edge z domyślną autoryzacją (udostępniony klucz prywatny).
...
Utwórz urządzenie IoT z obsługą krawędzi i dodaj do niego urządzenia podrzędne.
...
### — Dzieci
Lista dodaj urządzenia podrzędne (oddzielone przecinkami) obejmuje tylko urządzenia inne niż edge.
...
### -PrimaryThumbprint
Jawny własny podpis usb certyfikatu do użycia jako klucz podstawowy.
