...
### Przykład 1. Usuwanie wystąpienia roli usługi w chmurze
```powershell
PS C:\> Remove-AzCloudServiceInstance -ResourceGroup "ContosOrg" -CloudServiceName "ContosoCS" -RoleInstance "ContosoFrontEnd_IN_0"
```

To polecenie usuwa wystąpienie roli o nazwie ContosoFrontEnd_IN_0 o nazwie ContosoCS, które należy do grupy zasobów o nazwie ContosOrg.
