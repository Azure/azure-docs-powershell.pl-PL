...
### Przykład 1. Uruchom ponownie wiosenną usługę w chmurze według nazwy.
```powershell
PS C:\> Restart-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default
```

Uruchom ponownie wiosenną usługę w chmurze według nazwy.

### Przykład 2. Uruchom ponownie wiosenną usługę w chmurze z potoku.
```powershell
PS C:\> Get-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default | Restart-AzSpringCloud
```

Uruchom ponownie wiosenną usługę chmury z potoku.
