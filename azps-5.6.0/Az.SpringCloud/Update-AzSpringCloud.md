...
### Przykład 1. Aktualizowanie usługi Wiosna w chmurze według nazwy.
```powershell
...
Zaktualizuj wiosenną usługę w chmurze według nazwy.

### Przykład 2. Zaktualizuj wiosenną usługę w chmurze z potoku.
```powershell
...
Zaktualizuj wiosenną usługę w chmurze z potoku.
...
### — Tag
Tagi usługi, która jest listą kluczy par wartości opisujących zasób.
...
### -TraceEnabled
Wskazuje, czy można włączyć funkcję śledzenia.
...
### Microsoft.Azure.PowerShell.cmdlet.SpringCloud.Models.Api20200701.IServiceResource
