...
### Przykład 1. Aktualizowanie wiosennego wdrożenia chmury według nazwy.
```powershell
...
Zaktualizuj wiosenne wdrożenie w chmurze według nazwy.

### Przykład 2. Zaktualizuj wiosenne wdrożenie chmury z potoku.
```powershell
...
Zaktualizuj wiosenne wdrożenie w chmurze z potoku.
...
### -SourceArtifactSelector
Selektor artefaktu, który ma być używany do wdrożenia w projektach wielo module.
Powinna to być względna ścieżka do modułu docelowego/projektu.
...
### -SourceRelativePath
Względna ścieżka magazynu, w którym jest przechowywane źródło
...
### Microsoft.Azure.PowerShell.Cmdlet.SpringCloud.Models.Api200701.IDeploymentResource
