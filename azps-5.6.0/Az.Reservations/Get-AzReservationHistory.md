...
## OPIS
Lista wszystkich poprawek `Reservation` dla.
...
Uzyskiwanie historii poprawek dla danego rezerwacji
...
### — Rezerwacja
Parametr obiektu pipety dla `Reservation` s
...
### -ReservationId
ReservationId, `Reservation` którego historia ma być wyświetlana
...
### -ReservationOrderId
ReservationOrderId dla `ReservationOrder` zawierającego `Reservation`
