...
Aktualizuje typ AppliedScopeType określonego typu `Reservation` na Wartość Single i InstanceFlexibility do wartości On.
...
### -AppliedScope
SubscriptionId tego do `Reservation` zastosowania
