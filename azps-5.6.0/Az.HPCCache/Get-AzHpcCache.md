...
## OPIS
Polecenie **cmdlet Get-AzHpcCache** pobiera jedną pamięć podręczną, pamięci podręczne w określonej grupie zasobów lub listę pamięci podręcznych dla całej subskrypcji.
