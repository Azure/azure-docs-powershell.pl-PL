...
## OPIS
Polecenie **cmdlet Remove-AzHpcCacheStorageTarget** usuwa element docelowy magazynu z pamięci podręcznej Azure HPC Cache.
...
### — Wymuszanie
Wskazuje, że polecenie cmdlet nie wyświetla monitu o potwierdzenie. Domyślnie to polecenie cmdlet wyświetla monit o potwierdzenie, że chcesz usunąć miejsce docelowe magazynu.
...
### -ResourceGroupName
Nazwa grupy zasobów, w ramach której chcesz usunąć element docelowy magazynu z pamięci podręcznej.
