...
## OPIS
Polecenie **cmdlet Stop-AzHpcCache** zatrzymuje pamięć podręczną Azure HPC Cache.
...
### — Wymuszanie
Wskazuje, że polecenie cmdlet nie wyświetla monitu o potwierdzenie. Domyślnie to polecenie cmdlet wyświetla monit o potwierdzenie, że chcesz zatrzymać pamięć podręczną.
...
### -InputObject
Obiekt pamięci podręcznej, który ma się zatrzymać.
...
### -ResourceGroupName
Nazwa grupy zasobów, w ramach której ma zostać zatrzymana pamięć podręczna.
