...
## OPIS
Polecenie **cmdlet Get-AzStreamAnalyticsFunction** pobiera listę funkcji zdefiniowanych w zadaniu usługi Azure Stream Analytics lub w informacjach o określonej funkcji.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie wszystkich funkcji analizy strumienia
```
...
### Przykład 2. Uzyskiwanie konkretnej funkcji Analiza strumienia
```
...
### — Nazwa
Określa nazwę funkcji Analiza strumienia, która będzie pobierana przez to polecenie cmdlet.
...
To polecenie cmdlet pobiera funkcje dla grupy, która określa ten parametr.
