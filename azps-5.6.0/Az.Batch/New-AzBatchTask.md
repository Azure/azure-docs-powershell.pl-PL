...
Polecenia przechowują zadania w $Task 01 i $Task 02.
...
Zadanie nie zostanie zaplanowane, dopóki wszystkie zadania zależne od tego nie zostaną pomyślnie ukończone.
...
### - JobId
Określa identyfikator zadania, na podstawie którego to polecenie cmdlet tworzy zadanie.
