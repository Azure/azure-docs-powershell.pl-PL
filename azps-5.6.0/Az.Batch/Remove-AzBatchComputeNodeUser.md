...
## OPIS
Polecenie **cmdlet Remove-AzBatchComputeNodeUser** usuwa konto użytkownika z węzła obliczeniowego partii platformy Azure.
...
To polecenie usuwa użytkownika o nazwie Użytkownik14 z węzła obliczeniowego o nazwie ComputeNode01.
Węzeł obliczeniowy znajduje się w puli o nazwie Pula01.
...
### -ComputeNodeId
Określa identyfikator węzła obliczeniowego, z którego to polecenie cmdlet usuwa konto użytkownika.
...
### — Nazwa
Określa nazwę konta użytkownika do usunięcia.
...
### - PoolId
Określa identyfikator puli zawierającej węzeł obliczeniowy, z którego ma być usunięte konto użytkownika.
