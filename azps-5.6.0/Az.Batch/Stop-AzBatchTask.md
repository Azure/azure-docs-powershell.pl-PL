...
## OPIS
Polecenie **cmdlet Stop-AzBatchTask** zatrzymuje zadanie usługi Azure Batch.
...
To polecenie zatrzymuje zadanie o identyfikatorze Zadanie23 w obszarze zadania o identyfikatorze Zadanie 000001.
...
### Przykład 2. Zatrzymywanie zadania wsadowego przy użyciu potoku
```
PS C:\>Get-AzBatchTask -JobId "Job-000001" -Id "Task26" -BatchContext $Context | Stop-AzBatchTask -BatchContext $Context
```

To polecenie pobiera zadanie Batch, które ma identyfikator Zadanie26 w zadaniu, które ma zadanie identyfikatora 0000001, za pomocą polecenia cmdlet Get-AzBatchTask identyfikatora.
...
### — Identyfikator
Określa identyfikator zadania, które ma zatrzymać to polecenie cmdlet.
...
### — Zadanie
Określa zadanie, które ma zatrzymać to polecenie cmdlet.
