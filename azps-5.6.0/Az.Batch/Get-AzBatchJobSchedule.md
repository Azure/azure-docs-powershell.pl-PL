...
## OPIS
Polecenie **cmdlet Get-AzBatchJobSchedule** pobiera harmonogramy zadań partii platformy Azure dla konta batch określonego przez *parametr BatchContext.*
Określ identyfikator, aby uzyskać pojedynczy harmonogram zadań.
Określ parametr *filtru,* aby uzyskać harmonogramy zadań zgodne z filtrem protokołu Open Data (OData).

## PRZYKŁADY

### Przykład 1. Uzyskiwanie harmonogramu zadań przez podanie identyfikatora
```
...
To polecenie pobiera harmonogram zadań z identyfikatorem Harmonogram zadań23.
Użyj Get-AzBatchAccountKey cmdlet, aby przypisać kontekst do zmiennej $Context danych.

### Przykład 2. Uzyskiwanie harmonogramów zadań przy użyciu filtru
```
...
To polecenie pobiera wszystkie harmonogramy zadań, które mają identyfikatory, których nazwy zaczynają się od zadania, przez określenie *parametru* Filtruj.
...
To polecenie cmdlet zwraca harmonogramy zadań zgodne z filtrem, który określa ten parametr.
Jeśli filtr nie zostanie określony, to polecenie cmdlet zwróci wszystkie harmonogramy zadań dla kontekstu partii.
...
### — Identyfikator
Określa identyfikator harmonogramu zadań, który otrzymuje to polecenie cmdlet.
...
### -MaxCount
Określa maksymalną liczbę harmonogramów zadań do zwrócenia.
