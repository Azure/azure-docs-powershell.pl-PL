...
## OPIS
Polecenie **cmdlet Set-AzBatchPool** aktualizuje właściwości puli w usłudze wsadowej platformy Azure.
Użyj Get-AzBatchPool cmdlet, aby uzyskać **obiekt PSCloudPool.**
...
Pierwsze polecenie uzyskuje pulę przy użyciu **get-AzBatchPool,** a następnie przechowuje ją w $Pool zmienną.
Następne trzy polecenia modyfikują specyfikację zadania rozpoczęcia na $Pool obiekt.
Ostatnie polecenie aktualizuje usługę wsadową, aby dopasować obiekt lokalny w $Pool.
...
### — Pula
Określa **usługę PSCloudPool,** do której to polecenie cmdlet aktualizuje usługę Batch.
