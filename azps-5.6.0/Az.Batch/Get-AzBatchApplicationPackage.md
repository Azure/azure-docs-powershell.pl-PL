...
### Przykład 1. Uzyskiwanie szczegółów pakietu aplikacji na koncie wsadowym
```
...
To polecenie pobiera szczegółowe informacje o wersji 1.0 pakietu Litware.

## PARAMETERS

### -AccountName
Określa nazwę konta usługi Batch, z którego to polecenie cmdlet pobiera informacje.
