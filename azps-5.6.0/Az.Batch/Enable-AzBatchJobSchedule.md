...
## OPIS
Polecenie **cmdlet Enable-AzBatchJobSchedule** umożliwia włączenie harmonogramu zadań partii platformy Azure.
Po włączeniu harmonogramu zadań można tworzyć zadania zgodnie z tym harmonogramem.
...
To polecenie umożliwia włączenie harmonogramu zadań z identyfikatorem Harmonogram zadań17.
...
### — Identyfikator
Określa identyfikator harmonogramu zadań włączane przez to polecenie cmdlet.
