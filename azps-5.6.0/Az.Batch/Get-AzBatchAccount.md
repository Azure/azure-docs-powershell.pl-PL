...
## OPIS
Polecenie **cmdlet Get-AzBatchAccount** otrzymuje konto usługi Azure Batch w bieżącej subskrypcji. Możesz użyć parametru *AccountName* w celu uzyskania jednego konta lub użyć parametru *ResourceGroupName* w celu uzyskania kont w tej grupie zasobów.
...
To polecenie pobiera konto partii o nazwie Pfuller.

### Przykład 2. Uzyskiwanie kont partii skojarzonych z grupą zasobów
```
...
To polecenie pobiera konta partii skojarzone z grupą zasobów CmdletExampleRG.
...
Jeśli określisz grupę zasobów, to polecenie cmdlet pobiera konta w określonej grupie zasobów.
...
### — Tag
Pary klucz-wartość w postaci tabeli skrótu. Na przykład: @{key0="value0";key1=$null;key2="value2"} To polecenie cmdlet pobiera konta zawierające tagi, które ten parametr określa.
