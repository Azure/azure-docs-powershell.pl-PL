...
### Przykład 1. Zatrzymywanie zadania wsadowego
```
PS C:\>Stop-AzBatchJob -Id "Job-000001" -TerminateReason "No more tasks to run" -BatchContext $Context
```

To polecenie zatrzymuje zadanie o identyfikatorze Zadanie 000001.
To polecenie określa przyczynę zatrzymania zadania.
...
### — Identyfikator
Określa identyfikator zadania, które ma być zatrzymane przez to polecenie cmdlet.
...
### - TerminateReason
Określa przyczynę zatrzymania zadania.
To polecenie cmdlet przechowuje ten tekst jako właściwość **TerminateReason** zadania.
