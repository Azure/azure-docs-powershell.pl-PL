...
Pierwsze polecenie definiuje formułę, a następnie zapisuje ją w $Formula zmienną.
Drugie polecenie umożliwia automatyczne skalowanie puli o nazwie MyPool przy użyciu formuły $Formula.

## PARAMETERS

### -AutoScaleEvaluationIntervalation
Określa czas (w minutach), który upływa przed automatycznym dostosowaniem rozmiaru puli zgodnie z formułą Autoskalowanie.
...
### — Identyfikator
Określa identyfikator obiektu puli, dla której zostanie włączyć automatyczne skalowanie.
