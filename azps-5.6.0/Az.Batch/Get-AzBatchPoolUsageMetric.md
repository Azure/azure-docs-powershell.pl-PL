...
Możesz uzyskać statystykę dla konkretnej puli i przedziału czasu.
...
Możliwe operacje to: eq, ge, gt, le, lt, startswith.
...
Określ czas co najmniej dwie i pół godziny wcześniej.
Jeśli nie określisz czasu rozpoczęcia, to polecenie cmdlet użyje ostatniego dostępnego interwału agregacji.
