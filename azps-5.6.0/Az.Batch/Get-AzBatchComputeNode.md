...
Określ parametr *PoolID lub* *Pool.*
Określ parametr *Id,* aby uzyskać pojedynczy węzeł obliczeniowy.
Określ parametr *filtru,* aby uzyskać węzły obliczeniowe zgodne z filtrem protokołu Open Data (OData).
...
To polecenie pobiera węzeł obliczeniowy o identyfikatorze tvm-2316545714_1-20150725t213220z z puli, która ma pulę identyfikatorów06.
Użyj Get-AzBatchAccountKey cmdlet, aby przypisać kontekst do zmiennej $Context danych.

### Przykład 2. Uzyskiwanie wszystkich bezczynnych węzłów obliczeniowych z puli
```
...
To polecenie pobiera wszystkie bezczynne węzły obliczeniowe znajdujące się w puli zawierającej pulę identyfikatorów 06.
Polecenie określa stan bezczynności przy użyciu *parametru Filter.*
...
To polecenie pobiera pulę o identyfikatorze Pool07 przy użyciu Get-AzBatchPool cmdlet.
Polecenie przekazuje pulę do bieżącego polecenia cmdlet przy użyciu operatora potoku.
To polecenie cmdlet pobiera wszystkie węzły obliczeniowe z tej puli.
...
To polecenie cmdlet zwraca węzły obliczeniowe zgodne z filtrem, który określa ten parametr.
Jeśli filtr nie zostanie określony, to polecenie cmdlet zwróci wszystkie węzły obliczeniowe dla puli.
...
### — Identyfikator
Określa identyfikator węzła obliczeniowego, który to polecenie cmdlet pobiera z puli.
...
### -MaxCount
Określa maksymalną liczbę węzłów obliczeniowych do zwrócenia.
...
### — Pula
Określa pulę, jako **obiekt PSCloudPool,** zawierającą węzły obliczeniowe.
Aby uzyskać obiekt **PSCloudPool,** użyj Get-AzBatchPool cmdlet.
