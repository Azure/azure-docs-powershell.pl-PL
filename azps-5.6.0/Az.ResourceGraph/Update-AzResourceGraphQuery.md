...
## SYNOPSIS
Aktualizuje zapytanie wykresu, które już zostało dodane.
...
### Przykład 1. Aktualizowanie zapytania parametryowego i tagowanie według nazwy
```powershell
...
To polecenie aktualizuje zapytanie parametryowe i tagowanie według nazwy.

### Przykład 2. Aktualizowanie pliku parametru według obiektu
```powershell
...
To polecenie aktualizuje zapytanie parametryowe i tagowanie według obiektu.
