...
### Przykład 1. Usuwanie zapytania wykresu zasobów według nazwy
```powershell
PS C:\> Remove-AzResourceGraphQuery -ResourceGroupName azure-rg-test -Name query-t03

```

To polecenie usuwa zapytanie wykresu zasobów według nazwy.

### Przykład 2. Usuwanie zapytania wykresu zasobu według obiektu
```powershell
...
To polecenie usuwa zapytanie wykresu zasobów według obiektów.
