...
## OPIS
Utwórz obiekt reprezentujący ustawienia reguły sieciowej, których można używać podczas tworzenia magazynu.
...
Tworzenie nowego magazynu i określa reguły sieciowe umożliwiające dostęp do określonego adresu IP z sieci wirtualnej wskazanej przez $myNetworkResId.
