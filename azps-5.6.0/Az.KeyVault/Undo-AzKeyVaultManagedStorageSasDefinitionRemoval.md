...
## OPIS
Polecenie **Undo-AzKeyVaultManagedStorageSasDefinitionRemoval** przywraca wcześniej usuniętą definicję SAS zarządzanego magazynu pod warunkiem, że dla tego magazynu włączono funkcję "miękkiego usuwania" i że próba odzyskania wystąpi w czasie interwału odzyskiwania.
