...
## OPIS
Ponownie generuje określony klucz zarządzanego konta magazynu platformy Azure i ustawia klucz jako klucz aktywny. Magazyn kluczy przejmuje wywołanie do usługi Azure Resource Manager w celu ponownego wygenerowania klucza. Wywołujący musi posiadać uprawnienia, aby ponownie wygenerować klucze na danym koncie magazynu platformy Azure.

## PRZYKŁADY

### Przykład 1. Ponowne generowanie klucza
```powershell
...
Ponownie generuje "klucz1" konta "mystorageaccount" i ustawia "key1" jako aktywne konto magazynu kluczy zarządzanego przez usługę Azure Storage.
...
### -KeyName
Nazwa klucza konta magazynu do ponownego wygenerowania i aktywnego działania.
