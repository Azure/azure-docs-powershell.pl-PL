...
## OPIS
Polecenie **cmdlet New-AzKeyVaultManagedHsm** tworzy zarządzany moduł HSM w określonej grupie zasobów. Aby dodać, usunąć lub dodać klucze listy w zarządzanym modelu HSM, użytkownik powinien udzielić uprawnień, dodając identyfikator użytkownika do administratora.
...
To polecenie tworzy zarządzany moduł HSM o nazwie myhsm w lokalizacji eastus2euap. To polecenie dodaje zarządzany moduł HSM do grupy zasobów o nazwie myrg1. Polecenie nie określa wartości dla parametru *SKU,* dlatego tworzy Standard_B1 HSM.
...
To polecenie tworzy zarządzany moduł HSM, podobnie jak w poprzednim przykładzie. Określa jednak wartość parametru CustomB32 dla parametru *SKU* w celu utworzenia zarządzanego modułu HSM CustomB32.

## PARAMETERS

### — Administrator
Identyfikator obiektu administratora początkowego dla tej zarządzanej puli HSM.
...
### — Lokalizacja
Określa region platformy Azure, w którym ma być tworzyć magazyn kluczy.
Użyj polecenia Get-AzResourceProvider z parametrem ProviderNamespace, aby wyświetlić dostępne opcje.
...
### — Nazwa
Określa nazwę zarządzanego modułu HSM do utworzenia.
...
### - SKU
Określa wartość SKU zarządzanego wystąpienia HSM.
