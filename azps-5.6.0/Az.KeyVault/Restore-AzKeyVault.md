...
### InteractiveStorageName (Domyślna)
```
...
## OPIS
W pełni przywraca zarządzany moduł HSM z kopii zapasowej przechowywanej na koncie magazynu.
Użyj do `Backup-AzKeyVault` tworzenia kopii zapasowej.
...
### -BackupFolder
Nazwa folderu kopii zapasowej, na przykład "mhsm-*-2020101309020403". Może też być zagnieżdżony, na przykład "kopie zapasowe/mhsm-*-2020101309020403".
...
### - SasToken
Token podpisu dostępu udostępnionego (SAS) do uwierzytelnienia konta magazynu.
...
### — StorageContainerUri
URI kontenera magazynu, w którym będzie przechowywana kopia zapasowa.
