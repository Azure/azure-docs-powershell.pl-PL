...
## OPIS
Pobiera definicję SAS magazynu zarządzanego przez magazyn kluczy, jeśli określono nazwę definicji. Jeśli nazwa definicji nie zostanie określona, zostaną wyświetlone wszystkie definicje sygnatur SAS skojarzone z określonym kontem magazynu zarządzanego magazynu kluczy w magazynie.

## PRZYKŁADY

### Przykład 1. Lista wszystkich definicji SAS magazynu zarządzanego przez magazyn kluczy
```powershell
...
Lista wszystkich definicji SAS skojarzonych z zarządzanym kontem magazynu kluczy "mystorageaccount" zarządzanym przez magazyn "myvault"

### Przykład 2. Uzyskiwanie zarządzanego konta magazynu kluczy
```powershell
...
Pobiera szczegółowe informacje o "kontach" funkcji SAS Definition skojarzonych z zarządzanym kontem magazynu magazynu kluczy "mystorageaccount" zarządzanym przez magazyn "myvault".

### Przykład 3. Lista wszystkich definicji SAS magazynu zarządzanego przez magazyn kluczy przy użyciu filtrowania
```powershell
...
Lista wszystkich definicji SAS skojarzonych z zarządzanym kontem magazynu kluczy "mystorageaccount" zarządzanym przez magazyn "myvault", które zaczynają się od "konta".
...
### -InRemovedState
Określa, czy w wynikach mają być wyświetlane definicje sygnatur SAS wcześniej usuniętych magazynów.
...
Polecenie cmdlet konstruuje nazwę FQDN definicji sas magazynu z nazwy magazynu, obecnie wybranego środowiska, nazwy konta magazynu i nazwy definicji sas.
