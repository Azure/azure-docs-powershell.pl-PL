...
Jeśli stan włączony/wyłączony nie zostanie określony, pozostanie bez zmian.
...
Jeśli ten przełącznik jest określony, zwraca obiekt pakietu zaktualizowanych kluczy.
...
### — Tag
Tabela skrótów reprezentuje tagi klucza.
