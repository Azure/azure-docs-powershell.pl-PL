...
### Przykład 1. Bezpośrednia aktualizacja zarządzanego obiektu Hsm
```powershell
...
Aktualizuje tagi zarządzanego hsm nazwanego `$hsmName` w grupie `$resourceGroupName` zasobów.

### Przykład 2. Aktualizowanie zarządzanego hsm za pomocą linii rurowych
```powershell
...
Aktualizuje tagi zarządzanego hsm przy użyciu składni linii rurowych.
...
### -ResourceId
Identyfikator zasobu zarządzanego hsm.
