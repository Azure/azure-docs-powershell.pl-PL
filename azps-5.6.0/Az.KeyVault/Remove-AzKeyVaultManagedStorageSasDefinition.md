...
## OPIS
Usuwa definicje SAS magazynu zarządzanego przez magazyn kluczy platformy Azure. Usuwa to także tajny klucz używany do uzyskania tokenu SAS na tę definicję sas.

## PRZYKŁADY

### Przykład 1. Usuwanie zarządzanej definicji SAS magazynu platformy Azure.
```powershell
...
Usuwa definicję sas sas magazynu zarządzanego magazynem magazynu "mysasdef" skojarzoną z kontem "mystorageaccount" w magazynie "myvault".

### Przykład 2. Usuwanie zarządzanej definicji SAS magazynu platformy Azure bez potwierdzenia użytkownika.
```powershell
...
Polecenie cmdlet konstruuje nazwę FQDN zarządzanego konta magazynu z nazwy magazynu, obecnie wybranego środowiska i nazwy konta magazynu.
