...
## OPIS
Polecenie **cmdlet Undo-AzKeyVaultCertificateRemoval** spowoduje odzyskanie usuniętego wcześniej certyfikatu.
Odzyskany certyfikat będzie aktywny i może być używany we wszystkich operacjach.
...
To polecenie spowoduje odzyskanie usuniętego wcześniej certyfikatu "MyCertificate" w stanie aktywnym i użytecznym.
...
### — Nazwa
Nazwa certyfikatu.
Polecenie cmdlet konstruuje nazwę FQDN certyfikatu z nazwy magazynu, obecnie wybranego środowiska i nazwy certyfikatu.
