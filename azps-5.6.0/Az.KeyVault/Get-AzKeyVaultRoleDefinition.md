...
W przykładzie wymieniono wszystkie role w zakresie "/keys".
...
W tym przykładzie jest sprawdzana rola zarządzanej kopii zapasowej HSM i sprawdzane są jej uprawnienia.
...
### -RoleDefinitionName
Nazwa definicji roli do uzyskania.
