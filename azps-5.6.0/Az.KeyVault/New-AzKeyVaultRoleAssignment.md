...
## OPIS
Użyj tego `New-AzKeyVaultRoleAssignment` polecenia, aby udzielić dostępu.
...
Przypisaną rolę należy określić przy użyciu parametru RoleDefinitionName pr RoleDefinitionId. Zakres, w którym udzielany jest dostęp, można określić. Domyślnie wybrana subskrypcja jest zaznaczona.
...
W tym przykładzie przypisano rolę "Administrator zarządzanych zasad HSM" użytkownikowi " user1@microsoft.com w górnym zakresie.
