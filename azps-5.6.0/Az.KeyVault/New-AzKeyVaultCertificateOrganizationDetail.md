...
## OPIS
Polecenie **cmdlet New-AzKeyVaultCertificateOrganizationDetail** tworzy obiekt szczegółów organizacji certyfikatu w pamięci.
...
Pierwsze polecenie tworzy obiekt szczegółów administratora certyfikatu, a następnie zapisuje go w $AdminDetails certyfikatu.
Drugie polecenie tworzy obiekt szczegółów organizacji certyfikatu, a następnie zapisuje go w $OrgDetails danych.

## PARAMETERS

### -AdministratorDetails
Określa administratorów organizacji certyfikatu.
...
### System.Collections.generic.List'1[[Microsoft.Azure.Commands.KeyVault.Models.PSKeyVaultCertificateAdministratorDetails, Microsoft.Azure.PowerShell.Cmdlet.KeyVault, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]]
