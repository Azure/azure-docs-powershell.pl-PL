...
## OPIS
Polecenie **Undo-AzKeyVaultManagedStorageAccountRemoval** umożliwia odzyskanie poprzednio usuniętego zarządzanego konta magazynu pod warunkiem, że dla tego magazynu włączono funkcję "miękkiego usuwania" i że próba odzyskania wystąpi w interwale odzyskiwania.
...
Ta sekwencja poleceń określa, czy określone konto magazynu istnieje w magazynie w stanie usunięcia. Kolejne polecenie przywraca usunięte konto magazynu i przywraca je do stanu aktywnego.
...
### -InputObject
Usunięto obiekt Konta magazynu zarządzanego
...
Polecenie cmdlet konstruuje nazwę FQDN obiektu docelowego z nazwy magazynu, obecnie wybranego środowiska i nazwy konta magazynu zarządzanego.
