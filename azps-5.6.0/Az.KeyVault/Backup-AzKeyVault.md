...
Polecenie cmdlet utworzy folder (o nazwie zwykle nazywanej) w kontenerze magazynu, przechowa kopię zapasową w tym folderze i `mhsm-{name}-{timestamp}` wyprowadzi URI folderu.
