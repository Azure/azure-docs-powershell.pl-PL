...
## OPIS
Polecenie **Update-AzKeyVaultNetworkRuleSet** aktualizuje reguły sieciowe obowiązujące w określonym magazynie kluczy. 
...
To polecenie aktualizuje zestaw reguł sieciowych w magazynie o nazwie "myVault" dla określonego zakresu adresów IP i sieci wirtualnej, co pozwala na pominięcie reguły sieciowej dla usług Azure.

### Przykład 2

Aktualizuje zestaw reguł sieciowych w magazynie kluczy. (wygenerowane automatycznie)
...
Jeśli ten przełącznik jest określony, zwraca obiekt zaktualizowanego magazynu kluczy.
...
### System.Nullable'1[[Microsoft.Azure.Commands.KeyVault.Models.PSKeyVaultNetworkRuleDefaultActionEnum, Microsoft.Azure.PowerShell.Cmdlet.KeyVault, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]]

### System.Nullable'1[[Microsoft.Azure.Commands.KeyVault.Models.PSKeyVaultNetworkRuleBypassEnum, Microsoft.Azure.PowerShell.Cmdlet.KeyVault, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]]
