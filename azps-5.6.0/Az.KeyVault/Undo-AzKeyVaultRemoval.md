...
To polecenie spowoduje odzyskanie magazynu kluczy "MyKeyVault", który został wcześniej usunięty z regionu Eastus2 i grupy zasobów "MyResourceGroup", w stanie aktywnym i użytecznym. Ponadto zastępuje tagi nowym tagiem.
...
### — Lokalizacja
Określa oryginalny magazyn usunięty na platformie Azure.
