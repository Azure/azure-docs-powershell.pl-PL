...
## OPIS
Polecenie **cmdlet Get-AzKeyVaultCertificatePolicy** pobiera zasady dla certyfikatu w magazynie kluczy w magazynie kluczy platformy Azure.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie zasad certyfikatu
```powershell
...
To polecenie pobiera zasady certyfikatu TestCert01 w magazynie kluczy ContosoKV01.
