...
### Przykład 1. Uzyskiwanie poświadczeń administratora chmury prywatnej
```powershell
...
Uzyskiwanie poświadczeń administratora chmury prywatnej
...
### Microsoft.Azure.PowerShell.Cmdlet.VMWare.Models.Api20200320.IAdminCredentials
