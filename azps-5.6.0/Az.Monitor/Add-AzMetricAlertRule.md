...
## SYNOPSIS
Dodaje lub aktualizuje regułę alertów opartą na metrykach.
...
## OPIS
Polecenie **cmdlet Add-AzMetricAlertRule** dodaje lub aktualizuje regułę alertu opartą na metryki.
...
### Przykład 1. Dodawanie reguły alertu metryczne do witryny sieci Web
```
...
To polecenie tworzy regułę alertu metryczne dla witryny sieci Web.
...
Jeśli reguła nie istnieje, zostanie wyłączona.
Jeśli reguła istnieje, zostanie ona po prostu zablokowana.

### Przykład 3. Dodawanie reguły z akcjami
```
...
### — Akcja
Określa rozdzieloną przecinkami listę akcji.
...
### -DisableRule
Wyłącza regułę.
Jeśli nie określisz tego parametru, reguła zostanie włączona.
...
### — Lokalizacja
Określa lokalizację, w której jest zdefiniowana reguła.
...
### -MetricName
Określa nazwę metryki, która jest monitorowana przez regułę.
Określ ten parametr tylko dla reguł opartych na metrykach.
...
### -Operator
Określa operator relacyjnych warunku reguły.
...
### -ResourceGroupName
Określa nazwę grupy zasobów reguły.
...
### -TargetResourceId
Określa identyfikator zasobu, który jest monitorowyny przez regułę. UWAGA: Tej właściwości nie można zaktualizować dla istniejącej reguły alertu.
...
Określa operator agregacji do zastosowania w oknie czasowym podczas oceny reguły.
...
### -WindowSize
Określa rozmiar okna czasowego reguły obliczania danych.
...
### System.Nullable'1[[Microsoft.Azure.Management.Monitor.Management.Models.TimeAggregationOperator, Microsoft.Azure.PowerShell.Cmdlet.Monitor, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]]

### System.Management.Automation.SwitchParameters

### System.Collections.generic.List'1[[Microsoft.Azure.Management.Monitor.Management.Models.RuleAction, Microsoft.Azure.PowerShell.Cmdlet.Monitor, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]]
