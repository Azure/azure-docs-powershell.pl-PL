...
## OPIS
Polecenie **cmdlet Get-AzMetricAlertRuleV2** pobiera metryczną regułę alertu na podstawie jego nazwy lub URI albo wszystkich reguł alertów metrycznych z określonej grupy zasobów lub subskrypcji.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie wszystkich reguł alertów metrycznych w bieżącej subskrypcji
```powershell
...
### Przykład 2. Uzyskiwanie wszystkich reguł alertów metrycznych w grupie zasobów
...
To polecenie pobiera wszystkie reguły alertów metrycznych w grupie zasobów o nazwie metricAlertsRG.

### Przykład 3. Uzyskiwanie metryczna reguła alertu według nazwy
...
To polecenie pobiera regułę alertu metryki o nazwie PS3182019 w grupie zasobów o nazwie metryczneAlertsRG.

### Przykład 4. Uzyskiwanie reguły alertu metryczne za pomocą reguły RULEID
...
To polecenie pobiera regułę alertu metryczne z identyfikatorem danego zasobu.
...
### -ResourceId
Identyfikator reguły reguły metrycznych alertów
