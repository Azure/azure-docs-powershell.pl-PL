...
### Przykład 1. Uzyskiwanie wszystkich zdarzeń skojarzonych z subskrypcją
```
PS C:\>Get-AzAutoscaleHistory -StartTime 2015-02-09T18:35:00 -EndTime 2015-02-09T18:40:00 -DetailedOutput
```

To polecenie pobiera wszystkie zdarzenia związane z autoskalowaniem skojarzone z bieżącą subskrypcją.

### Przykład 2. Funkcja GetAutoscaleHistory dla określonego zasobu
```
...
To polecenie pobiera wszystkie zdarzenia związane z automatycznym skalą skojarzone z określonym zasobem zidentyfikowanym za pomocą identyfikatora zasobu (w zasadzie identyfikatora ResourceUri).
...
### -ResourceId
Określa identyfikator zasobu, z którym jest skojarzone ustawienie automatycznego skalowania.
...
### — Status
Określa filtr według stanu.
Ten parametr jest opcjonalny.
Błąd jest pustym ciągiem (tzn. bez filtru)
