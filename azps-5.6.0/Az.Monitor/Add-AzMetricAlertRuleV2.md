...
## OPIS
Dodaje lub aktualizuje regułę alertu opartą na metryce **(nieistnieczną) V2.** Dodana reguła jest skojarzona z grupą zasobów i ma nazwę. To polecenie cmdlet implementuje wzorzec ShouldProcess, czyli może wymagać potwierdzenia od użytkownika przed utworzeniem, zmodyfikowaniem lub usunięciem zasobu.
