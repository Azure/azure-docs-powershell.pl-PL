...
### Przykład 2. Usuwanie alertu dziennika aktywności przy użyciu danych wejściowych PSActivityLogAlertResource
```
...
Usuwa alert dziennika aktywności, używając jako danych wejściowych raportu PSActivityLogAlertResource.
