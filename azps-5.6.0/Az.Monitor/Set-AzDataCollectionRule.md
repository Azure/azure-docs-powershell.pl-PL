...
## SYNOPSIS
Aktualizuje (zastępuje) regułę zbierania danych.
...
## OPIS
Polecenie **cmdlet Set-AzDataCollectionRule** zastępuje istniejącą regułę zbierania danych.
...
Tutaj możesz znaleźć [szczegóły schematu.](https://docs.microsoft.com/rest/api/monitor/datacollectionrules/create)

Dane wyjściowe dcr serializowane za pomocą polecenia cmdlet ConvertTo-Json (przykład #2).

## PRZYKŁADY

### Przykład 1. Aktualizowanie reguły zbierania danych, JSON z interfejsu API rest
```powershell
...
To polecenie zastępuje istniejące reguły zbierania danych dla bieżącej subskrypcji.

### Przykład 2. Aktualizowanie reguły zbierania danych, JSON z usługi PSDataCollectionRuleResource
```powershell
PS C:\>Set-AzDataCollectionRule -Location 'East US 2 EUAP'
...
### Przykład 3. Aktualizowanie reguły zbierania danych z obiektu
```powershell
