...
## OPIS
Polecenie **cmdlet Get-AzMetricDefinition** pobiera definicje metryczne.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie definicji metrycznych dla zasobu
```
...
To polecenie pobiera definicje metryk dla określonego zasobu.

### Przykład 2. Uzyskiwanie definicji metrycznych ze szczegółowymi danymi wyjściowym
```
...
To polecenie pobiera definicje metryk dla witryny sieci Web 2.
Dane wyjściowe są szczegółowe.

### Przykład 3. Uzyskiwanie definicji metrycznych według nazwy
```
...
To polecenie pobiera definicje metryk BytesSent i CpuTime.
Dane wyjściowe są szczegółowe.
...
### -DetailedOutput
Oznacza, że ta operacja uwzględniała szczegółowe dane wyjściowe.
Jeśli nie określisz tego parametru, dane wyjściowe będą podsumowywane.
...
### -MetricNamespace
Określa metryczna przestrzeń nazw, dla których mają być kwerendne definicje metryk.
