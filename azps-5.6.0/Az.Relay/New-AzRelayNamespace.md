...
## OPIS
Polecenie **cmdlet New-AzRelayNamespace** tworzy nową przestrzeń nazw relay. Po utworzeniu manifestu zasobu przestrzeni nazw jest nieumiejętny.
...
Tworzy nową przestrzeń nazw Przekazywanie w obrębie określonej grupy zasobów.
...
### — Lokalizacja
Lokalizacja przestrzeni nazw przekazywania.
...
### — Nazwa
Nazwa przestrzeni nazw przekazywania.
