...
Ponowne generowanie podstawowych lub pomocniczych ciągów połączenia dla danej Relay-Namespace encji.
...
Ponowne generowanie podstawowych lub pomocniczych ciągów połączenia dla encji przekazywania (Przestrzeń nazw/WcfRelay/HybridConnection).
