...
## OPIS
Polecenie **cmdlet Get-AzRelayKey** zwraca podstawowe i pomocnicze parametry połączenia dla danych obiektów przekazywania (Przestrzeń nazw/WcfRelay/HybridConnection).
...
Podstawowe i pomocnicze ciągi połączenia do określonych obiektów przekazywania (Przestrzeń nazw/WcfRelay/HybridConnection).
