...
### -CertificateType
Typ certyfikatu używanego do bezpiecznego połączenia z frontendEndpoint
...
### -ProtocolType
Protokół rozszerzenia TLS używany do bezpiecznego dostarczania
...
Czy chcesz zezwolić na chciwość sesji na tym hoście.
...
TTL to use in seconds for session affinity, if applicable. Wartość domyślna to 0
