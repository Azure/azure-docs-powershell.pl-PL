...
Użyj polecenia cmdlet "New-AzFrontDoorRulesEngineActionObject", aby utworzyć obiekt PSRulesEngineAction w celu przekazania do parametru "-Action".
Użyj polecenia cmdlet "New-AzFrontDoorRulesEngineMatchConditionObject", aby utworzyć obiekt PSRulesEngineMatchCondition w celu przekazania do parametru "-MatchCondition".
...
Utwórz nowy obiekt PSRulesEngineRule i zademonstruj, jak wyświetlić podpola.
...
Oczekiwanie wyniku podczas przekazywania wartości nieprawidłowego priorytetu.

## PARAMETERS

### — Akcja
Akcje do wykonania w związku z żądaniem i odpowiedzią, jeśli są spełnione wszystkie warunki.
...
### - MatchCondition
Lista warunków dopasowania, które muszą zostać spełnione, aby działania tej reguły były uruchamiane. Brak dopasowania oznacza, że akcje będą zawsze uruchamiane.
...
Jeśli ta reguła jest zgodne, aparat reguł powinien nadal uruchamiać pozostałe reguły lub je zatrzymać.
Dopuszczalne wartości to Continue (Kontynuuj) i Stop (Zatrzymaj).
Jeśli nie jest obecna, domyślnie jest to ciąg Kontynuuj.
