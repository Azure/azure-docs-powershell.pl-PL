...
### — Przekształcanie
Lista przekształceń, które są stosowane przed ich dopasowaniem. Możliwe wartości poszczególnych przekształceń to Małe litery, Wielkie litery, Trim, UrlDecode, UrlEncode, RemoveNulls.
