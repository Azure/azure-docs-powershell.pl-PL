...
Dodatkowe opóźnienie (w milisekundach) dla chętnych należy do zasobnika z najmniejszymi opóźnieniami. Wartość domyślna to 0
...
### - SampleSize
Liczba próbek do rozważenia w celu podejmowania decyzji dotyczących równoważenia obciążenia.
...
Liczba próbek w okresie próbek, które muszą zakończyć się powodzeniem Wartość domyślna wynosi 2
