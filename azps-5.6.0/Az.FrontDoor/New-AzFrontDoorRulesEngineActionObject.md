...
Użyj polecenia cmdlet "New-AzFrontDoorHeaderActionObject", aby utworzyć zapytania PSHeaderObjects w celu przekazania do parametrów "-RequestHeaderActions" i "-ResponseHeaderActions".
...
### -BackendPoolName
Nazwa buforu backendpool, do którego ta reguła jest przekierowy łana
...
Pierwsze ?
i & zostaną dodane automatycznie, więc nie dołączaj ich z przodu, ale oddzielaj wiele ciągów zapytań za pomocą &.
...
### -EnableCaching
Czy należy włączyć buforowanie dla tej trasy.
...
### -ForwardingProtocol
Protokół, który ta reguła będzie stosować podczas przesyłania ruchu dalej do zaplecza.
...
### -RedirectType
Podczas przekierowywania ruchu wpisz regułę przekierowywania.
Wartość domyślna jest przenoszony
...
### -RequestHeaderAction
Lista akcji nagłówków, które mają być stosowane w żądaniu od afd do pochodzenia.
...
Lista akcji nagłówka do zastosowania w odpowiedzi z programu AFD do klienta.
