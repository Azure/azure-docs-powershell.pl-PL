...
## OPIS
Polecenie **cmdlet Sync-AzMediaServiceStorageKey** synchronizuje klucze konta magazynu dla konta magazynu skojarzonego z usługą multimedialną.
...
Pierwsze polecenie używa polecenia cmdlet Get-AzStorageAccount w celu uzyskania konta magazynu o nazwie Storage135, które należy do grupy ResourceGroup001, i przechowuje wynik w zmiennej o nazwie $StorageAccount.
Drugie polecenie synchronizuje klucze konta magazynu dla usługi multimediów o  nazwie MediaService001 przy użyciu właściwości Identyfikator zawartej w zmiennej $StorageAccount magazynu.

## PARAMETERS

### -AccountName
Określa nazwę usługi multimediów, która będzie synchronizowana przez to polecenie cmdlet.
...
### - StorageAccountId
Określa identyfikator konta magazynu skojarzonego z kontem usługi multimediów.
