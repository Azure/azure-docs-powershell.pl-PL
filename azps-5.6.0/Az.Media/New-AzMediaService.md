...
Jeśli usługa multimediów już istnieje, to polecenie cmdlet zaktualizuj jego właściwości.

## PRZYKŁADY

### Przykład1. Tworzenie usługi multimediów tylko z podstawowym kontem magazynu
```
PS C:\># Variables
## Global
...
W tym przykładzie pokazano, jak utworzyć usługę multimediów z określeniem tylko podstawowego konta magazynu.
W tym skrypcie jest używane kilka innych cmdlet.

### Przykład 2. Tworzenie usługi multimediów z wieloma magazynami
```
PS C:\># Variables
...
W tym przykładzie pokazano, jak utworzyć usługę multimediów z wieloma kontami magazynu.
W tym skrypcie jest używane kilka innych cmdlet.

## PARAMETERS

### -AccountName
Określa nazwę usługi multimediów, która jest owana przez to polecenie cmdlet.
...
### — Lokalizacja
Określa region, w który to polecenie cmdlet tworzy usługę multimediów.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, do których jest przypisana usługa multimediów.
...
### - StorageAccountId
Określa konto magazynu skojarzone z kontem usługi multimediów.
...
### — StorageAccounts
Określa tablicę kont magazynu do skojarzenia z usługą multimedialną.
...
### — Tag
Tagi skojarzone z kontem usługi multimediów.
