...
Tworzy definicję rejestracji według wartości roleDefinitionId i principalId podanych bezpośrednio.
...
Tworzy lub aktualizuje definicję rejestracji za pomocą szczegółów autoryzacji.
...
Aktualizuje definicję rejestracji ze szczegółami autoryzacji i nazwą definicji rejestracji.

## PARAMETERS

### — Autoryzacja
Lista mapowania autoryzacji z wartością principalId — roleDefinitionId.
...
### -ManagedByTenantId
Identyfikator dzierżawy zarządzanej przez.
...
### -RoleDefinitionId
Identyfikator definicji roli do udzielania uprawnień do identyfikatora głównego.
