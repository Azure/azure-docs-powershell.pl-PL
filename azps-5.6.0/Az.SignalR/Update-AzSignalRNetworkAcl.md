...
### -DefaultAction
Domyślna akcja acl sieci signalr ( zezwalaj lub odmów). Decyduje ona, czy ACL sieci są odrzucane, czy zezwalają na ich skutek. Jeśli na przykład akcja domyślna jest zezwalana, ważne są tylko acla odmów.
