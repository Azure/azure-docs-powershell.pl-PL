...
## OPIS
To polecenie tworzy punkt końcowy chmury synchronizacji plików platformy Azure. Punkt końcowy chmury jest odwołaniem do istniejącego udziału plików platformy Azure. Reprezentuje on udział plików i definiuje jego udział w synchronizacji wszystkich plików w grupie synchronizacji, w których utworzono punkt końcowy w chmurze.
...
Punkt końcowy chmury jest integralnym elementem grupy synchronizacji. Jest to przykład tworzenia punktu wewnątrz istniejącej grupy synchronizacji o nazwie "mySyncGroupName".
...
### — Nazwa
Nazwa punktu końcowego chmury. Po utworzeniu za pośrednictwem portalu Azure nazwa jest ustawiana jako nazwa pliku platformy Azure, do których się odwołuje.
