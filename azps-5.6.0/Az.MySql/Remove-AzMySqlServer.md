...
### Przykład 1. Usuwanie serwera MySql według nazwy serwera i grupy zasobów
```powershell
PS C:\> Remove-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

To polecenie cmdlet usuwa serwer MySql według nazwy serwera i grupy zasobów.

### Przykład 2. Usuwanie serwera MySql za pomocą tożsamości
```powershell
...
Te polecenia cmdlet usuwają serwer MySql za pomocą tożsamości.
