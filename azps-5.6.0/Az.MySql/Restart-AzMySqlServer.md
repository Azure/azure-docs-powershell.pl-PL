...
### Przykład 1. Ponowne uruchamianie serwera MySql według nazwy grupy zasobów i serwera
```powershell
PS C:\> Restart-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

To polecenie cmdlet powoduje ponowne uruchomienie serwera MySql według nazwy grupy zasobów i serwera.

### Przykład 2. Ponowne uruchamianie serwera MySql według tożsamości
```powershell
...
Te polecenia cmdlet ponownie uruchamiają serwer MySql według tożsamości.
