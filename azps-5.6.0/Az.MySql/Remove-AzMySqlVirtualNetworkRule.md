...
### Przykład 2. Usuwanie reguły wirtualnej sieci serwera MySql za pomocą tożsamości
```powershell
...
Te polecenia cmdlet usuwają regułę wirtualnej sieci na serwerze MySql za pomocą tożsamości.
