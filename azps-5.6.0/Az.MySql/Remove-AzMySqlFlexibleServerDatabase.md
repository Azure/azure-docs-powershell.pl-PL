...
### Przykład 1. Usuwanie bazy danych MySql według nazwy
```powershell
PS C:\> Remove-AzMySqlFlexibleServerDatabase -Name databasetest -ResourceGroupName PowershellMySqlTest -ServerName mysql-test
```

To polecenie cmdlet usuwa bazę danych MySql według nazwy.

### Przykład 2. Usuwanie bazy danych MySql za pomocą tożsamości
```powershell
...
Te polecenia cmdlet usuwają bazę danych MySql według tożsamości.
