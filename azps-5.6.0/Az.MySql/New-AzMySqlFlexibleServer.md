...
Domyślne wartości lokalizacji to Zachód Stanów Zjednoczonych 2, SKU to Standard_B1ms, warstwa SKU może być seriami, a rozmiar magazynu to 10GiB.
...
To polecenie cmdlet tworzy elastyczny serwer MySql z identyfikatorem sieci vnet lub nazwą sieci vnet podaną przez użytkownika.
