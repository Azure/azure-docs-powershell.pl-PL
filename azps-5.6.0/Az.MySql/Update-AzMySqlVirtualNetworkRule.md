...
### Przykład 1. Aktualizowanie reguły wirtualnej sieci MySql według nazwy
```powershell
...
To polecenie cmdlet aktualizuje wirtualną regułę sieci mysql według nazwy.

### Przykład 2. Aktualizowanie reguły sieci wirtualnej MySql przez tożsamość.
```powershell
...
Te polecenia cmdlet aktualizują wirtualną regułę sieci MySql według tożsamości.
