...
### Przykład 1. Uzyskiwanie bazy danych MySql według nazwy zasobu
```powershell
...
To polecenie cmdlet pobiera serwer MySql według nazwy zasobu.

### Przykład 2. Uzyskiwanie baz danych MySql według tożsamości
```powershell
...
To polecenie cmdlet uzyskuje serwer MySql według tożsamości.

### Przykład 3. Lista wszystkich baz danych MySql na określonym serwerze
```powershell
...
To polecenie cmdlet wyświetla listę wszystkich serwerów MySql w określonym serwerze.
...
### Microsoft.Azure.PowerShell.cmdlet.mySql.models.api20171201.iDatabase
