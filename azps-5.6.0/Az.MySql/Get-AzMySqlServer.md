...
To polecenie cmdlet pobiera serwer MySql z kontekstem domyślnym.
...
To polecenie cmdlet pobiera serwer MySql według nazwy grupy zasobów i serwera.
...
Te listy polecenia cmdlet pobierają serwer MySql według tożsamości.
