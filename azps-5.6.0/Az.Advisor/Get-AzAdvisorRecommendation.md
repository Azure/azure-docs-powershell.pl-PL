...
## SYNOPSIS
Otrzymuje listę zaleceń dotyczących usługi Azure Advisor.
...
## OPIS
Uzyskuje listę zaleceń dla doradcy platformy Azure. Można filtrować według kategorii, identyfikatora zasobu, nazwy itp.
...
Type                 : Microsoft.Advisor/recommendations
```
Pobiera listę wszystkich zaleceń filtrowanych według kategorii Wydajność.
