...
## SYNOPSIS
Uzyskaj konfiguracje doradcy platformy Azure dla danej subskrypcji lub grupy zasobów.
...
## OPIS
Konfiguracje skojarzone z subskrypcją mają dwa typy:

Konfiguracja na poziomie subskrypcji: Dla subskrypcji może być tylko jedna konfiguracja tego typu. Jedynymi właściwościami tego typu konfiguracji są LowCpuThreshold i Exclude.

Konfiguracja na poziomie grupy zasobów: Dla każdej grupy zasobów w subskrypcji może być tylko jedna konfiguracja. Jedyną właściwością tego typu konfiguracji jest Wyklucz.
...
```
Pobiera listę konfiguracji doradców platformy Azure.
