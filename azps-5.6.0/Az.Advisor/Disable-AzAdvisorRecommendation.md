...
## SYNOPSIS
Wyłącz zalecenie doradcy platformy Azure.

## SKŁADNIA

### IdParameterSet (domyślne)
```
...
## OPIS
Tworzy polecanie, co umożliwia odłożenie określonego zalecenia o określony czas trwania lub w nieskończoność.
...
Utwórz polecaną nazwę z wartością domyślną NazwaDomowy i domyślne dni na wartości -1.
...
Utworzono pochłoną to zalecenie.
...
Tworzenie wytłaczyń z programu Get-AzAdvisorRecommendation do disable-azAdvisorRecommendation.
