...
## OPIS
Polecenie Get-AzContainerRegistryCredential cmdlet pobiera poświadczenia logowania dla rejestru kontenera.
...
Aby uzyskać poświadczenia logowania, użytkownik administrator musi mieć włączony kontener rejestru \` MyRegistry. \`
