...
## OPIS
Polecenie Update-AzContainerRegistryWebhook cmdlet aktualizuje webhook rejestru kontenera.

## PRZYKŁADY

### Przykład 1. Aktualizowanie istniejącego kontenera rejestru webhook.
```powershell
...
Aktualizowanie istniejącego kontenera rejestru webhook.
...
### — Nagłówek
Nagłówki niestandardowe oddzielone spacjami w formacie "klucz \[ \] =wartość", które zostaną dodane do powiadomień aplikacji WebHook.
...
### — Tag
Tagi oddzielone spacjami w \[ formacie "key \] =value".
