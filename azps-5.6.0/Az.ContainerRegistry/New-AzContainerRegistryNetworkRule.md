...
## OPIS
Tworzenie obiektu reguły sieciowej w bieżącej sesji programu PowerShell.
...
Tworzenie zestawu reguł w sieci wirtualnej.

## PARAMETERS

### — Akcja
Działanie reguły sieciowej.
...
### -IPAddressOrRange
Określa zakres adresów IP lub IP w formacie CIDR.
Dozwolony jest tylko adres IPV4.
...
### -IPRule
Wskaż, aby utworzyć adres IPRule.
...
Identyfikator zasobu podsieci, na przykład: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/subnets/{subnetName}.
...
### — VirtualNetworkRule
Wskaż, aby utworzyć virtualNetworkRule.
