...
## OPIS
Polecenie Update-AzContainerRegistryCredential ponownie generuje poświadczenia logowania dla rejestru kontenera.

## PRZYKŁADY

### Przykład 1. Ponowne generowanie poświadczeń logowania dla rejestru kontenera
```powershell
...
To polecenie ponownie generuje poświadczenia logowania dla określonego rejestru kontenera.
Aby generować poświadczenia logowania, użytkownik administrator musi mieć włączony kontener rejestru \` MyRegistry. \`
...
Dozwolone wartości: hasło, hasło2.
