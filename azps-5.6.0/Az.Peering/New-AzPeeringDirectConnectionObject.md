...
Tworzenie bezpośredniego połączenia komunikacji równorzędnej przy włączonej usłudze komunikacji równorzędnej i adresach IP dostarczonych przez firmę Microsoft
...
Tworzenie bezpośredniego połączenia równorzędnego z użyciem na poziomie włączonej usługi komunikacji równorzędnej i adresów IP dostarczonych przez współpracowników
...
Tworzenie bezpośredniego połączenia komunikacji równorzędnej bez adresów IP sesji bgp. Aby można było skonfigurować sesję bgp, współpracownik będzie musiał ustawić adresy IP.

## PARAMETERS

### - BandwidthInMbps
Przepustowość dostępna w tej lokalizacji w mb/s.
...
### -MaxPrefixesAdvertvertpv4
Maksymalna anonsowana wartość IPv4
...
Włącz flagę informacąc firmę Microsoft o podaniem adresów sesji BGP.
...
Włącz możliwość używania z usługą komunikacji równorzędnej firmy Microsoft (MPS).
