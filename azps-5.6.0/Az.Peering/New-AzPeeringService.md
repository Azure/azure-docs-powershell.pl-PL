...
## OPIS
Tworzy usługę komunikacji równorzędnej.
...
Tworzy obiekt usługi komunikacji równorzędnej z dostawcą i lokalizacją komunikacji równorzędnej. Używanie w sprzężęcie z `Get-AzPeeringServiceProvider` i `Get-AzPeeringServiceLocation`
...
### -PeeringLocation
Lokalizacja fizyczna inna niż region platformy Azure. Użyj Get-AzPeeringServiceLocation [-Country] <country>
...
Nazwa usługodawca komunikacji równorzędnej.
Używanie Get-AzPeeringServiceProvider cmdlet dla listy
...
### — Tag
Tagi do skojarzenia z usługą Microsoft InputObject.
