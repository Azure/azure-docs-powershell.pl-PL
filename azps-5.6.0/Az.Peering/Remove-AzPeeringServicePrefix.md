...
## OPIS
Usuwa prefiks usługi komunikacji równorzędnej z usługi komunikacji równorzędnej.
...
Usuwanie prefiksu z obiektu usługi komunikacji równorzędnej
...
Usuwanie prefiksu z identyfikatora zasobu usługi komunikacji równorzędnej.
...
Usuwanie prefiksu z nazwy i nazwy grupy zasobów usługi komunikacji równorzędnej
...
### -InputObject
Używanie Get-AzPeeringServicePrefix
...
### -PassThru
Zwraca wartość prawda dla sukcesu lub fałsz dla błędu.
