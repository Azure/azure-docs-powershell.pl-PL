...
## OPIS
Pobiera komunikacji równorzędne z subskrypcji, grupy zasobów lub według nazwy.
...
Nazywa się komunikacja równorzędna programu Exchange `myExchangePeering1`
...
Pobiera nazwę komunikacji równorzędnej programu Exchange `myExchangePeering1` na podstawie identyfikatora zasobu.
