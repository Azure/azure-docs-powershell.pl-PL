...
## SYNOPSIS
Otrzymuje alerty zabezpieczeń wykryte przez Azure Security Center
...
Pobiera wszystkie alerty zabezpieczeń, które zostały wykryte w zasobach w ramach subskrypcji
...
Pobiera wszystkie alerty zabezpieczeń, które zostały wykryte w zasobach w grupie zasobów "mojaService1".
...
Pobiera określony alert zabezpieczeń, który został wykryty dla zasobów w grupie zasobów "mojaService1".
