...
ms.locfileid: "101979345"
---
# <span data-ttu-id="c9ef8-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="c9ef8-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="c9ef8-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="c9ef8-102">SYNOPSIS</span></span>
<span data-ttu-id="c9ef8-103">Otrzymuje alerty zabezpieczeń wykryte przez Azure Security Center</span><span class="sxs-lookup"><span data-stu-id="c9ef8-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="c9ef8-104">SKŁADNIA</span><span class="sxs-lookup"><span data-stu-id="c9ef8-104">SYNTAX</span></span>

### <span data-ttu-id="c9ef8-105">SubscriptionScope (domyślne)</span><span class="sxs-lookup"><span data-stu-id="c9ef8-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="c9ef8-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="c9ef8-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="c9ef8-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="c9ef8-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="c9ef8-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="c9ef8-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="c9ef8-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="c9ef8-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="c9ef8-110">OPIS</span><span class="sxs-lookup"><span data-stu-id="c9ef8-110">DESCRIPTION</span></span>
<span data-ttu-id="c9ef8-111">Otrzymuje alerty zabezpieczeń wykryte przez Azure Security Center</span><span class="sxs-lookup"><span data-stu-id="c9ef8-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="c9ef8-112">PRZYKŁADY</span><span class="sxs-lookup"><span data-stu-id="c9ef8-112">EXAMPLES</span></span>

### <span data-ttu-id="c9ef8-113">Przykład 1</span><span class="sxs-lookup"><span data-stu-id="c9ef8-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="c9ef8-114">Pobiera wszystkie alerty zabezpieczeń, które zostały wykryte w zasobach w ramach subskrypcji</span><span class="sxs-lookup"><span data-stu-id="c9ef8-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="c9ef8-115">Przykład 2</span><span class="sxs-lookup"><span data-stu-id="c9ef8-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="c9ef8-116">Pobiera wszystkie alerty zabezpieczeń, które zostały wykryte w zasobach w grupie zasobów "mojaService1".</span><span class="sxs-lookup"><span data-stu-id="c9ef8-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="c9ef8-117">Przykład 3</span><span class="sxs-lookup"><span data-stu-id="c9ef8-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="c9ef8-118">Pobiera określony alert zabezpieczeń, który został wykryty dla zasobów w grupie zasobów "mojaService1".</span><span class="sxs-lookup"><span data-stu-id="c9ef8-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="c9ef8-119">PARAMETERS</span><span class="sxs-lookup"><span data-stu-id="c9ef8-119">PARAMETERS</span></span>

### <span data-ttu-id="c9ef8-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="c9ef8-120">-DefaultProfile</span></span>
<span data-ttu-id="c9ef8-121">Poświadczenia, konto, dzierżawa i subskrypcja używane do komunikacji z platformą Azure.</span><span class="sxs-lookup"><span data-stu-id="c9ef8-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="c9ef8-122">— Lokalizacja</span><span class="sxs-lookup"><span data-stu-id="c9ef8-122">-Location</span></span>
<span data-ttu-id="c9ef8-123">Lokalizacja.</span><span class="sxs-lookup"><span data-stu-id="c9ef8-123">Location.</span></span>
...
### <span data-ttu-id="c9ef8-124">— Nazwa</span><span class="sxs-lookup"><span data-stu-id="c9ef8-124">-Name</span></span>
<span data-ttu-id="c9ef8-125">Nazwa zasobu.</span><span class="sxs-lookup"><span data-stu-id="c9ef8-125">Resource name.</span></span>
...
### <span data-ttu-id="c9ef8-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="c9ef8-126">-ResourceGroupName</span></span>
<span data-ttu-id="c9ef8-127">Nazwa grupy zasobów.</span><span class="sxs-lookup"><span data-stu-id="c9ef8-127">Resource group name.</span></span>
...
### <span data-ttu-id="c9ef8-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="c9ef8-128">-ResourceId</span></span>
<span data-ttu-id="c9ef8-129">Identyfikator zasobu.</span><span class="sxs-lookup"><span data-stu-id="c9ef8-129">Resource ID.</span></span>
...
### <span data-ttu-id="c9ef8-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="c9ef8-130">CommonParameters</span></span>
<span data-ttu-id="c9ef8-131">To polecenie cmdlet obsługuje typowe parametry: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction i -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="c9ef8-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="c9ef8-132">Aby uzyskać więcej informacji, zobacz [about_CommonParameters.](http://go.microsoft.com/fwlink/?LinkID=113216)</span><span class="sxs-lookup"><span data-stu-id="c9ef8-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="c9ef8-133">DANE WEJŚCIOWE</span><span class="sxs-lookup"><span data-stu-id="c9ef8-133">INPUTS</span></span>

### <span data-ttu-id="c9ef8-134">System.String</span><span class="sxs-lookup"><span data-stu-id="c9ef8-134">System.String</span></span>

## <span data-ttu-id="c9ef8-135">DANE WYJŚCIOWE</span><span class="sxs-lookup"><span data-stu-id="c9ef8-135">OUTPUTS</span></span>

### <span data-ttu-id="c9ef8-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="c9ef8-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="c9ef8-137">NOTATKI</span><span class="sxs-lookup"><span data-stu-id="c9ef8-137">NOTES</span></span>

## <span data-ttu-id="c9ef8-138">LINKI POKREWNE</span><span class="sxs-lookup"><span data-stu-id="c9ef8-138">RELATED LINKS</span></span>
