...
### SolutionLevelResource (Domyślne)
```
...
## OPIS
Polecenie Disable-AzIotSecurityAnalyticsAggregatedAlert cmdlet odrzuca określony alert agregowany na urządzeniach centrum iot. Nazwa alertów agregowanych to kombinacja typu alertu i daty zagregowanej alertu oddzielona przecinkiem "/".
...
Odrzuć zagregowany alert "IoT_SucessfulLocalLogin/2020-03-15" (nazwa połączona z typem alertu i zagregowaną datą) z rozwiązania zabezpieczeń IoT "MySolutionName" w grupie zasobów "MyResourceGroup"
...
Odrzuć zagregowany alert o identyfikatorze zasobu "/subscriptions/XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Security/iotSecuritySolutions/MySolutionName/analyticsModels/default/aggregatedAlerts/IoT_SucessfulLocalLogin/2020-03-15"
