...
## OPIS
Polecenie New-AzDeviceSecurityGroupTimeWindowRuleObject cmdlet tworzy nową listę reguł alertów dotyczących okna czasowego dla grupy zabezpieczeń urządzeń w rozwiązaniu zabezpieczeń IoT.
