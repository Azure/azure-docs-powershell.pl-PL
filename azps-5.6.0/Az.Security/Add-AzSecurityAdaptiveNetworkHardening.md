...
## SYNOPSIS
Wymusza podane reguły dla NSG wymienionych w żądaniu.
...
## OPIS
Adaptacyjne połączenia sieciowe są automatycznie obliczane przez Azure Security Center. Za pomocą tego polecenia cmdlet wymuszane są podane reguły dla NSG wymienionych w żądaniu.
...
Nazwa zasobu Adaptacyjne nasyłanie sieci.
...
Identyfikatory zasobów platformy Azure efektywnych grup zabezpieczeń sieci, które zostaną zaktualizowane o utworzone reguły zabezpieczeń z adaptacyjnych reguł tworzenia treści sieci.
...
### -PassThru
Zwraca wartość wskazującą sukces lub porażkę.
...
### Microsoft.Azure.Commands.SecurityCenter.Models.AdaptiveNetwork Jakenings.PSSecurityAdaptiveNetworkDeningsRule
