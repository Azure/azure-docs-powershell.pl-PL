...
## OPIS
Utworzenie lub zaktualizowanie wyniku oceny zabezpieczeń zasobu umożliwia zmianę stanu istniejącego wyniku lub dodanie dodatkowych danych.
mogą być używane tylko w przypadku typów ocen "Zarządzanie klientami" i tylko po utworzeniu dopasowanej metadanych oceny.
