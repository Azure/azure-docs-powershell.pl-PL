...
## SYNOPSIS
Uzyskiwanie analizy zabezpieczeń IoT
...
## OPIS
Polecenie Get-AzIotSecurityAnalytics cmdlet zwraca zestaw analizy zabezpieczeń określonego rozwiązania zabezpieczeń iot.
...
Uzyskaj niesłyszące analizy zabezpieczeń IoT dla rozwiązania zabezpieczeń "MySolution" w grupie ponownego źródła "MyResourceGroup"

## PARAMETERS

### — Domyślne
Jeśli jest dostępny, uzyskaj domyślny zestaw analiz, a w przeciwnym razie uzyskaj listę wszystkich zestawów analiz.
