...
## SYNOPSIS
Aktualizowanie co najmniej jednej z następujących właściwości w rozwiązaniu zabezpieczeń IoT: tagi, konfiguracja zalecenia, zasoby zdefiniowane przez użytkownika
...
## OPIS
Polecenie Update-AzIotSecuritySolution może updayes co najmniej jednej z następujących właściwości w konkretnym rozwiązaniu zabezpieczeń IoT: tagi, konfiguracja zalecenia, zasoby zdefiniowane przez użytkownika.
W rozwiązaniu zabezpieczeń systemu iot zostaną zaktualizowane tylko określone właściwości.
Rozwiązanie zabezpieczeń IoT zbiera dane zabezpieczeń i zdarzenia z urządzeń iot i centrum iot, aby chronić zagrożenia i je wykrywać.
...
Aktualizowanie rozwiązania zabezpieczeń "MySample" z grupy zasobów "MyResourceGroup" przy użyciu konfiguracji zalecenia i zasobów zdefiniowanych przez użytkownika
