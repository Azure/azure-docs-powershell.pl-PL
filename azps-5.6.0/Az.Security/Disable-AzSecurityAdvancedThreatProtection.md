...
## SYNOPSIS
Wyłącza zaawansowane zasady ochrony przed zagrożeniami dla konta magazynu/dyskuDB.
...
## OPIS
Polecenie `Disable-AzSecurityAdvancedThreatProtection` cmdlet wyłącza zasady ochrony przed zagrożeniami dla konta magazynu/magazynu (db).
...
To polecenie wyłącza zaawansowane zasady ochrony przed zagrożeniami dotyczące identyfikatora `"/subscriptions/xxxxxxx-xxxx-xxxx-xxxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.Storage/storageAccounts/myStorageAccount/"` zasobu.

### Przykład 2. Konto Wsdb
```powershell
...
To polecenie wyłącza zaawansowane zasady ochrony przed zagrożeniami dotyczące identyfikatora ` "/subscriptions/xxxxxxx-xxxx-xxxx-xxxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.DocumentDb/databaseAccounts/myCosmosDBAccount/"` zasobu.
