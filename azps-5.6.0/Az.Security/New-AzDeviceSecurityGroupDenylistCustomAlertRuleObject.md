...
## SYNOPSIS
Tworzenie nowej niestandardowej reguły alertów listy odmów dla grupy zabezpieczeń urządzeń (Zabezpieczenia IoT)
...
## OPIS
Polecenie New-AzDeviceSecurityGroupDenylistCustomAlertRuleObject cmdlet tworzy nową listę odrzucanych niestandardowych reguł alertów dla grupy zabezpieczeń urządzeń w rozwiązaniu zabezpieczeń IoT.
...
Tworzenie nowej niestandardowej reguły alertów listy odmów z typem rull "SomeRuleType" i ustawionym stanem na "desable"
