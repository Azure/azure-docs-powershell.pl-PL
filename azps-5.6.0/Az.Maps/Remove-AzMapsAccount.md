...
## OPIS
Polecenie Remove-AzMapsAccount cmdlet usuwa określone konto usługi Azure Maps.
...
Usuwa konto MyAccount z grupy zasobów MyResourceGroup.
...
Usuwa określone konto usługi Azure Maps.
...
### -PassThru
Sprawdź, czy określone konto zostało pomyślnie usunięte.
