...
Udzielanie użytkownikowi roli czytnika dostępu w zakresie grupy zasobów, gdy przypisanie roli jest dostępne do delegowania
...
### -ObjectId
Identyfikator obiektowy usługi Azure AD użytkownika, grupy lub podmiotu zabezpieczeń usługi.
...
Należy używać tylko w połączeniu z parametrami ResourceGroupName, ResourceName i (opcjonalnie)ParentResource w celu skonstruowania hierarchicznego zakresu w postaci względnego URI identyfikującego zasób.
