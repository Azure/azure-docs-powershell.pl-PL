...
To polecenie cmdlet zwraca obiekt reprezentujący nowy lub zmodyfikowany tag wraz z jego wartościami i liczbą zasobów, do których został zastosowany.
...
Tag Azure to para wartości nazw, za pomocą których można kategoryzować zasoby platformy Azure i grupy zasobów, na przykład według działów lub centrum kosztów, lub do śledzenia notatek lub komentarzy dotyczących zasobów i grup.
...
Do zasobu lub grupy zasobów można zastosować tag bez wartości albo dodać wartości do tagu za pomocą tagu **Nowy-AzTag.**
