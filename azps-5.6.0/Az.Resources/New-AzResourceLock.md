...
## SYNOPSIS
Tworzy kłódkę zasobu.

## SKŁADNIA

### BySpecifiedScope (Domyślna)
```
...
## OPIS
Polecenie **cmdlet New-AzResourceLock** tworzy blokadę zasobów.
...
To polecenie tworzy blokadę zasobów w witrynie sieci Web.
...
To polecenie tworzy blokadę zasobów w bazie danych Azure.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, do której ma zastosowanie blokada, lub zawierającej grupę zasobów, której dotyczy blokada.
...
### -ResourceType
Określa typ zasobu, którego kłódka ma zastosowanie.
...
### Microsoft.Azure.Commands.ResourceManager.Cmdlet.Entities.Locks.LockLevel
