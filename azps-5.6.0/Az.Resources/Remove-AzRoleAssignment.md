...
## OPIS
Użyj Remove-AzRoleAssignment commandlet, aby odwołać dostęp do dowolnego podmiotu głównego w danym zakresie i przy danej roli.
...
Rola przypisana do podmiotu zabezpieczeń MUSI zostać określona za pomocą parametru RoleDefinitionName.
Zakres przydziału MOŻE zostać określony, a jeśli nie zostanie określony, domyślnie zostanie określony zakres subskrypcji, czyli spróbuje usunąć przypisanie do określonego dyrektora i roli w zakresie subskrypcji.
...
### -ParentResource
Zasób nadrzędny w hierarchii(zasobu określonego za pomocą parametru ResourceName), jeśli został określony.
Należy go używać w połączeniu z parametrami ResourceGroupName, ResourceType i ResourceName, aby skonstruować zakres hierarchiczny w postaci względnego URI identyfikującego zasób.
