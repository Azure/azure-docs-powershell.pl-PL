...
## OPIS
Polecenie **cmdlet Remove-AzManagementGroupDeployment** usuwa wdrożenie platformy Azure w grupie zarządzania i wszystkie skojarzone operacje.
...
To polecenie usuwa wdrożenie "RolesDeployment" w grupie zarządzania "myMG".
