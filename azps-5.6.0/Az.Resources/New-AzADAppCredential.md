...
### ApplicationObjectIdWithPasswordParameterSet (Domyślne)
```
...
## OPIS
To New-AzADAppCredential cmdlet może służyć do dodawania nowych poświadczeń lub do rzutowania poświadczeń aplikacji.
...
Nowe poświadczenia hasła zostaną dodane do istniejącej aplikacji o identyfikatorze obiektu "1f89cf81-0146-4f4e-beae-2007d0668416".
...
Podany certyfikat x509 (myapp.cer) jest dodawany do istniejącej aplikacji z identyfikatorem aplikacji '4589cd6b-3d79-4bb4-93b8-a0b99f3bfc58'.

### Przykład 3. Tworzenie nowego poświadczenia aplikacji przy użyciu funkcji rurowych
...
Pobiera aplikację o identyfikatorze obiektu "1f89cf81-0146-4f4e-beae-2007d0668416" i potoki, które do systemu New-AzADAppCredential są przekierowywowane w celu utworzenia dla tej aplikacji nowego poświadczenia przy użyciu danego hasła.

## PARAMETERS

### -ApplicationId
Identyfikator aplikacji, do których chcesz dodać poświadczenia.
...
### -ApplicationObject
Obiekt aplikacji, do który chcesz dodać poświadczenia.
...
### -CertValue
Wartość typu poświadczeń "asymetrycznego". Reprezentuje certyfikat zakodowany na podstawie 64.
...
### -EndDate
Data zakończenia użytkowania poświadczeń. Domyślna wartość daty końcowej wynosi jeden rok od daty dzisiejszej.  W przypadku poświadczeń typu "asymetrycznego" musi on być ustawiony na datę ważności certyfikatu X509 lub wcześniejszą.
...
### -ObjectId
Identyfikator obiektu aplikacji, do których chcesz dodać poświadczenia.
...
### -StartDate
Data rozpoczęcia użytkowania poświadczeń. Domyślną wartością daty rozpoczęcia jest dzisiaj. W przypadku poświadczeń typu "asymetrycznego" musi on być ustawiony na datę ważności certyfikatu X509 lub późniejszą.
