...
Podczas modyfikowania zawartości szablonu ARM w wersji specyfikacji szablonu zawartość może pochodzić z nieprzetworzonego ciągu JSON (przy użyciu zestawu parametrów **UpdateVersionByNameFromJsonParameterSet)** lub z określonego pliku JSON (przy użyciu zestawu parametrów **UpdateVersionByNameFromJsonFileParameterSet).**
...
Modyfikuje wersję "1.0" specyfikacji szablonu o nazwie "myTemplateSpec". Określona wersja będzie $templateJson jako zawartość szablonu ARM wersji. Jeśli główna specyfikacja szablonu i/lub wersja jeszcze nie istnieją, zostaną utworzone.


**Uwagi:** 

* Szablon ARM w tym przykładzie to brak możliwości, ponieważ nie zawiera on żadnych rzeczywistych zasobów.
...
Modyfikuje wersję "2.0" specyfikacji szablonu o nazwie "myTemplateSpec". Określona wersja będzie zawierała zawartość lokalnego pliku "myTemplateContent.js", jako zawartość szablonu ARM wersji. Jeśli główna specyfikacja szablonu i/lub wersja jeszcze nie istnieją, zostaną utworzone.
