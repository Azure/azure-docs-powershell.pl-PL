...
### — DisplayName
Nazwa, która ma być wyświetlana w książce adresowej użytkownika.
przykład "Alex Wu".
...
Należy określić, czy użytkownik musi zmienić hasło podczas następnego pomyślnego logowania (prawda).
Zachowaniem domyślnym jest (fałsz), aby nie zmieniać hasła przy następnym pomyślnym logowaniu.
