...
### — Lokalizacja
Określa lokalizację grupy zasobów. Określ lokalizację centrum danych platformy Azure, taką jak Stany Zjednoczone Zachód lub Azja Południowo-Wschodnia. Grupę zasobów można umieścić w dowolnej lokalizacji. Grupa zasobów nie musi być w tej samej lokalizacji co subskrypcja platformy Azure ani w tej samej lokalizacji co jej zasoby.
