...
### RemoveByDeploymentName (Domyślna)
```
...
## OPIS
Polecenie **cmdlet Remove-AzTenantDeployment** usuwa wdrożenie platformy Azure w bieżącym zakresie dzierżawy i wszystkie skojarzone operacje.

## PRZYKŁADY

### Przykład 1. Usuwanie wdrożenia z podaną nazwą
```
PS C:\>Remove-AzTenantDeployment -Name "RolesDeployment"
```

To polecenie usuwa wdrożenie "RolesDeployment" w bieżącym zakresie dzierżawy.

### Przykład 2. Uzyskaj wdrożenie i usuń je
```
PS C:\>Get-AzTenantDeployment -Name "RolesDeployment" | Remove-AzTenantDeployment
```

To polecenie pobiera wdrożenie "RolesDeployment" w bieżącym zakresie dzierżawy i usuwa je.
