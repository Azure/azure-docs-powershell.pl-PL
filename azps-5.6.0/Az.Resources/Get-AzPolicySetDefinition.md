...
## OPIS
Polecenie **cmdlet Get-AzPolicySetDefinition** pobiera kolekcję definicji zestawu zasad lub określoną definicję zestawu zasad identyfikowaną za pomocą nazwy lub identyfikatora.
...
### Przykład 5. Pobierz definicje zestawu zasad z danej kategorii
```
