...
## OPIS
Polecenie Get-AzManagementGroup pobiera wszystkie lub konkretną grupę zarządzania.

## PRZYKŁADY

### Przykład 1. Pobierz wszystkie grupy zarządzania
```
...
### Przykład 2. Uzyskiwanie konkretnej grupy zarządzania
```
...
### Przykład 3. Uzyskiwanie konkretnej grupy zarządzania i pierwszego poziomu hierarchii
```
...
Flagą można poruszać się po tablicy i `Expand` uzyskać szczegółowe informacje dotyczące każdego `Children` dziecka. Na przykład `Children[0]` poda nazwę wyświetlaną `TestGroup1DisplayName` grupy.

### Przykład 4. Uzyskiwanie konkretnej grupy zarządzania i wszystkich poziomów hierarchii
```
...
### — Rozwiń
Rozwiń dane wyjściowe, aby wyświetlić listę dzieci grupy zarządzania
...
### - Rekurencie
Rekurencyjnie lista dzieci grupy zarządzania
