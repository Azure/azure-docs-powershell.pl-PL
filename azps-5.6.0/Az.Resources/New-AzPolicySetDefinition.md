...
## OPIS
Polecenie **cmdlet New-AzPolicySetDefinition** tworzy definicję zestawu zasad.

## PRZYKŁADY

### Przykład 1. Tworzenie definicji zestawu zasad z metadanymi przy użyciu pliku zestawu zasad
```
[
   {
...
To polecenie tworzy definicję zestawu zasad o nazwie VIRTUALPolicySetDefinition z metadanymi wskazującymi, że jej kategoria to "Maszyny wirtualne", która zawiera definicje zasad określone w C:\VMPolicy.jsna. Przykładowa zawartość VMPolicy.jsjest podany powyżej.

### Przykład 2. Tworzenie definicji zestawu parametrów zasad
```
[
   {
      "policyDefinitionId": "/providers/Microsoft.Authorization/policyDefinitions/2a0e14a6-b0a6-4fab-991a-187a4f81c498",
...
To polecenie tworzy parametryzowane definicje zestawu zasad o nazwie VMPolicySetDefinition, która zawiera definicje zasad określone w C:\VMPolicy.jszasad. Przykładowa zawartość VMPolicy.jsjest podany powyżej.

### Przykład 3. Tworzenie definicji zestawu zasad za pomocą grup definicji zasad
```
[
   {
      "policyDefinitionId": "/providers/Microsoft.Authorization/policyDefinitions/2a0e14a6-b0a6-4fab-991a-187a4f81c498",
...
To polecenie tworzy definicję zestawu zasad o nazwie VMPolicySetDefinition z grupowanie definicji zasad określonych w C:\VMPolicy.jszasad. Przykładowa zawartość VMPolicy.jsjest podany powyżej.
...
### -GroupDefinition
Grupy definicji zasad dla nowej definicji zestawu zasad. Może to być ścieżka do pliku zawierającego grupy lub grupy w postaci ciągu JSON.
...
### — Metadane
Metadane dla definicji zestawu zasad. Może to być ścieżka do nazwy pliku zawierającej metadane lub metadane jako ciąg JSON.
...
### - Parametr
Deklaracja parametrów dla definicji zestawu zasad.
Może to być ścieżka do nazwy pliku zawierającej deklarację parametrów lub deklaracja parametrów jako ciąg JSON.
...
### -PolicyDefinition
Definicje zasad. Może to być ścieżka do nazwy pliku zawierającej definicje zasad lub definicje zasad jako ciąg JSON.
...
### - SubscriptionId
Identyfikator subskrypcji definicji nowego zestawu zasad.
