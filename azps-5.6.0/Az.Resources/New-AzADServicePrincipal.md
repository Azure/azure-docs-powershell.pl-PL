...
Poniższy przykład tworzy nową aplikację o nazwie **ServicePrincipalName** i hasłem **nazwy StrongPassworld!23.** Podmiot zabezpieczeń usługi jest tworzony na podstawie utworzonej aplikacji. Data rozpoczęcia i data zakończenia zostaną dodane do poświadczeń hasła.
...
Data zakończenia użytkowania poświadczeń. Domyślna wartość daty końcowej wynosi jeden rok od daty dzisiejszej.
