...
To polecenie usuwa cały zestaw tagów zasobu za pomocą {resourceId}. Zwraca usunięty projekt podczas przechodzenia w "-PassThru".
...
### -PassThru
Zwraca obiekt reprezentujący usunięty tag lub wynikowy tag z usuniętymi wartościami.
