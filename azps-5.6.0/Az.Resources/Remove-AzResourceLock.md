...
## OPIS
Polecenie **cmdlet Remove-AzResourceLock** usuwa blokadę zasobów platformy Azure.
...
Usuwa blokadę zasobu. (wygenerowane automatycznie)
...
### - LockId
Określa identyfikator blokady, która jest usuwana przez to polecenie cmdlet.
...
### -LockName
Określa nazwę blokady, która ma być usuwana przez to polecenie cmdlet.
