...
To polecenie aktualizuje metadane definicji zestawu zasad o nazwie VIRTUALPolicySetDefinition, aby wskazać, że jej kategoria to "Maszyny wirtualne".
...
### -GroupDefinition
Grupy definicji zasad w definicji zaktualizowanego zestawu zasad. Może to być ścieżka do pliku zawierającego grupy lub grupy w postaci ciągu JSON.
