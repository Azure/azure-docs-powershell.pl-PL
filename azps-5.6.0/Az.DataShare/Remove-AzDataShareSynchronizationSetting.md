...
## OPIS
Polecenie **cmdlet Remove-AzDataShareSynchronizationSetting** usuwa ustawienie synchronizacji udostępniania danych
...
Te polecenia usuwają ustawienie synchronizacji o nazwie AdsShareSynchronizationSetting z usługi Share AdsShare. 

## PARAMETERS

### -AccountName
Nazwa konta usługi Azure Data Share
...
### -InputObject
Ustawienie synchronizacji udostępniania danych platformy Azure.
...
### -ResourceId
Identyfikator zasobu ustawienia synchronizacji
