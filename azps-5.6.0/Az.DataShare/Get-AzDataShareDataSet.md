...
## OPIS
Polecenie **cmdlet Get-AzDataShareDataSet** pobiera informacje o zestawach danych dodanych do udziału w koncie udziału danych platformy Azure. Jeśli określisz nazwę zestawu danych, to polecenie cmdlet pobiera informacje o tym zestawie danych. Jeśli nie określisz nazwy, to polecenie cmdlet pobiera informacje o wszystkich zestawach danych w udziału. I
...
To polecenie wyświetla informacje o zestawie danych AdsDataSet w usłudze Share AdsShare w usłudze Azure data share account WikiAdsAccount i grupie zasobów ADS.
