...
## OPIS
Polecenie cmdlet **New-AzDataShareAccount** tworzy konto udostępniania danych w określonej grupie zasobów platformy Azure.
...
### — Lokalizacja
Lokalizacja, w której należy utworzyć konto udostępniania danych.
...
### -ResourceGroupName
Zostanie utworzona nazwa grupy zasobów konta udziału danych platformy Azure.
...
### — Tag
Tagi, które należy skojarzyć z kontem usługi Azure Data Share.
