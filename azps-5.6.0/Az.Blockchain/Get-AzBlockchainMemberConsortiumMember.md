...
### Przykład 1. Lista członków tego przedsiębiorstwa.
```powershell
...
To polecenie zawiera listę członków organizacji, którzy są członkami tego zespołu.
...
### Microsoft.Azure.PowerShell.cmdlet.uściśl.models.api20180601Preview.IConsortiumMember
