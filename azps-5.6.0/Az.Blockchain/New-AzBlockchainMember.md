...
### Przykład 1. Tworzenie nowego członka zespołu
```powershell
...
To polecenie tworzy nowego członka zespołu.
...
### — Consortium
Pobiera lub ustawia to organizacji dla tego członka zespołu.
...
Pobiera nazwę wyświetlaną członka w ramach tego przedsiębiorstwa.
...
### -ConsortiumRole
Pełni rolę członka w ramach tego przedsiębiorstwa.
...
### - FirewallRule
Pobiera lub ustawia reguły zapory, które mają być konstruowane, zobacz sekcję NOTATKI, aby uzyskać informacje o właściwościach funkcji FIREWALLRULE i utworzyć tabelę skrótów.
...
### — Lokalizacja
Lokalizacja GEOGRAFICZNA usługi.
...
### — Hasło
Ustawia podstawowe hasło uwierzytelniania członka zespołu.
...
### — Protokół
Pobiera lub ustawia protokół protokołów.
