...
### Przykład 1. Uzyskaj więcej organizacji.
```powershell
PS C:\> Get-AzBlockchainConsortium -Location eastus

```

To polecenie wyświetla listę przedsiębiorstw w ramach subskrypcji dla określonej lokalizacji.
...
### Microsoft.Azure.PowerShell.cmdlet.u7.models.api20180601Preview.IConsortium
