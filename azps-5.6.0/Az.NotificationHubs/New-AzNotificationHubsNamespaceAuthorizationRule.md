...
## OPIS
Polecenie **cmdlet New-AzNotificationHubsNamespaceAuthorizationRule** tworzy regułę autoryzacji sygnatury dostępu udostępnionego (SAS) i przypisuje ją do przestrzeni nazw centrum powiadomień.
...
Można to zrobić za pomocą .NET Framework.
...
Nowe reguły muszą być przypisane do istniejącej przestrzeni nazw.
