...
## OPIS
Polecenie **cmdlet Remove-AzNotificationHubAuthorizationRule** usuwa regułę autoryzacji podpisu dostępu udostępnionego (SAS) z centrum powiadomień.
Reguły autoryzacji zarządzają dostępem do centrum powiadomień przez tworzenie linków ( URI) na podstawie różnych poziomów uprawnień.
...
Po uruchomieniu tego polecenia musisz określić zarówno przestrzeń nazw, jak i grupę zasobów, do których jest przypisane centrum.

## PARAMETERS

### -AuthorizationRule
Określa nazwę reguły uwierzytelniania SAS, która usuwa to polecenie cmdlet.
...
### - NotificationHub
Określa centrum powiadomień, do których są przypisane reguły autoryzacji.
Centra powiadomień są używane do wysyłania powiadomień wypychanych do wielu klientów, niezależnie od platformy.
