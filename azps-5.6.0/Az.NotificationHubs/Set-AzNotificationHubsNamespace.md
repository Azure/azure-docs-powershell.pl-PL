...
Gdy przestrzeń nazw jest wyłączona, użytkownicy nie mogą łączyć się z żadnym centrum powiadomień w przestrzeni nazw ani za pomocą tych centrum nie mogą wysyłać powiadomień wypychanych.
...
Ten parametr można ustawić na dowolną prawidłową lokalizację na platformie Azure, ale w celu zapewnienia optymalnej wydajności należy użyć centrum danych znajdującego się w pobliżu większości użytkowników.
