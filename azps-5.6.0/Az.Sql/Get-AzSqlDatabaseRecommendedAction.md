...
## OPIS
Polecenie **cmdlet Get-AzSqlDatabaseRecomctionAction** pobiera jedną lub więcej zalecanych akcji dla doradcy usługi Azure SQL Database.
...
To polecenie otrzymuje listę wszystkich zalecanych akcji doradcy o nazwie CreateIndex dostępnej dla bazy danych o nazwie wi-sprinter-australia-east.
...
To polecenie pobiera zalecaną akcję o nazwie IR_ \[ test_schema \] _ \[ test_table_0.0361551 _6C7AE8CC9C87E7FD5893 doradcy o nazwie \] CreateIndex.
...
### -DatabaseName
Określa nazwę bazy danych, dla której to polecenie cmdlet żąda zalecanych akcji.
