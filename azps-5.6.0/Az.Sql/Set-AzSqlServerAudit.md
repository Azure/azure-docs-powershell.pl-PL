...
### Przykład 7. Włączanie zasad inspekcji analizy dziennika na serwerze Azure SQL Server
```powershell
...
### Przykład 10. Wyłączanie wysyłania rekordów inspekcji serwera Azure SQL do magazynu obiektów blob i włączanie wysyłania ich do analizy dziennika.
```powershell
