...
## OPIS
Polecenie Get-AzSqlInstanceOperation pobiera informacje o operacjach w wystąpieniu zarządzanym przez język SQL. Możesz wyświetlić wszystkie operacje w zarządzanym wystąpieniu lub wyświetlić określoną operację, podając nazwę operacji.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie wszystkich operacji wystąpienia
```powershell
...
To polecenie pobiera wszystkie operacje, w których jest zarządzane wystąpienie języka SQL.

### Przykład 2. Uzyskiwanie konkretnej operacji
```powershell
...
To polecenie działa pod nazwą "5870c6d8-6703-4b27-8ae4-687b4ca7caea" w wystąpieniu zarządzanym przez język SQL.
...
To polecenie działa z identyfikatorem '/subscriptions/a8c9a924-06c0-4bde-9788-e7b1370969e1/resourceGroups/ps3753/providers/Microsoft.Sql/managedInstances/ps3698/operations/5870c6d8-6703-4b27-8ae4-687b4ca7caea'.
...
### -ResourceId
Identyfikator zasobu operacji zarządzanego wystąpienia.
