...
## OPIS
Polecenie **cmdlet New-AzSqlServer** tworzy serwer usługi Azure SQL Database.

## PRZYKŁADY

### Przykład 1. Tworzenie nowego serwera usługi Azure SQL Database
```
...
To polecenie tworzy serwer Azure SQL Database w wersji 12.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, do której ten serwer jest przypisany przez to polecenie cmdlet.
...
### -ServerVersion
Określa wersję nowego serwera. Dopuszczalne wartości dla tego parametru to: 2.0 i 12.0.
Określ liczbę 2.0, aby utworzyć serwer wersji 11, lub 12.0, aby utworzyć serwer wersji 12.
...
Określa poświadczenia administratora bazy danych SQL dla nowego serwera. Aby uzyskać obiekt **PSCredential,** użyj Get-Credential cmdlet. Aby uzyskać więcej informacji, wpisz `Get-Help
Get-Credential` .
