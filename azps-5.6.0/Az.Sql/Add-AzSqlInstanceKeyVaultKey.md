...
## OPIS
Polecenie Add-AzSqlInstanceKeyVaultKey cmdlet dodaje klucz magazynu klucza do podanego wystąpienia zarządzanego. Zarządzane wystąpienie musi mieć uprawnienia "get, wrapKey, unwrapKey" do magazynu, użyj poniższego skryptu, aby udzielić uprawnień do zarządzanego wystąpienia.
