...
## OPIS
Polecenie Remove-AzSqlDatabaseSensitivityClassification cmdlet usuwa typy informacji i etykiety wrażliwości kolumn w bazie danych.

## PRZYKŁADY

### Przykład 1. Usuwanie typu informacji i etykiety wrażliwości kolumny w usłudze Azure SQL Database.
```powershell
...
### Przykład 2. Usuwanie bieżących typów informacji i etykiet wrażliwości kolumn w bazie danych Azure SQL przy użyciu połączenia rurowego.
```powershell
...
### Przykład 3. Usuwanie typu informacji i etykiety wrażliwości kolumny w bazie danych Azure SQL przy użyciu połączenia rurowego.
```powershell
