...
## OPIS
Polecenie **cmdlet Get-AzSqlServerActiveDirectoryAdministrator** pobiera informacje o administratorze usługi Azure Active Directory (Azure AD) dla serwera AzureSQL w bieżącej subskrypcji.
...
To polecenie pobiera informacje o administratorze usługi Azure AD dla serwera o nazwie Server01 skojarzonego z grupą zasobów o nazwie ResourceGroup01.
...
### -ServerName
Określa nazwę programu SQL Server, dla którego to polecenie cmdlet pobiera informacje.
