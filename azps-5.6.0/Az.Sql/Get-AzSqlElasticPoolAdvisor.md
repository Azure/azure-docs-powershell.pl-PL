...
## OPIS
Polecenie **cmdlet Get-AzSqlElasticPoolAdvisor** pobiera co najmniej jednego doradcę puli elastycznej języka Azure SQL dla puli elastycznej języka Azure SQL.

## PRZYKŁADY

### Przykład 1. Lista wszystkich doradców dla określonej puli elastycznej
```
...
To polecenie wyświetla listę wszystkich doradców puli elastycznej o nazwie WIPoolPool.

### Przykład 2. Uzyskiwanie pojedynczego doradcy dla określonej puli elastycznej
```
...
To polecenie pobiera doradcę o nazwie CreateIndex dla puli elastycznej o nazwie WIPool.
...
To polecenie pobiera wszystkich doradców dla elastycznej puli z ich zalecanymi działaniami uwzględnioną w odpowiedzi.
...
### Przykład 5. Lista wszystkich doradców dla określonej puli elastycznej przy użyciu filtrowania
```
...
To polecenie wyświetla listę wszystkich doradców puli elastycznej o nazwie WIPool, których nazwa rozpoczyna się od litery "d".
...
Określa nazwę puli elastycznej, dla której to polecenie cmdlet żąda doradcy.
...
Wskazuje, że polecenie cmdlet zawiera w odpowiedzi zalecane akcje doradcy.
...
## NOTATKI
* Słowa kluczowe: azure, azurerm, arm, resource, management, manager, sql,pool i mssql, doradca
