...
## OPIS
Polecenie Get-AzSqlInstanceDatabaseSensitivityRecommendation zwraca zalecane typy informacji i etykiety wrażliwości kolumn w bazie danych azure SQL managed instance.

## PRZYKŁADY

### Przykład 1. Uzyskaj zalecane typy informacji i etykiety wrażliwości bazy danych azure SQL managed instance.
```powershell
...
### Przykład 2. Uzyskaj zalecane typy informacji i etykiety wrażliwości bazy danych azure SQL managed instance przy użyciu połączenia rurowego.
```powershell
