...
## OPIS
Polecenie **cmdlet Update-AzSqlSyncGroup** modyfikuje właściwości grupy synchronizacji usługi Azure SQL Database.

## PRZYKŁADY

### Przykład 1. Aktualizowanie grupy synchronizacji dla usługi Azure SQL Database.
```
...
Czy podczas nawiązywania połączenia z centrum tej grupy synchronizacji ma być nawiązywane połączenie z linkiem prywatnym.
