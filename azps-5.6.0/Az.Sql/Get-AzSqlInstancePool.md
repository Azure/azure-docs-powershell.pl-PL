...
### ListBySubOrResourceGroupParameterSet (Domyślne)
```
...
## OPIS
Polecenie **cmdlet Get-AzSqlInstancePool** zwraca informacje dotyczące co najmniej jednej puli wystąpień języka Azure SQL.
Określ nazwę puli wystąpień, aby wyświetlić informacje tylko dla tej puli wystąpień.

## PRZYKŁADY

### Przykład 1. Pobierz wszystkie pule wystąpień w ramach subskrypcji klienta
```powershell
...
To polecenie pobiera informacje o wszystkich pulach wystąpień w ramach subskrypcji klienta.

### Przykład 2. Uzyskiwanie wszystkich pul wystąpień w grupie zasobów
```powershell
...
To polecenie pobiera informacje o wszystkich pulach wystąpień w grupie zasobów resourcegroup01.

### Przykład 3. Uzyskiwanie informacji o puli wystąpień
```powershell
...
To polecenie pobiera informacje o wystąpieniu puli wystąpień 0.

### Przykład 4. Uzyskiwanie informacji o puli wystąpień przy użyciu identyfikatora zasobu puli wystąpień
```powershell
...
To polecenie pobiera informacje o puli wystąpień wraz z identyfikatorem zasobu.
