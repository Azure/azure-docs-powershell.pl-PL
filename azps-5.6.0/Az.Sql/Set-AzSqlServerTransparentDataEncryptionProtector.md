...
## OPIS
To Set-AzSqlServerTransparentDataEncryptionProtector cmdlet ustawia łamię TDE dla serwera SQL.
...
To polecenie aktualizuje typ danych TDE serwera na typ zarządzany przez usługę.
...
To polecenie aktualizuje serwer, aby używać klucza magazynu klucza serwera z identyfikatorem https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 ' jako klucza TDE.
ResourceGroupName ServerName Type ServerKeyVaultKeyName
----------------- ----------                   ---- ---------------------
