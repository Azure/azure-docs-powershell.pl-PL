...
## OPIS
Polecenie cmdlet **Get-AzSqlDatabaseImportExportStatus** pobiera szczegóły importu pliku bacpac z konta magazynu do bazy danych Azure SQL Database lub eksportu bazy danych Azure SQL Database jako pliku bacpac do konta magazynu.
