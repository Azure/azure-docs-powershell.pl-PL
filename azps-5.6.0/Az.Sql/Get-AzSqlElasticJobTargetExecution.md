...
## OPIS
Polecenie Get-AzSqlElasticJobTargetExecution cmdlet pobiera jedno lub więcej wykonań w zadaniu docelowym

## PRZYKŁADY

### Przykład 1. Pobiera jedno lub więcej wykonań docelowych zadań z wykonywania zadań
```powershell
...
### Przykład 2. Pobiera jedno lub więcej wykonań docelowych zadań z wykonywania zadań — filtrowanie według nazwy etapu
```powershell
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
...
### — Aktywne
Oflaguj, aby filtrować według aktywnych wykonywania.
...
### -CreateTimeMax
Filtrowanie według maks. czasu tworzenia
...
### -EndTimeMax
Filtrowanie według maksymalnej godziny zakończenia.
...
### -EndTimeMin
Filtrowanie według godzin zakończenia min.
...
### -ParentResourceId
Identyfikator zasobu wykonywania zadań.
