...
## OPIS
To polecenie modyfikuje konfigurację reguły wirtualnej sieci programu Azure SQL Server.
Aby kontrolować zestaw reguł sieci wirtualnej na serwerze, użyj zamiast tego "Add-AzSqlServerVirtualNetworkRule" i "Remove-AzSqlServerVirtualNetworkRule".
...
Modyfikuje istniejącą regułę sieci wirtualnej przy użyciu nowego identyfikatora podsieci wirtualnej, który zawiera informacje o nowej sieci wirtualnej
...
Identyfikator podsieci wirtualnej sieci dla reguły.
