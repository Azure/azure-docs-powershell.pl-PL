...
### Przykład 1. Usuwanie ustawień inspekcji serwera Azure SQL Server
```
PS C:\>Remove-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
```

### Przykład 2. Usuwanie za pośrednictwem potoku ustawień inspekcji serwera Azure SQL Server
```
