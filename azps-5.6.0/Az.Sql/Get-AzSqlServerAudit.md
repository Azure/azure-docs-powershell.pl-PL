...
## OPIS
Polecenie **cmdlet Get-AzSqlServerAudit** otrzymuje ustawienia inspekcji serwera Azure SQL.
Określ parametry *ResourceGroupName (Nazwa Grupy Zasobów)* i *ServerName (Nazwa Serwera),* aby zidentyfikować serwer.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie ustawień inspekcji serwera Azure SQL Server
```
...
### Przykład 2. Uzyskiwanie za pośrednictwem potoku ustawień inspekcji serwera Azure SQL Server
```
...
### Przykład 3. Uzyskiwanie ustawień inspekcji serwera Azure SQL Server
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
