...
### Przykład 4. Pobierz bieżący typ informacji i etykietę wrażliwości określonej kolumny bazy danych azure SQL managed instance database za pomocą połączenia rurowego.
```powershell
