...
## OPIS
Polecenie Add-AzSqlElasticJobTarget cmdlet dodaje zasób docelowy do grupy docelowej

## PRZYKŁADY

### Przykład 1. Dodawanie obiektu docelowego serwera
```powershell
...
### Przykład 2. Dodawanie obiektu docelowego bazy danych
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### Przykład 3. Dodawanie elastycznego celu puli
```powershell
...
### Przykład 4. Dodawanie celu mapy sowa
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Dodaje element docelowy (serwer, elastyczna pula, baza danych i mapa mapy mapy docelowej) do grupy docelowej.
