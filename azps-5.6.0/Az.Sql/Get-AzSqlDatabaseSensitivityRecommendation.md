...
## OPIS
Polecenie Get-AzSqlDatabaseSensitivityRecommendation zwraca zalecane typy informacji i etykiety wrażliwości kolumn w bazie danych.

## PRZYKŁADY

### Przykład 1. Uzyskaj zalecane typy informacji i etykiety wrażliwości bazy danych Azure SQL.
```powershell
...
### Przykład 2. Uzyskaj zalecane typy informacji i etykiety wrażliwości bazy danych Azure SQL przy użyciu połączenia rurowego.
```powershell
