...
## OPIS
Polecenie Add-AzSqlElasticJobStep cmdlet dodaje krok zadania do zadania

## PRZYKŁADY

### Przykład 1. Dodanie kroku do zadania
```powershell
...
Interwał ponownego ponawiania próby po odjęniu mnożenia
