...
## OPIS
Polecenie **cmdlet Get-AzSqlDatabaseAudit** pobiera ustawienia inspekcji bazy danych Azure SQL.
Aby użyć polecenia cmdlet, określ bazę danych za pomocą parametrów *ResourceGroupName,* *ServerName* i *DatabaseName.*

## PRZYKŁADY

### Przykład 1. Uzyskiwanie ustawień inspekcji bazy danych Azure SQL Database
```
...
### Przykład 2. Uzyskiwanie za pośrednictwem potoków ustawień inspekcji bazy danych Azure SQL
```
...
### Przykład 3. Uzyskiwanie ustawień inspekcji bazy danych Azure SQL Database
```
PS C:\>Get-AzSqlDatabaseAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
ServerName                          : server01
DatabaseName                        : database01
