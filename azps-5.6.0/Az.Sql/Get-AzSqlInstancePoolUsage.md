...
### InstancePoolUsageDefaultParameterSet (Domyślne)
```
...
## OPIS
Polecenie **cmdlet Get-AzSqlInstancePoolUsage** zwraca informacje o użyciu puli wystąpień języka Azure SQL.

## PRZYKŁADY

### Przykład 1. Pobiera użycie puli wystąpień języka Azure SQL
```powershell
...
Pobiera użycie puli wystąpień wystąpienia języka Azure SQL Instance0.

### Przykład 2. Pobiera użycie puli wystąpień języka Azure SQL przy użyciu obiektu puli wystąpień
```powershell
...
Pobiera użycie puli wystąpień wystąpienia języka Azure SQL przy użyciu obiektu puli wystąpień.

### Przykład 3. Pobiera użycie puli wystąpień języka Azure SQL przy użyciu identyfikatora zasobu puli wystąpień wystąpienia.
```powershell
...
Pobiera użycie dla puli wystąpień wystąpienia języka Azure SQL przy użyciu identyfikatora zasobu puli wystąpień.

### Przykład 3. Pobiera użycie puli wystąpień języka Azure SQL z podziałem użycia wystąpień zarządzanych w puli.
```powershell
...
Pobiera użycie dla puli wystąpień wystąpienia języka Azure SQL wraz z użyciami zarządzanych wystąpień w ramach instancepool0.
...
### -Expand Jednakowy
Flaga wskazująca, czy rozszerzyć użycie tej puli wystąpień wraz z użyciem dzieci.
...
### -InstancePool
Obiekt puli wystąpienia nadrzędnego.
...
### — Nazwa
Nazwa puli zarządzanego wystąpienia.
