...
## OPIS
Polecenie **cmdlet Remove-AzSqlSyncMember** usuwa członka synchronizacji usługi Azure SQL Database.

## PRZYKŁADY

### Przykład 1. Usuwanie członka synchronizacji
```
...
To polecenie usuwa członka synchronizacji usługi Azure SQL Database o nazwie syncMember01.
...
### -PassThru
Definiuje, czy zwrócić usuniętego członka synchronizacji
