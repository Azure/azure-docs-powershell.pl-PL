...
### AddAzureRmSqlServerTransparentDataEncryptionCertificateDefaultParameterSet (Domyślne)
```
...
## OPIS
Ta Add-AzSqlManagedInstanceTransparentDataEncryptionCertificate dodaje certyfikat przezroczystego szyfrowania danych dla danego wystąpienia programu SQL Server
...
Dodawanie certyfikatu TDE do serwera sql przy użyciu nazwy grupy zasobów i nazwy programu SQL Server
...
Dodawanie certyfikatu TDE do serwerów przy użyciu server resourceId
