...
## OPIS
Polecenie **cmdlet Get-AzSqlSyncAgentLinkedDatabase** zwraca informacje o bazach danych programu SQL Server połączonych przez agenta synchronizacji.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie połączonych baz danych programu SQL Server dla agenta synchronizacji języka Azure SQL.

Poniższy przykład zwraca połączone bazy danych programu SQL Server połączone przez agenta synchronizacji języka Azure SQL.
