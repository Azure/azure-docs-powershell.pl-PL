...
## OPIS
Polecenie cmdlet Get-AzSqlInstanceKeyVaultKey uzyskać informacje o kluczach magazynu kluczy w wystąpieniu zarządzanym przez język SQL. Możesz wyświetlić wszystkie klucze w wystąpieniu zarządzanym lub wyświetlić określony klucz, podając klucz KeyId.
...
To polecenie pobiera wszystkie klucze magazynu kluczy w wystąpieniu zarządzanym przez język SQL.
...
To polecenie pobiera klucz magazynu kluczy z identyfikatorem https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 '.
...
### Przykład 4. Użycie identyfikatora zasobu wystąpienia
```powershell
PS C:\> $managedInstance = Get-AzSqlInstance -Name 'ContosoManagedInstanceName' -ResourceGroupName 'ContosoResourceGroup'
