...
## OPIS
Polecenie Set-AzSqlElasticJobStep cmdlet aktualizuje krok zadania

## PRZYKŁADY

### Przykład 1. Aktualizacja grupy docelowej etapu zadania
```powershell
...
### Przykład 2. Aktualizacja skryptu T-SQL kroku zadania dla zadania
```powershell
PS C:\> $jobStep = Get-AzSqlElasticJobStep -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -StepName step1
...
Aktualizacje kroku zadania z zadania
...
Początkowa ponowna próba interwału (sekundy)
...
Maksymalna liczba ponownych prób w sekundach
...
Identyfikator zasobu wyjściowej bazy danych
...
### -ResourceId
Identyfikator zasobu kroku zadania
...
Mnożenie ponownego odejmowania interwału
...
### Microsoft.Azure.Commands.Sql.NajbłędszaJobs.Model.AzureSqlElasticJobStepModel
