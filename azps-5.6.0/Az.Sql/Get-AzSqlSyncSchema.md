...
To polecenie pobiera schemat synchronizacji dla bazy danych centrum w grupie synchronizacji SyncGroup01.

### Przykład 2. Uzyskaj schemat synchronizacji dla bazy danych centrum i rozwiń tabelę
```powershell
