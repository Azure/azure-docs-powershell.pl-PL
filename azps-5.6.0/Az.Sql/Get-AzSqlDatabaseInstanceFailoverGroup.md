...
## OPIS
Pobiera określoną grupę wystąpienia trybu failover lub wyświetla listę grup wystąpienia trybu failover w regionie w ramach subskrypcji użytkownika.

Do wykonania polecenia może zostać użyty jeden z regionów w grupie Wystąpienie trybu failover. Zwracane wartości będą odzwierciedlać stan wystąpień zarządzanych w tym regionie względem grupy trybu failover wystąpienia.
...
Lista wszystkich grup trybu failover w regionie
...
Pobierz konkretną grupę trybu failover wystąpienia.
...
### — Nazwa
Nazwa grupy wystąpienia trybu failover do pobrania.
