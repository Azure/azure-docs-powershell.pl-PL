...
## OPIS
Polecenie cmdlet **Set-AzSqlDatabaseAdvisorAutoExecuteStatus** modyfikuje właściwość auto execute doradcy usługi Azure SQL Database Advisor.
...
To polecenie zmienia stan automatycznego wykonywania doradcy o nazwie CreateIndex na Włączony.

## PARAMETERS

### - AdvisorName
Określa nazwę doradcy, dla którego to polecenie cmdlet modyfikuje stan.
