...
### CreateNewInstanceDatabaseFromInputParameters (Domyślne)
```
...
## OPIS
Polecenie **cmdlet New-AzSqlInstanceDatabase** tworzy bazę danych azure SQL Managed Instance.
...
To polecenie tworzy wystąpienie bazy danych o nazwie Database01 w wystąpieniu managedInstance1.
...
### — sortowanie
Sortowanie danych usługi Azure SQL Instance Database do użycia.
...
### — Nazwa
Nazwa bazy danych Azure SQL Instance Database do utworzenia.
...
### — Tag
Tagi do skojarzenia z bazą danych Azure Sql Instance Database
