...
## OPIS
Polecenie **cmdlet Remove-AzSqlDatabaseLongTermRetentionBackup** usuwa określoną kopię zapasową.

## PRZYKŁADY

### Przykład 1. Usuwanie pojedynczej kopii zapasowej za pomocą grupy zasobów
```powershell
...
Usuwa kopię zapasową o nazwie 601061b7-d10b-46e0-bf77-a2bfb16a6add;13165566550000000

### Przykład 2. Usuwanie pojedynczej kopii zapasowej bez grupy zasobów
```powershell
...
### Przykład 3. Usuwanie wszystkich kopii zapasowych dla lokalizacji
```powershell
...
To polecenie usuwa wszystkie długoterminowe kopie zapasowe przechowywania dla lokalizacji Northeurope.
...
### -InputObject
Obiekt długookresowej kopii zapasowej przechowywania bazy danych do usunięcia.
...
### -ResourceId
Identyfikator zasobu kopii zapasowej przechowywania długoterminowego bazy danych do usunięcia.
...
### -ServerName
Nazwa serwera Azure SQL Server kopii zapasowej znajduje się poniżej.
