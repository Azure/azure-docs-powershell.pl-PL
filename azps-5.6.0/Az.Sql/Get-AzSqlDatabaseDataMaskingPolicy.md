...
## OPIS
Polecenie **cmdlet Get-AzSqlDatabaseDataMaskingPolicy** pobiera zasady maskowania danych w bazie danych Azure SQL.
...
### Przykład 1. Uzyskiwanie zasad maskowania danych dla bazy danych Azure SQL
```
...
To polecenie pobiera zasady maskowania danych z bazy danych Database01 w grupie zasobów ResourceGroup01 na serwerze Server01.
