...
## OPIS
Polecenie **cmdlet Start-AzSqlSyncGroupSync** uruchamia synchronizację grupy synchronizacji.
...
To polecenie rozpoczyna rundę synchronizacji grupy synchronizacji.
...
### -PassThru
Definiuje, czy grupa synchronizacji ma być zwracana
