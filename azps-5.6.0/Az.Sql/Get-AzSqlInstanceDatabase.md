...
### GetInstanceDatabaseFromInputParameters (Domyślne)
```
...
## OPIS
Polecenie **cmdlet Get-AzSqlInstanceDatabase** pobiera jedną lub więcej baz danych Azure SQL z zarządzanego wystąpienia usługi Azure SQL Database.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie wszystkich baz danych w wystąpieniu
```
...
### Przykład 2. Uzyskiwanie bazy danych według nazwy w wystąpieniu zarządzanym
```
...
### Przykład 3. Uzyskiwanie wszystkich baz danych w wystąpieniu przy użyciu filtrowania
```
...
### -InstanceObject
Obiekt wystąpienia do użycia w celu uzyskania bazy danych wystąpienia
...
### — Nazwa
Nazwa bazy danych Azure SQL Instance Database do pobrania.
