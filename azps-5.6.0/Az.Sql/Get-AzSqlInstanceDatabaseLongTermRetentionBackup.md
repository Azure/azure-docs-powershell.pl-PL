...
Pobiera wszystkie długoterminowe kopie zapasowe przechowywania dla określonej bazy danych.  Grupa zasobów jest opcjonalna. 
...
### -DatabaseName
Nazwa zarządzanej bazy danych, pod którym znajdują się kopie zapasowe.
...
### -InstanceName
Nazwa zarządzanego wystąpienia kopii zapasowych jest w obszarze.
...
### — Lokalizacja
Lokalizacja źródłowego wystąpienia zarządzanego kopii zapasowych.
