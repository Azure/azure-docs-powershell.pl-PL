...
To polecenie tworzy nowe wystąpienie przy użyciu parametrów Edition i ComputeGeneracja.
...
### Przykład 6. Tworzenie nowego wystąpienia z konfiguracją konserwacji
```powershell
...
To polecenie tworzy nowe wystąpienie z konfiguracją konserwacji MI_2
...
### -DnsZonePartner
Identyfikator zasobu zarządzanego serwera partnerskiego do dziedziczenia właściwości DnsZone po utworzeniu wystąpienia zarządzanego
...
### — Lokalizacja
Lokalizacja, w której należy utworzyć wystąpienie
