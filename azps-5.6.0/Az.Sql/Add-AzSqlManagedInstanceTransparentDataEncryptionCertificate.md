...
## OPIS
Ta Add-AzSqlManagedInstanceTransparentDataEncryptionCertificate dodaje certyfikat przezroczystego szyfrowania danych dla danego zarządzanego wystąpienia
...
### -PassThru
Po pomyślnym wykonaniu zwraca dodany obiekt certyfikatu.
...
### — Hasło
Hasło do certyfikatu przezroczystego szyfrowania danych
...
### -PrivateBlob
Prywatny obiekt blob dla certyfikatu szyfrowania przezroczystych danych
