...
### RemoveInstanceDatabaseFromInputParameters (Domyślne)
```
...
## OPIS
Polecenie **cmdlet Remove-AzSqlInstanceDatabase** usuwa bazę danych azure SQL Managed Instance.
...
### -InputObject
Obiekt Instance Database do usunięcia
...
### — Nazwa
Nazwa bazy danych Azure SQL Instance Database do usunięcia.
...
### -ResourceId
Identyfikator zasobu obiektu instance database do usunięcia
