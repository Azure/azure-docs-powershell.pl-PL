...
## OPIS
Polecenie Set-AzSqlDatabaseSensitivityClassification ustawia typy informacji i etykiety wrażliwości kolumn w bazie danych.

## PRZYKŁADY

### Przykład 1. Ustawianie typu informacji i etykiety wrażliwości kolumny w bazie danych Azure SQL.
```powershell
...
### Przykład 2. Ustawianie zalecanych typów informacji i etykiet wrażliwości kolumn w bazie danych Azure SQL.
```powershell
...
### Przykład 3. Ustawianie typu informacji i etykiety wrażliwości kolumny w bazie danych Azure SQL przy użyciu połączenia rurowego.
```powershell
