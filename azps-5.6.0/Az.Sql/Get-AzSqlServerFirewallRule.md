...
## OPIS
Polecenie **cmdlet Get-AzSqlServerFirewallRule** pobiera reguły zapory dla serwera usługi Azure SQL Database.
Jeśli określisz nazwę reguły zapory, to polecenie cmdlet pobiera informacje o tej określonej regułie zapory.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie wszystkich reguł dla serwera
```
...
### Przykład 2. Uzyskiwanie wszystkich reguł dla serwera przy użyciu filtrowania
```
...
To polecenie pobiera wszystkie reguły zapory dla serwera o nazwie Server01, które zaczynają się od "Reguły".
...
### -ResourceGroupName
Określa nazwę grupy zasobów, do której jest przypisany program SQL Server.
