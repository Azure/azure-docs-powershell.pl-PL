...
### Przykład 1. Uzyskiwanie repliki serwera PostgreSql według nazwy grupy zasobów i serwera
```powershell
...
To polecenie cmdlet pobiera replikę serwera PostgreSql według nazwy grupy zasobów i serwera.
