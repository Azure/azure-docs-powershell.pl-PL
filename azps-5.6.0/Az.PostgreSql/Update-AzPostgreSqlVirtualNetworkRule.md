...
### Przykład 1. Aktualizowanie reguły wirtualnej sieci pogresql według nazwy
```powershell
...
To polecenie cmdlet aktualizuje regułę PostgreSql virtual network według nazwy.

### Przykład 2. Aktualizowanie reguły sieci wirtualnej PostgreSql według tożsamości.
```powershell
...
Te polecenia cmdlet aktualizują regułę postgresql wirtualnej sieci według tożsamości.
...
### -SubnetId
Identyfikator ARM sieci wirtualnej.
...
### Microsoft.Azure.PowerShell.cmdlet.PostgreSql.Models.Api20171201.IVirtualNetworkRule
