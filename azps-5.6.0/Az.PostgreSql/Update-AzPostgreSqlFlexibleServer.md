...
Użyj Update-AzPostSqlFlexibleServerConfiguration, jeśli chcesz zaktualizować parametry serwera, takie jak wait_timeout lub net_retry_count.
...
### Przykład 1. Aktualizowanie serwera PostgreSql według nazwy grupy zasobów i serwera
```powershell
...
To polecenie cmdlet aktualizuje serwer PostgreSql według nazwy grupy zasobów i serwera.

### Przykład 2. Aktualizowanie serwera PostgreSql według tożsamości.
```powershell
...
To polecenie cmdlet aktualizuje serwer PostgreSql według tożsamości.
...
### -MaintenanceWindow
Okres czasu (UTC) wyznaczonego na konserwację.
Przykłady: "Nie:23:30", aby zaplanować na niedzielę o godzinie 23:30 czasu UTC.
Aby wrócić do domyślnego przekazania w trybie "Wyłączone"
...
### - SKU
Nazwa sKU, np. Burstable_B1ms, Standard_D2ds_v4
