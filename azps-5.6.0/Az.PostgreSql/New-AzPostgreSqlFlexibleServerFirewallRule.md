...
Te polecenia cmdlet tworzą regułę zapory PostgreSql przy użyciu clientIPAddress.

### Przykład 3. Tworzenie nowej reguły zapory postgresqlowej umożliwiającej dostęp do wszystkich ip
```powershell
