...
### Przykład 1. Usuwanie reguły zapory postgresqlowej według nazwy
```powershell
...
To polecenie cmdlet usuwa regułę zapory PostgreSql według nazwy.

### Przykład 2. Usuwanie reguły zapory postgresqlowej za pomocą tożsamości
```powershell
...
Te polecenia cmdlet usuwają regułę zapory PostgreSql za pomocą tożsamości.
