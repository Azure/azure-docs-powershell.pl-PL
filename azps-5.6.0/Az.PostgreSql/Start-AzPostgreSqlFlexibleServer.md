...
### Przykład 1. Uruchamianie serwera według nazwy zasobu
```powershell
PS C:\> Start-AzPostgreSqlFlexibleServer -ResourceGroupName PowershellPostgreSqlTest -Name postgresql-test
```

Uruchamianie serwera według nazwy

### Przykład 2. Uruchamianie serwera według tożsamości
```powershell
...
Uruchamianie serwera według tożsamości
