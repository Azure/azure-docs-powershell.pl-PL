...
### Przykład 1. Tworzenie nowego serwera PostgreSql
```powershell
...
Te polecenia cmdlet tworzą nowy serwer PostgreSql.
...
### -GeoRedundantBackup
Włączanie nadmiarowej lokalizacji geograficznej dla kopii zapasowej na serwerze.
