...
### Przykład 1. Lista wszystkich reguł sieci wirtualnej w określonym serwerze PostgreSql
```powershell
...
To polecenie cmdlet wyświetla listę wszystkich reguł sieci wirtualnej na określonym serwerze PostgreSql.
...
To polecenie cmdlet otrzymuje regułę wirtualnej sieci według nazwy.
...
To polecenie cmdlet pobiera regułę sieci wirtualnej za pomocą tożsamości.
