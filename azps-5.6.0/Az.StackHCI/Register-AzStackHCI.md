...
## SYNOPSIS
Register-AzStackHCI utworzy zasób w chmurze Microsoft.AzureStackHCI reprezentujący klaster lokalnym i zarejestruje klastr lokalnego na platformie Azure.
...
Wywołuj w jednym z węźle klastrów.
...
Określa thumbprint certyfikatu dostępnego we wszystkich węzłach. Użytkownik jest odpowiedzialny za zarządzanie certyfikatem.
...
### — Nazwa_komputera
Określa nazwę klastra lub jeden z węzła klastrów w klastrze lokalnym, który jest zarejestrowany na platformie Azure.
...
Określenie tego ustawienia wraz z usługami ArmAccessToken i AccountId pozwoli uniknąć interakcyjnego logowania platformy Azure.
...
### — Region
Określa region do utworzenia zasobu.
Wartością domyślną jest region EastUS.
...
### -RepairRegistration
Naprawianie bieżącej rejestracji HCI usługi Azure Stack w chmurze. To polecenie cmdlet usuwa certyfikaty lokalne w węzłach grupowanych i certyfikaty zdalne w aplikacji usługi Azure AD w chmurze i generuje nowe certyfikaty zastępcze dla obu. Grupa zasobów, nazwa zasobu i inne opcje rejestracji zostaną zachowane.
...
Jest to jedyny parametr obowiązkowy.
...
### Wynik: Powodzenie, Niepowodzenie lub Oczekiwanie NaWSąduAdminconsent lub Anulowane.
### ResourceId: Identyfikator zasobu utworzonego na platformie Azure.
### PortalResourceURL: adres URL zasobu portalu Azure.
### PortalAADAppPermissionsURL: adres URL portalu Azure dla strony uprawnień aplikacji AAD.
## NOTATKI
