...
## OPIS
Jest to polecenie cmdlet pomocy, za pomocą których można utworzyć obiekt profilu kontaktu pomocy technicznej podczas tworzenia lub aktualizowania biletu pomocy technicznej. Aby utworzyć zgłoszenie do pomocy technicznej, musisz określić następujące parametry, które są obowiązkowe: 
...
### Przykład 1. Tworzenie obiektu kontaktu
```powershell
