...
### Przykład 1. Uzyskiwanie kluczy dostępu do bazy danych
```powershell
...
To polecenie pobiera klucze dostępu tajnego używane do uwierzytelniania połączeń z bazą danych programu Redis Enterprise Cache o nazwie MyCache.
