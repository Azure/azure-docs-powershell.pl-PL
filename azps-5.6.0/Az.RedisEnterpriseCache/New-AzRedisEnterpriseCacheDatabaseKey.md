...
### Przykład 1. Ponowne generowanie klucza dostępu podstawowego
```powershell
...
To polecenie ponownie generuje podstawowy tajny klucz dostępu używany do uwierzytelniania połączeń z bazą danych pamięci podręcznej Redis Enterprise Cache o nazwie MyCache.

### Przykład 2. Ponowne generowanie pomocniczego klucza dostępu
```powershell
...
To polecenie ponownie generuje dodatkowy tajny klucz dostępu używany do uwierzytelniania połączeń z bazą danych programu Redis Enterprise Cache o nazwie MyCache.
...
### -KeyType
Który klucz dostępu do ponownego wygenerowania.
...
### Microsoft.Azure.PowerShell.Cmdlet.RedisEnterpriseCache.Models.Api20201001Preview.IAccessKeys
