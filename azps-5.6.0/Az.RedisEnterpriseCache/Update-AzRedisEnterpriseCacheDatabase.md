...
### Przykład 1. Aktualizowanie protokołu klienta
```powershell
...
To polecenie aktualizuje protokół klienta bazy danych dla funkcji Redis Enterprise Cache o nazwie MyCache.

### Przykład 2. Aktualizowanie zasad protokołu klienta i wywłasu
```powershell
...
To polecenie aktualizuje zasady protokołu klienta i eksmisji bazy danych dla funkcji Redis Enterprise Cache o nazwie MyCache.
...
### -EvictionPolicy
Zasady ponownego wywłasowania — wartość domyślna to NietrwałaLRU
...
### Microsoft.Azure.PowerShell.Cmdlet.RedisEnterpriseCache.Models.Api20201001Preview.IDatabase
