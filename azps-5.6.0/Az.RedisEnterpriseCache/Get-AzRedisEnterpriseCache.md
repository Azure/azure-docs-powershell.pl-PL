...
### Przykład 1. Uzyskiwanie pamięci podręcznej Redis Enterprise Cache według nazwy
```powershell
...
To polecenie pobiera pamięć podręczną Redis Enterprise Cache o nazwie MyCache.

### Przykład 2. Uzyskiwanie każdej pamięci podręcznej Redis Enterprise Cache w grupie zasobów
```powershell
...
To polecenie pobiera wszystkie funkcje Redis Enterprise Cache w określonej grupie zasobów.
