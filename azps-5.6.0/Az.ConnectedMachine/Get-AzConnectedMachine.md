...
### Przykład 1. Lista wszystkich połączonych komputerów w subskrypcji
```powershell
...
Wyświetla listę wszystkich połączonych komputerów w subskrypcji.
Jeśli subskrypcja nie zostanie określona, będzie ona używać subskrypcji z bieżącego kontekstu programu Azure PowerShell.

### Przykład 2. Lista wszystkich połączonych komputerów w grupie zasobów
```powershell
...
Lista wszystkich połączonych komputerów w grupie zasobów.

### Przykład 3. Uzyskiwanie połączonego komputera w grupie zasobów według nazwy
```powershell
...
Uzyskiwanie połączonego komputera w grupie zasobów według nazwy.
...
### Microsoft.Azure.PowerShell.cmdlet.ConnectedMachine.Models.Api20200802.IMachine
