...
### Przykład 2. Aktualizowanie rozszerzenia za pomocą lokalizacji określonej za pośrednictwem potoku
```powershell
...
Aktualizuje określone rozszerzenie przekazywane za pośrednictwem potoku.
W tym miejscu używamy rozszerzenia przekazywanego za pośrednictwem potoku, aby pomóc nam w identyfikować, nad którym rozszerzeniem chcemy pracować.
...
EXTENSIONPARAMETERS: <IMachineExtensionUpdate> W tym artykule opisano aktualizację rozszerzenia komputera.
  ...
  - `[Setting <IMachineExtensionUpdatePropertiesSettings>]`: Sformatowane ustawienia publiczne rozszerzenia w formacie Json.
