...
Usuwa połączony komputer.

### Przykład 2. Usuwanie połączonych komputerów za pośrednictwem potoku
```powershell
PS C:\> Get-AzConnectedMachine -ResourceGroupName contoso-connected-machines | Remove-AzConnectedMachine

```

Usuwa wszystkie komputery z `contoso-connected-machines` grupy zasobów.
