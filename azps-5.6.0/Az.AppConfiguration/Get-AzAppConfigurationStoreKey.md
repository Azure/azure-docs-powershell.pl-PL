...
## SYNOPSIS
Wyświetla klucz dostępu dla określonego magazynu konfiguracji.
...
### Przykład 1. Lista wszystkich kluczy sklepu z konfiguracją aplikacji
```powershell
...
To polecenie zawiera listę wszystkich kluczy magazynu magazynu konfiguracji aplikacji.
...
### Microsoft.Azure.PowerShell.Cmdlet.AppConfiguration.Models.Api20200601.IApiKey
