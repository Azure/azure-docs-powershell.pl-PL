...
### NewByNameParameterSet (Domyślne)
```
...
## OPIS
Polecenie cmdlet **New-AzSynapseIntegrationRuntimeKey** ponownie generuje klucz środowiska uruchomieniowego integracji przy użyciu nazwy klucza określonej przez parametr "KeyName". Poprzedni klucz jest nieprawidłowy.
