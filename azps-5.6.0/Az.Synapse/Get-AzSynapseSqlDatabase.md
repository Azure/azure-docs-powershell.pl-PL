...
## SYNOPSIS
Pobiera bazę danych Synapse Analytics SQL.
...
## OPIS
[Ta funkcja jest w ograniczonym podglądzie, początkowo dostępna tylko dla niektórych subskrypcji.] Polecenie **cmdlet Get-AzSynapseSqlDatabase** pobiera informacje o bazie danych SQL Azure Synapse Analytics.
...
To polecenie pobiera bazę danych SQL w obszarze roboczym ContosoWorkspace o nazwie ContosoSqlDatabase.
...
To polecenie pobiera wszystkie bazy danych SQL w ramach obszaru roboczego za pośrednictwem potoku.
...
To polecenie pobiera bazę danych SQL o określonym identyfikatorze zasobu.
