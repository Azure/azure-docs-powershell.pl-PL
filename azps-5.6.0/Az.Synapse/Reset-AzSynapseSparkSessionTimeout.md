...
### ResetByNameParameterSet (Domyślne)
```
...
## OPIS
Polecenie **cmdlet Remove-AzSynapseSparkSessionTimeout** resetuje limit czasu sesji analizy Synapse Analytics Spark.
...
To polecenie resetuje limit czasu sesji Analizy Synpsy z określonym identyfikatorem użytkownika.
...
To polecenie resetuje limit czasu sesji Analizy Synapse (Spark) z określonym identyfikatorem identyfikacyjnym w potoku.
