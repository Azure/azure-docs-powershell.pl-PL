...
### DisableByNameParameterSet (domyślne)
```
...
## OPIS
Polecenie **cmdlet Disable-AzSynapseSqlAdvancedDataSecurity** wyłącza zabezpieczenia zaawansowane danych w obszarze roboczym.
...
To polecenie wyłącza zaawansowane zabezpieczenia danych w obszarze roboczym o nazwie ContosoWorkspace.
...
To polecenie wyłącza w potoku zaawansowane zabezpieczenia danych w obszarze roboczym o nazwie ContosoWorkspace.
