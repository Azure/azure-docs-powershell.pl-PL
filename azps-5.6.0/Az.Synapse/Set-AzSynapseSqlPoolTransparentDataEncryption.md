...
## OPIS
Polecenie cmdlet **Set-AzSynapseSqlPoolTransparentDataEncryption** modyfikuje właściwość transparentnego szyfrowania danych (TDE, Transparent Data Encryption) puli JĘZYKA SQL Synapse Analytics platformy Azure Synapse Analytics.
...
To polecenie umożliwia TDE dla puli języka SQL o nazwie ContosoSqlPool w obszarze roboczym o nazwie ContosoWorkspace.
...
### — województwo
Stan szyfrowania danych przezroczystych puli danych analizy Azure Synapse Analytics.
