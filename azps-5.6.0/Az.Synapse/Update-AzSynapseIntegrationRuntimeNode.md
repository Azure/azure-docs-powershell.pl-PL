...
## OPIS
Polecenie **cmdlet Update-AzSynapseIntegrationRuntimeNode** aktualizuje właściwości węzła środowiska uruchomieniowego integracji z własnym hostem w obszarze roboczym. Obecnie obsługuje tylko aktualizowanie "ConcurrentJobsLimit".
