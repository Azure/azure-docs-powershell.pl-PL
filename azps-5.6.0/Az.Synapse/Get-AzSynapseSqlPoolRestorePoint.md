...
## OPIS
Polecenie **cmdlet Get-AzSynapseSqlPoolRestorePoint** pobiera odrębne punkty przywracania, z których można przywrócić pulę sql usługi Azure Synapse Analytics.
...
To polecenie zwraca wszystkie dostępne punkty przywracania dla puli sql usługi Azure Synapse Analytics o nazwie ContosoSqlPool.
