...
### SuspendByNameParameterSet (Domyślne)
```
...
## OPIS
Polecenie cmdlet **Suspend-AzSynapseSqlPool** zawiesza pulę sql usługi Azure Synapse Analytics.
...
To polecenie zawiesza aktywną pulę sql usługi Azure Synapse Analytics.
