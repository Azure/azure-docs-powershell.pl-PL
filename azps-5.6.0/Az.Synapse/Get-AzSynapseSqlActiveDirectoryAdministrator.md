...
## OPIS
Polecenie cmdlet **Get-AzSynapseSqlActiveDirectoryAdministrator** pobiera informacje o administratorze usługi Azure Active Directory (Azure AD) dla obszaru roboczego analizy Synapse Analytics Azure w bieżącej subskrypcji.
