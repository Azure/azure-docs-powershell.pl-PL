...
## OPIS
Polecenie **cmdlet Update-AzSynapseSparkPool** aktualizuje pulę przebiegu w czasie analizy Azure Synapse.
...
To polecenie aktualizuje pulę przebiegu w czasie analizy Azure Synapse w potoku.
...
To polecenie wyłącza automatyczne wstrzymywanie dla puli przebiegu w czasie analizy Azure Synapse.
...
### -EnableAutoScale
Wskazuje, czy należy włączyć automatyczne skalowanie.
