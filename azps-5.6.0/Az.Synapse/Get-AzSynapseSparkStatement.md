...
### GetSparkStatementsByIdParameterSet (Domyślne)
```
...
## OPIS
Polecenie **cmdlet Get-AzSynapseSparkStatement** pobiera informacje o instrukcji Azure Synapse Analytics Spark.
...
To polecenie pobiera wszystkie instrukcje przebiegu w trakcie sesji przebiegu w przebiegu w trakcie.
...
To polecenie pobiera instrukcje przebiegu w czasie z określonym identyfikatorem.
...
To polecenie pobiera wszystkie instrukcje przebiegu w przebiegu w ramach sesji przebiegu w przebiegu w potoku.
...
### - Natłok
Identyfikator instrukcji Spark.
