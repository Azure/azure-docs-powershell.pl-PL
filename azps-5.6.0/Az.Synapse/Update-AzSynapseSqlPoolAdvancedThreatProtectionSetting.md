...
## OPIS
Polecenie cmdlet **Update-AzSynapseSqlPoolAdvancedThreatProtectionSetting** ustawia zaawansowane ustawienia ochrony przed zagrożeniami w puli sql usługi Azure Synapse Analytics.
Aby włączyć zaawansowaną ochronę przed zagrożeniami w puli sql, ustawienia inspekcji muszą być włączone w tej puli sql.
...
To polecenie ustawia zaawansowane ustawienia ochrony przed zagrożeniami dla puli SQL o nazwie ContosoSqlPool w obszarze roboczym o nazwie ContosoWorkspace.
...
### -EmailAdmin
Definiuje, czy administratorzy poczty e-mail.
...
Rozdzielana średnikami lista adresów e-mail, na które mają być wysyłane alerty.
