...
## SYNOPSIS
Usuwa bazę danych Synapse Analytics SQL.
...
## OPIS
Polecenie **cmdlet Remove-AzSynapseSqlPool** trwale usuwa bazę danych SQL Azure Synapse Analytics.
...
To polecenie usuwa bazę danych AZURE Synapse Analytics SQL.
...
To polecenie usuwa bazę danych Azure Synapse Analytics SQL w potoku.
...
To polecenie usuwa bazę danych AZURE Synapse Analytics SQL o określonym identyfikatorze zasobu.
...
### -InputObject
Obiekt wejściowy bazy danych SQL, który zwykle przechodzi przez potok.
...
### -ResourceId
Identyfikator zasobu synapse SQL Database.
