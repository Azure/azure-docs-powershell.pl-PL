...
### Przykład 1. Usuwanie typu informacji i etykiety wrażliwości kolumny w puli języka SQL Azure Synapse.
```powershell
...
### Przykład 2. Usuwanie bieżących typów informacji i etykiet wrażliwości kolumn w puli sql Synapse Azure przy użyciu połączenia rurowego.
```powershell
