...
### InvokeByNameParameterSet (Domyślne)
```
...
## OPIS
Polecenie cmdlet **Invoke-AzSynapseIntegrationRuntimeUpgrade** uaktualnia środowisko integracji samoobsługowej, jeśli jest dostępna nowa wersja.
...
Polecenie cmdlet uaktualnia środowisko uruchomieniowe integracji z własnym hostem o nazwie "test-selfhost-ir" w obszarze roboczym ContosoWorkspace.
