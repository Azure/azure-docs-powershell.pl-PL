...
Przywrócona pula sql jest tworzona jako nowa pula SQL.
...
To polecenie tworzy pulę sql analizy Azure Synapse Analytics, wykorzystując punkt przywracania z dowolnej puli sql w tej subskrypcji w celu odzyskania lub skopiowania z poprzedniego stanu.
...
To polecenie tworzy pulę sql usługi Azure Synapse Analytics, wykorzystując punkt przywracania z dowolnej puli sql w tej subskrypcji w celu odzyskania lub skopiowania z poprzedniego stanu z identyfikatorem zasobu.
...
### — FromBackup
Oznacza, że należy przywrócić najnowszą kopię zapasową dowolnej puli języka SQL w tej subskrypcji.
