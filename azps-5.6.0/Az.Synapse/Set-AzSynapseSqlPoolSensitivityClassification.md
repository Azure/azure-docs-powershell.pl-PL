...
## OPIS
Polecenie Set-AzSynapseSqlPoolSensitivityClassification cmdlet ustawia typy informacji i etykiety wrażliwości kolumn w puli SQL.

## PRZYKŁADY

### Przykład 1. Ustawianie typu informacji i etykiety wrażliwości kolumny w puli sql Synapse platformy Azure.
```powershell
...
### Przykład 2. Ustawianie zalecanych typów informacji i etykiet wrażliwości kolumn w puli języka SQL Synapse platformy Azure.
```powershell
...
### Przykład 3. Ustawianie typu informacji i etykiety wrażliwości kolumny w puli sql Synapse Azure przy użyciu połączenia rurowego.
```powershell
