...
### GetByWorkspaceNameAndIdParameterSet (Domyślne)
```
...
## OPIS
Polecenie **cmdlet Get-AzSynapseRoleDefinition** pobiera definicję ról analizy Azure Synapse.
Jeśli nie określisz nazwy roli ani identyfikatora roli, to polecenie cmdlet pobiera wszystkie definicje ról.
...
To polecenie pobiera definicję roli w obszarze obszaru roboczego ContosoWorkspace o nazwie ContosoRole.
...
To polecenie pobiera wszystkie definicje ról w obszarze roboczym za pośrednictwem potoku.
