...
## OPIS
Polecenie **Invoke-AzSynapsePipeline** uruchamia uruchomienie w określonym potoku i zwraca identyfikator tego uruchomienia. Ten identyfikator GUID może zostać przekazany do użytkownika **Get-AzSynapsePipelineRun** lub **Get-AzSynapseActivityRun,** aby uzyskać szczegółowe informacje o tym uruchomieniu.
...
To polecenie uruchamia uruchomienie potoku o nazwie ContosoPipeline w obszarze roboczym ContosoWorkspace.
...
To polecenie uruchamia potok o nazwie ContosoPipeline w obszarze roboczym ContosoWorkspace za pośrednictwem potoku.
...
### -InputObject
Informacje o uruchomieniu potoku.
...
Jeśli tryb odzyskiwania ma wartość True (Prawda), potok, do których prowadzi odwołanie, zostanie pogrupowany pod tym samym wartością groupId(a).
...
Identyfikator uruchomienia potoku dla ponownego uruchomienia.
Jeśli zostanie określony identyfikator uruchomienia, parametry określonego uruchomienia zostaną użyte do utworzenia nowego uruchomienia.
...
### -StartActivityName
W trybie odzyskiwania ponowne uruchomienie rozpocznie się od tego działania.
Jeśli nie zostanie określona, zostaną uruchomione wszystkie działania.
