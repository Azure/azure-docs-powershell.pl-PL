...
### GetSparkJobsByIdParameterSet (domyślne)
```
...
## OPIS
Polecenie **cmdlet Get-AzSynapseSparkJob** pobiera zadanie Azure Synapse Analytics Spark.
Jeśli nie określisz zadania, to polecenie cmdlet otrzyma wszystkie zadania.
...
To polecenie pobiera wszystkie zadania w ramach puli przebiegu w czas.
...
To polecenie pobiera wszystkie zadania w puli przebiegu w przebiegu w potoku.
