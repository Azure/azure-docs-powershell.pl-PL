...
## OPIS
Polecenie **cmdlet Add-AzCognitiveServicesAccountNetworkRule** dodaje wartości IpRules lub VirtualNetworkRules do właściwości NetworkRule konta usług Cognitive Services

## PRZYKŁADY

### Przykład 1. Dodawanie kilku adresów IpRules za pomocą adresu IpAddressOrRange
```
...
To polecenie pozwala dodać kilka poleceń IpRules z adresem IpAddressOrRange.

### Przykład 2. Dodawanie dodatku VirtualNetworkRule z virtualNetworkResourceID
```
...
To polecenie pozwala dodać pole VirtualNetworkRule z polem VirtualNetworkResourceID.

### Przykład 3. Dodawanie obiektów VirtualNetworkRules za pomocą funkcji VirtualNetworkRule Objects z innego konta
```
...
To polecenie pozwala dodać obiekty VirtualNetworkRules z obiektami VirtualNetworkRule z innego konta.

### Przykład 4. Dodawanie kilku adresów IpRule za pomocą obiektów IpRule, danych wejściowych za pomocą JSON
```
...
To polecenie pozwala dodać kilka obiektów IpRule z obiektami IpRule, dane wejściowe z wartością JSON.
...
### -IpAddressOrRange
Konto usług Cognitive Services NetworkRule IpRules IpAddressOrRange w ciągu.
...
### -IpRule
Konto usług Cognitive Services NetworkRule IpRules.
...
Konto usług Cognitive Services NetworkRule VirtualNetworkRules VirtualNetworkResourceId w ciągu.
...
### — VirtualNetworkRule
Konto usług Cognitive Services NetworkRule VirtualNetworkRules.
