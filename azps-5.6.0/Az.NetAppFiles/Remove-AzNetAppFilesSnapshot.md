...
## SYNOPSIS
Usuwa migawkę plików ANF (Azure NetApp Files).
...
## OPIS
Polecenie **cmdlet Remove-AzNetAppFilesSnapshot** usuwa migawkę ANF.
...
To polecenie usuwa migawkę ANF "MyAnfSnapshot".
...
### -PassThru
Zwracanie, czy określona głośność została pomyślnie usunięta
...
### — VolumeObject
Obiekt głośności zawierający migawkę do usunięcia
