...
## SYNOPSIS
Pobiera szczegółowe informacje o ilości plików Azure NetApp (ANF).
...
## OPIS
Polecenie **cmdlet Get-AzNetAppFilesVolume** pobiera szczegóły dotyczące woluminu ANF.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie głośności ANF
```
...
To polecenie pobiera wolumin o nazwie MyAnfVolume z puli "MyAnfPool". 
...
### - PoolObject
Obiekt puli zawierający wielkość, która ma być zwracana
