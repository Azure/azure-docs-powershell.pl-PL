...
## SYNOPSIS
Zawieszanie/przerwanie połączenia replikacji w woluminie docelowym
...
To polecenie zawiesza połączenie replikacji ANF na woluminie "MyDestinationAnfVolume".
...
### -ForceBreak
Jeśli replikacja jest w przesyłaniu stanu i chcesz wymusić przerwę replikacji, ustaw wartość True (Prawda)
...
### -InputObject
Obiekt woluminu docelowego ANF z przerwą replikacji
...
### -PassThru
Zwracanie, czy wykonano podział określonej replikacji woluminu
