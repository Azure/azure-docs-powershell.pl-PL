...
## SYNOPSIS
Przywracanie/przywracanie głośności do jednej z jego migawek
...
## OPIS
Przywracanie/przywracanie głośności migawki określonej w paramterze MigawkaD
...
To polecenie pozwala przywrócić/przywrócić głośność na stronie MyVolume do jednej z migawek za pomocą migawki 7d6e4069-6c78-6c61-7bf6-c60968e45fbf
...
### -PassThru
Zwracanie, czy określona głośność została pomyślnie przywrócona/przywrócona
...
### - PoolObject
Obiekt puli zawierający wolumin do usunięcia
...
### -SnapshotId
MigawkaId migawki.
UUID w wersji 4 używanej do identyfikowania migawki
