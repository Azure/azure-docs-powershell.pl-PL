...
## SYNOPSIS
Aktualizuje zasady migawki plików ANF (Azure NetApp Files) na dostarczane opcjonalne modyfikatory.
...
To polecenie zmienia zasady kopii zapasowej ANF "MySnapshotPolicy", aby mieć podany harmonogram godzinowy.
