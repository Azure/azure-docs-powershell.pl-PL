...
## SYNOPSIS
Pobiera szczegółowe informacje o konfiguracji usługi Active Directory w usłudze Azure NetApp Files (ANF).
...
## OPIS
Polecenie **cmdlet Get-AzNetAppFilesActiveDirectory** pobiera szczegółowe informacje o konfiguracji konta ANF w usłudze Active Directory.
...
To polecenie pobiera konfigurację usługi AD o nazwie MyADConfigName dla konta usługi Azure NetApp Files (ANF) o nazwie MyAnfAccount.
...
### -ActiveDirectoryId
ActiveDirectoryId usługi Active Directory ANF
