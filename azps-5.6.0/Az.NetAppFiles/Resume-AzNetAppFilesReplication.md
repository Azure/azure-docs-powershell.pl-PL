...
## SYNOPSIS
Wznów/zsynchronizuj połączenie z woluminem docelowym. Jeśli operacja zostanie uruchomiono w woluminie źródłowym, spowoduje to odwrócenie połączenia i zsynchronizowanie go ze źródłem do miejsca docelowego.
...
## OPIS
Wznawianie/ponowne synchronizacja połączenia woluminu docelowego
...
To polecenie wznawia połączenie replikacji ANF dla woluminu "MyDestinationAnfVolume".

## PARAMETERS

### -AccountName
Nazwa konta ANF dla woluminu replikacji
...
### -InputObject
Obiekt obrotu miejsca docelowego replikacji ANF do ponownej synchronizacji
...
### -PassThru
Zwracanie, czy wykonano ponowną synchronizację określonego woluminu replikacji
...
### -PoolName
Nazwa puli anfów dla woluminu replikacji
...
### -ResourceId
Identyfikator zasobu woluminu docelowego replikacji ANF
