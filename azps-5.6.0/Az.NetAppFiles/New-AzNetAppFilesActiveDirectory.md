...
## SYNOPSIS
Tworzy nową konfigurację usługi Azure NetApp Files (ANF) w usłudze Active Directory.
...
To polecenie pobiera hasło usługi AD z programu Promt do nowej konfiguracji usługi Active Directory dla konta ANF "MyAnfAccount".
...
### -AccountObject
Konto dla nowego obiektu zasad kopii zapasowej
