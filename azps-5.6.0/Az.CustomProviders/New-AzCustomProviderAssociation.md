...
Utwórz niestandardowe skojarzenie dostawcy, skojarzony element docelowy provioder musi być poprawnie skonfigurowany z trasą dla "skojarzeń"
...
### — Zakres
Zakres skojarzenia.
Zakres może być dowolnym prawidłowym wystąpieniem zasobu REST.
Na przykład użyj dla zasobu maszyny wirtualnej '/subscriptions/{subscription-id}/resourceGroups/{resource-group-name}/providers/Microsoft.Compute/virtualMachines/{machine-name}".
...
### -TargetResourceId
Wystąpienie zasobu REST zasobu docelowego dla tego skojarzenia.
