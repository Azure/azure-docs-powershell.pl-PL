...
### Przykład 1. Usuwanie niestandardowego skojarzenia dostawcy.
```powershell
PS C:\> PS C:\> Remove-AzCustomProviderAssociation -Scope $id -Name Namespace.Type
```

Usuwanie niestandardowego skojarzenia dostawcy.

### Przykład 2. Usuwanie niestandardowego skojarzenia dostawcy z usługą Piping
```powershell
...
Usuwanie niestandardowego skojarzenia dostawców za pomocą funkcji rurowych i funkcji PassThru w celu wskazania sukcesu lub niepowodzenia.
