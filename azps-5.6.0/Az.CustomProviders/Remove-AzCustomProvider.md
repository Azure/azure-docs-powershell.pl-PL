...
### Przykład 1. Usuwanie dostawcy niestandardowego.
```powershell
...
### Przykład 2. Usuwanie dostawcy niestandardowego za pomocą passthru
```powershell
...
Usuwanie dostawcy niestandardowego za pomocą funkcji PassThru w celu wskazania sukcesu lub niepowodzenia.
