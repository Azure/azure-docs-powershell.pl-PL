...
## SYNOPSIS
Pobiera kolekcję Bazy danych MongoDB.
...
## OPIS
Polecenie **cmdlet Get-AzCosmosDBMongoDBCollection** pobiera kolekcję Dosdb MongoDB.
...
Obiekt zasobu zawiera indeksy MongoIndexes, _rid, _ts, _etag właściwości.
...
W tym przykładzie jest pobierany klucz Skey z pobranej kolekcji.
