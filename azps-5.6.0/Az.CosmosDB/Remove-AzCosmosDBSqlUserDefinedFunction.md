...
## SYNOPSIS
Usuwa funkcję Sql UserDefinedFunction języka Sql.
...
## OPIS
Polecenie cmdlet **Remove-AzCosmosDBSqlUserDefinedFunction** powoduje usunięcie właściwości AlegosDB Sql UserDefinedFunction odpowiadającej danej nazwie ResourceGroupName, AccountName i DatabaseName.
...
### -InputObject
Obiekt funkcji zdefiniowany przez użytkownika sql
...
### — Nazwa
Nazwa funkcji zdefiniowanej przez użytkownika.
...
### -PassThru
Wartość True (Prawda), jeśli użytkownik chce otrzymać dane wyjściowe.
Dane wyjściowe są prawdziwe, jeśli operacja została pomyślnie i jeśli nie, zostanie wygenerowany błąd.
