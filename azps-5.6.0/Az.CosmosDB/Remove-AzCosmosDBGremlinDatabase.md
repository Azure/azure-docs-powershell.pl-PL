...
## SYNOPSIS
Usuwa bazę danych Grasdb Gremlin.
...
## OPIS
Polecenie **cmdlet Remove-AzCosmosDBGremlinDatabase** usuwa bazę danych GrysDB Gremlin.
...
Polecenie cmdlet zwraca obiekt typu bool(po przekazaniu wartości -PassThru), co jest prawdziwe, jeśli usunięcie powiodło się.
