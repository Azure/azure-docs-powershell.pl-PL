...
## SYNOPSIS
Aktualizacja wykresu Gremlin Graph dla gry GrysDB. Wykonuje operację poprawiania po stronie klienta, odczytując istniejący wykres.
...
Obiekt ConflictResolutionPolicy typu PSConflictResolutionPolicy, jeśli jest ustawiony jako ConflictResolutionPolicy kontenera.
...
### -IndexingPolicy
Obiekt zasad indeksowania typu Microsoft.Azure.Commands.Dosdb.PSIndexingPolicy.
...
### — Przepływność
Przepływność wykresu Gremlin Graph (RU/s).
...
### -UniqueKeyPolicy
Obiekt UniqueKeyPolicy typu Microsoft.Azure.Commands.Dosdb.PSUniqueKeyPolicy.
...
### Microsoft.Azure.Commands.Dosdb.Models.PSUniqueKeyPolicy

### Microsoft.Azure.Commands.DoceńDB.Models.PSConflictResolutionPolicy
