...
## SYNOPSIS
Utwórz nowy obiekt AADB VirtualNetworkRule Object(PSVirtualNetworkRule).
...
## OPIS
Utwórz nowy obiekt ANETSDB VirtualNetworkRule Object(PSVirtualNetworkRule).
...
Wartość logiczna wskazująca, czy utworzyć regułę zapory, zanim sieć wirtualna będzie mieć włączony punkt końcowy usługi vnet.
...
### Microsoft.Azure.Commands.DoceńDB.Models.PSVirtualNetworkRule
