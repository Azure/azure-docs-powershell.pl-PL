...
## SYNOPSIS
Tworzy nowy obiekt typu PSIncludedPath. Może być przekazywana jako wartość parametru Set-AzCosmosDBSqlContainer.
...
## OPIS
Obiekt odpowiadający obiektowi IncludedPath interfejsu API SQL.
