...
## SYNOPSIS
Pobiera wykres GrysDB Gremlin Graph.
...
## OPIS
Polecenie **cmdlet Get-AzCosmosDBGremlinGraph** pobiera właściwości GrysDB Gremlin Graph.
...
Obiekt zasobu zawiera właściwości IndexingPolicy, PartitionKey, DefaultTtl, UniqueKeyPolicy, ConflictResolutionPolicy, _rid, _ts, _etag.
