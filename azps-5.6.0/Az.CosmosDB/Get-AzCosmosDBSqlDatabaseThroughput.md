...
## SYNOPSIS
Pobiera ustawienia przepływności odpowiadające bazom danych Sql Dla DlaSDB.
...
## OPIS
Polecenie **cmdlet Get-AzCosmosDBSqlDatabaseThroughput** pobiera ustawienia przepływności odpowiadające bazie danych Sql DlaSDB.
