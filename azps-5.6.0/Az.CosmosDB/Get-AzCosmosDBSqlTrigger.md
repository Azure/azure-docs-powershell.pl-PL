...
## SYNOPSIS
Pobiera wyzwalacz języka SQL DossDB.
...
## OPIS
Polecenie cmdlet **Get-AzCosmosDBSqlTrigger** pobiera listę wszystkich istniejących wyzwalaczy sql dla aleji ResourceGroupName, AccountName, DatabaseName i ContainerName oraz otrzymuje jeden wyzwalacz sql dla danej nazwy ResourceGroupName, AccountName, DatabaseName, ContainerName i TriggerName.
...
### Microsoft.Azure.Commands.DoceńDB.Models.PSSqlTriggerGetResults
