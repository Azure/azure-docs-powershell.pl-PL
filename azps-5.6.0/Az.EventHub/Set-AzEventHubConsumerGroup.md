...
## OPIS
Polecenie Set-AzEventHubConsumerGroup aktualizuje określoną grupę klientów centrum zdarzeń.
...
Ustawia metadane użytkownika grupy konsumenckiej \` MyConsumerGroupName na \` "Testowanie".
...
### -UserMetadata
Metadane użytkownika dla grupy ConsumerGroup
