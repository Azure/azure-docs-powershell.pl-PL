...
## OPIS
Polecenie Remove-AzEventHubConsumerGroup cmdlet usuwa określoną grupę klienta z danego centrum zdarzeń.
...
Usuwa grupę konsumencką \` MyConsumerGroupName z centrum zdarzeń \` \` MyEventHubName (nazwa_ obszaru nazw \` \` MyNamespaceName). \`
...
### Przykład 4. Użycie zmiennej ResourceId
```powershell
PS C:\> $resourceid = Get-AzEventHubConsumerGroup <params>
PS C:\> Remove-AzEventHubConsumerGroup -ResourceId $resourceid.Id
```

### Przykład 5. Użycie ciągu ResourceId
```powershell
...
### -ResourceId
Identyfikator zasobu ConsumerGroup
