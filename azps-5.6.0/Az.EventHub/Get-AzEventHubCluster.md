...
## SYNOPSIS
Pobiera szczegółowe informacje dotyczące pojedynczego klastra centrum zdarzeń lub pobiera listę klastrów centrum zdarzeń.
...
## OPIS
Polecenie Get-AzEventHubCluster zwraca szczegóły klastra Centrum zdarzeń lub listę wszystkich klastrów centrum zdarzeń w danej grupie zasobów.
Jeśli podano nazwę klastra, zostaną zwrócone szczegóły dotyczące pojedynczego klastra.
Jeśli nazwa klastra nie jest podana, jest zwracana lista wszystkich klastrów w określonej grupie zasobów.
...
Zwraca detials grupowania 'Eventhub-Cluster-5557' z grupy zasobów RSG-Cluster27651.
