...
## OPIS
Polecenie Set-AzEventHubAuthorizationRule aktualizuje określoną regułę autoryzacji w danym centrum zdarzeń.
...
Aktualizuje regułę autoryzacji MyAuthRuleName, aby udzielić uprawnień zarządzania do centrum zdarzeń MyEventHubName o zakresie przestrzeni nazw \` \` \` \` \` MyNamespaceName. \`
