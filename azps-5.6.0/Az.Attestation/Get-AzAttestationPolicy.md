...
## OPIS
Polecenie Get-AzAttestationPolicy pobiera zasady od dzierżawy w usługach Azure Attestation.
...
Pobiera zasady dotyczące testu *pshtestu* dostawcy poświadczenia dla typu *Tee SgxEnają.*
...
Pobiera zasady domyślnego dostawcy atestacji z lokalizacji Zjednoczone Królestwo *Na* południe dla tee typu *SgxEnająe.*
...
To polecenie cmdlet pobiera zasady atestacji dla dzierżawy, które określa ten parametr.
...
Obsługujemy cztery typy środowiska: SgxEnenae, OpenEnenae, CyResComponent i VBSEnżdże.
