...
### — Podpis
Określa token sieci Web JSON RFC7519 zawierający żądanie o nazwie "maa-policyCertificate", którego wartość jest kluczem sieci Web JSON JSON RFC7517 zawierającym zaufany klucz podpisywania do usunięcia.
