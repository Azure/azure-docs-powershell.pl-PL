...
## OPIS
Polecenie **cmdlet Get-AzConsumptionMarketplace** otrzymuje witryny marketplace subskrypcji.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie użycia platform handlowych
```powershell
...
### Przykład 2. Uzyskiwanie użycia z witryny marketplace z zakresem dat
```powershell
...
### Przykład 3. Uzyskiwanie użycia nazwy BillingPeriodName na platformie handlowej
```powershell
...
### -BillingPeriodName
Nazwa konkretnego okresu rozliczeniowego, z którym będzie skojarzony sklep.
...
### -EndDate
Data zakończenia (w czasie UTC) na przefiltrowanych rynkach.
...
### -InstanceId
Identyfikator wystąpienia platform handlowych, które mają być filtrowane.
...
### -InstanceName
Nazwa wystąpienia, z których mają być filtrowane witryny.
...
### -ResourceGroup
Grupa zasobów na platformach handlowych, które mają być filtrowane.
...
### -StartDate
Data rozpoczęcia (w czasie UTC) dni handlowych, które mają być filtrowane.
