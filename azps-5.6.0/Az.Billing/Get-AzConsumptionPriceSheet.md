...
## OPIS
Polecenie **cmdlet Get-AzConsumptionPriceSheet** pobiera arkusze cen subskrypcji.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie arkuszy cen
```powershell
...
### Przykład 2. Uzyskiwanie arkuszy cenowych z rozbudowaną ofertą MeterDetails
```powershell
...
### Przykład 3. Uzyskiwanie arkuszy cen dla parametru BillingPeriodName
```powershell
...
### Przykład 4. Uzyskiwanie 5 najlepszych rekordów arkuszy cen
```powershell
...
### -BillingPeriodName
Nazwa konkretnego okresu rozliczeniowego w celu uzyskania arkuszy cen, z którym jest skojarzony.
...
### -ExpandMeterDetail
Rozwiń arkusze cen na podstawie szczegółów taryfowego.
