...
### Przykład 1. Usuwanie środowiska szczegółowych informacji z serii czasowej według nazwy
```powershell
PS C:\> Remove-AzTimeSeriesInsightsEnvironment -ResourceGroupName testgroup -Name tsill

```

To polecenie usuwa środowisko szczegółowych informacji szeregu czasowego.

### Przykład 2. Usuwanie środowiska szczegółowych informacji z serii czasowej według obiektu
```powershell
