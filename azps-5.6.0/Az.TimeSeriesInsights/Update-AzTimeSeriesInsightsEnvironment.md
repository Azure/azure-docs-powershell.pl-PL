...
## SYNOPSIS
Aktualizuje środowisko o określonej nazwie w określonej grupie subskrypcji i zasobów.
...
### Przykład 1. Aktualizowanie środowiska szczegółowych informacji szeregu czasowego generacji 1
```powershell
...
To polecenie aktualizuje środowisko szczegółowych informacji szeregu czasowego generacji 1.

### Przykład 2. Aktualizowanie środowiska szczegółowych informacji szeregu czasowego generacji 1
```powershell
...
### — Tag
Pary klucz-wartość dodatkowych właściwości środowiska.
