...
### Przykład 1. Usuwanie określonego zestawu danych odwołania według nazwy
```powershell
PS C:\> Remove-AzTimeSeriesInsightsReferenceDataSet -EnvironmentName tsitest001 -Name dstest001 -ResourceGroupName testgroup

```

To polecenie usuwa określony zestaw danych odwołania.

### Przykład 2. Usuwanie określonego zestawu danych odwołania z obiektu
```powershell
