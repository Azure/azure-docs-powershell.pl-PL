...
### Przykład 1. Aktualizowanie określonego źródła zdarzeń według nazwy
```powershell
...
To polecenie aktualizuje określone źródło zdarzeń.

### Przykład 3. Aktualizowanie określonego źródła zdarzeń według obiektu
```powershell
...
### — Tag
Pary klucz-wartość dodatkowych właściwości źródła zdarzeń.
