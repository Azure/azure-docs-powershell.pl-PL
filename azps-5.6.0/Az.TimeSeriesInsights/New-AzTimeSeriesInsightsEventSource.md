...
### Przykład 1. Tworzenie źródła zdarzeń aplikacji EventHub w określonym środowisku
```powershell
...
To polecenie tworzy źródło zdarzeń aplikacji EventHub w określonym środowisku.

### Przykład 2. Tworzenie źródła zdarzeń aplikacji iothub w określonym środowisku
```powershell
...
To polecenie tworzy źródło zdarzeń aplikacji iothub w określonym środowisku.

## PARAMETERS

### - ConsumerGroupName
Nazwa grupy konsumenckiej centrum zdarzeń/iot, która zawiera partycje, z których będą odczytywane zdarzenia.
...
### -KeyName
Nazwa klucza SAS, który udziela usłudze Time Series Insights dostępu do centrum zdarzeń/iot.
...
### -ServiceBusNameSpace
Nazwa autobusu usługi zawierającego centrum wydarzeń.
...
### -SharedAccessKey
Wartość klucza dostępu udostępnionego, który udziela usłudze Time Series Insights dostępu do odczytu centrum zdarzeń/iot.
...
Właściwość zdarzenia, która będzie używana jako sygnatura czasowa źródła zdarzenia.
...
### Microsoft.Azure.PowerShell.Cmdlet.TimeSeriesInsights.Models.Api20200515.IEventSourceResource
