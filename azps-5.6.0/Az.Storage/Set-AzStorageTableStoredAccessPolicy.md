...
## OPIS
Polecenie **cmdlet Set-AzStorageTableStoredAccessPolicy** ustawia zasady dostępu przechowywanego dla tabeli magazynu platformy Azure.

## PRZYKŁADY

### Przykład 1. Ustawianie przechowywanych zasad dostępu w tabeli z pełnymi uprawnieniami
```
PS C:\>Set-AzStorageTableStoredAccessPolicy -Table "MyTable" -Policy "Policy08" -Permission raud
```

To polecenie ustawia zasady dostępu o nazwie Zasady08 dla tabeli magazynu o nazwie Moja tabela.
...
### -ExpiryTime
Określa czas wygaśnięcia przechowywanych zasad dostępu.
