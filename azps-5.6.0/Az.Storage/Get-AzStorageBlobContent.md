...
## OPIS
Polecenie **cmdlet Get-AzStorageBlobContent** pobiera określony obiekt blob magazynu.
Jeśli nazwa obiektu blob nie jest prawidłowa dla komputera lokalnego, to polecenie cmdlet automatycznie rozwiązuje ją, jeśli jest to możliwe.

## PRZYKŁADY

### Przykład 1. Pobieranie zawartości obiektów blob według nazwy
```
...
### Przykład 2. Pobieranie zawartości obiektów blob przy użyciu potoku
```
PS C:\>Get-AzStorageBlob -Container containername -Blob blobname | Get-AzStorageBlobContent
```

To polecenie używa potoku do odnalezienia i pobrania zawartości obiektów blob.

### Przykład 3. Pobieranie zawartości obiektów blob przy użyciu potoku i symbolu wieloznacznego
```
PS C:\>Get-AzStorageContainer container* | Get-AzStorageBlobContent -Blob "cbox.exe" -Destination "C:\test"
```

W tym przykładzie do znalezienia i pobrania zawartości obiektów blob jest używany symbol wieloznaczny gwiazdki i potok.

### Przykład 4. Pobieranie obiektu blob i zapisywanie go w zmiennej, a następnie pobieranie zawartości obiektów blob z obiektem blob
```
PS C:\>$blob = Get-AzStorageBlob -Container containername -Blob blobname 
PS C:\>Get-AzStorageBlobContent -CloudBlob $blob.ICloudBlob -Destination "C:\test"
```

W tym przykładzie najpierw pobierz obiekt blob i zapisz go w zmiennej, a następnie pobierz zawartość obiektu blob wraz z tym obiektem blob. 
...
Możesz go utworzyć lub użyć Get-AzStorageContainer cmdlet.
...
### — Kontener
Określa nazwę kontenera, który zawiera obiekt blob, który chcesz pobrać.
...
### — kontekst
Określa konto magazynu platformy Azure, z którego chcesz pobrać zawartość obiektów blob.
...
### — miejsce docelowe
Określa lokalizację przechowywania pobranego pliku.
...
## NOTATKI
* Jeśli nazwa obiektu blob jest nieprawidłowa dla komputera lokalnego, to polecenie cmdlet automatycznie ją rozpozna, jeśli jest to możliwe.
