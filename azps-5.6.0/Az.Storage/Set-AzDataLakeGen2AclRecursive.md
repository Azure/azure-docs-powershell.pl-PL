...
## OPIS
Polecenie **cmdlet Set-AzDataLakeGen2AclRecursive** ustawia wartość ACL rekurencyjnie na określonej ścieżce. Wejściowa ACL całkowicie zastąpi pierwotną ACL.

## PRZYKŁADY

### Przykład 1. Cykliczne ustawianie listy ACL w katalogu
```
...
To polecenie najpierw tworzy obiekt ACL z 3 wpisami acl, a następnie rekurencyjnie ustawia pozycję ACL w katalogu.

### Przykład 2. Cykliczne ustawianie listy ACL w katalogu głównym systemu plików
```
...
To polecenie najpierw ustawia cyklicznie pozycję ACL na katalog główny i nie powiodło się, a następnie wznów z ciągiem ContinuationToken po poprawce pliku, który zakończył się niepowodzeniem.

### Przykład 3. Ustawianie rekurentywnego fragmentu listy ACL według fragmentu
```
$token = $null
...
Ten skrypt ustawia wartość ACL w sposób powtarzany dla fragmentu katalogu według fragmentu, a rozmiar fragmentu to BatchSize * MaxBatchCount. W tym skrypcie rozmiar fragmentu wynosi 200.

### Przykład 4. Ustawianie listy ACL rekurencyjnie w katalogu i continueOnFailure, a następnie wznawianie od niepowodzeń po 1
```
...
To polecenie najpierw ustawia pozycję ACL rekurencyjnie do katalogu z ciągiem ContinueOnFailure, a niektóre elementy nie powiodły się, a następnie wznawiaj elementy, których niepowodzenie nie powiodło się, jeden po drugie.
