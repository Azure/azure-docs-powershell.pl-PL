...
To polecenie najpierw tworzy obiekt ACL z 2 wpisami acl, a następnie rekurencyjnie usuwa pozycję ACL z katalogu głównego systemu plików.
...
To polecenie najpierw usuwa reckurencyjnie ACL z katalogu i nie powiodło się, a następnie wznów z ciągiem ContinuationToken po naprawieniu przez użytkownika pliku, który zakończył się niepowodzeniem.
...
Ten skrypt spowoduje ponowne usunięcie listy ACL w fragcie katalogu według fragmentu, z rozmiarem fragmentu w rozmiarze BatchSize * MaxBatchCount. W tym skrypcie rozmiar fragmentu wynosi 50 000.
...
To polecenie najpierw usuwa cyklicznie listy ACL do katalogu z ciągiem ContinueOnFailure, a niektóre elementy nie powiodły się, a następnie wznawiaj elementy, które zakończyły się niepowodzeniem, jeden po drugie.
