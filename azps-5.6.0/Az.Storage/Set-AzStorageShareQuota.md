...
Zobacz ograniczenie przydziału https://docs.microsoft.com/azure/azure-subscription-service-limits#azure-files-limits w. 
...
### -ShareName
Określa nazwę udziału plików, dla którego ma być ustawiany przydział.
