...
Piąte polecenie określa instrukcje **Do-While,** która używa polecenia cmdlet **Get-AzStorageBlob** w celu uzyskania obiektów blob.
...
### - IncludeVersion
Wersje obiektów blob będą wyświetlane tylko wtedy, gdy ten parametr jest podany, domyślnie obiekt blob nie będzie zawierał wersji obiektów blob.
...
Oznacza to, że jeśli kontener zawiera tylko obiekty blob o nazwach "My", "MyBlob1" i "MyBlob2" i określisz "-Prefix My*", polecenie cmdlet nie zwraca żadnych obiektów blob.
