...
## OPIS
Polecenie **cmdlet New-AzRmStorageContainer** tworzy kontener obiektów blob magazynu

## PRZYKŁADY

### Przykład 1. Tworzenie kontenera obiektów blob magazynu z nazwą konta magazynu i nazwą kontenera z metadanymi
```
PS C:\>New-AzRmStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" -ContainerName "myContainer" -Metadata @{tag0="value0";tag1="value1";tag2="value2"}
```

To polecenie tworzy kontener obiektów blob magazynu z nazwą konta magazynu i nazwą kontenera z metadanymi.

### Przykład 2. Tworzenie kontenera obiektów blob magazynu z obiektem konta magazynu i nazwą kontenera z dostępem publicznym jako obiektem blob
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount"
PS C:\>New-AzRmStorageContainer -StorageAccount $accountObject -ContainerName "myContainer" -PublicAccess Blob
```

To polecenie tworzy kontener obiektów blob magazynu z obiektem konta magazynu i nazwą kontenera, z dostępem publicznym jako obiektem blob.

### Przykład 3. Tworzenie kontenera magazynu przy użyciu ustawienia EncryptionScope
```
...
To polecenie tworzy kontener magazynu z algorytmem szyfrowania defaltu i blokuje zakres szyfrowania z domyślnego kontenera.
Następnie pokaż powiązane właściwości kontenera.
