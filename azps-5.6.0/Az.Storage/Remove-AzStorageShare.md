...
### Przykład 2. Usuwanie udziału plików i wszystkich jego migawek
```
PS C:\>Remove-AzStorageShare -Name "ContosoShare06" -IncludeAllSnapshot
```

To polecenie usuwa udział plików o nazwie ContosoShare06 i wszystkie jego migawki.
...
### — Wymuszanie
Wymusz usunięcie udziału ze wszystkimi migawkami i całą zawartością.
...
### - IncludeAllSnapshot
Usuń udostępnianie plików ze wszystkimi migawkami
...
To polecenie cmdlet usuwa udział plików, który jest określany przez ten parametr.
...
To polecenie cmdlet usuwa obiekt, który jest określany przez ten parametr.
