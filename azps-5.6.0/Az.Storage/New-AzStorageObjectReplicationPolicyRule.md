...
### Przykład 1. Tworzenie reguły zasad replikacji obiektu tylko przy użyciu konta źródłowego i docelowego oraz wyświetlanie jego właściwości
```
...
To polecenie reguły zasad replikacji obiektu ze wszystkimi właściwościami i pokazanie jej właściwości.
...
Nazwa kontenera docelowego, do którego chcesz zreplikować dane.
