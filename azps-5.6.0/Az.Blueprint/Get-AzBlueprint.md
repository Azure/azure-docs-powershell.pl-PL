...
## OPIS
Pobierz co najmniej jedną definicję planu. Definicje planu istnieją w grupie zarządzania lub w zakresie subskrypcji.
...
Pobierz definicje planu w ramach bieżącej subskrypcji i hierarchię grup zarządzania subskrypcji.
...
Pobierz definicje planu w obrębie określonej grupy zarządzania.
...
Pobierz definicje planu w ramach określonej subskrypcji i hierarchię grup zarządzania subskrypcji.
...
Pobierz definicję planu z nazwą podaną w ramach określonej subskrypcji.
...
Pobierz definicję planu z podaną nazwą i wersją w określonej grupie zarządzania.
...
Pobierz najnowszą opublikowaną definicję planu z podaną nazwą w określonej grupie zarządzania.
...
### - LatestPublished
Flaga definicji planu z najnowszą opublikowaną flagą.
Po jej skonfigurowaniu wykonanie zwraca najnowszą opublikowaną wersję definicji planu.
...
### -ManagementGroupId
Identyfikator grupy zarządzania, w którym jest zapisywana definicja planu.
...
### - SubscriptionId
Identyfikator subskrypcji, w którym jest zapisywana definicja planu.
