...
## SYNOPSIS
Powoduje ponowne uruchomienie replikacji dla określonego serwera.
...
### Przykład 1. Według identyfikatorów.
```powershell
...
### Przykład 2. Według obiektu Input
```powershell
...
### -TargetObjectID
Określa serwer, dla którego ma zostać zainicjowana ponowna synchronizacja.
