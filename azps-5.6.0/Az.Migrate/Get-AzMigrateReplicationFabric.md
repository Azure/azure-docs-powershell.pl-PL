...
### Przykład 1. Wszystkie zasoby są podszyte według grupy zasobów i nazwy magazynu
```powershell
...
Wszystko, co należy chcieć w grupie zasobów i magazynie

### Przykład 2. Uzyskiwanie struktury według grupy zasobów, nazwy magazynu i nazwy tkaniny
```powershell
...
### Microsoft.Azure.PowerShell.cmdlet.migrate.models.api20180110.iFabric
