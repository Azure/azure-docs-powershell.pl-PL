...
Metoda tworzenia nowego projektu migracji.
...
### - Właściwość
Określa właściwości projektu.
Aby utworzyć tabelę, zobacz sekcję NOTATKI, aby uzyskać informacje o właściwościach WŁAŚCIWOŚCI i utworzyć tabelę skrótu.
...
WŁAŚCIWOŚĆ: <IMigrateProjectProperties> określa właściwości projektu.
  - `[ProvisioningState <ProvisioningState?>]`: stan inicjowania obsługi administracyjnej projektu migracji.
  - `[RegisteredTool <String[]>]`: pobiera lub ustawia listę narzędzi zarejestrowanych w projekcie migracji.
