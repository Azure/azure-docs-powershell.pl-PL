...
## SYNOPSIS
Czyści migrację testów dla serwera replikowania.
...
### -InputObject
Określa serwer replikowania, dla którego należy zainicjować testowe oczyszczanie migracji.
Obiekt serwera można pobrać za pomocą polecenia cmdlet Get-AzMigrateServerReplication Aby utworzyć konstruowanie, zobacz sekcję NOTATKI, aby uzyskać informacje o właściwościach INPUTOBJECT i utworzyć tabelę skrótów.
...
INPUTOBJECT: Określa serwer replikowania, dla którego należy zainicjować testowe <IMigrationItem> oczyszczanie migracji. Obiekt serwera można pobrać za pomocą Get-AzMigrateServerReplication cmdlet
