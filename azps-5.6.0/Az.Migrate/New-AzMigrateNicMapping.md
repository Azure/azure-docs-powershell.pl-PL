...
## SYNOPSIS
Tworzy obiekt w celu zaktualizowania właściwości NIC serwera replikowania.
...
### Przykład 1. Tworzenie obiektu NIC
```powershell
...
Tworzy obiekt aktualizacji NIC.

## PARAMETERS

### - NicID
Określa identyfikator nic do zaktualizowania.
...
### - TargetNicIP
Określa adres IP w docelowej podsieci, który ma być używany dla nic.
...
Określa, czy karta NIC ma zostać zaktualizowana jako podstawowa, pomocnicza, czy nie.
...
### -TargetNicSubnet
Określa nazwę podsieci dla nic w docelowej sieci wirtualnej, do której należy zmigrować serwer.
...
### Microsoft.Azure.PowerShell.cmdlet.migrate.models.api20180110.IVCbtNicInput
