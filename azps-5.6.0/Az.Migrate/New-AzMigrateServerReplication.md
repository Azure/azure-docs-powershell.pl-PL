...
Dotyczy to sytuacji, w których istnieje wiele dyskietek, które muszą być chronione.
...
Aby skonstruować, zobacz sekcję NOTATEK, aby uzyskać informacje o właściwościach DISKTOINCLUDE i utworzyć tabelę skrótów.
...
### -PerformAutoResync
Określa, czy replikacja zostanie naprawiona automatycznie w przypadku, gdy śledzenie zmian dla serwera źródłowego w ramach replikacji zostanie utracone.
...
### -TargetSubnetName
Określa nazwę podsieci w docelowym środowisku wirtualnym Netowk, do którego należy przeprowadzić migrację serwera.
...
DISKTOINCLUDE <IVCbt Jednak[]>: Określa dysk, który ma zostać uwzględniony na serwerze źródłowym w celu replikacji.
