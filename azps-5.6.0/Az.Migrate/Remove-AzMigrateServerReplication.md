...
## SYNOPSIS
Zatrzymuje replikację dla migrego serwera.
...
Ponowne synchronizacja według identyfikatora.

### Przykład 2. Usuwanie według obiektu Input
```powershell
...
### -ForceRemove
Określa, czy replikacja musi zostać usunięta.
...
### -TargetObjectID
Określa serwer replcatingu, dla którego replice muszą zostać wyłączone.
