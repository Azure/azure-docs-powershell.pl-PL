...
## SYNOPSIS
Spowoduje to usunięcie pliku YAML użytego do skonfigurowania konfiguracji kontrolki źródła, co spowoduje zatrzymanie przyszłej synchronizacji ze źródłowym obiektem ponownie.
...
### Przykład 1. Usuwanie konfiguracji klastrów kubernetes według nazw
```powershell
...
To polecenie usuwa konfigurację klastrów kubernetes według nazw.

### Przykład 2. Usuwanie konfiguracji klastrów kubernetes według obiektów
```powershell
...
To polecenie usuwa konfigurację klastrów kubernetes według obiektów.
