...
## SYNOPSIS
Włącza diagnostykę w usłudze Azure Redis Cache.
...
## OPIS
Polecenie **cmdlet Set-AzRedisCacheDiagnostic** umożliwia diagnostykę dla pamięci podręcznej Azure Redis Cache.
...
To polecenie umożliwia diagnostykę dla pamięci podręcznej Azure Redis.
To polecenie włączy diagnostykę lub zaktualizuje konto magazynu dla wszystkich funkcji Azure Redis Caches w tym samym regionie subskrypcji.
...
### - StorageAccountId
Określa identyfikator zasobu konta magazynu używanego do przechowywania danych diagnostycznych.
