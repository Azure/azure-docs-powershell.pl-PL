...
## SYNOPSIS
Tworzy obiekt reprezentujący ścieżkę magazynu platformy Azure, która ma być montowana w aplikacji sieci Web. Ma być używany jako parametr (-AzureStoragePath) do Set-AzWebApp i Set-AzWebAppSlot
...
## OPIS
Tworzy obiekt reprezentujący ścieżkę magazynu platformy Azure do montażu w aplikacji sieci Web.
...
### — MountPath
Ścieżka w kontenerze, w którym zostanie ujawniony udział określony przez usługę ShareName
...
### — Nazwa
Identyfikator właściwości Magazyn platformy Azure.
Musi być unikatowy w aplikacji sieci Web lub w aplikacji Slot
...
### -ShareName
Nazwa udziału do montażu na kontenerze
