...
## OPIS
Pozwala przywrócić migawkę aplikacji sieci Web do aplikacji sieci Web. Przywracanie migawki powoduje zastąpienie wszystkich plików w aplikacji sieci Web plikami zawartymi w tej migawki. Aby przywrócić także ustawienia, użyj parametru przełącznika RecoverConfiguration. Migawkę z jednej aplikacji sieci Web można przywrócić do dowolnej innej aplikacji sieci Web w tej samej subskrypcji.
