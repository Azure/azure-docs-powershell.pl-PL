...
## OPIS
Polecenie **cmdlet Restore-AzWebAppBackup** przywraca kopię zapasową aplikacji Azure Web App.
...
Przywraca kopię zapasową określonej aplikacji ContosoWebApp, która znajduje się w grupie zasobów Default-Web-WestUS w obiekcie blob "myBlob", który znajduje się w https://storageaccount.file.core.windows.net

### Przykład 2

Polecenie Restore-AzWebAppBackup przywraca kopię zapasową aplikacji Azure Web App. (wygenerowane automatycznie)
...
### -AppServicePlan
Nazwa planu usługi aplikacji dla przywróconej aplikacji. Jeśli pozostawisz puste, zostanie użyty bieżący plan usług aplikacji.
...
Opcja Ignoruj nazwy hostów powodujące konflikt
