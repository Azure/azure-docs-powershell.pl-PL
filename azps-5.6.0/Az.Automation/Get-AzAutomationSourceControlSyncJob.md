...
## OPIS
Polecenie Get-AzAutomationSourceControlSyncJob pobiera zadania synchronizacji kontrolki źródła automatyzacji Azure. Aby uzyskać określone zadanie synchronizacji kontrolki źródła, określ jego identyfikator.

## PRZYKŁADY

### Przykład 1
To polecenie pobiera wszystkie zadania synchronizacji kontrolki źródła automatyzacji dla kontrolki źródłowej VSTSNative.
...
### Przykład 2
To polecenie pobiera zadanie synchronizacji kontrolki źródła o identyfikatorze 08d6d266-27b6-463c-beea-bc48a67ace15 dla kontrolki źródłowej VSTSNative. 
...
Pobiera zadania synchronizacji kontrolki źródła automatyzacji Azure. (wygenerowane automatycznie)
