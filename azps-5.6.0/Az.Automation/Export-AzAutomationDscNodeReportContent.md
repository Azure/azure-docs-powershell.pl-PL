...
## OPIS
Polecenie **cmdlet Export-AzAutomationDscNodeReportContent** eksportuje nieprzetworzone treści raportu APS Desired State Configuration (DSC).
Węzeł DSC wysyła raport DSC do usługi Azure Automation.
...
Ten zestaw poleceń eksportuje najnowszy raport z węzła DSC o nazwie Komputer14 na pulpit.

## PARAMETERS

### -AutomationAccountName
Określa nazwę konta automatyzacji.
To polecenie cmdlet eksportuje zawartość raportu dla węzła DSC, który należy do konta automatyzacji, które określa ten parametr.
...
### -OutputFolder
Określa folder wyjściowy, do którego to polecenie cmdlet eksportuje zawartość raportu.
...
### - ReportId
Określa unikatowy identyfikator raportu węzła DSC eksportowanego przez to polecenie cmdlet.
...
To polecenie cmdlet eksportuje zawartość raportu dla węzła DSC, który należy do grupy zasobów, której to polecenie cmdlet określa.
