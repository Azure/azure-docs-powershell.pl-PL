...
### Przykład 1. Wyłączanie aplikacji WebHook
```powershell
...
To polecenie ustawia wartość uruchamiania dla sieci Webhook i wymusza uruchomienie podręcznika w grupie Pracownik hybrydowy o nazwie Windows.
...
### - RunOn
Opcjonalna nazwa agenta hybrydowego, który powinien wykonać podręcznik
