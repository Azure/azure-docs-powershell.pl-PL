...
# Moduł Az.Automation
## Opis
W tym temacie o tematy pomocy dotyczące cmdlet azure Automation.

## Polecenia cmdlet az.automation
...
Eksportuje nieprzetworzone treści raportu DSC wysłanego z węzła DSC do automatyzacji.

### [Export-AzAutomationRunbook](Export-AzAutomationRunbook.md)
Eksportuje podręcznik automatyzacji.

### [Get-AzAutomationAccount](Get-AzAutomationAccount.md)
Pobiera konta automatyzacji w grupie zasobów.
...
Otrzymuje zadania kompilacji dsc w automatyzacji.

### [Get-AzAutomationDscCompilationJobOutput](Get-AzAutomationDscCompilationJobOutput.md)
Pobiera strumienie rejestrowania zadania kompilacji dsc automatyzacji.
...
Pobiera wdrożenia konfiguracji węzła dsc w automatyzacji.

### [Get-AzAutomationDscNodeConfigurationDeploymentSchedule](Get-AzAutomationDscNodeConfigurationDeploymentSchedule.md)
Pobiera harmonogram zadania wdrażania konfiguracji węzła dsc w automatyzacji.
...
Pobiera metadane dla modułów z automatyzacji.
...
Pobiera listę konfiguracji aktualizacji oprogramowania azure Automation.

### [Get-AzAutomationSoftwareUpdateMachineRun](Get-AzAutomationSoftwareUpdateMachineRun.md)
Pobiera listę uruchomionych maszyn do konfiguracji oprogramowania azure Automation Software Update.

### [Get-AzAutomationSoftwareUpdateRun](Get-AzAutomationSoftwareUpdateRun.md)
Pobiera listę uruchamianych aktualizacji oprogramowania Azure Automation.

### [Get-AzAutomationSourceControl](Get-AzAutomationSourceControl.md)
Pobiera listę kontrolek źródeł usługi Azure Automation.

### [Get-AzAutomationSourceControlSyncJob](Get-AzAutomationSourceControlSyncJob.md)
Pobiera zadania synchronizacji kontrolki źródła automatyzacji Azure.
...
Pobiera webhoox z automatyzacji.
...
Importuje podręcznik uruchamiania automatyzacji.
...
Tworzy połączenie automatyzacji.

### [New-AzAutomationCredential](New-AzAutomationCredential.md)
Tworzy poświadczenia automatyzacji.

### [New-AzAutomationKey](New-AzAutomationKey.md)
Ponownie generuje klucze rejestracji dla konta automatyzacji.
...
Tworzy podręcznik automatyzacji.
...
Tworzy zaplanowaną konfigurację aktualizacji oprogramowania azure Automation.
...
Tworzy witrynę sieci Web dla podręcznika uruchamiania automatyzacji.
...
Rejestruje maszynę wirtualną platformy Azure jako węzeł dsc dla konta automatyzacji.

### [Register-AzAutomationScheduledRunbook](Register-AzAutomationScheduledRunbook.md)
Kojarzy podręcznik z harmonogramem.

### [Remove-AzAutomationAccount](Remove-AzAutomationAccount.md)
Usuwa konto automatyzacji.
...
Usuwa metadane z konfiguracji węzła dsc w automatyzacji.

### [Remove-AzAutomationHybridWorkerGroup](Remove-AzAutomationHybridWorkerGroup.md)
Usuwa grupę pracowników hybrydowych z automatyzacji.
...
Usuwa kontrolkę źródła azure automation.
...
Modyfikuje konto automatyzacji.
...
Modyfikuje konfigurację węzła, na który jest zamapowany węzeł DSC.

### [Set-AzAutomationModule](Set-AzAutomationModule.md)
Aktualizuje moduł w automatyzacji.

### [Set-AzAutomationRunbook](Set-AzAutomationRunbook.md)
Modyfikuje podręcznik.
...
Wdraża konfigurację węzła dsc w automatyzacji.
...
Uruchamia zadanie synchronizacji kontrolki źródła automatyzacji Azure.

### [Stop-AzAutomationDscNodeConfigurationDeployment](Stop-AzAutomationDscNodeConfigurationDeployment.md)
Zatrzymuje wdrożenie konfiguracji węzła dsc w automatyzacji. Powoduje jedynie zatrzymanie bieżącego zadania wdrażania, ale nie powoduje nieprzypisu już przypisanych konfiguracji węzła.
