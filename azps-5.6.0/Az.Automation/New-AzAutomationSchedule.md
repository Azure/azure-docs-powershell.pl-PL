...
Pierwsze polecenie pobiera identyfikator strefy czasowej z systemu i przechowuje je w $TimeZone czasowej.
...
### -DayOfWeekOccurrence
Określa wystąpienie tygodnia w miesiącu, w który został uruchomiony harmonogram.
psdx_paramvalues
- 1
- 2
- 3
...
### -MonthInterval
Określa interwał (w miesiącu) dla harmonogramu.
...
### — OneTime
Określa, że polecenie cmdlet tworzy harmonogram czasowy.
