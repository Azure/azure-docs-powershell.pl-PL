...
## OPIS
Polecenie **cmdlet Get-AzAutomationJobOutput** pobiera dane wyjściowe zadania automatyzacji platformy Azure.

## PRZYKŁADY

### Przykład 1. Uzyskiwanie wyniku zadania automatyzacji
```
...
Określa nazwę konta automatyzacji, dla którego to polecenie cmdlet uzyskuje dane wyjściowe zadania.
...
### — Identyfikator
Określa identyfikator zadania, dla którego to polecenie cmdlet uzyskuje dane wyjściowe.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, dla której to polecenie cmdlet uzyskuje dane wyjściowe zadania.
...
### — StartTime
Określa czas rozpoczęcia jako obiekt **DateTimeOffset.**
Możesz określić ciąg, który może zostać przekonwertowany na prawidłowy **dateTimeOffset.**
Polecenie cmdlet pobiera dane wyjściowe utworzone po tym czasie.
