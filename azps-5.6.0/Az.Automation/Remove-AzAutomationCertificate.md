...
## OPIS
Polecenie **cmdlet Remove-AzAutomationCertificate** usuwa certyfikat z usługi Azure Automation.
...
To polecenie usuwa certyfikat o nazwie Cert01 z konta automatyzacji o nazwie Contoso17.
...
### — Nazwa
Określa nazwę certyfikatu, który zostanie usuwany przez to polecenie cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, dla której to polecenie cmdlet usuwa certyfikat.
