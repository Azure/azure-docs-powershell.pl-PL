...
## OPIS
Polecenie Update-AzAutomationSourceControl modyfikuje wartość pola w kontrolce źródłowej w automatyzacji azure.

## PRZYKŁADY

### Przykład 1
To polecenie ustawia wartość fałsz pola PublishRunbook dla kontrolki źródła azure Automation o nazwie VSTSNative na koncie o nazwie devAccount.
...
Aktualizuje kontrolkę źródłową azure automation. (wygenerowane automatycznie)
