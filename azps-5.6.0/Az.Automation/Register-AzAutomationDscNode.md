...
Jeśli chcesz zarejestrować węzeł do konta automatyzacji w innej subskrypcji, musisz użyć szablonu ARM zamiast polecenia cmdlet. Aby uzyskać więcej szczegółowych [informacji,](https://docs.microsoft.com/azure/automation/automation-dsc-onboarding#registering-virtual-machines-across-azure-subscriptions) zapoznaj się z dokumentacją usługi Azure Automation.
