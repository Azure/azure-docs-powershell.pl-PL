...
## OPIS
Polecenie Set-AzSqlVMConfigGroup cmdlet ustawia informacje potrzebne do dołączenia do grupy maszyn wirtualnych języka SQL w celu skonfigurowania maszyny wirtualnej sql.
...
Hasło dla konta bootstrap klastrów
...
Hasło dla konta operatora klastrów
...
### -SqlVM
Konfiguracja maszyny wirtualnej SQL, do której zostanie dodane członkostwo w grupach
...
### -SqlVMGroup
Grupa, do których należy maszynę wirtualna SQL
