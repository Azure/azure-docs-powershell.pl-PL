...
## OPIS
Polecenie Remove-AzAvailabilityGroupListener cmdlet usuwa słuchacza grupy dostępności.
...
Usuwa słuchacza grupy dostępności AgListener01 z grupy dostępności Grupy dostępności001.
...
### -InputObject
Obiekt Słuchacz grupy dostępności.
