...
## OPIS
Polecenie **cmdlet New-AzApiManagementOpenIdConnectProvider** tworzy dostawcę OpenID Connect w usłudze Azure API Management.

## PRZYKŁADY

### Przykład 1. Tworzenie dostawcy
```powershell
...
To polecenie tworzy dostawcę połączenia OpenID **o** nazwie Contoso OpenID Connect Provider

### Przykład 2

Tworzy dostawcę usługi OpenID Connect. (wygenerowane automatycznie)
...
Określa identyfikator dostawcy.
