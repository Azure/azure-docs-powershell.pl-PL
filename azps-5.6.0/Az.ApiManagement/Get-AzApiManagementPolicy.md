...
### Przykład 2. Pobierz zasady zakresu produktu
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
To polecenie pobiera zasady zakresu dzierżawy w formacie ucieczki poza xml.
...
Jeśli określisz ten parametr za pomocą *wartości ApiId,* polecenie cmdlet zwróci zasady zakresu operacji.
