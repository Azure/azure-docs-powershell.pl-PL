...
## OPIS
Polecenie **cmdlet Remove-AzApiManagementOperation** usuwa istniejącą operację.

## PRZYKŁADY

### Przykład 1. Usuwanie istniejącej operacji interfejsu API
```powershell
...
### -ApiRevision
Identyfikator poprawki interfejsu API. Ten parametr jest opcjonalny. Jeśli nie zostanie określona, operacja zostanie usunięta z aktualnie aktywnej poprawki interfejsu API.
