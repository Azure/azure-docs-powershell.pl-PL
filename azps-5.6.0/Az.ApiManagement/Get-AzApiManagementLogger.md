...
## OPIS
Polecenie **cmdlet Get-AzApiManagement Można** uzyskać **Loglogowanie** usługi Azure API Management lub wszystkich rejestratorów.
...
To polecenie pobiera wszystkie rejestratory w określonym kontekście.
