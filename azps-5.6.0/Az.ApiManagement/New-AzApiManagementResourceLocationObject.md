...
## OPIS
Polecenie **cmdlet New-AzApiManagementResourceLocationObject** tworzy nową umowę o lokalizację zasobu (używaną w bramach).

## PRZYKŁADY

### Przykład 1. Tworzenie umowy o lokalizację zasobu
```powershell
PS C:\>$location = New-AzApiManagementResourceLocationObject -Name "n1" -City "c1" -District "d1" -CountryOrRegion "r1"
```

To polecenie tworzy lokalizację zasobu.
