...
## OPIS
Uzyskaj szczegółowe informacje o konfiguracji dostawcy tożsamości.
ClientSecret nie zostanie uwzględniony w szczegółach wyników. Aby uzyskać klucz tajny klienta, użyj funkcji **Get-AzApiManagementIdentityProviderClientSecret.**

## PRZYKŁADY

### Przykład 1. Uzyskiwanie wszystkich dostawców tożsamości
...
Pobierz całą konfigurację dostawcy tożsamości do usługi.

### Przykład 2. Uzyskiwanie dostawcy tożsamości typu AAD
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### Przykład 3. Uzyskiwanie dostawcy tożsamości typu B2C AAD
```powershell
