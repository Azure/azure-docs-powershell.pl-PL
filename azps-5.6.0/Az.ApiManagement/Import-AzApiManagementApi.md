...
### -ServiceUrl
Adres URL usługi sieci Web eksponujące interfejs API. Ten adres URL będzie używany tylko w usłudze Azure API Management i nie będzie publiczny. Ten parametr jest opcjonalny. Jeśli zostanie podany, zastąpi ono wartość ServiceUrl określoną w dokumencie Specyfikacje.
