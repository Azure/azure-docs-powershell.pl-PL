...
### Przykład 1. Uzyskiwanie szczegółów całego schematu interfejsu API interfejsu API
```powershell
...
To polecenie pobiera wszystkie schematy interfejsu API skojarzone z interfejsem API dla określonego kontekstu `swagger-petstore-extensive` ApiManagement.
...
To polecenie pobiera schemat interfejsu API skojarzony z interfejsem API dla określonego kontekstu `5cc9cf67e6ed3b1154e638bd` `swagger-petstore-extensive` ApiManagement.
...
### -ResourceId
Identyfikator zasobu arm schematu interfejsu API. Jeśli zostanie określona, spróbuje znaleźć schemat interfejsu API za pomocą identyfikatora. Ten parametr jest wymagany.
