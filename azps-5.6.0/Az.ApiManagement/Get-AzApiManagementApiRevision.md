...
### Przykład 1. Uzyskiwanie wszystkich poprawek interfejsu API
```powershell
...
To polecenie pobiera wszystkie poprawki interfejsu API określonego interfejsu API dla określonego kontekstu apiManagement.

## PARAMETERS

### -ApiId
Identyfikator API, którego poprawki chcemy wyświetlić.
