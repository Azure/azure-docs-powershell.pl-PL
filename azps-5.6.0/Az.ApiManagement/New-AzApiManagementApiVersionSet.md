...
## OPIS
Polecenie **cmdlet New-AzApiManagementApiVersionSet** tworzy jednostkę zestawu wersji interfejsu API w kontekście zarządzania interfejsem API platformy Azure.
...
To polecenie tworzy zestaw wersji interfejsu API, który określa schemat wersji `Query` i parametr `api-version` zapytania.
...
Jeśli nie określono identyfikatora, zostanie wygenerowany.
