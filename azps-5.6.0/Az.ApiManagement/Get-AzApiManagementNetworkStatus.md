...
## OPIS
Pobiera stan sieci usługi zarządzania interfejsami API
...
Pobiera stan łączności różnych zasobów, od których zależy usługa ApiManagement.

## PARAMETERS

### -ApiManagementObject
Wystąpienie programu PsApiManagement. Ten parametr jest wymagany.
...
### — Lokalizacja
Lokalizacja usługi zarządzania interfejsami API.
...
### — Nazwa
Nazwa zarządzania interfejsami API.
...
### -ResourceGroupName
Nazwa grupy zasobów, w której istnieje zarządzanie interfejsem API.
