...
## OPIS
Polecenie **cmdlet Add-AzApiManagementApiToProduct** dodaje interfejs API zarządzania interfejsem Azure API do produktu.
...
To polecenie dodaje określony interfejs API do określonego produktu.

## PARAMETERS

### -ApiId
Określa identyfikator interfejsu API do dodania do produktu.
...
### - ProductId
Określa identyfikator produktu, do którego ma być dodać interfejs API.
