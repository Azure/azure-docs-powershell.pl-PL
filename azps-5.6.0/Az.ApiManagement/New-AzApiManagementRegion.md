...
## OPIS
Polecenie Pomocnik w celu utworzenia wystąpienia polecenia PsApiManagementRegion.
...
Tworzy usługę ApiManagement typu VpnType zewnętrznego w regionie Zachód Stanów Zjednoczonych z dodatkowymi regionami w środkowych Usa.

## PARAMETERS

### — Pojemność
Pojemność SKU dodatkowego regionu usługi Azure API Management.
