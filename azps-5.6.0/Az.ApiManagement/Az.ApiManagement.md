...
---
# Moduł Az.ApiManagement
## Opis
W tym temacie o tematy pomocy dotyczące cmdlet zarządzania interfejsami API platformy Azure.
...
Umożliwia kopię zapasową usługi zarządzania interfejsem API.

### [Export-AzApiManagementApi](Export-AzApiManagementApi.md)
Eksportuje interfejs API do pliku.

### [Get-AzApiManagement](Get-AzApiManagement.md)
Pobiera listę lub określony opis usługi zarządzania interfejsami API.

### [Get-AzApiManagementApi](Get-AzApiManagementApi.md)
Otrzymuje interfejs API.
...
Pobiera szczegółowe informacje o wszystkich poprawkach interfejsu API

### [Get-AzApiManagementApiSchema](Get-AzApiManagementApiSchema.md)
Uzyskiwanie szczegółowych informacji o schemacie interfejsu API
...
Poznaj szczegóły dotyczące bazy danych.
...
Pobiera certyfikaty zarządzania interfejsem API skonfigurowane na celu w celu obsługi w usłudze uwierzytelniania wspólnego z zapleczami.
...
Pobiera listę lub określonej nazwanej wartości.

### [Get-AzApiManagementNamedValueSecretValue](Get-AzApiManagementNamedValueSecretValue.md)
Pobiera wartość tajny określonej nazwanej wartości.

### [Get-AzApiManagementNetworkStatus](Get-AzApiManagementNetworkStatus.md)
Pobiera stan łączności z zasobami zewnętrznymi, od których zależy usługa zarządzania interfejsami API w obrębie usługi w chmurze. Zwraca to również serwery DNS jako widoczne dla usługi CloudService.
...
Pobiera listę lub określony produkt.

### [Get-AzApiManagementSsoToken](Get-AzApiManagementSsoToken.md)
Pobiera link z tokenem logowania jednokrotnego do wdrożonego portalu zarządzania usługą zarządzania interfejsami API.
...
Pobiera klucze konfiguracji dostępu dla dzierżawy.
...
Pobiera klucze konfiguracji git dostępu dla dzierżawy.

### [Get-AzApiManagementTenantSyncState](Get-AzApiManagementTenantSyncState.md)
Pobiera stan ostatniej synchronizacji między bazą danych konfiguracji a repozytorium Git.
...
Tworzy nową wersję istniejącego interfejsu API.
...
Tworzy certyfikat zarządzania interfejsem API, który ma być używany podczas uwierzytelniania za pomocą zaplecza.

### [New-AzApiManagementContext](New-AzApiManagementContext.md)
Tworzy wystąpienie obiektu PsAzureApiManagementContext.
...
Tworzy nazwę hosta konfiguratin dla istniejącej bramy.
...
Tworzy wystąpienie narzędzia **PsApiManagementHttpMessageDiagnostic,** które jest ustawieniem diagnostycznym Http Message narzędzia Diagnostic
...
Tworzy dostawcę usługi OpenID Connect.
...
Tworzy wystąpienie regionu PsApiManagementRegion.

### [New-AzApiManagementResourceLocationObject](New-AzApiManagementResourceLocationObject.md)
Tworzenie nowej umowy o lokalizację zasobu (używanej w bramach).
...
Publikuje zmiany z gałęzi Git do bazy danych konfiguracji.
...
Usuwa schemat interfejsu API z interfejsu API.
...
Usuń jednostkę diagnostyczną z zakresu globalnego lub na poziomie interfejsu API.

### [Remove-AzApiManagementGateway](Remove-AzApiManagementGateway.md)
Odłącza interfejs API od bramy.
...
Usuwa istniejącą grupę zarządzania interfejsem API.
...
Usuwa istniejący produkt zarządzania interfejsami API.
...
Zapisuje zmiany przez utworzenie zatwierdzenia dla bieżącej konfiguracji.
...
Ustawia szczegóły produktu zarządzania interfejsem API.
...
Włączenie lub wyłączenie dostępu do dzierżawy.
...
Konfiguruje bramę zarządzania interfejsem API.
