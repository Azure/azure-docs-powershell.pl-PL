...
### ByResourceIdParameterSet (domyślne)
```
...
## OPIS
Polecenie cmdlet **Remove-AzApiManagementDiagnostic** usuwa jednostkę diagnostyczną określoną przez zakres `DiagnosticId` globalny lub `ApiId` zakres

## PRZYKŁADY

### Przykład 1. Usuwanie jednostki diagnostycznej
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementDiagnostic -Context $apimContext -DiagnosticId "applicationinsights"
```

W tym przykładzie usuń narzędzie `applicationinsights` diagnostyczne z usługi zarządzania interfejsami API.
...
### -InputObject
Wystąpienie programu PsApiManagementDiagnostic. Ten parametr jest wymagany.
...
### -ResourceId
Arm ResourceId of Diagnostic. Ten parametr jest wymagany.
