...
Pierwsze polecenie przypisuje dwie wartości do zmiennej $Tags zmienną.
Drugie polecenie modyfikuje nazwaną wartość o właściwości ID11.
To polecenie przypisuje ciągi w $Tags jako tagi nazwanej wartości.

### Przykład 2. Modyfikowanie nazwanej wartości w celu ustawienia wartości tajnej
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Set-AzApiManagementNamedValue -Context $apimContext -NamedValueId "Property12" -Secret $True -PassThru
```

To polecenie zmienia nazwaną wartość na zaszyfrowaną.

### Przykład 3

Modyfikuje wartość nazwaną zarządzania interfejsem API. (wygenerowane automatycznie)
...
### — Nazwa
Nazwa nazwanej wartości.
Maksymalna długość to 100 znaków.
Może zawierać tylko litery, cyfry, kropki, kreski i znaki podkreślenia.
...
### -PassThru
Jeśli zostanie określone, wówczas wystąpienie właściwości Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementProperty reprezentującej zmodyfikowaną właściwość zostanie zapisane w wyniku.
...
### - Tajna
Czy nazwana wartość jest kluczem tajnym, a jej wartość powinna zostać zaszyfrowana.
Ten parametr jest opcjonalny.
...
Nie może on być pusty ani składać się tylko z białych znaków.
Ten parametr jest opcjonalny.
