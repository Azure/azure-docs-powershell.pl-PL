...
## OPIS
Polecenie **cmdlet Set-AzApiManagementProduct** ustawia szczegóły produktu zarządzania interfejsem API.
...
To polecenie aktualizuje szczegóły produktu zarządzania interfejsem API, wymaga subskrypcji, a następnie cofanie publikacji.
...
Wartość domyślna dla tego parametru to **$True.**
...
Wartość domyślna dla tego parametru to Brak.
...
### — Tytuł
Określa tytuł produktu zestawy tego polecenia cmdlet.
