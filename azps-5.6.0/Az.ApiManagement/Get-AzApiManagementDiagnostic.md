...
### Przykład 1. Uzyskaj wszystkie diagnostyczne skonfigurowane w zakresie dzierżawy.
```powershell
...
### -ResourceId
Identyfikator zasobu arm w diagnostyce diagnostycznej lub diagnostyce interfejsu api. Jeśli zostanie określona, spróbuje znaleźć diagnostykę za pomocą identyfikatora. Ten parametr jest wymagany.
