...
## OPIS
Polecenie **cmdlet Update-AzApiManagementGateway** konfiguruje bramę zarządzania interfejsem API.
...
To polecenie konfiguruje bramę.
...
### -InputObject
Wystąpienie aplikacji PsApiManagementGateway. Ten parametr jest wymagany.
...
### -PassThru
Jeśli określono, wówczas wystąpienie właściwości Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementGateway typ reprezentujący zmodyfikowaną bramę.
...
### -ResourceId
Arm ResourceId bramy. Ten parametr jest wymagany.
