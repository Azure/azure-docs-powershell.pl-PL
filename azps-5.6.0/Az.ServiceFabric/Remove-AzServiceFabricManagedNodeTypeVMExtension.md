...
## OPIS
Usuń rozszerzenie maszyny wirtualnej z typu węzła według nazwy. Użyj [właściwości Get-AzServiceFabricManagedNodeType](./Get-AzServiceFabricManagedNodeType.md) i sprawdź właściwość VmExtensions, aby zobaczyć bieżące rozszerzenie typu węzła.
...
Usuń rozszerzenie z typu węzła według nazwy.
...
Usuń rozszerzenie z typu węzła według nazwy za pomocą połączeń rurowych.
