...
## OPIS
To polecenie cmdlet tworzy nową wersję typu aplikacji przy użyciu pakietu określonego w pliku -PackageUrl. To powinno być dostępne za pośrednictwem punktu końcowego REST dla usługi Azure Resource Manager do użycia podczas wdrażania i zawierało aplikację spakowana i spakowana wraz z rozszerzeniem sfpkg. To polecenie spowoduje utworzenie typu aplikacji, jeśli jeszcze nie istnieje.
