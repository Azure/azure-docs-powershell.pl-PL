...
## OPIS
Użyj **metody Remove-AzServiceFabricClientCertificate,** aby usunąć certyfikaty klientów lub podmioty certyfikatów z użycia w celu uwierzytelniania klienta w klastrze.
...
To polecenie spowoduje usunięcie certyfikatu klienta ze znakiem usbprint "5F3660C715EBBDA31DB1FFDCF508302348DE8E7A" z klastra.

## PARAMETERS

### -AdminClientThumbprint
Określanie etykiety usbprint certyfikatu klienta, która ma tylko uprawnienia administratora
