...
## OPIS
Użyj właściwości **Remove-AzServiceFabricNodeType,** aby usunąć wszystkie węzły z określonego typu węzła i typu węzła z klastry. Tego polecenia nie można użyć do usunięcia typu węzła podstawowego.
...
To polecenie spowoduje usunięcie typu NodeType 'nt1' z klastrowania.
