...
To polecenie spowoduje dodanie nowego typu NodeType 'n2' o pojemności 5, a nazwa administratora maszyny wirtualnej to "nazwa_administratora".
...
### -DurabilityLevel
Określenie poziomu niezawodności typu NodeType.
