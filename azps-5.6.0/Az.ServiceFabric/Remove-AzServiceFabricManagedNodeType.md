...
## OPIS
Usuń typ węzła lub określone węzły w obrębie typu węzła. Jeśli paremter -NodeName jest używany, zostaną usunięte tylko określone węzły.
...
Usuwanie typu węzła za pomocą rur.
...
Usuń 2 węzły z typu węzła za pomocą rur.
...
Należy zachować ostrożność, ponieważ może to spowodować utratę danych, jeśli w węzłach są uruchomione obciążenia pracą o stanie lub jeśli po zakończeniu procesu grupowania nie ma wystarczającej ilości węzłów inicjalacji.
