...
Naprawianie węzła jednostki skali.
...
### -BareMetalNode
Opis węzła systemu operacyjnego, który jest wykorzystywany do działania ScaleOut w klastrze.
Aby skonstruować, zobacz sekcję notatki dla właściwości BAREMETALNODE i Utwórz tablicę skrótów.
...
### -BiosVersion
Wersja systemu BIOS komputera fizycznego.
...
### -MacAddress
Nazwa adresu MAC węzła bez metalu.
...
### -Numer seryjny
Numer seryjny maszyny fizycznej.
...
### Microsoft. Azure. PowerShell. polecenia. FabricAdmin. models. Api20160501. IBareMetalNodeDescription
...
BAREMETALNODE <IBareMetalNodeDescription> : parametr tożsamości
  - `[BiosVersion <String>]`: Wersja systemu BIOS komputera fizycznego.
  - `[BmciPv4Address <String>]`: Adres BMC komputera fizycznego.
  - `[ClusterName <String>]`: Nazwa klastra.
  - `[ComputerName <String>]`: Nazwa komputera.
  - `[MacAddress <String>]`: Nazwa adresu MAC węzła systemu operacyjnego z niemetalową wersją.
  - `[Model <String>]`: Model maszyny fizycznej.
  - `[SerialNumber <String>]`: Numer seryjny maszyny fizycznej.
  - `[Vendor <String>]`: Dostawca komputera fizycznego.
