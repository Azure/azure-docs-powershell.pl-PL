...
## STRESZCZENIe
Uzyskaj lokalizację aktualizacji na podstawie nazwy.
...
### Przykład 1: pobieranie wszystkich lokalizacji aktualizacji
```powershell
...
Bez żadnych parametrów ta unifiedgroup będzie pobierać wszystkie lokalizacje aktualizacji

### Przykład 2: pobieranie wszystkich lokalizacji aktualizacji według nazwy
```powershell
...
Spowoduje pobranie wszystkich lokalizacji aktualizacji zgodnych z określonym parametrem nazwy
...
### Microsoft. Azure. PowerShell. polecenia. UpdateAdmin. models. Api20160501. IUpdateLocation
