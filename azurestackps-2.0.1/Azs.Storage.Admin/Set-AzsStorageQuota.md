...
Zaktualizuj istniejący przydział magazynowania według nazwy.
...
Zaktualizuj istniejący przydział magazynowania według połączeń rurowych.
...
### -Przydziałobject
Aby skonstruować, zobacz sekcję notatki dla właściwości przydziałów i Utwórz tablicę skrótów.
...
Przydziały <IStorageQuota> : 
  - `[CapacityInGb <Int32?>]`: Maksymalna pojemność (GB).
  - `[NumberOfStorageAccounts <Int32?>]`: Łączna liczba kont magazynu.
