...
Przekazanie TestUbuntu. test. 1.0.0 do galerii.
...
### -GalleryItemUri
Identyfikator URI dla pakietu galerii, który został już przekazany w trybie online.
...
Lokalizacja ładunku elementu galerii.
Aby skonstruować, zobacz sekcję notatki dla właściwości GALLERYITEMURIPAYLOAD i Utwórz tablicę skrótów.
...
### Microsoft. Azure. PowerShell. polecenia cmdlet. Gallery. models. Api20150401. IGalleryItemUriPayload
...
GALLERYITEMURIPAYLOAD <IGalleryItemUriPayload> : Lokalizacja ładunku elementu galerii.
  - `[GalleryItemUri <String>]`: Identyfikator URI pakietu galerii, który został już przekazany w trybie online.
