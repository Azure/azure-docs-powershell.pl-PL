...
Przetestuj, czy subskrypcje użytkowników mogą być przenoszone do oferty delegowanego dostawcy.
...
Przetestuj, czy subskrypcje użytkowników mogą być przenoszone przez dostawcę delegowanego na domyślnego dostawcę.
...
Identyfikator oferty delegowanego dostawcy (z kontekstu administratora), do którego mają być przenoszone subskrypcje.
...
Definicja akcji Przenieś subskrypcje w celu skonstruowania, zobacz sekcję notatki dla właściwości MOVESUBSCRIPTIONSDEFINITION i Utwórz tablicę skrótów.
...
### -ResourceId
Kolekcja subskrypcji przenoszonych do docelowej oferty delegowanego dostawcy.
...
### Microsoft. Azure. PowerShell. polecenia. SubscriptionsAdmin. models. Api20151101. IMoveSubscriptionsDefinition
...
MOVESUBSCRIPTIONSDEFINITION <IMoveSubscriptionsDefinition> : definicja akcji Przenieś subskrypcje
  - `Resources <String[]>`: Kolekcja subskrypcji, które mają zostać przeniesione do docelowej oferty delegowanego dostawcy.
  - `[TargetDelegatedProviderOffer <String>]`: Identyfikator oferty delegowanego dostawcy (z kontekstu administratora), do którego mają być przenoszone subskrypcje.
