...
## Opis
New-AzureHDInsightCluster tworzy klaster usługi Azure HDInsight przy użyciu określonych parametrów lub obiektu konfiguracji utworzonego za pomocą polecenia cmdlet New-AzureRmHDInsightClusterConfig.
...
Możesz również użyć polecenia cmdlet Add-AzureRmHDInsightStorage.
...
Dostępne opcje: Hadoop, HBase, burza, Spark
...
Ten obiekt można utworzyć przy użyciu polecenia cmdlet New-AzureRmHDInsightClusterConfig.
...
Możesz również użyć polecenia cmdlet Add-AzureRmHDInsightConfigValues.
...
Możesz również użyć polecenia cmdlet Set-AzureRmHDInsightDefaultStorage.
...
Możesz również użyć dodatku Add-AzureRmHDInsightScriptAction.
...
Możesz również użyć polecenia cmdlet Add-AzureRmHDInsightSecurityProfile.
