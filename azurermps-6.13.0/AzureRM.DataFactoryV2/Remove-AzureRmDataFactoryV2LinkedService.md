...
## Opis
Polecenie cmdlet Remove-AzureRmDataFactoryV2LinkedService powoduje usunięcie połączonej usługi z usługi Azure Data Factory.

## Przykłady

### Przykład 1: usuwanie połączonej usługi
```
...
To polecenie powoduje usunięcie połączonej usługi o nazwie LinkedServiceTest z fabryki danych o nazwie WikiADF.
...
To polecenie cmdlet umożliwia usunięcie połączonej usługi z fabryki danych, którą ten parametr określa.
...
### -Inputobject
Określa obiekt LinkedService, który ma zostać usunięty.
...
### -Name (nazwa)
Określa nazwę połączonej usługi, którą należy usunąć.
...
To polecenie cmdlet powoduje usunięcie połączonej usługi z grupy, którą ten parametr określa.
...
### -ResourceId
Identyfikator zasobu platformy Azure połączonej usługi do usunięcia.
