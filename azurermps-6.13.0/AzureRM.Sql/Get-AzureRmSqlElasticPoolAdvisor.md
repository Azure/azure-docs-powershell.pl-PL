...
## Opis
Polecenie cmdlet **Get-AzureRmSqlElasticPoolAdvisor** pobiera co najmniej jeden Doradca puli elastycznej SQL platformy Azure dla puli elastycznej SQL Azure.
