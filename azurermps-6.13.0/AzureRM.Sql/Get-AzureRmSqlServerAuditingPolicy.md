...
## Opis
Polecenie cmdlet **Get-AzureRmSqlServerAuditingPolicy** pobiera zasady inspekcji programu Azure SQL Server.
Określ parametry *ResourceGroupName* , *nazwa_serwera* i *DatabaseName* , które identyfikują bazę danych.
To polecenie cmdlet zwraca zasadę używaną przez bazy danych SQL Azure, które są zdefiniowane w określonym programie Azure SQL Server i używają jej zasad inspekcji.

## Przykłady

### Przykład 1: uzyskiwanie zasad inspekcji programu Azure SQL Server z zdefiniowaną funkcją inspekcji tabeli
```
...
### Przykład 2: uzyskiwanie zasad inspekcji programu Azure SQL Server z zdefiniowaną funkcją inspekcji obiektu BLOB
```
PS C:\>Get-AzureRmSqlServerAuditingPolicy -ResourceGroupName "resourcegroup01" -ServerName "server01"
...
### -Nazwa_serwera
Określa nazwę programu Azure SQL Server, dla którego to polecenie cmdlet pobiera zasady inspekcji.
