...
## Opis
Polecenie cmdlet **Get-AzureRmSqlDatabaseLongTermRetentionBackup** pobiera wszystkie długotrwałe kopie zapasowe przechowywania dla lokalizacji, serwera lub bazy danych albo pobiera określoną długotrwałą kopię zapasową przechowywania.
...
To polecenie pobiera wszystkie długie kopie zapasowe przechowywania dla wszystkich baz danych (które mogą być aktywne lub usunięte) w northeurope.

### Przykład 2: pobieranie konkretnej kopii zapasowej przechowywania w długim okresie
```powershell
...
### Przykład 3: pobieranie wszystkich długoterminowych kopii zapasowych przechowywania dla bazy danych
```powershell
