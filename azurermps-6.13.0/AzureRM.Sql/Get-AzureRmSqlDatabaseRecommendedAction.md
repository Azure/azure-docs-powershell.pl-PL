...
## Opis
Polecenie cmdlet **Get-AzureRmSqlDatabaseRecommendedAction** umożliwia wykonanie jednej lub większej liczby zalecanych akcji dla klasyfikatora bazy danych Azure SQL Database.
