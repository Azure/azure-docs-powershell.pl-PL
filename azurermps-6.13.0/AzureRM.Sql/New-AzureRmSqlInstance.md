...
## Opis
Polecenie cmdlet **New-AzureRmSqlInstance** tworzy wystąpienie zarządzane bazy danych Azure SQL Database.
...
To polecenie tworzy nowe wystąpienie przy użyciu parametrów wersja i ComputeGeneration.
