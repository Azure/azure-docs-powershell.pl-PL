...
## Opis
Polecenie cmdlet **Set-AzureRmApplicationGatewaySslCertificate** ustawia stan celu certyfikatu SSL.

## Przykłady

### Przykład 1: Ustawianie stanu celu certyfikatu SSL
```
...
To polecenie ustawia stan celu dla certyfikatu SSL z bramy Application Gateway o nazwie ApplicationGateway01.
