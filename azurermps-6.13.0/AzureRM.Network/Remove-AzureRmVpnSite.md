...
Po utworzeniu witryny jest ona natychmiast usuwana przy użyciu polecenia Remove-AzureRmVpnSite.
...
Taki sam jak w przykładzie 1, ale usunięcie jest wykonywane przy użyciu danych wyjściowych potoku z poziomu polecenia Get-AzureRmVpnSite.
