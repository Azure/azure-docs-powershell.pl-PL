...
## Opis
Polecenie cmdlet Get-AzureRmNetworkWatcherConnectionMonitorReport zwraca raport na temat najnowszych Stanów połączeń.

## Przykłady

### Przykład 1: Uzyskiwanie najnowszej migawki połączenia monitora połączeń według nazwy w określonej lokalizacji
```
...
W tym przykładzie zbadano ostatnie Stany połączeń określonego monitora połączeń.
