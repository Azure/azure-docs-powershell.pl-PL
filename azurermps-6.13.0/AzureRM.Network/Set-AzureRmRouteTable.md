...
## Opis
Polecenie cmdlet **Set-AzureRmRouteTable** ustawia stan celu dla tabeli routingu platformy Azure.

## Przykłady

### Przykład 1. Dodaj trasę, a następnie ustaw stan celu w tabeli tras
```
...
Polecenie przekazuje tę tabelę do polecenia cmdlet Add-AzureRmRouteConfig przy użyciu operatora potoku.
Polecenie **Add-AzureRmRouteConfig** dodaje trasę o nazwie Route07, a następnie przekazuje wynik do bieżącego polecenia cmdlet, co powoduje zaktualizowanie tabeli w celu odzwierciedlenia zmian.
...
### -Routeing
Określa obiekt tabeli tras reprezentujący stan celu, do którego to polecenie cmdlet ustawia tabelę tras.
