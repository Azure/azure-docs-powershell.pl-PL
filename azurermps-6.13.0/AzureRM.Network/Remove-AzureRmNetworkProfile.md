...
## Opis
Polecenie cmdlet **Remove-AzureRmNetworkProfile** usuwa profil sieciowy, jeśli nie utworzono interfejsów sieciowych kontenera (w przeciwieństwie do **konfiguracji** interfejsu sieciowego kontenera).
