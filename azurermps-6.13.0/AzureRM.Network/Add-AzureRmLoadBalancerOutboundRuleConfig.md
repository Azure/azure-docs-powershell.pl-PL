...
## Opis
Polecenie cmdlet **Add-AzureRmLoadBalancerOutboundRuleConfig** umożliwia dodanie konfiguracji reguły wychodzącej do modułu równoważenia obciążenia platformy Azure.
...
Drugie polecenie używa operatora potoku w celu przekazania modułu równoważenia obciążenia w $slb do polecenia **Add-AzureRmLoadBalancerOutboundRuleConfig** , które powoduje dodanie konfiguracji reguły ruchu wychodzącego do modułu równoważenia obciążenia.
...
System. Int32 system. String. String system. Collections. Generic. list \` 1 [[Microsoft. Azure. Commands. models. PSResourceId; Microsoft. Azure. Commands......
