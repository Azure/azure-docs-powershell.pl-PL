...
## STRESZCZENIe
Update-AzureRmVpnGateway aktualizuje skalowalną bramę VPN do odpowiedniego stanu celu.
...
## Opis
Update-AzureRmVpnGateway aktualizuje skalowalną bramę VPN do odpowiedniego stanu celu. AzureRmVpnGateway to programowana łączność między witrynami w ramach VirtualHub. Ta brama zmienia rozmiar i skaluje się na podstawie jednostki skali określonej przez użytkownika. Połączenie można skonfigurować z poziomu filii/witryny nazywanej VPNSite do bramy skalowalnej. Każde połączenie składa się z 2 Active-Active tuneli
...
Po utworzeniu bramy używa Set-AzureRmVpnGateway, aby uaktualnić bramę do 3 jednostek skali.
