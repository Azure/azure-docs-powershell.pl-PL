...
## Opis
Polecenie cmdlet Get-AzureRmNetworkUsage pobiera limity i bieżące użycie zasobów sieciowych.
...
### — Lokalizacja
Lokalizacja, w której jest wykonywane zapytanie dotyczące użycia zasobów.
