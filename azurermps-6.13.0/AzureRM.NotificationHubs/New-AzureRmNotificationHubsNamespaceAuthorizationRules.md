...
Plik JSON jest plikiem tekstowym używającym składni podobnej do następującej: {  
    ...
    "Prawa": \[  
        ...
        Przysła  
    \]  
} Gdy jest używana w połączeniu z poleceniem cmdlet **New-AzureRmNotificationHubsNamespaceAuthorizationRules** , powyższy przykład JSON powoduje utworzenie reguły autoryzacji o nazwie ContosoAuthorizationRule, która umożliwia użytkownikom odsłuchiwanie i wysyłanie praw do obszaru nazw.
