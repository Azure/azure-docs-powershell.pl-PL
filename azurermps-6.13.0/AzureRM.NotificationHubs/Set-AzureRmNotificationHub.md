...
} Gdy jest używana w połączeniu z poleceniem cmdlet **Set-AzureRmNotificationHub** , poprzednia przykład JSON ustawia wartość lokalizacji centrum powiadomień o nazwie ContosoNotificationHub na zachodni stan USA.
