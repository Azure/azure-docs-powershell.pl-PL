...
Plik JSON jest plikiem tekstowym używającym składni podobnej do następującej: {  
    ...
    "Prawa": \[  
        ...
        Przysła  
    \]  
} Gdy jest używana w połączeniu z poleceniem cmdlet **Set-AzureRmNotificationHubsNamespaceAuthorizationRules** , poprzednia próbka JSON modyfikuje regułę autoryzacji o nazwie ContosoAuthorizationRule, aby dać użytkownikom możliwość odsłuchiwania i wysyłania praw do obszaru nazw.
