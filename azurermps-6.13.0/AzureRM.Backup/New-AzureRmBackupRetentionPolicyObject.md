...
- Weekly 
- Podstaw 
- Rocznie Utwórz jednej zasady przechowywania dla każdego typu retencji, który ma zostać użyty.
...
- Poniedziałek 
- Sobota 
- Niedziela Określ ten parametr, jeśli określisz parametry *WeeklyRetention* , *MonthlyRetentionInWeeklyFormat* i *YearlyRetentionInWeeklyFormat* .
