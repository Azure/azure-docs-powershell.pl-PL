...
## Opis
Polecenie cmdlet **Get-AzureRmApiManagementApiRelease umożliwia pobranie** co najmniej jednego wydania interfejsu API zarządzania interfejsem Azure API.
...
[Nowe — AzureRmApiManagementApiRelease](./Get-AzureRmApiManagementApiRelease.md)
