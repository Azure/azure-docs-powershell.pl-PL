...
## Opis
Polecenie cmdlet **New-AzureRmServiceBusQueue** tworzy kolejkę usługi Service Bus w określonym obszarze nazw usługi Service Bus.
...
Określa okno czasu historii wykrywania duplikatów, valuethat [TimeSpan](https://msdn.microsoft.com/library/system.timespan.aspx) określa czas trwania historii wykrywania duplikatów. Wartość domyślna to 10 minut.
