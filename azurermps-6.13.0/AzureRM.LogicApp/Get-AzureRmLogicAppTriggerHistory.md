...
## Opis
Polecenie cmdlet **Get-AzureRmLogicAppTriggerHistory** pobiera historię wyzwalaczy w aplikacji logicznej w funkcji aplikacje logiczne.
To polecenie cmdlet zwraca obiekt **WorkflowTriggerHistory** .
Określ aplikację logiczną, grupę zasobów i wyzwalacz.
...
### Przykład 1: uzyskiwanie historii wyzwalacza aplikacji logicznej
```
...
To polecenie pobiera określoną historię wyzwalacza aplikacji logiki dla wyzwalacza w aplikacji logicznej o nazwie LogicApp03.

### Przykład 2: uzyskiwanie historii wyzwalaczy aplikacji logicznej
```
...
To polecenie pobiera historie wyzwalacza przepływu pracy dla wyzwalacza w aplikacji logicznej o nazwie LogicApp07.
...
### -Historyname
Określa nazwę historii, jaką uzyskuje to polecenie cmdlet.
...
### -Name (nazwa)
Określa nazwę aplikacji logicznej, dla której to polecenie cmdlet pobiera historię wyzwalacza.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, w której ten aplet polecenia pobiera historię.
...
### -Triggername
Określa nazwę wyzwalacza, dla którego jest pobierana historia tego polecenia cmdlet.
...
### Microsoft. Azure. Management. Logic. MODELES. WorkflowTriggerHistory
