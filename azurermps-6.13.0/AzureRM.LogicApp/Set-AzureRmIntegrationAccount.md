...
## Opis
Polecenie cmdlet **Set-AzureRmIntegrationAccount** modyfikuje konto integracji.
To polecenie cmdlet zwraca obiekt reprezentujący konto integracji.
...
### Przykład 1: modyfikowanie konta integracji
```
...
To polecenie modyfikuje konto integracyjne o nazwie IntegrationAccount31 w określonej grupie zasobów.
