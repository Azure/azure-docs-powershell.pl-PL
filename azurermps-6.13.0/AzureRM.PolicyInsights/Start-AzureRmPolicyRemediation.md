...
## Opis
Polecenie cmdlet **Start-AzureRmPolicyRemediation** tworzy korygowanie zasad dla określonego przydziału zasad. Wszystkie niezgodne zasoby na poziomie lub poniżej zakresu korygowania zostaną skorygowane. Korygowanie jest obsługiwane tylko w przypadku zasad z efektem "deployIfNotExists".
