...
ms.locfileid: "93541443"
---
# <span data-ttu-id="fcf5b-101">Get-AzureRmSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="fcf5b-101">Get-AzureRmSecurityAlert</span></span>

## <span data-ttu-id="fcf5b-102">STRESZCZENIe</span><span class="sxs-lookup"><span data-stu-id="fcf5b-102">SYNOPSIS</span></span>
<span data-ttu-id="fcf5b-103">Pobiera alerty zabezpieczeń wykryte przez usługę Azure Security Center</span><span class="sxs-lookup"><span data-stu-id="fcf5b-103">Gets security alerts that were detected by Azure Security Center</span></span>

[!INCLUDE [migrate-to-az-banner](../../includes/migrate-to-az-banner.md)]

## <span data-ttu-id="fcf5b-104">POLECENIA</span><span class="sxs-lookup"><span data-stu-id="fcf5b-104">SYNTAX</span></span>

### <span data-ttu-id="fcf5b-105">SubscriptionScope (domyślny)</span><span class="sxs-lookup"><span data-stu-id="fcf5b-105">SubscriptionScope (Default)</span></span>
```
Get-AzureRmSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="fcf5b-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="fcf5b-106">ResourceGroupScope</span></span>
```
Get-AzureRmSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="fcf5b-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="fcf5b-107">ResourceGroupLevelResource</span></span>
```
Get-AzureRmSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="fcf5b-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="fcf5b-108">SubscriptionLevelResource</span></span>
```
Get-AzureRmSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="fcf5b-109">Zasobów</span><span class="sxs-lookup"><span data-stu-id="fcf5b-109">ResourceId</span></span>
```
Get-AzureRmSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="fcf5b-110">Opis</span><span class="sxs-lookup"><span data-stu-id="fcf5b-110">DESCRIPTION</span></span>
<span data-ttu-id="fcf5b-111">Pobiera alerty zabezpieczeń wykryte przez usługę Azure Security Center</span><span class="sxs-lookup"><span data-stu-id="fcf5b-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="fcf5b-112">Przykłady</span><span class="sxs-lookup"><span data-stu-id="fcf5b-112">EXAMPLES</span></span>

### <span data-ttu-id="fcf5b-113">Przykład 1</span><span class="sxs-lookup"><span data-stu-id="fcf5b-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="fcf5b-114">Pobiera wszystkie alerty zabezpieczeń wykryte w ramach resoruces w ramach abonamentu.</span><span class="sxs-lookup"><span data-stu-id="fcf5b-114">Gets all the security alerts that were detected on resoruces inside a subscription</span></span>

### <span data-ttu-id="fcf5b-115">Przykład 2</span><span class="sxs-lookup"><span data-stu-id="fcf5b-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="fcf5b-116">Pobiera wszystkie alerty zabezpieczeń wykryte w resoruces w grupie zasobów "myService1".</span><span class="sxs-lookup"><span data-stu-id="fcf5b-116">Gets all the security alerts that were detected on resoruces inside the "myService1" resource group</span></span>

### <span data-ttu-id="fcf5b-117">Przykład 3</span><span class="sxs-lookup"><span data-stu-id="fcf5b-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="fcf5b-118">Pobiera określony alert zabezpieczeń wykryty w resoruces w grupie zasobów "myService1".</span><span class="sxs-lookup"><span data-stu-id="fcf5b-118">Gets a specific security alert that were detected on resoruces inside the "myService1" resource group</span></span>

## <span data-ttu-id="fcf5b-119">PARAMETRÓW</span><span class="sxs-lookup"><span data-stu-id="fcf5b-119">PARAMETERS</span></span>

### <span data-ttu-id="fcf5b-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="fcf5b-120">-DefaultProfile</span></span>
<span data-ttu-id="fcf5b-121">Poświadczenia, konto, dzierżawa i subskrypcja używane do komunikacji z usługą Azure.</span><span class="sxs-lookup"><span data-stu-id="fcf5b-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="fcf5b-122">— Lokalizacja</span><span class="sxs-lookup"><span data-stu-id="fcf5b-122">-Location</span></span>
<span data-ttu-id="fcf5b-123">Pozycję.</span><span class="sxs-lookup"><span data-stu-id="fcf5b-123">Location.</span></span>
...
### <span data-ttu-id="fcf5b-124">-Name (nazwa)</span><span class="sxs-lookup"><span data-stu-id="fcf5b-124">-Name</span></span>
<span data-ttu-id="fcf5b-125">Nazwa zasobu.</span><span class="sxs-lookup"><span data-stu-id="fcf5b-125">Resource name.</span></span>
...
### <span data-ttu-id="fcf5b-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="fcf5b-126">-ResourceGroupName</span></span>
<span data-ttu-id="fcf5b-127">Nazwa grupy zasobów.</span><span class="sxs-lookup"><span data-stu-id="fcf5b-127">Resource group name.</span></span>
...
### <span data-ttu-id="fcf5b-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="fcf5b-128">-ResourceId</span></span>
<span data-ttu-id="fcf5b-129">Identyfikator zasobu.</span><span class="sxs-lookup"><span data-stu-id="fcf5b-129">Resource ID.</span></span>
...
### <span data-ttu-id="fcf5b-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="fcf5b-130">CommonParameters</span></span>
<span data-ttu-id="fcf5b-131">To polecenie cmdlet obsługuje typowe parametry:-Debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-unvariable,-subbuffer,-PipelineVariable,-verbose,-WarningAction i-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="fcf5b-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="fcf5b-132">Aby uzyskać więcej informacji, zobacz about_CommonParameters ( https://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="fcf5b-132">For more information, see about_CommonParameters (https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="fcf5b-133">WEJŚCIOWE</span><span class="sxs-lookup"><span data-stu-id="fcf5b-133">INPUTS</span></span>

### <span data-ttu-id="fcf5b-134">System. String</span><span class="sxs-lookup"><span data-stu-id="fcf5b-134">System.String</span></span>

## <span data-ttu-id="fcf5b-135">WYSYŁA</span><span class="sxs-lookup"><span data-stu-id="fcf5b-135">OUTPUTS</span></span>

### <span data-ttu-id="fcf5b-136">Microsoft. Azure. Commands. Security. models. Alerts. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="fcf5b-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="fcf5b-137">INFORMACYJN</span><span class="sxs-lookup"><span data-stu-id="fcf5b-137">NOTES</span></span>

## <span data-ttu-id="fcf5b-138">LINKI POKREWNE</span><span class="sxs-lookup"><span data-stu-id="fcf5b-138">RELATED LINKS</span></span>
