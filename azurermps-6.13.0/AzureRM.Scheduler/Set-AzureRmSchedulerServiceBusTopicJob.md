...
## Opis
Polecenie cmdlet **Set-AzureRmSchedulerServiceBusTopicJob** modyfikuje zadanie tematu magistrali usług w usłudze Azure Scheduler.
...
### -ServiceBusMessage
Określa komunikat tematu usługi Service Bus.
...
### -ServiceBusTopicPath
Określa ścieżkę tematu usługi Service Bus.
