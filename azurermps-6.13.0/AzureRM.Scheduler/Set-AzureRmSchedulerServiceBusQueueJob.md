...
## Opis
Polecenie cmdlet **Set-AzureRmSchedulerServiceBusQueueJob** modyfikuje zadanie kolejki usługi Service Bus w usłudze Azure Scheduler.
...
### -ServiceBusMessage
Określa wiadomość kolejki usługi Service Bus.
...
### -ServiceBusNamespace
Określa obszar nazw usługi Service Bus.
...
### -ServiceBusQueueName
Określa nazwę kolejki usługi Service Bus.
...
Określa nazwę klucza podpisu z dostępem udostępnionym.
...
Określa wartość klucza podpisu z dostępem udostępnionym.
...
Określa typ transportu usługi Service Bus.
Dopuszczalne wartości tego parametru to:
- Wiadomości SMS 
- AMQP
