...
---
# Moduł AzureRM. resources
## Opis
W tym temacie są wyświetlane tematy pomocy dotyczące poleceń cmdlet Menedżera zasobów platformy Azure.

## Polecenia cmdlet AzureRM. zasoby
### [Dodaj-AzureRmADGroupMember](Add-AzureRmADGroupMember.md)
Dodaje użytkownika do istniejącej grupy usługi AD.

### [Eksportowanie — AzureRmResourceGroup](Export-AzureRmResourceGroup.md)
...
Pobiera wdrożenie w zakresie abonamentu.

### [Get-AzureRmDeploymentOperation](Get-AzureRmDeploymentOperation.md)
Pobiera operacje wdrażania wdrożenia w zakresie subskrypcji.
...
### [Nowe — AzureRmADGroup](New-AzureRmADGroup.md)
...
### [Nowe — AzureRmDeployment](New-AzureRmDeployment.md)
Tworzy nowe wdrożenie w zakresie abonamentu.

### [Nowe — AzureRmManagedApplication](New-AzureRmManagedApplication.md)
Tworzy aplikację zarządzaną na platformie Azure.

### [Nowe — AzureRmManagedApplicationDefinition](New-AzureRmManagedApplicationDefinition.md)
Tworzy definicję aplikacji zarządzanej.

### [Nowe — AzureRmManagementGroup](New-AzureRmManagementGroup.md)
Tworzy grupę zarządzania

### [Nowe — AzureRmManagementGroupSubscription](New-AzureRmManagementGroupSubscription.md)
...
### [Nowe — AzureRmPolicySetDefinition](New-AzureRmPolicySetDefinition.md)
...
### [Nowe — AzureRmResourceLock](New-AzureRmResourceLock.md)
...
### [Rejestr — AzureRmResourceProvider](Register-AzureRmResourceProvider.md)
...
Usuwa wdrożenie w zakresie subskrypcji.
...
### [Zapisz — AzureRmDeploymentTemplate](Save-AzureRmDeploymentTemplate.md)
Pobiera szablon wdrożenia w zakresie abonamentu.

### [Zapisz — AzureRmResourceGroupDeploymentTemplate](Save-AzureRmResourceGroupDeploymentTemplate.md)
...
### [Zatrzymaj — AzureRmDeployment](Stop-AzureRmDeployment.md)
Anuluje wdrożenie uruchomione w zakresie subskrypcji.
...
Sprawdza poprawność szablonu i parametrów wdrażania w zakresie subskrypcji.
