...
## Opis
Polecenie cmdlet **Get-AzureRmAutomationSourceControlSyncJobOutput** pobiera dane wyjściowe zadania synchronizacji kontroli źródła usługi Azure Automation.

## Przykłady

### Przykład 1
To polecenie pobiera dane wyjściowe zadania synchronizacji kontroli źródła z identyfikatorem 08d6d266-27b6-463c-Beea-bc48a67ace15 dla VSTSNative kontroli źródła. 
