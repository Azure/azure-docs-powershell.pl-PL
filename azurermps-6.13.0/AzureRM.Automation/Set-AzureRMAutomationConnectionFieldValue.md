...
## Opis
Polecenie cmdlet **Set-AzureRmAutomationConnectionFieldValue** modyfikuje wartość pola w połączeniu w usłudze Azure Automation.
...
To polecenie zmienia Identyfikator subskrypcji dla połączenia platformy Azure o nazwie ContosoConnection na koncie usługi Automation o nazwie AutomationAccount01.
...
### -ConnectionFieldName
Określa nazwę pola, które zostanie zmodyfikowane przez to polecenie cmdlet.
...
### -Value
Określa wartość do zmodyfikowania w polu połączenie.
