...
## STRESZCZENIe
Pobiera węzły obliczeniowe partii z puli.
...
## Opis
Polecenie cmdlet **Get-AzureBatchComputeNode** pobiera węzły obliczeniowe usługi Azure Batch z puli.
Określ parametr *PoolID* lub *Pool (Pula* ).
Określ parametr *ID* , aby uzyskać jeden węzeł obliczeniowy.
Określ parametr *Filter* , aby uzyskać węzły obliczeniowe, które pasują do filtru protokołu OData (Open Data Protocol).

## Przykłady

### Przykład 1: uzyskiwanie węzła obliczeniowego według identyfikatora
```
...
To polecenie uzyskuje węzeł obliczeniowy mający identyfikator TVM-2316545714_1-20150725t213220z z puli zawierającej identyfikator Pool06.
Użyj polecenia cmdlet Get-AzureRmBatchAccountKeys, aby przypisać kontekst do zmiennej $Context.

### Przykład 2: uzyskiwanie wszystkich węzłów obliczeń bezczynnych z puli
```
...
To polecenie pobiera wszystkie węzły obliczeniowe, które są zawarte w puli o IDENTYFIKATORze Pool06.
To polecenie określa stan bezczynności za pomocą parametru *Filter* .

### Przykład 3: uzyskiwanie wszystkich węzłów obliczeniowych w określonej puli
```
...
To polecenie pobiera pulę o IDENTYFIKATORze Pool07 przy użyciu polecenia cmdlet Get-AzureBatchPool.
Polecenie przekazuje tę pulę do bieżącego polecenia cmdlet za pomocą operatora potoku.
To polecenie cmdlet pobiera wszystkie węzły COMPUTE z tej puli.
...
To polecenie cmdlet zwraca węzły obliczeniowe, które pasują do filtru, który określa ten parametr.
Jeśli nie określisz filtru, to polecenie cmdlet zwróci wszystkie węzły COMPUTE dla puli.
...
### -ID
Określa identyfikator węzła obliczeniowego, który ten polecenie cmdlet pobiera z puli.
...
### -MaxCount
Określa maksymalną liczbę węzłów obliczeniowych, które mają zostać zwrócone.
...
### -Pool
Określa pulę jako obiekt **PSCloudPool** , który zawiera węzły obliczeniowe.
Aby uzyskać obiekt **PSCloudPool** , użyj polecenia cmdlet Get-AzureBatchPool.
...
[Resetowanie — AzureBatchComputeNode](./Reset-AzureBatchComputeNode.md)
