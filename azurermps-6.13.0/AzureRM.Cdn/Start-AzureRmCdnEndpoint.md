...
## Opis
Polecenie cmdlet **Start-AzureRmCdnEndpoint** umożliwia uruchomienie punktu końcowego sieci dostarczania zawartości Azure (CDN).
...
### -CdnEndpoint
Określa punkt końcowy, w którym jest uruchamiane to polecenie cmdlet.
...
### -EndpointName
Określa nazwę punktu końcowego, który jest uruchamiany przez to polecenie cmdlet.
