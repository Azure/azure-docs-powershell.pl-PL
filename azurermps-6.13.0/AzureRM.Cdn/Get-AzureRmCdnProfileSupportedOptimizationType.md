...
## Opis
Polecenie cmdlet **Get-AzureRmCdnProfileSupportedOptimizationType** pobiera obsługiwane typy optymalizacji dla bieżącego profilu. Użytkownik może utworzyć punkt końcowy z typem optymalizacji na liście wartości.
