...
## Opis
Polecenie cmdlet **Add-AzureRmVMDataDisk** dodaje dysk danych do maszyny wirtualnej lub do maszyny wirtualnej VMSS.
...
### Przykład 5: dodanie zarządzanego dysku danych do maszyny wirtualnej VMSS.
```
