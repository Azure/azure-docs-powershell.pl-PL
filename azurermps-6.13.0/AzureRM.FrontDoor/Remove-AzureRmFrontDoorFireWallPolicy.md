...
## Opis
Polecenie cmdlet **Remove-AzureRmFrontDoor** usuwa zasadę WAF w ramach bieżącego abonamentu
...
Usuń zasady WAF o nazwie $name w $resourceGroup.
...
Usuń wszystkie zasady WAF w $resourceGroup.
