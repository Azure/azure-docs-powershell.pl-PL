...
## Opis
Polecenie cmdlet **Set-AzureRmStorageContainerImmutabilityPolicy** tworzy lub aktualizuje ImmutabilityPolicy kontenerów blob magazynu
...
### Przykład 3: aktualizowanie ImmutabilityPolicyof kontenera obiektów blob magazynu 
```
...
To polecenie aktualizuje ImmutabilityPolicy kontenera obiektów blob magazynu za pomocą obiektu kontenera magazynu o wartości 2 razy, a najpierw ImmutabilityPeriod 12 dni bez elementu ETag, a następnie do ImmutabilityPeriod 9 dni przy użyciu elementu ETag.
