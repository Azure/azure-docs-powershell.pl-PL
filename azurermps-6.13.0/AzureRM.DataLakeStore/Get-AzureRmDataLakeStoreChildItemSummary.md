...
## Opis
**Element get-AzureRmDataLakeStoreChildItemSummary** pobiera podsumowanie zawartości dla danej ścieżki. Rekurencyjnie oblicza całkowitą liczbę plików, katalogów i całkowity rozmiar wszystkich plików pod daną ścieżką.
