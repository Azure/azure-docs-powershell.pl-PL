...
### -AzureToAzure
Parametr Switch określający, że tworzone mapowanie sieci będzie używane do replikowania maszyn wirtualnych platformy Azure między dwoma regionami platformy Azure.
