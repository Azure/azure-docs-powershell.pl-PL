...
## Opis
W tym temacie opisano tematy pomocy dotyczące apletów poleceń odzyskiwania witryny platformy Azure.

## Polecenia cmdlet AzureRM. RecoveryServices. SiteRecovery
...
### [Nowe — AzureRmRecoveryServicesAsrAzureToAzureDiskReplicationConfig](New-AzureRmRecoveryServicesAsrAzureToAzureDiskReplicationConfig.md)
...
### [Nowe — AzureRmRecoveryServicesAsrNetworkMapping](New-AzureRmRecoveryServicesAsrNetworkMapping.md)
...
### [Nowe — AzureRmRecoveryServicesAsrProtectableItem](New-AzureRmRecoveryServicesAsrProtectableItem.md)
Dodawanie (odnajdowanie) serwera fizycznego do listy elementów, które można chronić.

### [Nowe — AzureRmRecoveryServicesAsrProtectionContainer](New-AzureRmRecoveryServicesAsrProtectionContainer.md)
...
### [Nowe — AzureRmRecoveryServicesAsrvCenter](New-AzureRmRecoveryServicesAsrvCenter.md)
