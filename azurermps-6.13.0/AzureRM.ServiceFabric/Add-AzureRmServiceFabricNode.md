...
## Opis
Dodaj węzły do określonego typu węzła za pomocą **dodatku Add-AzureRmServiceFabricNode** . Wystarczy określić liczbę węzłów, które mają zostać dodane do typu węzła.
...
### System. Int32
Parametry: NumberOfNodesToAdd (ByValue)
