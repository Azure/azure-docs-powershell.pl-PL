...
```
## Opis
Aktualizowanie przydziału obliczeń

## Przykłady

### Przykład 1. Ustawianie właściwości w istniejącym kontyngencie obliczeniowym
```powershell
...
Ustaw parametry określone w wierszu polecenia.
Wszystkie parametry, których nie ustawiono, domyślnie mają wartość 0
