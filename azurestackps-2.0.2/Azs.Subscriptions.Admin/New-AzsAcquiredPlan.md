...
Utwórz plan abonamentu.

## PARAMETRÓW

### -AcquiredPlanDefinition
Aby skonstruować, zobacz sekcję notatki dla właściwości ACQUIREDPLANDEFINITION i Utwórz tablicę skrótów.
...
### Microsoft. Azure. PowerShell. polecenia. SubscriptionsAdmin. models. Api20151101. IPlanAcquisition
...
ACQUIREDPLANDEFINITION <IPlanAcquisition> : 
  - `[AcquisitionId <String>]`: Identyfikator nabycia.
  - `[AcquisitionTime <DateTime?>]`: Czas nabycia.
  - `[ExternalReferenceId <String>]`: Zewnętrzny identyfikator odwołania.
  - `[Id <String>]`: Identyfikator w kontekście subskrypcji dzierżawy.
  - `[PlanId <String>]`: Identyfikator planu w kontekście subskrypcji dzierżawy.
