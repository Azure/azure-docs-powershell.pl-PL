...
## STRESZCZENIe
Usuwa regułę zapory z serwera bazy danych Azure SQL.
...
## Opis
Polecenie cmdlet **Remove-AzureSqlDatabaseServerFirewallRule** usuwa regułę zapory z wystąpienia serwera bazy danych SQL Azure w bieżącej subskrypcji.

## Przykłady

### Przykład 1. Usuń regułę
```
PS C:\>Remove-AzureSqlDatabaseServerFirewallRule -ServerName "lpqd0zbr8y" -RuleName "FirewallRule24"
```

To polecenie usuwa regułę zapory o nazwie FirewallRule24 z serwera bazy danych SQL Azure o nazwie lpqd0zbr8y.
...
### -RuleName
Określa nazwę reguły zapory, która zostanie usunięta przez to polecenie cmdlet.
...
To polecenie cmdlet usuwa regułę zapory z serwera, który określa ten parametr.
...
[Usuwanie reguły zapory](https://msdn.microsoft.com/en-us/library/azure/dn505706.aspx)
