...
## STRESZCZENIe
Tworzy połączenie sieciowe bramy wirtualnej platformy Azure.
...
## Opis
Polecenie cmdlet **New-AzureVirtualNetworkGatewayConnection** tworzy połączenie sieciowe bramy wirtualnej platformy Azure.
...
### -EnableBgp
Włącza protokół BGP (Border Gateway Protocol).
...
Określa nazwę połączenia bramy.
...
Określa identyfikator bramy sieci wirtualnej.
