...
## Opis
Polecenie cmdlet **Get-AzureSiteRecoveryRecoveryPlan** pobiera plan odzyskiwania w usłudze Azure Site Recovery.

## Przykłady

### Przykład 1: pobieranie planu odzyskiwania
```
...
To polecenie pobiera informacje o planie odzyskiwania bieżącego magazynu usługi Azure Site Recovery.
