...
## STRESZCZENIe
Tworzy zadanie harmonogramu zawierające akcję magazynu.
...
Polecenie cmdlet **New-AzureSchedulerStorageQueueJob** tworzy zadanie harmonogramu z akcją usługi Azure Storage.

## Przykłady

### Przykład 1. Tworzenie zadania przechowywania, które jest uruchamiane raz
```
...
To polecenie tworzy zadanie przechowywania harmonogramu jako część kolekcji o nazwie JobCollection01.
To polecenie Określa konto magazynu, nazwę kolejki i token SAS.
Zadanie jest uruchamiane raz natychmiast.

### Przykład 2: Tworzenie zadania magazynowania, które jest uruchamiane określoną liczbą razy
```
...
To polecenie tworzy zadanie przechowywania harmonogramu jako część kolekcji o nazwie JobCollection01.
To polecenie Określa konto magazynu, nazwę kolejki i token SAS.
Zadanie jest wykonywane w sumie 20 razy, dwa razy w ciągu godziny.
