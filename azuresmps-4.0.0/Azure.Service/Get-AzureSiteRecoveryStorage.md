...
## STRESZCZENIe
Pobiera magazyny odzyskiwania witryny dla magazynu.
...
## Opis
Polecenie cmdlet **Get-AzureSiteRecoveryStorage** pobiera magazyny odzyskiwania witryny platformy Azure dla bieżącego magazynu usługi Azure Site Recovery.

## Przykłady

### Przykład 1: pobieranie magazynu odzyskiwania witryny
```
...
Drugie polecenie pobiera magazyn odzyskiwania witryny dla pierwszego serwera w tablicy $Servers.
...
### -Server
Określa serwer magazynu odzyskiwania witryny platformy Azure.
Aby uzyskać obiekt **ASRServer** , użyj polecenia cmdlet **Get-AzureSiteRecoveryServer** .
