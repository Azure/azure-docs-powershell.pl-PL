...
## STRESZCZENIe
Pobiera zasady tworzenia kopii zapasowych.
...
## Opis
Polecenie cmdlet **Get-AzureStorSimpleDeviceBackupPolicy** pobiera zasady tworzenia kopii zapasowych.
To polecenie cmdlet zwraca obiekt **BackupPolicy** lub listę wszystkich obiektów **BackupPolicy** , które należą do urządzenia.
Obiekty zasad tworzenia kopii zapasowych zawierają następujące właściwości: 
...
### Przykład 1: uzyskiwanie szczegółowych informacji o zasadach
```
...
To polecenie pobiera obiekt **BackupPolicyDetails** o nazwie GeneralBackupPolicy07 na urządzeniu o nazwie Contoso63-AppVm.

### Przykład 2: uzyskiwanie listy zasad tworzenia kopii zapasowych
```
...
To polecenie wyświetla listę obiektów **BackupPolicy** na urządzeniu o nazwie Contoso63-AppVm.

## PARAMETRÓW

### -BackupPolicyName
Określa nazwę zasad tworzenia kopii zapasowych, które należy uzyskać.
Jeśli nie podano tego parametru, to polecenie cmdlet będzie pobierać wszystkie zasady.
...
To polecenie cmdlet zwraca obiekt **BackupPolicyDetails** , jeśli określisz parametr *BackupPolicyName* .
Jeśli nie określisz tego parametru, zwraca obiekt **IList \<BackupPolicy\>** .
