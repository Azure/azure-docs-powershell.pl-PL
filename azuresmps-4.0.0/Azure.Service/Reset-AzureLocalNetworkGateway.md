...
## Opis
Polecenie cmdlet **Reset-AzureLocalNetworkGateway** resetuje bramę sieci lokalnej.
...
### -BgpPeeringAddress
Określa adres równorzędny protokołu BGP (Border Gateway Protocol).
...
[Nowe — AzureLocalNetworkGateway](./New-AzureLocalNetworkGateway.md)
