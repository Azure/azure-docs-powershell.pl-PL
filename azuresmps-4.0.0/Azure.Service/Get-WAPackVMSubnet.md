...
## STRESZCZENIe
Pobiera obiekty podsieci maszyny wirtualnej.

## POLECENIA

### FromVMNetworkObject (domyślny)
```
...
Polecenie cmdlet **Get-WAPackVMSubnet** Pobiera obiekty podsieci maszyny wirtualnej.

## Przykłady

### Przykład 1: uzyskiwanie podsieci maszyny wirtualnej za pomocą nazwy
```
PS C:\> $VNet = Get-WAPackVNet -Name "ContosoVNet01"
PS C:\> Get-WAPackVMTemplate -VNet $VNet -Name "ContosoSubnet01"
```

To polecenie pobiera podsieć maszyny wirtualnej o nazwie ContosoSubnet01.

### Przykład 2: uzyskiwanie podsieci maszyny wirtualnej przy użyciu identyfikatora
```
PS C:\> $VNet = Get-WAPackVNet -Name "ContosoVNet01"
PS C:\> Get-WAPackVMSubnet -VNet $VNet -Id 66242D17-189F-480D-87CF-8E1D749998C8
```

To polecenie pobiera podsieć maszyny wirtualnej o określonym IDENTYFIKATORze.

### Przykład 3: pobieranie wszystkich podsieci maszyn wirtualnych z danej wirtualnej sieci
```
PS C:\> $VNet = Get-WAPackVNet -Name "ContosoVNet01"
PS C:\> Get-WAPackVMSubnet -VNet $VNet
```

To polecenie pobiera wszystkie podsieci maszyny wirtualnej z danej wirtualnej sieci.

## PARAMETRÓW

### -ID
Określa unikatowy identyfikator podsieci maszyny wirtualnej.
