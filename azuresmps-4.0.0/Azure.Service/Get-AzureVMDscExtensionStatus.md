...
## STRESZCZENIe
Pobiera stan rozszerzenia DSC dla wszystkich maszyn wirtualnych wdrożonych w usłudze chmury lub dla konkretnej maszyny wirtualnej w usłudze.

## POLECENIA

### GetStatusByServiceAndVMName (domyślny)
```
...
## Opis
Polecenie cmdlet **Get-AzureVMDscExtensionStatus** Pobiera stan rozszerzenia konfiguracji stanu (DSC) dla wszystkich maszyn wirtualnych wdrożonych w usłudze chmury lub dla konkretnej maszyny wirtualnej w usłudze.
...
### Microsoft. platformy windowsazure. Commands. servicemanagement. IaaS. Extensions. VirtualMachineDscExtensionStatusContext
