...
## STRESZCZENIe
Wyłącza dostęp RDP do klastra usługi HDInsight.
...
Polecenie cmdlet **REVOKE-AzureHDInsightRdpAccess** wyłącza dostęp do protokołu RDP (Remote Desktop Protocol) do klastra usługi Azure HDInsight.
...
### -Subscription
Określa abonament.
Ten aplet polecenia odwołuje dostęp do protokołu RDP (Remote Desktop Protocol) dla subskrypcji, którą ten parametr określa.
