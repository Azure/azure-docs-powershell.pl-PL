...
## STRESZCZENIe
Tworzy zadanie harmonogramu z akcją HTTP.
...
Polecenie cmdlet **New-AzureSchedulerHttpJob** tworzy zadanie harmonogramu z akcją http.

## Przykłady

### Przykład 1. Tworzenie zadania HTTP
```
...
To polecenie tworzy zadanie HTTP harmonogramu w kolekcji zadań o nazwie JobCollection01.
Polecenie określa identyfikator URI i określa metodę GET AS.

### Przykład 2: Tworzenie zadania HTTP dla określonej liczby uruchomień
```
...
To polecenie tworzy zadanie http harmonogramu w kolekcji zadań o nazwie JobCollection01.
Polecenie określa identyfikator URI i określa metodę GET AS.
To polecenie powoduje, że zadanie jest uruchamiane 20 razy.
