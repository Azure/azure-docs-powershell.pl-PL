...
## STRESZCZENIe
Usuwa klaster usługi HDInsight z subskrypcji.
...
Polecenie cmdlet **Remove-AzureHDInsightCluster** umożliwia usunięcie określonego klastra usługi HDInsight z subskrypcji.
...
### Przykład 1: usuwanie klastra
```
PS C:\>Remove-AzureHDInsightCluster -Name "HDICluster"
```

To polecenie usuwa klaster usługi HDInsight o nazwie HDICluster.
...
### -Name (nazwa)
Określa nazwę klastra usługi HDInsight do usunięcia.
...
### -Subscription
Określa konto abonamentu zawierające klaster usługi HDInsight do usunięcia.
