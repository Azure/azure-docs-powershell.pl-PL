...
## STRESZCZENIe
Umożliwia zaktualizowanie kluczy konta usługi Azure Media Services.
...
Polecenie cmdlet **New-AzureMediaServicesKey** umożliwia zaktualizowanie podstawowego lub pomocniczego klucza określonego konta usług multimedialnych.

## Przykłady

### Przykład 1: aktualizowanie klucza konta usług multimedialnych
```
...
### -Force
Wskazuje, że generowanie klucza nie jest potwierdzone.
...
### -KeyType
Określa typ klucza usług multimedialnych; Prawidłowe wartości:
