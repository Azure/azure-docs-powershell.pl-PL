...
## STRESZCZENIe
Umożliwia utworzenie wirtualnego urządzenia StorSimple.
...
## Opis
Polecenie cmdlet **New-AzureStorSimpleVirtualDevice** umożliwia utworzenie wirtualnego urządzenia StorSimple.
Określ nazwę urządzenia dla urządzenia.
Określanie sieci wirtualnej i szczegółów podsieci dla sieci wirtualnej w tej samej subskrypcji.
Lokalizację geograficzną należy dopasować do geograficznej, w której jest tworzony zasób StorSimple.
Aby użyć istniejącego konta magazynu dla tego urządzenia wirtualnego, określ jego nazwę.
Aby utworzyć nowe konto magazynu dla tego urządzenia wirtualnego, określ zarówno parametry *StorageAccountName* , jak i *CreateNewStorageAccount* .

## Przykłady

### Przykład 1. Tworzenie urządzenia wirtualnego z nowym kontem i istniejącą siecią
```
...
To polecenie tworzy urządzenie wirtualne korzystające z nowego konta magazynu i istniejącej sieci wirtualnej.

### Przykład 2: Tworzenie urządzenia wirtualnego z istniejącym kontem i siecią wirtualną
```
...
To polecenie tworzy urządzenie wirtualne korzystające z istniejącego konta magazynu i istniejącej sieci wirtualnej.

## PARAMETRÓW

### -CreateNewStorageAccount
Wskazuje, że to polecenie cmdlet tworzy nowe konto magazynu.
...
### -SubNetname
Określa nazwę podsieci wirtualnej.
...
### -VirtualDeviceName
Określa nazwę urządzenia wirtualnego.
...
### Ciąg
To polecenie cmdlet zwraca identyfikator zadania, które powoduje utworzenie urządzenia wirtualnego.
Możesz użyć tego identyfikatora, aby śledzić postęp za pomocą polecenia cmdlet Get-AzureStorSimpleJob.
