...
## STRESZCZENIe
Umożliwia zaktualizowanie zadania harmonogramu, które zawiera akcję magazynu.
...
Polecenie cmdlet **Set-AzureSchedulerStorageQueueJob** aktualizuje zadanie harmonogramu z akcją magazynu platformy Azure.

## Przykłady

### Przykład 1: aktualizowanie wiadomości w kolejce magazynu
```
...
To polecenie aktualizuje komunikat kolejki dla zadania przechowywania o nazwie Job12.
Polecenie określa nazwę kolekcji zadań i lokalizację.

### Przykład 2: Włączanie zadania w kolejce magazynu
```
...
To polecenie włącza zadanie o nazwie Job16.
Polecenie zmieni stan zadania na włączone przez określenie wartości parametru *JobState* .

## PARAMETRÓW

### -EndTime
Określa godzinę jako obiekt **DateTime** , aby harmonogram przestał zainicjowania zadania.
...
### -JobName
Określa nazwę zadania harmonogramu do zaktualizowania.
...
[Nowe — AzureSchedulerStorageQueueJob](./New-AzureSchedulerStorageQueueJob.md)
