...
### RemoveByExtensionName (domyślny)
```
...
To polecenie usuwa wszystkie rozszerzenia z określonej maszyny wirtualnej jako przechowywane w zmiennej $VM.
...
### — Wydawca
Umożliwia określenie wydawcy rozszerzenia.
