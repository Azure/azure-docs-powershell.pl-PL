...
## STRESZCZENIe
Pobiera ustawienia rozszerzenia DSC na maszynie wirtualnej.
...
## Opis
Polecenie cmdlet **Get-AzureVMDscExtension** pobiera ustawienia rozszerzenia DSC na maszynie wirtualnej.

## Przykłady

### Przykład 1: uzyskiwanie ustawienia dla rozszerzenia DSC na maszynie wirtualnej
```
...
To polecenie pobiera ustawienia rozszerzenia DSC na maszynie wirtualnej.
...
### Microsoft. platformy windowsazure. Commands. servicemanagement. IaaS. Extensions. VirtualMachineDscExtensionContext
