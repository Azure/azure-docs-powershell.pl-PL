...
## STRESZCZENIe
Pobiera rozszerzenia zasobów zastosowane do maszyn wirtualnych.

## POLECENIA

### ListByReferenceName (domyślny)
```
...
## Opis
Polecenie cmdlet **Get-AzureVMExtension** umożliwia stosowanie rozszerzeń zasobów na maszynach wirtualnych.

## Przykłady

### Przykład 1: uzyskiwanie rozszerzeń zasobów zastosowanych do maszyny wirtualnej
```
PS C:\> Get-AzureVM -ServiceName $SVC -Name $VM | Get-AzureVMExtension;
```

To polecenie pobiera rozszerzenia zasobów zastosowane do określonej maszyny wirtualnej jako przechowywane w zmiennej $VM.
