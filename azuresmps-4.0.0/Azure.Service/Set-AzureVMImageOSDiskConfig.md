...
## STRESZCZENIe
Ustawia właściwości dysku systemu operacyjnego na obrazie maszyny wirtualnej.
...
## Opis
Polecenie cmdlet **Set-AzureVMImageOSDiskConfig** ustawia właściwości dysku systemu operacyjnego obrazu maszyny wirtualnej.

## Przykłady

### Przykład 1: Ustawianie właściwości dysku systemu operacyjnego w obrazie maszyny wirtualnej
```
...
W tym przykładzie są ustawiane właściwości dysku systemu operacyjnego obrazu maszyny wirtualnej.
...
### -OS
Określa system operacyjny konfiguracji dysku.
...
### -OSState
Określa stan systemu operacyjnego dla obrazu maszyny wirtualnej
...
Użycie tego parametru wskazuje, że zamierzasz przechwycić obraz maszyny wirtualnej na platformie Azure.
