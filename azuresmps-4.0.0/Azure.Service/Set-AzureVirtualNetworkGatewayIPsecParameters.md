...
## STRESZCZENIe
Ustawia parametry protokołu IPsec dla bramy sieci wirtualnej.
...
## Opis
Polecenie cmdlet **Set-AzureVirtualNetworkGatewayIPsecParameters** ustawia parametry protokołu IPSec dla bramy sieci wirtualnej.
