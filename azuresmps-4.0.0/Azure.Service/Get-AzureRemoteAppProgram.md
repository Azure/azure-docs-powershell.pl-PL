...
## STRESZCZENIe
Pobiera właściwości jednego lub większej liczby opublikowanych programów RemoteApp usługi Azure dla kolekcji.

## POLECENIA

### FilterByName (domyślny)
```
...
## Opis
Polecenie cmdlet **Get-AzureRemoteAppProgram** pobiera właściwości jednego lub większej liczby opublikowanych programów funkcji Azure RemoteApp dla kolekcji.

## Przykłady

### Przykład 1: pobieranie właściwości programu
```
...
To polecenie wyświetla właściwości programu usługi Azure RemoteApp.
Program o nazwie aplikacja finansowa znajduje się w kolekcji funkcji Azure RemoteApp o nazwie ContosoApps.

## PARAMETRÓW

### -Alias
Określa alias programu, dla którego mają zostać pobrane właściwości.
...
### -RemoteAppProgram
Określa nazwę programu, dla którego mają zostać pobrane właściwości.
