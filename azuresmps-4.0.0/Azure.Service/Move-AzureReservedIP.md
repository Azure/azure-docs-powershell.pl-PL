...
## STRESZCZENIe
Migruje zastrzeżony adres IP do stosu Menedżera zasobów platformy Azure.
...
## Opis
Polecenie cmdlet **Move-AzureReservedIP** migruje zastrzeżony adres IP do grupy zasobów na stosie usługi Azure Resource Manager.
...
### -Przerwij
Wskazuje, że to polecenie cmdlet anuluje migrację zastrzeżonych adresów IP.
...
### -Commit
Wskazuje, że to polecenie cmdlet rozpoczyna migrację zastrzeżonych adresów IP.
...
### -Przygotuj
Wskazuje, że to polecenie cmdlet przygotowuje zastrzeżony adres IP do migracji.
...
### -ReservedIPName
Określa nazwę zastrzeżonych adresów IP, które wykonuje to polecenie cmdlet.
...
### -Validate
Określa, że to polecenie cmdlet sprawdza poprawność zastrzeżonego adresu IP do migracji.
