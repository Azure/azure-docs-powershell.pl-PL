...
## STRESZCZENIe
Generuje konfigurację rozszerzenia diagnostycznego dla określonych ról lub wszystkich ról.
...
## Opis
Polecenie cmdlet **New-AzureServiceDiagnosticsExtensionConfig** generuje konfigurację rozszerzenia diagnostycznego dla określonych ról lub wszystkich ról.

## Przykłady

### Przykład 1. Tworzenie rozszerzenia Diagnostyka platformy Azure dla wszystkich ról w usłudze chmury
```
...
To polecenie tworzy rozszerzenie Diagnostyka platformy Azure dla wszystkich ról w usłudze chmury.

### Przykład 2: Tworzenie rozszerzenia Diagnostyka platformy Azure dla roli
```
...
To polecenie tworzy rozszerzenie Diagnostyka platformy Azure dla roli WebRole01 w usłudze chmury.
...
Określa ścieżkę konfiguracji diagnostyki.
...
### -Rola
Określa opcjonalną tablicę ról określającą konfigurację diagnostyki.
Jeśli nie określono, konfiguracja diagnostyki jest stosowana jako domyślna konfiguracja wszystkich ról.
