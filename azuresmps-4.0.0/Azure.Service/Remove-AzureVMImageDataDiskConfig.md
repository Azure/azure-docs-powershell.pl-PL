...
## STRESZCZENIe
Usuwa konfigurację dysku danych z obiektu DiskConfigSet.

## POLECENIA

### RemoveByDiskName (domyślny)
```
...
## Opis
Polecenie cmdlet **Remove-AzureVMImageDataDiskConfig** usuwa konfigurację dysku danych z obiektu **DiskConfigSet** .

## Przykłady

### Przykład 1: Usuwanie konfiguracji dysku danych z obiektu DiskConfigSet
```
...
W tym przykładzie przedstawiono tworzenie **DiskConfigSet** , jego konfigurację, a następnie Usuwanie dysku danych.

## PARAMETRÓW

### -Datadyskname
Określa nazwę dysku danych, które zostanie usunięte przez to polecenie cmdlet.
