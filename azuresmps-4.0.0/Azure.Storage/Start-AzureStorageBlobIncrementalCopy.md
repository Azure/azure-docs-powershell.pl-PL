...
### -AbsoluteUri
Bezwzględny identyfikator URI do źródła.
Należy zauważyć, że poświadczenia powinny być podane w identyfikatorze URI, jeśli źródło wymaga dowolnych danych.
...
### -CloudBlob
Obiekt CloudBlob z biblioteki klienta magazynu platformy Azure.
Możesz je utworzyć lub użyć Get-AzureStorageBlob polecenia cmdlet.
...
### -CloudBlobContainer
Obiekt CloudBlobContainer z biblioteki klienta magazynu platformy Azure.
...
### -Context
Kontekst źródłowy usługi Azure Storage.
...
### -DestContext
Kontekst miejsca docelowego usługi Azure Storage.
Możesz je utworzyć, New-AzureStorageContext polecenie cmdlet.
