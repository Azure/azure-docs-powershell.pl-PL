...
## Opis
Polecenie cmdlet **Get-AzCognitiveServicesAccount** pobiera konta usług poznawczych w grupie zasobów określonym przez parametr *ResoureGroupName* .
Jeśli nie określisz parametru *ResoureGroupName* , to polecenie cmdlet otrzyma wszystkie konta usług poznawczych dla bieżącego abonamentu.
