...
## Opis
Tworzy nowe zadanie importu urządzeń dla IotHub.
Spowoduje to zaimportowanie wszystkich urządzeń do IotHub z określonego kontenera. Zapoznaj się z następującym artykułem dotyczącym generowania identyfikatora URI SAS.
...
Tworzy nowe żądanie importu urządzenia dla IotHub "myiothub".
...
Wejściowy identyfikator URI kontenera BLOB dla FileUpload
...
Identyfikator URI, do którego ma zostać napisana produkcja. 
