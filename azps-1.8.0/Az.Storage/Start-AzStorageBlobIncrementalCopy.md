...
### -CloudBlob
Obiekt CloudBlob z biblioteki klienta magazynu platformy Azure. Możesz je utworzyć lub użyć Get-AzStorageBlob polecenia cmdlet.
...
### -CloudBlobContainer
Obiekt CloudBlobContainer z biblioteki klienta magazynu platformy Azure. Możesz je utworzyć lub użyć Get-AzStorageContainer polecenia cmdlet.
...
### -Context
Kontekst źródłowy usługi Azure Storage. Możesz je utworzyć, New-AzStorageContext polecenie cmdlet.
...
### -DestContext
Kontekst miejsca docelowego usługi Azure Storage. Możesz je utworzyć, New-AzStorageContext polecenie cmdlet.
