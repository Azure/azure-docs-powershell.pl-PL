...
## Opis
Polecenie cmdlet **Get-AzStorageContainerStoredAccessPolicy** zawiera listę przechowywanych zasad dostępu lub zasad dotyczących kontenera magazynu platformy Azure.

## Przykłady

### Przykład 1: uzyskiwanie zapisanych zasad dostępu w kontenerze magazynu
```
PS C:\>Get-AzStorageContainerStoredAccessPolicy -Container "Container07" -Policy "Policy22"
```

To polecenie pobiera zasady dostępu o nazwie Policy22 w kontenerze magazynu o nazwie Container07.
...
### Microsoft. platformy windowsazure. Storage. blob. SharedAccessBlobPolicy
