...
### -UseConnectedAccount
Wskazuje, że to polecenie cmdlet tworzy kontekst usługi Azure Storage z uwierzytelnianiem uwierzytelniania OAuth.
Polecenie cmdlet będzie domyślnie używać uwierzytelniania OAuth, jeśli nie podano innych anthentication.
