...
## Opis
Polecenie cmdlet **Remove-AzDataLakeAnalyticsDataSource** umożliwia usunięcie źródła danych z konta usługi Azure Data Lake Analytics.

## Przykłady

### Przykład 1: Usuwanie źródła danych
```
PS C:\>Remove-AzDataLakeAnalyticsDataSource -Account "ContosoAdlAccount" -Blob "AzureStorage01"
```

To polecenie usuwa źródło danych o nazwie AzureStorage01 z konta o nazwie ContosoAdlAccount.
...
### -Obiekt BLOB
Określa nazwę konta magazynu usługi AzureBlob, które ma zostać usunięte.
...
### -DataLakeStore
Określa nazwę konta usługi AzureData Lake Store, które ma zostać usunięte.
