...
## Opis
Polecenie cmdlet **Update-AzImage** umożliwia zaktualizowanie obrazu.
Obecnie można aktualizować tylko te Tagi.
...
To polecenie aktualizuje wartość znacznika istniejącego obrazu "Image01" w grupie zasobów "ResourceGroup01".
