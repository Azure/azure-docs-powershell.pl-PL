...
## Opis
Polecenie cmdlet **Remove-AzVmssNetworkInterfaceConfiguration** usuwa konfigurację interfejsu sieciowego z zestawu skali maszyny wirtualnej (VMSS).
...
Pierwsze polecenie uzyskuje VMSS przy użyciu polecenia cmdlet Get-AzVmss, a następnie zapisuje je w zmiennej $VMSS.
