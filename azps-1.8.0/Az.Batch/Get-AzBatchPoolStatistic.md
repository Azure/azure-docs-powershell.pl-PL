...
## Opis
Polecenie cmdlet **Get-AzBatchPoolStatistic** pobiera statystykę okresu istnienia dla wszystkich pul na określonym koncie.
Statystyka jest agregowana we wszystkich pulach, które kiedykolwiek istniały na koncie, od utworzenia konta do ostatniej aktualizacji statystyk.

## Przykłady

### Przykład 1: Pobieranie statystyk zasobów wszystkich pul na koncie
```
...
Pierwsze polecenie tworzy odwołanie obiektu do kluczy konta dla konta wsadowego o nazwie ContosoBatchAccount przy użyciu polecenia **Get-AzBatchAccountKeys**.
Polecenie zapisuje to odwołanie do obiektu w zmiennej $Context.
Drugie polecenie pobiera statystykę wszystkich pul z określonego konta, a następnie zapisuje je w $PoolStatistics.
Polecenie ostatnie wyświetla Właściwość **ResourceStatistics** $PoolStatistics.
...
### Microsoft.Azure.Commands.Batch. Modele. PSPoolStatistics
