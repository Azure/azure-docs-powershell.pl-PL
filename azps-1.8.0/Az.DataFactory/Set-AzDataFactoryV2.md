...
### Przykład 2: Tworzenie fabryki danych ze szczegółami repoconfiguration przy użyciu istniejącego obiektu fabryki.
```
...
To polecenie tworzy fabrykę danych o nazwie WikiADF w grupie zasobów o nazwie ADF w lokalizacji na zachód.
...
### -HostName
Nazwa hosta dla konfiguracji repozytorium.
...
### -NazwaProjektu
Nazwa projektu dla konfiguracji repozytorium.
...
### -Dzierżawy
Identyfikator dzierżawy dla konfiguracji repozytorium.
