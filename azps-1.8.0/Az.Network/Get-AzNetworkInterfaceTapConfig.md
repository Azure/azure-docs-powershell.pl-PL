...
## Opis
Polecenie cmdlet **Get-AzNetworkInterfaceTapConfig umożliwia pobranie** konfiguracji platformy Azure dla danej grupy zasobów, interfejsu sieciowego i naciśnięcie nazwy konfiguracji lub listy konfiguracji naciśnij pozycję konfiguracje w grupie zasobów i interfejsie sieciowym.
...
### Przykład 3: uzyskiwanie danej konfiguracji TAP
```
PS C:\> Get-AzNetworkInterface -ResourceGroupName "ResourceGroup1" -NetworkInterface "sourceNicName" -Name "tapconfig*"
```

To polecenie pobiera konfiguracje dodane dla danego interfejsu sieciowego o nazwie rozpoczynającej się od wyrazu "tapconfig".
