...
## SYNOPSIS
Tworzy nowy obiekt profilu konfiguracji sieci. Ten obiekt służy do ograniczenia confiuration sieci podczas sesji diagnostycznej przy użyciu określonych kryteriów.
...
## OPIS
Polecenie New-AzNetworkWatcherNetworkConfigurationDiagnosticProfile cmdlet tworzy nowy obiekt profilu diagnostycznego. Ten obiekt służy do ograniczania confiuration sieci podczas sesji diagnostycznej konfiguracji sieci przy użyciu określonych kryteriów.
