...
Pobiera wszystkie dostępne zmienne serwerowe, nagłówki żądań i odpowiedzi.
...
Polecenie cmdlet Get-AzInterfaceEndpoint Pobiera punkt końcowy interfejsu.
...
Umożliwia utworzenie reguły actionset dla bramy aplikacji.
...
Tworzy nowy obiekt profilu diagnostycznego konfiguracji sieci. Ten obiekt służy do ograniczania confiuration sieci podczas sesji diagnostycznej przy użyciu określonych kryteriów.
...
Aktualizuje VpnSite reprezentujący oddział klienta do zamierzonego stanu celu.
