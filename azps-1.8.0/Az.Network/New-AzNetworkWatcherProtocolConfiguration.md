...
## OPIS
Polecenie New-AzNetworkWatcherProtocolConfiguration cmdlet tworzy nowy obiekt konfiguracji protokołu. Ten obiekt służy do ograniczania pomylinia protokołu podczas sesji sprawdzania sprzężeń przy użyciu określonych kryteriów. 

## PRZYKŁADY

### Przykład 1. Testowanie łączności z usługą Network Watcher z maszyny wirtualnej do witryny internetowej z konfiguracją protokołu
```
