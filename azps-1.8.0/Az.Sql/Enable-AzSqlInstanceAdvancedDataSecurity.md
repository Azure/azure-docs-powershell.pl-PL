...
## Opis
Polecenie cmdlet **enable-AzSqlInstanceAdvancedDataSecurity** włącza zaawansowane zabezpieczenia danych w zarządzanym wystąpieniu.
...
### Przykład 2 — Włączanie zaawansowanego zabezpieczenia danych wystąpienia zarządzanego z zasobu serwera
```powershell
