...
To polecenie tworzy definicję zestawu zasad o nazwie VMPolicyDefinition zawierającą definicje zasad określone w C:\VMPolicy.js. Przykładowa zawartość VMPolicy.jsjest podana powyżej.
...
To polecenie tworzy definicję zestawu zasad sparametryzowanego o nazwie VMPolicyDefinition zawierającą definicje zasad określone w C:\VMPolicy.js. Przykładowa zawartość VMPolicy.jsjest podana powyżej.
...
### -Metadata
Metadane dotyczące definicji zestawu zasad. Może to być ścieżka do nazwy pliku zawierającego metadane lub metadane jako ciąg.
