...
## STRESZCZENIe
Zaktualizuj NetwrokruleSet danych Namepsace w bieżącej subskrypcji platformy Azure.
...
Aktualizowanie parametrów NetworkRuleSet-IPRule i-VirtualNteworkRule
...
Aktualizowanie funkcji NetworkRuleSet.-Inputobject
...
Zaktualizuj NetworkRuleSet, używając-ResourceId innej przestrzeni nazw.

## PARAMETRÓW

### -DefaultAction
Domyślna akcja dla NetwrokeuleSet
...
### -Inputobject
Obiekt konfiguracji NetworkruleSet
...
### -ResourceId
Identyfikator zasobu w obszarze nazw
