...
## STRESZCZENIe
Umożliwia aktualizowanie biletu pomocy technicznej.

## POLECENIA

### UpdateByNameWithContactDetailParameterSet (domyślny)
```
...
## Opis
Za pomocą tego polecenia cmdlet można zaktualizować poziom ważności biletu pomocy technicznej, status lub dane kontaktowe klienta. Zwróć uwagę, że zaktualizowanie poziomu ważności biletu pomocy technicznej lub statusu nie jest dozwolone, gdy bilet jest przypisany do inżyniera pomocy technicznej. Jeśli chcesz zaktualizować poziom ważności lub status po przypisaniu biletu, skontaktuj się z pracownikiem pomocy technicznej, wysyłając wiadomość na bilet.

## Przykłady

### Przykład 1: Aktualizacja ważność biletu pomocy technicznej.
```powershell
...
### Przykład 2: zaktualizowanie statusu biletu pomocy technicznej.
```powershell
...
### Przykład 3: aktualizowanie danych kontaktu dotyczących biletu pomocy technicznej przez określenie obiektu kontaktu.
```powershell
...
### Przykład 4: Aktualizacja ważność biletu pomocy technicznej dzięki obiektowi biletu pomocy technicznej dla połączeń rurowych.
```powershell
...
### Przykład 5: aktualizowanie danych kontaktowych dotyczących biletu pomocy technicznej przez określenie indywidualnych parametrów kontaktu.
```powershell
...
### Przykład 6: aktualizowanie stanu biletu pomocy technicznej przez obiekt biletu pomocy technicznej dla połączeń rurowych.
```powershell
...
Zaktualizuj szczegółowe dane kontaktowe w witrynie SupportTicket.
...
Preferowany język obsługi klienta.
Musi to być prawidłowy kod językowy dla jednego z obsługiwanych języków z listy https://azure.microsoft.com/support/faq/ .
...
### -Inputobject
Obiekt zasobu SupportTicket, który jest aktualizowany przez to polecenie cmdlet.
...
### -Name (nazwa)
Nazwa zasobu SupportTicket, który jest aktualizowany przez to polecenie cmdlet.
...
### — Ważność
Aktualizuj ważność SupportTicket.
...
### -Status
Zaktualizuj stan SupportTicket.
