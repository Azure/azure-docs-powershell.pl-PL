...
### Przykład 1: Uzyskaj aplikację funkcyjną według nazwy i Rozpocznij ją.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Start-AzFunctionApp
```

To polecenie pobiera aplikację funkcyjną według nazwy i uruchamia ją.
...
To polecenie uruchamia aplikację funkcyjną według nazwy.
