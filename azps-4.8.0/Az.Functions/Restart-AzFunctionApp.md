...
### Przykład 1: Uzyskaj aplikację funkcyjną według nazwy i uruchom ją ponownie.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Restart-AzFunctionApp -Force
```

To polecenie pobiera aplikację funkcyjną według nazwy i uruchamia ją ponownie.

### Przykład 2: ponowne uruchomienie aplikacji funkcji według nazwy.
```powershell
...
### -Force
Wymusza ponowne uruchomienie aplikacji funkcji bez monitowania o potwierdzenie.
