...
To polecenie ustawia SystemAssignedą zarządzaną tożsamość dla aplikacji funkcji.

### Przykład 3: funkcja Aktualizacje aplikacja szczegółowe informacje o aplikacji.
```powershell
...
To polecenie aktualizuje informacje o funkcjach w aplikacji.

### Przykład 3: Usuwanie zarządzanej tożsamości z aplikacji funkcji.
```powershell
PS C:\> Update-AzFunctionApp -Name MyUniqueFunctionAppName -ResourceGroupName MyResourceGroupName -IdentityType None 
```

To polecenie usuwa zarządzaną tożsamość z aplikacji funkcji.
...
Typ "Brak" spowoduje usunięcie wszystkich tożsamości z aplikacji funkcji.
Dopuszczalne wartości tego parametru to:-SystemAssigned-UserAssigned-none.
