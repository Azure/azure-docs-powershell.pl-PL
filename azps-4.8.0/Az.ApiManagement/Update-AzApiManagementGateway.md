...
## Opis
Polecenie cmdlet **Update-AzApiManagementGateway** konfiguruje bramę zarządzania API.
...
To polecenie umożliwia skonfigurowanie bramy.
...
### -Inputobject
Wystąpienie PsApiManagementGateway. Ten parametr jest wymagany.
...
### -PassThru
W przypadku określenia wystąpienia funkcji Microsoft. Azure. Commands. ApiManagement. servicemanagement. models. PsApiManagementGateway (typ) reprezentujący zmodyfikowaną bramę.
...
### -ResourceId
Identyfikator zasobu ARM bramy. Ten parametr jest wymagany.
