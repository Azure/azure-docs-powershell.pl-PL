...
## Opis
Polecenie cmdlet **Get-AzApiManagementGatewayHostnameConfiguration** pobiera całą lub określoną konfigurację hosta dla istniejącej bramy.

## Przykłady

### Przykład 1: uzyskiwanie wszystkich konfiguracji hostów dla bramy
```
...
### Przykład 2: Uzyskiwanie konfiguracji nazwy hosta dla bramy
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
To polecenie pobiera konfigurację hosta "123" dla bramy "0123456789".
