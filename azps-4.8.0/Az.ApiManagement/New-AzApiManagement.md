...
## Opis
Polecenie cmdlet **New-AzApiManagement** tworzy wdrożenie zarządzania interfejsem API w usłudze Azure API Management.
...
To polecenie tworzy usługę zarządzania interfejsem API warstwy zużycia z certyfikatem klienta włączonym w zachodniej Europie.
...
To polecenie tworzy standardową usługę zarządzania interfejsem API i włączy protokół TLS 1,0 na kliencie frontonu, aby ApiManagement bramę i klienta zaplecza między bramą ApiManagement i zapleczem wewnętrznym.
...
### -EnableClientCertificate
Flaga przeznaczona tylko do użytku w usłudze ApiManagement SKU. Wymusza to, że certyfikat klienta jest prezentowany na każdej prośbie do bramy. Umożliwia także uwierzytelnianie certyfikatu w zasadach w bramie.
...
### -SslSetting
Ustawienie protokołu SSL usługi ApiManagement. Wartość domyślna to $null
...
Przypisz tożsamości użytkowników do tego serwera, aby móc korzystać z usług zarządzania kluczami, takich jak Magazyn kluczy platformy Azure.
...
### System. Nullable "1 [[Microsoft. Azure. Commands. ApiManagement. MODELES. PsApiManagementSku, Microsoft. Azure. PowerShell. cmdlet. ApiManagement, Version = 1.0.0.0, Culture = neutral, PublicKeyToken = null]]
