...
---
# AZ. ApiManagement, moduł
## Opis
W tym temacie są wyświetlane tematy pomocy dotyczące poleceń cmdlet zarządzania usługą Azure API.

## AZ. ApiManagement polecenia cmdlet
### [Dodaj-AzApiManagementApiToGateway](Add-AzApiManagementApiToGateway.md)
Dołącza interfejs API do bramy.

### [Dodaj-AzApiManagementApiToProduct](Add-AzApiManagementApiToProduct.md)
Dodaje interfejs API do produktu.

### [Dodaj-AzApiManagementProductToGroup](Add-AzApiManagementProductToGroup.md)
...
Uzyskiwanie szczegółowych informacji o schemacie API
...
Uzyskaj szczegółowe informacje o diagnostyce skonfigurowanej na poziomie usługi lub interfejsie API. Diagnostyka umożliwia rejestrowanie żądań/odpowiedzi z bramy zarządzania interfejsem API.
...
Pobiera wszystkie lub określoną konfigurację hosta dla istniejącej bramy.

### [Get-AzApiManagementGatewayKey](Get-AzApiManagementGatewayKey.md)
Pobiera klucze istniejącej bramy.
...
Uzyskaj klucz tajny klienta dostawcy tożsamości.

### [Get-AzApiManagementLogger](Get-AzApiManagementLogger.md)
Pobiera obiekty rejestratora zarządzania interfejsem API.

### [Get-AzApiManagementNamedValue](Get-AzApiManagementNamedValue.md)
Pobiera listę lub określoną wartość nazwaną.

### [Get-AzApiManagementNamedValueSecretValue](Get-AzApiManagementNamedValueSecretValue.md)
Pobiera tajną wartość określonej nazwanej wartości.

### [Get-AzApiManagementNetworkStatus](Get-AzApiManagementNetworkStatus.md)
Pobiera stan łączności do zasobów zewnętrznych, od których zależy usługa zarządzania interfejsem API w ramach usługi w chmurze. Spowoduje to również zwrócenie serwerów DNS jako widocznych dla CloudService.
...
Pobiera klucz tajny klienta z OpenID Connect.
...
Pobiera listę lub konkretny produkt.

### [Get-AzApiManagementSsoToken](Get-AzApiManagementSsoToken.md)
Pobiera link z tokenem SSO do wdrożonego portalu zarządzania usługi zarządzania interfejsem API.
...
Pobiera klucze konfiguracji programu Access dla dzierżawy.

### [Get-AzApiManagementTenantGitAccess](Get-AzApiManagementTenantGitAccess.md)
Pobiera konfigurację dostępu git dla dzierżawy.

### [Get-AzApiManagementTenantGitAccessSecret](Get-AzApiManagementTenantGitAccessSecret.md)
Pobiera klucze konfiguracji dostępu git dla dzierżawy.
...
### [Nowe — AzApiManagementApiRelease](New-AzApiManagementApiRelease.md)
...
### [Nowe — AzApiManagementApiSchema](New-AzApiManagementApiSchema.md)
Tworzy nowy schemat interfejsu API w usłudze ApiManagement
...
### [Nowe — AzApiManagementBackendServiceFabric](New-AzApiManagementBackendServiceFabric.md)
Tworzy obiekt `PsApiManagementServiceFabric`

### [Nowe — AzApiManagementCache](New-AzApiManagementCache.md)
Tworzy nową jednostkę pamięci podręcznej

### [Nowe — AzApiManagementCertificate](New-AzApiManagementCertificate.md)
Tworzy certyfikat zarządzania interfejsem API do użycia podczas uwierzytelniania z zapleczem wewnętrznym.

### [Nowe — AzApiManagementContext](New-AzApiManagementContext.md)
Tworzy wystąpienie PsAzureApiManagementContext.

### [Nowe — AzApiManagementCustomHostnameConfiguration](New-AzApiManagementCustomHostnameConfiguration.md)
...
Tworzy nową diagnostykę w zakresie globalnym lub w zakresie interfejsu API.

### [Nowe — AzApiManagementGateway](New-AzApiManagementGateway.md)
Tworzy nową jednostkę bramy.

### [Nowe — AzApiManagementGatewayHostnameConfiguration](New-AzApiManagementGatewayHostnameConfiguration.md)
...
### [Nowe — AzApiManagementHttpMessageDiagnostic](New-AzApiManagementHttpMessageDiagnostic.md)
...
### [Nowe — AzApiManagementLogger](New-AzApiManagementLogger.md)
Tworzy rejestratora zarządzania interfejsem API.

### [Nowe — AzApiManagementNamedValue](New-AzApiManagementNamedValue.md)
Tworzy nową nazwaną wartość.

### [Nowe — AzApiManagementOpenIdConnectProvider](New-AzApiManagementOpenIdConnectProvider.md)
Tworzy dostawcę OpenID Connect.

### [Nowe — AzApiManagementOperation](New-AzApiManagementOperation.md)
Tworzy operację zarządzania interfejsem API.

### [Nowe — AzApiManagementPipelineDiagnosticSetting](New-AzApiManagementPipelineDiagnosticSetting.md)
Tworzenie ustawień diagnostycznych dla przychodzących/wychodzących wiadomości HTTP do bramy.

### [Nowe — AzApiManagementProduct](New-AzApiManagementProduct.md)
Tworzy produkt zarządzania interfejsem API.

### [Nowe — AzApiManagementRegion](New-AzApiManagementRegion.md)
Tworzy wystąpienie PsApiManagementRegion.

### [Nowe — AzApiManagementResourceLocationObject](New-AzApiManagementResourceLocationObject.md)
Tworzenie nowego kontraktu dotyczącego lokalizacji zasobów (używanej w bramach).

### [Nowe — AzApiManagementSamplingSetting](New-AzApiManagementSamplingSetting.md)
Tworzenie nowego ustawienia próbkowania dla diagnostyki

### [Nowe — AzApiManagementSslSetting](New-AzApiManagementSslSetting.md)
Tworzy wystąpienie PsApiManagementSslSetting

### [Nowe — AzApiManagementSubscription](New-AzApiManagementSubscription.md)
Tworzy abonament.

### [Nowe — AzApiManagementSystemCertificate](New-AzApiManagementSystemCertificate.md)
...
### [Nowe — AzApiManagementUserToken](New-AzApiManagementUserToken.md)
Generuje token dostępu współdzielonego dla użytkownika.

### [Nowe — AzApiManagementVirtualNetwork](New-AzApiManagementVirtualNetwork.md)
...
Usuwa interfejs API z produktu.
...
Usuwa schemat API z interfejsu API.
...
Usuwa serwer autoryzacji.

### [Remove-AzApiManagementBackend](Remove-AzApiManagementBackend.md)
Usuwanie wewnętrznej bazy danych.
...
Usuwa rejestratora zarządzania interfejsem API.

### [Remove-AzApiManagementNamedValue](Remove-AzApiManagementNamedValue.md)
Usuwa wartość zarządzania interfejsem API o nazwie.
...
### [Zapisz — AzApiManagementTenantGitConfiguration](Save-AzApiManagementTenantGitConfiguration.md)
Zapisuje zmiany, tworząc zatwierdzenie bieżącej konfiguracji.

### [Set-AzApiManagement](Set-AzApiManagement.md)
Aktualizuje usługę zarządzania interfejsem API platformy Azure
...
Modyfikuje schemat API

### [Set-AzApiManagementApiVersionSet](Set-AzApiManagementApiVersionSet.md)
Aktualizuje wersję interfejsu API ustawioną w kontekście zarządzania interfejsem API.
...
Modyfikuje certyfikat zarządzania interfejsem API, który jest skonfigurowany dla wzajemnego uwierzytelniania z zapleczem wewnętrznym.

### [Set-AzApiManagementDiagnostic](Set-AzApiManagementDiagnostic.md)
Modyfikuje diagnostykę zarządzania interfejsem API w zakresie globalnym lub interfejsem API.
...
Umożliwia zaktualizowanie konfiguracji istniejącego dostawcy tożsamości.

### [Set-AzApiManagementLogger](Set-AzApiManagementLogger.md)
Modyfikuje rejestratora zarządzania interfejsem API.
...
Aktualizuje określoną wersję interfejsu API.
...
Umożliwia skonfigurowanie bramy zarządzania interfejsu API.
