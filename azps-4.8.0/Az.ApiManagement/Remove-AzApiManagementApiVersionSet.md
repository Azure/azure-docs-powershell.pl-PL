...
Polecenie cmdlet **Remove-AzAzureRmApiManagementApiVersionSet** umożliwia usunięcie zestawu wersji interfejsu API.

## Przykłady

### Przykład 1: usuwanie zestawu wersji interfejsu API
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementApiVersionSet -Context $apimContext -ApiVersionSetId "query-param-set"
```

To polecenie usuwa zestaw wersji interfejsu API z określonym ApiVersionSetId.

## PARAMETRÓW

### -ApiVersionSetId
Identyfikator zestawu wersji interfejsu API.
...
### -ResourceId
Identyfikator zasobu ARM ApiVersionSet. Ten parametr jest wymagany.
