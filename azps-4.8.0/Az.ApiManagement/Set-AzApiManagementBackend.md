...
### Przykład 1: aktualizuje opis wewnętrznej bazy danych 123
```powershell
...
Umożliwia zaktualizowanie wewnętrznej bazy danych. (autogenerowana)
...
### -Inputobject
Wystąpienie PsApiManagementBackend. Ten parametr jest wymagany.
