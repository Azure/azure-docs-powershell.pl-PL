...
### Przykład 4: Importowanie interfejsu API z łącza Open API
```powershell
...
To polecenie importuje interfejs API z określonego linku specyfikacji Open 3,0.

### Przykład 5: Importowanie interfejsu API z łącza Open API do zestawu ApiVersion
...
To polecenie importuje interfejs API z określonego dokumentu specyfikacji Open 3,0 i tworzy nowy ApiVersion.
...
### -Protocol (protokół)
Protokoły API sieci Web (http, https). Protokoły, w których udostępniono interfejs API. Ten parametr jest opcjonalny. Jeśli przewidziano, zastąpi protokoły określone w dokumencie specyfikacje.
...
### -ServiceUrl
Adres URL usługi sieci Web, która uwidacznia interfejs API. Ten adres URL będzie wykorzystany tylko przez funkcję zarządzania interfejsem Azure API i nie zostanie udostępniony publicznie. Ten parametr jest opcjonalny. Jeśli to pole zastąpi ServiceUrl określone w dokumencie specyfikacji.
