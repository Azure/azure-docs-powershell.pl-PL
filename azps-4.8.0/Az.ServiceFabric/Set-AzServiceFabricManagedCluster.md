...
Zaktualizuj nazwę DNS i port połączenia klienta dla klastra przy użyciu połączeń rurowych.
...
Port służący do połączeń klientów z klastrem. Wartość domyślna: 19000.
...
### -CodeVersion
Wersja kodu klastra. Używaj tylko trybu uaktualniania ręcznego.
...
Port służący do połączeń HTTP z klastrem. Wartość domyślna: 19080.
...
### -ResourceId
Identyfikator zarządzanego zasobu klastra
...
### -Upgrademode
Tryb uaktualniania wersji kodu klastra. Automatyczne lub ręczne.
