...
## Opis
Polecenie cmdlet **New-AzDataShareDataSet** umożliwia dodanie zestawów danych w usłudze Azure Data Share dla konta udziału danych. Możesz dodać zestawy danych typu BLOB, ADLS Gen2 i ADLS Gen1.
...
To polecenie umożliwia dodanie zestawu danych o nazwie AdsDataSet w kontenerze typu BLOB do usługi Azure Data Share AdsShare.
...
### -AdlsGen1FolderPath
Ścieżka folderu usługi Azure Storage ADLS Gen1
...
### -FileName
Usługa Azure Storage ADLS Gen1 nazwa pliku
...
### -FilePath
Ścieżka do pliku magazynu platformy Azure
...
### — System plików
Nazwa systemu plików usługi Azure ADLS Gen2
...
### -Name (nazwa)
Nazwa zestawu danych platformy Azure
...
Identyfikator zasobu konta usługi Azure Storage
