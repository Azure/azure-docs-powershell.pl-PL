...
### Przykład 1: aktualizowanie rozmiaru klastra według nazwy
```powershell
...
Aktualizowanie rozmiaru klastra według nazwy

### Przykład 2: aktualizowanie rozmiaru klastra według obiektu wejścia
```powershell
...
Aktualizowanie rozmiaru klastra według obiektu wejścia
