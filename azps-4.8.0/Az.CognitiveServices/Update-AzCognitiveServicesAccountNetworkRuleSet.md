...
## Opis
Polecenie cmdlet **Update-AzCognitiveServicesAccountNetworkRuleSet** aktualizuje właściwość NetworkRule konta usług poznawczych
...
### Przykład 3: porządkowanie reguł NetworkRule z usług poznawczych
```
...
To polecenie czyści reguły NetworkRuleego konta usług poznawczych (inne właściwości nie zmieniają się).

## PARAMETRÓW

### -DefaultAction
Konto usług poznawczych NetworkRule DefaultAction. Wartość domyślna `Deny` .
...
### -IpRule
Konto usług poznawczych NetworkRule IpRules.
...
### -VirtualNetworkRule
Konto usług poznawczych NetworkRule VirtualNetworkRules.
