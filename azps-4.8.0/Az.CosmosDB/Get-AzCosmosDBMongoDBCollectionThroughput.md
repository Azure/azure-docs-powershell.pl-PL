...
## STRESZCZENIe
Pobiera właściwości przepływności CosmosDB kolekcji MongoDB.
...
## Opis
Polecenie cmdlet **Get-AzCosmosDBMongoDBCollectionThroughput** pobiera właściwości przepływności kolekcji MongoDB.
...
### -Inputobject
Jeśli ta funkcja zostanie dostarczona, polecenie cmdlet zwróci kolekcję z odpowiednią wartością przepustowości.
