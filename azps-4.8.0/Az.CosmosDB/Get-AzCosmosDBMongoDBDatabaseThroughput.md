...
## STRESZCZENIe
Pobiera właściwości przepływności CosmosDB bazy danych MongoDB.
...
## Opis
Polecenie cmdlet **Get-AzCosmosDBMongoDBDatabaseThroughput** pobiera właściwości przepływności bazy danych MongoDB.
