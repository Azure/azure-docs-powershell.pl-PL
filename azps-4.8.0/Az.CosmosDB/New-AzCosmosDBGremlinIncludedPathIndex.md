...
## STRESZCZENIe
Tworzy nowy obiekt typu PSIndexes. Może on zostać przekazany jako wartość parametru w parametrze Set-AzCosmosDBGremlinIncludedPath.
...
## Opis
Obiekt odpowiadający indeksom IncludedPath's interfejsu API Gremlin.
