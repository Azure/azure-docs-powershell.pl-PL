...
## Opis
Edytowanie trasy. Możesz zaktualizować wszystkie pola w marszrucie, w tym źródło danych, punkt końcowy, zapytanie routingu, a także włączyć lub wyłączyć trasę.
...
Aktualizowanie informacji o marszrucie.
...
### -Warunek
Warunek, który ma zostać oceniony w celu zastosowania reguły routingu
