...
### -Próbkowanie
Umożliwia włączenie i wyłączenie próbkowania dla śledzenia rozproszonego.
...
### -SamplingRate
Umożliwia określenie liczby wiadomości próbkowanych w celu dodania kontekstu śledzenia.
Ta wartość jest wartością procentową.
Dozwolone są tylko wartości z przedziału od 0 do 100 (włącznie).
