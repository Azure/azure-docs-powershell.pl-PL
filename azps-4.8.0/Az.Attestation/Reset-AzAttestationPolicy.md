...
## Opis
Polecenie cmdlet Reset-AzAttestationPolicy resetuje zasady zaświadczania zdefiniowane przez użytkownika od dzierżawy w zaświadczeniu platformy Azure.
...
Przywróć domyślną zasadę dla *Pshtest* dostawcy zaświadczania dla typu tee *SgxEnclave*.
...
Jeśli *Pshtest* dostawcy zaświadczania jest skonfigurowany do korzystania z izolowanego modelu zaufania, Przywróć domyślną zasadę dla typu tee *SgxEnclave* , dołączając zasady podpisane.
...
To polecenie cmdlet resetuje zasady zaświadczania dla dzierżawy, którą ten parametr określa.
...
### -Policy
Określa token internetowy JSON opisujący dokument zasad do zresetowania.
...
Obsługujemy cztery typy środowiska: SgxEnclave, OpenEnclave, CyResComponent i VBSEnclave.
