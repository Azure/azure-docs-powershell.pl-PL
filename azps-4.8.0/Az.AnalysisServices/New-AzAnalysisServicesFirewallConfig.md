...
## Opis
New-AzAnalysisServicesFirewallConfig tworzy nowy obiekt konfiguracji zapory
...
Tworzy obiekt konfiguracji zapory z dwiema regułami, a ponadto umożliwia dostęp z usługi Power BI.
...
Flaga wskazująca, czy zapora zezwala na dostęp z usługi Power BI
...
### System. Collections. Generic. list "1 [[Microsoft. Azure. Commands. AnalysisServices. MODELES. PsAzureAnalysisServicesFirewallRule, Microsoft. Azure. PowerShell. cmdlets. AnalysisServices, Version = 1.0.0.0, Culture = neutral, PublicKeyToken = null]]
