...
## Opis
Tworzy obiekt typu źródło.
Ten obiekt ma zostać przekazany do polecenia, które tworzy regułę alertu dziennika
...
Tworzy obiekt typu źródło. (autogenerowana)
...
### -DataSourceId
Źródło danych, w którym jest tworzony ten alert
