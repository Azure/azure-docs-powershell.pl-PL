...
### ListSignalRServiceParameterSet (domyślny)
```
...
### Uzyskiwanie wszystkich usług sygnalizacji w ramach subskrypcji
```
PS C:\> Get-AzSignalR
...
### Uzyskiwanie wszystkich usług sygnalizacji w grupie zasobów
```
...
### Uzyskaj określoną usługę sygnalizującą
```
...
### Uzyskiwanie określonej usługi sygnalizującego z domyślnej grupy zasobów
```
...
Domyślną grupę zasobów można ustawić przez \` Set-AzDefault-ResourceGroupName moja zasobów \` .
