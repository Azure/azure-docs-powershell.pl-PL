...
## Opis
Polecenie cmdlet **Start-AzRecoveryServicesAsrUnplannedFailoverJob** rozpoczyna nieplanowane przejście w tryb pracy awaryjnej w trybie failover replikacji odzyskiwania witryny platformy Azure lub planu odzyskiwania.
...
Rozpoczyna nieplanowaną operację pracy awaryjnej dla planu odzyskiwania z określonymi parametrami i zwraca zadanie ASR używane do śledzenia operacji.

### Przykład 2

Rozpoczyna nieplanowaną operację pracy awaryjnej. (autogenerowana)
