...
Pierwsze polecenie pobiera odpowiedni magazyn. Drugie polecenie pobiera tablicę nieudanych zadań w magazynie, a następnie zapisuje je w tablicy $Jobs.
W trzecim poleceniu są dostępne szczegóły zadania dla pierwszego zadania zakończonego niepowodzeniem w $Jobs, a następnie są one przechowywane w zmiennej $JobDetails.
