...
## Opis
Polecenie cmdlet **Update-AzRecoveryServicesAsrProtectionDirection** aktualizuje kierunek replikacji określonego obiektu odzyskiwania witryny platformy Azure po zakończeniu operacji zatwierdzania trybu failover.
...
Uruchamianie operacji zmiany kierunku aktualizacji dla określonego chronionego elementu replikacji zaszyfrowanej w docelowym regionie platformy Azure zdefiniowanym przez mapowanie kontenera ochrony i dostarczoną konfiguracją replikacji dysku.
...
Uruchamianie operacji zmiany kierunku aktualizacji dla określonego elementu chronionego replikacji w docelowym regionie platformy Azure zdefiniowanym przez mapowanie kontenera ochrony i korzystanie z przestrzeni dyskowej w pamięci podręcznej (w tym samym regionie co maszyna wirtualna) i grupy umieszczania zbliżeniowe.
...
Określa konfigurację dysku dla odzyskiwania po awarii.
...
### -AzureToVMware
Określa scenariusz przełączenia platformy Azure na vMWare.
...
### -KeyEncryptionKeyUrl
Określa adres URL klucza szyfrowania dysku (szyfrowanie dysków Azure), który ma być wykorzystywany do odzyskiwania maszyny wirtualnej po przełączeniu do trybu failover.
...
Identyfikator zasobu grupy położenia usługi zbliżeniowej w celu przejścia do trybu failover tej maszyny wirtualnej.
