...
## Opis
Polecenie cmdlet **Update-AzRecoveryServicesAsrPolicy** aktualizuje określone zasady replikacji odzyskiwania witryny platformy Azure.
...
Rozpoczyna operację aktualizowania zasad replikacji platformy Azure do platformy Azure przy użyciu określonych parametrów i zwraca zadanie ASR używane do śledzenia operacji.
...
Uruchamia zasady replikacji usługi Azure to Azure przy użyciu określonych parametrów i zwraca zadanie ASR używane do śledzenia operacji.
...
### -AzureToAzure
Określa odzyskiwanie na platformie Azure po awarii.
...
### -AzureToVMware
Określa odzyskiwanie platformy Azure do programu vMWare po awarii.
...
### -HyperVToAzure
Parametr Switch wskazujący, że określone zasady są używane do replikowania maszyn wirtualnych funkcji Hyper-V na platformie Azure.
...
Określa identyfikator konta usługi Azure Storage dla lokalizacji docelowej replikacji. Używane jako docelowe konto magazynu do replikacji, jeśli nie podano elementu alternatywnego podczas włączania replikacji przy użyciu polecenia cmdlet New-AzRecoveryServicesASRReplicationProtectedItem.
...
Czas w godzinach na zachowanie punktów odzyskiwania po utworzeniu.
...
### -VmmToVmm
Parametr Switch wskazujący, że określone zasady są używane do replikowania maszyn wirtualnych funkcji Hyper-V zarządzanych przez program VMM między dwiema lokacjami funkcji Hyper-V.
...
### -VMwareToAzure
Parametr Switch wskazujący, że określone zasady są używane do replikowania maszyn wirtualnych VMware na platformie Azure.
