...
## Opis
Polecenie cmdlet **New-AzDeploymentManagerService** tworzy usługę w ramach topologii usług i zwraca obiekt reprezentujący tę usługę.
Określ usługę za pomocą jej nazwy, topologii usługi i nazwy grupy zasobów. 

Polecenie cmdlet zwraca obiekt usługi. Możesz zmodyfikować ten obiekt lokalnie, a następnie zastosować zmiany w usłudze za pomocą polecenia cmdlet Set-AzDeploymentManagerService.
