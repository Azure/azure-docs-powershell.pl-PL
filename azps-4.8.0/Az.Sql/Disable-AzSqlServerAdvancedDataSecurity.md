...
## Opis
Polecenie cmdlet **disable-AzSqlServerAdvancedDataSecurity** wyłącza zaawansowane zabezpieczenia danych na serwerze.

## Przykłady

### Przykład 1
### Przykład 2: wyłączenie zaawansowanych zabezpieczeń danych serwera
```powershell
...
### Przykład 3: wyłączenie zaawansowanego zabezpieczenia danych serwera na podstawie zasobu serwera
```powershell
