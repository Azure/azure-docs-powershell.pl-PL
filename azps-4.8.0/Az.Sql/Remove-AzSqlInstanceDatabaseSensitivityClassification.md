...
## Opis
Polecenie cmdlet Remove-AzSqlInstanceDatabaseSensitivityClassification usuwa typy informacji oraz etykiety liter kolumn w bazie danych wystąpienia zarządzanego SQL Azure.

## Przykłady

### Przykład 1: usuwanie typu informacji i etykiety wrażliwości kolumny w bazie danych wystąpienia zarządzanego SQL Azure.
```powershell
...
### Przykład 2: usuwanie bieżących typów informacji i etykiet liter kolumn w bazie danych wystąpień zarządzanych SQL Azure z potokiem.
```powershell
...
### Przykład 3: usuwanie typu informacji i etykiety wrażliwości kolumny w bazie danych wystąpienia zarządzanego SQL Azure z potokiem.
```powershell
