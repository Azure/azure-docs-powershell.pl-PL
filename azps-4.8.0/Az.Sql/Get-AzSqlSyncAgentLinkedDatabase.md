...
## Opis
Polecenie cmdlet **Get-AzSqlSyncAgentLinkedDatabase** zwraca informacje o bazach danych programu SQL Server połączonych z agentem synchronizacji.

## Przykłady

### Przykład 1: uzyskiwanie połączonych baz danych programu SQL Server dla agenta synchronizacji usługi Azure SQL.

W poniższym przykładzie jest zwracana połączona baza danych programu SQL Server, która jest połączona z agentem synchronizacji usługi Azure SQL.
