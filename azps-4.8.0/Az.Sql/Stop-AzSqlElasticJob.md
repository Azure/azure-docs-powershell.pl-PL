...
## Opis
Polecenie cmdlet Stop-AzSqlElasticJob zatrzymuje zadanie z uruchomionym wykonaniem.
Zwraca bieżący stan wykonania zadania.

## Przykłady

### Przykład 1: zatrzymuje zadanie z uruchomionym wykonaniem zadania
```powershell
...
Zatrzymuje uruchomione zadanie wykonania zadania i zwraca jego bieżący stan.
