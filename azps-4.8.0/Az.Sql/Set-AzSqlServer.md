...
## Opis
Polecenie cmdlet **Set-AzSqlServer** modyfikuje właściwości serwera bazy danych Azure SQL.
...
Modyfikuje właściwości serwera bazy danych SQL. (autogenerowana)
...
### -MinimalTlsVersion
Wersja minimalnego szyfrowania TLS do wymuszania dla programu SQL Server
...
### -PublicNetworkAccess
Umożliwia określenie, czy dostęp do serwera jest dozwolony w sieci publicznej, czy jest włączony i wyłączony.
Po wyłączeniu tego serwera mogą się łączyć tylko połączenia realizowane za pośrednictwem linków prywatnych.
