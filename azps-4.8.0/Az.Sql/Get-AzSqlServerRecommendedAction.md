...
## Opis
Polecenie cmdlet **Get-AzSqlServerRecommendedAction** umożliwia wykonanie jednej lub wielu zalecanych akcji dla usługi Azure SQL Server Advisor.

## Przykłady

### Przykład 1: Wyświetlanie listy wszystkich zalecanych akcji dla konkretnego klasyfikatora
```
...
To polecenie powoduje wyświetlenie listy wszystkich zalecanych akcji dotyczących usługi SQL Server Advisor o nazwie Moja indeks dostępnego dla serwera o nazwie Wi-Runner-Australia-wschód.

### Przykład 2: Uzyskaj jedną zalecaną akcję dla klasyfikatora
```
...
To polecenie uzyskuje zalecaną akcję o nazwie IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893 od klasyfikatora o nazwie Moja indeks.

## PARAMETRÓW

### -Klasyfikatorname
Określa nazwę klasyfikatora, dla którego to polecenie cmdlet żąda akcji.
...
Określa nazwę zalecanej akcji, która ma być pobierana przez to polecenie cmdlet.
...
### -ResourceGroupName
Określa nazwę grupy zasobów serwera, która zawiera ten serwer.
...
### -Nazwa_serwera
Określa nazwę serwera, do którego należy klasyfikator.
