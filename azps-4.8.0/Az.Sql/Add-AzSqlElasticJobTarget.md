...
## Opis
Polecenie cmdlet Add-AzSqlElasticJobTarget Dodawanie zasobu docelowego do grupy docelowej
...
### Przykład 3: Dodawanie elementu docelowego puli elastycznej
```powershell
...
### Przykład 4: Dodawanie obiektu docelowego mapy Shard
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Dodaje docelową (serwerową, elastyczną pulę, bazę danych i mapę Shard) do grupy docelowej.
