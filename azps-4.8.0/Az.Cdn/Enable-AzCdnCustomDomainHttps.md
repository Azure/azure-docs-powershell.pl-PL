...
## Opis
Polecenie cmdlet **enable-AzCdnCustomDomainHttps** włącza zabezpieczoną dostawę https domeny NIESTANDARDOWEJ usługi CDN.
...
Włącz Zabezpieczanie dostarczania domeny niestandardowej.

## PARAMETRÓW

### -CustomDomainName
Nazwa wyświetlana domeny niestandardowej usługi Azure CDN.
...
### -ResourceId
Identyfikator zasobu domeny niestandardowej
