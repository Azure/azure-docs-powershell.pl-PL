...
### Przykład 1: Tworzenie configuation dla Kubernetes klastra
```powershell
...
To polecenie tworzy configuation dla Kubernetes klastra.
...
### -ClusterScoped
Jeśli przekazano, Ustaw zakres konfiguracji na klaster (domyślnie jest to obszar nazw).
...
### -EnableHelmOperator
Opcja umożliwiająca włączenie operatora Helm dla tej konfiguracji git.
...
Przesłonięcie wartości dla wykresu Helm dla operatorów.
...
Nazwa wystąpienia operatora — identyfikująca określoną konfigurację.
...
### -OperatorNamespace
Obszar nazw, do którego jest zainstalowany ten operator.
Maksymalnie 253 małych znaków alfanumerycznych, łączników i tylko okresów.
...
### -OperatorParameters
Wszystkie parametry wystąpienia operatora w formacie String.
