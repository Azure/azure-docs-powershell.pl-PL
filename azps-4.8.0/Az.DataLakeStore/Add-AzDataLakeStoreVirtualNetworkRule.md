...
## Opis
Polecenie cmdlet **Add-AzDataLakeStoreVirtualNetworkRule** umożliwia dodanie reguły sieci wirtualnej do określonego konta usługi Data Lake Store.
...
Spowoduje to utworzenie nowej reguły sieci wirtualnej o nazwie "myVNET" w koncie "DLS" z identyfikatorem podsieci "testId".

## PARAMETRÓW

### — Konto
Konto usługi Data Lake Store umożliwiające dodanie reguły sieci wirtualnej do
...
### -SubnetId
SubnetId reguły sieci wirtualnej
