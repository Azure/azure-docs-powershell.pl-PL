...
### -IdentityType
Typ tożsamości, wartość może być wartością "SystemAssigned", "none".
...
### — Lokalizacja
Region geograficzny, w którym klaster zostanie wdrożony.
...
### -SkuCapacity
Pojemność SKU, wartość musi być wielokrotnością 100 i zakresem 1000-2000.
