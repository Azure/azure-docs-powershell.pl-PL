...
Łączenie klastra dla obszaru roboczego
...
### -ResourceId
Identyfikator zasobu zasobu, który zostanie połączony z obszarem roboczym.
Należy go użyć do łączenia zasobów wymagających dostępu do odczytu.
...
Identyfikator zasobu zasobu, który zostanie połączony z obszarem roboczym.
Należy go użyć do łączenia zasobów wymagających uprawnień do zapisu.
Klaster musi mieć stan inicjowania obsługi "zakończony powodzeniem" i prawidłowe właściwości magazynu.
