...
## Opis
Polecenie cmdlet **New-AzDataBoxEdgeStorageAccount** tworzy nowe konto magazynu Edge na urządzeniu z danymi na krawędziach pola danych. W przypadku urządzenia jedna krawędź konta magazynu może być mapowana tylko na jedno konto w chmurze.
...
2 EdgeStorageAccounts na urządzeniu nie można udostępnić więcej niż 1 konta w chmurze
...
### — Chmura
W przypadku warstw będzie używana CloudStorageAccount
