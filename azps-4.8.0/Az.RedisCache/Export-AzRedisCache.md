...
## Opis
Polecenie cmdlet **Export-AzRedisCache** eksportuje dane z pamięci podręcznej Azure Redis do kontenera.

## Przykłady

### Przykład 1. Eksportowanie danych
```
...
### -Prefix
Określa prefiks, którego należy użyć w przypadku nazw obiektów BLOB.
