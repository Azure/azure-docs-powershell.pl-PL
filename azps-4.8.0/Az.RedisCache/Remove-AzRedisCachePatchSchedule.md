...
## Opis
Polecenie cmdlet **Remove-AzRedisCachePatchSchedule** usuwa harmonogram poprawek z pamięci podręcznej w pamięci podręcznej platformy Azure Redis.

## Przykłady

### Przykład 1: Usuwanie harmonogramu poprawek
```
