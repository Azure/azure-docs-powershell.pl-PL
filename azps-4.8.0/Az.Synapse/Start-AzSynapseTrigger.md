...
## Opis
Polecenie cmdlet **Start-AzSynapseTrigger** rozpoczyna wyzwalacz w obszarze roboczym. Jeśli wyzwalacz jest w stanie "zatrzymany", polecenie cmdlet rozpoczyna wyzwalacz i po pewnym czasie wywoła potoki na podstawie jego definicji. Jeśli wyzwalacz jest już w stanie "uruchomiony", to polecenie cmdlet nie ma żadnego wpływu.
...
Uruchamia wyzwalacz o nazwie ContosoTrigger w obszarze roboczym ContosoWorkspace.
...
Uruchamia wyzwalacz o nazwie ContosoTrigger w obszarze roboczym ContosoWorkspace za pośrednictwem rurociągu.
