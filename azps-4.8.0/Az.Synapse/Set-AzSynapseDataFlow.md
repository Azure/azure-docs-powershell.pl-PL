...
## Opis
Polecenie cmdlet **Set-AzSynapseDataFlow** umożliwia utworzenie przepływu danych lub zaktualizowanie istniejącego przepływu danych w obszarze roboczym.
...
To polecenie tworzy przepływ danych o nazwie ContosoDataFlow w obszarze roboczym o nazwie ContosoWorkspace.
Polecenie opiera się na przeniesieniu przepływu danych na informacjach w DataFlow.jspliku.
