...
### RunSparkStatementByCodePathParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **Invoke-AzSynapseSparkStatement** wywołuje instrukcję Synapse Analytics Spark.
...
Te polecenia rozpoczynają sesję platformy Spark, a następnie wywołują wbudowaną instrukcję Spark za pomocą potoku.
...
Te polecenia rozpoczynają sesję platformy Spark, a następnie wywołują wbudowaną instrukcję Spark.
...
Te polecenia rozpoczynają sesję platformy Spark, a następnie wywołują instrukcje programu Spark w pliku.
...
### -FilePath
Określa ścieżkę pliku lokalnego zawierającą kod wykonania.
...
### -Response
Wskazuje, że należy zwrócić pełną odpowiedź.
