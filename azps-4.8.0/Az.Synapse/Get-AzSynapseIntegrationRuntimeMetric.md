...
## Opis
Polecenie cmdlet **Get-AzSynapseIntegrationRuntimeMetric** pobiera dane metryki dotyczące środowiska uruchomieniowego integracji w obszarze roboczym.
...
To polecenie wyświetla dane metryczne dotyczące środowiska wykonawczego integracji o nazwie "test-SelfHost-IR" w obszarze roboczym o nazwie ContosoWorkspace.
