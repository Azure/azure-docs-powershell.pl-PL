...
### GetSparkStatementsByIdParameterSet (domyślny)
```
...
To polecenie pobiera wszystkie instrukcje usługi Spark w ramach sesji usługi Spark.
...
To polecenie pobiera instrukcję Spark z określonym IDENTYFIKATORem livy.
...
To polecenie pobiera wszystkie instrukcje usługi Spark w sesji Spark za pośrednictwem rurociągu.
