...
## Opis
Polecenie cmdlet **New-AzSynapseFirewallRule** tworzy regułę zapory Azure Synapse Analytics.
...
To polecenie tworzy regułę zapory o nazwie ContosoFirewallRule w obszarze roboczym ContosoWorkspace z nazwą ContosoFirewallRule.
...
To polecenie tworzy regułę zapory o nazwie ContosoFirewallRule w obszarze roboczym za pośrednictwem rurociągu.
...
To polecenie tworzy regułę zapory zezwalającą na wszystkie adresy IP usługi Azure w obszarze roboczym.

## PARAMETRÓW

### -AllowAllAzureIP
Umożliwia utworzenie specjalnej reguły zapory, która umożliwia dostęp do wszystkich adresów IP platformy Azure.
...
Musi być większe lub równe startIpAddress.
...
### -StartIpAddress
Początkowy adres IP reguły zapory.
Musi to być format IPv4.
