...
Użyj polecenia cmdlet "New-AzFrontDoorRulesEngineActionObject", aby utworzyć obiekt PSRulesEngineAction w celu przekazania go do parametru "-Action".
Użyj polecenia cmdlet "New-AzFrontDoorRulesEngineMatchConditionObject", aby utworzyć obiekt PSRulesEngineMatchCondition w celu przekazania go do parametru "-MatchCondition".
...
Utwórz nowy obiekt PSRulesEngineRule, aby pokazać, jak wyświetlić pola.
...
Oczekiwanie danych wyjściowych podczas przechodzenia do nieprawidłowej wartości priorytetu.

## PARAMETRÓW

### -Action
Akcje, które należy wykonać na żądanie i odpowiedź, jeśli wszystkie warunki zgodności zostaną spełnione.
...
### -MatchCondition
Lista warunków zgodności, które muszą zostać spełnione w celu uruchomienia akcji tej reguły. Brak zgodnych warunków oznacza, że akcje będą zawsze uruchamiane.
...
Jeśli ta reguła jest zgodna, jeśli aparat reguł nadal uruchamia pozostałe reguły lub Zatrzymaj.
Możliwe wartości są kontynuowane i zatrzymane.
Jeśli nie jest obecny, domyślnie jest to kontynuacja.
