...
## Opis
Polecenie cmdlet **Get-AzStackEdgeUser** wyświetla listę użytkowników skonfigurowanych dla urządzenia z krawędzią stosu. Aby uzyskać szczegółowe informacje o konkretnym użytkowniku, możesz podać nazwę w polu parametry.
