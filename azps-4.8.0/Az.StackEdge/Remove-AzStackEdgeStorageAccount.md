...
## Opis
Polecenie cmdlet **Remove-AzStackEdgeStorageAccount** usuwa powiązane konto magazynu z Edge na urządzeniu z krawędzią stosu. Możesz określić nazwę konta magazynu granicznego, które ma zostać usunięte jako parametr w poleceniu cmdlet.
