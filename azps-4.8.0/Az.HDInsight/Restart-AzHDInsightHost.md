...
## Opis
To polecenie cmdlet **restart-AzHDInsightHost** uruchamia ponownie określone hosty klastra usługi HDInsight.
...
To polecenie powoduje ponowne uruchomienie dwóch hostów klastra: worknode1, worknode2.
...
To polecenie pokazuje, jak współpracować z poleceniem cmdlet "Get-AzHDInsightHost".
...
Pobiera lub ustawia nazwę hosta.
...
### System. Collections. Generic. IList ' 1 [[Microsoft. Azure. Commands. HDInsight. MODELES. Management. AzureHDInsightHostInfo, Microsoft. Azure. PowerShell. cmdlet. HDInsight, Version = 3.2.0.0, Culture = neutral, PublicKeyToken = null]]
