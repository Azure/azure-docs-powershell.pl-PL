...
## Opis
Polecenie cmdlet **Remove-AzHDInsightClusterAutoscaleConfiguration** usuwa konfigurację autoskalowania klastra usługi HDInsight.

## Przykłady

### Przykład 1: Usunięcie konfiguracji autoskalowania klastra usługi HDInsight.
```powershell
...
To polecenie powoduje usunięcie konfiguracji autoskalowania klastra usługi HDInsight.
