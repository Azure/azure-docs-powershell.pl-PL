...
W poniższym przykładzie jest aktualizowana aplikacja sieci Web o nazwie IpRule, która należy do grupy moja grupa zasobów, aby używać konfiguracji ograniczeń dostępu witryny głównej w witrynie SCM.
