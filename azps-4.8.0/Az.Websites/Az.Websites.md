...
Pobiera ustawienia ograniczeń dostępu w aplikacji Azure Web App.

### [Update-AzWebAppAccessRestrictionConfig](Update-AzWebAppAccessRestrictionConfig.md)
Aktualizowanie konfiguracji dziedziczenia witryny SCM dla aplikacji Azure Web App.

### [Dodaj-AzWebAppAccessRestrictionRule](Add-AzWebAppAccessRestrictionRule.md)
Dodaje ograniczenie dostępu do aplikacji Azure Web App.

### [Remove-AzWebAppAccessRestrictionRule](Remove-AzWebAppAccessRestrictionRule.md)
Usuwa ograniczenie dostępu do aplikacji Azure Web App