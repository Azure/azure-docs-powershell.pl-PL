...
### CreateTemplateArtifact (domyślny)
```
...
## Opis
Utwórz nowy artefakt. Istnieją dwa sposoby tworzenia artefaktu: za pośrednictwem notacji JSON artefaktu jako pliku wejściowego lub dostarczając parametrów w tekście artefaktu. Gdy metoda JSON nie wymaga typu artefaktu, który ma zostać dostarczony w metodzie parametered, wymagane jest, aby użytkownik podał typ artefaktu za pomocą parametru-type.
...
Tworzenie nowego artefaktu za pomocą pliku JSON artefaktu.
...
Tworzenie nowego artefaktu za pomocą parametrów wbudowanych.
...
Utwórz nowy artefakt za pomocą pliku szablonu ARM.
