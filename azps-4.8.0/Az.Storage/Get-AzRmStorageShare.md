...
### Przykład 4: pobieranie udziału plików magazynu z udziałem udostępniania w bajtach
```
...
To polecenie pobiera udział plików magazynu z nazwą konta magazynu i nazwą udziału oraz uwzględnia użycie udostępniania w bajtach.

### Przykład 5: wyświetlanie wszystkich udziałów plików magazynu na koncie magazynu z uwzględnieniem usuniętych udziałów
```
...
To polecenie wyświetla listę wszystkich udziałów plików magazynu obejmującą usunięte udziały konta magazynu z nazwą konta magazynu.
...
### -GetShareUsage
Określ ten parametr, aby uzyskać użycie udziałów w bajtach.
...
### -IncludeDeleted
Uwzględnij usunięte akcje, domyślnie udziały list nie będą obejmować akcji usuniętych
