...
## Opis
Polecenie cmdlet **Get-AzStorageContainer** zawiera listę kontenerów magazynu skojarzonych z kontem magazynu na platformie Azure.
...
Uprawnienia kontenera nie zostaną pobrane, gdy użyjesz kontekstu magazynu utworzonego na podstawie tokenu SAS, ponieważ uprawnienia kontenera kwerendy wymagają uprawnień klucza konta magazynu.
