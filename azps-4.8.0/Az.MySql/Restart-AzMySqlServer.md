...
### Przykład 1: ponowne uruchamianie serwera MySql według grupy zasobów i nazwy serwera
```powershell
PS C:\> Restart-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

To polecenie cmdlet powoduje ponowne uruchomienie serwera MySql według grupy zasobów i nazwy serwera.

### Przykład 2: ponowne uruchomienie serwera MySql według tożsamości
```powershell
...
Te polecenia cmdlet uruchamiają ponownie serwer MySql przez tożsamość.
