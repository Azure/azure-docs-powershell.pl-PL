...
### Przykład 1: Aktualizacja reguły sieci wirtualnej MySql według nazwy
```powershell
...
To polecenie cmdlet powoduje zaktualizowanie reguły sieci wirtualnej MySql według nazwy.

### Przykład 2: aktualizowanie reguły sieci wirtualnej MySql według tożsamości.
```powershell
...
Te polecenia cmdlet aktualizują regułę sieci wirtualnej MySql według tożsamości.
