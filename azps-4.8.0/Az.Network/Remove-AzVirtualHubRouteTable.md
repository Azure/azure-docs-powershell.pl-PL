...
### ByVirtualHubRouteTableName (domyślny)
```
...
## Opis
Usuwa określoną tabelę tras skojarzoną z określonym koncentratorem wirtualnym.
...
To polecenie usuwa routeTable1 wirtualnego centrum westushub.
...
### -Inputobject
Zasób virtualhubroutetable do usunięcia.
...
### -ResourceId
Identyfikator zasobu virtualhubroutetable, który ma zostać usunięty.
