...
New-AzVpnGateway tworzy skalowalną bramę VPN. Jest to programowa łączność między oprogramowaniem na potrzeby połączeń z witrynami w VirtualHub. 

Ta brama zmienia rozmiar i skaluje się na podstawie jednostki skali określonej w tym lub Set-AzVpnGateway polecenia cmdlet. 

Połączenie jest konfigurowane na podstawie filii/witryny nazywanej VPNSite do bramy skalowalnej. Każde połączenie składa się z 2 Active-Active tuneli.

VpnGateway będzie w tym samym miejscu, w którym znajduje się VirtualHub.
