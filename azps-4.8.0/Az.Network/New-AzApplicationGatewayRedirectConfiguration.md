...
## Opis
Polecenie cmdlet **New-AzApplicationGatewayRedirectConfiguration** umożliwia utworzenie konfiguracji przekierowywania dla bramy aplikacji.
...
Tworzy konfigurację przekierowania dla bramy aplikacji. (autogenerowana)
