...
## Opis
Polecenie cmdlet **Set-AzExpressRoutePort** zapisuje zmodyfikowane ExpressRoutePort na platformie Azure.
...
Modyfikuje stan administratora linku ExpressRoutePort
