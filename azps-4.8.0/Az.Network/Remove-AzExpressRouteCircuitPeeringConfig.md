...
## Opis
Polecenie cmdlet **Remove-AzExpressRouteCircuitPeeringConfig** umożliwia usunięcie konfiguracji komunikacji równorzędnej ExpressRoute obwodu.

## Przykłady

### Przykład 1: Usuwanie konfiguracji komunikacji równorzędnej ze obwodu ExpressRoute
```
