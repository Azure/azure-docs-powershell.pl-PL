...
## Opis
Polecenie cmdlet **Remove-AzHpcCache** usuwa pamięć podręczną usługi Azure HPC.
...
### -Force
Wskazuje, że polecenie cmdlet nie monituje o potwierdzenie. Domyślnie to polecenie cmdlet monituje o potwierdzenie zamiaru usunięcia pamięci podręcznej.
...
### -ResourceGroupName
Nazwa grupy zasobów, w której ma zostać usunięta pamięć podręczna.
