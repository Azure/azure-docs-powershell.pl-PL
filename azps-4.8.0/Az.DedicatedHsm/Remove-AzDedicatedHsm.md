...
### Przykład 1: usuwanie dedykowanego modułu HSM według nazwy
```powershell
PS C:\> Remove-AzDedicatedHsm -Name hsm-7t2xaf -ResourceGroupName lucas-manual-test

```

Ta commnad usuwa sprzętowy moduł zabezpieczeń (HSM) według nazwy.
...
Ten commnad usuwa dedykowany obiekt HSM.
