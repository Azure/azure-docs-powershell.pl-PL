...
### Przykład 1: wyświetlanie wszystkich konfiguracji na serwerze PostgreSql
```powershell
...
To polecenie cmdlet wyświetla wszystkie konfiguracje określone na serwerze PostgreSql.

### Przykład 2: Uzyskaj określoną konfigurację PostgreSql według nazwy
```powershell
...
To polecenie cmdlet pobiera określoną konfigurację PostgreSql według nazwy.
