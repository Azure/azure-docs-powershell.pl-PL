...
### Przykład 1: aktualizowanie reguły sieci wirtualnej PostgreSql według nazwy
```powershell
...
To polecenie cmdlet aktualizuje PostgreSql sieci wirtualnej według nazwy.
...
Te polecenia cmdlet aktualizują regułę sieci wirtualnej PostgreSql według tożsamości.
...
### -SubnetId
Identyfikator zasobu ARM podsieci sieci wirtualnej.
