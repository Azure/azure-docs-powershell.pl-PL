...
## Opis
Polecenie cmdlet **New-AzIntegrationAccountAgreement** umożliwia utworzenie umowy dotyczącej konta integracji.
To polecenie cmdlet zwraca obiekt reprezentujący umowę dotyczącą konta integracji.
Określ nazwę konta integracji, nazwę grupy zasobów, nazwę umowy, typ, nazwę partnera, kwalifikatory partnera i zawartość umowy.
...
### Przykład 1: Tworzenie umowy dotyczącej konta integracji
```powershell
...
To polecenie tworzy umowę dotyczącą konta integracji w określonej grupie zasobów platformy Azure.

### Przykład 2

Umożliwia utworzenie umowy dotyczącej konta integracji. (autogenerowana)
...
### -Agreementtype
Określa typ umowy dotyczącej konta integracji. Dopuszczalne wartości tego parametru to:
- X12 
- AS2
- Edifact
