...
## Opis
Polecenie cmdlet **Get-AzLogicAppTrigger** pobiera wyzwalacze z aplikacji logiki.
To polecenie cmdlet zwraca obiekt **WorkflowTrigger** .
Określ przepływ pracy, grupę zasobów i wyzwalacz.
...
### Przykład 1: uzyskiwanie wyzwalacza aplikacji logicznej
```
...
To polecenie pobiera wyzwalacz o nazwie Trigger01 z aplikacji logiki o nazwie LogicApp05.

### Przykład 2: uzyskiwanie wszystkich wyzwalaczy aplikacji logicznej
```
...
To polecenie pobiera wyzwalacze aplikacji logicznej o nazwie LogicApp07.
...
### -Name (nazwa)
Określa nazwę aplikacji logicznej, z poziomu której to polecenie cmdlet pobiera wyzwalacz.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, w której ten aplet polecenia pobiera wyzwalacz.
...
### -Triggername
Określa nazwę wyzwalacza, który jest pobierany przez to polecenie cmdlet.
...
### Microsoft. Azure. Management. Logic. MODELES. WorkflowTrigger
