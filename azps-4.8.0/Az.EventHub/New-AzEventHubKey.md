...
### Przykład 1: obszar_nazw-AuthorizationRule PrimaryKey
```powershell
...
### Przykład 2: EventHub — AuthorizationRule PrimaryKey
```powershell
...
### Przykład 3:-Namespace-AuthorizationRule SecondaryKey
```powershell
