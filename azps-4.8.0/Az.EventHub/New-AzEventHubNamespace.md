...
### Przykład 3: obszar nazw z włączoną Kafka
```powershell
...
### Przykład 4: obszar nazw z włączoną obsługą ZoneRedundant
```powershell
...
### Przykład 5. Tworzenie obszaru nazw za pomocą zarządzania tożsamością w klastrze 
```powershell
...
### -ClusterARMId
Identyfikator ARM klastra, w którym ma zostać utworzony obszar nazw
...
### -ZoneRedundant
Włączanie i wyłączanie nadmiarowych stref dla obszaru nazw
