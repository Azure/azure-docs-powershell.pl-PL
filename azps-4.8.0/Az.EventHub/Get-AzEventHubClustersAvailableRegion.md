...
## STRESZCZENIe
Pobiera szczegóły pojedynczego klastra Eventhub lub listy klastrów w danej grupie zasobów.
...
## Opis
Lista Get-AzEventHubClustersAvailableRegion polecenia cmdlet, w której można tworzyć dedykowane regiony.
...
Lista regionów jest zwracana w miejscu, w którym
...
### System. Collections. Generic. IEnumerable ' 1 [[Microsoft. Azure. Commands. EventHub. Framework. PSEventHubsAvailableCluster, Microsoft. Azure. PowerShell. PowerShell.. EventHub, Version = 1.5.0.0, Culture = neutral, PublicKeyToken = null]]
