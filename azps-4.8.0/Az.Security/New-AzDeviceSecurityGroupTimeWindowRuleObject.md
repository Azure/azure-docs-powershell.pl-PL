...
## Opis
Polecenie cmdlet New-AzDeviceSecurityGroupTimeWindowRuleObject służy do tworzenia nowej listy reguł alertów dotyczących okien czasu dla grupy zabezpieczeń urządzenia w rozwiązaniu bezpieczeństwa IoT.
...
Tworzenie nowej reguły dotyczącej okien czasu na podstawie typu "ActiveConnectionsNotInAllowedRange"
