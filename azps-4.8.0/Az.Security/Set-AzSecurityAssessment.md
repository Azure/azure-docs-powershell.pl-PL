...
## Opis
Tworzenie lub aktualizowanie wyniku oceny zabezpieczeń dla zasobu można użyć w celu zmiany stanu istniejącego wyniku lub dodania dodatkowych danych.
można użyć tylko w przypadku typów oceny "CustomerManaged" i tylko po utworzeniu dopasowanych metadanych oceny.
...
Oznacza wynik subskrypcji jako "niezdrowy" dla oceny typu "4FB6C0A0-1137-42C7-A1C7-4BD37C91DE8D" — więcej szczegółów dotyczących typu oceny można znaleźć pod typem assessmentMetadata

## PARAMETRÓW

### -AdditionalData
Dane, które są dołączane do wyniku oceny, w celu uzyskania lepszych wyników badań lub przejrzystości statusu.
...
### -AssessedResourceId
Pełny identyfikator zasobu, dla którego jest obliczana Ocena.
...
### -StatusCause
Progremmatic kod przyczyny wyniku oceny.
...
### -StatusCode
Kod Progremmatic dla wyniku oceny.
może mieć wartość "zdrowy", "niezdrowe" lub "NotApplicable"
...
### -StatusDescription
Zrozumiały dla człowieka opis przyczyny wyniku oceny.
...
### Microsoft. Azure. Commands. Security. MODELES. oceny. PSSecurityAssessment
