...
## Opis
Włącza lub wyłącza automatyczne ustawienia inicjowania obsługi dla subskrypcji.
Ustawienia automatycznego inicjowania obsługi pozwalają zdecydować, czy usługa Azure Security Center ma automatycznie zastrzec Agent zabezpieczeń, który zostanie zainstalowany na maszynach wirtualnych.
...
Włącza automatyczne ustawianie inicjowania obsługi dla subskrypcji.
...
Wyłącza automatyczne ustawianie inicjowania obsługi dla subskrypcji.
