...
### -FilePath
Określa ścieżkę pliku JSON zawierającego definicję zasad usługi SQL Information Protection.
...
### -Policy
Określa definicję zasad dotyczących ochrony danych SQL. Możesz określić ścieżkę pliku JSON lub ciąg formatu JSON definiujący zasady.
