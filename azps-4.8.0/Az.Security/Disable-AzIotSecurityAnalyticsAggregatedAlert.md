...
### SolutionLevelResource (domyślny)
```
...
## Opis
Polecenie cmdlet Disable-AzIotSecurityAnalyticsAggregatedAlert odrzuca określony alert aggragated na urządzeniach Centrum IoT. Nazwa zagregowanych alertów to kombinacja typu alertu i daty aggragted alertu rozdzielonej znakiem "/".
...
Odrzucanie zagregowanego alertu "IoT_SucessfulLocalLogin/2020-03-15" (nazwa połączona z typu alertu i jego zagregowaną datą) z rozwiązania zabezpieczeń IoT "Moja nazwa" w grupie zasób
...
Odrzuć zagregowany alert z identyfikatorem zasobu "/subscriptions/XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Security/iotSecuritySolutions/MySolutionName/analyticsModels/default/aggregatedAlerts/IoT_SucessfulLocalLogin/2020-03-15"
