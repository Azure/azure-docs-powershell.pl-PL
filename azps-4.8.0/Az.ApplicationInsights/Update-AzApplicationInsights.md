...
### Przykład 1 aktualizacja składnika Application Insights
```powershell
Update-AzApplicationInsights -ResourceGroupName "rgName" -Name "aiName" -PublicNetworkAccessForIngestion "Disabled" -PublicNetworkAccessForQuery "Disabled"
```

aktualizowanie składnika Application Insights "aiName" PublicNetworkAccessForIngestion/PublicNetworkAccessForQuery na "Disabled"
...
Typ dostępu do sieci służący do uzyskiwania dostępu do pokarmowania w usłudze Application Insights.
...
Typ dostępu do sieci służący do uzyskiwania dostępu do zapytania usługi Application Insights.
Wartość powinna być równa "Enabled" lub "Disabled"
...
### -RetentionInDays
Utrzymanie jest domyślnie zachowywane w dniach 90.
