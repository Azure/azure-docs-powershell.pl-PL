...
Konfiguracja poziomu subskrypcji: dla subskrypcji może istnieć tylko jedna konfiguracja tego typu. LowCpuThreshold i Exclude są jedyną właściwością tego typu konfiguracji.

Konfiguracja poziomu zasobów źródłowych: w subskrypcji może być tylko jedna konfiguracja dla każdej z nich. Funkcja wykluczania jest jedyną właściwością tego typu konfiguracji.
...
```
Pobiera listę konfiguracji usługi Azure Advisor.
