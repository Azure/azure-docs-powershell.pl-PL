...
### Przykład 1. Sprawdź dostępność nazwy połączenia danych, która jest w użyciu.
```powershell
...
Powyższe polecenie zwraca informację o tym, czy połączenie danych o nazwie "mykustodataconnection" istnieje w bazie danych "mykustodatabase".

### Przykład 2: Sprawdzanie dostępności nazwy połączenia danych, która nie jest używana
```powershell
...
Powyższe polecenie zwraca informację o tym, czy połączenie danych o nazwie "mydataconnection" istnieje w bazie danych "mykustodatabase".
...
### -Type
Typ zasobu, Microsoft. Kusto/klastry/połączenia danych.
