...
### Przykład 1. Usuń istniejącą Kusto bazy danych PrincipalAssignment według nazwy
```powershell
...
Powyższe polecenie usunie PrincipalAssignment o nazwie "kustoprincipal1" w bazie danych Kusto "mykustodatabase".
