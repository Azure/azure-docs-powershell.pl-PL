...
### Przykład 1. Sprawdź dostępność nazwy principalassignment klastra, która jest w użyciu.
```powershell
...
Powyższe polecenie zwraca informację o tym, czy w klastrze "testnewkustocluster" istnieje PrincipalAssignment o nazwie "The Principal".

### Przykład 2: Sprawdzanie dostępności principalassignment klastra nazwa, która nie jest używana
```powershell
...
Powyższe polecenie zwraca informację o tym, czy w klastrze "testnewkustocluster" istnieje PrincipalAssignment o nazwie "NewPrincipal".
...
### -Name (nazwa)
Nazwa zasobu przydziału podstawowego.
...
### -Type
Typ zasobu, Microsoft. Kusto/klastrów/principalAssignments.
...
### Microsoft. Azure. PowerShell. polecenia. Kusto. models. Api20200614. ICheckNameResult
