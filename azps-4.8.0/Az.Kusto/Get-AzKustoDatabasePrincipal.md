...
### Przykład 1: Lista podmiotów zabezpieczeń bazy danych w danym klastrze Kusto i bazie danych
```powershell
...
Powyższe polecenie zwraca listę podmiotów zabezpieczeń bazy danych danej Kusto klastra i bazy danych.
