...
### Przykład 1: Usuwanie istniejącego klastra Kusto według nazwy
```powershell
PS C:\> Remove-AzKustoCluster -ResourceGroupName testrg -Name testnewkustocluster
```

Powyższe polecenie usuwa klaster Kusto o nazwie "testnewkustocluster" w grupie zasobów "testrg".
