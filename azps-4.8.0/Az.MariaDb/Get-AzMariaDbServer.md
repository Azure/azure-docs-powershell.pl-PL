...
### Przykład 1: wyświetlanie wszystkich MariaDB w obszarze abonamentów
```powershell
...
To polecenie wyświetla listę wszystkich MariaDB w obszarze abonamentów.

### Przykład 2: Lista wszystkich MariaDB w grupie zasobów
```powershell
...
To polecenie wyświetla listę wszystkich MariaDB w grupie zasobów.

### Przykład 3: uzyskiwanie MariaDB
```powershell
