...
## Opis
Tworzy prefiks usługi peer-and skojarzony z obiektem usługi peer.
...
Tworzy prefiks na podstawie identyfikatora zasobu usługi peer.
...
Tworzy prefiks nazwy i nazwy grupy zasobów usługi peer-Group.
...
### -PeeringServiceName
Nazwa usługi peer.
Użyj polecenia cmdlet New-AzPeeringService dla nowej usługi peer lub Get-AzPeeringService listy.
...
### -ServiceKey
Jest to unikatowy identyfikator GUID podany przez dostawcę usługi
