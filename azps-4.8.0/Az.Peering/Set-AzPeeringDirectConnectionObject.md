...
Umożliwia uaktualnienie przepustowości dla pierwszego połączenia w obiekcie równorzędnym w pamięci. 
...
### Aktualizowanie użytkowania usługi peer
```powershell
...
Aktualizuje połączenie do użytku z usługą komunikacji równorzędnej
...
### -Inputobject
Obiekt połączenie bezpośrednie
