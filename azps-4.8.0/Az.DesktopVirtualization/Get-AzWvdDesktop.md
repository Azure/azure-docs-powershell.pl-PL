...
### Przykład 1: uzyskiwanie pulpitu wirtualnego systemu Windows według nazwy
```powershell
...
To polecenie pobiera pulpit pulpitu wirtualnego systemu Windows w grupie Applicaton.

### Przykład 2: Wyświetlanie pulpitów pulpitów wirtualnych systemu Windows
```powershell
...
To polecenie listsWindows pulpity pulpitów wirtualnych w grupie Applicaton.
...
### -Name (nazwa)
Nazwa pulpitu w określonej grupie pulpit
...
### Microsoft. Azure. PowerShell. polecenia. DesktopVirtualization. models. Api20191210Preview. IDesktop

### Microsoft. Azure. PowerShell. polecenia. DesktopVirtualization. models. Api20191210Preview. IDesktopList
