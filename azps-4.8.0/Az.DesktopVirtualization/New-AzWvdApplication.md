...
### Przykład 1: Tworzenie aplikacji klasycznej Windows Virtual
```powershell
...
To polecenie tworzy wirtualną aplikację klasyczną systemu Windows w grupie Applicaton.

## PARAMETRÓW

### -AppAlias
Alias aplikacji z elementu menu Start
...
### Microsoft. Azure. PowerShell. polecenia. DesktopVirtualization. models. Api20191210Preview. IApplication
