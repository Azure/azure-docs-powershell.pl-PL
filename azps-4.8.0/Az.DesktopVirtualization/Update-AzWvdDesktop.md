...
### Przykład 1: aktualizowanie pulpitu wirtualnego systemu Windows
```powershell
...
To polecenie aktualizuje pulpit pulpitu wirtualnego systemu Windows w grupie Applicaton.
