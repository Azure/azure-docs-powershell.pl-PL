...
## Opis
Polecenie cmdlet **Get-AzDataLakeAnalyticsCatalogItemAclEntry** pobiera listę wpisów (ACE) na liście kontroli dostępu (ACL) wykazu lub elementu wykazu w usłudze Data Lake Analytics.
