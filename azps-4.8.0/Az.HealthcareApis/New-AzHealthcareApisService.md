...
## Opis
Umożliwia utworzenie lub zaktualizowanie metadanych wystąpienia usługi.

## Przykłady

### Przykład 1: tworzy nową nową usługę Azure healthcareapis fhir o nazwie Moja usługa w grupie zasobu moja grupa w lokalizacji westus2 z cosmosdb przepływem pracy = 400
```powershell
...
### -CorsHeader
Lista usługi HealthcareApis Fhir nagłówka CORS. Określ nagłówki HTTP, których można użyć podczas żądania. Użyj znaku * dla dowolnego nagłówka.
...
### -CorsMaxAge
Maksymalny wiek usługi HealthcareApis Fhir service cors. Określ, jak długo wynik żądania może być buforowany w sekundach. Przykład: 600 oznacza 10 minut.
...
### -CorsMethod
HealthcareApis Fhir Service (lista) Metoda CORS.
...
### -CorsOrigin
HealthcareApis Fhir Service (lista pochodzenia CORS). Określ adresy URL witryn pochodzących, które mogą uzyskiwać dostęp do tego interfejsu API, lub użyj znaku *, aby zezwolić na dostęp z dowolnej witryny.
