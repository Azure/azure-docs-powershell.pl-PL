...
## Opis
Polecenie cmdlet **New-AzPrivateDnsZone** tworzy nową strefę DNS (Private Domain Name System) w określonej grupie zasobów. Musisz określić unikatową nazwę prywatnej strefy DNS dla parametru *name* lub polecenie cmdlet zwróci błąd. Po utworzeniu strefy Użyj polecenia cmdlet New-AzPrivateDnsRecordSet, aby utworzyć zestaw rekordów w strefie.
