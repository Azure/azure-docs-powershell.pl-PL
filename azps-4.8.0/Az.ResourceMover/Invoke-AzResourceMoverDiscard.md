...
### Przykład 1. Sprawdź poprawność dependecies przed odrzuceniem zasobów.
```powershell
...
Sprawdź poprawność dependecies przed odrzuceniem zasobów.

### Przykład 2: odrzucanie przeniesień zasobów przy użyciu funkcji "MoveResource Name" jako danych wejściowych
```powershell
...
Odrzucanie przenoszonych zasobów przy użyciu funkcji "MoveResource Name" jako danych wejściowych.

### Przykład 3: odrzucanie przeniesień zasobów przy użyciu "SourceARMID" jako danych wejściowych
```powershell
...
Odrzucanie przenoszonych zasobów przy użyciu "SourceARMID" jako danych wejściowych.
