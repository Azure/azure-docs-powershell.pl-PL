...
## Opis
Polecenie cmdlet **Remove-AzBatchJobSchedule** usuwa harmonogram zadań usługi Azure Batch.

## Przykłady

### Przykład 1: Usuwanie harmonogramu zadań wsadowych
```
PS C:\>Remove-AzBatchJobSchedule -Id "MyJobSchedule" -BatchContext $Context
```

To polecenie usuwa harmonogram zadań o IDENTYFIKATORze MyJobSchedule.
...
To polecenie pobiera harmonogram zadań o IDENTYFIKATORze MyJobSchedule przy użyciu polecenia cmdlet Get-AzBatchJobSchedule.
Polecenie przekazuje ten harmonogram zadań do bieżącego polecenia cmdlet za pomocą operatora potoku.
Polecenie usunie harmonogram zadań.
...
### -ID
Określa identyfikator harmonogramu zadań, który ma zostać usunięty.
