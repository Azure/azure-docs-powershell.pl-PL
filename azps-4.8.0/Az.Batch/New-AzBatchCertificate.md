...
### -Kind
Rodzaj certyfikatu do utworzenia. Jeśli to nie jest określone, przyjmuje się, że wszystkie certyfikaty bez hasła to CER, a wszystkie certyfikaty z hasłami są PFX.
