...
## Opis
Polecenie cmdlet **Grant-AzDiskAccess** umożliwia uzyskanie dostępu do dysku.
...
Udziel uprawnienia "Odczyt" na dysk o nazwie "Disk01" w grupie zasobów o nazwie "ResourceGroup01" dla 60 sekund.
...
### -DurationInSecond
Określa czas trwania dostępu w sekundach.
...
### Microsoft. Azure. Commands. COMPUTE. Automation. MODELES. PSAccessUri
