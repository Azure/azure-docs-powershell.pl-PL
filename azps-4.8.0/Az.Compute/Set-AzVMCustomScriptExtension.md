...
### ByNameWithContainerAndFileNamesParameterSet (domyślny)
```
...
Umożliwia dodanie niestandardowego rozszerzenia skryptu do maszyny wirtualnej. (autogenerowana)
...
### -FileName
Określa nazwę pliku skryptu. Jeśli plik jest przechowywany w usłudze Azure Blob Storage, w wartości nazwy pliku jest uwzględniana wielkość liter. W nazwach plików przechowywanych w usłudze Azure File Storage nie jest rozróżniana wielkość liter.
...
Aby uzyskać wersję, uruchom polecenie cmdlet Get-AzVMExtensionImage z wartością argumentu Microsoft. COMPUTE dla parametru *wydawcy* i CustomScriptExtension dla parametru *Type* .
