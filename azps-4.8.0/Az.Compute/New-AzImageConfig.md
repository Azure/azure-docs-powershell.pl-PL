...
## Opis
Polecenie cmdlet **New-AzImageConfig** tworzy obiekt z obrazem konfigurowalnym.
...
Kolejne trzy polecenia umożliwiają przypisanie ścieżek do dysków systemu operacyjnego i dwóch dysków z danymi do $osDiskVhdUri, $dataDiskVhdUri 1 i $dataDiskVhdUri 2 zmiennych. Taka metoda dotyczy tylko czytelności następujących poleceń.
...
### -HyperVGeneration
Określa typ HyperVGeneration maszyny wirtualnej utworzonej na podstawie obrazu.  Dozwolone wartości to V1 i v2.
...
### -OsDisk
Określa dysk systemu operacyjnego.
...
Określa identyfikator źródłowego maszyny wirtualnej.
...
### -ZoneResilient
Włączanie odporności na strefy
...
### Microsoft. Azure. Management. COMPUTE. MODELES. ImageOSDisk

### Microsoft. Azure. Management. COMPUTE. MODELES. ImageDataDisk []
