...
## Opis
To polecenie cmdlet utworzy hosta.
...
To polecenie tworzy Host danej jednostki SKU w danej grupie hostów i określoną lokalizację.
...
Określa, czy host powinien być zastępowany automatycznie w przypadku niepowodzenia. Wartość jest domyślnie równa "prawda", gdy nie jest podana.
...
### -LicenseType
Określa typ licencji na oprogramowanie, który zostanie zastosowany do maszyn wirtualnych wdrożonych na hoście. Możliwe wartości: brak, Windows_Server_Hybrid i Windows_Server_Perpetual.  Wartość domyślna to None.
...
### -PlatformFaultDomain
Określa liczbę domen błędów platformy hosta.  Wartość minimalna wynosi 0, a wartość maksymalna to 2.
