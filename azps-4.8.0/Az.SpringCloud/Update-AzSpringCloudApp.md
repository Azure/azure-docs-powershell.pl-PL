...
### Przykład 1: Uaktualnij aplikację wiosennej chmury według nazwy.
```powershell
...
Zaktualizuj aplikację wiosną chmurą według nazwy.

### Przykład 2: Aktualizacja aplikacji wiosennej w chmurze z potoku.
```powershell
...
Aktualizuj aplikację wiosennej chmury z potoku.
...
### -HttpsOnly
Wskazuje, czy dozwolony jest tylko protokół https.
...
Ścieżka instalacji trwałego dysku
...
### Microsoft. Azure. PowerShell. polecenia. SpringCloud. models. Api20190501Preview. IAppResource
