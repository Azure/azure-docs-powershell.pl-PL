...
### Przykład 1: aktualizowanie usługi w chmurze wiosennej według nazwy.
```powershell
...
Zaktualizuj usługę wiosennej chmury według imienia i nazwiska.

### Przykład 2: aktualizowanie usługi w chmurze wiosennej z potoku.
```powershell
...
Aktualizuj usługę wiosennej chmury z potoku.
