...
### Przykład 1: zatrzymywanie wiosennej usługi w chmurze według nazwy.
```powershell
PS C:\> Stop-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default
```

Zatrzymywanie wiosennej usługi w chmurze według nazwy.
...
Zatrzymywanie wiosennej usługi w chmurze z potoku.
