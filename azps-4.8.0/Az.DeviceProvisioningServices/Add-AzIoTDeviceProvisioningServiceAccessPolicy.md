...
Dodaj nowe zasady dostępu współdzielonego do usługi dostarczania urządzeń centrum usług Azure IoT, korzystając z praw EnrollmentWrite i ServiceConfig.
...
Dodaj nowe zasady dostępu współdzielonego do usługi dostarczania urządzeń centrum usługi Azure IoT, korzystając z EnrollmentRead prawej.
...
### -NazwaKlucza
Nazwa klucza zasad dostępu do usługi dla urządzeń IoT
...
### -Uprawnienia
Uprawnienia zasad dostępu do usługi dla urządzeń IoT
