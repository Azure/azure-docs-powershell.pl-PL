...
## Opis
Zweryfikuj certyfikat, przekazując certyfikat weryfikacji zawierający kod weryfikacyjny uzyskany przez połączenie z kodem generowania-weryfikacji. Jest to ostatni krok w celu poświadczania procesu posiadania.
...
Sprawdź własność klucza prywatnego "mój certyfikat".
...
Sprawdź własność klucza prywatnego "mój certyfikat" przy użyciu potoku.
...
### -Path
Reprezentacja Base-64 — ścieżka pliku lub pliku PEM z certyfikatem x509. cer
