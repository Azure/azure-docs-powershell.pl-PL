...
## Opis
Wznów lub ponownie zsynchronizuj połączenie na woluminie docelowym
...
To polecenie wznawia połączenie replikacji ANF w woluminie "MyDestinationAnfVolume".

## PARAMETRÓW

### -AccountName
Nazwa konta ANF woluminu replikacji
...
### -Inputobject
Obiekt woluminu docelowego replikacji ANF do ponownej synchronizacji
...
### -Name (nazwa)
Nazwa woluminu docelowego replikacji ANF
...
### -PassThru
Zwraca, czy została wykonana ponowna synchronizacja określonego woluminu replikacji
...
### -PoolName
Nazwa puli ANF woluminu replikacji
...
### -ResourceGroupName
Grupa zasobów woluminu docelowego replikacji ANF
...
### -ResourceId
Identyfikator zasobu w docelowym woluminie replikacji ANF
