...
## Opis
Polecenie cmdlet **Invoke-AzResourceAction** umożliwia wywołanie akcji dotyczącej określonego zasobu platformy Azure.
Aby uzyskać listę obsługiwanych akcji, użyj narzędzia Eksplorator zasobów platformy Azure.

## Przykłady

### Przykład 1: wywoływanie Rozpoczynanie maszyny wirtualnej z identyfikatorem ResourceId
...
To polecenie umożliwia uruchomienie maszyny wirtualnej z identyfikatorem {ResourceId}.

### Przykład 2: wywołanie maszyny wirtualnej z resourceName poweroffing
...
Polecenie określa parametr *Force* , dlatego nie monituje o potwierdzenie.

### Przykład 3: wywoływanie rejestrowania dostawcy zasobów z identyfikatorem ResourceId
