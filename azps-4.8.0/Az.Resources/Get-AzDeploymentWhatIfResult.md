...
## Opis
Polecenie cmdlet **Get-AzDeploymentWhatIfResult** pobiera szablon ARM What-If wyniku wdrożenia szablonu w bieżącym zakresie subskrypcji. Zwraca listę zmian wskazujących, które zasoby zostaną zaktualizowane po zastosowaniu wdrożenia bez wprowadzania zmian w rzeczywistych zasobach. Aby określić format wyniku zwracanego, użyj parametru *ResultFormat* .

## Przykłady

### Przykład 1: uzyskiwanie What-If wyniku w zakresie subskrypcji
```powershell
...
To polecenie pobiera What-If wynik w bieżącym zakresie subskrypcji przy użyciu pliku szablonu niestandardowego i pliku parametrów na dysku.
...
### Przykład 2: uzyskiwanie What-If wyniku w zakresie subskrypcji za pomocą ResourceIdOnly
```powershell
PS C:\> Get-AzDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
