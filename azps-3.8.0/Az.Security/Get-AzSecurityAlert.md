...
ms.locfileid: "94053651"
---
# <span data-ttu-id="5d80f-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="5d80f-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="5d80f-102">STRESZCZENIe</span><span class="sxs-lookup"><span data-stu-id="5d80f-102">SYNOPSIS</span></span>
<span data-ttu-id="5d80f-103">Pobiera alerty zabezpieczeń wykryte przez usługę Azure Security Center</span><span class="sxs-lookup"><span data-stu-id="5d80f-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="5d80f-104">POLECENIA</span><span class="sxs-lookup"><span data-stu-id="5d80f-104">SYNTAX</span></span>

### <span data-ttu-id="5d80f-105">SubscriptionScope (domyślny)</span><span class="sxs-lookup"><span data-stu-id="5d80f-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="5d80f-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="5d80f-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="5d80f-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="5d80f-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="5d80f-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="5d80f-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="5d80f-109">Zasobów</span><span class="sxs-lookup"><span data-stu-id="5d80f-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="5d80f-110">Opis</span><span class="sxs-lookup"><span data-stu-id="5d80f-110">DESCRIPTION</span></span>
<span data-ttu-id="5d80f-111">Pobiera alerty zabezpieczeń wykryte przez usługę Azure Security Center</span><span class="sxs-lookup"><span data-stu-id="5d80f-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="5d80f-112">Przykłady</span><span class="sxs-lookup"><span data-stu-id="5d80f-112">EXAMPLES</span></span>

### <span data-ttu-id="5d80f-113">Przykład 1</span><span class="sxs-lookup"><span data-stu-id="5d80f-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="5d80f-114">Pobiera wszystkie alerty zabezpieczeń wykryte na zasobach w ramach subskrypcji.</span><span class="sxs-lookup"><span data-stu-id="5d80f-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="5d80f-115">Przykład 2</span><span class="sxs-lookup"><span data-stu-id="5d80f-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="5d80f-116">Pobiera wszystkie alerty zabezpieczeń wykryte dla zasobów w grupie zasobów "myService1".</span><span class="sxs-lookup"><span data-stu-id="5d80f-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="5d80f-117">Przykład 3</span><span class="sxs-lookup"><span data-stu-id="5d80f-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="5d80f-118">Pobiera określony alert zabezpieczeń wykryty dla zasobów w grupie zasobów "myService1".</span><span class="sxs-lookup"><span data-stu-id="5d80f-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="5d80f-119">PARAMETRÓW</span><span class="sxs-lookup"><span data-stu-id="5d80f-119">PARAMETERS</span></span>

### <span data-ttu-id="5d80f-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="5d80f-120">-DefaultProfile</span></span>
<span data-ttu-id="5d80f-121">Poświadczenia, konto, dzierżawa i subskrypcja używane do komunikacji z usługą Azure.</span><span class="sxs-lookup"><span data-stu-id="5d80f-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="5d80f-122">— Lokalizacja</span><span class="sxs-lookup"><span data-stu-id="5d80f-122">-Location</span></span>
<span data-ttu-id="5d80f-123">Pozycję.</span><span class="sxs-lookup"><span data-stu-id="5d80f-123">Location.</span></span>
...
### <span data-ttu-id="5d80f-124">-Name (nazwa)</span><span class="sxs-lookup"><span data-stu-id="5d80f-124">-Name</span></span>
<span data-ttu-id="5d80f-125">Nazwa zasobu.</span><span class="sxs-lookup"><span data-stu-id="5d80f-125">Resource name.</span></span>
...
### <span data-ttu-id="5d80f-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="5d80f-126">-ResourceGroupName</span></span>
<span data-ttu-id="5d80f-127">Nazwa grupy zasobów.</span><span class="sxs-lookup"><span data-stu-id="5d80f-127">Resource group name.</span></span>
...
### <span data-ttu-id="5d80f-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="5d80f-128">-ResourceId</span></span>
<span data-ttu-id="5d80f-129">Identyfikator zasobu.</span><span class="sxs-lookup"><span data-stu-id="5d80f-129">Resource ID.</span></span>
...
### <span data-ttu-id="5d80f-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="5d80f-130">CommonParameters</span></span>
<span data-ttu-id="5d80f-131">To polecenie cmdlet obsługuje typowe parametry:-Debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-unvariable,-subbuffer,-PipelineVariable,-verbose,-WarningAction i-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="5d80f-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="5d80f-132">Aby uzyskać więcej informacji, zobacz about_CommonParameters ( http://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="5d80f-132">For more information, see about_CommonParameters (http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="5d80f-133">WEJŚCIOWE</span><span class="sxs-lookup"><span data-stu-id="5d80f-133">INPUTS</span></span>

### <span data-ttu-id="5d80f-134">System. String</span><span class="sxs-lookup"><span data-stu-id="5d80f-134">System.String</span></span>

## <span data-ttu-id="5d80f-135">WYSYŁA</span><span class="sxs-lookup"><span data-stu-id="5d80f-135">OUTPUTS</span></span>

### <span data-ttu-id="5d80f-136">Microsoft. Azure. Commands. Security. models. Alerts. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="5d80f-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="5d80f-137">INFORMACYJN</span><span class="sxs-lookup"><span data-stu-id="5d80f-137">NOTES</span></span>

## <span data-ttu-id="5d80f-138">LINKI POKREWNE</span><span class="sxs-lookup"><span data-stu-id="5d80f-138">RELATED LINKS</span></span>
