...
Użyj polecenia cmdlet Get-AzBatchJob, aby uzyskać obiekt **PSCloudJob** .
...
Pierwsze polecenie pobiera zadanie przy użyciu polecenia **Get-AzBatchJob** , a następnie zapisuje je w zmiennej $Job.
