...
## STRESZCZENIe
Generuje tolen SAS dla usługi Azure ServiceBus w obszarze nazw/kolejek/tematów. 
...
## Opis
Polecenie cmdlet New-AzServiceBusAuthorizationRuleSASToken generuje token dostępu współużytkowanego (SAS) dla usługi Azure Eventhub Namesapce lub Azure Eventhub
