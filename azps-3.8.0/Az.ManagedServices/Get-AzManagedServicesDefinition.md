...
Pobiera wszystkie definicje rejestracji.
...
Pobiera definicję rejestracji pod kątem jej identyfikatora.
...
Pobiera definicję rejestracji pod kątem w pełni kwalifikowanego identyfikatora zasobu.
...
### -ID
Identyfikator definicji rejestracji (na przykład b0c052e5-c437-4771-a476-8b1201158a57).
```yaml
Type: System.String
Parameter Sets: ById
Aliases:
