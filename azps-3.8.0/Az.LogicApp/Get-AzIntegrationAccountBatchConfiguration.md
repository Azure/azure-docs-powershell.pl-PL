...
## Opis
Polecenie cmdlet **Get-AzIntegrationAccountBatchConfiguration** Pobiera konfigurację partii z konta integracji.

## Przykłady

### Przykład 1: Uzyskiwanie konfiguracji wsadowej według parametrów
```powershell
...
Pobierz konfigurację wsadową o nazwie "sampleBatchConfig" znajdującą się na koncie integracyjnym "sampleIntegrationAccount", który jest zawarty w grupie zasobów "sampleResourceGroup".

### Przykład 2: wyświetlanie wszystkich konfiguracji partii w ramach konta integracji według parametrów
```powershell
...
Pobierz wszystkie konfiguracje wsadowe zlokalizowane na koncie integracyjnym "sampleIntegrationAccount", które jest zawarte w grupie zasobów "sampleResourceGroup".
