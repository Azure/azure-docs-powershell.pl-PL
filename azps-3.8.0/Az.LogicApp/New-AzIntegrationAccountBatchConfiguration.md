...
Tworzy nową konfigurację partii przy użyciu pliku lokalnego znajdującego się w ścieżce pliku znajdującej się w "$batchConfigurationFilePath".
...
Tworzy nową konfigurację partii przy użyciu ciągu JSON zawartego w "$batchConfigurationContent".
...
Tworzenie nowej konfiguracji wsadowej przez ręczne podanie wszystkich niezbędnych parametrów.
