...
## Opis
Polecenie cmdlet **New-AzDataBoxEdgeOrder** tworzy nowe zamówienie na urządzeniu z danymi na krawędziach pola danych. Przed utworzeniem zamówienia należy najpierw utworzyć zasób urządzenia z krawędzią pola danych. Możesz określić szczegóły, takie jak osoba kontaktowa, nazwa firmy, e-mail, adres itd., jako parametry tworzenia zamówienia.
