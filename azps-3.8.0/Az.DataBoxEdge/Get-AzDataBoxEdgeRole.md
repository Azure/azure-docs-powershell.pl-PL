...
## Opis
Polecenie cmdlet **Get-AzDataBoxEdgeRole** umożliwia pobranie dostępnych ról usługi IoT dla urządzenia z krawędzią pola danych. Parametr name można wspominać, aby uzyskać szczegółowe informacje o konkretnej roli IoT.
