...
### ByFieldsWithBackendPoolsSettingParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **New-AzFrontDoor** tworzy nowy moduł równoważenia obciążenia z przodu platformy Azure w określonej grupie zasobów w obszarze bieżący abonament

## Przykłady

### Przykład 1. Tworzenie drzwi przednich na podstawie podanych parametrów.
```powershell
