...
## Opis
Polecenie cmdlet **New-AzFrontDoorBackendpoolsSettingObject** tworzy nowy obiekt PSBackendPoolsSettings na potrzeby tworzenia przednich drzwi.

## Przykłady

### Przykład 1: Tworzenie obiektu BackendPoolsSettings przy użyciu domyślnych
```powershell
...
### Przykład 2: Tworzenie obiektu BackendPoolsSettings z wartościami określonymi przez użytkownika
```powershell
...
Czy należy wymusić sprawdzanie nazw certyfikatów na żądania HTTPS we wszystkich pulach zaplecza.
Brak wpływu na żądania inne niż HTTPS.
...
Przekrocz limit czasu wysyłania i odbierania żądań przesyłania dalej w wewnętrznej bazie danych. Po osiągnięciu limitu czasu żądanie nie powiedzie się i zwróci wartość.
