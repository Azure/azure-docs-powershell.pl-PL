...
## Opis
Polecenie cmdlet **Get-AzFrontDoorFrontendEndpoint** pobiera wszystkie istniejące punkty końcowe frontonu w bieżącym zasobie z przodu, które pasują do podanych informacji.

## Przykłady

### Przykład 1: uzyskiwanie wszystkich punktów końcowych frontonu w przednich drzwiach "frontdoor1", które są częścią grupy zasobów "RG1".
```powershell
...
Pobierz wszystkie punkty końcowe frontonu w przód "frontdoor1", który jest częścią grupy zasobów "RG1".

### Przykład 2: pobieranie punktu końcowego frontonu o nazwie "frontdoor1-azurefd-NET" w przednich drzwiach "frontdoor1", który jest częścią grupy zasobów "RG1"
```powershell
...
Pobierz punkt końcowy frontonu o nazwie "frontdoor1-azurefd-NET" w przednich drzwiach "frontdoor1", który jest częścią grupy zasobów "RG1"
...
### -ResourceId
Identyfikator zasobu Przednie drzwi
