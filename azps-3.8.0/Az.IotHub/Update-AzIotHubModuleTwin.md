...
## Opis
Umożliwia aktualizowanie lub zamienianie sznurka urządzenia. https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-module-twinsAby uzyskać więcej informacji, zobacz.
...
Zwraca obiekt z zaktualizowanym modułem sznurka urządzenia.
...
Zwraca obiekt sznura modułowego urządzenia ze zaktualizowanymi pożądanymi właściwościami.
...
Zwraca obiekt typu sznurek modułu urządzenia z zaktualizowaną właściwością Tagi.
...
Zwraca obiekt z zamienionym modułem sznurka urządzenia.
...
### — Wymagane
Dodaj lub zaktualizuj odpowiednią właściwość w module sznurek.
...
### -Częściowa
Umożliwia tylko częściowe zaktualizowanie znaczników i pożądanych właściwości modułu sznurek.
...
### -Tag
Dodaj lub zaktualizuj właściwość znaczniki w module sznurek.
