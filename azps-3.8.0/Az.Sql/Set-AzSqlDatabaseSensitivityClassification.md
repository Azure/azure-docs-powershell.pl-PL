...
## Opis
Polecenie cmdlet Set-AzSqlDatabaseSensitivityClassification ustawia typy informacji oraz etykiety liter kolumn w bazie danych.

## Przykłady

### Przykład 1: Ustawianie typu informacji i etykiety wrażliwości kolumny w bazie danych Azure SQL Database.
```powershell
...
### Przykład 2: Ustawianie zalecanych typów informacji i etykiet wrażliwości kolumn w bazie danych Azure SQL Database.
```powershell
...
### Przykład 3: Ustawianie typu informacji i etykiety wrażliwości kolumny w bazie danych Azure SQL Database przy użyciu połączeń rurowych.
```powershell
