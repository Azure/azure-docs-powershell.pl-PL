...
### Przykład 3,1: Włączanie zasad inspekcji magazynu obiektów BLOB bazy danych Azure SQL z filtrowaniem zaawansowanymi przy użyciu predykatu T-SQL
```
...
### Przykład 3,2: usuwanie ustawienia filtrowania zaawansowanego z zasad inspekcji bazy danych Azure SQL Database
```
...
### Przykład 4: Włączanie zasad inspekcji centrum zdarzeń bazy danych platformy Azure SQL
```
...
### Przykład 5: wyłączanie zasad inspekcji centrum zdarzeń bazy danych platformy Azure SQL
```
...
### Przykład 6: Włączanie zasad inspekcji analizy dzienników bazy danych platformy Azure SQL
```
...
### Przykład 7: wyłączanie zasad inspekcji analizy dzienników bazy danych platformy Azure SQL
```
...
### Przykład 8: wyłączanie, za pośrednictwem rurociągu, zasady inspekcji analizy dzienników bazy danych platformy Azure SQL
```
...
### Przykład 9: wyłączanie wysyłania rekordów inspekcji bazy danych usługi Azure Database do magazynu obiektów blob i włączanie wysyłania ich do analizy dzienników.
```
...
### Przykład 10: Włączanie wysyłania rekordów inspekcji bazy danych usługi Azure SQL do magazynu obiektów blob, centrum zdarzeń i analizy dzienników.
```
