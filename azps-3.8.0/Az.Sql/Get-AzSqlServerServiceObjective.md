...
## Opis
Polecenie cmdlet **Get-AzSqlServerServiceObjective** Pobiera dostępne cele usługi dla serwera bazy danych Azure SQL.

## Przykłady

### Przykład 1: uzyskiwanie celów dotyczących usługi
```
...
To polecenie uzyskuje cele usługi dla serwera o nazwie Server01.

### Przykład 2: uzyskiwanie celów serwisowych przy użyciu funkcji filtrowania
```
...
To polecenie uzyskuje cele usługi dla serwera o nazwie Server01, który rozpoczyna się od "system".

### Przykład 3: uzyskiwanie celów usługi dla lokalizacji
```
...
To polecenie umożliwia pobieranie celów usługi dla określonego regionu platformy Azure.
...
### — Lokalizacja
Nazwa lokalizacji, w której mają zostać wyświetlone cele usługi.
...
To polecenie cmdlet umożliwia pobieranie celów usługi dla serwera bazy danych SQL przypisanego do tego zasobu.
...
### -Nazwa_serwera
Określa nazwę serwera bazy danych SQL bazy danych SQL.
...
### -Servicecelname
Określa nazwę celu usługi dla serwera bazy danych Azure SQL.
Dopuszczalne wartości tego parametru to: Basic, S0, S1, S2, P1, P2 i P3.
...
### Microsoft. Azure. Commands. SQL. serviceobject. model. AzureSqlServerServiceObjectiveModel
