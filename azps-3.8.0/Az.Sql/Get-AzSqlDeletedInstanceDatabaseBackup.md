...
## Opis
Polecenie cmdlet **Get-AzSqlDeletedInstanceDatabaseBackup** pobiera określoną usuniętą kopię zapasową bazy danych wystąpienia SQL, którą można przywrócić, lub wszystkie usunięte kopie zapasowe, które można przywrócić.
To polecenie cmdlet jest również obsługiwane przez usługę bazy danych SQL Server o ciągach na platformie Azure.
