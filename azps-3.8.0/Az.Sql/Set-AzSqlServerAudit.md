...
### Przykład 3,1: Włączanie zasad inspekcji magazynu obiektów BLOB programu Azure SQL Server za pomocą funkcji filtrowania zaawansowanego przy użyciu predykatu T-SQL
```
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -BlobStorageTargetState Enabled -StorageAccountResourceId "/subscriptions/7fe3301d-31d3-4668-af5e-211a890ba6e3/resourceGroups/resourcegroup01/providers/Microsoft.Storage/storageAccounts/mystorage" -PredicateExpression "statement <> 'select 1'"
```

### Przykład 3,2: usuwanie ustawienia filtrowania zaawansowanego z zasad inspekcji programu Azure SQL Server
```
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -PredicateExpression ""
```

### Przykład 4: Włączanie zasad inspekcji centrum zdarzeń programu Azure SQL Server
```
...
### Przykład 5: wyłączanie zasad inspekcji centrum zdarzeń w programie Azure SQL Server
```
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -EventHubTargetState Disabled
```

### Przykład 6: Włączanie zasad inspekcji analizy dzienników programu Azure SQL Server
```
...
### Przykład 7: wyłączenie zasad inspekcji analizy dzienników programu Azure SQL Server
```
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -LogAnalyticsTargetState Disabled
```

### Przykład 8: wyłączanie, za pośrednictwem rurociągu, zasady inspekcji analizy dzienników w usłudze Azure SQL Server
```
...
### Przykład 9: wyłączanie wysyłania rekordów inspekcji programu Azure SQL Server do magazynu obiektów blob i włączanie wysyłania ich do analizy dzienników.
```
...
### Przykład 10: Włączanie wysyłania rekordów inspekcji programu Azure SQL Server do magazynu obiektów blob, centrum zdarzeń i analizy dzienników.
```
