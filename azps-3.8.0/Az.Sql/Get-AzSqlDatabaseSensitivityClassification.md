...
## Opis
Polecenie cmdlet Get-AzSqlDatabaseSensitivityClassification zwraca bieżące typy informacji oraz etykiety liter kolumn w bazie danych SQL Azure.

## Przykłady

### Przykład 1: pobieranie bieżących typów informacji i etykiet liter w bazie danych SQL Azure.
```powershell
...
### Przykład 2: uzyskiwanie aktualnych typów informacji i etykiet wrażliwości bazy danych SQL Azure z potokiem.
```powershell
...
### Przykład 3: uzyskiwanie aktualnego typu informacji i etykiety wrażliwości konkretnej kolumny bazy danych SQL Azure.
```powershell
...
### Przykład 4: uzyskiwanie informacji o typie i etykiecie wrażliwości konkretnej kolumny bazy danych SQL Azure przy użyciu połączeń rurowych.
```powershell
