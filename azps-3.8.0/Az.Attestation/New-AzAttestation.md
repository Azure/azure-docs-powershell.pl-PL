...
Utwórz nowe wystąpienie dostawcy zaświadczania o nazwie *pshtest4* z kilkoma znacznikami i używając zaufania w usłudze AAD dla głównych zasad usługi tee.
...
Utwórz nowe wystąpienie dostawcy zaświadczania o nazwie *pshtest3* ', który używa zaufania Isoladed dla głównych zasad tee za pośrednictwem określania zestawu zaufanych kluczy podpisywania za pośrednictwem pliku PEM.
...
### — Lokalizacja
Określa region platformy Azure, w którym ma zostać utworzony dostawca zaświadczania. Użyj polecenia Get-AzResourceProvider z parametrem ProviderNamespace, aby wyświetlić wybrane opcje.
...
Określa zestaw zaufanych kluczy podpisywania dla zasad wystawiania w jednym pliku certyfikatu.
