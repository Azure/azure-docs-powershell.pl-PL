...
### ByAvailableAttestation (domyślny)
```
...
## Opis
Polecenie cmdlet Remove-AzAttestation usuwa określoną zaświadczenie.
...
Usuń dostawcę zaświadczania o nazwie *pshtest3* w grupie zasobów o nazwie *PSH-test-RG* z bieżącego abonamentu.
...
### -Inputobject
Obiekt zaświadczania do usunięcia.
...
### -Name (nazwa)
Określa nazwę zaświadczenia, które należy usunąć.
...
### -ResourceGroupName
Określa nazwę grupy zasobów na potrzeby zaświadczania usługi Azure do usunięcia.
...
### -ResourceId
Identyfikator zasobu zaświadczania.
