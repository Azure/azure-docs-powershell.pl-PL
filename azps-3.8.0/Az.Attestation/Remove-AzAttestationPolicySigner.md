...
### -Osoba podpisująca
Określa token sieci Web JSON usługi RFC7519 zawierający oświadczenie o nazwie "AAS-policyCertificate", którego wartość jest kluczem sieci Web JSON usługi RFC7517, który zawiera zaufany klucz podpisywania do usunięcia.
