...
> [!Note]  
> Polecenie cmdlet Invoke-AzStorageSyncChangeDetection nie wykrywa plików, które zostały usunięte z udziału plików w usłudze Azure. Jeśli pliki zostaną usunięte z udziału plików w usłudze Azure, będą one wykrywane po uruchomieniu [zadania wykrywania zmian](https://docs.microsoft.com/azure/storage/files/storage-sync-files-troubleshoot?tabs=portal1%2Cazure-portal#afs-change-detection) .
...
W tym przykładzie funkcja wykrywania zmian jest uruchamiana dla katalogu "Przykłady" i rekursywnie wykrywa zmiany w podkatalogach. Pamiętaj, że to polecenie może wykryć do 10 000 zmian, zanim zostanie automatycznie przerwane. Jeśli podejrzewasz, że wystąpił więcej niż 10 000 zmian, uruchom polecenie w części podrzędnej obszaru nazw.
