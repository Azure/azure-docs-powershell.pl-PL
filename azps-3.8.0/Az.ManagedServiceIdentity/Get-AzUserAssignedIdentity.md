...
### SuscriptionParameterSet (domyślny)
```
...
## Opis
**AzUserAssignedIdentity** pobiera istniejące tożsamości przypisane użytkownikowi.

## Przykłady

### Przykład 1
Ten przykładowy polecenie cmdlet pobiera tożsamość przydzieloną użytkownikowi o nazwie **ID1** pod grupą zasobów **PSRG**
...
### Przykład 2
Ten przykładowy polecenie cmdlet pobiera wszystkie tożsamości przypisane do użytkownika pod pozycją Grupa zasobów **PSRG**
...
### Przykład 3
Ten przykładowy polecenie cmdlet pobiera wszystkie tożsamości przypisane do użytkownika w ramach abonamentu.
