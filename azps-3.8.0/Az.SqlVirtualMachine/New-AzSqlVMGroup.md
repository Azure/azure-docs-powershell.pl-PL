...
## Opis
Polecenie cmdlet New-AzSqlVMGroup służy do tworzenia grupy maszyn wirtualnych SQL Azure.
...
Tworzy nową grupę maszyn wirtualnych SQL Azure z maszyną wirtualną grupy testowej w ResourceGroup01 grupy zasobów.
$profile to obiekt typu Microsoft. Azure. Management. SqlVirtualMachine. models. WsfcDomainProfile
...
Nazwa używana do tworzenia klastra
...
Nazwa używana przez klaster operacyjny
...
### — Lokalizacja
Lokalizacja grupy maszyn wirtualnych SQL.
...
### -Offer
Oferta grupy maszyn wirtualnych SQL.
...
### -OuPath
Ścieżka jednostki organizacyjnej, w której znajdują się węzły i klaster
...
### -SKU
Typ wydania Grupa maszyn wirtualnych SQL.
...
### -SqlServiceAccount
Nazwa, pod którą usługa SQL będzie uruchamiana na wszystkich uczestniczących maszynach wirtualnych SQL w klastrze
...
Klucz podstawowy konta magazynu monitora
...
### -Tag
Tagi, które mają zostać skojarzone z grupą maszyny wirtualnej SQL.
