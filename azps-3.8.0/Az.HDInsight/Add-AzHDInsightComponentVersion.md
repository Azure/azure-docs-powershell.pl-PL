...
## Opis
Polecenie cmdlet Add-AzHDInsightComponentVersion powoduje dodanie wersji dla usługi uruchomionej w klastrze do obiektu konfiguracji usługi Azure HDInsight utworzonego za pomocą New-AzHDInsightClusterConfig polecenia cmdlet.

## Przykłady

### Przykład 1: dodanie wersji dla usługi Spark do obiektu konfiguracji klastra.
```
...
To polecenie powoduje dodanie wersji programu Spark do klastra usługi HDInsight o nazwie "Your-Spark-001".
