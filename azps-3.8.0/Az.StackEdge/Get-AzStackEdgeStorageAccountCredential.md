...
## Opis
Polecenie cmdlet **Get-AzStackEdgeStorageAccountCredential** Pobiera poświadczenia konta magazynu dla odpowiedniego konta magazynu na urządzeniu z krawędziami stosu. Możesz określić nazwę, nazwę grupy zasobów i parametry nazwy urządzenia, aby uzyskać informacje o poświadczeniach określonego konta magazynu.
...
### -Name (nazwa)
Nazwa konta magazynu, które ma być używane
