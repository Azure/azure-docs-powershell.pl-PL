...
### InvokeByNameParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **Invoke-AzStackEdgeStorageContainer** wywołuje akcje umożliwiające odświeżenie danych w kontenerze magazynu na urządzeniu z krawędziami stosu. 
...
### -RefreshData
Odświeżanie metadanych kontenera przy użyciu danych z chmury
