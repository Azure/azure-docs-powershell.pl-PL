...
## Opis
Polecenie cmdlet **Remove-AzApiManagementLogger** usuwa **Rejestrator** zarządzania interfejsem API platformy Azure.
...
### -LoggerId
Określa identyfikator rejestratora, który ma zostać usunięty.
