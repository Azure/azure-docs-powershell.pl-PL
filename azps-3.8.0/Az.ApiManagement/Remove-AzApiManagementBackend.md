...
## OPIS
Usuwa backend określony przez identyfikator z zarządzania interfejsami API.

## PRZYKŁADY

### Przykład 1. Usuwanie bazy danych Backend 123
```powershell
...
### -BackendId
Identyfikator istniejącej bazy danych.
