...
### ByResourceIdParameterSet (domyślny)
```
...
## Opis
Polecenie cmdlet **Remove-AzApiManagementDiagnostic** usuwa jednostkę diagnostyczną określoną za pomocą `DiagnosticId` zakresu globalnego lub `ApiId` zakresu.

## Przykłady

### Przykład 1. Usuń jednostkę diagnostyczną
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementDiagnostic -Context $apimContext -DiagnosticId "applicationinsights"
```

W tym przykładzie pokazano, jak usunąć diagnostykę `applicationinsights` z usługi zarządzania interfejsem API.
...
### -Inputobject
Wystąpienie PsApiManagementDiagnostic. Ten parametr jest wymagany.
...
### -ResourceId
ARM identyfikator zasobu diagnostycznego. Ten parametr jest wymagany.
