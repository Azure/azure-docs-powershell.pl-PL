...
## Opis
Polecenie cmdlet New-AzDataMigrationTask służy do tworzenia zadania migracji danych. To polecenie cmdlet przyjmuje parametry dla modułu wyliczającego typ zadania, grupę zasobów platformy Azure, nazwę skojarzonej usługi migracji bazy danych platformy Azure i projektu jako dane wejściowe. 
...
Ten przykładowy skrypt przedstawia sposób tworzenia nowego zadania migracji danych o nazwie MyMigrationTask w projekcie o nazwie myDMSProject i usługi o nazwie TestService. 
...
### -MigrationValidation 
Obiekt odpowiedzi na zadanie z użyciem rozmowy sprawdzającej, opcjonalnej, ale zalecanej.
...
### -Czekaj
Określa, czy czekać na zakończenie zadania. Jeśli flaga jest ustawiona, sprawdza co określoną liczbę sekund, aż zadanie zostanie zakończone, i powróć do użytkownika właściwości zadania, w którym można sprawdzić dane wyjściowe lub błąd. 
```yaml
