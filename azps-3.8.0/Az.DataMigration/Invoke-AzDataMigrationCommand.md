...
## Opis
Polecenie cmdlet Invoke-AzDataMigrationCommand tworzy nowe zadanie w celu uruchomienia go w istniejącym zadaniu migracji.
...
W powyższych przykładach użyto polecenia cmdlet Invoke-AzDataMigrationCommand, aby utworzyć polecenie dla istniejącej usługi, projektu i zadania.
...
```
### -NazwaObiektu
Nazwa obiektu bazy danych, względem którego zostanie uruchomione polecenie.
