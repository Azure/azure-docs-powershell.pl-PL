...
## Opis
Polecenie cmdlet **Get-AzDataShareSynchronizationDetail** zawiera szczegółowe informacje dotyczące synchronizacji zainicjowanej dla udziału.
...
To polecenie zawiera informacje o szczegółach synchronizacji wszystkich zestawów danych odpowiadających danemu identyfikatorowi synchronizacji.
...
### -ResourceId
Identyfikator zasobu udziału danych w usłudze Azure
...
### -SynchronizationId
Identyfikator synchronizacji synchronizacji udziału
