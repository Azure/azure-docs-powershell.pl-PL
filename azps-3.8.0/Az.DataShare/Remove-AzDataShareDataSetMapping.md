...
## Opis
Polecenie cmdlet **Remove-AzDataShareDataSetMapping** usuwa mapowania zestawu danych.
...
To polecenie usuwa zestaw danych o nazwie DSM z sharesubscription WikiAds. 
...
### -Inputobject
Obiekt mapowania zestawu danych platformy Azure
