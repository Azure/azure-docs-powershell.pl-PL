...
Aby uzyskać bieżące właściwości magazynu, można użyć polecenia cmdlet **Set-AzRecoveryServicesVaultProperty** .
Za pomocą tego polecenia cmdlet **SoftDeleteFeatureState** w magazynie można włączyć w dowolnym momencie.
