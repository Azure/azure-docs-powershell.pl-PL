...
Użycie parametru FriendlyName może spowodować zwrócenie więcej niż jednego udziału plików platformy Azure. W takich przypadkach należy użyć parametru-name z wartością Parameter jako właściwości Name zwróconej w zmiennej $BackupItem.
