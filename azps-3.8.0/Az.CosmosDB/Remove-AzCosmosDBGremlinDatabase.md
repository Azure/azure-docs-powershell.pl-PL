...
## STRESZCZENIe
Usuwa bazę danych programu CosmosDB Gremlin.
...
## Opis
Polecenie cmdlet **Remove-AzCosmosDBGremlinDatabase** usuwa CosmosDB Gremlin Database.
...
Polecenie cmdlet zwraca obiekt typu wartość logiczna (gdy przekazano parametr-PassThru) o wartości prawda, Jeśli usunięcie powiodło się.
