...
## STRESZCZENIe
Ustawia bazę danych programu CosmosDB MongoDB
...
## Opis
Polecenie cmdlet **Set-AzCosmosDBMongoDBDatabase** pobiera bazę danych CosmosDB MongoDB.
...
### -Produktywność
Przepływność bazy danych Mongo (RU/s).
