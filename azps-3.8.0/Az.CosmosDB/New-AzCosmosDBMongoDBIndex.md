...
## STRESZCZENIe
Tworzy nowy indeks MongoDB CosmosDB.
...
## Opis
**Nowy — AzCosmosDBMongoDBIndex** tworzy nowy CosmosDB indeks MongoDB.
...
### -Key
Tablica wartości klucza jako ciągi.
...
### -TtlInSeconds
Liczba sekund, po upływie których indeks wygasa.
