...
## STRESZCZENIe
Umożliwia ustawienie tabeli CosmosDB.
...
## Opis
Polecenie cmdlet **Set-AzCosmosDBTable** tworzy nową tabelę lub aktualizuje istniejącą tabelę, zastępując istniejącą tabelę całkowicie.
