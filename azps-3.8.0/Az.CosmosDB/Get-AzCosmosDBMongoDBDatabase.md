...
## STRESZCZENIe
Pobiera bazę danych MongoDB CosmosDB
...
## Opis
Polecenie cmdlet **Get-AzCosmosDBMongoDBDatabase** pobiera bazę danych CosmosDB MongoDB.
...
Obiekt zasobu zawiera _rid, _ts, właściwości _etag.
...
Jeśli ta funkcja zostanie dostarczona, polecenie cmdlet zwróci bazę danych z odpowiednią wartością przepustowości.
