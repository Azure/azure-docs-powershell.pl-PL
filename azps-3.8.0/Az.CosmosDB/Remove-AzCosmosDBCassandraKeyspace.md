...
## Opis
Polecenie cmdlet **Remove-AzCosmosDBCassandraKeyspace** usuwa istniejące CosmosDB Cassandra Space.
...
Polecenie cmdlet zwraca obiekt typu wartość logiczna (gdy przekazano parametr-PassThru), który ma wartość PRAWDA, Jeśli usunięcie powiodło się.
