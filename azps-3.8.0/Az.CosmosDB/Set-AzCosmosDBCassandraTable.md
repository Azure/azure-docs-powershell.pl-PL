...
## STRESZCZENIe
Umożliwia ustawienie tabeli Cassandra CosmosDB.
...
## Opis
Polecenie cmdlet **Set-AzCosmosDBCassandraTable** ustawia CosmosDB Cassandra Space.
...
Obiekt zasobu zawiera wartości właściwości _rid, _ts, _etag, DefaultTtl i schematu.
