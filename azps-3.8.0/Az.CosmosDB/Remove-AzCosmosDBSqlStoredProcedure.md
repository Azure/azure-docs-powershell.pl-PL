...
## Opis
Polecenie cmdlet **Remove-AzCosmosDBSqlStoredProcedure** usuwa CosmosDB SQL StoredProcedure odpowiadającą podanemu ResourceGroupName, AccountName i DatabaseName.
