...
## Opis
Polecenie cmdlet **Set-AzCosmosDBCassandraKeyspace** ustawia CosmosDB Cassandra Space.
...
Obiekt zasobu zawiera wartości _rid, _ts _etag właściwości.
