...
## STRESZCZENIe
Tworzy nowy klucz klastra Cassandra CosmosDB.
...
## Opis
**Nowy-AzCosmosDBCassandraClusterKey** tworzy nowy klucz klastra CosmosDB Cassandra.
...
### -Name (nazwa)
Nazwa klucza klastra usługi Cassandra.
...
### -OrderBy
Zamawianie klucza klastra Cassandra.
Możliwe wartości są następujące: "ASC", "DESC"
