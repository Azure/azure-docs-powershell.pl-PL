...
## Opis
Polecenie cmdlet **Get-AzCosmosDBTable** pobiera istniejącą tabelę.
...
Obiekt zasobu zawiera właściwości _rid, _ts, ETag tabeli.
...
Jeśli ta funkcja zostanie dostarczona, polecenie cmdlet zwróci tabelę z odpowiednią wartością przepustowości.
