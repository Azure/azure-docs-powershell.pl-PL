...
```
### Przykład 3
Przykład przechwytywania pakietów służący do przechwytywania wszystkich pakietów wewnętrznych i zewnętrznych
```powershell
...
### -FilterData
Opcje filtrowania dotyczące rozpoczynania przechwytywania pakietów w połączeniu bramy sieci wirtualnej.
...
### -Inputobject
Obiekt połączenie bramy sieci wirtualnej, w którym jest uruchamiany przechwytywanie pakietów.
...
### -Name (nazwa)
Nazwa połączenia bramy sieci wirtualnej, w którym można uruchomić przechwytywanie pakietów.
...
### -ResourceId
Identyfikator zasobu platformy Azure VirtualNetworkGatewayConnection, w którym jest uruchamiane przechwytywanie pakietów.
