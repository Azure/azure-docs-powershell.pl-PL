...
### 1: Tworzenie prywatnego punktu końcowego
```
...
W tym przykładzie przedstawiono tworzenie prywatnego punktu końcowego z określonym identyfikatorem prywatnego łącza w określonej podsieci w sieci wirtualnej.
...
Połączenie z usługą link prywatny.
