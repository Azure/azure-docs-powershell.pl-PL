...
Tworzy konfigurację adresu URL reguły ponownej edycji dla bramy aplikacji
...
Umożliwia utworzenie monitora połączenia.
...
Umożliwia utworzenie punktu końcowego monitora połączenia.
...
Aktualizowanie monitora połączeń.

### [Set-AzNetworkWatcherFlowLog](Set-AzNetworkWatcherFlowLog.md)
Aktualizowanie zasobu dziennika przepływu.
...
Odłączanie połączenia VPN bramy sieci wirtualnej.

### [Disconnect-AzP2sVpnGatewayVpnConnection](Disconnect-AzP2sVpnGatewayVpnConnection.md)
Odłączanie połączenia VPN z bramą VPN P2S.
