...
## Opis
Polecenie cmdlet **Remove-AzVirtualNetworkTap** usuwa pozycję Sieć wirtualna Azure.

## Przykłady

### Przykład 1: usunięcie sieci wirtualnej
```
PS C:\>Remove-AzNetworkInterface -Name "VirtualNetworkTap1" -ResourceGroup "ResourceGroup1"
```

To polecenie usuwa VirtualNetworkTap1 w grupie zasób ResourceGroup1.
...
### -Inputobject
Odwołanie do zasobu VirtualNetworkTap
