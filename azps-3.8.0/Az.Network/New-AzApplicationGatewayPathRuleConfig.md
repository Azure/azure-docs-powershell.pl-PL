...
Identyfikatory zasad zapory można zwrócić za pomocą Get-AzApplicationGatewayWebApplicationFirewallPolicy cmdlet. Po użyciu identyfikatora można użyć parametru *FirewallPolicyId* zamiast *parametru FirewallPolicy.*
