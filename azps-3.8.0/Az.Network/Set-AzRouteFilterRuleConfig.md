...
## Opis
Polecenie cmdlet **Set-AzRouteFilterRuleConfig** modyfikuje regułę filtru tras filtru tras.
...
Pierwsze polecenie uzyskuje filtr trasy o nazwie RouteFilter01 i zapisuje go w zmiennej $rf.
Drugie polecenie modyfikuje regułę filtrowania tras o nazwie Rule01 i przechowuje zaktualizowaną filtr tras w zmiennej $rf.
Trzecie polecenie zapisuje zaktualizowany filtr trasy.

## PARAMETRÓW

### — Dostęp
Typ dostępu do reguły.
Możliwe wartości: "Zezwalaj", "Odmów"
