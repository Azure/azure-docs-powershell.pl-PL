...
## Opis
Polecenie cmdlet **Set-AzApplicationGatewayUrlPathMapConfig** ustawia konfigurację tablicy mapowań ścieżek adresów URL na pulę serwerów wewnętrznej bazy danych.

## Przykłady

### Przykład 1: Aktualizowanie mapowania ścieżki URL
```
...
Drugie polecenie aktualizuje mapowanie ścieżki adresu URL o nazwie map01 w bramie Application Gateway.
W trzecim poleceniu jest aktualizowana Brama Application Gateway.

## PARAMETRÓW

### -ApplicationGateway
Określa bramę aplikacji, do której to polecenie cmdlet ustawia konfigurację mapowania ścieżki URL.
...
### -Name (nazwa)
Określa nazwę mapy ścieżki URL, w której to polecenie cmdlet ustawia konfigurację dla.
