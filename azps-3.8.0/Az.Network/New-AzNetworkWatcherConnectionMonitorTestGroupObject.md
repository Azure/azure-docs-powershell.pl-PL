...
## Opis
Polecenie cmdlet New-AzNetworkWatcherConnectionMonitorTestGroupObject tworzy grupę testową monitora połączenia.

## Przykłady

### Przykład 1. Tworzenie grupy testowej z dwoma punktami końcowymi 2 testConfigurations, w źródłowym i 2 docelowym
...
### -Miejsce docelowe
Lista docelowych punktów końcowych.
...
### -Disable
Flaga wskazująca, czy grupa testowa jest wyłączona.
...
### -Source
Lista źródłowych punktów końcowych.
