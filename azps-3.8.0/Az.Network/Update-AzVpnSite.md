...
### ByVpnSiteNameNoVirtualWanUpdate (domyślny)
```
...
## Opis
Polecenie cmdlet **Update-AzVpnSite** aktualizuje witrynę sieci VPN.
...
Po utworzeniu witryny wiadomość zostanie zaktualizowana w adresie IP witryny przy użyciu polecenia Set-AzVpnSite.

## PARAMETRÓW

### -AddressSpace
Prefiksy adresów sieci wirtualnej.
Użyj tego lub AddressSpaceObject, ale nie obu.
...
### -ResourceId
Identyfikator zasobu platformy Azure dla witryny sieci VPN.
