...
### ByVirtualHubNameByVpnServerConfigurationObject (domyślny)
```
...
## Opis
Polecenie cmdlet **New-AzP2sVpnGateway** umożliwia utworzenie nowego P2SVpnGateway w obszarze VirtualHub na potrzeby punktu połączenia z witryną od klientów do usługi Azure VirtualWan.
...
Polecenie cmdlet **New-AzP2sVpnGateway** umożliwia utworzenie nowego P2SVpnGateway w obszarze VirtualHub na potrzeby punktu połączenia z witryną.
...
### -VirtualHub
VirtualHub, do tego P2SVpnGateway należy skojarzyć.
...
### -VirtualHubId
Identyfikator VirtualHub, do którego należy ten P2SVpnGateway musi być skojarzony.
