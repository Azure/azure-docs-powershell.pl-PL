...
### -IkeEncryption
Algorytm szyfrowania IKE (faza IKE 1)
...
### -IkeIntegrity
Algorytm integralności IKE (Usługa IKE faza 1)
...
### -IpsecEncryption
Algorytm szyfrowania protokołu IPSec (Usługa IKE Phase 2)
...
### -IpsecIntegrity
Algorytm integralności protokołu IPSec (Usługa IKE Phase 2)
