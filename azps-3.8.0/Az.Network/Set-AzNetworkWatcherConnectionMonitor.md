...
## Opis
Polecenie Set-AzNetworkWatcherConnectionMonitor polecenia cmdlet aktualizuje zasób monitora połączeń.

## Przykłady

### Przykład 1: aktualizowanie monitora połączeń
```
...
W tym przykładzie Zaktualizowano istniejący monitor połączenia, zmieniając destinationAddress i dodając Tagi.
...
### -ResourceId
Identyfikator zasobu ConnectionMonitor.
