...
Ilość czasu, w której automatyczne naprawy są zawieszane ze względu na zmianę stanu maszyny wirtualnej. Czas prolongaty rozpoczyna się po zakończeniu zmiany stanu. Pomaga to uniknąć przedwczesnych lub przypadkowych napraw. Czas trwania należy określić w formacie ISO 8601. Wartość domyślna to 5 minut (PT5M).
...
Procent (pojemność scaleset) maszyn wirtualnych, które zostaną jednocześnie naprawione. Wartość domyślna to 20%.
