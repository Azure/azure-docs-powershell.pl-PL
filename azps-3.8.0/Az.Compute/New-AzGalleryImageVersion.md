...
### -StorageAccountType
Określa typ konta magazynu, który ma być wykorzystywany do przechowywania obrazu. Tej właściwości nie można aktualizować. Dostępne wartości to Standard_LRS i Standard_ZRS.
