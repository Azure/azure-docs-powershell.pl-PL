...
Powyższe polecenie aktualizuje warstwę klastra Kusto "mykustocluster" w grupie zasobów "testrg".

### Przykład 2 — Aktualizowanie istniejącego klastra za pomocą połączeń rurowych
...
Powyższe polecenie pobiera klaster Kusto "mykustocluster" znajdujący się w grupie zasobów "testrg" przy użyciu `Get-AzKustoCluster` polecenia cmdlet, a następnie powoduje przełączenie wyniku w celu `Update-AzKustoCluster` zaktualizowania warstwy klastra na wartość "standard".

## PARAMETRÓW

### -Pojemność
Numer wystąpienia maszyny wirtualnej.
...
### -Name (nazwa)
Nazwa klastra do zaktualizowania.
...
### -SkuName
Nazwa jednostki SKU użytej do utworzenia klastra
...
### -Warstwowy
Nazwa warstwy użytej do utworzenia klastra
