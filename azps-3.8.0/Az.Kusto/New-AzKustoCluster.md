...
### Przykład 1-Tworzenie nowego klastra Kusto
...
Powyższe polecenie tworzy nowy klaster Kusto o nazwie "mykustocluster" w grupie zasobów "testrg".
...
### — Lokalizacja
Obszar platformy Azure, w którym ma zostać utworzony klaster.
...
### -ResourceGroupName
Nazwa grupy zasobów, w której ma zostać utworzony klaster.
...
### -Tag
Ciąg znaków, który jest ciągiem znaczników skojarzonych z tym klastrem
