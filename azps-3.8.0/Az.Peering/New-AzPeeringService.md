...
Tworzy obiekt usługi peer dla dostawców i lokalizacji równorzędnej. Używanie w conjuction z `Get-AzPeeringServiceProvider` i `Get-AzPeeringServiceLocation`
...
### -PeeringLocation
Lokalizacja fizyczna różna od obszaru Azure region. Użyj Get-AzPeeringServiceLocation [-Country <country> ]
...
Nazwa dostawcy usługi Peer-Name.
Używanie polecenia cmdlet Get-AzPeeringServiceProvider dla listy
...
### -Tag
Tagi, które mają zostać skojarzone z usługą Microsoft Inputobject.
