...
### Przykład 3: Uzyskaj pierwszych 2 bilety pomocy technicznej filtrowane według statusu
```powershell
...
### Przykład 3: Uzyskaj wszystkie bilety pomocy technicznej, które są w stanie otwartym, i utworzono po 20 grudnia 2019 r.
```powershell
