...
## STRESZCZENIe
Tworzy obiekt profilu kontaktu pomocy technicznej.
...
## Opis
To jest polecenie cmdlet pomocnika, którego można użyć do utworzenia obiektu profilu kontaktu pomocy technicznej podczas tworzenia lub aktualizowania biletu pomocy technicznej. Musisz określić następujące parametry, które są wymagane do utworzenia biletu pomocy technicznej: 
...
### Przykład 1. Tworzenie obiektu Contact
```powershell
