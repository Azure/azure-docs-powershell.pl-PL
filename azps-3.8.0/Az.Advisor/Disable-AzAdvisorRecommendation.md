...
## Opis
Tworzy pominięcie rekomendacji, to umożliwia odroczenie konkretnego rekomendacji na określony czas trwania lub bez zatrzymania.
...
Utwórz tłumienie dla danej nazwy rekomendacji z domyślną wartością-SuppressionName i domyślną wartością dni na-1.
...
Dla danego zalecenia-ID jest tworzone pomijanie.
...
Tworzenie tłumienia, przewody rurowe z Get-AzAdvisorRecommendation w celu wyłączenia-AzAdvisorRecommendation.
...
### -Inputobject
Typ obiektu programu PowerShell PsAzureAdvisorResourceRecommendationBase zwrócony przez połączenie Get-AzAdvisorRecommendation.
...
### Microsoft. Azure. Commands. Advisor. cmdlet. models. PsAzureAdvisorSuppressionContract
