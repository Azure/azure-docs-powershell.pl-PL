...
Tworzenie nowej puli adresów IP.
...
Liczba obecnie przydzielonych adresów IP.
...
Bieżąca liczba adresów IP w obszarze przejścia.
...
### -Pool
Ten zasób definiuje zakres adresów IP, z których adresy są przydzielane węzłom w podsieci.
Aby skonstruować, zobacz sekcję notatki dla właściwości puli i Utwórz tablicę skrótów.
...
### Microsoft. Azure. PowerShell. polecenia. FabricAdmin. models. Api20160501. IIPPool
...
Pula <IIPPool> : ten zasób definiuje zakres adresów IP, z których adresy są przydzielane węzłom w podsieci.
  - `[Location <String>]`: Region, w którym znajduje się zasób.
  - `[Tag <IResourceTags>]`: Lista par klucz-wartość.
    - `[(Any) <String>]`: Wskazuje, że do tego obiektu można dodać dowolną właściwość.
  - `[AddressPrefix <String>]`: Prefiks adresu.
  - `[EndIPAddress <String>]`: Końcowy adres IP.
  - `[NumberOfAllocatedIPAddresses <Int64?>]`: Liczba obecnie przydzielonych adresów IP.
  - `[NumberOfIPAddresses <Int64?>]`: Łączna liczba adresów IP.
  - `[NumberOfIPAddressesInTransition <Int64?>]`: Bieżąca liczba adresów IP w ramach przejścia.
  - `[StartIPAddress <String>]`: Początkowy adres IP.
