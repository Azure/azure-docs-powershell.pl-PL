...
### Przykład 1: pobieranie wszystkich dysków 
```powershell
PS C:\> Get-AzsDisk
```

Bez żadnych parametrów `Get-AzsDisk` zostanie wystawiona lista wszystkich dysków.

### Przykład 2: uzyskiwanie dysku według nazwy
```powershell
...
Określ dysk, `Name` Aby go pobrać.

### Przykład 3: Uzyskaj określoną liczbę dysków
```powershell
...
Użyj `Count` parametru, aby pobrać określoną liczbę dysków.

### Przykład 4: pobieranie wszystkich dysków w określonej lokalizacji
```powershell
...
`ScaleUnit` `VolumeLabel` Aby wyświetlić wszystkie dyski w określonej lokalizacji, użyj parametru lub.
...
### -ScaleUnit
Jednostka skali, do której należy zasób.
...
### -SharePath
Udział, do którego należy zasób.
...
### -UserSubscriptionId
Identyfikator subskrypcji użytkownika, do którego należy zasób.
...
### -VolumeLabel
Etykieta woluminu, do którego należy zasób.
...
### Microsoft. Azure. PowerShell. polecenia. ComputeAdmin. models. Api20180730Preview. IDisk
