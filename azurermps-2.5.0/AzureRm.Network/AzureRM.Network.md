...
## Polecenia cmdlet AzureRM. Network
...
### [Dodaj-AzureRmApplicationGatewayBackendHttpSettings](Add-AzureRmApplicationGatewayBackendHttpSettings.md)
...
### [Dodaj-AzureRmApplicationGatewayProbeConfig](Add-AzureRmApplicationGatewayProbeConfig.md)
Dodaje badanie kondycji do bramy aplikacji.

### [Dodaj-AzureRmApplicationGatewayRedirectConfiguration](Add-AzureRmApplicationGatewayRedirectConfiguration.md)
...
{{Tutaj ręcznie wprowadź Add-AzureRmLoadBalancerInboundNatPoolConfig opis}}
...
### [Dodaj-AzureRmVirtualNetworkGatewayIpConfig](Add-AzureRmVirtualNetworkGatewayIpConfig.md)
...
{{Tutaj ręcznie wprowadź Get-AzureRmBgpServiceCommunity opis}}
...
{{Tutaj ręcznie wprowadź Get-AzureRmLoadBalancerInboundNatPoolConfig opis}}
...
{{Tutaj ręcznie wprowadź Get-AzureRmVirtualNetworkGatewayConnectionSharedKey opis}}
...
### [Nowe — AzureRmApplicationGatewayFirewallDisabledRuleGroupConfig](New-AzureRmApplicationGatewayFirewallDisabledRuleGroupConfig.md)
...
### [Nowe — AzureRmApplicationGatewayProbeConfig](New-AzureRmApplicationGatewayProbeConfig.md)
Umożliwia utworzenie badania dotyczącego kondycji.

### [Nowe — AzureRmApplicationGatewayProbeHealthResponseMatch](New-AzureRmApplicationGatewayProbeHealthResponseMatch.md)
Tworzy dopasowanie odpowiedzi badania kondycji używane przez sondę kondycji dla bramy aplikacji.

### [Nowe — AzureRmApplicationGatewayRedirectConfiguration](New-AzureRmApplicationGatewayRedirectConfiguration.md)
...
### [Nowe — AzureRmIpsecPolicy](New-AzureRmIpsecPolicy.md)
Tworzy zasady IPSec.
...
{{Tutaj ręcznie wprowadź New-AzureRmLoadBalancerInboundNatPoolConfig opis}}
...
### [Nowe — AzureRmRouteFilter](New-AzureRmRouteFilter.md)
Tworzy filtr trasy.
...
{{Tutaj ręcznie wprowadź New-AzureRmVirtualNetworkGatewayConnection opis}}

### [Nowe — AzureRmVirtualNetworkGatewayIpConfig](New-AzureRmVirtualNetworkGatewayIpConfig.md)
...
### [Nowe — AzureRmVpnClientConfiguration](New-AzureRmVpnClientConfiguration.md)
...
{{Tutaj ręcznie wprowadź Remove-AzureRmLoadBalancerInboundNatPoolConfig opis}}
...
{{Tutaj ręcznie wprowadź Remove-AzureRmVirtualNetworkGatewayIpConfig opis}}

### [Remove-AzureRmVirtualNetworkPeering](Remove-AzureRmVirtualNetworkPeering.md)
{{Tutaj ręcznie wprowadź Remove-AzureRmVirtualNetworkPeering opis}}
...
{{Tutaj ręcznie wprowadź Reset-AzureRmVirtualNetworkGateway opis}}

### [Resetowanie — AzureRmVirtualNetworkGatewayConnectionSharedKey](Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey.md)
{{Tutaj ręcznie wprowadź Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey opis}}
...
{{Tutaj ręcznie wprowadź Set-AzureRmLoadBalancerInboundNatPoolConfig opis}}
...
{{Tutaj ręcznie wprowadź Test-AzureRmDnsAvailability opis}}
