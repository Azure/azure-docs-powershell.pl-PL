...
## Opis
Polecenie cmdlet **Set-AzureRmApplicationGatewayIPConfiguration** modyfikuje konfigurację adresu IP.
Konfiguracja IP zawiera podsieć, w której wdrożono bramę aplikacji.

## Przykłady

### Przykład 1: Ustawianie stanu celu konfiguracji adresu IP
```
