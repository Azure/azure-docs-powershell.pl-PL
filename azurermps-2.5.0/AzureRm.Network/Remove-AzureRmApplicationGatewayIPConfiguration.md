...
## Opis
Polecenie cmdlet **Remove-AzureRmApplicationGatewayIPConfiguration** usuwa konfigurację IP z bramy aplikacji platformy Azure.

## Przykłady

### Przykład 1: Usuwanie konfiguracji adresów IP z bramy aplikacji platformy Azure
```
...
Drugie polecenie usuwa konfigurację adresu IP o nazwie Subnet02 z bramy aplikacji przechowywanej w $AppGw.

## PARAMETRÓW

### -ApplicationGateway
Określa bramę aplikacji, z której ma zostać usunięta Konfiguracja IP.
...
### -Name (nazwa)
Określa nazwę konfiguracji IP, którą należy usunąć.
