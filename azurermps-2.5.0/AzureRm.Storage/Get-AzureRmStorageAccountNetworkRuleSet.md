...
## Opis
Polecenie cmdlet **Get-AzureRmStorageAccountNetworkRuleSet** Pobiera właściwość NetworkRule konta magazynu

## Przykłady

### Przykład 1: pobieranie właściwości NetworkRule określonego konta magazynu
```
