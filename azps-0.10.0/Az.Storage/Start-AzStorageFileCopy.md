...
## Opis
Polecenie cmdlet **Start-AzStorageFileCopy** rozpoczyna kopiowanie pliku źródłowego do pliku docelowego.
...
Aby uzyskać kontekst, użyj funkcji **New-AzStorageContext**.
...
Możesz utworzyć obiekt BLOB chmury lub uzyskać go za pomocą polecenia cmdlet Get-AzStorageBlob.
...
Możesz utworzyć obiekt kontenera obiektu BLOB chmury lub użyć polecenia cmdlet Get-AzStorageContainer.
...
### -SrcFile
Określa obiekt **CloudFile** .
Możesz utworzyć plik w chmurze lub uzyskać go za pomocą polecenia **Get-AzStorageFile**.
...
Możesz utworzyć udział plików w chmurze lub uzyskać go za pomocą polecenia cmdlet Get-AzStorageShare.
