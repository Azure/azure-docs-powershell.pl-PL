...
## Opis
Polecenie cmdlet **Add-AzKeyVaultCertificate** uruchamia proces rejestrowania certyfikatu w magazynie kluczy usługi Azure Key.
...
W pierwszym poleceniu jest używane polecenie cmdlet New-AzKeyVaultCertificatePolicy w celu utworzenia zasad certyfikatu, a następnie zapisanie go w zmiennej $Policy.

Drugie polecenie używa polecenia **Add-AzKeyVaultCertificate** , aby rozpocząć proces tworzenia certyfikatu.

W trzecim poleceniu użyto polecenia cmdlet Get-AzKeyVaultCertificateOperation do sondowania operacji w celu sprawdzenia, czy jest ona kompletna.

Polecenie ostatnie używa polecenia cmdlet Get-AzKeyVaultCertificate, aby uzyskać certyfikat.
