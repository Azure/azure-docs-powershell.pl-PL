...
## Opis
Polecenie cmdlet **Get-AzMetricDefinition** umożliwia pobieranie definicji metryk.

## Przykłady

### Przykład 1: uzyskiwanie definicji metryk dla zasobu
```
...
### Przykład 2: uzyskiwanie definicji metryk ze szczegółowym wyjściem
```
...
To polecenie pobiera definicje metryk dla website2.
Wynik jest szczegółowy.

### Przykład 3: uzyskiwanie definicji metryk według nazw
```
...
### -MetricNamespace
Określa obszar nazw metryki służący do wyszukiwania definicji metryki.
