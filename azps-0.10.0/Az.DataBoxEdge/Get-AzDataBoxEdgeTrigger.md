...
## Opis
Polecenie cmdlet **Get-AzDataBoxEdgeTriger** pobiera wyzwalacze dla urządzenia. Możesz określić nazwę jako parametr w poleceniu cmdlet, aby pobrać szczegółowe dane dotyczące określonych wyzwalaczy.
