...
### -Type
Określa typ konta, które ma zostać utworzone. Bieżące dopuszczalne wartości tego parametru to:

- Usługa Bing. autosugerował. v7
- Bing. CustomSearch
- Usługa Bing. Search. v7
- Bing. mowa
- Bing. Sprawdzanie pisowni. v7
- ComputerVision
- ContentModerator
- CustomSpeech
- CustomVision. przewidywania
- CustomVision. szkolenia
- Emocji
- Silne
- LUIS
- QnAMaker
