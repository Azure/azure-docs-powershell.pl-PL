...
## Opis
Polecenie cmdlet **New-AzureRmDnsRecordConfig** tworzy lokalny obiekt **DnsRecord** .
Tablica tych obiektów jest przekazywana do polecenia cmdlet New-AzureRmDnsRecordSet za pomocą parametru *DnsRecords* w celu określenia rekordów, które mają zostać utworzone w zestawie rekordów.
