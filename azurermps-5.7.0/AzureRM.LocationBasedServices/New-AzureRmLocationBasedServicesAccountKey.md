...
## Opis
Polecenie cmdlet **New-AzureRmLocationBasedServicesAccountKey** GENERUJE klucz API dla konta usług opartego na lokalizacji.
...
Generuje ponownie podstawowy klucz interfejsu API dla konta Moje konto w grupie zasobu moja grupa zasobów.
...
Ponownie generuje pomocniczy klucz API dla określonego konta usługi opartego na lokalizacji.
...
### -NazwaKlucza
Klucz konta usług opartych na lokalizacji.
...
### System. String
Microsoft. Azure. Commands. LocationBasedServices. NewAzureLocationBasedServicesAccountKeyCommand + nameType

## WYSYŁA

### Microsoft. Azure. Management. LocationBasedServices. MODELES. LocationBasedServicesAccountKeys
