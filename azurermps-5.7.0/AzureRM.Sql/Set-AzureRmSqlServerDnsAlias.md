...
## Opis
To polecenie aktualizuje serwer, do którego jest wskazywany alias. 

To polecenie należy wydać w ramach abonamentu, w którym znajduje się nowy serwer, do którego ma się odnosić alias.
