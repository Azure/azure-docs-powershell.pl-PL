...
## Opis
Polecenie cmdlet **Get-AzureRmSqlDatabaseImportExportStatus** pobiera szczegóły importu pliku BACPAC z konta magazynu do bazy danych SQL Azure lub eksportu bazy danych SQL Azure jako pliku BACPAC do konta magazynu.
...
### -OperationStatusLink
Umożliwia określenie łącza stanu zwróconego przez aplety poleceń New-AzureRmSqlDatabaseExport lub New-AzureRmSqlDatabaseImport.
