...
## Opis
Polecenie cmdlet **Get-AzureRmSqlDatabaseActivity** Pobiera stan operacji bazy danych w usłudze Azure SQL Database.

## Przykłady

### Przykład 1: uzyskiwanie statusu dla wszystkich wystąpień bazy danych SQL
```
PS C:\>Get-AzureRmSqlDatabaseActivity -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

To polecenie zwraca stan operacji wszystkich wystąpień bazy danych SQL w puli elastycznej o nazwie ElasticPool01.

### Przykład 2: uzyskiwanie statusu dla wszystkich operacji bazy danych SQL
```
...
### -DatabaseName
Określa nazwę bazy danych, dla której to polecenie cmdlet pobiera stan.
...
### -ElasticPoolName
Określa nazwę puli Elastic Database, dla której to polecenie cmdlet pobiera stan.
...
### -OperationId
Określa identyfikator operacji, która jest pobierana przez to polecenie cmdlet.
...
### -Nazwa_serwera
Określa nazwę programu Microsoft SQL Server, który zawiera bazę danych.
