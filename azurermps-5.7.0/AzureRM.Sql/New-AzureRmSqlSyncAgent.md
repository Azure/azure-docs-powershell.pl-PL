...
### SyncDatabaseComponent (domyślny)
```
...
## Opis
Polecenie cmdlet **New-AzureRmSqlSyncAgent** umożliwia utworzenie agenta synchronizacji SQL Azure.

## Przykłady

### Przykład 1: tworzenie agenta synchronizacji dla programu Azure SQL Server.
```
...
To polecenie tworzy agenta synchronizacji dla programu Azure SQL Server.
...
### -SyncDatabaseResourceID
Identyfikator zasobu bazy danych metadanych synchronizacji.
