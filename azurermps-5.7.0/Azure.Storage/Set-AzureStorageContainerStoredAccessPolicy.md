...
## Opis
Polecenie cmdlet **Set-AzureStorageContainerStoredAccessPolicy** ustawia zapisane zasady dostępu dla kontenera magazynu platformy Azure.
...
Parametr "Container" akceptuje wartość typu "String" z procesu
