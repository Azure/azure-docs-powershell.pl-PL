...
## Opis
Polecenie cmdlet **New-AzureRmResource** umożliwia utworzenie zasobu platformy Azure, takiego jak witryna sieci Web, serwer bazy danych SQL Azure lub baza danych SQL Azure, w grupie zasobów.
...
Określa nazwę zasobu rozszerzenia dla zasobu. Aby na przykład określić bazę danych, użyj następującego formatu:
...
Jeśli na przykład zasób rozszerzenia jest bazą danych, określ następujący typ:
...
Zasób można umieścić w dowolnej lokalizacji obsługującej zasoby tego typu. Grupy zasobów mogą zawierać zasoby z różnych lokalizacji. Aby określić, które lokalizacje obsługują poszczególne typy zasobów, użyj polecenia cmdlet Get-AzureLocation.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, w której to polecenie cmdlet tworzy zasób.
...
### -ResourceName
Określa nazwę zasobu. Aby na przykład określić bazę danych, użyj następującego formatu:
