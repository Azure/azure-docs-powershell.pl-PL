...
## Opis
Polecenie cmdlet **Get-AzureRmAutoscaleHistory** pobiera historię zdarzeń związanych z ustawieniem skalowania automatycznego.

## Przykłady

### Przykład 1. pobieranie wszystkich zdarzeń skojarzonych z subskrypcją
```
PS C:\>Get-AzureRmAutoscaleHistory -StartTime 2015-02-09T18:35:00 -EndTime 2015-02-09T18:40:00 -DetailedOutput
```

To polecenie umożliwia pobieranie wszystkich zdarzeń związanych z autoskalowaniem skojarzonych z bieżącą subskrypcją.

### Przykład 2: GetAutoscaleHistory dla określonego zasobu
```
...
To polecenie pobiera wszystkie zdarzenia związane z autoskalowaniem skojarzone z określonym zasobem określonym przez identyfikator zasobu (zasadniczo ResourceUri).
...
### -DetailedOutput
Wskazuje, że ta operacja zawiera szczegółowe dane wyjściowe.
Jeśli ten parametr nie zostanie określony, dane wyjściowe zostaną podsumowane.
...
### -ResourceId
Określa identyfikator zasobu, do którego jest skojarzone ustawienie skalowania automatycznego.
...
### -Status
Umożliwia określenie filtru według stanu.
Ten parametr jest opcjonalny.
Błąd jest ciągiem pustym (tzn. bez filtru).
...
### Lista<Microsoft. Azure. Commands. Insights. OutputClasses. PSEventData>
