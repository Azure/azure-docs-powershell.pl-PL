...
## Opis
Polecenie cmdlet **Get-AzureRmAutoscaleSetting** pobiera wszystkie ustawienia autoskalowania skojarzone z grupą zasobów lub określonym ustawieniem skalowania automatycznego.

## Przykłady

### Przykład 1: Uzyskaj ustawienia autoskalowania
```
...
To polecenie pobiera ustawienia skalowania automatycznego przypisane do grupy zasobów-Web-wschodniego.
...
To polecenie pobiera ustawienie skalowania automatycznego o nazwie DefaultServerFarm-Default-Web-wschodniego.
...
### -DetailedOutput
Wskazuje, że ta operacja wyświetla wszystkie szczegóły w wynikach.
...
### -Name (nazwa)
Określa nazwę ustawienia do pobrania.
