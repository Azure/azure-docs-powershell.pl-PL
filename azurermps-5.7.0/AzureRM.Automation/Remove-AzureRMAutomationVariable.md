...
## Opis
Polecenie cmdlet **Remove-AzureRmAutomationVariable** usuwa zmienną z usługi Azure Automation.

## Przykłady

### Przykład 1. Usuń zmienną
```
...
To polecenie usuwa zmienną o nazwie StringVariable22 na koncie automatyzacji o nazwie Contoso17.
...
Określa nazwę konta automatyzacji zawierającego zmienną, którą to polecenie cmdlet usuwa.
...
### -Name (nazwa)
Określa nazwę zmiennej, którą to polecenie cmdlet usuwa.
...
### -ResourceGroupName
Określa grupę zasobów, dla której to polecenie cmdlet usuwa zmienną.
