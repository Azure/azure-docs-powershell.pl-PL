...
## Opis
Polecenie cmdlet **New-AzureRmServerManagementNode** umożliwia utworzenie węzła zarządzania serwerem platformy Azure.
...
### -ComputerName
Określa nazwę komputera zarządzanego na komputerze.
...
### — Poświadczenie
Określa obiekt **PSCredential** dla połączenia z węzłem zarządzania serwerem.
...
### -Gateway
Określa bramę zarządzającą węzłem.

Ten parametr może być wykorzystywany zamiast parametrów *ResourceGroupName* , *gatewayname* i *Location* .
...
### -Bramaname
Określa nazwę bramy, która uzyskuje dostęp do węzła.
...
### — Lokalizacja
Określa lokalizację, w której to polecenie cmdlet tworzy węzeł.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, w której ten aplet polecenia tworzy węzeł.
...
### -Tag
Pary klucz/wartość skojarzone z obiektem.
