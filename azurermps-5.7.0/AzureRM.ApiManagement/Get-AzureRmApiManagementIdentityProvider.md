...
Szczegóły dostawcy tożsamości skonfigurowanego w usłudze zarządzania interfejsem API.

### IList<Microsoft. Azure. Commands. ApiManagement. servicemanagement. models. PsApiManagementIdentityProvider>
Lista dostawców tożsamości skonfigurowanych w usłudze zarządzania interfejsem API.
