...
Szczegóły dotyczące wewnętrznej bazy danych skonfigurowane w usłudze zarządzania interfejsem API.

### IList<Microsoft. Azure. Commands. ApiManagement. servicemanagement. models. PsApiManagementBackend>
Lista zaplecza skonfigurowana w usłudze zarządzania interfejsem API.
