...
## Opis
Weryfikuje certyfikat, przekazując certyfikat weryfikacji zawierający kod weryfikacyjny otrzymany za pomocą polecenia cmdlet Get-AzureRmIotHubCertificateVerificationCode. Jest to ostatni krok w celu poświadczania procesu posiadania.
