...
## Opis
Spowoduje to wyeksportowanie zagregowanych liczb z funkcji Microsoft. obliczeniowych wywołań API, rozdzielonych sukcesem, niepowodzeniem lub ograniczeniem wyświetlanym w odstępach czasu.
Dzienniki mogą być pogrupowane według trzech parametrów: GroupByOperationName, GroupByThrottlePolicy lub GroupByResourceName.
