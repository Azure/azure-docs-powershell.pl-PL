...
## Opis
Polecenie cmdlet **Add-AzureRmImageDataDisk** dodaje dysk danych do obiektu obrazu.
...
Kolejne trzy polecenia umożliwiają przypisanie ścieżek dysku systemu operacyjnego i dwóch dysków danych do $osDiskVhdUri, $dataDiskVhdUri 1 i $dataDiskVhdUri 2 zmiennych.
...
Polecenie ostatnie powoduje utworzenie obrazu o nazwie ImageName01 w grupie zasób ResourceGroup01.

## PARAMETRÓW

### -BlobUri
Określa łącze jako identyfikator URI dla obiektu BLOB.
...
### -DiskSizeGB
Określa rozmiar dysku w gigabajtach (GB).
...
### -StorageAccountType
Typ konta magazynu na dysku obrazu danych
...
System. Int32 system. String. String. Nullable `1[[Microsoft.Azure.Management.Compute.Models.CachingTypes, Microsoft.Azure.Management.Compute, Version=14.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35]]
