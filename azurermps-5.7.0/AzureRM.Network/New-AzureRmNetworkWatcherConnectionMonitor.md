...
## Opis
Polecenie cmdlet New-AzureRmNetworkWatcherConnectionMonitor rcreates monitorze połączeń dla określonego źródła i miejsca docelowego.

## Przykłady

### Przykład 1. Tworzenie monitora połączeń dla maszyny wirtualnej i lokalizacji docelowej w Internecie
```
...
Polecenie cmdlet New-AzureRmNetworkWatcherConnectionMonitor tworzy monitor połączenia dla określonego źródła i miejsca docelowego.
...
### -DestinationAddress
Adres IP miejsca docelowego monitora połączeń.
...
Identyfikator miejsca docelowego monitora połączeń.
...
Interwał monitorowania w sekundach.
...
### -SourceResourceId
Identyfikator źródła monitora połączeń.
