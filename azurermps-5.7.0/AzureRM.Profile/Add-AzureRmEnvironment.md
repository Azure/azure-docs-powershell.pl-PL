...
### -DefaultProfile
Credeetnails, dzierżawa i subskrypcja używana do komunikacji z usługą Azure
...
Określa punkt końcowy dostępu do zapytań o szczegółowe dane. 
...
Określa odbiorców dla tokenów dostępu, które autoryzują żądania dotyczące usług usługi Insights.
