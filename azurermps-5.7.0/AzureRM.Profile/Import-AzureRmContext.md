...
W tym przykładzie wybrano kontekst z pliku JSON przekazanego do polecenia cmdlet. Ten plik JSON można utworzyć w usłudze Save-AzureRmContext.

## PARAMETRÓW

### -AzureContext
Określa kontekst platformy Azure, na podstawie którego jest odczytywane to polecenie cmdlet. Jeśli nie określisz kontekstu, to polecenie cmdlet odczytuje dane z lokalnego kontekstu domyślnego.
...
Zawiera zestaw poświadczeń, kont i subskrypcji, które są używane do komunikacji z usługą Azure.

## WYSYŁA

### Microsoft. Azure. Commands. profile. PSAzureProfile
Zawiera zestaw poświadczeń, kont i subskrypcji, których można użyć do komunikacji z usługą Azure.
