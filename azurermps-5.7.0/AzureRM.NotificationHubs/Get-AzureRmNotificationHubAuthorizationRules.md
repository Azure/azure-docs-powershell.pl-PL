...
## Opis
Polecenie cmdlet **Get-AzureRmNotificationHubAuthorizationRules** pobiera informacje o regułach autoryzacji podpisu dostępu udostępnionego (SAS) skojarzonych z centrum powiadomień.
...
Polecenie cmdlet **Get-AzureRmNotificationHubAuthorizationRules** pobiera tylko informacje o regułach autoryzacji skojarzonych z centrum powiadomień.
Aby uzyskać informacje na temat samego centrum, użyj polecenie Get-AzureRmNotificationHub.
