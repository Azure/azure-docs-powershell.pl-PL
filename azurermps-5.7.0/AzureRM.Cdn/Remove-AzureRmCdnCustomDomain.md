...
## Opis
Polecenie cmdlet **Remove-AzureRmCdnCustomDomain** usuwa domenę niestandardową z punktu końcowego sieci dostarczania zawartości platformy Azure (CDN).
...
### -CdnCustomDomain
Określa domenę niestandardową, która zostanie usunięta przez to polecenie cmdlet.
...
### -CustomDomainName
Określa nazwę zasobu niestandardowej domeny, która zostanie usunięta przez to polecenie cmdlet.
...
### -EndpointName
Określa nazwę punktu końcowego, z którego to polecenie cmdlet usuwa domenę niestandardową.
...
### -Refilename
Określa nazwę profilu, z którego to polecenie cmdlet usuwa domenę niestandardową.
...
### -ResourceGroupName
Określa nazwę grupy zasobów, z której to polecenie cmdlet usuwa domenę niestandardową.
...
### PSCustomDomain
Parametr "CdnCustomDomain" akceptuje wartość typu "PSCustomDomain" z rurociągu
