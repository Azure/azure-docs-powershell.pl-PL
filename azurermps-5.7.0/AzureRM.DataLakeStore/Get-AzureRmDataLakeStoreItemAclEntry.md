...
## Opis
Polecenie cmdlet **Get-AzureRmDataLakeStoreItemAclEntry** pobiera wpis (ACE) z listy kontroli dostępu (ACL) do pliku lub folderu w usłudze Data Lake Store.
...
To polecenie pobiera listę ACL katalogu głównego określonego konta usługi Data Lake Store
...
### -Path
Określa ścieżkę do usługi Data Lake Store elementu, dla którego to polecenie cmdlet pobiera wpis ACE, rozpoczynając od katalogu głównego (/).
...
Lista wpisów list ACL dla określonego folderu lub pliku.
