...
## Opis
Polecenie cmdlet **Get-AzureBatchCertificate** pobiera certyfikaty na koncie usługi Azure Batch, które określa parametr *BatchContext* .
Aby uzyskać określony certyfikat, określ parametry *ThumbprintAlgorithm* i *odcisk palca* .
Określ parametr *Filter* , aby uzyskać certyfikaty zgodne z filtrem Open Data Protocol (OData).

## Przykłady

### Przykład 1: uzyskiwanie certyfikatu według odcisku palca
```
...
To polecenie pobiera jeden certyfikat z określonym palcem.
Algorytm odcisku palca certyfikatu to SHA1.

### Przykład 2: uzyskiwanie przefiltrowanych certyfikatów
```
...
To polecenie pobiera wszystkie certyfikaty w stanie aktywnym z konta wsadowego.
Parametr *Filter* określa stan.
...
Jeśli określisz ten parametr, to polecenie cmdlet otrzyma certyfikaty zgodne z filtrem.
...
### -MaxCount
Określa maksymalną liczbę zwracanych certyfikatów.
...
### Microsoft.Azure.Commands.Batch. Modele. PSCertificate
