...
## Opis
Polecenie cmdlet **Get-AzureRmServiceBusAuthorizationRule** Pobiera opis określonej reguły autoryzacji w danym obszarze nazw lub kolejce albo temacie lub aliasze (Konfiguracja GeoDR).
...
Zwraca opis reguły autoryzacji określonej kolejki.
...
Zwraca opis reguły autoryzacji określonego tematu.
...
Zwraca opis reguły autoryzacji określonego obszaru nazw i aliasu.

## PARAMETRÓW

### -Aliasname
Nazwa konfiguracji GeoDR
...
### System. Collections. Generic. list "1 [[Microsoft. Azure. Commands. ServiceBus. MODELES. PSSharedAccessAuthorizationRuleAttributes, Microsoft. Azure. Commands. ServiceBus, Version = 0.5.0.0, Culture = neutral, PublicKeyToken = null]]
