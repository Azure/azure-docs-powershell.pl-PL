...
## Opis
Polecenie cmdlet **Get-AzureRmSiteRecoveryNetworkMapping** pobiera informacje o mapowaniach sieciowych usługi Azure Site Recovery dla bieżącego magazynu odzyskiwania witryny.
...
### -Azure
Wskazuje, że polecenie pobiera listę mapowań sieciowych dla sieci na serwerze podstawowym zamapowanym na wirtualne sieci Azure.
...
### ASRFabric
Parametr "PrimaryFabric" akceptuje wartość typu "ASRFabric" z rurociągu

### ASRServer
Parametr "PrimaryServer" akceptuje wartość typu "ASRServer" z rurociągu
